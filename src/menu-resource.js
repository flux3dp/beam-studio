module.exports = {
    ...
    'zh-cn': {
        ...
        samples: '范例',
        import_first_engrave: '初次雕刻',
        import_material_testing_old: '材质测试档 (旧)', 
        import_material_testing_simple_cut: '材质测试档 - 简易切割',
        import_material_testing_cut: '材质测试档 - 切割',
        import_material_testing_engrave: '材质测试档 - 雕刻',
        import_material_testing_line: '材质测试档 - 线段',
        export_to: '汇出成...',
        export_flux_task: 'FLUX 工作',
        export_SVG: 'SVG',
        export_PNG: 'PNG',
