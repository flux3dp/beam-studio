...
const NEW_USER_TUTORIAL: ITutorial = {
  ...
  dialogStylesAndContents: [
    ...
    {
      dialogBoxStyles: {
        position: { left: 56, top: 66 }
      },
      holePosition: { left: 7, top: 56 },
      holeSize: { width: 36, height: 36 },
      hintCircle: { left: 5, top: 49, width: 40, height: 40 },
      text: LANG.newUser.end_preview_mode,
      nextStepRequirement: nextStepRequirements.TO_EDIT_MODE,
    },
    {
      dialogBoxStyles: {
        position: { left: 56, top: 197 }
      },
      holePosition: { left: 7, top: 187 },
      holeSize: { width: 36, height: 36 },
      hintCircle: { left: 5, top: 178, width: 40, height: 40 },
    ...
    {
      dialogBoxStyles: {
        position: { right: Constant.rightPanelWidth + 4, top: Constant.topBarHeightWithoutTitleBar + 20 },
        arrowDirection: 'right'
      },
      holePosition: { right: Constant.rightPanelWidth - 31, top: Constant.topBarHeightWithoutTitleBar },
      holeSize: { width: 32, height: 40 },
      hintCircle: { right: Constant.rightPanelWidth - 36, top: Constant.topBarHeightWithoutTitleBar, width: 40, height: 40 },
      text: LANG.newUser.switch_to_layer_panel,
      nextStepRequirement: nextStepRequirements.TO_LAYER_PANEL,
    },
    {
      dialogBoxStyles: {
        position: { right: Constant.rightPanelWidth - 2, top: Constant.topBarHeightWithoutTitleBar + Constant.layerListHeight + 141 },
        arrowDirection: 'right'
      },
      holePosition: { right: 15, top: Constant.topBarHeightWithoutTitleBar + Constant.layerListHeight + 126 },
      holeSize: { width: Constant.rightPanelWidth - 22, height: 30 },
      hintCircle: { right: 5, top: Constant.topBarHeightWithoutTitleBar + Constant.layerListHeight + 122, width: Constant.rightPanelWidth - 12, height: 40 },
    ...
    {
      dialogBoxStyles: {
        position: { left: 56, top: 238 }
      },
      holePosition: { left: 7, top: 228 },
      holeSize: { width: 36, height: 36 },
      hintCircle: { left: 5, top: 221, width: 40, height: 40 },
    ...
    {
      dialogBoxStyles: {
        position: { right: 65, top: 301 },
        arrowDirection: 'right'
      },
      holePosition: { right: 15, top: 289 },
      holeSize: { width: 55, height: 20 },
      hintCircle: { right: 9, top: 281, width: 55, height: 40 },
    ...
    },
    {
      ...
      holeSize: {},
      hintCircle: { right: 4, top: 3, width: isMac ? 36 : 64, height: isMac ? 36 : 33 },
