export default {
    ...
    tutorial: {
        ...
        welcome: 'WELCOME',
        needNewUserTutorial: 'Start a Tutorial.',
        needNewInterfaceTutorial: 'Start a Tutorial for Beam Studio’s new interface.',
        next: 'NEXT',
        look_for_machine: 'Looking for Machine for Tutorial...',
