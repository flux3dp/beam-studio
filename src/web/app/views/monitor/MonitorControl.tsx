...
export default class MonitorControl extends React.PureComponent {
  ...
  renderCameraButton(enable = true) {
  ...
  render() {
    const {
      mode, currentPath, highlightedItem, report, onDownload, onPlay, onStop, endRelocate,
    } = this.context;

    let leftButton: Element; let midButton: Element; let
      rightButton: Element;
    if (mode === Mode.FILE) {
