...
const CHANGES_EN = {
    ...
    fixed: [
        ...
        'Fixed the wrong popup order of insert machine password panel and error message.',
        'Fixed speed limit warning message not appearring when both speed and power is too high.',
