define(['app/actions/beambox/beambox-preference', 'app/actions/beambox/constant', 'helpers/i18n'], function (BeamboxPreference, Constant, i18n) {
  'use strict';
  ...
  return {
    ...
    NEW_USER_TUTORIAL: {
      ...
      dialogStylesAndContents: [{
        ...
        dialogBoxStyles: {
          position: {
            left: window.innerWidth - Constant.rightPanelWidth,
            top: 300
          }
        },
        holePosition: {
        ...
        hintCircle: {
          left: 55,
          top: 45,
          width: window.innerWidth - Constant.sidePanelsWidth - 10,
          height: window.innerHeight - Constant.topBarHeight - 10
        },
        ...
        dialogBoxStyles: {
          position: {
            right: 50 + Constant.rightPanelScrollBarWidth,
            top: 302
          },
        ...
        holeSize: {
          width: 30 + Constant.rightPanelScrollBarWidth,
          height: 20
        },
        hintCircle: {
          right: 9,
          top: 282,
          width: 40 + Constant.rightPanelScrollBarWidth,
          height: 40
        },
        ...
        dialogBoxStyles: {
          position: {
            right: Constant.rightPanelWidth + 3,
            top: Constant.topBarHeightWithoutTitleBar + 20
          },
          arrowDirection: 'right'
        },
        holePosition: {
          right: Constant.rightPanelWidth - 32,
          top: Constant.topBarHeightWithoutTitleBar
        },
        holeSize: {
          width: 32,
          height: 40
        ...
        hintCircle: {
          right: Constant.rightPanelWidth - 37,
          top: Constant.topBarHeightWithoutTitleBar,
          width: 40,
          height: 40
        },
        ...
        dialogBoxStyles: {
          position: {
            right: Constant.rightPanelWidth - 2,
            top: Constant.topBarHeightWithoutTitleBar + Constant.layerListHeight + 110
          },
          arrowDirection: 'right'
        },
        holePosition: {
          right: 15,
          top: Constant.topBarHeightWithoutTitleBar + Constant.layerListHeight + 95
        },
        holeSize: {
          width: Constant.rightPanelWidth - 22,
          height: 30
        },
        hintCircle: {
          right: 5,
          top: Constant.topBarHeightWithoutTitleBar + Constant.layerListHeight + 91,
          width: Constant.rightPanelWidth - 12,
          height: 40
        },
        ...
        dialogBoxStyles: {
          position: {
            right: 40 + Constant.rightPanelScrollBarWidth,
            top: Constant.topBarHeightWithoutTitleBar + Constant.layerListHeight + 22
          },
          arrowDirection: 'right'
        },
        holePosition: {
          right: 15,
          top: Constant.topBarHeightWithoutTitleBar + Constant.layerListHeight + 10
        },
        holeSize: {
          width: 20 + Constant.rightPanelScrollBarWidth,
          height: 20
        },
        hintCircle: {
          right: 14,
          top: Constant.topBarHeightWithoutTitleBar + Constant.layerListHeight + 9,
          width: 25 + Constant.rightPanelScrollBarWidth,
          height: 25
        },
        ...
        subElement: /*#__PURE__*/React.createElement("div", {
          className: "sub-content"
        }, /*#__PURE__*/React.createElement("div", {
          className: "sub-line"
        }, LANG.newUser.put_wood), /*#__PURE__*/React.createElement("div", {
          className: "sub-line"
        }, LANG.newUser.adjust_focus, /*#__PURE__*/React.createElement("div", {
          className: "hint-mark",
          onClick: () => adjustFocusLinkClick()
        }, '?')), /*#__PURE__*/React.createElement("div", {
          className: "sub-line"
        }, LANG.newUser.close_cover)),
    ...
    INTERFACE_TUTORIAL: {
      ...
      dialogStylesAndContents: [{
        ...
        dialogBoxStyles: {
          position: {
            left: 56,
            top: Constant.topBarHeightWithoutTitleBar + 40
          }
        },
        hintCircle: {
          left: 5,
          top: Constant.topBarHeightWithoutTitleBar + 5,
          width: 40,
          height: 135
        },
        ...
        dialogBoxStyles: {
          position: {
            left: 56,
            top: Constant.topBarHeightWithoutTitleBar + 175
          }
        },
        hintCircle: {
          left: 5,
          top: Constant.topBarHeightWithoutTitleBar + 150,
          width: 40,
          height: 190
        },
        ...
        dialogBoxStyles: {
          position: {
            left: 56,
            top: Constant.topBarHeightWithoutTitleBar + 370
          }
        },
        hintCircle: {
          left: 5,
          top: Constant.topBarHeightWithoutTitleBar + 350,
          width: 40,
          height: 40
        },
        ...
        dialogBoxStyles: {
          position: {
            right: Constant.rightPanelWidth - 30,
            top: 100
          },
          arrowDirection: 'right'
        },
        ...
        hintCircle: {
          right: Constant.rightPanelWidth - 70,
          top: 123,
          width: 65,
          height: 36
        },
        ...
        hintCircle: {
          right: Constant.rightPanelScrollBarWidth + 5,
          top: 123,
          width: 115,
          height: 36
        },
        ...
        dialogBoxStyles: {
          position: {
            right: Constant.rightPanelScrollBarWidth + 75,
            top: 230
          },
          arrowDirection: 'right'
        },
        hintCircle: {
          right: Constant.rightPanelScrollBarWidth + 10,
          top: 213,
          width: 57,
          height: 34
        },
