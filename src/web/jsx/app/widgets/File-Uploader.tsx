...
define(['jquery', 'reactClassset'], function ($, ReactCx) {
  'use strict';
  ...
  return _temp = _class = class FileUploader extends React.Component {
    constructor(...args) {
      super(...args);

      _defineProperty(this, "getFileExtension", fileName => {
        return fileName.split('.').pop();
      });

      _defineProperty(this, "readFiles", (e, files) => {
        var self = this,
      ...
      _defineProperty(this, "_onReadFile", e => {
