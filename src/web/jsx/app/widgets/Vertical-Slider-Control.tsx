define(['plugins/classnames/index', 'app/constants/keycode-constants'], function (ClassNames, keyCodeConstants) {
  'use strict';
  ...
  class VerticalSlider extends React.Component {
    ...
    componentDidMount() {
      ...
      let sliderBarRadius = $(ReactDOM.findDOMNode(this.refs.sliderBar)).css('border-width'); //This is a hack: Assuming unit is "px", may cause problem
      ...
      $(ReactDOM.findDOMNode(this.refs.sliderBar)).css({
        top: sliderTop
      });
    }
    ...
    render() {
      return /*#__PURE__*/React.createElement("div", {
        id: this.props.id,
        className: "vertical-slider-control"
