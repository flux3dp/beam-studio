define(['helpers/shortcuts'], function (shortcuts) {
  ...
  return class CurveControl extends React.PureComponent {
    ...
    _onMouseMove(e) {
      if (this.dragging != null) {
        ...
        this.state.controlPoints[this.dragging] = {
          x,
          y
        };
        this.setState({
    ...
    _renderControlPoints() {
      ...
      this.state.controlPoints.forEach((p, index) => {
        ...
        items.push( /*#__PURE__*/React.createElement("rect", {
          id: index,
          key: index,
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        className: "curve-control-container"
