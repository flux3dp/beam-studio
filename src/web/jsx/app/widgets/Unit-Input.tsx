...
define(['helpers/unit-converter', 'app/constants/keycode-constants', 'helpers/round', 'plugins/classnames/index'], function (unitConverter, keyCodeConstants, round, ClassNames) {
  'use strict';
  ...
  return _temp = _class = class UnitInput extends React.Component {
    constructor(props) {
      super(props);

      _defineProperty(this, "value", val => {
      ...
      _defineProperty(this, "_parseValue", value => {
      ...
      _defineProperty(this, "_confirmValue", addValue => {
        ...
        value = this.value(this._parseValue(el.value) + addValue); // check value boundary
      ...
      _defineProperty(this, "_onKeyUp", e => {
        ...
        switch (e.keyCode) {
          ...
          case keyCodeConstants.KEY_DIVIDE:
            operatorAmount = Math.floor(e.currentTarget.value.split(this.operatorRegex).length / 2); // check negative number
