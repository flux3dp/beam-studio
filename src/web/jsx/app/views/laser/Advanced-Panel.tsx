...
define(['reactPropTypes', 'jsx!widgets/Button-Group', 'jsx!widgets/Text-Input', 'jsx!widgets/Unit-Input', 'helpers/api/config', 'plugins/classnames/index', 'helpers/round', 'app/actions/input-lightbox-actions', 'jsx!widgets/File-Uploader', 'helpers/i18n', 'plugins/jquery/serializeObject', 'helpers/array-findindex'], function (PropTypes, ButtonGroup, TextInput, UnitInput, config, classNames, round, InputLightboxActions, FileUploader, i18n) {
  'use strict';
  ...
  class AdvancedPanel extends React.Component {
    constructor(props) {
      ...
      _defineProperty(this, "_getFooterButtons", () => {
        var buttonGroup = [{
      ...
      _defineProperty(this, "_getControlButtons", () => {
        var self = this,
            buttonGroup = [{
      ...
      _defineProperty(this, "_applySetting", e => {
        this.props.onDone();
      });

      _defineProperty(this, "_onLoadPreset", e => {
      ...
      _defineProperty(this, "_onSaveAndApply", e => {
        var self = this,
            material = {
      ...
      _defineProperty(this, "_onCustomBackground", e => {
        var self = this;
      ...
      _defineProperty(this, "_onApply", e => {
        var material = {
          value: 'custom',
      ...
      _defineProperty(this, "_changeInputNumber", () => {
        var self = this,
      ...
      _defineProperty(this, "_changeRangeNumber", () => {
        var self = this,
      ...
      _defineProperty(this, "_updateDefaultMaterial", defaultMaterial => {
      ...
      _defineProperty(this, "_renderSaveForm", () => {
        var maxLength = 10;
        return /*#__PURE__*/React.createElement("div", {
          className: "form"
        }, /*#__PURE__*/React.createElement("header", {
          class: "header"
        }, advancedLang.save_as_preset), /*#__PURE__*/React.createElement("div", {
          className: "controls"
        }, /*#__PURE__*/React.createElement("div", {
          className: "control"
        }, /*#__PURE__*/React.createElement("label", {
          className: "label"
        }, advancedLang.name), /*#__PURE__*/React.createElement(TextInput, {
          ref: "presetName",
          maxLength: maxLength
        }))));
      });

      _defineProperty(this, "_renderDefaultForm", () => {
    ...
    render() {
      var form = false === this.state.openSaveWindow ? this._renderDefaultForm() : this._renderSaveForm(),
          footer = this._renderFooter(),
          fileUploader = this._renderFileUploader();

      return /*#__PURE__*/React.createElement("div", {
        className: "advanced-panel"
      }, fileUploader, form, footer);
    }
