...
define(['jquery', 'reactPropTypes', 'helpers/i18n', 'helpers/shortcuts', 'jsx!widgets/Modal', 'jsx!widgets/AlertDialog', 'helpers/device-master', 'app/constants/device-constants', 'app/actions/alert-actions', 'app/stores/alert-store', 'helpers/device-error-handler'], function ($, PropTypes, i18n, shortcuts, Modal, AlertDialog, DeviceMaster, DeviceConstants, AlertActions, AlertStore, DeviceErrorHandler) {
  ...
  class ChangeFilament extends React.Component {
    constructor(props) {
      ...
      _defineProperty(this, "_onCancel", e => {
      ...
      _defineProperty(this, "_goMaintain", type => {
        var self = this,
          ...
          switch (status) {
            ...
            case 'LOADING':
              ...
              if (self.state.loading_status !== response.stage[1]) {
                self.setState({
                  loading_status: response.stage[1]
                });
                self.forceUpdate();
              }
        ...
        const processReport = report => {
          console.log('processing report', report); // if changing filament during pause

          if (report.st_id === 48) {
            this.isChangingFilamentDuringPause = true;
            DeviceMaster.changeFilamentDuringPause(type).progress((p, t) => {
              ...
              DeviceMaster.changeFilament(type, this.state.flexible).progress(progress).done(done).fail(function (response) {
      ...
      _defineProperty(this, "_next", (nextStep, type) => {
        let flexible = false;
      ...
      _defineProperty(this, "_loadFilamentFromComplete", () => {
        this.setState(this.getInitialState(), () => {
          this._next(steps.GUIDE, DeviceConstants.LOAD_FILAMENT);
        });
      });

      _defineProperty(this, "_makeCaption", caption => {
      ...
      _defineProperty(this, "_sectionHome", () => {
        return {
          ...
          }, lang.change_filament.load_filament_caption), /*#__PURE__*/React.createElement("button", {
            className: "btn btn-default",
            "data-ga-event": "load-filament",
            onClick: this._next.bind(null, steps.GUIDE, DeviceConstants.LOAD_FLEXIBLE_FILAMENT)
          }, lang.change_filament.load_flexible_filament_caption), /*#__PURE__*/React.createElement("button", {
            className: "btn btn-default",
      ...
      _defineProperty(this, "_sectionGuide", () => {
      ...
      _defineProperty(this, "_sectionHeating", () => {
        let {
          temperature,
          targetTemperature
        } = this.state;
        return {
          ...
          }, /*#__PURE__*/React.createElement("span", null, lang.change_filament.heating_nozzle), /*#__PURE__*/React.createElement("span", null, temperature, " / ", targetTemperature || maxTemperature, "\xB0C")), /*#__PURE__*/React.createElement("div", {
      ...
      _defineProperty(this, "_sectionEmerging", () => {
        var self = this,
        ...
        buttons = [{
          ...
          }, this.state.loading_status === 'WAITING' ? lang.change_filament.auto_emerging : lang.change_filament.loading_filament), /*#__PURE__*/React.createElement("div", {
            className: "spinner-roller spinner-roller-reverse"
          })],
          type: 'icon',
          className: 'btn-icon',
      ...
      _defineProperty(this, "_sectionUnloading", () => {
        return {
          message: /*#__PURE__*/React.createElement("div", {
            className: "message-container"
          }, /*#__PURE__*/React.createElement("p", null, lang.change_filament.unloading), /*#__PURE__*/React.createElement("div", {
            className: "spinner-roller spinner-roller-reverse"
          })),
          buttons: []
        };
      ...
      _defineProperty(this, "_sectionCompleted", () => {
        let loaded, unloaded;
        ...
        unloaded = /*#__PURE__*/React.createElement("div", {
          className: "message-container"
        }, lang.change_filament.unloaded, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("a", {
      ...
      _defineProperty(this, "_sectionDisconnected", () => {
        return {
          message: /*#__PURE__*/React.createElement("div", {
            className: "message-container"
      ...
      _defineProperty(this, "_sectionFactory", () => {
        var self = this,
            renderFunc,
