define(['jquery', 'helpers/i18n', 'app/app-settings', 'helpers/api/discover', 'helpers/device-master', 'helpers/check-device-status', 'helpers/check-firmware', 'helpers/version-checker', 'helpers/firmware-updater', 'helpers/firmware-version-checker', 'helpers/api/cloud', 'helpers/output-error', 'plugins/classnames/index', 'app/constants/device-constants', 'jsx!views/beambox/About-Beam-Studio', 'app/contexts/AlertCaller', 'app/constants/alert-constants', 'app/actions/alert-actions', 'app/stores/alert-store', 'jsx!contexts/DialogCaller', 'app/actions/global-actions', 'app/stores/global-store', 'app/stores/topbar-store', 'app/actions/beambox', 'helpers/device-list', 'app/actions/progress-actions', 'app/constants/progress-constants', 'app/constants/global-constants', 'app/actions/initialize-machine', 'app/actions/beambox/preview-mode-background-drawer', 'app/actions/beambox/preview-mode-controller', 'app/actions/beambox/svgeditor-function-wrapper', 'app/actions/beambox/bottom-right-funcs', 'app/actions/beambox/beambox-preference', 'app/actions/beambox/constant'], function ($, i18n, appSettings, Discover, DeviceMaster, checkDeviceStatus, checkFirmware, VersionChecker, firmwareUpdater, FirmwareVersionChecker, CloudApi, OutputError, ClassNames, DeviceConstants, AboutBeamStudio, Alert, AlertConstants, AlertActions, AlertStore, DialogCaller, GlobalActions, GlobalStore, TopmenuStore, BeamboxActions, DeviceList, ProgressActions, ProgressConstants, GlobalConstants, InitializeMachine, PreviewModeBackgroundDrawer, PreviewModeController, FnWrapper, BottomRightFuncs, BeamboxPreference, Constant) {
  'use strict';
  ...
  return function (args) {
    ...
    var _id = 'TopMenu',
      ...
      downloader.then(file => {
        ...
        let msg = data === 'canceled' ? lang.device.download_log_canceled : lang.device.download_log_error;
        Alert.popUp({
    ...
    class TopMenu extends React.Component {
      ...
      componentWillUnmount() {
        ...
        TopmenuStore.removeUpdateTopMenuListener(() => {
          this.setState(this.state);
        }); // unregisterEvents();
      }
      ...
      async _handleExportClick() {
        ...
        for (let i = 1; i < imageElems.length; i++) {
          if (imageElems[i].getAttribute('data-shading') === 'true' && (dpi === 'medium' && imageElems[i].parentNode.getAttribute('data-speed') > 135 || dpi === 'high' && imageElems[i].parentNode.getAttribute('data-speed') > 90)) {
            isSpeedTooHigh = true;
            break;
          }
        }
        ...
        Discover('top-menu', function (machines) {
      ...
      async _onSuccessConnected(device, e) {
        ...
        e.preventDefault(); // Check firmware
      ...
      _handleContextMenu(event) {
        electron && electron.ipc.send("POPUP_MENU_ITEM", {
          x: event.screenX,
          y: event.screenY
        }, {});
      }
      ...
      _renderDeviceList() {
        var status = lang.machine_status,
          ...
          return /*#__PURE__*/React.createElement("li", {
            ...
            className: "name"
          }, device.name), /*#__PURE__*/React.createElement("label", {
            className: "status"
          }, headText, " ", statusText), /*#__PURE__*/React.createElement("label", {
            className: "progress"
            ...
            list;
        list = 0 < options.length ? options : [/*#__PURE__*/React.createElement("div", {
          key: "spinner-roller",
          className: "spinner-roller spinner-roller-reverse"
        })];
        return /*#__PURE__*/React.createElement("ul", null, list);
      }
      ...
      _renderTopDropDown(id, label) {
        const labelFunctionMap = {
          'align-h': [{
            id: 'align-l',
            label: lang.topbar.left_align,
            f: () => {
              FnWrapper.alignLeft();
            }
          }, {
            id: 'align-h',
            label: lang.topbar.center_align,
            f: () => {
              FnWrapper.alignCenter();
            }
          }, {
            id: 'align-r',
            label: lang.topbar.right_align,
            f: () => {
          ...
          'align-v': [{
            id: 'align-t',
            label: lang.topbar.top_align,
            f: () => {
              FnWrapper.alignTop();
            }
          }, {
            id: 'align-v',
            label: lang.topbar.middle_align,
            f: () => {
              FnWrapper.alignMiddle();
            }
          }, {
            id: 'align-b',
            label: lang.topbar.bottom_align,
            f: () => {
        ...
        const _setTopDropDownPosition = function () {
          $('.top-dropdown-control').hover(function () {
            ...
            $(this).children('.top-dropdown-content').css({
              left: `${l}px`
            });
          });
        };
        ...
        return /*#__PURE__*/React.createElement("div", {
          className: ClassNames('top-btn top-dropdown-control', process.platform, {
            disabled
          }),
          onMouseEnter: () => {
            _setTopDropDownPosition();
          }
        }, /*#__PURE__*/React.createElement("img", {
          src: `img/top-menu/icon-${id}.svg`,
          onError: e => {
            e.target.onerror = null;
            e.target.src = `img/top-menu/icon-${id}.png`;
          }
        }), /*#__PURE__*/React.createElement("div", {
          className: "btn-label"
        }, label), /*#__PURE__*/React.createElement("div", {
          className: "top-dropdown-content"
        }, /*#__PURE__*/React.createElement("div", {
          className: "arrowup "
        }), /*#__PURE__*/React.createElement("div", {
      ...
      _renderTopBtn(id, label, onClick) {
        ...
        if (disabled) onClick = () => {};
        return /*#__PURE__*/React.createElement("div", {
          className: ClassNames('top-btn', process.platform, {
            disabled
          }),
          key: id,
          onClick: () => {
      ...
      _renderZoomBtn(id, label, onClick) {
        return /*#__PURE__*/React.createElement("div", {
          className: ClassNames('top-btn zoom', process.platform),
          onClick: onClick,
          key: id
        }, /*#__PURE__*/React.createElement("img", {
          src: `img/top-menu/icon-${id}.svg`,
      ...
      _renderScrollCue() {
        ...
        const left_scroll_cue = /*#__PURE__*/React.createElement("div", {
          className: "top-scroll-cue",
          onMouseEnter: () => {
            startScroll.bind(this)(-5);
          },
          onMouseLeave: endScroll.bind(this)
        }, left_space > 30 ? /*#__PURE__*/React.createElement("img", {
          src: "img/top-menu/icon-cue-left.svg"
        }) : null);
        const right_scroll_cue = /*#__PURE__*/React.createElement("div", {
          className: "top-scroll-cue",
          onMouseEnter: () => {
            startScroll.bind(this)(5);
          },
          onMouseLeave: endScroll.bind(this)
        }, right_space > 30 ? /*#__PURE__*/React.createElement("img", {
          src: "img/top-menu/icon-cue-right.svg"
        }) : null);
        return {
          left_scroll_cue,
          right_scroll_cue
      ...
      _checkButtonAvailable() {
        ...
        try {
          ...
          if (e instanceof ReferenceError) {} else {
            throw e;
          }
        }
      ...
      render() {
        ...
        return /*#__PURE__*/React.createElement("div", null, left_scroll_cue, /*#__PURE__*/React.createElement("div", {
          className: "top-btns",
          onScroll: () => {
            this.setState(this.state);
          }
          ...
          className: "top-controls zoom-controls"
        }, this._renderZoomBtn('zoomout', 'out', () => {
          svgEditor.zoomOut();
        }), this._renderTopBtn('zoom', lang.topbar.zoom, () => {
          svgEditor.resetView();
        }), this._renderZoomBtn('zoomin', 'in', () => {
          svgEditor.zoomIn();
        })), /*#__PURE__*/React.createElement("div", {
          className: "top-controls group-controls"
        }, this._renderTopBtn('group', lang.topbar.group, () => {
          FnWrapper.groupSelected();
        }), this._renderTopBtn('ungroup', lang.topbar.ungroup, () => {
          FnWrapper.ungroupSelected();
        })), /*#__PURE__*/React.createElement("div", {
          className: "top-controls align-controls"
        }, this._renderTopDropDown('align-h', lang.topbar.halign), this._renderTopDropDown('align-v', lang.topbar.valign), this._renderTopBtn('dist-h', lang.topbar.hdist, () => {
          FnWrapper.distHori();
        }), this._renderTopBtn('dist-v', lang.topbar.vdist, () => {
          FnWrapper.distVert();
        })), /*#__PURE__*/React.createElement("div", {
          className: "top-controls clip-controls"
        }, this._renderTopBtn('union', lang.topbar.union, () => {
          FnWrapper.booleanUnion();
        }), this._renderTopBtn('subtract', lang.topbar.subtract, () => {
          FnWrapper.booleanDifference();
        }), this._renderTopBtn('intersect', lang.topbar.intersect, () => {
          FnWrapper.booleanIntersect();
        }), this._renderTopBtn('difference', lang.topbar.difference, () => {
          FnWrapper.booleanXor();
        })), /*#__PURE__*/React.createElement("div", {
          className: "top-controls flip-controls"
        }, this._renderTopBtn('h-flip', lang.topbar.hflip, () => {
          FnWrapper.flipHorizontal();
        }), this._renderTopBtn('v-flip', lang.topbar.vflip, () => {
          FnWrapper.flipVertical();
        })))), right_scroll_cue, this._renderFileTitle(), /*#__PURE__*/React.createElement("div", {
          title: lang.print.deviceTitle,
          className: `device ${process.platform}`
        }, /*#__PURE__*/React.createElement("div", {
          className: "device-icon",
          onClick: this._handleExportClick.bind(this)
        }, /*#__PURE__*/React.createElement("img", {
          src: "img/top-menu/icon-export.svg",
          draggable: "false"
        }), /*#__PURE__*/React.createElement("div", null, lang.topbar.export)), /*#__PURE__*/React.createElement("div", {
          className: menuClass
        }, /*#__PURE__*/React.createElement("div", {
          className: "arrow arrow-right"
        }), /*#__PURE__*/React.createElement("div", {
          className: "device-list"
        }, deviceList))), /*#__PURE__*/React.createElement(AboutBeamStudio, null));
      }
