...
define(['reactClassset', 'jsx!widgets/Button-Group'], function (ReactCx, ButtonGroup) {
  'use strict';
  ...
  class ActionButtons extends React.Component {
    constructor(...args) {
      ...
      _defineProperty(this, "_getActionButtons", lang => {
        var self = this,
            buttons = [],
            className;
  ...
  ActionButtons.defaultProps = {
    ...
    // convert from point cloud to stl
    onScanAgainClick: function () {},
    // start over
    onMultiScanClick: function () {},
    // ready to multi scan
