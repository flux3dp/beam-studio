...
define(['jquery', 'helpers/i18n', 'app/actions/beambox/beambox-preference', 'jsx!widgets/AlertDialog', 'jsx!widgets/Unit-Input-v2', 'helpers/device-master', 'helpers/version-checker', 'app/contexts/AlertCaller', 'app/constants/alert-constants', 'helpers/check-device-status', 'app/actions/progress-actions', 'app/constants/progress-constants', 'app/actions/beambox/preview-mode-controller', 'helpers/api/camera-calibration', 'app/actions/beambox/constant', 'helpers/device-error-handler'], function ($, i18n, BeamboxPreference, AlertDialog, UnitInput, DeviceMaster, VersionChecker, Alert, AlertConstants, CheckDeviceStatus, ProgressActions, ProgressConstants, PreviewModeController, CameraCalibration, Constant, DeviceErrorHandler) {
  const React = require('react');

  const classNames = require('classnames');

  const LANG = i18n.lang.diode_calibration; //View render the following steps
  ...
  class DiodeCalibration extends React.Component {
    constructor(props) {
      ...
      _defineProperty(this, "updateCurrentStep", nextStep => {
        this.setState({
      ...
      _defineProperty(this, "doCuttingTask", async () => {
        const {
          device
        } = this.props;
      ...
      _defineProperty(this, "doCaptureTask", async () => {
        const {
          device
        } = this.props;
        let blobUrl;
      ...
      _defineProperty(this, "cropAndRotateImg", async () => {
        const img = new Image();
      ...
      _defineProperty(this, "renderHintModal", () => {
      ...
      _defineProperty(this, "moveAndRetakePicture", async dir => {
        try {
          ProgressActions.open(ProgressConstants.NONSTOP, LANG.taking_picture);
          let {
            cameraMovedX,
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        className: "modal-diode-calibration"
      }, content);
    }
    ...
    renderStepCut() {
      ...
      return /*#__PURE__*/React.createElement(AlertDialog, {
        ...
        buttons: [{
          ...
          className: classNames('btn-default btn-alone-right primary', {
    ...
    renderStepAnalyze() {
      ...
      let manual_calibration = /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
        ...
        onClick: () => this.moveAndRetakePicture('up')
      }), /*#__PURE__*/React.createElement("div", {
        className: "camera-control down",
        onClick: () => this.moveAndRetakePicture('down')
      }), /*#__PURE__*/React.createElement("div", {
        className: "camera-control left",
        onClick: () => this.moveAndRetakePicture('left')
      }), /*#__PURE__*/React.createElement("div", {
