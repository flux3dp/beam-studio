define(['jsx!widgets/Modal', 'jsx!widgets/Select', 'jsx!widgets/Vertical-Slider-Control', 'app/stores/beambox-store', 'app/actions/beambox/bottom-right-funcs', 'app/actions/progress-actions', 'app/constants/progress-constants', 'helpers/i18n'], function (Modal, SelectView, VerticalSlider, BeamboxStore, BottomRightFuncs, ProgressActions, ProgressConstants, i18n) {
  ...
  const TAB_GCODE = 0;
  const TAB_CONSOLE = 1;
  const TAB_MOVE = 2; //const MockBinding = require('@serialport/binding-mock');
  ...
  class TaskInterpreterPanel extends React.Component {
    constructor(props) {
      ...
      this._ondataCB = () => {}; //GCode Tab


      this._ln = 0;
      this.playerState = 'idle';
      this.gcodelist = []; //Move Tab
    ...
    _onListWheel(e) {
      ...
      if (e.deltaY > 0 && currentScrollTop === maxScrollTop) {
        this.setState({
          firstIndex: this.state.firstIndex + LINES_PER_PAGE / 2
        }, () => {
        ...
        if (this.state.firstIndex === 0) {
          ...
          this.setState({
            firstIndex: Math.max(0, this.state.firstIndex - LINES_PER_PAGE / 2)
          }, () => {
            $('.gcode-command-list').scrollTop(currentScrollTop + $('.gcode-command-container').outerHeight() * (LINES_PER_PAGE / 2));
          });
        }
    ...
    _scrollToTargetY(clientY) {
      ...
      targetIndex = Math.max(0, Math.min(this.gcodelist.length - 10, targetIndex)); //console.log(targetIndex);
    ...
    _sendCommand() {
      ...
      if (this.port && this.port.isOpen) {
        ...
        ReactDOM.findDOMNode(this.refs.command).value = ''; //ReactDOM.findDOMNode(this.refs.command).focus();
      }
    }
    ...
    async _handleLineModeCommand(cmd, id) {
      if (cmd.startsWith('G')) {
        ...
        c %= 65536;
        await this._waitForBuffer(this._ln); //console.log(`l${this._ln + this._nonGlines -1}`, cmd);
        ...
        this._ondataCB = data => {
          ...
          this._executedIndex = data[0] - data[1] + this._nonGlines - 1; //console.log(this._executedIndex);
        };
      } else {
        this._nonGlines += 1;
      }
      ...
      if (this.state.currentIndex < this.gcodelist.length) {
        ...
        if (this.state.currentIndex === this.gcodelist.length) {
          ...
          this.gcodePlayerCB = () => {
            ...
            this.maxBufferNumber = 20;
            console.log('gcode play end'); //this.port.write('\x18');
          };
        } else {
    ...
    _renderLeftPart() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        className: "left-part"
      }, this._renderTabControl(), tabContent);
    }

    _renderTabControl() {
      return /*#__PURE__*/React.createElement("div", {
        className: "tab-control"
      }, this._renderTabButton(TAB_GCODE, 'GCODE'), this._renderTabButton(TAB_CONSOLE, 'CONSOLE'), this._renderTabButton(TAB_MOVE, 'MOVE'));
    }

    _renderTabButton(tab, label) {
      let className = tab === this.state.tab ? 'selected pull-left tab-button' : 'pull-left tab-button';
      return this._renderButton(className, () => {
        this.setState({
          tab
        });
      }, label);
    ...
    _renderGCodeTab() {
      ...
      let ret = [/*#__PURE__*/React.createElement("div", {
        ...
        key: 'list'
      }, this._renderGCodeList()), /*#__PURE__*/React.createElement("div", {
        className: "scroll-bar",
        key: 'scroll-bar',
        onMouseDown: e => {
          this._onScrollbarMouseDown(e);
        },
        onMouseMove: e => {
          this._onScrollbarMouseMove(e);
        },
        onMouseUp: e => {
    ...
    _renderGCodeList() {
      ...
      for (let i = this.state.firstIndex; i < Math.min(this.gcodelist.length, this.state.firstIndex + LINES_PER_PAGE); i++) {
        ...
        cmds.push( /*#__PURE__*/React.createElement("div", {
          className: `gcode-command-container ${current}`,
          key: i
        }, /*#__PURE__*/React.createElement("div", {
          className: "line-index"
        }, i), /*#__PURE__*/React.createElement("div", {
          className: "gcode-command"
        }, this.gcodelist[i])));
      }
    ...
    _renderMoveTab() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "title"
      }, "Feedrate"), /*#__PURE__*/React.createElement(VerticalSlider, {
        id: 'feedrate',
        max: 7500,
        min: 500,
        step: 100,
        ...
        className: "row"
      }, this._renderButton("pull-left", () => {
        this._handleMoveButtonClick();
      }, '1', !connecting), this._renderButton("pull-left", () => {
        this._handleMoveButtonClick('up');
      }, '2', !connecting), this._renderButton("pull-left", () => {
        this._handleMoveButtonClick();
      }, '3', !connecting)), /*#__PURE__*/React.createElement("div", {
        className: "row"
      }, this._renderButton("pull-left", () => {
        this._handleMoveButtonClick('left');
      }, '4', !connecting), this._renderButton("pull-left", () => {
        this._handleMoveButtonClick('home');
      }, '5', !connecting), this._renderButton("pull-left", () => {
        this._handleMoveButtonClick('right');
      }, '6', !connecting)), /*#__PURE__*/React.createElement("div", {
        className: "row"
      }, this._renderButton("pull-left", () => {
        this._handleMoveButtonClick();
      }, '7', !connecting), this._renderButton("pull-left", () => {
        this._handleMoveButtonClick('down');
      }, '8', !connecting), this._renderButton("pull-left", () => {
        this._handleMoveButtonClick();
      }, '9', !connecting))), /*#__PURE__*/React.createElement("div", {
        className: "distance-container"
      }, /*#__PURE__*/React.createElement("div", {
        className: "title"
      }, "Distance"), /*#__PURE__*/React.createElement(VerticalSlider, {
        id: 'distance',
        max: 50,
        min: 1,
        step: 1,
    ...
    render() {
      if (this.state.show) {
        ...
        return /*#__PURE__*/React.createElement(Modal, {
          ...
          className: "task-interpreter-panel"
        }, /*#__PURE__*/React.createElement("div", {
        ...
        }), this._renderConnectButton()), /*#__PURE__*/React.createElement("div", {
          ...
          maxLength: "255",
          ref: "taskInput"
        }), this._renderButton('pull-right', () => this._openFile(), 'Open'), this._renderButton('pull-right', () => this._fromScene(), 'Scene')), /*#__PURE__*/React.createElement("div", {
          className: "main-content"
        }, leftPart, /*#__PURE__*/React.createElement("div", {
          ref: "rightPart",
          ...
          className: "footer"
        }, this._renderButton('pull-left', () => this._play(), 'Play'), this._renderButton('pull-left', () => this._nextStep(), 'Next Step'), this._renderButton('pull-left', () => this._pause(), 'Pause'), this._renderButton('pull-left', () => this._stop(), 'Stop'), this._renderButton('pull-right', () => this._close(), 'Close'))));
      } else {
        return null;
      }
    }
