...
define(['app/contexts/AlertCaller', 'app/constants/alert-constants', 'app/actions/beambox/constant', 'helpers/i18n'], function (Alert, AlertConstants, Constant, i18n) {
  ...
  class SvgNestButtons extends React.Component {
    constructor(props) {
      ...
      _defineProperty(this, "nestElements", (elements, containerElem, config) => {
        let containerPoints;
      ...
      _defineProperty(this, "stopNestElement", () => {
        SvgNest.stop();
      ...
      _defineProperty(this, "onStartOrStop", () => {
        const {
          isWorking
        } = this.state;
      ...
      _defineProperty(this, "renderStartButton", () => {
        ...
        return /*#__PURE__*/React.createElement("div", {
          className: "svg-nest-button active",
          onClick: () => {
            this.onStartOrStop();
          }
    ...
    render() {
      return /*#__PURE__*/React.createElement("div", {
        className: `svg-nest-buttons`
      }, this.renderStartButton(), /*#__PURE__*/React.createElement("div", {
        className: "svg-nest-button",
        onClick: () => this._close()
      }, /*#__PURE__*/React.createElement("div", {
        className: 'text'
      }, LANG._nest.end)));
