define(['jquery', 'app/actions/beambox/svgeditor-function-wrapper', 'helpers/i18n'], function ($, FnWrapper, i18n) {
  ...
  class FillPanel extends React.Component {
    constructor(props) {
      ...
      let {
        isAnyFilled,
        isAllFilled
      } = svgCanvas.calcElemFilledInfo(props.$me[0]);
      this.state = {
        isAnyFilled,
        isAllFilled,
        isFillable
    ...
    render() {
      ...
      return this.state.isFillable ? /*#__PURE__*/React.createElement("div", {
        ...
        className: "caption"
      }, LANG.fill, /*#__PURE__*/React.createElement("label", {
