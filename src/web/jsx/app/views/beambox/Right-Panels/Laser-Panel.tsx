...
define(['jquery', 'reactPropTypes', 'app/actions/beambox/beambox-preference', 'app/actions/beambox/svgeditor-function-wrapper', 'app/constants/right-panel-constants', 'app/stores/beambox-store', 'jsx!contexts/DialogCaller', 'jsx!widgets/Unit-Input-v2', 'jsx!widgets/Button-Group', 'jsx!widgets/Dropdown-Control', 'jsx!widgets/Modal', 'jsx!views/beambox/Right-Panels/Laser-Manage-Modal', 'helpers/local-storage', 'helpers/i18n', 'app/contexts/AlertCaller', 'app/constants/alert-constants', 'jsx!views/tutorials/Tutorial-Controller', 'jsx!constants/tutorial-constants', 'app/actions/beambox/constant', 'app/actions/beambox/diode-boundary-drawer'], function ($, PropTypes, BeamboxPreference, FnWrapper, RightPanelConstants, BeamboxStore, DialogCaller, UnitInput, ButtonGroup, DropdwonControl, Modal, LaserManageModal, LocalStorage, i18n, Alert, AlertConstants, TutorialController, TutorialConstants, Constant, DiodeBoundaryDrawer) {
  'use strict';
  ...
  const defaultLaserOptions = ['parameters', ...RightPanelConstants.laserPresetKeys];
  const functionalLaserOptions = ['save', 'export', 'more'];

  class LaserPanel extends React.Component {
    constructor(props) {
      super(props);

      _defineProperty(this, "initDefaultConfig", () => {
        ...
        if (!LocalStorage.get('defaultLaserConfigsInUse') || !LocalStorage.get('customizedLaserConfigs')) {
            ...
            if (customized[i].isDefault) {
              if (defaultLaserOptions.includes(customized[i].key)) {
                const {
                  ...
                  power,
                  repeat
                } = this._getDefaultParameters(customized[i].key);
          ...
          newPreset.forEach(preset => {
            const {
              ...
              power,
              repeat
            } = this._getDefaultParameters(preset);
      ...
      _defineProperty(this, "exportLaserConfigs", async () => {
      ...
      _defineProperty(this, "updatePresetLayerConfig", () => {
            ...
            if (config.isDefault) {
              if (defaultLaserOptions.includes(customized[i].key)) {
                const {
                  ...
                  power,
                  repeat
                } = this._getDefaultParameters(config.key);
      ...
      _defineProperty(this, "_handleSpeedChange", (val, unit) => {
        if (unit === 'inches') {
          val *= 25.4;
        }
      ...
      _defineProperty(this, "_handleStrengthChange", val => {
        this.setState({
          strength: val
        });
      ...
      _defineProperty(this, "_handleRepeatChange", val => {
        this.setState({
          repeat: val
        });
      ...
      _defineProperty(this, "_toggleEnableHeight", () => {
      ...
      _defineProperty(this, "_handleHeightChange", val => {
        this.setState({
          height: val
        });
        this.props.funcs.writeHeight(this.props.layerName, val);
      ...
      _defineProperty(this, "_handleZStepChange", val => {
        this.setState({
          zStep: val
        });
      ...
      _defineProperty(this, "_toggleDiode", () => {
      ...
      _defineProperty(this, "_handleSaveConfig", name => {
      ...
      _defineProperty(this, "_handleCancelModal", () => {
      ...
      _defineProperty(this, "_handleParameterTypeChanged", (id, value) => {
      ...
      _defineProperty(this, "_renderStrength", () => {
        const maxValue = 100;
        const minValue = 1;
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "title"
        }, LANG.strength), /*#__PURE__*/React.createElement(UnitInput, {
          min: minValue,
          max: maxValue,
          unit: "%",
          ...
          onChange: e => {
            this._handleStrengthChange(e.target.value);
          }
        })));
      });

      _defineProperty(this, "_renderSpeed", (hasVector, unit) => {
        const maxValue = 300;
        const minValue = 3;
        ...
        const valueDisplay = this.state.speed / {
          mm: 1,
          inches: 25.4
        }[unit];
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          getValue: val => {
            this._handleSpeedChange(val, unit);
          },
          ...
          onChange: e => {
            this._handleSpeedChange(e.target.value);
          }
        })));
      });
      ...
      _defineProperty(this, "_renderEnableHeight", () => {
        if (BeamboxPreference.read('enable-autofocus') && Constant.addonsSupportList.autoFocus.includes(BeamboxPreference.read('workarea'))) {
          return /*#__PURE__*/React.createElement("div", {
            ...
            onClick: () => {
              this._toggleEnableHeight();
            }
          }, /*#__PURE__*/React.createElement("span", {
            className: "title"
          }, LANG.focus_adjustment), /*#__PURE__*/React.createElement("input", {
            type: "checkbox",
            checked: this.state.height > 0,
            onChange: () => {}
          }));
        } else {
          return null;
      ...
      _defineProperty(this, "_renderHeight", () => {
        if (!BeamboxPreference.read('enable-autofocus') || !Constant.addonsSupportList.autoFocus.includes(BeamboxPreference.read('workarea')) || this.state.height < 0) {
          return null;
        }
      ...
      _defineProperty(this, "_renderZStep", () => {
        if (!BeamboxPreference.read('enable-autofocus') || this.state.repeat <= 1 || this.state.height < 0 || !Constant.addonsSupportList.autoFocus.includes(BeamboxPreference.read('workarea'))) {
          return null;
        }
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "title"
        }, LANG.z_step), /*#__PURE__*/React.createElement(UnitInput, {
          min: 0,
          max: 20,
          unit: 'mm',
      ...
      _defineProperty(this, "_renderDiode", () => {
        if (BeamboxPreference.read('enable-diode') && Constant.addonsSupportList.hybridLaser.includes(BeamboxPreference.read('workarea'))) {
          return /*#__PURE__*/React.createElement("div", {
            ...
            className: "title"
          }, LANG.diode), /*#__PURE__*/React.createElement("input", {
            type: "checkbox",
            checked: this.state.isDiode,
            onChange: () => {}
          }));
        } else {
          return null;
      ...
      _defineProperty(this, "_getDefaultParameters", para_name => {
        const model = BeamboxPreference.read('workarea') || BeamboxPreference.read('model');
      ...
      _defineProperty(this, "_renderMoreModal", () => {
        return /*#__PURE__*/React.createElement(LaserManageModal, {
      ...
      _defineProperty(this, "_renderModal", () => {
    ...
    render() {
      ...
      const dropdownOptions = customizedOptions ? [defaultOptions[0]].concat(customizedOptions).concat(functionalOptions) : defaultOptions.concat(functionalOptions);
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
        className: "layername"
      }, this.props.layerName), /*#__PURE__*/React.createElement("div", {
        className: "layerparams"
      }, /*#__PURE__*/React.createElement(DropdwonControl, {
        id: "laser-config-dropdown",
        default: defaultLaserOptions[0],
        onChange: this._handleParameterTypeChanged,
        options: dropdownOptions
      }), strengthPanel, speedPanel, repeatPanel, enableHeightPanel, heightPanel, zStepPanel, diodePanel, modalDialog));
    }
