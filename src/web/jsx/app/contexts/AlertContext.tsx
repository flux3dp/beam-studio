...
define(['helpers/i18n', 'app/constants/alert-constants'], function (i18n, AlertConstants) {
  ...
  class AlertContextProvider extends React.Component {
    constructor(props) {
      ...
      _defineProperty(this, "popAlertStack", () => {
        this.state.alertStack.pop();
        this.setState(this.state);
      });

      _defineProperty(this, "popAlertStackById", id => {
        this.state.alertStack = this.state.alertStack.filter(alert => {
          return alert.id !== id;
        });
        this.setState(this.state);
      });

      _defineProperty(this, "pushAlertToStack", alert => {
