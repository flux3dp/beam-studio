...
define(['jquery', 'reactPropTypes', 'jsx!views/cutter/Setup-Panel', 'jsx!pages/Holder', 'helpers/api/config', 'helpers/i18n'], function ($, PropTypes, HolderSetupPanel, HolderGenerator, ConfigHelper, i18n) {
