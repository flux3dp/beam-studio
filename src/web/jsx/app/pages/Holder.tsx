...
define(['jquery', 'reactClassset', 'reactPropTypes', 'app/actions/laser', 'app/actions/alert-actions', 'app/actions/delta/holder-global-interactions', 'app/actions/progress-actions', 'jsx!views/laser/Setup-Panel', 'jsx!views/holder/Setup-Panel', 'jsx!views/laser/Image-Panel', 'jsx!widgets/File-Uploader', 'jsx!widgets/Modal', 'jsx!views/Printer-Selector', 'jsx!widgets/Button-Group', 'helpers/api/config', 'helpers/i18n', 'helpers/dnd-handler'], function ($, ReactCx, PropTypes, laserEvents, AlertActions, HolderGlobalInteraction, ProgressActions, LaserSetupPanel, HolderSetupPanel, ImagePanel, FileUploader, Modal, PrinterSelector, ButtonGroup, ConfigHelper, i18n, DnDHandler) {
  'use strict';
  ...
  return function (args) {
    ...
    class Holder extends React.Component {
      constructor(props) {
        ...
        _defineProperty(this, "_handleStartClick", () => {
          this.setState({
        ...
        _defineProperty(this, "_handleShowOutlineClick", () => {
          this.setState({
            openPrinterSelectorWindow: true,
        ...
        _defineProperty(this, "_handleCalibrateClick", () => {
          this.setState({
            openPrinterSelectorWindow: true,
        ...
        _defineProperty(this, "_handleZProbeClick", () => {
          this.setState({
            openPrinterSelectorWindow: true,
        ...
        _defineProperty(this, "_handleExportClick", filemode => {
          this.state.laserEvents.exportTaskCode(this._fetchFormalSettings(), filemode);
        });

        _defineProperty(this, "_handleDragAndDrop", e => {
          e.preventDefault();
        ...
        _defineProperty(this, "_onLoadCalibrationImage", e => {
          this.state.laserEvents.uploadDefaultLaserImage();
          this.setState({
            debug: 1
          }); // Debug flag will be reset at laser.js/deleteImage
        });
        ...
        _defineProperty(this, "_inactiveSelectImage", e => {
          if (e.target === e.currentTarget) {
            this.state.laserEvents.inactiveAllImage();
          }
        });

        _defineProperty(this, "_renderStageSection", () => {
          var self = this,
              image_panel_class = ReactCx.cx({
            'panel object-position': true
          }),
              imagePanel = this.state.selectedImage ? /*#__PURE__*/React.createElement(ImagePanel, {
            lang: lang,
          ...
          return /*#__PURE__*/React.createElement("div", {
            ref: "laserStage",
            className: "laser-stage"
          }, /*#__PURE__*/React.createElement("section", {
            ref: "operationTable",
            "data-close-image-panel": "true",
            className: "operation-table",
            onClick: closeSubPopup
          }, /*#__PURE__*/React.createElement("div", {
            ref: "laserObject",
            "data-close-image-panel": "true",
            className: "laser-object border-circle",
            onClick: closeSubPopup
          }), imagePanel), paramPanel);
        });

        _defineProperty(this, "_renderPrinterSelectorWindow", () => {
          if (!this.state.openPrinterSelectorWindow) {
            return '';
          }
        ...
        _defineProperty(this, "_renderFileUploader", () => {
          var self = this,
            ...
            AlertActions.showPopupError('laser-upload-error', msg);
              ...
              typeErrorMessage = 'laser' === self.props.page ? lang.laser.laser_accepted_images : lang.laser.draw_accepted_images;

          return /*#__PURE__*/React.createElement("div", {
            className: uploadStyle
          }, /*#__PURE__*/React.createElement("label", {
            htmlFor: "file-uploader"
          }, lang.laser.import), /*#__PURE__*/React.createElement(FileUploader, {
            ref: "fileUploader",
            accept: accept,
        ...
        _defineProperty(this, "_renderActionButtons", () => {
      ...
      componentDidMount() {
        ...
        if (laser_custom_bg) {
          $('.laser-object').css({
            background: 'url(' + laser_custom_bg + ')',
      ...
      render() {
        ...
        return /*#__PURE__*/React.createElement("div", {
          className: "studio-container laser-studio"
        }, printerSelector, /*#__PURE__*/React.createElement("div", {
          className: "stage"
        }, stageSection, actionButtons), uploader);
      }
