define(['jquery', 'reactClassset', 'jsx!widgets/List', 'jsx!widgets/Modal', 'app/actions/scanned-model', 'helpers/api/3d-scan-control', 'helpers/api/3d-scan-modeling', 'jsx!views/scan/Setup-Panel', 'jsx!views/scan/Manipulation-Panel', 'jsx!views/Printer-Selector', 'jsx!views/scan/Export', 'jsx!views/scan/Progress-Bar', 'jsx!views/scan/Action-Buttons', 'jsx!widgets/File-Uploader', 'app/actions/alert-actions', 'app/stores/alert-store', 'app/actions/progress-actions', 'app/stores/progress-store', 'app/constants/progress-constants', 'helpers/shortcuts', 'helpers/round', 'helpers/dnd-handler', 'helpers/point-cloud', 'Rx', 'helpers/duration-formatter', 'helpers/firmware-version-checker', 'helpers/shortcuts', // non-return
'helpers/array-findindex', 'helpers/object-assign', 'plugins/file-saver/file-saver.min'], function ($, ReactCx, List, Modal, ScannedModel, ScanControl, ScanModeling, SetupPanel, ManipulationPanel, PrinterSelector, Export, ProgressBar, ActionButtons, FileUploader, AlertActions, AlertStore, ProgressActions, ProgressStore, ProgressConstants, shortcuts, round, dndHandler, PointCloudHelper, Rx, FormatDuration, FirmwareVersionChecker, Shortcuts) {
    ...
    var View = React.createClass({
      ...
      _undo: function () {
        var self = this,
          ...
          add: function (mesh) {
            ...
            currentMesh.isUndo = true; // ask for delete

            if (0 === revertTimes) {
              self._onDeletingMesh(currentMesh, mesh.arrayIndex);
            } else {
              self._onDeleteMesh(mesh.arrayIndex, currentMesh); // delete associted mesh
          ...
          update: function (mesh) {
            ...
            fileReader.onload = function () {
              ...
              self._onDeleteMesh(mesh.arrayIndex, currentMesh); // add old


              typedArray = new Float32Array(this.result); // update point cloud
      ...
      _doCropOff: function (mesh) {
            ...
            args = [// min z
        {
          mode: 'z',
          direction: 'True',
          value: cylider_box.min.z
        }, // max z
        {
          mode: 'z',
          direction: 'False',
          value: cylider_box.max.z
        }, // radius
        {
          mode: 'r',
          direction: 'False',
          value: Math.min(cylider_box.max.y, cylider_box.max.x)
        }];
      ...
      _onScanCancel: function (e) {
        ...
        self.state.scanCtrlWebSocket.stopScan(); // TODO: restore to the status before scan
      ...
      _onCalibrateFail: function (message, Popup) {
        ...
        Popup('calibrate', /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("img", {
          className: "calibrate-image",
          src: imageSrc
        }), /*#__PURE__*/React.createElement("p", null, failMessage.message)), failMessage.caption);
      },
      _onCalibrate: function () {
        ...
        FirmwareVersionChecker.check(self.state.selectedPrinter, 'SCAN_CALIBRATION').then(allowCalibration => {
          if (allowCalibration) {
            next();
          } else {
      ...
      _renderSettingPanel: function () {
        ...
        return /*#__PURE__*/React.createElement(SetupPanel, {
          className: className,
          ref: "setupPanel",
          lang: lang,
          onCalibrate: this._onCalibrate
        });
      },
      _renderManipulationPanel: function (lang) {
        ...
        return 0 < state.selectedMeshes.length && false === state.isScanStarted && false === state.openBlocker && false === state.showCamera ? /*#__PURE__*/React.createElement(ManipulationPanel, {
          lang: lang,
      ...
      _renderStageSection: function (lang) {
        ...
        return /*#__PURE__*/React.createElement("section", {
          ref: "operatingSection",
          className: "operating-section"
        }, meshThumbnails, /*#__PURE__*/React.createElement("div", {
          id: "model-displayer",
          className: "model-displayer"
        }, /*#__PURE__*/React.createElement("img", {
          src: cameraImage,
          className: camera_image_class,
          onClick: closeSubPopup
        })), settingPanel, manipulationPanel);
      },
      _renderActionButtons: function (lang) {
        ...
        return true === this.state.gettingStarted && true === this.state.printerIsReady ? /*#__PURE__*/React.createElement(ActionButtons, {
          mode: mode,
          className: className,
          lang: lang,
      ...
      _renderProgressBar: function (lang) {
        return true === this.state.openProgressBar ? /*#__PURE__*/React.createElement(ProgressBar, {
          lang: lang,
      ...
      _renderPrinterSelectorWindow: function (lang) {
        var self = this,
          ...
          history.go(-1);
            ...
            content = /*#__PURE__*/React.createElement(PrinterSelector, {
          uniqleId: "scan",
        ...
        return false === self.state.gettingStarted ? /*#__PURE__*/React.createElement(Modal, {
          content: content,
          className: className,
        ...
        thumbnails = meshes.map(function (mesh, i) {
          ...
          return {
            label: /*#__PURE__*/React.createElement("div", {
              ...
              className: "mesh-thumbnail-no",
              "data-index": mesh.index,
              onClick: onChooseMesh
            }, mesh.index), /*#__PURE__*/React.createElement("div", {
              className: "mesh-thumbnail-close fa fa-times",
              onClick: self._onDeletingMesh.bind(self, mesh, i)
            }))
          };
        });
        return 0 < meshes.length && false === self.state.hasConvert ? /*#__PURE__*/React.createElement(List, {
      ...
      render: function () {
        ...
        }), selectPrinter, scanStage, actionButtons, progressBar, alert);
      }
    });
    return View;
  };
