...
define(['jsx!widgets/Modal', 'jsx!widgets/Button-Group', 'app/actions/initialize-machine', 'app/actions/alert-actions', 'app/actions/beambox/beambox-preference', 'helpers/sprintf', 'helpers/i18n'], function (Modal, ButtonGroup, initializeMachine, AlertActions, BeamboxPreference, sprintf, i18n) {
  ...
  return function () {
    class ConnectBeambox extends React.Component {
      constructor(...args) {
        ...
        _defineProperty(this, "onOpenTutorialLink", () => {
        ...
        _defineProperty(this, "_renderSelectMachineStep", () => {
          ...
          }, sprintf(LANG.set_connection, "Beambox")), /*#__PURE__*/React.createElement("div", null, sprintf(LANG.please_goto_touchpad, "Beambox")), /*#__PURE__*/React.createElement("div", {
            className: "tutorial"
          }, LANG.tutorial, /*#__PURE__*/React.createElement("input", {
            type: "text",
            id: "machine_ip_init",
            placeholder: "x.x.x.x"
