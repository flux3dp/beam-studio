define(['jsx!views/beambox/Tool-Panels/Tool-Panels', 'app/actions/beambox/svgeditor-function-wrapper', 'app/actions/beambox/constant', 'app/actions/beambox/beambox-global-interaction'], function (ToolPanels, FnWrapper, Constant, BeamboxGlobalInteraction) {
  ...
  class ToolPanelsController {
    ...
    _render() {
      ReactDOM.render( /*#__PURE__*/React.createElement(ToolPanels, {
