describe('align tools', () => {
  ...
  it('top align', () => {
    ...
    cy.get('#selectorGrip_resize_s')
      .first()
      .should(($grip) => {
        expect($grip.attr('cx')).to.be.closeTo(150, 2);
      });
    cy.get('#selectorGrip_resize_s')
      .first()
      .should(($grip) => {
        expect($grip.attr('cy')).to.be.closeTo(100, 2);
      });
  });
  ...
  it('middle align', () => {
    ...
    cy.get('#selectorGrip_resize_se')
      .first()
      .should(($grip) => {
        expect($grip.attr('cx')).to.be.closeTo(250, 2);
      });
    cy.get('#selectorGrip_resize_se')
      .first()
      .should(($grip) => {
        expect($grip.attr('cy')).to.be.closeTo(175, 2);
      });
  });

  it('bottom align', () => {
    cy.get('#bottom_align').click();
    cy.get('#selectorGrip_resize_n')
      .first()
      .should(($grip) => {
        expect($grip.attr('cx')).to.be.closeTo(150, 2);
      });
  ...
  it('left align', () => {
    ...
    cy.get('#selectorGrip_resize_e')
      .first()
      .should(($grip) => {
        expect($grip.attr('cy')).to.be.closeTo(150, 2);
      });
  });
  ...
  it('center align', () => {
    ...
    cy.get('#selectorGrip_resize_sw')
      .first()
      .should(($grip) => {
        expect($grip.attr('cx')).to.be.closeTo(125, 2);
      });
    cy.get('#selectorGrip_resize_sw')
      .first()
      .should(($grip) => {
        expect($grip.attr('cy')).to.be.closeTo(250, 2);
      });
  });

  it('right align', () => {
    cy.get('#right_align').click();
    cy.get('#selectorGrip_resize_w')
      .first()
      .should(($grip) => {
        expect($grip.attr('cx')).to.be.closeTo(200, 2);
      });
    cy.get('#selectorGrip_resize_w')
      .first()
      .should(($grip) => {
  ...
  it('hdist of distribute', () => {
    ...
    cy.get('#selectorGrip_resize_se')
      .first()
      .should(($grip) => {
        expect($grip.attr('cx')).to.be.closeTo(175, 2);
      });
    cy.get('#selectorGrip_resize_se')
      .first()
      .should(($grip) => {
  ...
  it('vdist of distribute', () => {
    ...
    cy.get('#selectorGrip_resize_nw')
      .first()
      .should(($grip) => {
        expect($grip.attr('cy')).to.be.closeTo(125, 2);
      });
  });
});
