...
(function () {
  ...
  var svgWhiteList_ = {
    ...
    "text": ['data-ratiofixed', 'data-np', 'data-textpath', 'data-origx', 'data-origy', "class", "clip-path", "clip-rule", "fill", "fill-opacity", "fill-rule", "filter", "font-family", "font-size", "font-style", "font-weight", "id", "mask", "opacity", "requiredFeatures", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "style", "systemLanguage", "text-anchor", "transform", "x", "xml:space", "y", "letter-spacing", "data-verti", "data-line-spacing", "data-original-layer", 'font-postscript'],
    "textPath": ['alignment-baseline', "class", 'dominant-baseline', 'href', "id", "method", "requiredFeatures", "spacing", "startOffset", "style", "systemLanguage", "transform", 'vector-effect'],
    "title": [],
    "tspan": ["data-original-layer", "class", "clip-path", "clip-rule", "dx", "dy", "fill", "fill-opacity", "fill-rule", "filter", "font-family", "font-size", "font-style", "font-weight", "id", "mask", "opacity", "requiredFeatures", "rotate", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "style", "systemLanguage", "text-anchor", "textLength", "transform", 'vector-effect', "x", "xml:space", "y"],
    "use": [
      'data-ratiofixed',
      'data-xform',
      'data-original-layer',
