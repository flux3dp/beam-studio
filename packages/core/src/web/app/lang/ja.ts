...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    position_ref: '位置',
    position_ref_bottom_center: '下',
    position_ref_left_center: '左',
    position_ref_right_center: '右',
    position_ref_top_center: '上',
