...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: 'カメラのキャリブレーション用に、以下のファイルをA4用紙にダウンロードして印刷してください。',
    put_chessboard_bm2_2: '作業台の指定位置にキャリブレーション用紙を平らに置いてください。',
    ...
    put_paper: '紙を置く',
    put_paper_bm2_1: '作業エリアに清潔なA4またはレターサイズの白い用紙を2枚並べて置き、平らにします。',
