    ...
    right_panel: {
      ...
      object_panel: {
        ...
        option_panel: {
          ...
          fill: 'インフィル',
          fill_engraving_mode: '塗りつぶし彫刻モード',
          font_family: 'フォント',
          font_size: 'サイズ',
          font_style: 'スタイル',
          layer_count: 'レイヤー数',
          ...
          text_transform: '大文字小文字',
          text_transform_fullwidth: '全角',
          text_transform_halfwidth: '半角',
          text_transform_lowercase: '小文字',
          text_transform_none: '元のまま',
          text_transform_sentence: '文頭を大文字',
          text_transform_title: '単語の頭文字を大文字',
          text_transform_toggle: '大文字小文字を反転',
          text_transform_uppercase: '大文字',
          threshold: 'しきい値',
