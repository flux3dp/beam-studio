...
const lang: ILang = {
  ...
  beambox: {
    ...
    material_browser: {
      add_from_layer: {
        attach_to: '素材に追加',
        bucket_hint: '「マイ素材」コレクション（その他）に保存されました。あとで別の素材へ移動できます。',
        create_new: '新しい素材を作成…',
        new_material_name: '新しい素材名',
        preset_name: 'パラメータ名',
        settings_from_layer: '現在のレイヤーからコピーした設定',
        title: '現在のレイヤー設定をパラメータとして保存',
      },
      add_material: '素材を追加',
      add_preset: 'パラメータを追加',
      apply: '適用',
      ...
      editor: {
        appearance: '外観',
        appearance_hint: '写真がない場合は、代わりにカバーカラーを選択してください。',
        category: 'カテゴリー',
        ...
        title_add: '素材を追加',
        title_edit: '素材を編集',
        upload_hint: '写真をクリックまたはドラッグしてください。ギャラリーに大きなプレビューが表示されます。',
      },
      enable: '有効',
      export: 'エクスポート',
      favorites: 'お気に入り',
      from_current_layer: '現在のレイヤーから',
      import: 'インポート',
      machine: '機種',
      manual: '手動',
      manual_settings: '手動設定',
      modified: 'パラメータ適用後に変更されています',
      move_to_material: '素材に移動…',
      new_preset_manual: '新しいパラメータ…',
      no_materials_in_category: '%s に対応する素材はまだありません。',
      no_presets_for_machine: '%s 用の設定はまだありません。',
      no_search_match: '「%s」に一致する素材が見つかりません。',
      preset_editor: {
        name: 'パラメータ名',
        name_required: '名前を入力してください',
        title_edit: 'パラメータを編集',
      ...
      presets: 'パラメータ',
      recents: '最近使用',
      recents_empty: '最近適用した素材がここに表示されます。',
      regions: {
        auto: '自動',
        eu: 'ヨーロッパ',
        global: 'グローバル',
      ...
      restore_default: 'FLUX デフォルトに戻す',
      result: '検索結果',
      search_placeholder: '素材、タグ、カテゴリーを検索…',
      settings_region: '素材カタログの地域',
      settings_use: '素材ブラウザーを使用',
      showing_bundled: '内蔵カタログを表示中',
      state_customized: 'カスタマイズ済み',
      state_default: 'デフォルト',
      state_disabled: '無効',
      state_user: 'ユーザー定義',
      storage_full: 'ストレージの空き容量が不足しているため、素材ライブラリを保存できませんでした。写真の代わりにカラーカバーをご利用ください。',
      sure_to_delete_material: 'この素材とすべてのパラメータを削除しますか？',
      sure_to_delete_preset: 'このパラメータを削除しますか？',
      sure_to_delete_variant: 'この厚さとそのプリセットを削除しますか？',
      sure_to_import: 'インポートすると、ファイルが素材ライブラリに統合されます。続行しますか？',
      thickness: '厚さ',
      title: '素材ブラウザー',
      variant_exists: 'この厚さのバリエーションは既に存在します。',
      variants: '%d 種類',
    },
    ...
    popup: {
      ...
      disassemble_use: {
        ...
        variable_text_warning: '可変テキストのオブジェクトはスキップされました。分解する前に可変テキストをオフにしてください。',
      },
    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          disabled_by_noun_project: 'この図形は知的財産法によって保護されているため、パスを編集できません。',
  ...
  print_and_cut: {
    ...
    calibration: {
      align_desc: '1. 印刷した校正シートを作業エリアに置き、ずれないようテープやマスキングテープで固定してから、フォーカスを合わせます。\n2. 「プレビューと位置合わせ」をクリックしてカメラ位置合わせを実行します。\n3. マークが検出されたら「目盛りを刻む」をクリックし、低出力でシートに基準線を刻みます。',
      aligned: '位置合わせマークを検出しました。刻印できます。',
      auto_read: 'カメラで目盛りを読み取る',
      auto_read_failed: '目盛りを自動で読み取れませんでした。目視で読み取って値を入力してください。',
      auto_read_hint: 'カメラの読み取り値には ±2 目盛りの誤差がある場合があります。校正シートで確認してください。',
      current_offset: '現在のオフセット：X %s mm、Y %s mm',
      export_pdf: '校正用 PDF を書き出す',
      power: '出力',
      print_desc: '1. 校正シートの PDF を書き出します。シートには 4 つの位置合わせマークと 2 つの目盛りが含まれます。\n2. シートを 100%（実寸）で印刷します。',
      reading_desc: '1. 最も長い刻印線（中央の線）を見つけ、印刷された 0 の線のどちら側にあるかを確認します。\n2. その方向へ 1 本ずつたどり、刻印線と印刷線がぴったり一致する位置を探します。\n3. 0 からその印刷線まで数えます（数字は 5 本ごとに印刷されています。その間の数字のない線も数えてください）。',
      reading_x: 'X の読み',
      reading_y: 'Y の読み',
      scratch: '目盛りを刻む',
      speed: '速度',
