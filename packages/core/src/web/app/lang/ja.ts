...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: '位置：左上の彫刻点に合わせてください。',
    align_4_1: '位置：右上の彫刻点に合わせてください。',
    align_4_2: '位置：左下の彫刻点に合わせてください。',
    align_4_3: '位置：右下の彫刻点に合わせてください。',
    align_8_0: '位置: 外側の左上の彫刻ポイントに合わせてください。',
    align_8_1: '位置: 外側の右上の彫刻ポイントに合わせてください。',
    align_8_2: '位置: 外側の左下の彫刻ポイントに合わせてください。',
    align_8_3: '位置: 外側の右下の彫刻ポイントに合わせてください。',
    align_8_4: '位置: 内側の左上の彫刻ポイントに合わせてください。',
    align_8_5: '位置: 内側の右上の彫刻ポイントに合わせてください。',
    align_8_6: '位置: 内側の左下の彫刻ポイントに合わせてください。',
    align_8_7: '位置: 内側の右下の彫刻ポイントに合わせてください。',
    ...
    charuco_open_the_machine_lid: 'マシンの蓋を開けてください。',
    charuco_place_charuco: '印刷したキャリブレーションパターンを作業領域の<b>%s</b>に水平に配置してください。',
    ...
    check_pnp_desc: 'キャリブレーション結果に基づいて画像を再取得し、彫刻の基準点をマークしました。\n赤いマーカーが実際の彫刻位置と一致しているか確認してください。\n明らかにずれている場合は、「再調整」をクリックしてやり直してください。',
    ...
    solve_pnp_keep_door_closed: '以下の処理中はドアを閉めてください。ドアが開くと、システムがカメラの再配置を試みます。',
    solve_pnp_move_platform: '機械が自動的に下に移動し、別の写真を撮影します。このプロセス中はキャリブレーション用紙を動かさないでください。',
    solve_pnp_open_the_lid: '写真を撮るために蓋を開けてください。',
    solve_pnp_relocate_camera: 'レーザーヘッドがまだ水平方向に中央にない場合は「カメラを再配置」をクリックしてください。',
  ...
  settings: {
    ...
    module_offset_uv_varnish: 'ニスオフセット',
    module_offset_uv_white_ink: '白インクオフセット',
    none: 'なし',
    normal: '普通',
    notification_off: 'オフ',
    notification_on: 'オン',
