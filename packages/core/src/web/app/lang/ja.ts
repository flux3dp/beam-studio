    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          diabled_by_gradient: 'この機能を使用する前に、シェーディングを無効にしてください。',
          diabled_by_infilled: 'この機能を使用する前に、インフィルを閉じてください。',
          diabled_by_infilled_and_variable_text: 'この機能を使用する前に、インフィルと可変テキストを閉じてください。',
          diabled_by_variable_text: 'この機能を使用する前に、可変テキストを閉じてください。',
