...
const lang: ILang = {
  ...
  settings: {
    ...
    curve_engraving_speed_limit: 'จำกัดความเร็วของ 3D Curve',
  ...
  z_speed_limit_test: {
    alert_before: 'ก่อนเริ่มการแกะสลัก 3D ระบบจะทำการทดสอบโหลดเพื่อป้องกันการสูญเสียสเต็ปเนื่องจากน้ำหนักเกิน',
