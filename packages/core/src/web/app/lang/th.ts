...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    hole: 'รู',
    hole_diameter: 'เส้นผ่านศูนย์กลาง',
    hole_offset: 'ออฟเซ็ต',
    hole_position: 'ตำแหน่ง',
    hole_thickness: 'ความหนา',
    hole_type: 'ประเภท',
    hole_type_punch: 'รูเจาะ',
    hole_type_ring: 'ห่วง',
    ...
    position_ref: 'ตำแหน่ง',
    position_ref_bottom_center: 'ล่าง',
    position_ref_left_center: 'ซ้าย',
    position_ref_right_center: 'ขวา',
    position_ref_top_center: 'บน',
    ...
    types: {
      hotel_key_chain: 'พวงกุญแจโรงแรม',
