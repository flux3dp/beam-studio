...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'ขนาดผลลัพธ์ (%s) เกินค่าสูงสุดที่แนะนำ %d × %d px การประมวลผลอาจใช้เวลาหลายนาที และผลลัพธ์อาจทำให้ Beam Studio ทำงานช้าลง ต้องการดำเนินการต่อหรือไม่',
