...
const lang: ILang = {
  ...
  message: {
    ...
    detecting_objects: 'กำลังตรวจจับวัตถุในภาพตัวอย่าง…',
    device_blocked: {
    ...
    object_detection_failed: 'การตรวจจับวัตถุล้มเหลว ไม่สามารถสแนปเข้ากับวัตถุในภาพตัวอย่างนี้ได้',
    objects_detected: 'ตรวจจับวัตถุแล้ว',
  ...
  settings: {
    ...
    ai_contour_detection_tooltip: 'ใช้โมเดล AI ค้นหาวัตถุในภาพตัวอย่างจากกล้อง แม่นยำกว่าบนวัสดุที่มีลวดลาย แต่ช้ากว่าบนคอมพิวเตอร์รุ่นเก่า ปิดเพื่อใช้การตรวจจับแบบดั้งเดิม ใช้กับ: ปรับให้พอดีอัตโนมัติ, สแนปไปที่จุดกึ่งกลางวัตถุ',
  ...
  topbar: {
    ...
    menu: {
      ...
      snap_to_object_center: 'สแนปไปที่จุดกึ่งกลางวัตถุ',
