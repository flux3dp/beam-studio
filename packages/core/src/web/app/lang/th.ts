...
const lang: ILang = {
  ...
  maintenance: {
    actions: {
      fail: 'ไม่ผ่าน',
      history: 'ประวัติ',
      mark_checked: 'บันทึกว่าตรวจแล้ว',
      mark_done: 'บันทึกว่าทำแล้ว',
    ...
    feedback: {
      all_essential: 'การบำรุงรักษาที่จำเป็นทั้งหมดเป็นปัจจุบันแล้ว — %s ของคุณอยู่ในสภาพเยี่ยม!',
      checked: 'ตรวจ %s แล้ว',
    ...
    tasks: {
      ...
      lube: {
        keyPoints: 'ทำความสะอาดแกนนำ รางเลื่อน และกลไกปรับโฟกัส แล้วหล่อลื่นใหม่',
        name: 'การหล่อลื่น',
      },
      maintain_test: {
