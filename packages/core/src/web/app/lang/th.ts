...
const lang: ILang = {
  ...
  message: {
    ...
    camera: {
      ...
      calibration_data_missing: 'ไม่สามารถรับข้อมูลการสอบเทียบกล้องได้',
      calibration_data_missing_message: 'ไม่สามารถรับข้อมูลการสอบเทียบกล้องได้ หากคุณส่งออกข้อมูลการสอบเทียบกล้องแล้ว กรุณานำเข้าข้อมูลไปยังอุปกรณ์ มิฉะนั้น กรุณาทำการสอบเทียบกล้อง (ขั้นสูง) เพื่อสอบเทียบกล้องใหม่',
