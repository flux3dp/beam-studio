...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'ตำแหน่ง: จัดแนวกับจุดที่แกะสลักด้านบนซ้าย',
    align_4_1: 'ตำแหน่ง: จัดแนวกับจุดที่แกะสลักด้านบนขวา',
    align_4_2: 'ตำแหน่ง: จัดแนวกับจุดที่แกะสลักด้านล่างซ้าย',
    align_4_3: 'ตำแหน่ง: จัดแนวกับจุดที่แกะสลักด้านล่างขวา',
    align_8_0: 'ตำแหน่ง: จัดตำแหน่งกับจุดแกะสลักด้านนอกบนซ้าย',
    align_8_1: 'ตำแหน่ง: จัดตำแหน่งกับจุดแกะสลักด้านนอกบนขวา',
    align_8_2: 'ตำแหน่ง: จัดตำแหน่งกับจุดแกะสลักด้านนอกล่างซ้าย',
    align_8_3: 'ตำแหน่ง: จัดตำแหน่งกับจุดแกะสลักด้านนอกล่างขวา',
    align_8_4: 'ตำแหน่ง: จัดตำแหน่งกับจุดแกะสลักด้านในบนซ้าย',
    align_8_5: 'ตำแหน่ง: จัดตำแหน่งกับจุดแกะสลักด้านในบนขวา',
    align_8_6: 'ตำแหน่ง: จัดตำแหน่งกับจุดแกะสลักด้านในล่างซ้าย',
    align_8_7: 'ตำแหน่ง: จัดตำแหน่งกับจุดแกะสลักด้านในล่างขวา',
    ...
    charuco_open_the_machine_lid: 'เปิดฝาครอบเครื่อง',
    charuco_place_charuco: 'วางรูปแบบการปรับเทียบที่พิมพ์แล้วในแนวนอนที่<b>%s</b>ของพื้นที่ทำงาน',
    ...
    check_pnp_desc: 'เราได้ถ่ายภาพใหม่ตามผลการปรับเทียบ และทำเครื่องหมายจุดอ้างอิงสำหรับการแกะสลักไว้แล้ว\nกรุณาตรวจสอบว่าตำแหน่งที่ทำเครื่องหมายด้วยสีแดงตรงกับจุดแกะสลักจริงหรือไม่\nหากมีความคลาดเคลื่อนชัดเจน ให้คลิก "ปรับเทียบใหม่" เพื่อทำซ้ำอีกครั้ง',
    ...
    solve_pnp_keep_door_closed: 'กรุณาปิดฝาระหว่างกระบวนการต่อไป หากฝาเปิด ระบบจะพยายามระบุตำแหน่งกล้องใหม่อีกครั้ง',
    ...
    solve_pnp_relocate_camera: 'คลิก "ย้ายตำแหน่งกล้อง" หากหัวเลเซอร์ยังไม่อยู่กึ่งกลางในแนวนอน',
