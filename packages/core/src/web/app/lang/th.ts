...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'การใช้ความเร็วที่สูงเกินไปกับเลเยอร์ที่มีวัตถุเส้นโค้ง 3D อาจลดความแม่นยำในการแกะสลักได้\nขอแนะนำให้รักษาความเร็วต่ำกว่า %(limit)s เพื่อผลลัพธ์ที่ดีที่สุดสำหรับวัตถุเส้นโค้ง 3D',
      too_fast_for_curve_and_constrain: 'เลเยอร์ต่อไปนี้: %(layers)s เกินขีดจำกัดความเร็ว %(limit)s\nความเร็วในการแกะสลักสำหรับวัตถุเส้นโค้ง 3D จะถูกจำกัดที่ %(limit)s คุณสามารถลบขีดจำกัดนี้ได้ในการตั้งค่าค่ากำหนด',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'ความเร็วในการแกะสลักของวัตถุ 3D แบบโค้งจะถูกจำกัดไว้ที่ %(limit)s คุณสามารถยกเลิกข้อจำกัดนี้ได้ที่การตั้งค่าความชอบ',
  ...
  framing: {
    ...
    rotation_frame_warning: 'การแสดงตัวอย่างกรอบจะหมุนหนึ่งรอบ โปรดหลีกเลี่ยงการหยุดกลางคันเพื่อป้องกันการเยื้องตำแหน่งการทำเครื่องหมาย หากต้องการดูตัวอย่างอีกครั้ง โปรดรอให้การหมุนเสร็จสิ้นก่อนคลิกอีกครั้ง',
