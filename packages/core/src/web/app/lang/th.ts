...
const lang: ILang = {
  ...
  layer_module: {
    ...
    notification: {
      ...
      importedDocumentContainsPrinting4C: 'เอกสารมีชั้นการพิมพ์ (4C) คุณต้องการเปลี่ยนพื้นที่ทำงานเป็น beamo II หรือไม่',
  ...
  settings: {
    ...
    module_offset_4c: 'การชดเชยการพิมพ์ (4C)',
    ...
    module_offset_uv_varnish: 'การชดเชยวานิช',
    module_offset_uv_white_ink: 'การชดเชึกหมึกขาว',
    none: 'ไม่มี',
    normal: 'สูง',
