...
const lang: ILang = {
  ...
  beambox: {
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'แนบไปยังวัสดุ',
        bucket_hint: 'บันทึกไว้ในคอลเลกชัน “วัสดุของฉัน” (อื่น ๆ) แล้ว คุณสามารถย้ายไปยังวัสดุอื่นได้ภายหลัง',
        create_new: 'สร้างวัสดุใหม่…',
        new_material_name: 'ชื่อวัสดุใหม่',
        preset_name: 'ชื่อพรีเซ็ต',
        settings_from_layer: 'การตั้งค่าที่คัดลอกจากเลเยอร์ปัจจุบัน',
        title: 'บันทึกการตั้งค่าเลเยอร์ปัจจุบันเป็นพรีเซ็ต',
      },
      add_material: 'เพิ่มวัสดุ',
      add_preset: 'เพิ่มพรีเซ็ต',
      apply: 'ใช้งาน',
      back_to_catalog: 'กลับไปยังแคตตาล็อก',
      buy_on_shop: 'ซื้อที่ร้านค้า',
      catalog: {
        materials: {
          acrylic: 'อะคริลิกใส',
      ...
      editor: {
        ...
        appearance_hint: 'ไม่มีรูปภาพใช่ไหม? เลือกสีปกแทนได้',
        category: 'หมวดหมู่',
        ...
        photo: 'รูปภาพ',
        tags: 'แท็ก',
        title_add: 'เพิ่มวัสดุ',
        title_edit: 'แก้ไขวัสดุ',
        upload_hint: 'คลิกหรือลากรูปภาพ ภาพตัวอย่างขนาดใหญ่จะแสดงในแกลเลอรี',
      },
      enable: 'เปิดใช้งาน',
      export: 'ส่งออก',
      favorites: 'รายการโปรด',
      from_current_layer: 'จากเลเยอร์ปัจจุบัน',
      import: 'นำเข้า',
      machine: 'เครื่อง',
      manual: 'กำหนดเอง',
      manual_settings: 'การตั้งค่าแบบกำหนดเอง',
      modified: 'มีการแก้ไขพารามิเตอร์หลังจากใช้พรีเซ็ต',
      move_to_material: 'ย้ายไปยังวัสดุ…',
      new_preset_manual: 'พรีเซ็ตใหม่…',
      no_materials_in_category: 'ยังไม่มีวัสดุสำหรับ %s ที่นี่',
      no_presets_for_machine: 'ยังไม่มีการตั้งค่าสำหรับ %s',
      no_search_match: 'ไม่พบวัสดุที่ตรงกับ “%s”',
      preset_editor: {
        name: 'ชื่อพรีเซ็ต',
        name_required: 'กรุณากรอกชื่อ',
        title_edit: 'แก้ไขพรีเซ็ต',
        title_new: 'พรีเซ็ตใหม่',
      },
      presets: 'พรีเซ็ต',
      recents: 'ใช้ล่าสุด',
      recents_empty: 'วัสดุที่ใช้ล่าสุดจะแสดงที่นี่',
      regions: {
        auto: 'อัตโนมัติ',
        eu: 'ยุโรป',
        global: 'ทั่วโลก',
      ...
      restore_default: 'คืนค่าเริ่มต้นของ FLUX',
      result: 'ผลลัพธ์',
      search_placeholder: 'ค้นหาวัสดุ แท็ก หมวดหมู่…',
      settings_region: 'ภูมิภาคของแคตตาล็อกวัสดุ',
      settings_use: 'ใช้เบราว์เซอร์วัสดุ',
      showing_bundled: 'กำลังแสดงแคตตาล็อกในตัว',
      state_customized: 'ปรับแต่งแล้ว',
      state_default: 'ค่าเริ่มต้น',
      state_disabled: 'ปิดใช้งานแล้ว',
      state_user: 'กำหนดโดยผู้ใช้',
      storage_full: 'พื้นที่จัดเก็บเต็ม จึงไม่สามารถบันทึกคลังวัสดุได้ ลองใช้ปกสีแทนรูปภาพ',
      sure_to_delete_material: 'ลบวัสดุนี้พร้อมพรีเซ็ตทั้งหมดหรือไม่?',
      sure_to_delete_preset: 'ลบพรีเซ็ตนี้หรือไม่?',
      sure_to_delete_variant: 'ลบความหนานี้และค่าที่ตั้งไว้ล่วงหน้าหรือไม่?',
      sure_to_import: 'การนำเข้าจะรวมไฟล์เข้ากับคลังวัสดุของคุณ ดำเนินการต่อหรือไม่?',
      thickness: 'ความหนา',
      title: 'เบราว์เซอร์วัสดุ',
      variant_exists: 'มีตัวเลือกความหนานี้อยู่แล้ว',
      variants: '%d รูปแบบ',
    },
    ...
    popup: {
      ...
      disassemble_use: {
        ...
        variable_text_warning: 'ข้ามวัตถุข้อความแปรผันแล้ว กรุณาปิดข้อความแปรผันก่อนแยกส่วน',
      },
    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          disabled_by_noun_project: 'รูปทรงนี้ได้รับความคุ้มครองโดยกฎหมายทรัพย์สินทางปัญญา จึงไม่สามารถแก้ไขเส้นพาธได้',
  ...
  print_and_cut: {
    ...
    calibration: {
      align_desc: '1. วางแผ่นปรับเทียบที่พิมพ์แล้วในพื้นที่ทำงาน ยึดด้วยเทปหรือเทปกาวย่นเพื่อไม่ให้เลื่อน แล้วปรับโฟกัส\n2. คลิก “ดูตัวอย่างและจัดตำแหน่ง” เพื่อเรียกใช้การจัดแนวด้วยกล้อง\n3. เมื่อพบเครื่องหมายแล้ว ให้คลิก “ขีดสเกล” เพื่อขีดเส้นอ้างอิงลงบนแผ่นด้วยกำลังต่ำ',
      aligned: 'ตรวจพบเครื่องหมายจัดแนวแล้ว พร้อมขีด',
      auto_read: 'อ่านสเกลด้วยกล้อง',
      auto_read_failed: 'ไม่สามารถอ่านสเกลอัตโนมัติได้ กรุณาอ่านด้วยสายตาแล้วกรอกค่า',
      auto_read_hint: 'ค่าที่กล้องอ่านได้อาจคลาดเคลื่อนได้ถึง ±2 ช่อง โปรดตรวจสอบกับแผ่นสอบเทียบ',
      current_offset: 'ค่าชดเชยปัจจุบัน: X %s มม., Y %s มม.',
      export_pdf: 'ส่งออก PDF ปรับเทียบ',
      power: 'กำลัง',
      print_desc: '1. ส่งออก PDF แผ่นปรับเทียบ แผ่นประกอบด้วยเครื่องหมายจัดแนวสี่จุดและสเกลสองชุด\n2. พิมพ์แผ่นที่ขนาด 100% (ขนาดจริง)',
      reading_desc: '1. หาเส้นขีดที่ยาวที่สุด (เส้นกลาง) แล้วดูว่าอยู่ด้านใดของเส้น 0 ที่พิมพ์ไว้\n2. ไล่ดูทีละเส้นไปทางด้านนั้นจนพบตำแหน่งที่เส้นขีดตรงกับเส้นพิมพ์พอดี\n3. นับจาก 0 ถึงเส้นพิมพ์นั้น (มีตัวเลขพิมพ์ทุก 5 เส้น ให้นับเส้นที่ไม่มีตัวเลขระหว่างนั้นด้วย)',
      reading_x: 'ค่าอ่าน X',
      reading_y: 'ค่าอ่าน Y',
      scratch: 'ขีดสเกล',
      speed: 'ความเร็ว',
      title: 'การปรับเทียบ พิมพ์และตัด',
    },
  ...
  settings: {
    ai_contour_detection: 'การตรวจจับเส้นขอบด้วย AI',
    ai_contour_detection_tooltip: 'ใช้โมเดล AI ค้นหาวัตถุในภาพตัวอย่างจากกล้อง แม่นยำกว่าบนวัสดุที่มีลวดลาย แต่ช้ากว่าบนคอมพิวเตอร์รุ่นเก่า ปิดเพื่อใช้การตรวจจับแบบดั้งเดิม ใช้กับ: ปรับให้พอดีอัตโนมัติ',
  ...
  topbar: {
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'ปรับเทียบ พิมพ์และตัด',
