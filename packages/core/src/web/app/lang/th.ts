...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    retake: 'ถ่ายรูปใหม่',
    retake_tooltip: 'ถ่ายรูปจากกล้องใหม่ที่ตำแหน่งของแต่ละวัตถุเพื่อการตรวจจับที่ดีขึ้น',
    retry_with_remove_bg: 'ลบพื้นหลัง',
    retry_with_remove_bg_tooltip: 'ลบพื้นหลังจากรูปภาพตัวอย่างเพื่อปรับปรุงการตรวจจับเส้นขอบ',
    rotation: 'หมุน',
    ...
    use_original_image: 'ใช้รูปภาพต้นฉบับ',
    use_original_image_tooltip: 'กู้คืนรูปภาพตัวอย่างต้นฉบับโดยไม่มีการลบพื้นหลัง',
    warning_bg_removal: 'การดำเนินการนี้จะเรียกใช้ฟีเจอร์ "ลบพื้นหลัง" ซึ่งจะใช้ 0.02 Credit คุณต้องการดำเนินการต่อหรือไม่?',
    warning_retake_preview: 'การดำเนินการนี้เป็นการถ่ายภาพใหม่บางส่วน จะมีภาพและพื้นหลังใหม่เพิ่มเข้ามา คุณต้องการดำเนินการต่อหรือไม่?',
  },
  autosave: {
    open_settings: 'เปิดการตั้งค่า',
    path_not_correct: 'ตำแหน่งบันทึกอัตโนมัติไม่มีอีกต่อไป',
    path_not_correct_desc: 'กรุณาเลือกโฟลเดอร์ใหม่ใน <b>%(preferences)s > %(autosave)s > %(path)s</b> เพื่อดำเนินการบันทึกงานของคุณต่อ',
  },
  barcode_generator: {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s เครดิต AI',
      credit_balance: 'ยอดเครดิต AI คงเหลือ',
      credit_cost: 'เครดิต AI ที่ใช้',
      description: 'เพิ่มความละเอียดและรายละเอียดของภาพด้วย AI ภาพที่ขยายแล้วจะแทนที่ภาพต้นฉบับบนแคนวาส',
      done: 'การขยายภาพเชิงสร้างสรรค์เสร็จสมบูรณ์',
      dpi_recommended: 'แนะนำสำหรับ DPI ของเลเยอร์ปัจจุบัน: %dx',
      dpi_recommended_capped: 'แนะนำสำหรับ DPI ของเลเยอร์ปัจจุบัน: %dx แต่ %dx คือค่าสูงสุดภายในขนาดผลลัพธ์ที่แนะนำ',
      failed: 'ไม่สามารถขยายภาพเชิงสร้างสรรค์ได้ โปรดตรวจสอบการเชื่อมต่อเครือข่ายแล้วลองอีกครั้ง',
      insufficient_credit: 'เครดิต AI ไม่เพียงพอสำหรับการขยายภาพเชิงสร้างสรรค์',
      layer_dpi: 'DPI ของเลเยอร์',
      original_size: 'ขนาดต้นฉบับ',
      output_size: 'ขนาดผลลัพธ์',
      oversize_warning: 'ขนาดผลลัพธ์ (%s) เกินค่าสูงสุดที่แนะนำ %dpx x %dpx การประมวลผลอาจใช้เวลาหลายนาที และผลลัพธ์อาจทำให้ Beam Studio ทำงานช้าลง ต้องการดำเนินการต่อหรือไม่',
      processing: 'กำลังขยายภาพ…',
      processing_hint: 'เวลาประมวลผลขึ้นอยู่กับขนาดภาพและสภาพเครือข่าย',
      recommended: 'แนะนำ',
      retry: 'ลองอีกครั้ง',
      start: 'เริ่มขยายภาพ',
    },
    ...
    left_panel: {
      ...
      label: {
        ...
        polygon: 'รูปเหลี่ยม',
        preview: 'ตัวอย่าง',
        preview_precise: 'ตัวอย่างกล้องแม่นยำ',
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: 'สามารถสร้างงานได้เร็วขึ้น',
        keep_current: 'คงเดิม',
        message: 'เราได้อัปเกรดเอ็นจิ้นคำนวณงานเพื่อปรับปรุงประสิทธิภาพและเร่งความเร็วในการสร้างงาน\nคุณต้องการเปลี่ยนไปใช้เอ็นจิ้นเร่งความเร็วใหม่หรือไม่?\nคุณสามารถปิดได้ทุกเมื่อที่ %(preferences)s > %(editor)s > %(path_acceleration)s',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'ในโหมดแกะสลักเส้นโค้ง ความเร็วปัจจุบันอาจสูงเกินไปและอาจส่งผลต่อรายละเอียดการแกะสลักสำหรับเลเยอร์: %(layers)s\nพิจารณาลดความเร็วเพื่อคุณภาพที่ดีขึ้น',
    ...
    right_panel: {
      laser_panel: {
        ...
        dropdown: {
          inches: {
            ...
            acrylic_7mm_cutting: 'อะคริลิค - 1/4″ ตัด',
            ...
            mdf_7mm_cutting: 'ไม้อัด - 1/4″ ตัด',
          ...
          mm: {
            ...
            acrylic_7mm_cutting: 'อะคริลิค - 7 มม. ตัด',
            ...
            mdf_7mm_cutting: 'ไม้อัด - 7 มม. ตัด',
            mdf_engraving: 'ไม้อัด - กัดขูด',
        ...
        high_quality_desc: 'ใช้ได้เฉพาะกับการแกะสลักเวกเตอร์ที่เติมและวัตถุภาพเท่านั้น การเปิดใช้งานจะลดความเร่งในการแกะสลักเพื่อผลลัพธ์ที่ละเอียดยิ่งขึ้น',
        ...
        texture: 'พื้นผิว',
        texture_angle: 'มุม',
        texture_intensity: 'ความเข้ม',
        texture_interval: 'ระยะห่าง',
        texture_random: 'สุ่ม',
        texture_stripe: 'ลายเส้น',
        times: 'ครั้ง',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'การขยายภาพเชิงสร้างสรรค์',
          ai_upscale_short: 'ขยายภาพ',
          ai_upscale_too_large: 'รูปภาพนี้ใหญ่เกินไปสำหรับการขยายด้วย AI ขนาดสูงสุดที่รองรับคือ %dpx x %dpx',
          array: 'แถวลําดับ',
          ...
          disabled_by_noun_project: 'รูปทรงจาก Noun Project ได้รับความคุ้มครองโดยกฎหมายทรัพย์สินทางปัญญา จึงไม่สามารถแก้ไขเส้นพาธได้',
  ...
  boxgen: {
    ...
    inner: 'ภายใน',
    joints: 'รอยต่อ',
    max_dimension_tooltip: 'ความกว้างสูงสุดคือ %s, ความสูง/ความลึกสูงสุดคือ %s',
    merge: 'รวม',
    outer: 'ภายนอก',
    reset: 'รีเซ็ต',
    tCount: 'จํานวน T ',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'เลื่อนหัวเลเซอร์เพื่อให้แสงสีแดงตรงกับจุดกึ่งกลางของ <b>จุด A</b>',
    charuco_move_to_point_b: 'เลื่อนหัวเลเซอร์ในแนวนอนเพื่อให้แสงสีแดงตรงกับจุดกึ่งกลางของ <b>จุด B</b>',
    ...
    check_pnp_desc: 'ตรวจสอบให้แน่ใจว่าเครื่องหมายสีแดงสอดคล้องกับจุดแกะสลัก\nหากไม่ใช่ ให้คลิก "กลับ" เพื่อปรับ\nหากทุกอย่างเรียบร้อยดี ยอดเยี่ยมมาก! 🎉',
    ...
    next: 'ถัดไป',
    no_picture_found: '#852 อุปกรณ์ของคุณไม่มีรูปถ่ายดิบที่มีสำหรับการปรับแต่ง กรุณาดำเนินการ "การปรับเทียบกล้อง (ขั้นสูง)"',
    ...
    put_charuco: 'วางแผ่นลายสำหรับปรับเทียบ',
    put_charuco_1: 'พิมพ์แผ่นลายสำหรับปรับเทียบ (A4/Letter)',
    put_charuco_2: 'ติดให้แบนราบบนแผ่นแข็ง',
    put_charuco_3: 'วางไว้ตรงกลางและทำการโฟกัสอัตโนมัติ',
    put_charuco_bm2_1: 'พิมพ์ไฟล์แผ่นลายสำหรับปรับเทียบลงบนกระดาษ A4 (ขนาด Letter) สำหรับการปรับเทียบ.',
    put_charuco_bm2_2: 'คลิก “ถัดไป” และทำตามคำแนะนำเพื่อวางกระดาษ.',
    put_charuco_promark_2: "โปรดตรวจสอบให้แน่ใจว่ากระดาษสำหรับปรับเทียบมองเห็นได้ชัดเจนโดยไม่มีแสงสะท้อน คลิก 'ถัดไป' เพื่อถ่ายภาพ",
    put_charuco_promark_desc_1: 'โปรดใช้กระดาษสำหรับปรับเทียบที่ให้มาในกล่องอุปกรณ์ หรือพิมพ์ลายสำหรับปรับเทียบด้านล่างลงบนกระดาษ A4 เพื่อปรับเทียบกล้อง',
    ...
    put_paper_promark: 'วางกระดาษแข็งสีดำ',
    put_paper_promark_1: 'วางกระดาษแข็งสีดำจากกล่องอุปกรณ์ลงบนพื้นที่ทำงาน',
    put_paper_promark_2: 'ปรับโฟกัสให้ถูกต้อง จากนั้นคลิก "เริ่มกัดขูด" เพื่อดำเนินการต่อ',
  ...
  connection_issue_guide: {
    alert_link: 'การเชื่อมต่อหลุดหรือไม่? ลองวิธีแก้ไขปัญหานี้',
    connect_computer: {
      content: 'คอมพิวเตอร์ของคุณต้องอยู่ในเครือข่ายเดียวกันกับเครื่อง',
      macos_steps: 'คลิกไอคอน Wi-Fi ในแถบเมนู จากนั้นเลือกฮอตสปอตของโทรศัพท์คุณ',
      macos_title: 'macOS',
      title: 'เชื่อมต่อคอมพิวเตอร์ของคุณ',
      windows_steps: 'คลิกไอคอนเครือข่ายในแถบงาน จากนั้นเลือกฮอตสปอตของโทรศัพท์คุณ',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'เครื่องหาฮอตสปอตของฉันไม่พบ',
      dont_know_hotspot_name: 'ฉันไม่ทราบชื่อฮอตสปอตของฉัน',
      step1: '1. บนหน้าจอสัมผัสของเครื่อง ไปที่: เครือข่าย → เชื่อมต่อ Wi-Fi',
      step2: '2. ค้นหาและเลือกชื่อฮอตสปอตของโทรศัพท์คุณจากรายการ Wi-Fi',
      step3: '3. ป้อนรหัสผ่านฮอตสปอตแล้วเชื่อมต่อ',
    ...
    enter_ip: {
      ...
      placeholder: 'ที่อยู่ IP',
      step1: 'ป้อนที่อยู่ IP ที่คุณพบในขั้นตอนก่อนหน้า',
      step2: 'คลิก "ตรวจสอบ" เพื่อทดสอบการเชื่อมต่อ',
      step3: 'Beam Studio จะตรวจสอบ:',
      title: 'ป้อนที่อยู่ IP ของเครื่องคุณ',
      verify: 'ตรวจสอบ',
    },
    fail: {
      bullet1: '• รุ่นเครื่องและหมายเลขซีเรียลของคุณ',
      bullet2: '• ที่อยู่ IP ที่แสดงบนหน้าจอสัมผัส',
      bullet3: '• คำอธิบายข้อผิดพลาดที่คุณพบ',
      contact_title: 'เมื่อติดต่อฝ่ายสนับสนุน ควรเตรียมข้อมูลต่อไปนี้:',
      intro: 'ไม่ต้องกังวล — นี่ไม่ได้หมายความว่าเครื่องของคุณมีปัญหาเสมอไป อาจมีปัจจัยอื่นที่ส่งผลต่อการเชื่อมต่อ ทีมสนับสนุนของเราพร้อมช่วยคุณหาสาเหตุ',
      title: 'เราไม่สามารถทำการทดสอบให้เสร็จสมบูรณ์ได้',
    },
    hotspot: {
      android_steps: 'การตั้งค่า → การเชื่อมต่อ → ฮอตสปอตมือถือและการปล่อยสัญญาณ → ฮอตสปอตมือถือ',
      android_title: 'Android',
      ios_steps: 'การตั้งค่า → ฮอตสปอตส่วนตัว → อนุญาตให้ผู้อื่นเข้าร่วม',
      ios_title: 'iPhone (iOS)',
      tip: 'เคล็ดลับ: ใช้ชื่อฮอตสปอตเป็นภาษาอังกฤษที่เรียบง่ายและรหัสผ่านเป็นตัวเลข (เช่น ชื่อ: FLUX_Test   รหัสผ่าน: 12345678)',
      warning_2_4ghz: 'สำคัญ: เครื่อง FLUX รองรับเฉพาะ Wi-Fi 2.4GHz เท่านั้น ตั้งค่าฮอตสปอตของคุณเป็น 2.4GHz ก่อนดำเนินการต่อ',
    },
    how_it_works: 'การทดสอบทำงานอย่างไร:',
    how_it_works_step1: '1. ตั้งค่าโทรศัพท์ของคุณเป็นฮอตสปอต Wi-Fi',
    how_it_works_step2: '2. เชื่อมต่อเครื่องกับฮอตสปอต',
    how_it_works_step3: '3. เชื่อมต่อคอมพิวเตอร์ของคุณกับฮอตสปอตเดียวกัน',
    how_it_works_step4: '4. ทดสอบการเชื่อมต่อใน Beam Studio',
    intro: 'มาทดสอบอย่างรวดเร็วเพื่อตรวจสอบว่าเครื่องของคุณทำงานปกติหรือไม่ เราจะเชื่อมต่อเครื่องและคอมพิวเตอร์ของคุณผ่านฮอตสปอตของโทรศัพท์มือถือ เพื่อระบุว่าปัญหาเกิดจากเครือข่ายของคุณหรือตัวเครื่องเอง',
    ip_address: {
      step1: 'บนหน้าจอสัมผัสของเครื่อง ไปที่:\nเครือข่าย → มองหา "ที่อยู่ IP"',
      step2: 'โดยทั่วไป IP จะมีลักษณะเช่น: 172.20.10.x หรือ 192.168.x.x\n(ขึ้นอยู่กับฮอตสปอตของโทรศัพท์คุณ)',
      step3: 'จดที่อยู่ IP นี้ไว้สำหรับขั้นตอนถัดไป',
      title: 'ค้นหาที่อยู่ IP ของเครื่องคุณ',
      warning: 'หาก IP ขึ้นต้นด้วย 169.254 แสดงว่าการเชื่อมต่อล้มเหลว กลับไปที่ขั้นตอนที่ 1 แล้วลองใหม่',
    },
    success: {
      cause: 'ปัญหาการเชื่อมต่อที่คุณพบมีแนวโน้มว่าเกิดจากสภาพแวดล้อมเครือข่ายในพื้นที่ของคุณ ไม่ใช่ตัวเครื่องเอง',
      intro: 'คุณทำการทดสอบการเชื่อมต่อ Wi-Fi สำเร็จแล้ว — เยี่ยมมาก! นี่ยืนยันว่าเครื่อง FLUX ของคุณทำงานได้อย่างสมบูรณ์',
      recommend1: '• ติดต่อผู้ให้บริการอินเทอร์เน็ต (ISP) หรือผู้ผลิตเราเตอร์ของคุณเพื่อขอความช่วยเหลือเกี่ยวกับการตั้งค่า Wi-Fi',
      recommend2: '• สอบถามผู้ดูแลระบบเครือข่ายหากคุณอยู่ในโรงเรียน สำนักงาน หรือพื้นที่ทำงานร่วมกัน',
      recommend3: '• ตรวจสอบว่าเราเตอร์ของคุณรองรับ 2.4GHz และลองรีสตาร์ท',
      recommend_title: 'สิ่งที่เราแนะนำ:',
      title: 'เยี่ยมมาก! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'เครื่องสร้างพวงกุญแจ',
  ...
  initialize: {
    ...
    select_hexa: 'เลือก HEXA ของคุณ',
    select_language: 'เลือกภาษา',
    select_machine_type: 'เลือกรุ่นของเครื่อง',
    select_promark: 'เลือก Promark ของคุณ',
    setting_completed: {
      back: 'กลับ',
  ...
  keychain_generator: {
    ...
    text: 'ข้อความ',
    text_options: {
      font_family: 'ตระกูลตัวอักษร',
      font_settings: 'การตั้งค่าตัวอักษร',
  ...
  machine_linking: {
    ...
    i_have_read: 'ฉันได้อ่านแล้ว',
    input_birthday_to_link: 'กรุณาใส่วันเกิดของคุณเพื่อดำเนินการเชื่อมต่ออุปกรณ์',
    input_birthday_to_link_note: '*ใช้เพื่อตรวจสอบว่าอายุของคุณตรงตามข้อกำหนดคุณสมบัติหรือไม่',
    link_failed: 'การเชื่อมโยงล้มเหลว',
    link_failed_already_linked: 'อุปกรณ์นี้ปัจจุบันเชื่อมโยงกับ FLUX ID อื่นอยู่ คุณสามารถใช้งานต่อหรือเชื่อมโยงกับบัญชีของคุณได้',
    link_failed_cannot_set_secret: 'ไม่สามารถบันทึกข้อมูลการเชื่อมโยงลงในอุปกรณ์ได้ กรุณาตรวจสอบการเชื่อมต่อระหว่างคอมพิวเตอร์และอุปกรณ์',
    link_failed_under_age: 'ขณะนี้คุณไม่มีคุณสมบัติในการใช้บริการนี้และไม่สามารถดำเนินการเชื่อมต่ออุปกรณ์ได้',
    link_machine: 'เชื่อมโยง FLUX ID',
    link_machine_to_account: 'เชื่อมต่อกับ %(name)s แล้ว คุณต้องการเชื่อมโยงอุปกรณ์นี้กับบัญชีของคุณหรือไม่?',
    link_success: 'เชื่อมโยงสำเร็จ',
    link_to_my_flux_id: 'เชื่อมโยงกับ FLUX ID ของฉัน',
    privacy_policy: 'นโยบายความเป็นส่วนตัว',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'กำลังเชื่อมโยง…',
    use_without_linking: 'ใช้งานโดยไม่เชื่อมโยง',
  },
  machine_status: {
  ...
  maintenance: {
    ...
    cadence: {
      by_material: 'ตามวัสดุ',
      condition: 'ตามสภาพ',
      day: 'ทุกวัน',
      days: 'ทุก %s วัน',
      each_operation: 'ทุกครั้งที่ใช้งาน',
      every_1_2_weeks: 'ทุก 1–2 สัปดาห์',
      month: 'ทุกเดือน',
      months: 'ทุก %s เดือน',
      upon_unboxing: 'เมื่อแกะกล่องครั้งแรก',
      week: 'ทุกสัปดาห์',
      weeks: 'ทุก %s สัปดาห์',
    },
    celebration: {
      subtitle: '%s ของคุณอยู่ในสภาพเยี่ยม — รักษาไว้แบบนี้ต่อไป',
      title: 'การบำรุงรักษาที่จำเป็นเสร็จครบแล้ว!',
    },
    columns: {
      cadence: 'ความถี่',
      status: 'สถานะ',
    ...
    empty_no_machine: 'เชื่อมต่อหรือเลือกเครื่องเพื่อดูตารางการบำรุงรักษา',
    empty_no_schedule: 'ยังไม่มีรายการตรวจสอบการบำรุงรักษาสำหรับรุ่นนี้',
    essential: 'จำเป็น',
    essential_health: 'สุขภาพรายการจำเป็น',
    essential_hint: 'นับรวมในคะแนนสุขภาพ',
    feedback: {
      checked: 'ตรวจ %s แล้ว',
      done: '%s เพิ่งทำเสร็จ ครั้งถัดไปกำหนด %s',
      done_no_date: '%s เสร็จแล้ว',
      fail_warning: '%s: บันทึกว่าต้องเปลี่ยนหลอดเลเซอร์ เปิดคู่มือเพื่อดูขั้นตอน',
      passed: '%s ผ่าน — หลอดเลเซอร์อยู่ในสภาพดี!',
    },
    footer_tip: 'เคล็ดลับ: กัดขูดไฟล์ตัวอย่างทุกเดือนเพื่อรักษาสภาพเครื่องให้ดีอยู่เสมอ',
    history_hint: 'ระบบเก็บประวัติล่าสุดเพียง %s รายการสำหรับแต่ละงาน',
    intro: 'ติดตามงานบำรุงรักษาแต่ละรายการของเครื่องนี้ และบันทึกว่าทำเสร็จได้ในคลิกเดียว',
    legend: {
    ...
    status: {
      ...
      healthy: 'สภาพดี',
      last: 'ทำล่าสุด',
      never_done: 'ยังไม่เคยทำ',
      next: 'กำหนดถัดไป',
      not_checked: 'ยังไม่ได้ตรวจ',
      not_logged: 'ยังไม่ได้บันทึก',
      overdue: 'เกินกำหนด',
      replace_tube: 'เปลี่ยนหลอดเลเซอร์',
    },
    tasks: {
      align: {
        keyPoints: 'ปรับเมื่อเส้นทางลำแสงคลาดเคลื่อน',
        name: 'การปรับแนวเส้นทางลำแสง',
      },
      chassis: {
        keyPoints: 'กำจัดคราบเศษวัสดุและน้ำมันดินออกจากตัวเครื่องและฝาครอบด้านล่าง',
        name: 'การทำความสะอาดตัวเครื่อง',
      },
      door: {
        keyPoints: 'กำจัดคราบมันออกจากฝาครอบประตู',
        name: 'การทำความสะอาดฝาครอบประตู',
      },
      exhaust: {
        keyPoints: 'ทำความสะอาดฝุ่นบนใบพัดลม',
        name: 'การทำความสะอาดพัดลมดูดอากาศ',
      },
      fan: {
        keyPoints: 'กำจัดฝุ่นออกจากใบพัดลมระบายอากาศ',
        name: 'การทำความสะอาดพัดลมระบายอากาศ',
      },
      fieldlens: {
        keyPoints: 'ทำความสะอาดเลนส์สนาม โดยเช็ดจากตรงกลางออกด้านนอกตามเข็มนาฬิกา',
        name: 'การทำความสะอาดเลนส์สนาม',
      },
      honeycomb_plate: {
        keyPoints: 'กำจัดคราบเศษวัสดุและน้ำมันดินออกจากช่องตารางของแผ่นรังผึ้ง',
        name: 'การทำความสะอาดแผ่นรังผึ้ง',
      },
      honeycomb_table: {
        keyPoints: 'กำจัดคราบเศษวัสดุและน้ำมันดินออกจากตะแกรงรังผึ้ง',
        name: 'การทำความสะอาดโต๊ะรังผึ้ง',
      },
      lube: {
        keyPoints: 'ทำความสะอาดแกนนำ รางเลื่อน และกลไกปรับโฟกัส แล้วหล่อลื่นใหม่ ความถี่จะแตกต่างกันไปตามวัสดุที่คุณตัด',
        name: 'การหล่อลื่น',
      },
      maintain_test: {
        keyPoints: 'ตรวจสอบหน้าจอแสดงสถานะและสวิตช์',
        name: 'หน้า MAINTAIN',
      },
      mirrors_combiner: {
        keyPoints: 'กำจัดคราบสกปรกออกจากเลนส์/กระจก และตรวจสอบการเกิดออกซิเดชัน ไม่ให้มีคราบแอลกอฮอล์หรือคราบน้ำหลงเหลือ',
        name: 'กระจก เลนส์โฟกัส และตัวรวมลำแสง',
      },
      mirrors_lens: {
        keyPoints: 'ทำความสะอาดกระจกทั้ง 4 บานและเลนส์ ตรวจสอบว่าไม่มีออกซิเดชันหรือคราบน้ำ',
        name: 'การทำความสะอาดกระจกและเลนส์',
      },
      mod_diode: {
        keyPoints: 'ทำความสะอาดพัดลม เลนส์โฟกัส และ POGO pin',
        name: 'โมดูลเลเซอร์ไดโอด',
      },
      mod_ir: {
        keyPoints: 'ทำความสะอาดเลนส์โฟกัส',
        name: 'โมดูลเลเซอร์อินฟราเรด',
      },
      optical_inspection: {
        keyPoints: 'ตรวจสอบเส้นทางลำแสง รวมถึงเมื่อแกะกล่องและหลังเปลี่ยนหลอดเลเซอร์',
        name: 'การตรวจสอบเส้นทางลำแสง',
      },
      optical_unboxing: {
        keyPoints: 'ตรวจสอบให้แน่ใจว่าเส้นทางลำแสงแม่นยำ ตรวจสอบเมื่อแกะกล่องครั้งแรก',
        name: 'การตรวจสอบเส้นทางลำแสง',
      },
      screen: {
        keyPoints: 'ทำความสะอาดฝุ่นและคราบมันบนแผงควบคุม',
        name: 'การทำความสะอาดหน้าจอ',
      },
      tube: {
        keyPoints: 'หากไม่สามารถตัดอะคริลิก 3 มม. ที่กำลัง 70% ได้ ให้เปลี่ยนหลอดเลเซอร์',
        name: 'การตรวจสอบสภาพหลอดเลเซอร์',
      },
      water: {
        keyPoints: 'เติมน้ำให้เกิน 80% โดยไม่มีฟองอากาศ',
        name: 'การเปลี่ยนน้ำหล่อเย็น',
      },
      worktable: {
        keyPoints: 'ฉีดแอลกอฮอล์ลงบนกระดาษทิชชู แล้วเช็ดโต๊ะทำงาน',
        name: 'การทำความสะอาดโต๊ะทำงาน',
      },
      zaxis: {
        keyPoints: 'เช็ดสกรูเสาแกน Z แล้วทาสารหล่อลื่นให้ทั่วด้วยสำลีก้าน',
        name: 'การหล่อลื่นเสาแกน Z',
      },
    },
  ...
  message: {
    ...
    camera: {
      ...
      calibration_data_missing: 'ตั้งค่าการสอบเทียบกล้อง',
      calibration_data_missing_message: 'ไม่พบข้อมูลการสอบเทียบกล้อง\nกรุณานำเข้าข้อมูลการสอบเทียบที่บันทึกไว้ หรือทำการสอบเทียบกล้อง',
      ...
      fail_to_transmit_image: '#845 มีบางอย่างผิดพลาดกับการส่งภาพ โปรดรีสตาร์ทเครื่องของคุณหรือ Beam Studio หากข้อผิดพลาดนี้ยังคงเกิดขึ้น โปรดทําตาม<a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">คู่มือนี้</a>',
      switching_camera: 'กำลังสลับกล้อง...',
      wide_angle_open_door: 'เปิดฝาครอบประตู',
      wide_angle_open_door_text: 'กรุณาเปิดฝาครอบประตูก่อนสลับไปยังกล้องมุมกว้าง',
    ...
    preview: {
      ...
      please_focus_before_preview: 'เพื่อให้ได้คุณภาพการแสดงตัวอย่างที่ดีขึ้น โปรดทำการโฟกัสอัตโนมัติก่อนแสดงตัวอย่าง',
  ...
  monitor: {
    ...
    HARDWARE_ERROR_CARTRIDGE_OVERHEAT: '#931 การแจ้งเตือนอุณหภูมิตลับหมึก\nอุณหภูมิตลับหมึกสูงเกินกว่าปกติ\nเพื่อความปลอดภัย งานถูกหยุดชะงัก กรุณาติดตั้งตลับหมึกใหม่และเริ่มงานอีกครั้ง',
    HARDWARE_ERROR_CARTRIDGE_POWERON_FAILED: '#930 ติดตั้งตลับหมึกใหม่\nตรวจพบการเชื่อมต่อที่ไม่ดีที่ตลับหมึก กรุณาติดตั้งตลับหมึกใหม่แล้วลองอีกครั้ง',
    ...
    HARDWARE_ERROR_KEY_OFF: '#929 ไม่พบกุญแจนิรภัย\nไม่พบกุญแจนิรภัยหรือกุญแจนิรภัยถูกปิดใช้งาน เพื่อความปลอดภัยของคุณ เครื่องจะไม่สามารถทำงานได้จนกว่าจะเปิดกุญแจอย่างถูกต้อง\nกรุณาใส่กุญแจนิรภัยและเปิดก่อนเริ่มงานใหม่',
    HARDWARE_ERROR_LASER_TEMPERATURE_ABNORMAL: '#933 อุณหภูมิเลเซอร์ผิดปกติ\nอุณหภูมิเลเซอร์สูงเกินไป กรุณาหยุดการทำงานและรอให้เลเซอร์เย็นลงก่อนเริ่มใหม่',
    ...
    HARDWARE_ERROR_LIMIT_SWITCH_TRIGGERED: '#934 เครื่องหยุดทำงาน — หัวเลเซอร์ถึงขีดจำกัดพื้นที่ทำงาน',
    ...
    HARDWARE_ERROR_PUMP_ERROR: '#900 การไหลของน้ำหล่อเย็นต่ำ โปรดตรวจสอบถังน้ําของคุณ',
    HARDWARE_ERROR_REMOTE_INTERLOCK_OPENED: '#927 อินเตอร์ล็อคระยะไกลถูกเปิดใช้งาน\nกรุณาตรวจสอบขั้วต่ออินเตอร์ล็อคระยะไกลและให้แน่ใจว่าเชื่อมต่อแน่นหนาก่อนเริ่มงานใหม่',
  ...
  params_label: {
    ...
    layer_name: 'ชื่อชั้น',
    placeholder: 'ป้ายพารามิเตอร์',
    preview_hint: 'นี่คือตัวอย่าง เนื้อหาข้อความจะได้รับการอัปเดตโดยอัตโนมัติก่อนส่งงาน',
    save_as_default: 'บันทึกเป็นค่าเริ่มต้น',
    settings: 'การตั้งค่าป้ายพารามิเตอร์',
    update: 'อัปเดต',
    updated: 'อัปเดตป้ายพารามิเตอร์แล้ว',
    use_default: 'ใช้ค่าเริ่มต้นที่บันทึกไว้',
    use_recommended: 'ใช้ค่าที่แนะนำ',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      ...
      completing: 'ใกล้เสร็จสิ้น',
      detecting: 'กำลังตรวจจับเครื่องหมายจัดตำแหน่ง',
      locating: 'กำลังค้นหาเครื่องหมายจัดตำแหน่ง',
      preparing: 'กำลังเตรียมกล้อง',
      refining: 'กำลังปรับตำแหน่งเครื่องหมาย',
    },
    alignment: {
      detect_failed: 'ตรวจพบเครื่องหมายจัดตำแหน่งไม่เพียงพอ กรุณาถ่ายภาพตัวอย่างกล้องใหม่แล้วลองอีกครั้ง',
      fit_error: 'ค่าคลาดเคลื่อน (X / Y)',
      no_preview: 'ไม่พบภาพตัวอย่างจากกล้อง กรุณาเรียกใช้การแสดงตัวอย่างกล้องเพื่อถ่ายภาพวัสดุที่พิมพ์แล้วก่อน',
      rotation: 'การหมุน',
      scale: 'สเกล',
      success: 'จัดตำแหน่งเสร็จสมบูรณ์!',
    },
    backend_outdated: 'เฟิร์มแวร์ปัจจุบันของเครื่องยังไม่รองรับ Print & Cut',
    continue_to_alignment: 'ดำเนินการต่อไปยังการจัดตำแหน่ง',
    cutting_layer_name: 'พิมพ์และตัด - การตัด',
    design_changed: 'งานออกแบบมีการเปลี่ยนแปลงหลังจากพิมพ์ จึงแสดงเฉพาะเส้นทางการตัด\nดำเนินการต่อเพื่อจัดตำแหน่งวัสดุที่พิมพ์ไว้ก่อนหน้านี้ หรือเริ่มใหม่เพื่อเตรียมงานออกแบบปัจจุบัน',
    export_pdf: 'ส่งออก PDF',
    finish: 'เสร็จสิ้น',
    fit_content: 'พอดีกับเนื้อหา',
    generate_from_contour: 'สร้างจากเส้นขอบ',
    grid_columns: 'คอลัมน์',
    grid_rows: 'แถว',
    grid_spacing: 'ระยะห่าง (mm)',
    no_content: 'ไม่มีเนื้อหาในเลเยอร์การพิมพ์ UV กรุณาเพิ่มงานออกแบบของคุณลงในเลเยอร์การพิมพ์ UV ก่อนใช้พิมพ์และตัด',
    no_layer_with_path: 'ไม่มีชั้นเลเซอร์ใดที่มีเส้นทางเวกเตอร์ กรุณาเตรียมชั้นเลเซอร์ที่มีเส้นทางการตัดเพื่อใช้เป็นเส้นขอบ',
    no_uv_layer: 'ไม่พบเลเยอร์การพิมพ์ UV กรุณาเปลี่ยนโมดูลของเลเยอร์งานออกแบบเป็น "การพิมพ์ UV" เพื่อใช้พิมพ์และตัด',
    open_preferences: 'เปิดการตั้งค่า',
    orientation: 'การวางแนว',
    orientation_landscape: 'แนวนอน',
    orientation_portrait: 'แนวตั้ง',
    paper_size: 'ขนาดผลลัพธ์',
    paper_too_small: 'ขอบเขตผลลัพธ์เล็กเกินไป งานออกแบบ (รวมถึงเครื่องหมายจัดตำแหน่ง) ต้องมีระยะขอบอย่างน้อย %s มม. จากขอบวัสดุ เพื่อให้อยู่ในพื้นที่ที่พิมพ์ได้ของเครื่องพิมพ์ กรุณาเลือกขนาดผลลัพธ์ที่ใหญ่ขึ้น มิฉะนั้นงานพิมพ์จะถูกตัดขอบหรือย่อขนาดลง',
    preview_and_align: 'ดูตัวอย่างและจัดตำแหน่ง',
    resume_desc: 'งานออกแบบนี้เตรียมพร้อมสำหรับพิมพ์และตัดแล้ว\nวางวัสดุที่พิมพ์ชิ้นถัดไปในเครื่องแล้วดำเนินการต่อไปยังการจัดตำแหน่งด้วยกล้อง หรือเริ่มใหม่เพื่อเปลี่ยนงานออกแบบ ขนาดผลลัพธ์ หรือเส้นทางการตัด',
    resume_title: 'ดำเนินการพิมพ์และตัดต่อ',
    select_cut_layer: 'ชั้นเส้นทางการตัด',
    start_over: 'เริ่มใหม่',
    step_align: 'การจัดตำแหน่งด้วยกล้อง',
    step_align_desc: 'วางวัสดุที่พิมพ์ในเครื่องแล้วเรียกใช้การแสดงตัวอย่างกล้อง\nระบบจะตรวจจับเครื่องหมายและจัดแนวเส้นตัดให้ตรงกับงานพิมพ์โดยอัตโนมัติ\nคลิก “เสร็จสิ้น” เพื่อเพิ่มชั้นการตัดที่จัดตำแหน่งแล้วลงในแคนวาส ชั้นงานออกแบบเดิมจะถูกซ่อน\nจากนั้นส่งงานจากตัวแก้ไข',
    step_export: 'ส่งออกและพิมพ์ PDF',
    step_export_desc: 'ส่งออกไฟล์ PDF ที่มีงานออกแบบและเครื่องหมายจัดตำแหน่ง แล้วพิมพ์ด้วยเครื่องพิมพ์ของคุณที่มาตราส่วน 100% (ขนาดจริง)\nอย่าใช้ “ปรับให้พอดีกับหน้า” มิฉะนั้นเส้นทางการตัดจะไม่ตรงกับงานพิมพ์\nเส้นทางการตัดแบบออฟเซ็ตจะไม่รวมอยู่ด้วย เนื่องจากใช้เฉพาะกับเครื่องตัดเลเซอร์เท่านั้น',
    step_paper: 'ขนาดผลลัพธ์',
    step_paper_desc: 'เลือกขนาดผลลัพธ์สำหรับไฟล์ PDF ที่ส่งออก\nกำหนดแถวและคอลัมน์เพื่อพิมพ์และตัดงานออกแบบหลายชุดบนวัสดุชิ้นเดียว\nตัวอย่างจะแสดงขอบเขตผลลัพธ์รอบเนื้อหา',
    step_setup: 'เส้นทางการตัดและเครื่องหมาย',
    step_setup_desc: 'เลือกวิธีสร้างเส้นทางการตัด: สร้างเส้นขอบรอบงานออกแบบทั้งหมด หรือใช้ชั้นที่มีอยู่เป็นเส้นทางการตัด',
    title: 'พิมพ์และตัด',
    use_layer_as_cut_path: 'ใช้ชั้น',
    uv_print_file_disabled: 'พิมพ์และตัดจะพิมพ์เนื้อหาของเลเยอร์การพิมพ์ UV กรุณาเปิดใช้งาน "เปิดใช้งานไฟล์พิมพ์ UV" ในการตั้งค่า แล้วเพิ่มงานออกแบบของคุณลงในเลเยอร์การพิมพ์ UV',
    white_mark_base: 'พื้นหลังสีขาวใต้เครื่องหมาย',
  },
  ...
  puzzle_generator: {
    ...
    export_engrave: 'เลเยอร์แกะสลัก',
    export_failed: 'ไม่สามารถนำเข้าจิ๊กซอว์ไปยังพื้นที่ทำงาน โปรดลองอีกครั้งหรือปรับการตั้งค่าจิ๊กซอว์',
    export_none: 'ไม่มี',
    export_print: 'เลเยอร์พิมพ์',
    file_too_large: 'ไฟล์ที่เลือกมีขนาดเกินขนาดสูงสุดที่อนุญาต',
    guide_lines: 'เส้นแนวทาง',
    ...
    orientation_type_1: 'ประเภท 1',
    orientation_type_2: 'ประเภท 2',
    orientation_type_3: 'ประเภท 3',
    orientation_type_4: 'ประเภท 4',
    piece_size: 'ขนาดชิ้นส่วน',
    preview_placeholder: 'แสดงตัวอย่างจิ๊กซอว์',
    puzzle_board: 'กระดานจิ๊กซอว์',
    puzzle_pieces: 'ชิ้นส่วนจิ๊กซอว์',
    radius: 'รัศมี',
    raised_edges: 'ขอบนูน',
    reset_to_default: 'รีเซ็ตเป็นค่าเริ่มต้น',
    rows: 'แถว',
    switch_type_warning: 'การตั้งค่าปัจจุบันของคุณยังไม่ได้นำเข้าสู่พื้นที่ทำงาน\nการเปลี่ยนประเภทจิ๊กซอว์จะรีเซ็ตการตั้งค่าทั้งหมดเป็นค่าเริ่มต้น',
    tab_size: 'ขนาดแท็บ',
    types: {
      circle_jigsaw: 'จิ๊กซอว์กลม',
      heart_jigsaw: 'จิ๊กซอว์รูปหัวใจ',
      hex_jigsaw: 'จิ๊กซอว์หกเหลี่ยม',
      rectangle_jigsaw: 'จิ๊กซอว์สี่เหลี่ยม',
    },
    unsupported_file_type: 'ประเภทไฟล์ไม่รองรับ กรุณาใช้ JPG, PNG หรือ WebP',
    upload_hint: 'JPG, PNG, WebP (สูงสุด 10MB)',
    upload_image: 'คลิกหรือลากเพื่ออัปโหลด',
    zoom: 'ซูม',
  },
  qr_code_generator: {
  ...
  settings: {
    ...
    show_banners: 'แสดงแบนเนอร์หน้าแรก',
  ...
  tips: {
    canvas_hold_space_to_pan: 'กดค้างที่ Space และลากเพื่อเลื่อนดูแคนวาส',
    feature_auto_fit: 'หลังจากดูตัวอย่างกล้อง ใช้การกระทำ → ปรับให้พอดีอัตโนมัติเพื่อวางวัตถุบนวัสดุของคุณโดยอัตโนมัติ',
    feature_box_generator: 'ใช้ตัวสร้าง → ตัวสร้างกล่องเพื่อสร้างกล่องขนาดที่กำหนดเองในไม่กี่วินาที',
    feature_code_generator: 'ใช้ตัวสร้าง → ตัวสร้างบาร์โค้ดเพื่อสร้าง QR Code และบาร์โค้ด',
    feature_elements: 'แผงองค์ประกอบตอนนี้รวมกราฟิกกว่าหนึ่งล้านรายการที่พร้อมใช้งาน',
    feature_layer_color_configurations: 'แมปสีเลเยอร์ SVG กับความเร็วและพลังงานผ่านทาง แก้ไข → เลเยอร์ → การตั้งค่าสี',
    feature_material_test: 'ใช้ตัวสร้าง → ตัวสร้างการทดสอบวัสดุในแถบเครื่องมือด้านซ้ายเพื่อค้นหาการตั้งค่าที่ดีที่สุดสำหรับวัสดุอย่างรวดเร็ว',
    layer_execution_order: 'ลำดับเลเยอร์กำหนดลำดับงาน งานทำงานจากบนลงล่าง',
    machine_clean_mirror: 'ตรวจสอบกระจกและเลนส์โฟกัสเป็นประจำและทำความสะอาดเมื่อจำเป็นเพื่อป้องกันการสะสมของควัน',
    machine_no_unattended_operation: 'อย่าปล่อยให้เครื่องทำงานโดยไม่มีผู้ดูแล',
    machine_regular_start: 'เริ่มงานเลเซอร์อย่างน้อยสองสัปดาห์ละครั้งเพื่อช่วยยืดอายุการใช้งานของหลอดเลเซอร์',
    object_edit_image_to_erase: 'ใช้รูปภาพ → การกระทำ → แก้ไขรูปภาพเพื่อลบพื้นที่ที่ไม่ต้องการในภาพ',
    object_polygon_sides: 'ปรับจำนวนด้านในแผงคุณสมบัติของรูปหลายเหลี่ยม',
    object_rounded_rectangle: 'ตั้งค่ารัศมีมุมของสี่เหลี่ยมผืนผ้ามุมมนในแผงคุณสมบัติของสี่เหลี่ยมผืนผ้า',
    object_sharpen_portrait: 'ปรับปรุงการแกะสลักภาพบุคคลด้วย รูปภาพ → การกระทำ → ทำให้คม',
    settings_auto_save: 'เปิดใช้งานบันทึกอัตโนมัติในการตั้งค่าเพื่อหลีกเลี่ยงการสูญเสียงานของคุณ',
    settings_default_text_font: 'คุณสามารถตั้งค่าแบบอักษรเริ่มต้นสำหรับเครื่องมือข้อความในการตั้งค่า',
    task_focus_lower_for_cutting: 'สำหรับวัสดุที่หนากว่า การโฟกัสประมาณ 2 มม. ใต้พื้นผิวสามารถปรับปรุงผลการตัดได้',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 ไม่สามารถเชื่อมต่อกับกล้องได้ โปรดรีสตาร์ทเครื่องหรือ Beam Studio หากยังคงเกิดข้อผิดพลาดนี้ โปรดปฏิบัติตาม <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">คําแนะนํานี้</a>',
      fail_to_get_door_status: 'โปรดตรวจสอบให้แน่ใจว่าฝาครอบประตูปิด เพื่อเปิดใช้งานเลเซอร์ต่ํากําลังสําหรับการทํางาน',
      fail_to_start_preview: '#803 ไม่สามารถเริ่มโหมดแสดงตัวอย่างได้ โปรดรีสตาร์ทเครื่องของคุณหรือ Beam Studio หากยังคงเกิดข้อผิดพลาดนี้ โปรดปฏิบัติตาม <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">คําแนะนํานี้</a>',
      ...
      start_preview_timeout: '#803 หมดเวลาในการเริ่มโหมดแสดงตัวอย่าง โปรดรีสตาร์ทเครื่องของคุณหรือ Beam Studio หากยังคงเกิดข้อผิดพลาดนี้ โปรดปฏิบัติตาม <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">คําแนะนํานี้</a>',
    ...
    frame_task: 'การจัดองค์ประกอบภาพ',
    hint: {
    ...
    menu: {
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'ส่งออกข้อมูลการสอบเทียบ',
      ...
      import_hexa_rf_example: 'ตัวอย่าง HEXA RF',
      ...
      import_promark_engraving_example_1: 'ตัวอย่างการแกะสลัก Promark I',
      import_promark_engraving_example_2: 'ตัวอย่างการแกะสลัก Promark II',
      ...
      machines: 'เครื่อง',
      maintenance_checklist: 'รายการตรวจสอบการบำรุงรักษา',
    ...
    task_preview: 'ดูตัวอย่างเส้นทาง',
    untitled: 'ไม่มีชื่อ',
  },
  topmenu: {
