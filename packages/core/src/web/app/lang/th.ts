...
const lang: ILang = {
  ...
  beambox: {
    ...
    document_panel: {
      ...
      scale: 'มาตราส่วน',
      skip_prespray: 'ข้ามการพ่นล่วงหน้า',
      start_from: 'เริ่มจาก',
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: 'ดาวน์โหลดและพิมพ์ไฟล์ต่อไปนี้ลงบนกระดาษ A4 สำหรับการปรับเทียบกล้อง',
    put_chessboard_bm2_2: 'วางกระดาษปรับเทียบให้อยู่ในตำแหน่งที่กำหนดบนพื้นที่ทำงานอย่างเรียบ',
    ...
    put_paper: 'วางกระดาษ',
    put_paper_bm2_1: 'วางกระดาษสีขาวขนาด A4 หรือขนาด Letter สองแผ่นให้เรียบข้างกันในพื้นที่ทำงาน',
