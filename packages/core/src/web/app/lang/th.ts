...
const lang: ILang = {
  ...
  framing: {
    ...
    frame_preview_warning: 'การแสดงตัวอย่างกรอบจะหมุนหนึ่งรอบ โปรดหลีกเลี่ยงการหยุดกลางคันเพื่อป้องกันการเยื้องตำแหน่งการทำเครื่องหมาย หากต้องการดูตัวอย่างอีกครั้ง โปรดรอให้การหมุนเสร็จสิ้นก่อนคลิกอีกครั้ง',
