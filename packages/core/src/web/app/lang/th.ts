...
const lang: ILang = {
  ...
  monitor: {
    ...
    HARDWARE_ERROR_CARTRIDGE_POWERON_FAILED: '#930 ข้อผิดพลาดพลังงานตลับหมึก\nตรวจพบการเชื่อมต่อพลังงานผิดปกติที่ตลับหมึก กรุณาติดตั้งตลับหมึกใหม่แล้วลองอีกครั้ง',
