...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Sijainti: Kohdista kaiverrettuun pisteeseen vasemmassa yläkulmassa.',
    align_4_1: 'Sijainti: Kohdista kaiverrettuun pisteeseen oikeassa yläkulmassa.',
    align_4_2: 'Sijainti: Kohdista kaiverrettuun pisteeseen vasemmassa alakulmassa.',
    align_4_3: 'Sijainti: Kohdista kaiverrettuun pisteeseen oikeassa alakulmassa.',
    align_8_0: 'Sijainti: Kohdista kaiverrettuun pisteeseen vasemmassa yläkulmassa ulkopuolella.',
    align_8_1: 'Sijainti: Kohdista kaiverrettuun pisteeseen oikeassa yläkulmassa ulkopuolella.',
    align_8_2: 'Sijainti: Kohdista kaiverrettuun pisteeseen vasemmassa alakulmassa ulkopuolella.',
    align_8_3: 'Sijainti: Kohdista kaiverrettuun pisteeseen oikeassa alakulmassa ulkopuolella.',
    align_8_4: 'Sijainti: Kohdista kaiverrettuun pisteeseen vasemmassa yläkulmassa sisäpuolella.',
    align_8_5: 'Sijainti: Kohdista kaiverrettuun pisteeseen oikeassa yläkulmassa sisäpuolella.',
    align_8_6: 'Sijainti: Kohdista kaiverrettuun pisteeseen vasemmassa alakulmassa sisäpuolella.',
    align_8_7: 'Sijainti: Kohdista kaiverrettuun pisteeseen oikeassa alakulmassa sisäpuolella.',
    ...
    charuco_open_the_machine_lid: 'Avaa laitteen kansi.',
    charuco_place_charuco: 'Aseta tulostettu kalibrointikuvio vaakasuoraan työalueen <b>%s</b> kohtaan.',
    ...
    check_pnp_desc: 'Otimme kuvat uudelleen kalibrointitulosten perusteella ja merkitsimme kaiverruksen viitepisteet.\nTarkista, vastaavatko punaiset merkit todellisia kaiverruskohtia.\nJos havaitset selkeän epätarkkuuden, napsauta "Kalibroi uudelleen" yrittääksesi uudelleen.',
    ...
    solve_pnp_keep_door_closed: 'Pidä ovi suljettuna seuraavan prosessin aikana. Jos ovi avataan, järjestelmä yrittää sijoittaa kameran uudelleen.',
    ...
    solve_pnp_relocate_camera: 'Klikkaa "Siirrä kamera", jos laserpää ei ole vielä vaakasuunnassa keskitetty.',
  ...
  settings: {
    ...
    module_offset_4c: 'Tulostuksen (4C) siirtymä',
    ...
    module_offset_uv_varnish: 'Lakan siirtymä',
    module_offset_uv_white_ink: 'Valkomusteen siirtymä',
    none: 'Ei mitään',
    normal: 'Normaali',
