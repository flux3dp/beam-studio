...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Liian suurien nopeuksien käyttö 3D-käyräobjekteja sisältäville kerroksille voi vähentää kaiverruksen tarkkuutta.\nSuosittelemme pitämään nopeuden alle %(limit)s optimaalisten tulosten saavuttamiseksi 3D-käyräobjekteilla.',
      too_fast_for_curve_and_constrain: 'Seuraavat kerrokset: %(layers)s ylittävät nopeusrajan %(limit)s.\nKaiverrusnopeus 3D-käyräobjekteille rajoitetaan arvoon %(limit)s. Voit poistaa tämän rajoituksen Asetuksista.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: '3D-käyräobjektien kaiverrusnopeus rajoitetaan arvoon %(limit)s. Voit poistaa tämän rajoituksen Asetusten asetuksista.',
