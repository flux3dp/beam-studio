  ...
  beambox: {
    ...
    material_browser: {
      ...
      editor: {
        ...
        parent_hint: 'Jos asetettu, se näytetään paksuusvaihtoehtona ylätason materiaalin alla (ei ylimmässä ruudukossa).',
        parent_material: 'Ylätason materiaali',
        photo: 'Kuva',
        tags: 'Tunnisteet',
        thickness_inch: 'Paksuus (tuuma)',
        thickness_inch_hint: 'Murtoluvut ovat sallittuja',
        thickness_mm: 'Paksuus (mm)',
