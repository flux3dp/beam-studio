...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    hole: 'Reikä',
    hole_diameter: 'Halkaisija',
    hole_offset: 'Siirtymä',
    hole_position: 'Sijainti',
    hole_thickness: 'Paksuus',
    hole_type: 'Tyyppi',
    hole_type_punch: 'Lävistys',
    ...
    position_ref: 'Sijainti',
    position_ref_bottom_center: 'Ala',
    position_ref_left_center: 'Vasen',
    position_ref_right_center: 'Oikea',
    position_ref_top_center: 'Ylä',
