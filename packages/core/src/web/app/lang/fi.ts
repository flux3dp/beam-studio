...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'Tuloskoko (%s) ylittää suositellun enimmäiskoon %d × %d px. Käsittely voi kestää useita minuutteja ja tulos voi hidastaa Beam Studiota. Jatketaanko silti?',
