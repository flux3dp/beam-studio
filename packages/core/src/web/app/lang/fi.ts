...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_1: 'Tulosta shakkilauta (A4/Letter).',
    put_chessboard_2: 'Kiinnitä se tasaisesti jäykälle levylle.',
    put_chessboard_3: 'Aseta keskelle ja suorita automaattitarkennus.',
