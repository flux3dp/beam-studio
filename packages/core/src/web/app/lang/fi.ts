...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Kuinka parantaa tunnistuksen tarkkuutta?',
    ...
    retake_tooltip: 'Ota kamerakuva uudelleen kunkin kohteen sijainnissa paremman tunnistuksen saavuttamiseksi',
    retry_with_remove_bg: 'Poista tausta',
    retry_with_remove_bg_tooltip: 'Poista tausta esikatselukuvasta ääriviivan tunnistuksen parantamiseksi',
    rotation: 'Kiertää',
    ...
    use_original_image_tooltip: 'Palauta alkuperäinen esikatselukuva ilman taustan poistoa',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s AI-krediittiä',
      credit_balance: 'AI-krediittisaldo',
      credit_cost: 'Käytetyt AI-krediitit',
      description: 'Paranna kuvan resoluutiota ja yksityiskohtia tekoälyllä. Skaalattu kuva korvaa alkuperäisen piirtoalueella.',
      done: 'Generatiivinen skaalaus valmis',
      dpi_recommended: 'Suositus nykyiselle tason DPI:lle: %dx.',
      dpi_recommended_capped: 'Suositus nykyiselle tason DPI:lle: %dx, mutta %dx on suurin suositellun tuloskoon sisällä.',
      failed: 'Generatiivista skaalausta ei voitu suorittaa. Tarkista verkkoyhteys ja yritä uudelleen.',
      insufficient_credit: 'AI-krediitit eivät riitä generatiiviseen skaalaukseen.',
      layer_dpi: 'Tason DPI',
      original_size: 'Alkuperäinen koko',
      output_size: 'Tuloskoko',
      oversize_warning: 'Tuloskoko (%s) ylittää suositellun enimmäiskoon %dpx x %dpx. Käsittely voi kestää useita minuutteja ja tulos voi hidastaa Beam Studiota. Jatketaanko silti?',
      processing: 'Skaalataan…',
      processing_hint: 'Käsittelyaika riippuu kuvan koosta ja verkon tilasta.',
      recommended: 'Suositus',
      retry: 'Yritä uudelleen',
      start: 'Aloita skaalaus',
    },
    announcement_panel: {
      title: 'Tiedote',
    },
    ...
    document_panel: {
      ...
      auto_shrink_tooltip: 'Koskee vain tasoja, joiden resoluutio on vähintään 250 DPI.',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Liitä materiaaliin',
        bucket_hint: 'Tallennettu kokoelmaasi “Omat materiaalit” (Muut). Voit siirtää sen materiaaliin myöhemmin.',
        create_new: 'Luo uusi materiaali…',
        new_material_name: 'Uuden materiaalin nimi',
        preset_name: 'Esiasetuksen nimi',
        settings_from_layer: 'Asetukset kopioitu nykyisestä tasosta',
        title: 'Tallenna nykyisen tason asetukset esiasetukseksi',
      },
      add_material: 'Lisää materiaali',
      ...
      editor: {
        appearance: 'Ulkoasu',
        appearance_hint: 'Eikö kuvaa ole? Valitse sen sijaan kansiväri.',
        category: 'Kategoria',
        category_required: 'Valitse kategoria',
        color: 'Väri',
        name: 'Materiaalin nimi',
        name_required: 'Nimi on pakollinen',
        photo: 'Kuva',
        tags: 'Tunnisteet',
        title_add: 'Lisää materiaali',
        title_edit: 'Muokkaa materiaalia',
        upload_hint: 'Napsauta tai vedä kuva tähän. Suuri esikatselu näkyy galleriassa.',
      },
      enable: 'Ota käyttöön',
      export: 'Vie',
      favorites: 'Suosikit',
      from_current_layer: 'Nykyisestä tasosta',
      import: 'Tuo',
      machine: 'Laite',
      manual: 'Manuaalinen',
      manual_settings: 'Manuaaliset asetukset',
      modified: 'Parametreja on muokattu esiasetuksen käyttöönoton jälkeen',
      move_to_material: 'Siirrä materiaaliin…',
      new_preset_manual: 'Uusi esiasetus…',
      no_materials_in_category: 'Ei vielä materiaaleja kohteelle %s.',
      no_presets_for_machine: 'Ei vielä asetuksia kohteelle %s.',
      no_search_match: 'Mikään materiaali ei vastaa hakua “%s”.',
      preset_editor: {
        name: 'Esiasetuksen nimi',
        name_required: 'Nimi on pakollinen',
        title_edit: 'Muokkaa esiasetusta',
        title_new: 'Uusi esiasetus',
      },
      presets: 'Esiasetukset',
      recents: 'Viimeisimmät',
      recents_empty: 'Viimeksi käytetyt materiaalit näkyvät tässä.',
      regions: {
        auto: 'Automaattinen',
        eu: 'Eurooppa',
      ...
      restore_default: 'Palauta FLUX-oletus',
      result: 'Tulos',
      search_placeholder: 'Hae materiaaleja, tunnisteita, kategorioita…',
      settings_region: 'Materiaaliluettelon alue',
      settings_use: 'Käytä materiaaliselainta',
      showing_bundled: 'Näytetään sisäänrakennettu luettelo',
      state_customized: 'Mukautettu',
      state_default: 'Oletus',
      state_disabled: 'Poistettu käytöstä',
      state_user: 'Käyttäjän määrittämä',
      storage_full: 'Tallennustila on täynnä, materiaalikirjastoa ei voitu tallentaa. Käytä kuvien sijaan värikansia.',
      sure_to_delete_material: 'Poistetaanko tämä materiaali ja kaikki sen esiasetukset?',
      sure_to_delete_preset: 'Poistetaanko tämä esiasetus?',
      sure_to_delete_variant: 'Poistetaanko tämä paksuus ja sen esiasetukset?',
      sure_to_import: 'Tuonti yhdistää tiedoston materiaalikirjastoosi. Jatketaanko?',
      thickness: 'Paksuus',
      title: 'Materiaaliselain',
      variant_exists: 'Tämän paksuinen variantti on jo olemassa.',
      variants: '%d varianttia',
    },
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: 'Nopeampi työn luonti saatavilla',
        keep_current: 'Säilytä nykyinen',
        message: 'Olemme päivittäneet työn laskentamoottorin parantaaksemme suorituskykyä ja nopeuttaaksemme työn luontia.\nHaluatko vaihtaa uuteen nopeutettuun moottoriin?\nVoit kytkeä sen pois käytöstä milloin tahansa kohdassa %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'Käyräkaiverrusmoodissa nykyinen nopeus voi olla liian korkea ja voi vaikuttaa kaiverruksen yksityiskohtiin kerroksissa: %(layers)s.\nHarkitse nopeuden pienentämistä paremman laadun saavuttamiseksi.',
    ...
    right_panel: {
      laser_panel: {
        ...
        texture: 'Tekstuuri',
        texture_angle: 'Kulma',
        texture_intensity: 'Voimakkuus',
        texture_interval: 'Väli',
        texture_random: 'Satunnainen',
        texture_stripe: 'Raidat',
        times: 'kertaa',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Generatiivinen skaalaus',
          ai_upscale_short: 'Skaalaus',
          ai_upscale_too_large: 'Tämä kuva on liian suuri AI-suurennukseen. Suurin tuettu koko on %dpx x %dpx.',
          array: 'Taulukko',
          ...
          disabled_by_noun_project: 'Tämä muoto on immateriaalioikeuslain suojaama, joten sen polkua ei voi muokata.',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Siirrä laserpäätä kohdistamaan punainen valo <b>pisteen A</b> keskelle.',
    charuco_move_to_point_b: 'Siirrä laserpäätä vaakasuunnassa kohdistamaan punainen valo <b>pisteen B</b> keskelle.',
    ...
    check_pnp_desc: 'Varmista, että punaiset merkit ovat linjassa kaiverruskohtien kanssa\nJos eivät, napsauta "Takaisin" säätääksesi.\nJos kaikki on kunnossa, hienoa työtä! 🎉',
    ...
    put_charuco: 'Aseta kalibrointikuvio',
    put_charuco_1: 'Tulosta kalibrointikuvio (A4/Letter).',
    put_charuco_2: 'Kiinnitä se tasaisesti jäykälle levylle.',
    put_charuco_3: 'Aseta keskelle ja suorita automaattitarkennus.',
    put_charuco_bm2_1: 'Tulosta kalibrointikuviotiedosto A4 (Letter Size) -paperille kalibrointia varten.',
    put_charuco_bm2_2: 'Napsauta “Seuraava” ja seuraa ohjeita paperin asettamiseksi.',
    put_charuco_promark_2: "Varmista, että kalibrointipaperi näkyy selkeästi ilman häikäisyä. Napsauta 'Seuraava' ottaaksesi valokuvan.",
    put_charuco_promark_desc_1: 'Käytä lisävarustelaatikosta löytyvää kalibrointipaperia tai tulosta alla oleva kalibrointikuvio A4‑paperille kameran kalibrointia varten.',
    ...
    put_chessboard_promark_desc_2: 'Aseta shakkilauta tasaisesti ja keskelle työalustaa.',
    ...
    put_paper_promark: 'Aseta musta pahvi',
    put_paper_promark_1: 'Aseta musta pahvi tarvikelaatikosta työalustalle.',
    put_paper_promark_2: 'Säädä tarkennus oikein ja napsauta sitten "Aloita Kaiverrus" jatkaaksesi.',
  ...
  connection_issue_guide: {
    alert_link: 'Yhteys katkeaa? Kokeile tätä vianmääritystapaa.',
    connect_computer: {
      content: 'Tietokoneesi on oltava samassa verkossa kuin laite.',
      macos_steps: 'Napsauta Wi-Fi-kuvaketta valikkopalkissa. Valitse sitten puhelimesi yhteyspiste.',
      macos_title: 'macOS',
      title: 'Yhdistä tietokoneesi',
      windows_steps: 'Napsauta verkkokuvaketta tehtäväpalkissa. Valitse sitten puhelimesi yhteyspiste.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Laite ei löydä yhteyspistettäni',
      dont_know_hotspot_name: 'En tiedä yhteyspisteeni nimeä',
      step1: '1. Siirry laitteen kosketusnäytöllä kohtaan: Verkko → Yhdistä Wi-Fi-verkkoon.',
      step2: '2. Etsi ja valitse puhelimesi yhteyspisteen nimi Wi-Fi-luettelosta.',
      step3: '3. Syötä yhteyspisteen salasana ja yhdistä.',
    ...
    enter_ip: {
      ...
      step1: 'Syötä edellisessä vaiheessa löytämäsi IP-osoite.',
      step2: 'Napsauta "Vahvista" testataksesi yhteyden.',
      step3: 'Beam Studio tarkistaa:',
      title: 'Syötä laitteesi IP-osoite',
      verify: 'Vahvista',
    },
    fail: {
      bullet1: '• Laitteesi malli ja sarjanumero',
      bullet2: '• Kosketusnäytöllä näkyvä IP-osoite',
      bullet3: '• Kuvaus kohtaamastasi virheestä',
      contact_title: 'Kun otat yhteyttä tukeen, on hyödyllistä, että sinulla on:',
      intro: 'Älä huoli — tämä ei välttämättä tarkoita, että laitteessasi olisi jotain vikaa. Yhteyteen voi vaikuttaa muitakin tekijöitä. Tukitiimimme auttaa sinua mielellään selvittämään asian.',
      title: 'Emme voineet suorittaa testiä loppuun',
    },
    hotspot: {
      android_steps: 'Asetukset → Yhteydet → Mobiilipiste ja jaettu yhteys → Mobiilipiste',
      android_title: 'Android',
      ios_steps: 'Asetukset → Henkilökohtainen yhteyspiste → Salli muiden liittyä',
      ios_title: 'iPhone (iOS)',
      tip: 'Vinkki: Käytä yksinkertaista englanninkielistä yhteyspisteen nimeä ja numeerista salasanaa (esim. Nimi: FLUX_Test   Salasana: 12345678)',
      warning_2_4ghz: 'Tärkeää: FLUX-laitteet tukevat vain 2.4GHz Wi-Fi-verkkoa. Aseta yhteyspiste 2.4GHz-taajuudelle ennen jatkamista.',
    },
    how_it_works: 'Näin testi toimii:',
    how_it_works_step1: '1. Määritä puhelimesi Wi-Fi-yhteyspisteeksi.',
    how_it_works_step2: '2. Yhdistä laite yhteyspisteeseen.',
    how_it_works_step3: '3. Yhdistä tietokoneesi samaan yhteyspisteeseen.',
    how_it_works_step4: '4. Testaa yhteys Beam Studiossa.',
    intro: 'Suoritetaan nopea testi, jolla tarkistetaan, toimiiko laitteesi oikein. Yhdistämme laitteesi ja tietokoneesi matkapuhelimesi yhteyspisteen kautta selvittääksemme, johtuuko ongelma verkostasi vai itse laitteesta.',
    ip_address: {
      step1: 'Siirry laitteen kosketusnäytöllä kohtaan:\nVerkko → Etsi "IP-osoite"',
      step2: 'IP näyttää yleensä tältä: 172.20.10.x tai 192.168.x.x\n(Tämä riippuu puhelimesi yhteyspisteestä)',
      step3: 'Kirjoita tämä IP-osoite muistiin seuraavaa vaihetta varten.',
      title: 'Etsi laitteesi IP-osoite',
      warning: 'Jos IP alkaa numerolla 169.254, yhteys epäonnistui. Palaa vaiheeseen 1 ja yritä uudelleen.',
    },
    success: {
      cause: 'Kokemasi yhteysongelma johtuu todennäköisimmin paikallisen verkkosi ympäristöstä, ei itse laitteesta.',
      intro: 'Suoritit Wi-Fi-yhteystestin onnistuneesti — hienoa työtä! Tämä vahvistaa, että FLUX-laitteesi toimii moitteettomasti.',
      recommend1: '• Ota yhteyttä internetpalveluntarjoajaasi (ISP) tai reitittimesi valmistajaan saadaksesi apua Wi-Fi-asetuksissa',
      recommend2: '• Kysy verkonvalvojalta, jos olet koulussa, toimistossa tai jaetussa työtilassa',
      recommend3: '• Tarkista, tukeeko reitittimesi 2.4GHz-taajuutta, ja yritä käynnistää se uudelleen',
      recommend_title: 'Suosituksemme:',
      title: 'Hienoa työtä! 🎉',
    },
    title: 'Yhteysongelma?',
  },
  ...
  generators: {
    ...
    keychain_generator: 'Avaimenperägeneraattori',
    material_test_generator: 'Materiaalitestin Generaattori',
    puzzle_generator: 'Palapeligeneraattori',
    title: 'Generaattorit',
  },
  generic_error: {
  ...
  keychain_generator: {
    ...
    text_options: {
      ...
      font_settings: 'Kirjasinasetukset',
      font_size: 'Kirjasinkoko',
      font_style: 'Kirjasintyyli',
      letter_spacing: 'Kirjainväli',
      line_spacing: 'Riviväli',
  ...
  machine_linking: {
    continue: 'Jatka',
    i_have_read: 'Olen lukenut',
    input_birthday_to_link: 'Syötä syntymäpäiväsi laitteen yhdistämisen viimeistelemiseksi',
    input_birthday_to_link_note: '*Käytetään ikäsi kelpoisuusvaatimusten täyttymisen tarkistamiseen',
    link_failed: 'Linkitys epäonnistui.',
    link_failed_already_linked: 'Tämä laite on tällä hetkellä linkitetty toiseen FLUX ID:hen. Voit jatkaa sen käyttöä tai linkittää sen tiliisi.',
    link_failed_cannot_set_secret: 'Linkitystietoja ei voi tallentaa laitteeseen. Tarkista tietokoneen ja laitteen välinen yhteys.',
    link_failed_under_age: 'Et täytä tällä hetkellä tämän palvelun käyttövaatimuksia etkä voi suorittaa laitteen yhdistämistä loppuun.',
    link_machine: 'Linkitä FLUX ID',
    link_machine_to_account: 'Yhdistetty laitteeseen %(name)s. Haluatko linkittää tämän laitteen tiliisi?',
    link_success: 'Linkitys onnistui.',
    link_to_my_flux_id: 'Linkitä omaan FLUX ID:hen',
    privacy_policy: 'Tietosuojakäytäntö',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Linkitetään…',
    use_without_linking: 'Käytä ilman linkitystä',
  },
  machine_status: {
    '-17': 'Kasetin IO-tila',
    '-10': 'Huoltotila',
  ...
  maintenance: {
    ...
    areas: {
      back_cover: 'Takakansi',
      modules: 'Moduulit',
      optics: 'Optiikka',
      panel: 'Paneeli',
      working_area: 'Työalue',
    },
    cadence: {
      by_material: 'Materiaalin mukaan',
      condition: 'Tilanteen mukaan',
      day: 'Päivittäin',
      days: '%s päivän välein',
      each_operation: 'Joka käyttökerta',
      every_1_2_weeks: '1–2 viikon välein',
      month: 'Kuukausittain',
      months: '%s kuukauden välein',
      upon_unboxing: 'Ensimmäisessä käyttöönotossa',
      week: 'Viikoittain',
      weeks: '%s viikon välein',
    },
    celebration: {
    ...
    feedback: {
      ...
      fail_warning: '%s: merkitty laserputken vaihtoon. Avaa ohje nähdäksesi vaiheet.',
      passed: '%s hyväksytty — laserputki on hyvässä kunnossa!',
    },
    footer_tip: 'Vinkki: kaiverra näytetiedosto kuukausittain pitääksesi koneen hyvässä kunnossa.',
    history_hint: 'Kustakin tehtävästä säilytetään vain %s viimeisintä merkintää.',
    intro: 'Seuraa tämän koneen huoltotehtäviä ja merkitse ne tehdyiksi yhdellä napsautuksella.',
    legend: {
      due_soon: 'Erääntyy pian',
      overdue: 'Myöhässä',
    ...
    status: {
      ...
      healthy: 'Kunnossa',
      last: 'Viimeksi tehty',
      never_done: 'Ei koskaan tehty',
      next: 'Seuraava eräpäivä',
      not_checked: 'Ei tarkistettu',
      not_logged: 'Ei kirjattu',
      overdue: 'Myöhässä',
      replace_tube: 'Vaihda putki',
    },
    tasks: {
      align: {
        keyPoints: 'Säädä, kun optinen rata on väärin kohdistettu.',
        name: 'Optisen radan kohdistus',
      },
      chassis: {
        keyPoints: 'Poista jäämät ja tervaöljy rungosta ja pohjakannesta.',
        name: 'Rungon puhdistus',
      },
      door: {
        keyPoints: 'Poista rasva luukun kannesta.',
        name: 'Luukun kannen puhdistus',
      },
      exhaust: {
        keyPoints: 'Puhdista pöly puhaltimen siivistä.',
        name: 'Poistopuhaltimen puhdistus',
      },
      fan: {
        keyPoints: 'Poista pöly tuuletuspuhaltimen siivistä.',
        name: 'Tuuletuspuhaltimen puhdistus',
      },
      fieldlens: {
        keyPoints: 'Puhdista kenttälinssi pyyhkien keskeltä ulospäin myötäpäivään.',
        name: 'Kenttälinssin puhdistus',
      },
      honeycomb_plate: {
        keyPoints: 'Poista jäämät ja terva hunajakennolevyn ritilöistä.',
        name: 'Hunajakennolevyn puhdistus',
      },
      honeycomb_table: {
        keyPoints: 'Poista jäämät ja tervaöljy hunajakennoverkosta.',
      ...
      maintain_test: {
        keyPoints: 'Tarkista tilanäyttö ja kytkimet.',
        name: 'MAINTAIN-sivu',
      },
      mirrors_combiner: {
        keyPoints: 'Poista lika linsseistä/peileistä; tarkista hapettuminen. Ei alkoholi- tai vesijälkiä.',
        name: 'Peilit, tarkennuslinssi ja säteenyhdistin',
      },
      mirrors_lens: {
        keyPoints: 'Puhdista 4 peiliä ja linssi; varmista, ettei hapettumista tai vesijälkiä ole.',
        name: 'Peilien ja linssin puhdistus',
      },
      mod_diode: {
        keyPoints: 'Puhdista tuuletin, tarkennuslinssi ja POGO pin.',
        name: 'Diodilasermoduuli',
      },
      mod_ir: {
        keyPoints: 'Puhdista tarkennuslinssi.',
        name: 'Infrapunalasermoduuli',
      },
      optical_inspection: {
        keyPoints: 'Tarkasta optinen rata; myös käyttöönotossa ja putken vaihdon jälkeen.',
        name: 'Optisen radan tarkastus',
      },
      optical_unboxing: {
        keyPoints: 'Varmista, että optinen rata on tarkka. Tarkista ensimmäisessä käyttöönotossa.',
        name: 'Optisen radan tarkastus',
      },
      screen: {
        keyPoints: 'Puhdista pöly ja rasva paneelista.',
        name: 'Näytön puhdistus',
      },
      tube: {
        keyPoints: 'Jos 3 mm akryyliä ei voi leikata 70 %:n teholla, vaihda laserputki.',
        name: 'Laserputken kuntotarkistus',
      },
      water: {
        keyPoints: 'Lisää vettä, kunnes säiliö on yli 80 % täynnä eikä ilmakuplia ole.',
        name: 'Jäähdytysveden vaihto',
      },
      worktable: {
        keyPoints: 'Suihkuta alkoholia liinaan ja pyyhi työtaso.',
        name: 'Työtason puhdistus',
      },
      zaxis: {
        keyPoints: 'Pyyhi Z-akselin pylvään ruuvi ja levitä voiteluainetta tasaisesti vanupuikolla.',
        name: 'Z-akselin pylvään voitelu',
      },
    },
    title: 'Huoltolista',
  },
  ...
  message: {
    ...
    camera: {
      ...
      fail_to_transmit_image: '#845 Kuvan siirrossa tapahtui virhe. Käynnistä kone tai Beam Studio uudelleen. Jos virhe ei poistu, noudata <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">tätä ohjetta</a>.',
      switching_camera: 'Vaihdetaan kameraa...',
      wide_angle_open_door: 'Avaa ovensuojus',
      wide_angle_open_door_text: 'Avaa ovensuojus ennen kuin vaihdat laajakulmakameraan.',
  ...
  params_label: {
    ...
    placeholder: 'Parametrinimike',
    preview_hint: 'Tämä on esikatselu. Tekstisisältö päivitetään automaattisesti ennen työn lähettämistä',
    save_as_default: 'Tallenna oletukseksi',
    settings: 'Parametrinimikkeen asetukset',
    update: 'Päivitä',
    updated: 'Parametrinimike päivitetty',
    use_default: 'Käytä tallennettua oletusta',
    use_recommended: 'Käytä suositeltuja',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      calculating: 'Lasketaan…',
      capturing: 'Otetaan kuvaa',
      completing: 'Valmistuu pian',
      detecting: 'Tunnistetaan kohdistusmerkkejä',
      locating: 'Etsitään kohdistusmerkkejä',
      preparing: 'Valmistellaan kameraa',
      refining: 'Tarkennetaan merkkien sijaintia',
    },
    alignment: {
    ...
    calibration: {
      align_desc: '1. Aseta tulostettu kalibrointiarkki työalueelle, kiinnitä se teipillä tai maalarinteipillä, jotta se ei liiku, ja tarkenna.\n2. Napsauta ”Esikatsele ja kohdista” suorittaaksesi kamerakohdistuksen.\n3. Kun merkit on löydetty, napsauta ”Raaputa asteikot”, jolloin viiteviivat raaputetaan arkille pienellä teholla.',
      aligned: 'Kohdistusmerkit tunnistettu. Valmis raaputtamaan.',
      auto_read: 'Lue asteikot kameralla',
      auto_read_failed: 'Asteikkoja ei voitu lukea automaattisesti. Lue ne silmämääräisesti ja syötä arvot.',
      auto_read_hint: 'Kameran lukema voi poiketa jopa ±2; tarkista se arkista.',
      current_offset: 'Nykyinen siirtymä: X %s mm, Y %s mm',
      export_pdf: 'Vie kalibrointi-PDF',
      power: 'Teho',
      print_desc: '1. Vie kalibrointiarkin PDF. Se sisältää neljä kohdistusmerkkiä ja kaksi asteikkoa.\n2. Tulosta arkki 100 %:n koossa (todellinen koko).',
      reading_desc: '1. Etsi pisin raaputettu viiva (keskimmäinen) ja katso, kummalla puolella tulostettua 0-viivaa se on.\n2. Siirry viiva kerrallaan siihen suuntaan, kunnes raaputettu viiva ja tulostettu viiva osuvat tarkalleen kohdakkain.\n3. Laske nollasta tuohon tulostettuun viivaan (numerot on tulostettu joka 5. viivan kohdalle; laske myös numeroimattomat viivat välissä).',
      reading_x: 'X-lukema',
      reading_y: 'Y-lukema',
      scratch: 'Raaputa asteikot',
      speed: 'Nopeus',
      title: 'Tulosta ja leikkaa -kalibrointi',
    },
    ...
    export_pdf: 'Vie PDF',
    finish: 'Valmis',
    fit_content: 'Sovita sisältöön',
    generate_from_contour: 'Luo ääriviivasta',
    grid_columns: 'Sarakkeet',
    grid_rows: 'Rivit',
    ...
    orientation: 'Suunta',
    orientation_landscape: 'Vaaka',
    orientation_portrait: 'Pysty',
    paper_size: 'Tulosteen koko',
    paper_too_small: 'Tulostusalue on liian pieni. Suunnitelma (kohdistusmerkit mukaan lukien) tarvitsee vähintään %s mm marginaalin materiaalin reunasta pysyäkseen tulostimen tulostettavalla alueella. Valitse suurempi tulosteen koko, muuten tuloste rajautuu tai pienenee.',
    preview_and_align: 'Esikatsele ja kohdista',
    resume_desc: 'Tämä suunnitelma on jo valmisteltu Tulosta ja leikkaa -toimintoa varten.\nAseta seuraava tulostettu materiaali koneeseen ja jatka kamerakohdistukseen, tai aloita alusta vaihtaaksesi suunnitelman, tulosteen koon tai leikkausreitin.',
    resume_title: 'Jatka Tulosta ja leikkaa -toimintoa',
    select_cut_layer: 'Leikkausreitin taso',
    ...
    step_setup: 'Leikkausreitit ja merkit',
    ...
    uv_print_file_disabled: 'Tulosta ja leikkaa tulostaa UV-tulostustasojen sisällön. Ota asetuksista käyttöön "Ota käyttöön UV-tulostustiedosto" ja lisää sitten suunnitelmasi UV-tulostustasolle.',
  ...
  puzzle_generator: {
    ...
    columns: 'Sarakkeet',
    design_preview: 'Suunnitelman esikatselu',
    exploded_view: 'Räjäytyskuva',
    export_as: 'Vie muodossa',
    export_engrave: 'Kaiverrustaso',
    export_failed: 'Palapelin tuonti piirtoalustalle epäonnistui. Yritä uudelleen tai säädä palapelin asetuksia.',
    export_none: 'Ei mitään',
    export_print: 'Tulostustaso',
    file_too_large: 'Valittu tiedosto ylittää suurimman sallitun koon.',
    ...
    orientation_type_1: 'Tyyppi 1',
    orientation_type_2: 'Tyyppi 2',
    orientation_type_3: 'Tyyppi 3',
    orientation_type_4: 'Tyyppi 4',
    piece_size: 'Palojen koko',
    preview_placeholder: 'Palapelin esikatselu',
    puzzle_board: 'Palapohjalauta',
    puzzle_pieces: 'Palapelin palat',
    radius: 'Säde',
    ...
    types: {
      ...
      heart_jigsaw: 'Sydämenmuotoinen palapeli',
      hex_jigsaw: 'Kuusikulmio palapeli',
      rectangle_jigsaw: 'Suorakulmio palapeli',
    },
    unsupported_file_type: 'Ei-tuettu tiedostotyyppi. Käytä JPG, PNG tai WebP.',
    upload_hint: 'JPG, PNG, WebP (enint. 10Mt)',
    upload_image: 'Napsauta tai vedä lataaksesi',
    zoom: 'Zoomaus',
  },
  qr_code_generator: {
  ...
  tips: {
    canvas_hold_space_to_pan: 'Pidä välilyöntiä pohjassa ja vedä panoroidaksesi kankaalla.',
    feature_auto_fit: 'Kameran esikatselun jälkeen käytä Toiminnot → Automaattinen sovitus sijoittaaksesi kohteet automaattisesti materiaalillesi.',
    feature_box_generator: 'Käytä Generaattorit → Laatikkogeneraattori luodaksesi mukautetun kokoisia laatikoita sekunneissa.',
    feature_code_generator: 'Käytä Generaattorit → Viivakoodigeneraattori luodaksesi QR-koodeja ja viivakoodeja.',
    feature_elements: 'Elementit-paneeli sisältää nyt yli miljoona grafiikkaa käyttövalmiina.',
    feature_layer_color_configurations: 'Kartoita SVG-tasovärit nopeuteen ja tehoon kautta Muokkaa → Taso → Väriasetukset.',
    feature_material_test: 'Käytä Generaattorit → Materiaalitestigeneraattori vasemmassa työkalupalkissa löytääksesi nopeasti parhaat asetukset materiaalille.',
    layer_execution_order: 'Tasojärjestys määrittää työn järjestyksen. Työt suoritetaan ylhäältä alas.',
    machine_clean_mirror: 'Tarkista peilit ja tarkennuslinssi säännöllisesti ja puhdista tarvittaessa savun kertymisen estämiseksi.',
    machine_no_unattended_operation: 'Älä koskaan jätä konetta käyntiin ilman valvontaa.',
    machine_regular_start: 'Suorita lasertyö vähintään kerran kahden viikon välein auttaaksesi pidentämään laserputken käyttöikää.',
    object_edit_image_to_erase: 'Käytä Kuva → Toiminnot → Muokkaa kuvaa poistaaksesi ei-toivottuja alueita kuvasta.',
    object_polygon_sides: 'Säädä sivujen määrää monikulmion ominaisuuspaneelissa.',
    object_rounded_rectangle: 'Aseta pyöristetyn suorakulmion kulman säde suorakulmion ominaisuuspaneelissa.',
    object_sharpen_portrait: 'Paranna muotokuvakaiveruksia käyttämällä Kuva → Toiminnot → Terävöitä.',
    settings_auto_save: 'Ota automaattinen tallennus käyttöön asetuksissa välttääksesi työsi menettämisen.',
    settings_default_text_font: 'Voit asettaa oletusfontin tekstityökalulle asetuksissa.',
    task_focus_lower_for_cutting: 'Paksuimmille materiaaleille tarkentaminen noin 2 mm pinnan alapuolelle voi parantaa leikkaustuloksia.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Yhteyden muodostaminen kameraan epäonnistui. Käynnistä tietokone tai Beam Studio uudelleen. Jos virhe toistuu, noudata <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">näitä ohjeita</a>.',
      fail_to_get_door_status: 'Varmista, että ovensuojus on kiinni, jotta kehys voidaan käynnistää matalalla teholla.',
      fail_to_start_preview: '#803 Esikatselutilan käynnistys epäonnistui. Käynnistä kone tai Beam Studio uudelleen. Jos virhe toistuu, noudata <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">tätä ohjetta</a>.',
      ...
      start_preview_timeout: '#803 Aikakatkaisu esikatselutilan käynnistyksessä. Käynnistä kone tai Beam Studio uudelleen. Jos virhe toistuu, noudata <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">tätä ohjetta</a>.',
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Kalibroi Tulosta ja leikkaa',
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Vie kalibrointitiedot',
      ...
      machines: 'Koneet',
      maintenance_checklist: 'Huoltolista',
