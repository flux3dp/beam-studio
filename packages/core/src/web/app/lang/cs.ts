...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Pozice: Zarovnejte s vyrytým bodem vlevo nahoře.',
    align_4_1: 'Pozice: Zarovnejte s vyrytým bodem vpravo nahoře.',
    align_4_2: 'Pozice: Zarovnejte s vyrytým bodem vlevo dole.',
    align_4_3: 'Pozice: Zarovnejte s vyrytým bodem vpravo dole.',
    align_8_0: 'Pozice: Zarovnejte s vnějším vyrytým bodem vlevo nahoře.',
    align_8_1: 'Pozice: Zarovnejte s vnějším vyrytým bodem vpravo nahoře.',
    align_8_2: 'Pozice: Zarovnejte s vnějším vyrytým bodem vlevo dole.',
    align_8_3: 'Pozice: Zarovnejte s vnějším vyrytým bodem vpravo dole.',
    align_8_4: 'Pozice: Zarovnejte s vnitřním vyrytým bodem vlevo nahoře.',
    align_8_5: 'Pozice: Zarovnejte s vnitřním vyrytým bodem vpravo nahoře.',
    align_8_6: 'Pozice: Zarovnejte s vnitřním vyrytým bodem vlevo dole.',
    align_8_7: 'Pozice: Zarovnejte s vnitřním vyrytým bodem vpravo dole.',
    ...
    charuco_open_the_machine_lid: 'Otevřete víko zařízení.',
    charuco_place_charuco: 'Umístěte vytištěný kalibrační vzor vodorovně na <b>%s</b> pracovní plochy.',
    ...
    check_pnp_desc: 'Znovu jsme pořídili snímky na základě výsledků kalibrace a označili referenční body gravírování.\nZkontrolujte, zda červené značky odpovídají skutečným místům gravírování.\nPokud vidíte zjevnou nesrovnalost, klikněte na „Znovu kalibrovat“ a zkuste to znovu.',
    ...
    solve_pnp_keep_door_closed: 'Během následujícího procesu mějte dveře zavřené. Pokud se dveře otevřou, systém se pokusí znovu lokalizovat kameru.',
    ...
    solve_pnp_relocate_camera: 'Pokud hlava laseru stále není vodorovně vycentrovaná, klikněte na „Přemístit kameru".',
