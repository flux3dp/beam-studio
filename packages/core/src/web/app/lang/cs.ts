  ...
  beambox: {
    ...
    material_browser: {
      ...
      editor: {
        ...
        parent_hint: 'Pokud je nastaven, zobrazí se jako varianta tloušťky pod nadřazeným materiálem (ne v hlavní mřížce).',
        parent_material: 'Nadřazený materiál',
        photo: 'Fotografie',
        tags: 'Štítky',
        thickness_inch: 'Tloušťka (palce)',
        thickness_inch_hint: 'Lze zadat zlomek',
        thickness_mm: 'Tloušťka (mm)',
