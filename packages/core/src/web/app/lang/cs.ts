...
const lang: ILang = {
  ...
  beambox: {
    ...
    document_panel: {
      ...
      rotary_mode: 'Rotační',
      scale: 'Měřítko',
      skip_prespray: 'Přeskočit předspray',
      start_from: 'Začít od',
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: 'Stáhněte a vytiskněte následující soubor na papír formátu A4 pro kalibraci kamery.',
    put_chessboard_bm2_2: 'Umístěte kalibrační papír naplocho na určené místo na pracovním stole.',
