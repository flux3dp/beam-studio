    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          diabled_by_gradient: 'Před použitím této funkce prosím vypněte přechod.',
          diabled_by_infilled: 'Před použitím této funkce zavřete výplň.',
          diabled_by_infilled_and_variable_text: 'Před použitím této funkce zavřete výplň a proměnný text.',
          diabled_by_variable_text: 'Před použitím této funkce zavřete proměnný text.',
