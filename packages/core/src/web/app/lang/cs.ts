...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Použití příliš vysokých rychlostí u vrstev obsahujících 3D křivkové objekty může snížit přesnost gravírování.\nDoporučujeme udržovat rychlost pod %(limit)s pro optimální výsledky s 3D křivkovými objekty.',
      too_fast_for_curve_and_constrain: 'Následující vrstvy: %(layers)s překračují rychlostní limit %(limit)s.\nRychlost gravírování pro 3D křivkové objekty bude omezena na %(limit)s. Tento limit můžete odstranit v nastavení Předvoleb.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'Rychlost gravírování 3D křivkových objektů bude omezena na %(limit)s. Toto omezení můžete odstranit v Nastavení předvoleb.',
  ...
  settings: {
    ...
    curve_engraving_speed_limit: 'Omezení rychlosti 3D křivky',
  ...
  z_speed_limit_test: {
    alert_before: 'Před zahájením 3D gravírování systém provede test zatížení, aby se zabránilo ztrátě kroků v důsledku nadměrné hmotnosti.',
