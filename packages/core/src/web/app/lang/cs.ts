...
const lang: ILang = {
  ...
  beambox: {
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Přiřadit k materiálu',
        bucket_hint: 'Uloženo do vaší kolekce „Moje materiály“ (Ostatní). Později jej můžete přesunout k materiálu.',
        create_new: 'Vytvořit nový materiál…',
        new_material_name: 'Název nového materiálu',
        preset_name: 'Název předvolby',
        settings_from_layer: 'Nastavení zkopírováno z aktuální vrstvy',
        title: 'Uložit nastavení aktuální vrstvy jako předvolbu',
      },
      ...
      editor: {
        appearance: 'Vzhled',
        appearance_hint: 'Nemáte fotografii? Zvolte místo ní barvu obalu.',
        category: 'Kategorie',
        category_required: 'Vyberte kategorii',
        color: 'Barva',
        name: 'Název materiálu',
        name_required: 'Název je povinný',
        photo: 'Fotografie',
        tags: 'Štítky',
        title_add: 'Přidat materiál',
        title_edit: 'Upravit materiál',
        upload_hint: 'Klikněte nebo přetáhněte fotografii. V galerii se zobrazí velký náhled.',
      },
      enable: 'Povolit',
      export: 'Exportovat',
      favorites: 'Oblíbené',
      from_current_layer: 'Z aktuální vrstvy',
      import: 'Importovat',
      machine: 'Zařízení',
      manual: 'Ručně',
      manual_settings: 'Ruční nastavení',
      modified: 'Parametry byly od použití předvolby upraveny',
      move_to_material: 'Přesunout k materiálu…',
      new_preset_manual: 'Nová předvolba…',
      no_materials_in_category: 'Pro %s zde zatím nejsou žádné materiály.',
      no_presets_for_machine: 'Pro %s zatím nejsou žádná nastavení.',
      no_search_match: 'Výrazu „%s“ neodpovídají žádné materiály.',
      preset_editor: {
        name: 'Název předvolby',
        name_required: 'Název je povinný',
        title_edit: 'Upravit předvolbu',
        title_new: 'Nová předvolba',
      },
      presets: 'Předvolby',
      recents: 'Nedávné',
      recents_empty: 'Nedávno použité materiály se zobrazí zde.',
      regions: {
        auto: 'Automaticky',
        eu: 'Evropa',
        global: 'Globální',
      ...
      restore_default: 'Obnovit výchozí nastavení FLUX',
      result: 'Výsledek',
      search_placeholder: 'Hledat materiály, štítky, kategorie…',
      settings_region: 'Region katalogu materiálů',
      settings_use: 'Používat prohlížeč materiálů',
      showing_bundled: 'Zobrazuje se vestavěný katalog',
      state_customized: 'Přizpůsobeno',
      state_default: 'Výchozí',
      state_disabled: 'Zakázáno',
      state_user: 'Uživatelské',
      storage_full: 'Úložiště je plné, knihovnu materiálů se nepodařilo uložit. Použijte místo fotografií barevné obaly.',
      sure_to_delete_material: 'Smazat tento materiál a všechny jeho předvolby?',
      sure_to_delete_preset: 'Smazat tuto předvolbu?',
      sure_to_delete_variant: 'Smazat tuto tloušťku a její předvolby?',
      sure_to_import: 'Import sloučí soubor s vaší knihovnou materiálů. Pokračovat?',
      thickness: 'Tloušťka',
      title: 'Prohlížeč materiálů',
      variant_exists: 'Varianta s touto tloušťkou již existuje.',
      variants: '%d variant',
    },
  ...
  print_and_cut: {
    ...
    calibration: {
      align_desc: '1. Umístěte vytištěný kalibrační list do pracovní oblasti, přilepte ho páskou nebo maskovací páskou, aby se neposunul, a zaostřete.\n2. Klikněte na „Náhled a zarovnání“ pro spuštění zarovnání kamerou.\n3. Po nalezení značek klikněte na „Vyrýt stupnice“, čímž se na list nízkým výkonem vyryjí referenční čáry.',
      aligned: 'Zarovnávací značky nalezeny. Připraveno k rytí.',
      auto_read: 'Přečíst stupnice kamerou',
      auto_read_failed: 'Stupnice se nepodařilo přečíst automaticky. Odečtěte je okem a zadejte hodnoty.',
      auto_read_hint: 'Odečet kamerou se může lišit až o ±2; zkontrolujte jej podle listu.',
      current_offset: 'Aktuální posun: X %s mm, Y %s mm',
      export_pdf: 'Exportovat kalibrační PDF',
      power: 'Výkon',
      print_desc: '1. Exportujte PDF kalibračního listu. Obsahuje čtyři zarovnávací značky a dvě stupnice.\n2. Vytiskněte list v měřítku 100 % (skutečná velikost).',
      reading_desc: '1. Najděte nejdelší vyrytou čáru (prostřední) a všimněte si, na které straně tištěné čáry 0 leží.\n2. Postupujte čáru po čáře tímto směrem, dokud vyrytá čára přesně nelícuje s tištěnou čárou.\n3. Spočítejte od 0 k této tištěné čáře (čísla jsou vytištěna u každé 5. čáry; nečíslované čáry mezi nimi počítejte také).',
      reading_x: 'Odečet X',
      reading_y: 'Odečet Y',
      scratch: 'Vyrýt stupnice',
      speed: 'Rychlost',
      title: 'Kalibrace Tisk a řez',
    },
  ...
  topbar: {
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Kalibrovat Tisk a řez',
