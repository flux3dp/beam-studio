...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    retake_tooltip: 'Znovu vyfotit na pozici každého objektu pro lepší detekci',
    retry_with_remove_bg: 'Odstranit pozadí',
    retry_with_remove_bg_tooltip: 'Odstranit pozadí z náhledového obrázku pro zlepšení detekce obrysů',
    rotation: 'Otočit',
    ...
    use_original_image_tooltip: 'Obnovit původní náhledový obrázek bez odstranění pozadí',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s AI kreditů',
      credit_balance: 'Zůstatek AI kreditů',
      credit_cost: 'Použité AI kredity',
      description: 'Zvyšte rozlišení a detaily obrázku pomocí AI. Zvětšený obrázek nahradí originál na plátně.',
      done: 'Generativní zvětšení dokončeno',
      dpi_recommended: 'Doporučeno pro aktuální DPI vrstvy: %dx.',
      dpi_recommended_capped: 'Doporučeno pro aktuální DPI vrstvy: %dx, ale %dx je maximum v rámci doporučené výstupní velikosti.',
      failed: 'Generativní zvětšení se nepodařilo dokončit. Zkontrolujte síťové připojení a zkuste to znovu.',
      insufficient_credit: 'Nedostatek AI kreditů pro spuštění generativního zvětšení.',
      layer_dpi: 'DPI vrstvy',
      original_size: 'Původní velikost',
      output_size: 'Výstupní velikost',
      oversize_warning: 'Výstupní velikost (%s) překračuje doporučené maximum %dpx x %dpx. Zpracování může trvat několik minut a výsledek může zpomalit Beam Studio. Přesto pokračovat?',
      processing: 'Zvětšování…',
      processing_hint: 'Doba zpracování závisí na velikosti obrázku a stavu sítě.',
      recommended: 'Doporučeno',
      retry: 'Zkusit znovu',
      start: 'Spustit zvětšení',
    },
    announcement_panel: {
      title: 'Ohlášení',
    },
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: 'K dispozici rychlejší generování úloh',
        keep_current: 'Zachovat současné',
        message: 'Vylepšili jsme výpočetní engine úloh pro zlepšení výkonu a zrychlení generování úloh.\nChcete přepnout na nový zrychlený engine?\nMůžete jej kdykoli vypnout v %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'V režimu křivkového gravírování může být aktuální rychlost příliš vysoká a může ovlivnit detaily gravírování vrstev: %(layers)s.\nZvažte snížení rychlosti pro lepší kvalitu.',
    ...
    right_panel: {
      laser_panel: {
        ...
        dropdown: {
          inches: {
            ...
            acrylic_7mm_cutting: 'Akryl - 1/4″ řez',
            ...
            mdf_7mm_cutting: 'Novozélandský MDF - 1/4″ řez',
          ...
          mm: {
            ...
            acrylic_7mm_cutting: 'Akryl - 7mm řez',
            ...
            mdf_7mm_cutting: 'Novozélandská MDF - 7mm řez',
        ...
        texture: 'Textura',
        texture_angle: 'Úhel',
        texture_intensity: 'Intenzita',
        texture_interval: 'Interval',
        texture_random: 'Náhodný',
        texture_stripe: 'Pruhy',
        times: 'krát',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Generativní zvětšení',
          ai_upscale_short: 'Zvětšení',
          ai_upscale_too_large: 'Tento obrázek je pro AI zvětšení příliš velký. Maximální podporovaná velikost je %dpx x %dpx.',
          array: 'Pole',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Přesuňte laserovou hlavu tak, aby červené světlo bylo zarovnáno se středem <b>bodu A</b>.',
    charuco_move_to_point_b: 'Přesuňte laserovou hlavu vodorovně tak, aby červené světlo bylo zarovnáno se středem <b>bodu B</b>.',
    ...
    check_pnp_desc: 'Ujistěte se, že červené značky jsou zarovnány s místy gravírování\nPokud ne, klikněte na „Zpět" pro úpravu.\nPokud je vše v pořádku, výborně! 🎉',
    ...
    put_charuco: 'Umístěte kalibrační vzor',
    put_charuco_1: 'Vytiskněte kalibrační vzor (A4/Letter).',
    put_charuco_2: 'Nalepte ji naplocho na pevnou desku.',
    put_charuco_3: 'Umístěte na střed a proveďte automatické zaostření.',
    put_charuco_bm2_1: 'Vytiskněte soubor kalibračního vzoru na papír formátu A4 (Letter).',
    put_charuco_bm2_2: 'Klikněte na „Další“ a postupujte podle pokynů pro umístění papíru.',
    put_charuco_promark_2: 'Ujistěte se, že je kalibrační papír jasně viditelný bez odlesků. Klikněte na "Další" pro pořízení fotografie.',
    put_charuco_promark_desc_1: 'Použijte kalibrační papír dodaný v krabici s příslušenstvím, nebo vytiskněte následující kalibrační vzor na papír velikosti A4 pro kalibraci kamery.',
    ...
    put_chessboard_promark_desc_2: 'Umístěte šachovnici naplocho a na středu pracovní plochy.',
    ...
    put_paper_promark: 'Vložte černou lepenku',
    put_paper_promark_1: 'Položte černou lepenku z příslušenství na pracovní platformu.',
    put_paper_promark_2: 'Správně nastavte zaostření a poté klikněte na "Začít Gravírovat" pro pokračování.',
  ...
  connection_issue_guide: {
    alert_link: 'Odpojuje se? Vyzkoušejte tento postup řešení potíží.',
    connect_computer: {
      content: 'Váš počítač musí být ve stejné síti jako zařízení.',
      macos_steps: 'Klikněte na ikonu Wi-Fi v řádku nabídek. Poté vyberte hotspot svého telefonu.',
      macos_title: 'macOS',
      title: 'Připojte svůj počítač',
      windows_steps: 'Klikněte na ikonu sítě na hlavním panelu. Poté vyberte hotspot svého telefonu.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Zařízení nemůže najít můj hotspot',
      dont_know_hotspot_name: 'Neznám název svého hotspotu',
      step1: '1. Na dotykovém panelu zařízení přejděte na: Síť → Připojit k Wi-Fi.',
      step2: '2. V seznamu Wi-Fi najděte a vyberte název hotspotu svého telefonu.',
      step3: '3. Zadejte heslo hotspotu a připojte se.',
    ...
    enter_ip: {
      ...
      step1: 'Zadejte IP adresu, kterou jste našli v předchozím kroku.',
      step2: 'Kliknutím na „Ověřit" otestujte připojení.',
      step3: 'Beam Studio zkontroluje:',
      title: 'Zadejte IP adresu svého zařízení',
      verify: 'Ověřit',
    },
    fail: {
      bullet1: '• Model a sériové číslo vašeho zařízení',
      bullet2: '• IP adresu zobrazenou na dotykovém panelu',
      bullet3: '• Popis chyby, na kterou jste narazili',
      contact_title: 'Při kontaktování podpory je užitečné mít po ruce:',
      intro: 'Nebojte se — nemusí to nutně znamenat, že je s vaším zařízením něco v nepořádku. Připojení mohou ovlivňovat další faktory. Náš tým podpory vám rád pomůže to vyřešit.',
      title: 'Test se nepodařilo dokončit',
    },
    hotspot: {
      android_steps: 'Nastavení → Připojení → Mobilní hotspot a sdílení připojení → Mobilní hotspot',
      android_title: 'Android',
      ios_steps: 'Nastavení → Osobní hotspot → Povolit ostatním připojení',
      ios_title: 'iPhone (iOS)',
      tip: 'Tip: Použijte jednoduchý anglický název hotspotu a číselné heslo (např. Název: FLUX_Test   Heslo: 12345678)',
      warning_2_4ghz: 'Důležité: Zařízení FLUX podporují pouze Wi-Fi 2.4GHz. Před pokračováním nastavte hotspot na 2.4GHz.',
    },
    how_it_works: 'Jak test funguje:',
    how_it_works_step1: '1. Nastavte svůj telefon jako hotspot Wi-Fi.',
    how_it_works_step2: '2. Připojte zařízení k hotspotu.',
    how_it_works_step3: '3. Připojte počítač ke stejnému hotspotu.',
    how_it_works_step4: '4. Otestujte připojení v Beam Studio.',
    intro: 'Provedeme rychlý test, abychom zkontrolovali, zda vaše zařízení funguje správně. Zařízení a počítač propojíme přes hotspot vašeho mobilního telefonu, abychom zjistili, zda je problém ve vaší síti, nebo v samotném zařízení.',
    ip_address: {
      step1: 'Na dotykovém panelu zařízení přejděte na:\nSíť → Vyhledejte „IP adresa"',
      step2: 'IP obvykle vypadá takto: 172.20.10.x nebo 192.168.x.x\n(Závisí to na hotspotu vašeho telefonu)',
      step3: 'Poznamenejte si tuto IP adresu pro další krok.',
      title: 'Najděte IP adresu svého zařízení',
      warning: 'Pokud IP začíná na 169.254, připojení selhalo. Vraťte se ke Kroku 1 a zkuste to znovu.',
    },
    success: {
      cause: 'Problém s připojením, který jste zaznamenali, je nejpravděpodobněji způsoben prostředím vaší místní sítě, nikoli samotným zařízením.',
      intro: 'Úspěšně jste dokončili test připojení Wi-Fi — skvělá práce! To potvrzuje, že vaše zařízení FLUX funguje bezvadně.',
      recommend1: '• Obraťte se na svého poskytovatele internetu (ISP) nebo výrobce routeru s žádostí o pomoc s nastavením Wi-Fi',
      recommend2: '• Zeptejte se správce sítě, pokud jste ve škole, kanceláři nebo sdíleném pracovním prostoru',
      recommend3: '• Zkontrolujte, zda váš router podporuje 2.4GHz, a zkuste jej restartovat',
      recommend_title: 'Co doporučujeme:',
      title: 'Skvělá práce! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'Generátor přívěsků',
    material_test_generator: 'Generátor testování materiálu',
    puzzle_generator: 'Generátor puzzle',
    title: 'Generátory',
  },
  generic_error: {
  ...
  initialize: {
    ...
    select_hexa: 'Vyberte svůj HEXA',
    select_language: 'Vyberte jazyk',
    select_machine_type: 'Vyberte typ vašeho přístroje',
    select_promark: 'Vyberte svůj Promark',
    setting_completed: {
      back: 'Zpět',
  ...
  maintenance: {
    ...
    cadence: {
      ...
      condition: 'Podle stavu',
      day: 'Každý den',
      days: 'Jednou za %s dny',
      each_operation: 'Každé použití',
      every_1_2_weeks: 'Jednou za 1–2 týdny',
      month: 'Každý měsíc',
      months: 'Jednou za %s měsíce',
      upon_unboxing: 'Při prvním rozbalení',
      week: 'Každý týden',
      weeks: 'Jednou za %s týdny',
    },
    celebration: {
    ...
    feedback: {
      ...
      fail_warning: '%s: označeno k výměně trubice. Postup najdete v návodu.',
      passed: '%s prošlo — trubice je v pořádku!',
    },
    footer_tip: 'Tip: Gravírujte každý měsíc vzorový soubor, abyste udrželi přístroj v dobré kondici.',
    history_hint: 'U každé úlohy se uchovává pouze %s posledních záznamů.',
    intro: 'Sledujte všechny úlohy údržby tohoto přístroje a označte je jako hotové jedním kliknutím.',
    legend: {
      due_soon: 'Brzy na řadě',
      overdue: 'Po termínu',
      up_to_date: 'Aktuální',
    },
    machine_groups: {
      my_machines: 'Moje přístroje',
      other_models: 'Ostatní modely',
    },
    ...
    status: {
      ...
      due: 'Termín',
      healthy: 'V pořádku',
      last: 'Naposledy hotovo',
      never_done: 'Nikdy neprovedeno',
      next: 'Příští termín',
      not_checked: 'Nezkontrolováno',
      not_logged: 'Nezaznamenáno',
      overdue: 'Po termínu',
      replace_tube: 'Vyměnit trubici',
    },
    tasks: {
      align: {
        keyPoints: 'Seřiďte, pokud je optická dráha rozladěná.',
        name: 'Seřízení optické dráhy',
      },
      chassis: {
        keyPoints: 'Odstraňte zbytky a dehtový olej ze skříně a spodního krytu.',
        name: 'Čištění skříně',
      },
      door: {
        keyPoints: 'Odstraňte mastnotu z krytu dvířek.',
        name: 'Čištění krytu dvířek',
      },
      exhaust: {
        keyPoints: 'Očistěte prach z lopatek ventilátoru.',
        name: 'Čištění odtahového ventilátoru',
      },
      fan: {
        keyPoints: 'Odstraňte prach z lopatek větracího ventilátoru.',
        name: 'Čištění větracího ventilátoru',
      },
      fieldlens: {
        keyPoints: 'Očistěte polní čočku, otírejte od středu ven ve směru hodinových ručiček.',
        name: 'Čištění polní čočky',
      },
      honeycomb_plate: {
        keyPoints: 'Odstraňte zbytky a dehet z mřížky voštinové desky.',
        name: 'Čištění voštinové desky',
      },
      honeycomb_table: {
        keyPoints: 'Odstraňte zbytky a dehtový olej z voštinové mřížky.',
      ...
      maintain_test: {
        keyPoints: 'Zkontrolujte stavový displej a spínače.',
        name: 'Stránka MAINTAIN',
      },
      mirrors_combiner: {
        keyPoints: 'Odstraňte nečistoty z čoček a zrcadel; zkontrolujte oxidaci. Nenechávejte stopy po alkoholu ani vodě.',
        name: 'Zrcadla, fokusační čočka a slučovač paprsků',
      },
      mirrors_lens: {
        keyPoints: 'Očistěte 4 zrcadla a čočku; ujistěte se, že nejsou oxidované a nemají vodní skvrny.',
        name: 'Čištění zrcadel a čočky',
      },
      mod_diode: {
        keyPoints: 'Očistěte ventilátor, fokusační čočku a POGO pin.',
        name: 'Modul diodového laseru',
      },
      mod_ir: {
        keyPoints: 'Očistěte fokusační čočku.',
        name: 'Infračervený laserový modul',
      },
      optical_inspection: {
        keyPoints: 'Zkontrolujte optickou dráhu; také při rozbalení a po výměně trubice.',
        name: 'Kontrola optické dráhy',
      },
      optical_unboxing: {
        keyPoints: 'Ujistěte se, že je optická dráha přesná. Zkontrolujte při prvním rozbalení.',
        name: 'Kontrola optické dráhy',
      },
      screen: {
        keyPoints: 'Očistěte prach a mastnotu na panelu.',
        name: 'Čištění obrazovky',
      },
      tube: {
        keyPoints: 'Pokud nelze řezat 3mm akryl na 70% výkon, vyměňte trubici.',
        name: 'Kontrola stavu laserové trubice',
      },
      water: {
        keyPoints: 'Doplňte vodu na více než 80 % bez vzduchových bublin.',
        name: 'Výměna chladicí vody',
      },
      worktable: {
        keyPoints: 'Nastříkejte alkohol na ubrousek a poté otřete pracovní desku.',
        name: 'Čištění pracovní desky',
      },
      zaxis: {
        keyPoints: 'Otřete šroub sloupku osy Z a poté vatovou tyčinkou rovnoměrně naneste mazivo.',
        name: 'Mazání sloupku osy Z',
      },
    },
    title: 'Kontrolní seznam údržby',
  },
  ...
  message: {
    ...
    enteringRawMode: 'Vstupuji do režimu ovládání stroje...',
  ...
  monitor: {
    ...
    HARDWARE_ERROR_PUMP_ERROR: '#900 Nízký průtok chladicí kapaliny. Zkontrolujte prosím nádržku s vodou.',
  ...
  params_label: {
    ...
    placeholder: 'Štítek parametrů',
    preview_hint: 'Toto je náhled. Obsah textu se automaticky aktualizuje před odesláním úlohy',
    save_as_default: 'Uložit jako výchozí',
    settings: 'Nastavení štítku parametrů',
    update: 'Aktualizovat',
    updated: 'Štítek parametrů byl aktualizován',
    use_default: 'Použít uložené výchozí',
    use_recommended: 'Použít doporučené',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      calculating: 'Výpočet…',
      capturing: 'Snímání obrazu',
      completing: 'Brzy dokončeno',
      detecting: 'Rozpoznávání zarovnávacích značek',
      locating: 'Hledání zarovnávacích značek',
      preparing: 'Příprava kamery',
      refining: 'Upřesňování polohy značek',
    },
    alignment: {
    ...
    finish: 'Dokončit',
    fit_content: 'Přizpůsobit obsahu',
    generate_from_contour: 'Vytvořit z obrysu',
    grid_columns: 'Sloupce',
    grid_rows: 'Řádky',
    ...
    paper_size: 'Velikost výstupu',
    paper_too_small: 'Oblast výstupu je příliš malá. Návrh (včetně zarovnávacích značek) potřebuje alespoň %s mm okraje od hrany materiálu, aby zůstal v tisknutelné oblasti tiskárny. Zvolte větší velikost výstupu, jinak bude tisk oříznut nebo zmenšen.',
    preview_and_align: 'Náhled a zarovnání',
    resume_desc: 'Tento návrh je již připraven pro Tisk a řez.\nVložte do stroje další potištěný materiál a pokračujte k zarovnání kamerou, nebo začněte znovu a změňte návrh, velikost výstupu či řezací dráhu.',
    resume_title: 'Pokračovat v Tisk a řez',
    select_cut_layer: 'Vrstva s řezací dráhou',
    ...
    step_setup: 'Řezací dráhy a značky',
    ...
    uv_print_file_disabled: 'Funkce Tisk a řez tiskne obsah vrstev UV tisku. Nejprve ve vlastnostech povolte „Povolit UV tiskový soubor“ a přidejte svůj návrh do vrstvy UV tisku.',
  ...
  puzzle_generator: {
    ...
    export_engrave: 'Vrstva gravírování',
    export_failed: 'Import puzzle na plátno se nezdařil. Zkuste to znovu nebo upravte nastavení puzzle.',
    export_none: 'Žádné',
    export_print: 'Vrstva tisku',
    file_too_large: 'Vybraný soubor překračuje maximální povolenou velikost.',
    guide_lines: 'Vodítka',
    ...
    piece_size: 'Velikost dílků',
    preview_placeholder: 'Náhled puzzle',
    puzzle_board: 'Deska puzzle',
    puzzle_pieces: 'Dílky puzzle',
    radius: 'Poloměr',
    ...
    types: {
      ...
      heart_jigsaw: 'Srdcové puzzle',
      hex_jigsaw: 'Šestiúhelníkové puzzle',
      rectangle_jigsaw: 'Obdélníkové puzzle',
    },
    unsupported_file_type: 'Nepodporovaný typ souboru. Použijte JPG, PNG nebo WebP.',
    upload_hint: 'JPG, PNG, WebP (max. 10MB)',
    upload_image: 'Klikněte nebo přetáhněte pro nahrání',
    zoom: 'Přiblížení',
  },
  qr_code_generator: {
  ...
  tips: {
    canvas_hold_space_to_pan: 'Podržte mezerník a táhněte pro posunutí plátna.',
    feature_auto_fit: 'Po náhledu kamery použijte Akce → Automatické přizpůsobení pro automatické umístění objektů na materiál.',
    feature_box_generator: 'Použijte Generátory → Generátor krabic k vytvoření krabic na míru během několika sekund.',
    feature_code_generator: 'Použijte Generátory → Generátor čárových kódů k vytvoření QR kódů a čárových kódů.',
    feature_elements: 'Panel Prvky nyní obsahuje přes milion grafik připravených k použití.',
    feature_layer_color_configurations: 'Namapujte barvy vrstev SVG na rychlost a výkon pomocí Upravit → Vrstva → Nastavení barev.',
    feature_material_test: 'Použijte Generátory → Generátor testu materiálu v levém panelu nástrojů pro rychlé nalezení nejlepších nastavení pro materiál.',
    layer_execution_order: 'Pořadí vrstev určuje pořadí úloh. Úlohy se provádějí shora dolů.',
    machine_clean_mirror: 'Pravidelně kontrolujte zrcadla a fokusační čočku a v případě potřeby je čistěte, abyste předešli nahromadění kouře.',
    machine_no_unattended_operation: 'Nikdy nenechávejte stroj běžet bez dohledu.',
    machine_regular_start: 'Spouštějte laserovou úlohu alespoň jednou za dva týdny, abyste prodloužili životnost laserové trubice.',
    object_edit_image_to_erase: 'Použijte Obrázek → Akce → Upravit obrázek k vymazání nežádoucích oblastí na obrázku.',
    object_polygon_sides: 'Upravte počet stran v panelu vlastností polygonu.',
    object_rounded_rectangle: 'Nastavte poloměr rohu zaoblného obdélníku v panelu vlastností obdélníku.',
    object_sharpen_portrait: 'Vylepšete rytí portrétů pomocí Obrázek → Akce → Zostřit.',
    settings_auto_save: 'Povolte Automatické ukládání v Předvolbách, abyste předešli ztrátě své práce.',
    settings_default_text_font: 'V Předvolbách můžete nastavit výchozí písmo pro nástroj Text.',
    task_focus_lower_for_cutting: 'U tlustších materiálů může zaostření přibližně 2 mm pod povrchem zlepšit výsledky řezání.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Nepodařilo se navázat spojení s kamerou. Restartujte prosím své zařízení nebo Beam Studio. Pokud bude tato chyba přetrvávat, přečtěte si prosím <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">tento návod</a>.',
      fail_to_get_door_status: 'Ujistěte se prosím, že jsou dvířka uzavřená, aby mohl laser nízké intenzity zahájit rámování.',
      fail_to_start_preview: '#803 Nepodařil se spustit náhled. Restartujte prosím své zařízení nebo Beam Studio. Pokud bude tato chyba přetrvávat, přečtěte si prosím <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">tento návod</a>.',
      ...
      start_preview_timeout: '#803 Během spuštění náhledu došlo k přerušení. Restartujte prosím své zařízení nebo Beam Studio. Pokud bude tato chyba přetrvávat, přečtěte si prosím <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">tento návod</a>.',
    ...
    menu: {
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Exportovat kalibrační data',
      ...
      machines: 'Přístroje',
      maintenance_checklist: 'Kontrolní seznam údržby',
