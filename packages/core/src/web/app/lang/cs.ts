...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    font_size: 'Velikost písma',
    hole: 'Otvor',
    hole_diameter: 'Průměr',
    hole_offset: 'Odsazení',
    hole_position: 'Pozice',
    hole_thickness: 'Tloušťka',
    hole_type: 'Typ',
    hole_type_punch: 'Průraz',
    ...
    position_ref: 'Pozice',
    position_ref_bottom_center: 'Dole',
    position_ref_left_center: 'Vlevo',
    position_ref_right_center: 'Vpravo',
    position_ref_top_center: 'Nahoře',
