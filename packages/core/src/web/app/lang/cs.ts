...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'Výstupní velikost (%s) překračuje doporučené maximum %d × %d px. Zpracování může trvat několik minut a výsledek může zpomalit Beam Studio. Přesto pokračovat?',
