...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_1: 'Vytiskněte šachovnici (A4/Letter).',
    put_chessboard_2: 'Nalepte ji naplocho na pevnou desku.',
    put_chessboard_3: 'Umístěte na střed a proveďte automatické zaostření.',
