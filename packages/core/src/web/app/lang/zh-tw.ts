...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: '位置：對準左上角的雕刻點。',
    align_4_1: '位置：對準右上角的雕刻點。',
    align_4_2: '位置：對準左下角的雕刻點。',
    align_4_3: '位置：對準右下角的雕刻點。',
    align_8_0: '位置：對齊外側左上角的雕刻點。',
    align_8_1: '位置：對齊外側右上角的雕刻點。',
    align_8_2: '位置：對齊外側左下角的雕刻點。',
    align_8_3: '位置：對齊外側右下角的雕刻點。',
    align_8_4: '位置：對齊內側左上角的雕刻點。',
    align_8_5: '位置：對齊內側右上角的雕刻點。',
    align_8_6: '位置：對齊內側左下角的雕刻點。',
    align_8_7: '位置：對齊內側右下角的雕刻點。',
    ...
    charuco_open_the_machine_lid: '開啟機器門蓋。',
    charuco_place_charuco: '請將列印好的校正圖案水平放置在工作區的<b>%s</b>位置進行拍攝。',
    ...
    check_pnp_desc: '我們已根據校正結果重新拍攝畫面，並標示出雕刻的標記點位置。\n請檢查紅色標記點是否正確對應到實際雕刻的位置。\n若發現有明顯偏差，請點選「重新校正」重新進行校正。',
    ...
    solve_pnp_relocate_camera: '若雷射頭尚未水平置中，請點選「重新定位相機」。',
