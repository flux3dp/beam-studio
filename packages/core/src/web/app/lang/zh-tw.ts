...
const lang: ILang = {
  ...
  beambox: {
    ...
    right_panel: {
      laser_panel: {
        ...
        multi_layer: '多個圖層',
        opacity: '不透明度',
        opacity_desc: '此圖層僅供對位參考，送出工作時不會被處理。',
      ...
      object_panel: {
        ...
        left_align: '靠左對齊',
        library: {
          allow_user_upload: '允許使用者上傳',
          download_library_contents: '保存圖形庫內容',
          image_not_supported: '此檔案不支援',
          object_not_supported: '此物件不支援',
          set_as_default: '設定為預設',
          svg_not_supported: '此 SVG 不支援',
        },
        lock_aspect: '鎖定長寬比',
        middle_align: '中線對齊',
        option_panel: {
          ...
          text_transform_sentence: '句首大寫',
          text_transform_title: '每個單字字首大寫',
          text_transform_toggle: '切換大小寫',
          text_transform_uppercase: '大寫',
          threshold: '臨界值',
          threshold_short: '臨界值',
          variable_text: '可變文字',
    ...
    svg_editor: {
      ...
      import_image: {
        camera: '拍攝照片',
        camera_desc: '使用相機拍攝新照片',
        file: '選擇檔案',
        file_desc: '從裝置選擇圖片檔案',
        gallery: '照片圖庫',
        gallery_desc: '從圖庫選擇照片檔案',
        title: '上傳圖片',
      },
  ...
  save_file: {
    target_cloud_hint: '儲存到雲端',
    target_local: '本機',
    target_local_hint: '儲存到本地裝置',
    type_project_message: '選擇專案儲存位置，儲存後將切換到專案模式',
    type_project_title: '儲存為專案',
    type_template_message: '選擇模板儲存位置，儲存後將切換到模板模式',
    type_template_title: '儲存為模板',
    type_unchanged_message: '選擇專案儲存位置',
    type_unchanged_title: '儲存檔案',
  },
  select_device: {
  ...
  template_target_layer_setting: {
    allow_import: '允許匯入',
    ask_to_edit: '您要編輯目前的模板目標圖層嗎？',
    ask_to_edit_title: '設定模板目標圖層',
    description: '設置客戶可以匯入的圖層',
    display_name: '顯示名稱',
    layer_name: '圖層名稱',
    no_target_layer_found: '找不到模板目標圖層。您的客戶將無法在此模板中新增物件。',
    select_target_layer: '選擇目標圖層',
  },
  template_thumbnail: {
    edit_thumbnails_confirm: '是否要編輯縮圖？',
    thumbnails: '縮圖',
    upload: {
      dimensions_too_large: '圖片尺寸太大。',
      failed_to_load: '圖片載入失敗，請選擇其他檔案。',
      file_too_large: '檔案太大。',
      wrong_file_type: '不支援的檔案類型，請選擇 JPG 或 PNG 圖片。',
    },
  },
  tips: {
  ...
  topbar: {
    ...
    menu: {
      ...
      samples: '範例',
      save_as: '另存新檔',
      save_as_project: '另存專案',
      save_as_template: '另存模板',
      save_scene: '儲存',
      save_to_cloud: '儲存到雲端',
      scale: '縮放',
      service: '服務',
  ...
  welcome_page: {
    create_your_template_file: '建立您的模板檔案',
    follow_us: {
