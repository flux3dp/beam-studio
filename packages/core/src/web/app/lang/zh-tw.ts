    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          diabled_by_gradient: '請先關閉漸層後再使用此功能。',
          diabled_by_infilled: '請先關閉填充後再使用此功能。',
          diabled_by_infilled_and_variable_text: '請先關閉填充和可變文字後再使用此功能。',
          diabled_by_variable_text: '請先關閉可變文字後再使用此功能。',
