...
const lang: ILang = {
  ...
  beambox: {
    ...
    material_browser: {
      add_from_layer: {
        attach_to: '附加到材質',
        bucket_hint: '已儲存至「我的材質」集合（其他分類），之後可再移動到其他材質。',
        create_new: '建立新材質…',
        new_material_name: '新材質名稱',
        preset_name: '參數名稱',
        settings_from_layer: '複製自目前圖層的設定',
        title: '將目前圖層設定儲存為參數',
      },
      add_material: '新增材質',
      add_preset: '新增參數',
      apply: '套用',
      back_to_catalog: '返回材質目錄',
      buy_on_shop: '前往商店購買',
      catalog: {
        materials: {
          acrylic: '透明壓克力',
          ...
          faux_leather: '仿皮革',
          felt: '不織布',
          fluorescent_acrylic: '螢光壓克力',
          glass: '玻璃',
          glitter_acrylic: '亮片壓克力',
          gloss_leather: '亮面真皮',
          gold: '金',
          iron: '鐵',
          kraft_paper: '牛皮紙',
      ...
      editor: {
        appearance: '外觀',
        appearance_hint: '沒有照片？可改用封面顏色。',
        category: '分類',
        category_required: '請選擇分類',
        color: '顏色',
        name: '材質名稱',
        name_required: '請輸入名稱',
        photo: '照片',
        ...
        title_add: '新增材質',
        title_edit: '編輯材質',
        upload_hint: '點擊或拖曳照片，將顯示於材質目錄的大型預覽。',
      },
      enable: '啟用',
      export: '匯出',
      favorites: '最愛',
      from_current_layer: '自目前圖層',
      import: '匯入',
      machine: '機器',
      manual: '手動',
      manual_settings: '手動設定',
      modified: '套用參數後已手動調整',
      move_to_material: '移動到材質…',
      new_preset_manual: '新增參數…',
      no_materials_in_category: '此分類尚無 %s 適用的材質。',
      no_presets_for_machine: '尚無 %s 適用的參數。',
      no_search_match: '找不到符合「%s」的材質。',
      preset_editor: {
        name: '參數名稱',
        name_required: '請輸入名稱',
        title_edit: '編輯參數',
      ...
      restore_default: '還原 FLUX 預設值',
      result: '搜尋結果',
      search_placeholder: '搜尋材質、標籤、分類…',
      settings_region: '材質目錄地區',
      settings_use: '使用材質瀏覽器',
      showing_bundled: '目前顯示內建材質目錄',
      state_customized: '已自訂',
      state_default: '預設',
      state_disabled: '已停用',
      state_user: '使用者自訂',
      storage_full: '儲存空間已滿，材質庫無法儲存。請改用顏色封面，或刪除部分材質照片。',
      sure_to_delete_material: '確定要刪除此材質與其所有參數嗎？',
      sure_to_delete_preset: '確定要刪除此參數嗎？',
      sure_to_delete_variant: '確定要刪除此厚度規格與其參數嗎？',
      sure_to_import: '匯入將會合併到你的材質庫，是否繼續？',
      thickness: '厚度',
      title: '材質瀏覽器',
      variant_exists: '已有相同厚度的規格。',
      variants: '%d 種規格',
    },
    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          disabled_by_noun_project: '本圖形受知識產權法律保護，因此無法編輯其路徑。',
  ...
  print_and_cut: {
    ...
    calibration: {
      align_desc: '1. 將列印好的校正紙放入工作區，以膠帶或紙膠帶固定避免滑動，並進行對焦。\n2. 點擊「預覽並對位」進行相機對位。\n3. 找到標記點後點擊「刻劃刻度」在紙上以低功率劃出參考線。',
      aligned: '已偵測到定位點，可以開始刻劃。',
      auto_read: '以相機讀取刻度',
      auto_read_failed: '無法自動讀取刻度，請目視判讀後輸入數值。',
      auto_read_hint: '相機讀數可能有 ±2 格的誤差，請對照校正紙確認。',
      current_offset: '目前偏移：X %s mm，Y %s mm',
      export_pdf: '匯出校正 PDF',
      power: '功率',
      print_desc: '1. 匯出校正紙 PDF，校正紙包含四個定位點以及兩組刻度。\n2. 將校正紙以 100% 比例（實際大小）列印。',
      reading_desc: '1. 找出最長的雷射刻線（中線），看它相對於印刷的 0 刻線偏向哪一側。\n2. 往該側逐格比對，找到雷射刻線與列印刻線完全對齊的位置。\n3. 從 0 數到該列印刻線（每 5 格印有數字，其間的刻線請自行計數）。',
      reading_x: 'X 讀數',
      reading_y: 'Y 讀數',
      scratch: '刻劃刻度',
      speed: '速度',
  ...
  topbar: {
    ...
    menu: {
      ...
      calibrate_print_and_cut: '校正精準對位',
