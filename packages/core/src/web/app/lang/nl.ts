...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Hoe kan de detectienauwkeurigheid worden verbeterd?',
    ...
    retake_tooltip: 'Camerafoto opnieuw nemen op de positie van elk object voor betere detectie',
    retry_with_remove_bg: 'Achtergrond verwijderen',
    retry_with_remove_bg_tooltip: 'Achtergrond verwijderen uit voorbeeldafbeelding om contourdetectie te verbeteren',
    rotation: 'Draaien',
    ...
    use_original_image_tooltip: 'Herstel de originele voorbeeldafbeelding zonder achtergrondverwijdering',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      credit_balance: 'AI-creditsaldo',
      credit_cost: 'Gebruikte AI-credits',
      description: 'Verhoog de resolutie en details van de afbeelding met AI. De opgeschaalde afbeelding vervangt het origineel op het canvas.',
      done: 'Generatief opschalen voltooid',
      dpi_recommended: 'Aanbevolen voor de huidige laag-DPI: %dx.',
      dpi_recommended_capped: 'Aanbevolen voor de huidige laag-DPI: %dx, maar %dx is het maximum binnen de aanbevolen uitvoergrootte.',
      failed: 'Generatief opschalen kon niet worden voltooid. Controleer je netwerkverbinding en probeer het opnieuw.',
      insufficient_credit: 'Onvoldoende AI-credits om generatief opschalen uit te voeren.',
      layer_dpi: 'Laag-DPI',
      original_size: 'Oorspronkelijke grootte',
      output_size: 'Uitvoergrootte',
      oversize_warning: 'De uitvoergrootte (%s) overschrijdt het aanbevolen maximum van %dpx x %dpx. De verwerking kan enkele minuten duren en het resultaat kan Beam Studio vertragen. Toch doorgaan?',
      processing: 'Bezig met opschalen…',
      processing_hint: 'De verwerkingstijd hangt af van de afbeeldingsgrootte en het netwerk.',
      recommended: 'Aanbevolen',
      retry: 'Opnieuw proberen',
      start: 'Opschalen starten',
    },
    announcement_panel: {
      title: 'Aankondiging',
    },
    ...
    document_panel: {
      ...
      prespray_times: 'Aantal reinigingen',
    ...
    left_panel: {
      ...
      label: {
        ...
        preview_precise: 'Nauwkeurig cameravoorbeeld',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Aan materiaal koppelen',
        bucket_hint: 'Opgeslagen in uw verzameling “Mijn materialen” (Overig). U kunt het later aan een materiaal koppelen.',
        create_new: 'Nieuw materiaal maken…',
        new_material_name: 'Naam van nieuw materiaal',
        preset_name: 'Naam van voorinstelling',
        settings_from_layer: 'Instellingen gekopieerd van de huidige laag',
        title: 'Huidige laaginstellingen opslaan als voorinstelling',
      },
      add_material: 'Materiaal toevoegen',
      add_preset: 'Voorinstelling toevoegen',
      apply: 'Toepassen',
      back_to_catalog: 'Terug naar catalogus',
      buy_on_shop: 'Kopen in de shop',
      catalog: {
        materials: {
        ...
        presets: {
          cutting: 'Snijden',
          engraving: 'Graveren',
          engraving_diode: 'Graveren (diode)',
          engraving_fiber: 'Graveren (fiber)',
          engraving_spray: 'Graveren (spray)',
          kiss_cut: 'Kiss cut',
          marking: 'Markeren',
          marking_dark: 'Donkere markering',
          marking_light: 'Lichte markering',
          printing: 'Printen',
          printing_fabric: 'Printen (stof)',
        },
      },
      categories: {
        acrylic: 'Acryl',
      ...
      editor: {
        appearance: 'Weergave',
        appearance_hint: 'Geen foto? Kies dan een omslagkleur.',
        category: 'Categorie',
        ...
        photo: 'Foto',
        tags: 'Tags',
        title_add: 'Materiaal toevoegen',
        title_edit: 'Materiaal bewerken',
        upload_hint: 'Klik of sleep een foto. Een grote voorbeeldweergave wordt in de galerij getoond.',
      },
      enable: 'Inschakelen',
      export: 'Exporteren',
      favorites: 'Favorieten',
      from_current_layer: 'Van huidige laag',
      import: 'Importeren',
      machine: 'Machine',
      manual: 'Handmatig',
      manual_settings: 'Handmatige instellingen',
      modified: 'Parameters gewijzigd sinds de voorinstelling werd toegepast',
      move_to_material: 'Verplaatsen naar materiaal…',
      new_preset_manual: 'Nieuwe voorinstelling…',
      no_materials_in_category: 'Nog geen materialen hier voor %s.',
      no_presets_for_machine: 'Nog geen instellingen voor %s.',
      no_search_match: 'Geen materialen komen overeen met “%s”.',
      preset_editor: {
        name: 'Naam van voorinstelling',
        name_required: 'Naam is verplicht',
        title_edit: 'Voorinstelling bewerken',
        title_new: 'Nieuwe voorinstelling',
      },
      presets: 'Voorinstellingen',
      recents: 'Recent',
      recents_empty: 'Recent toegepaste materialen verschijnen hier.',
      regions: {
        auto: 'Automatisch',
        eu: 'Europa',
        global: 'Wereldwijd',
      ...
      restore_default: 'FLUX-standaard herstellen',
      result: 'Resultaat',
      search_placeholder: 'Zoek materialen, tags, categorieën…',
      settings_region: 'Regio van materiaalcatalogus',
      settings_use: 'Materiaalbrowser gebruiken',
      showing_bundled: 'Ingebouwde catalogus wordt getoond',
      state_customized: 'Aangepast',
      state_default: 'Standaard',
      state_disabled: 'Uitgeschakeld',
      state_user: 'Door gebruiker gedefinieerd',
      storage_full: "De opslag is vol, de materiaalbibliotheek kon niet worden opgeslagen. Gebruik kleuromslagen in plaats van foto's.",
      sure_to_delete_material: 'Dit materiaal en alle bijbehorende voorinstellingen verwijderen?',
      sure_to_delete_preset: 'Deze voorinstelling verwijderen?',
      sure_to_delete_variant: 'Deze dikte en de bijbehorende voorinstellingen verwijderen?',
      sure_to_import: 'Bij importeren wordt het bestand samengevoegd met uw materiaalbibliotheek. Doorgaan?',
      thickness: 'Dikte',
      title: 'Materiaalbrowser',
      variant_exists: 'Er bestaat al een variant met deze dikte.',
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: 'Snellere taakgeneratie beschikbaar',
        keep_current: 'Huidig behouden',
        message: 'We hebben de taakberekeningsengine geüpgraded om de prestaties te verbeteren en het genereren van taken te versnellen.\nWilt u overschakelen naar de nieuwe versnelde engine?\nU kunt dit op elk moment uitschakelen in %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'In curve-graveermodus kan de huidige snelheid te hoog zijn en de graveerdetails voor lagen beïnvloeden: %(layers)s.\nOverweeg de snelheid te verlagen voor betere kwaliteit.',
    ...
    right_panel: {
      laser_panel: {
        ...
        texture: 'Textuur',
        texture_angle: 'Hoek',
        texture_intensity: 'Intensiteit',
        texture_interval: 'Interval',
        texture_random: 'Willekeurig',
        texture_stripe: 'Strepen',
        times: 'keer',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Generatief opschalen',
          ai_upscale_short: 'Opschalen',
          ai_upscale_too_large: 'Deze afbeelding is te groot voor AI-opschaling. De maximaal ondersteunde grootte is %dpx x %dpx.',
          array: 'Array',
          ...
          disabled_by_noun_project: 'Deze vorm is beschermd door de intellectuele eigendomswet, daarom kan het pad niet worden bewerkt.',
  ...
  boxgen: {
    ...
    inner: 'Binnen',
    joints: 'Verbinding',
    max_dimension_tooltip: 'Max. breedte is %s, max. hoogte/diepte instelling is %s.',
    merge: 'Samenvoegen',
    outer: 'Buiten',
    reset: 'Resetten',
    tCount: 'T Aantal',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Verplaats de laserkop om het rode licht uit te lijnen met het midden van <b>punt A</b>.',
    charuco_move_to_point_b: 'Verplaats de laserkop horizontaal om het rode licht uit te lijnen met het midden van <b>punt B</b>.',
    ...
    check_pnp_desc: 'Zorg ervoor dat de rode markeringen zijn uitgelijnd met de graveerpunten\nZo niet, klik op "Terug" om aan te passen.\nAls alles goed is, goed gedaan! 🎉',
    ...
    put_charuco: 'Kalibratiepatroon Plaatsen',
    put_charuco_1: 'Print het kalibratiepatroon (A4/Letter).',
    put_charuco_2: 'Plak het plat op een stijve plaat.',
    put_charuco_3: 'Plaats in het midden en voer autofocus uit.',
    put_charuco_bm2_1: 'Print het kalibratiepatroonbestand op A4- (Letterformaat) papier voor kalibratie.',
    put_charuco_bm2_2: 'Klik op “Volgende” en volg de gids om het papier te plaatsen.',
    put_charuco_promark_2: "Zorg ervoor dat het kalibratiepapier duidelijk zichtbaar is zonder schittering. Klik op 'Volgende' om een foto te maken.",
    put_charuco_promark_desc_1: 'Gebruik het kalibratiepapier uit de accessoiredoos of print het volgende kalibratiepatroon op A4‑papier voor camerakalibratie.',
    ...
    put_paper_promark: 'Plaats zwart karton',
    put_paper_promark_1: 'Plaats het zwarte karton uit de accessoiredoos op het werkplatform.',
    put_paper_promark_2: 'Stel de focus correct af en klik vervolgens op "Graveren Starten" om verder te gaan.',
  ...
  cloud_sync: {
    import_config: 'Cloudinstellingen gevonden voor dit apparaat. Wilt u deze importeren?',
    import_failed: 'Kan cloudinstellingen niet lezen.',
    sync_config: 'Wilt u deze instellingen synchroniseren met de cloud?',
    sync_failed: 'Synchronisatie van instellingen naar de cloud mislukt.',
    sync_success: 'Instellingen succesvol gesynchroniseerd met de cloud.',
  },
  code_generator: {
  ...
  connection_issue_guide: {
    alert_link: 'Verbinding wordt verbroken? Probeer deze probleemoplossingsmethode.',
    connect_computer: {
      content: 'Je computer moet op hetzelfde netwerk zijn als de machine.',
      macos_steps: 'Klik op het Wi-Fi-pictogram in de menubalk. Selecteer vervolgens de hotspot van je telefoon.',
      macos_title: 'macOS',
      title: 'Verbind je computer',
      windows_steps: 'Klik op het netwerkpictogram in de taakbalk. Selecteer vervolgens de hotspot van je telefoon.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Machine kan mijn hotspot niet vinden',
      dont_know_hotspot_name: 'Ik weet mijn hotspotnaam niet',
      step1: '1. Ga op het touchpaneel van je machine naar: Netwerk → Verbinden met Wi-Fi.',
      step2: '2. Zoek en selecteer de hotspotnaam van je telefoon in de Wi-Fi-lijst.',
      step3: '3. Voer het hotspotwachtwoord in en maak verbinding.',
      title: 'Machine verbinden met telefoonhotspot',
    },
    enter_ip: {
      check_firmware: 'Firmwareversie',
      check_ip_reachable: 'IP bereikbaar',
      check_machine_responds: 'Machine reageert',
      placeholder: 'IP-adres',
      step1: 'Voer het IP-adres in dat je in de vorige stap hebt gevonden.',
      step2: 'Klik op "Verifiëren" om de verbinding te testen.',
      step3: 'Beam Studio controleert:',
      title: 'Voer het IP-adres van je machine in',
      verify: 'Verifiëren',
    },
    fail: {
      bullet1: '• Je machinemodel en serienummer',
      bullet2: '• Het IP-adres dat op het touchpaneel wordt weergegeven',
      bullet3: '• Een beschrijving van de fout die je bent tegengekomen',
      contact_title: 'Wanneer je contact opneemt met de ondersteuning, is het handig om het volgende bij de hand te hebben:',
      intro: 'Geen zorgen — dit betekent niet noodzakelijk dat er iets mis is met je machine. Er kunnen aanvullende factoren zijn die de verbinding beïnvloeden. Ons ondersteuningsteam helpt je graag om het uit te zoeken.',
      title: 'We konden de test niet voltooien',
    },
    hotspot: {
      android_steps: 'Instellingen → Verbindingen → Mobiele hotspot en tethering → Mobiele hotspot',
      android_title: 'Android',
      ios_steps: 'Instellingen → Persoonlijke hotspot → Anderen toestaan deel te nemen',
      ios_title: 'iPhone (iOS)',
      tip: 'Tip: Gebruik een eenvoudige Engelse hotspotnaam en een numeriek wachtwoord (bijv. Naam: FLUX_Test   Wachtwoord: 12345678)',
      warning_2_4ghz: 'Belangrijk: FLUX-machines ondersteunen alleen 2.4GHz Wi-Fi. Stel je hotspot in op 2.4GHz voordat je verdergaat.',
    },
    how_it_works: 'Zo werkt de test:',
    how_it_works_step1: '1. Stel je telefoon in als Wi-Fi-hotspot.',
    how_it_works_step2: '2. Verbind de machine met de hotspot.',
    how_it_works_step3: '3. Verbind je computer met dezelfde hotspot.',
    how_it_works_step4: '4. Test de verbinding in Beam Studio.',
    intro: 'Laten we een snelle test uitvoeren om te controleren of je machine goed werkt. We verbinden je machine en computer via de hotspot van je mobiele telefoon om te bepalen of het probleem bij je netwerk of de machine zelf ligt.',
    ip_address: {
      step1: 'Ga op het touchpaneel van de machine naar:\nNetwerk → Zoek naar "IP-adres"',
      step2: 'De IP ziet er meestal zo uit: 172.20.10.x of 192.168.x.x\n(Dit hangt af van de hotspot van je telefoon)',
      step3: 'Noteer dit IP-adres voor de volgende stap.',
      title: 'Vind het IP-adres van je machine',
      warning: 'Als de IP begint met 169.254, is de verbinding mislukt. Ga terug naar Stap 1 en probeer het opnieuw.',
    },
    success: {
      cause: 'Het verbindingsprobleem dat je hebt ervaren, wordt hoogstwaarschijnlijk veroorzaakt door je lokale netwerkomgeving en niet door de machine zelf.',
      intro: 'Je hebt de Wi-Fi-verbindingstest met succes voltooid — goed gedaan! Dit bevestigt dat je FLUX-machine perfect werkt.',
      recommend1: '• Neem contact op met je internetprovider (ISP) of routerfabrikant voor hulp bij je Wi-Fi-instellingen',
      recommend2: '• Vraag je netwerkbeheerder als je op een school, kantoor of gedeelde werkplek bent',
      recommend3: '• Controleer of je router 2.4GHz ondersteunt en probeer deze opnieuw op te starten',
      recommend_title: 'Wat we aanbevelen:',
      title: 'Goed gedaan! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'Sleutelhangergenerator',
    material_test_generator: 'Materiaaltestgenerator',
    puzzle_generator: 'Puzzelgenerator',
    title: 'Generatoren',
  },
  generic_error: {
  ...
  initialize: {
    ...
    Machines > "Promark Naam" > Promark-instellingen`,
      ...
      setting_completed_ask_camera_calibration: 'De Promark-veldlensinstallatie is succesvol voltooid! Wilt u doorgaan met de camerakalibratie?',
  ...
  keychain_generator: {
    ...
    text_options: {
      ...
      font_settings: 'Lettertype-instellingen',
      font_size: 'Lettergrootte',
      font_style: 'Letterstijl',
  ...
  machine_linking: {
    continue: 'Doorgaan',
    i_have_read: 'Ik heb gelezen',
    input_birthday_to_link: 'Voer uw geboortedatum in om de apparaatkoppeling te voltooien',
    input_birthday_to_link_note: '*Wordt gebruikt om te verifiëren of uw leeftijd voldoet aan de geschiktheidsvereisten',
    link_failed: 'Koppelen mislukt.',
    link_failed_already_linked: 'Dit apparaat is momenteel gekoppeld aan een andere FLUX ID. U kunt het blijven gebruiken of aan uw account koppelen.',
    link_failed_cannot_set_secret: 'Kan koppelingsinformatie niet op het apparaat opslaan. Controleer de verbinding tussen uw computer en het apparaat.',
    link_failed_under_age: 'U voldoet momenteel niet aan de vereisten om deze dienst te gebruiken en kunt de apparaatkoppeling niet voltooien.',
    link_machine: 'FLUX ID koppelen',
    link_machine_to_account: 'Verbonden met %(name)s. Wilt u dit apparaat aan uw account koppelen?',
    link_success: 'Koppelen gelukt.',
    link_to_my_flux_id: 'Koppelen aan mijn FLUX ID',
    privacy_policy: 'Privacybeleid',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Koppelen…',
    use_without_linking: 'Gebruiken zonder koppelen',
  },
  machine_status: {
  ...
  maintenance: {
    ...
    cadence: {
      by_material: 'Per materiaal',
      condition: 'Voorwaarde',
      day: 'Elke dag',
      days: 'Elke %s dagen',
      each_operation: 'Elk gebruik',
      every_1_2_weeks: 'Elke 1–2 weken',
      month: 'Elke maand',
      months: 'Elke %s maanden',
      upon_unboxing: 'Bij het eerste uitpakken',
      week: 'Elke week',
      weeks: 'Elke %s weken',
    },
    celebration: {
    ...
    feedback: {
      ...
      fail_warning: '%s: gemarkeerd voor vervanging van de laserbuis. Open de handleiding voor de stappen.',
      passed: '%s geslaagd — de laserbuis is gezond!',
    },
    footer_tip: 'Tip: graveer maandelijks een voorbeeldbestand om de machine gezond te houden.',
    history_hint: 'Alleen de %s meest recente vermeldingen worden per taak bewaard.',
    intro: 'Volg elke onderhoudstaak voor deze machine en markeer deze met één klik als voltooid.',
    legend: {
      due_soon: 'Binnenkort',
      overdue: 'Verlopen',
    ...
    status: {
      ...
      healthy: 'Gezond',
      last: 'Laatst gedaan',
      never_done: 'Nooit gedaan',
      next: 'Volgende beurt',
      not_checked: 'Niet gecontroleerd',
      not_logged: 'Niet geregistreerd',
      overdue: 'Verlopen',
      replace_tube: 'Laserbuis vervangen',
    },
    tasks: {
      align: {
        keyPoints: 'Stel bij wanneer het optische pad niet is uitgelijnd.',
        name: 'Uitlijning optisch pad',
      },
      chassis: {
        keyPoints: 'Verwijder resten en teerolie van het chassis en de onderklep.',
        name: 'Chassis reinigen',
      },
      door: {
        keyPoints: 'Verwijder vet van de deurklep.',
        name: 'Deurklep reinigen',
      },
      exhaust: {
        keyPoints: 'Verwijder het stof van de ventilatorbladen.',
        name: 'Afzuigventilator reinigen',
      },
      fan: {
        keyPoints: 'Verwijder stof van de bladen van de ventilatieventilator.',
        name: 'Ventilatieventilator reinigen',
      },
      fieldlens: {
        keyPoints: 'Reinig de veldlens en veeg vanuit het midden naar buiten met de klok mee.',
        name: 'Veldlens reinigen',
      },
      honeycomb_plate: {
        keyPoints: 'Verwijder resten en teer uit de roosters van de honingraatplaat.',
        name: 'Honingraatplaat reinigen',
      },
      honeycomb_table: {
        keyPoints: 'Verwijder resten en teerolie van het honingraatgaas.',
      ...
      maintain_test: {
        keyPoints: 'Controleer het statusscherm en de schakelaars.',
        name: 'MAINTAIN-pagina',
      },
      mirrors_combiner: {
        keyPoints: 'Verwijder vuil van lenzen/spiegels; controleer op oxidatie. Laat geen alcohol- of watervlekken achter.',
        name: 'Spiegels, focuslens en beam combiner',
      },
      mirrors_lens: {
        keyPoints: 'Reinig de 4 spiegels en de lens; zorg dat er geen oxidatie of watervlekken zijn.',
        name: 'Spiegels en lens reinigen',
      },
      mod_diode: {
        keyPoints: 'Reinig de ventilator, de focuslens en de POGO pin.',
        name: 'Diode lasermodule',
      },
      mod_ir: {
        keyPoints: 'Reinig de focuslens.',
        name: 'Infrarood lasermodule',
      },
      optical_inspection: {
        keyPoints: 'Inspecteer het optische pad; ook bij het uitpakken en na vervanging van de laserbuis.',
        name: 'Inspectie optisch pad',
      },
      optical_unboxing: {
        keyPoints: 'Zorg dat het optische pad nauwkeurig is. Controleer bij het eerste uitpakken.',
        name: 'Inspectie optisch pad',
      },
      screen: {
        keyPoints: 'Verwijder het stof en vet op het paneel.',
        name: 'Scherm reinigen',
      },
      tube: {
        keyPoints: 'Als 3 mm acryl niet kan worden gesneden bij 70% vermogen, vervang dan de laserbuis.',
        name: 'Conditiecontrole laserbuis',
      },
      water: {
        keyPoints: 'Vul water bij tot meer dan 80% vol, zonder luchtbellen.',
        name: 'Koelwater vervangen',
      },
      worktable: {
        keyPoints: 'Spuit alcohol op een doekje en veeg daarmee de werktafel schoon.',
        name: 'Werktafel reinigen',
      },
      zaxis: {
        keyPoints: 'Veeg de schroefspindel van de Z-askolom af en breng gelijkmatig smeermiddel aan met een wattenstaafje.',
        name: 'Smering Z-askolom',
      },
    },
    title: 'Onderhoudschecklist',
  },
  ...
  message: {
    ...
    camera: {
      ...
      calibration_data_missing: 'Camerakalibratie instellen',
      calibration_data_missing_message: 'Er zijn geen camerakalibratiegegevens.\nImporteer uw opgeslagen kalibratiegegevens of voer de camerakalibratie uit.',
      ...
      fail_to_transmit_image: '#845 Er ging iets mis met beeldoverdracht. Start uw machine of Beam Studio opnieuw op. Als deze fout aanhoudt, volg dan <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">deze handleiding</a>.',
      switching_camera: 'Camera wisselen...',
      wide_angle_open_door: 'Open het deksel',
      wide_angle_open_door_text: 'Open het deksel voordat u overschakelt naar de groothoekcamera.',
  ...
  monitor: {
    ...
    HARDWARE_ERROR_PUMP_ERROR: '#900 Lage koelvloeistofstroom. Controleer uw watertank.',
    HARDWARE_ERROR_REMOTE_INTERLOCK_OPENED: '#927 Externe vergrendeling geactiveerd\nControleer de connector van de externe vergrendeling en zorg ervoor dat deze goed is aangesloten voordat u het werk herstart.',
  ...
  params_label: {
    ...
    preview_hint: 'Dit is een voorbeeld. De tekstinhoud wordt automatisch bijgewerkt voordat een taak wordt verzonden',
    save_as_default: 'Opslaan als standaard',
    settings: 'Instellingen parameterlabel',
    update: 'Bijwerken',
    updated: 'Parameterlabel bijgewerkt',
    use_default: 'Opgeslagen standaard gebruiken',
    use_recommended: 'Aanbevolen gebruiken',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      calculating: 'Berekenen…',
      capturing: 'Afbeelding vastleggen',
      completing: 'Bijna voltooid',
      detecting: 'Uitlijnmarkeringen detecteren',
      locating: 'Uitlijnmarkeringen zoeken',
      preparing: 'Camera voorbereiden',
      refining: 'Positie van markeringen verfijnen',
    },
    alignment: {
    ...
    calibration: {
      align_desc: '1. Leg het afgedrukte kalibratieblad in het werkgebied, plak het vast met tape of schilderstape zodat het niet kan verschuiven en stel scherp.\n2. Klik op ‘Voorvertoning en uitlijnen’ om de camera-uitlijning uit te voeren.\n3. Zodra de markeringen zijn gevonden, klik je op ‘Schalen krassen’ om de referentielijnen met laag vermogen op het blad te krassen.',
      aligned: 'Uitlijnmarkeringen gedetecteerd. Klaar om te krassen.',
      auto_read: 'Schalen aflezen met camera',
      auto_read_failed: 'De schalen konden niet automatisch worden afgelezen. Lees ze met het oog af en voer de waarden in.',
      auto_read_hint: 'De cameralezing kan tot ±2 afwijken; controleer die op het blad.',
      current_offset: 'Huidige verschuiving: X %s mm, Y %s mm',
      export_pdf: 'Kalibratie-PDF exporteren',
      power: 'Vermogen',
      print_desc: '1. Exporteer de PDF van het kalibratieblad. Het bevat de vier uitlijnmarkeringen en twee schalen.\n2. Druk het blad af op 100% (ware grootte).',
      reading_desc: '1. Zoek de langste gekraste lijn (de middelste) en kijk aan welke kant van de afgedrukte 0-lijn die ligt.\n2. Ga lijn voor lijn naar die kant tot een gekraste lijn en een afgedrukte lijn precies samenvallen.\n3. Tel vanaf 0 tot die afgedrukte lijn (om de 5 lijnen staat een getal; tel de ongenummerde lijnen ertussen mee).',
      reading_x: 'X-aflezing',
      reading_y: 'Y-aflezing',
      scratch: 'Schalen krassen',
      speed: 'Snelheid',
      title: 'Printen en snijden-kalibratie',
    },
    ...
    finish: 'Voltooien',
    fit_content: 'Aanpassen aan inhoud',
    generate_from_contour: 'Genereren uit contour',
    ...
    paper_size: 'Uitvoergrootte',
    paper_too_small: 'Het uitvoerbereik is te klein. Het ontwerp (inclusief uitlijnmarkeringen) heeft minstens %s mm marge tot de rand van het materiaal nodig om binnen het afdrukbare gebied van de printer te blijven. Kies een grotere uitvoergrootte, anders wordt de afdruk bijgesneden of verkleind.',
    preview_and_align: 'Voorvertoning en uitlijnen',
    resume_desc: 'Dit ontwerp is al voorbereid voor Printen en snijden.\nPlaats het volgende bedrukte materiaal in de machine en ga door naar de camera-uitlijning, of begin opnieuw om het ontwerp, de uitvoergrootte of het snijpad te wijzigen.',
    resume_title: 'Printen en snijden hervatten',
    select_cut_layer: 'Laag met snijpad',
    ...
    step_setup: 'Snijpaden en markeringen',
    ...
    uv_print_file_disabled: 'Printen en snijden print de inhoud van de UV-printlagen. Schakel "UV-afdrukbestand inschakelen" in bij de voorkeuren en voeg je ontwerp toe aan een UV-printlaag.',
  ...
  puzzle_generator: {
    ...
    columns: 'Kolommen',
    design_preview: 'Ontwerpvoorbeeld',
    exploded_view: 'Explosieweergave',
    export_as: 'Exporteren als',
    export_engrave: 'Graveerlaag',
    export_failed: 'Kan puzzel niet naar canvas importeren. Probeer het opnieuw of pas de puzzelinstellingen aan.',
    export_none: 'Geen',
    export_print: 'Afdruklaag',
    file_too_large: 'Het geselecteerde bestand overschrijdt de maximaal toegestane grootte.',
    ...
    piece_size: 'Stukgrootte',
    preview_placeholder: 'Puzzelvoorbeeld',
    puzzle_board: 'Puzzelbord',
    puzzle_pieces: 'Puzzelstukken',
    radius: 'Radius',
    raised_edges: 'Verhoogde randen',
    ...
    types: {
      ...
      heart_jigsaw: 'Hartvormige puzzel',
      hex_jigsaw: 'Hexagonale puzzel',
      rectangle_jigsaw: 'Rechthoekige puzzel',
    },
    unsupported_file_type: 'Niet-ondersteund bestandstype. Gebruik JPG, PNG of WebP.',
    upload_hint: 'JPG, PNG, WebP (max 10MB)',
    upload_image: 'Klik of sleep om te uploaden',
    zoom: 'Zoom',
  },
  qr_code_generator: {
  ...
  tips: {
    canvas_hold_space_to_pan: 'Houd de spatiebalk ingedrukt en sleep om over het canvas te bewegen.',
    feature_auto_fit: 'Na cameravoorbeeld kunt u Acties → Automatisch aanpassen gebruiken om objecten automatisch op uw materiaal te plaatsen.',
    feature_box_generator: 'Gebruik Generatoren → Box Generator om in enkele seconden dozen van aangepast formaat te maken.',
    feature_code_generator: 'Gebruik Generatoren → Barcode Generator om QR-codes en barcodes te maken.',
    feature_elements: 'Het Elements-paneel bevat nu meer dan een miljoen graphics die klaar zijn voor gebruik.',
    feature_layer_color_configurations: 'Koppel SVG-laagkleuren aan snelheid en vermogen via Bewerken → Laag → Kleurinstellingen.',
    feature_material_test: 'Gebruik Generatoren → Material Test Generator in de linkerwerkbalk om snel de beste instellingen voor een materiaal te vinden.',
    layer_execution_order: 'De laagvolgorde bepaalt de taakvolgorde. Taken worden van boven naar beneden uitgevoerd.',
    machine_clean_mirror: 'Controleer de spiegels en focuslens regelmatig en reinig ze indien nodig om ophoping van rook te voorkomen.',
    machine_no_unattended_operation: 'Laat de machine nooit onbeheerd draaien.',
    machine_regular_start: 'Voer minstens eens per twee weken een lasertaak uit om de levensduur van de laserbuis te verlengen.',
    object_edit_image_to_erase: 'Gebruik Afbeelding → Acties → Afbeelding bewerken om ongewenste gebieden in een afbeelding te wissen.',
    object_polygon_sides: 'Pas het aantal zijden aan in het eigenschappenpaneel van de veelhoek.',
    object_rounded_rectangle: 'Stel de hoekradius van een afgeronde rechthoek in in het eigenschappenpaneel van de rechthoek.',
    object_sharpen_portrait: 'Verbeter portretgravures met Afbeelding → Acties → Verscherpen.',
    settings_auto_save: 'Schakel Automatisch opslaan in Voorkeuren in om te voorkomen dat u uw werk verliest.',
    settings_default_text_font: 'U kunt uw standaardlettertype voor de teksttool instellen in Voorkeuren.',
    task_focus_lower_for_cutting: 'Voor dikkere materialen kan focussen ongeveer 2 mm onder het oppervlak de snijresultaten verbeteren.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Kan geen verbinding maken met machinecamera. Start uw machine of Beam Studio opnieuw op. Als deze fout zich blijft voordoen, volg dan <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">deze handleiding</a>.',
      ...
      fail_to_start_preview: '#803 Kan voorbeeldmodus niet starten. Start uw machine of Beam Studio opnieuw op. Als deze fout zich blijft voordoen, volg dan <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">deze handleiding</a>.',
      ...
      start_preview_timeout: '#803 Time-out opgetreden bij het starten van de voorbeeldmodus. Start uw machine of Beam Studio opnieuw op. Als deze fout zich blijft voordoen, volg dan <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">deze handleiding</a>.',
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Printen en snijden kalibreren',
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Kalibratiegegevens exporteren',
      ...
      import_promark_engraving_example_1: 'Voorbeeld van Promark-gravure I',
      import_promark_engraving_example_2: 'Voorbeeld van Promark-gravure II',
      ...
      machines: 'Machines',
      maintenance_checklist: 'Onderhoudschecklist',
