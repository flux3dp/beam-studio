    ...
    material_browser: {
      ...
      catalog: {
        ...
        presets: {
          ...
          engraving_quality: 'Graveren (kwaliteit)',
      ...
      editor: {
        ...
        parent_hint: 'Indien ingesteld, wordt het getoond als diktevariant onder het bovenliggende materiaal (niet in het bovenste raster).',
        parent_material: 'Bovenliggend materiaal',
        photo: 'Foto',
        tags: 'Tags',
        thickness_inch: 'Dikte (inch)',
        thickness_inch_hint: 'Breuken zijn toegestaan',
