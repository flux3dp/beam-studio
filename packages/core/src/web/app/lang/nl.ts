...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Het gebruik van te hoge snelheden voor lagen met 3D-curveobjecten kan de graveernauwkeurigheid verminderen.\nWe raden aan de snelheid onder %(limit)s te houden voor optimale resultaten met 3D-curveobjecten.',
      too_fast_for_curve_and_constrain: 'De volgende lagen: %(layers)s overschrijden de snelheidslimiet van %(limit)s.\nDe graveersnelheid voor 3D-curveobjecten wordt beperkt tot %(limit)s. U kunt deze limiet verwijderen in de Voorkeursinstellingen.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'De graveersnelheid van 3D-curve-objecten wordt beperkt tot %(limit)s. U kunt deze limiet verwijderen in de Voorkeurinstellingen.',
