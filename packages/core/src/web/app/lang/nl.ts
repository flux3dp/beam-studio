...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_1: 'Print het schaakbord (A4/Letter).',
    put_chessboard_2: 'Plak het plat op een stijve plaat.',
    put_chessboard_3: 'Plaats in het midden en voer autofocus uit.',
