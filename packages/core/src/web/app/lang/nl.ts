...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: 'Download en print het volgende bestand op A4-papier voor de camerakalibratie.',
    put_chessboard_bm2_2: 'Plaats het kalibratiepapier plat op de aangegeven positie in het werkgebied.',
