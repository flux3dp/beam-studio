...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    hole_offset: 'Offset',
    hole_position: 'Positie',
    hole_thickness: 'Dikte',
    hole_type: 'Type',
    hole_type_punch: 'Ponsgat',
    hole_type_ring: 'Ring',
    ...
    position_ref: 'Positie',
    position_ref_bottom_center: 'Onder',
    position_ref_left_center: 'Links',
    position_ref_right_center: 'Rechts',
    position_ref_top_center: 'Boven',
    ...
    types: {
      hotel_key_chain: 'Hotel sleutelhanger',
      rectangle: 'Rechthoek',
      text: 'Tekst',
    },
  },
