...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Positie: Lijn uit met het gegraveerde punt linkerbovenhoek.',
    align_4_1: 'Positie: Lijn uit met het gegraveerde punt rechterbovenhoek.',
    align_4_2: 'Positie: Lijn uit met het gegraveerde punt linkerbenedenhoek.',
    align_4_3: 'Positie: Lijn uit met het gegraveerde punt rechterbenedenhoek.',
    align_8_0: 'Positie: Lijn uit met het gegraveerde punt aan de buitenkant linksboven.',
    align_8_1: 'Positie: Lijn uit met het gegraveerde punt aan de buitenkant rechtsboven.',
    align_8_2: 'Positie: Lijn uit met het gegraveerde punt aan de buitenkant linksonder.',
    align_8_3: 'Positie: Lijn uit met het gegraveerde punt aan de buitenkant rechtsonder.',
    align_8_4: 'Positie: Lijn uit met het gegraveerde punt aan de binnenkant linksboven.',
    align_8_5: 'Positie: Lijn uit met het gegraveerde punt aan de binnenkant rechtsboven.',
    align_8_6: 'Positie: Lijn uit met het gegraveerde punt aan de binnenkant linksonder.',
    align_8_7: 'Positie: Lijn uit met het gegraveerde punt aan de binnenkant rechtsonder.',
    ...
    charuco_open_the_machine_lid: 'Open het deksel van de machine.',
    charuco_place_charuco: 'Plaats het afgedrukte kalibratiepatroon horizontaal op de <b>%s</b> van het werkgebied.',
    ...
    check_pnp_desc: 'We hebben de beelden opnieuw genomen op basis van de kalibratieresultaten en de graveerreferentiepunten gemarkeerd.\nControleer of de rode markeringen overeenkomen met de werkelijke graveerpunten.\nAls u een duidelijke afwijking ziet, klik dan op "Opnieuw kalibreren" om het opnieuw te proberen.',
    ...
    solve_pnp_keep_door_closed: 'Houd de deur gesloten tijdens het volgende proces. Als de deur wordt geopend, probeert het systeem de camera opnieuw te positioneren.',
    ...
    solve_pnp_relocate_camera: 'Klik op "Camera opnieuw positioneren" als de laserhead nog niet horizontaal is gecentreerd.',
