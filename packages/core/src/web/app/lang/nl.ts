...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'De uitvoergrootte (%s) overschrijdt het aanbevolen maximum van %d × %d px. De verwerking kan enkele minuten duren en het resultaat kan Beam Studio vertragen. Toch doorgaan?',
