...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'Kích thước đầu ra (%s) vượt quá mức khuyến nghị tối đa %d × %d px. Quá trình xử lý có thể mất vài phút và kết quả có thể làm chậm Beam Studio. Vẫn tiếp tục?',
