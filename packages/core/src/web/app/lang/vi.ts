...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Làm thế nào để cải thiện độ chính xác phát hiện?',
    ...
    retake: 'Chụp lại ảnh',
    retake_tooltip: 'Chụp lại ảnh camera tại vị trí của từng đối tượng để phát hiện tốt hơn',
    retry_with_remove_bg: 'Xóa nền',
    retry_with_remove_bg_tooltip: 'Xóa nền khỏi ảnh xem trước để cải thiện phát hiện đường viền',
    rotation: 'Xoay',
    ...
    use_original_image_tooltip: 'Khôi phục ảnh xem trước gốc mà không xóa nền',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s tín dụng AI',
      credit_balance: 'Số dư tín dụng AI',
      credit_cost: 'Tín dụng AI sử dụng',
      description: 'Tăng độ phân giải và chi tiết hình ảnh bằng AI. Hình ảnh sau khi nâng cấp sẽ thay thế ảnh gốc trên canvas.',
      done: 'Nâng cấp tạo sinh hoàn tất',
      dpi_recommended: 'Khuyến nghị cho DPI của lớp hiện tại: %dx.',
      dpi_recommended_capped: 'Khuyến nghị cho DPI của lớp hiện tại: %dx, nhưng %dx là mức lớn nhất trong kích thước đầu ra khuyến nghị.',
      failed: 'Không thể hoàn tất nâng cấp tạo sinh. Vui lòng kiểm tra kết nối mạng và thử lại.',
      insufficient_credit: 'Không đủ tín dụng AI để chạy nâng cấp tạo sinh.',
      layer_dpi: 'DPI của lớp',
      original_size: 'Kích thước gốc',
      output_size: 'Kích thước đầu ra',
      oversize_warning: 'Kích thước đầu ra (%s) vượt quá mức khuyến nghị tối đa %dpx x %dpx. Quá trình xử lý có thể mất vài phút và kết quả có thể làm chậm Beam Studio. Vẫn tiếp tục?',
      processing: 'Đang nâng cấp…',
      processing_hint: 'Thời gian xử lý phụ thuộc vào kích thước ảnh và tình trạng mạng.',
      recommended: 'Khuyến nghị',
      retry: 'Thử lại',
      start: 'Bắt đầu nâng cấp',
    },
    announcement_panel: {
      title: 'Thông báo',
    },
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: 'Tạo công việc nhanh hơn',
        keep_current: 'Giữ hiện tại',
        message: 'Chúng tôi đã nâng cấp công cụ tính toán công việc để cải thiện hiệu suất và tăng tốc độ tạo công việc.\nBạn có muốn chuyển sang công cụ tăng tốc mới không?\nBạn có thể tắt bất cứ lúc nào trong %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'Trong chế độ khắc đường cong, tốc độ hiện tại có thể quá cao và có thể ảnh hưởng đến chi tiết khắc cho các lớp: %(layers)s.\nHãy cân nhắc giảm tốc độ để có chất lượng tốt hơn.',
    ...
    right_panel: {
      laser_panel: {
        ...
        texture: 'Kết cấu',
        texture_angle: 'Góc',
        texture_intensity: 'Cường độ',
        texture_interval: 'Khoảng cách',
        texture_random: 'Ngẫu nhiên',
        texture_stripe: 'Sọc',
        times: 'lần',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Nâng cấp tạo sinh',
          ai_upscale_short: 'Nâng cấp',
          ai_upscale_too_large: 'Hình ảnh này quá lớn để phóng to bằng AI. Kích thước tối đa được hỗ trợ là %dpx x %dpx.',
          array: 'Mảng',
          ...
          to_image: 'Thành Hình ảnh',
          to_path: 'Thành Đường dẫn',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Di chuyển đầu laser để căn chỉnh ánh sáng đỏ với tâm của <b>điểm A</b>.',
    charuco_move_to_point_b: 'Di chuyển đầu laser theo chiều ngang để căn chỉnh ánh sáng đỏ với tâm của <b>điểm B</b>.',
    ...
    check_pnp_desc: 'Đảm bảo các dấu đỏ căn chỉnh với các điểm khắc\nNếu không, nhấp vào "Quay Lại" để điều chỉnh.\nNếu mọi thứ đều ổn, làm tốt lắm! 🎉',
    ...
    put_charuco: 'Đặt Mẫu Hiệu Chuẩn',
    put_charuco_1: 'In mẫu hiệu chuẩn (A4/Letter).',
    put_charuco_2: 'Dán phẳng lên một tấm cứng.',
    put_charuco_3: 'Đặt ở giữa và lấy nét tự động.',
    put_charuco_bm2_1: 'In tệp mẫu hiệu chuẩn trên giấy A4 (kích thước Letter) để hiệu chuẩn.',
    put_charuco_bm2_2: 'Nhấn “Tiếp theo” và làm theo hướng dẫn để đặt tờ giấy.',
    put_charuco_promark_2: "Hãy đảm bảo giấy hiệu chuẩn được nhìn thấy rõ ràng và không bị chói. Nhấn 'Tiếp theo' để chụp ảnh.",
    put_charuco_promark_desc_1: 'Vui lòng sử dụng giấy hiệu chuẩn có trong hộp phụ kiện hoặc in mẫu hiệu chuẩn sau trên giấy A4 để hiệu chuẩn camera.',
    ...
    put_paper_promark: 'Đặt Bìa Đen',
    put_paper_promark_1: 'Đặt tấm bìa đen từ hộp phụ kiện lên bề mặt làm việc.',
    put_paper_promark_2: 'Điều chỉnh tiêu cự đúng cách, sau đó nhấn "Bắt Đầu Khắc" để tiếp tục.',
  ...
  connection_issue_guide: {
    alert_link: 'Bị ngắt kết nối? Hãy thử cách khắc phục sự cố này.',
    connect_computer: {
      content: 'Máy tính của bạn phải ở cùng mạng với máy.',
      macos_steps: 'Nhấp vào biểu tượng Wi-Fi trên thanh menu. Sau đó chọn điểm phát sóng của điện thoại bạn.',
      macos_title: 'macOS',
      title: 'Kết Nối Máy Tính Của Bạn',
      windows_steps: 'Nhấp vào biểu tượng mạng trên thanh tác vụ. Sau đó chọn điểm phát sóng của điện thoại bạn.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Máy không tìm thấy điểm phát sóng của tôi',
      dont_know_hotspot_name: 'Tôi không biết tên điểm phát sóng của mình',
      step1: '1. Trên bảng điều khiển cảm ứng của máy, đi tới: Mạng → Kết nối Wi-Fi.',
      step2: '2. Tìm và chọn tên điểm phát sóng của điện thoại bạn từ danh sách Wi-Fi.',
      step3: '3. Nhập mật khẩu điểm phát sóng và kết nối.',
    ...
    enter_ip: {
      ...
      step1: 'Nhập địa chỉ IP bạn tìm thấy ở bước trước.',
      step2: 'Nhấp "Xác minh" để kiểm tra kết nối.',
      step3: 'Beam Studio sẽ kiểm tra:',
      title: 'Nhập Địa Chỉ IP Của Máy',
      verify: 'Xác minh',
    },
    fail: {
      bullet1: '• Kiểu máy và số sê-ri của bạn',
      bullet2: '• Địa chỉ IP hiển thị trên bảng điều khiển cảm ứng',
      bullet3: '• Mô tả lỗi bạn gặp phải',
      contact_title: 'Khi liên hệ hỗ trợ, bạn nên chuẩn bị sẵn:',
      intro: 'Đừng lo — điều này không nhất thiết có nghĩa là máy của bạn có vấn đề. Có thể có các yếu tố khác ảnh hưởng đến kết nối. Đội ngũ hỗ trợ của chúng tôi luôn sẵn sàng giúp bạn tìm ra nguyên nhân.',
      title: 'Chúng Tôi Không Thể Hoàn Tất Bài Kiểm Tra',
    },
    hotspot: {
      android_steps: 'Cài đặt → Kết nối → Điểm phát sóng di động và chia sẻ kết nối → Điểm phát sóng di động',
      android_title: 'Android',
      ios_steps: 'Cài đặt → Điểm phát sóng cá nhân → Cho phép người khác tham gia',
      ios_title: 'iPhone (iOS)',
      tip: 'Mẹo: Sử dụng tên điểm phát sóng tiếng Anh đơn giản và mật khẩu dạng số (ví dụ Tên: FLUX_Test   Mật khẩu: 12345678)',
      warning_2_4ghz: 'Quan trọng: Máy FLUX chỉ hỗ trợ Wi-Fi 2.4GHz. Đặt điểm phát sóng của bạn thành 2.4GHz trước khi tiếp tục.',
    },
    how_it_works: 'Cách bài kiểm tra hoạt động:',
    how_it_works_step1: '1. Thiết lập điện thoại của bạn thành điểm phát sóng Wi-Fi.',
    how_it_works_step2: '2. Kết nối máy với điểm phát sóng.',
    how_it_works_step3: '3. Kết nối máy tính của bạn với cùng điểm phát sóng.',
    how_it_works_step4: '4. Kiểm tra kết nối trong Beam Studio.',
    intro: 'Hãy chạy một bài kiểm tra nhanh để kiểm tra xem máy của bạn có hoạt động bình thường không. Chúng tôi sẽ kết nối máy và máy tính của bạn qua điểm phát sóng của điện thoại di động để xác định vấn đề nằm ở mạng của bạn hay ở chính chiếc máy.',
    ip_address: {
      step1: 'Trên bảng điều khiển cảm ứng của máy, đi tới:\nMạng → Tìm "Địa chỉ IP"',
      step2: 'IP thường có dạng: 172.20.10.x hoặc 192.168.x.x\n(Điều này phụ thuộc vào điểm phát sóng của điện thoại bạn)',
      step3: 'Ghi lại địa chỉ IP này cho bước tiếp theo.',
      title: 'Tìm Địa Chỉ IP Của Máy',
      warning: 'Nếu IP bắt đầu bằng 169.254, kết nối đã thất bại. Quay lại Bước 1 và thử lại.',
    },
    success: {
      cause: 'Sự cố kết nối bạn gặp phải nhiều khả năng do môi trường mạng cục bộ của bạn, không phải do chính chiếc máy.',
      intro: 'Bạn đã hoàn thành thành công bài kiểm tra kết nối Wi-Fi — làm tốt lắm! Điều này xác nhận máy FLUX của bạn đang hoạt động hoàn hảo.',
      recommend1: '• Liên hệ Nhà cung cấp dịch vụ Internet (ISP) hoặc nhà sản xuất bộ định tuyến để được trợ giúp về cài đặt Wi-Fi',
      recommend2: '• Hỏi quản trị viên mạng nếu bạn đang ở trường học, văn phòng hoặc không gian làm việc chung',
      recommend3: '• Kiểm tra xem bộ định tuyến của bạn có hỗ trợ 2.4GHz không và thử khởi động lại',
      recommend_title: 'Chúng Tôi Khuyến Nghị:',
      title: 'Tuyệt Vời! 🎉',
    },
    title: 'Sự Cố Kết Nối?',
  },
  ...
  generators: {
    ...
    keychain_generator: 'Trình tạo móc khóa',
  ...
  initialize: {
    ...
    select_promark: 'Chọn Promark của bạn',
    setting_completed: {
      back: 'Quay lại',
  ...
  machine_linking: {
    continue: 'Tiếp tục',
    i_have_read: 'Tôi đã đọc',
    input_birthday_to_link: 'Vui lòng nhập ngày sinh của bạn để hoàn tất liên kết thiết bị',
    input_birthday_to_link_note: '*Được sử dụng để xác minh liệu tuổi của bạn có đáp ứng yêu cầu về độ tuổi hay không',
    link_failed: 'Liên kết thất bại.',
    link_failed_already_linked: 'Thiết bị này hiện đang được liên kết với FLUX ID khác. Bạn có thể tiếp tục sử dụng hoặc liên kết với tài khoản của bạn.',
    link_failed_cannot_set_secret: 'Không thể lưu thông tin liên kết vào thiết bị. Vui lòng kiểm tra kết nối giữa máy tính và thiết bị.',
    link_failed_under_age: 'Bạn hiện không đủ điều kiện để sử dụng dịch vụ này và không thể hoàn tất liên kết thiết bị.',
    link_machine: 'Liên kết FLUX ID',
    link_machine_to_account: 'Đã kết nối với %(name)s. Bạn có muốn liên kết thiết bị này với tài khoản của mình không?',
    link_success: 'Liên kết thành công.',
    link_to_my_flux_id: 'Liên kết với FLUX ID của tôi',
    privacy_policy: 'Chính sách Bảo mật',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Đang liên kết…',
    use_without_linking: 'Sử dụng không liên kết',
  },
  machine_status: {
  ...
  maintenance: {
    ...
    cadence: {
      by_material: 'Theo vật liệu',
      condition: 'Theo tình trạng',
      day: 'Hằng ngày',
      days: 'Mỗi %s ngày',
      each_operation: 'Mỗi lần vận hành',
      every_1_2_weeks: 'Mỗi 1–2 tuần',
      month: 'Hằng tháng',
      months: 'Mỗi %s tháng',
      upon_unboxing: 'Khi mở hộp lần đầu',
      week: 'Hằng tuần',
      weeks: 'Mỗi %s tuần',
    },
    celebration: {
    ...
    feedback: {
      ...
      fail_warning: '%s: cần thay ống laser. Mở hướng dẫn để xem các bước.',
      passed: '%s đạt — ống laser vẫn tốt!',
    },
    footer_tip: 'Mẹo: khắc một tệp mẫu mỗi tháng để giữ máy luôn hoạt động tốt.',
    history_hint: 'Mỗi hạng mục chỉ lưu %s mục gần nhất.',
    intro: 'Theo dõi từng hạng mục bảo trì của máy này và đánh dấu hoàn tất chỉ với một cú nhấp.',
    legend: {
    ...
    status: {
      ...
      healthy: 'Tốt',
      last: 'Lần cuối',
      never_done: 'Chưa từng làm',
      next: 'Hạn kế tiếp',
      not_checked: 'Chưa kiểm tra',
      not_logged: 'Chưa ghi nhận',
      overdue: 'Quá hạn',
      replace_tube: 'Thay ống laser',
    },
    tasks: {
      align: {
        keyPoints: 'Điều chỉnh khi đường quang bị lệch.',
        name: 'Căn chỉnh đường quang',
      },
      chassis: {
        keyPoints: 'Loại bỏ cặn bẩn và dầu hắc trên khung máy và nắp đáy.',
        name: 'Vệ sinh khung máy',
      },
      door: {
        keyPoints: 'Loại bỏ dầu mỡ trên nắp cửa.',
        name: 'Vệ sinh nắp cửa',
      },
      exhaust: {
        keyPoints: 'Làm sạch bụi trên cánh quạt.',
        name: 'Vệ sinh quạt hút khói',
      },
      fan: {
        keyPoints: 'Loại bỏ bụi trên cánh quạt thông gió.',
        name: 'Vệ sinh quạt thông gió',
      },
      fieldlens: {
        keyPoints: 'Vệ sinh ống kính trường, lau từ tâm ra ngoài theo chiều kim đồng hồ.',
        name: 'Vệ sinh ống kính trường',
      },
      honeycomb_plate: {
        keyPoints: 'Loại bỏ cặn bẩn và hắc ín trong các ô của tấm tổ ong.',
        name: 'Vệ sinh tấm tổ ong',
      },
      honeycomb_table: {
        keyPoints: 'Loại bỏ cặn bẩn và dầu hắc trên lưới tổ ong.',
      ...
      maintain_test: {
        keyPoints: 'Kiểm tra màn hình trạng thái và các công tắc.',
        name: 'Trang MAINTAIN',
      },
      mirrors_combiner: {
        keyPoints: 'Loại bỏ bụi bẩn trên thấu kính/gương; kiểm tra hiện tượng oxy hóa. Không để lại vết cồn hay vết nước.',
        name: 'Gương, thấu kính tiêu cự & bộ ghép chùm tia',
      },
      mirrors_lens: {
        keyPoints: 'Vệ sinh 4 gương và thấu kính; đảm bảo không bị oxy hóa hay có vết nước.',
        name: 'Vệ sinh gương & thấu kính',
      },
      mod_diode: {
        keyPoints: 'Vệ sinh quạt, thấu kính tiêu cự và POGO pin.',
        name: 'Mô-đun laser điốt',
      },
      mod_ir: {
        keyPoints: 'Vệ sinh thấu kính tiêu cự.',
        name: 'Mô-đun laser hồng ngoại',
      },
      optical_inspection: {
        keyPoints: 'Kiểm tra đường quang; cũng thực hiện khi mở hộp và sau khi thay ống laser.',
        name: 'Kiểm tra đường quang',
      },
      optical_unboxing: {
        keyPoints: 'Đảm bảo đường quang chính xác. Kiểm tra khi mở hộp lần đầu.',
        name: 'Kiểm tra đường quang',
      },
      screen: {
        keyPoints: 'Làm sạch bụi và dầu mỡ trên bảng điều khiển.',
        name: 'Vệ sinh màn hình',
      },
      tube: {
        keyPoints: 'Nếu không cắt được acrylic 3 mm ở mức công suất 70%, hãy thay ống laser.',
        name: 'Kiểm tra tình trạng ống laser',
      },
      water: {
        keyPoints: 'Thêm nước đến hơn 80% dung tích và không có bọt khí.',
        name: 'Thay nước làm mát',
      },
      worktable: {
        keyPoints: 'Xịt cồn lên khăn giấy, sau đó lau bàn làm việc.',
        name: 'Vệ sinh bàn làm việc',
      },
      zaxis: {
        keyPoints: 'Lau trục vít cột Z, sau đó bôi đều dầu bôi trơn bằng tăm bông.',
        name: 'Bôi trơn trục vít cột Z',
      },
    },
  ...
  message: {
    ...
    camera: {
      ...
      fail_to_transmit_image: '#845 Đã xảy ra lỗi khi truyền ảnh. Vui lòng khởi động lại máy hoặc Beam Studio. Nếu lỗi này vẫn xảy ra, vui lòng làm theo <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">hướng dẫn này</a>.',
      switching_camera: 'Đang chuyển đổi camera...',
      wide_angle_open_door: 'Mở nắp',
      wide_angle_open_door_text: 'Vui lòng mở nắp trước khi chuyển sang camera góc rộng.',
  ...
  params_label: {
    ...
    preview_hint: 'Đây là bản xem trước. Nội dung văn bản sẽ được tự động cập nhật trước khi gửi tác vụ',
    save_as_default: 'Lưu làm mặc định',
    settings: 'Cài đặt nhãn thông số',
    update: 'Cập nhật',
    updated: 'Đã cập nhật nhãn thông số',
    use_default: 'Dùng mặc định đã lưu',
    use_recommended: 'Dùng đề xuất',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      ...
      completing: 'Sắp hoàn tất',
      detecting: 'Đang phát hiện dấu căn chỉnh',
      locating: 'Đang tìm dấu căn chỉnh',
      preparing: 'Đang chuẩn bị camera',
      refining: 'Đang tinh chỉnh vị trí dấu',
    },
    alignment: {
    ...
    export_pdf: 'Xuất PDF',
    finish: 'Hoàn tất',
    fit_content: 'Vừa với nội dung',
    generate_from_contour: 'Tạo từ đường viền',
    grid_columns: 'Cột',
    grid_rows: 'Hàng',
    ...
    paper_size: 'Kích thước đầu ra',
    paper_too_small: 'Vùng đầu ra quá nhỏ. Thiết kế (bao gồm cả dấu căn chỉnh) cần ít nhất %s mm lề tính từ mép vật liệu để nằm trong vùng in được của máy in. Hãy chọn kích thước đầu ra lớn hơn, nếu không bản in sẽ bị cắt xén hoặc thu nhỏ.',
    preview_and_align: 'Xem trước và căn chỉnh',
    resume_desc: 'Thiết kế này đã được chuẩn bị cho In và cắt.\nĐặt vật liệu đã in tiếp theo vào máy và tiếp tục căn chỉnh bằng camera, hoặc bắt đầu lại để thay đổi thiết kế, kích thước đầu ra hoặc đường cắt.',
    resume_title: 'Tiếp tục In và cắt',
    select_cut_layer: 'Lớp đường cắt',
    ...
    uv_print_file_disabled: 'In và cắt sẽ in nội dung của các lớp In UV. Vui lòng bật "Bật tệp in UV" trong tùy chọn, sau đó thêm thiết kế của bạn vào lớp In UV.',
  ...
  puzzle_generator: {
    ...
    columns: 'Cột',
    design_preview: 'Xem trước thiết kế',
    exploded_view: 'Chế độ xem phân tách',
    export_as: 'Xuất dưới dạng',
    export_engrave: 'Lớp khắc',
    export_failed: 'Không thể nhập ghép hình vào canvas. Vui lòng thử lại hoặc điều chỉnh cài đặt ghép hình.',
    export_none: 'Không có',
    export_print: 'Lớp in',
    file_too_large: 'Tệp đã chọn vượt quá kích thước tối đa cho phép.',
    ...
    orientation_type_1: 'Loại 1',
    orientation_type_2: 'Loại 2',
    orientation_type_3: 'Loại 3',
    orientation_type_4: 'Loại 4',
    piece_size: 'Kích thước mảnh ghép',
    preview_placeholder: 'Xem trước ghép hình',
    puzzle_board: 'Bảng ghép hình',
    puzzle_pieces: 'Mảnh ghép',
    radius: 'Bán kính',
    ...
    types: {
      ...
      heart_jigsaw: 'Ghép hình trái tim',
      hex_jigsaw: 'Ghép hình lục giác',
      rectangle_jigsaw: 'Ghép hình chữ nhật',
    },
    unsupported_file_type: 'Loại tệp không được hỗ trợ. Vui lòng sử dụng JPG, PNG hoặc WebP.',
    upload_hint: 'JPG, PNG, WebP (tối đa 10MB)',
    upload_image: 'Nhấp hoặc kéo để tải lên',
    zoom: 'Thu phóng',
  },
  qr_code_generator: {
  ...
  tips: {
    canvas_hold_space_to_pan: 'Giữ phím Space và kéo để di chuyển trên canvas.',
    feature_auto_fit: 'Sau khi xem trước camera, sử dụng Hành động → Tự động khớp để tự động đặt các đối tượng trên vật liệu của bạn.',
    feature_box_generator: 'Sử dụng Trình tạo → Trình tạo hộp để tạo hộp kích thước tùy chỉnh trong vài giây.',
    feature_code_generator: 'Sử dụng Trình tạo → Trình tạo mã vạch để tạo mã QR và mã vạch.',
    feature_elements: 'Bảng điều khiển Phần tử hiện bao gồm hơn một triệu đồ họa sẵn sàng sử dụng.',
    feature_layer_color_configurations: 'Ánh xạ màu lớp SVG với tốc độ và công suất thông qua Chỉnh sửa → Lớp → Cài đặt màu.',
    feature_material_test: 'Sử dụng Trình tạo → Trình tạo kiểm tra vật liệu trong thanh công cụ bên trái để nhanh chóng tìm cài đặt tốt nhất cho vật liệu.',
    layer_execution_order: 'Thứ tự lớp xác định thứ tự công việc. Công việc chạy từ trên xuống dưới.',
    machine_clean_mirror: 'Kiểm tra gương và thấu kính tiêu cự thường xuyên và làm sạch khi cần thiết để ngăn tích tụ khói.',
    machine_no_unattended_operation: 'Không bao giờ để máy chạy mà không có giám sát.',
    machine_regular_start: 'Chạy công việc laser ít nhất một lần mỗi hai tuần để giúp kéo dài tuổi thọ ống laser.',
    object_edit_image_to_erase: 'Sử dụng Hình ảnh → Hành động → Chỉnh sửa hình ảnh để xóa các vùng không mong muốn trong hình ảnh.',
    object_polygon_sides: 'Điều chỉnh số cạnh trong bảng thuộc tính của đa giác.',
    object_rounded_rectangle: 'Đặt bán kính góc của hình chữ nhật bo tròn trong bảng thuộc tính của hình chữ nhật.',
    object_sharpen_portrait: 'Cải thiện khắc chân dung với Hình ảnh → Hành động → Làm sắc nét.',
    settings_auto_save: 'Bật Tự động lưu trong Tùy chọn để tránh mất công việc của bạn.',
    settings_default_text_font: 'Bạn có thể đặt phông chữ mặc định cho công cụ Văn bản trong Tùy chọn.',
    task_focus_lower_for_cutting: 'Đối với vật liệu dày hơn, lấy tiêu điểm khoảng 2 mm dưới bề mặt có thể cải thiện kết quả cắt.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Không thể kết nối với camera máy. Vui lòng khởi động lại máy hoặc Beam Studio. Nếu lỗi này vẫn xảy ra, vui lòng làm theo <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">hướng dẫn này</a>.',
      fail_to_get_door_status: 'Vui lòng đảm bảo nắp đã đóng để bật laser thấp cho khung chạy.',
      fail_to_start_preview: '#803 Không thể bắt đầu chế độ xem trước. Vui lòng khởi động lại máy hoặc Beam Studio. Nếu lỗi này vẫn xảy ra, vui lòng làm theo <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">hướng dẫn này</a>.',
      ...
      start_preview_timeout: '#803 Đã xảy ra lỗi khi bắt đầu chế độ xem trước. Vui lòng khởi động lại máy hoặc Beam Studio. Nếu lỗi này vẫn xảy ra, vui lòng làm theo <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">hướng dẫn này</a>.',
    ...
    menu: {
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Xuất dữ liệu hiệu chuẩn',
      ...
      import_beamo_2_printing_test: 'Kiểm tra in beamo II',
      import_calibration_data: 'Nhập dữ liệu hiệu chuẩn',
      ...
      machines: 'Máy in',
      maintenance_checklist: 'Danh sách bảo trì',
