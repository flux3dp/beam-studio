...
const lang: ILang = {
  ...
  beambox: {
    ...
    tool_panels: {
      ...
      _offset: { corner_type: 'Góc', direction: 'Hướng offset', dist: 'Khoảng cách offset', expand: 'Mở rộng', fail_message: 'Không thể offset đối tượng', inward: 'Hướng trong', not_support_message: 'Các phần tử được chọn chứa thẻ SVG không hỗ trợ:\nHình ảnh, Nhóm, Văn bản và Đối tượng nhập:\n', outward: 'Hướng ngoài', round: 'Tròn', sharp: 'Sắc nét', shrink: 'Thu nhỏ' },
