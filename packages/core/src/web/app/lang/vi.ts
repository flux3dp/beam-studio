...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    font_size: 'Cỡ chữ',
    hole: 'Lỗ',
    hole_diameter: 'Đường kính',
    hole_offset: 'Độ lệch',
    hole_position: 'Vị trí',
    hole_thickness: 'Độ dày',
    hole_type: 'Loại',
    hole_type_punch: 'Lỗ đục',
    hole_type_ring: 'Vòng',
    ...
    position_ref: 'Vị trí',
    position_ref_bottom_center: 'Dưới',
    position_ref_left_center: 'Trái',
    position_ref_right_center: 'Phải',
    position_ref_top_center: 'Trên',
