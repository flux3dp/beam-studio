...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Vị trí: Căn chỉnh với điểm khắc ở góc trên bên trái.',
    align_4_1: 'Vị trí: Căn chỉnh với điểm khắc ở góc trên bên phải.',
    align_4_2: 'Vị trí: Căn chỉnh với điểm khắc ở góc dưới bên trái.',
    align_4_3: 'Vị trí: Căn chỉnh với điểm khắc ở góc dưới bên phải.',
    align_8_0: 'Vị trí: Căn chỉnh với điểm khắc ở phía trên cùng bên trái bên ngoài.',
    align_8_1: 'Vị trí: Căn chỉnh với điểm khắc ở phía trên cùng bên phải bên ngoài.',
    align_8_2: 'Vị trí: Căn chỉnh với điểm khắc ở phía dưới cùng bên trái bên ngoài.',
    align_8_3: 'Vị trí: Căn chỉnh với điểm khắc ở phía dưới cùng bên phải bên ngoài.',
    align_8_4: 'Vị trí: Căn chỉnh với điểm khắc ở phía trên cùng bên trái bên trong.',
    align_8_5: 'Vị trí: Căn chỉnh với điểm khắc ở phía trên cùng bên phải bên trong.',
    align_8_6: 'Vị trí: Căn chỉnh với điểm khắc ở phía dưới cùng bên trái bên trong.',
    align_8_7: 'Vị trí: Căn chỉnh với điểm khắc ở phía dưới cùng bên phải bên trong.',
    ...
    charuco_open_the_machine_lid: 'Mở nắp máy.',
    charuco_place_charuco: 'Đặt mẫu hiệu chuẩn đã in nằm ngang tại <b>%s</b> của khu vực làm việc.',
    ...
    check_pnp_desc: 'Chúng tôi đã chụp lại hình ảnh dựa trên kết quả hiệu chuẩn và đánh dấu các điểm tham chiếu khắc.\nVui lòng kiểm tra xem các dấu đỏ có khớp với vị trí khắc thực tế không.\nNếu bạn thấy sự sai lệch rõ ràng, chỉ cần nhấp vào "Hiệu chuẩn lại" để thử lại.',
    ...
    solve_pnp_keep_door_closed: 'Giữ cửa đóng trong quá trình tiếp theo. Nếu cửa mở, hệ thống sẽ cố định lại vị trí máy ảnh.',
    ...
    solve_pnp_relocate_camera: 'Nhấn "Di chuyển máy ảnh" nếu đầu laser vẫn chưa được căn giữa theo chiều ngang.',
  ...
  settings: {
    ...
    module_offset_4c: 'Bù chỉnh in (4C)',
    ...
    module_offset_uv_varnish: 'Bù chỉnh véc-ni UV',
    module_offset_uv_white_ink: 'Bù chỉnh mực trắng UV',
    none: 'Không có',
    normal: 'Cao',
