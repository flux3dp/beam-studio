    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          diabled_by_gradient: 'Vui lòng tắt hiệu ứng chuyển sắc trước khi sử dụng tính năng này.',
          diabled_by_infilled: 'Vui lòng tắt infill trước khi sử dụng tính năng này.',
          diabled_by_infilled_and_variable_text: 'Vui lòng tắt infill và văn bản biến trước khi sử dụng tính năng này.',
          diabled_by_variable_text: 'Vui lòng tắt văn bản biến trước khi sử dụng tính năng này.',
