...
const lang: ILang = {
  ...
  beambox: {
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Gắn vào vật liệu',
        bucket_hint: 'Đã lưu vào bộ sưu tập “Vật liệu của tôi” (Khác). Bạn có thể chuyển sang vật liệu khác sau.',
        create_new: 'Tạo vật liệu mới…',
        new_material_name: 'Tên vật liệu mới',
        preset_name: 'Tên thông số',
        settings_from_layer: 'Cài đặt được sao chép từ lớp hiện tại',
        title: 'Lưu cài đặt của lớp hiện tại thành thông số',
      },
      add_material: 'Thêm vật liệu',
      ...
      editor: {
        ...
        appearance_hint: 'Không có ảnh? Hãy chọn màu bìa thay thế.',
        category: 'Danh mục',
        category_required: 'Hãy chọn một danh mục',
        color: 'Màu sắc',
        name: 'Tên vật liệu',
        name_required: 'Bắt buộc nhập tên',
        photo: 'Ảnh',
        tags: 'Thẻ',
        title_add: 'Thêm vật liệu',
        title_edit: 'Chỉnh sửa vật liệu',
        upload_hint: 'Nhấp hoặc kéo thả ảnh. Ảnh xem trước lớn sẽ hiển thị trong thư viện.',
      },
      enable: 'Bật',
      export: 'Xuất',
      favorites: 'Yêu thích',
      from_current_layer: 'Từ lớp hiện tại',
      import: 'Nhập',
      machine: 'Máy',
      manual: 'Thủ công',
      manual_settings: 'Cài đặt thủ công',
      modified: 'Thông số đã được chỉnh sửa sau khi áp dụng',
      move_to_material: 'Chuyển sang vật liệu…',
      new_preset_manual: 'Thông số mới…',
      no_materials_in_category: 'Chưa có vật liệu nào cho %s tại đây.',
      no_presets_for_machine: 'Chưa có cài đặt nào cho %s.',
      no_search_match: 'Không có vật liệu nào khớp với “%s”.',
      preset_editor: {
        name: 'Tên thông số',
        name_required: 'Bắt buộc nhập tên',
        title_edit: 'Chỉnh sửa thông số',
        title_new: 'Thông số mới',
      },
      presets: 'Thông số',
      recents: 'Gần đây',
      recents_empty: 'Các vật liệu vừa áp dụng sẽ hiển thị tại đây.',
      regions: {
        auto: 'Tự động',
        eu: 'Châu Âu',
        global: 'Toàn cầu',
      ...
      restore_default: 'Khôi phục mặc định của FLUX',
      result: 'Kết quả',
      search_placeholder: 'Tìm vật liệu, thẻ, danh mục…',
      settings_region: 'Khu vực danh mục vật liệu',
      settings_use: 'Sử dụng trình duyệt vật liệu',
      showing_bundled: 'Đang hiển thị danh mục tích hợp sẵn',
      state_customized: 'Đã tùy chỉnh',
      state_default: 'Mặc định',
      state_disabled: 'Đã tắt',
      state_user: 'Do người dùng định nghĩa',
      storage_full: 'Bộ nhớ đã đầy nên không thể lưu thư viện vật liệu. Hãy dùng ảnh bìa màu thay cho ảnh chụp.',
      sure_to_delete_material: 'Xóa vật liệu này cùng toàn bộ thông số của nó?',
      sure_to_delete_preset: 'Xóa thông số này?',
      sure_to_delete_variant: 'Xóa độ dày này và các cài đặt sẵn của nó?',
      sure_to_import: 'Việc nhập sẽ hợp nhất tệp vào thư viện vật liệu của bạn. Tiếp tục?',
      thickness: 'Độ dày',
      title: 'Trình duyệt vật liệu',
      variant_exists: 'Đã có biến thể với độ dày này.',
      variants: '%d biến thể',
    },
  ...
  print_and_cut: {
    ...
    calibration: {
      align_desc: '1. Đặt tờ hiệu chuẩn đã in vào khu vực làm việc, cố định bằng băng keo hoặc băng keo giấy để không bị xê dịch, rồi lấy nét.\n2. Nhấp “Xem trước và căn chỉnh” để chạy căn chỉnh bằng camera.\n3. Khi đã tìm thấy các dấu, nhấp “Khắc thang đo” để khắc các vạch tham chiếu lên tờ giấy ở công suất thấp.',
      aligned: 'Đã phát hiện các dấu căn chỉnh. Sẵn sàng khắc.',
      auto_read: 'Đọc thang đo bằng camera',
      auto_read_failed: 'Không thể tự động đọc thang đo. Vui lòng đọc bằng mắt và nhập giá trị.',
      auto_read_hint: 'Giá trị camera đọc có thể lệch tới ±2; hãy đối chiếu với tờ hiệu chuẩn.',
      current_offset: 'Độ lệch hiện tại: X %s mm, Y %s mm',
      export_pdf: 'Xuất PDF hiệu chuẩn',
      power: 'Công suất',
      print_desc: '1. Xuất PDF tờ hiệu chuẩn. Tờ giấy gồm bốn dấu căn chỉnh và hai thang đo.\n2. In tờ giấy ở tỷ lệ 100% (kích thước thật).',
      reading_desc: '1. Tìm vạch khắc dài nhất (vạch giữa) và xem nó nằm ở phía nào của vạch 0 in sẵn.\n2. Dò từng vạch về phía đó cho đến khi một vạch khắc và một vạch in trùng khớp hoàn toàn.\n3. Đếm từ 0 đến vạch in đó (số được in mỗi 5 vạch; hãy đếm cả các vạch không có số ở giữa).',
      reading_x: 'Số đọc X',
      reading_y: 'Số đọc Y',
      scratch: 'Khắc thang đo',
      speed: 'Tốc độ',
      title: 'Hiệu chuẩn In và cắt',
    },
  ...
  topbar: {
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Hiệu chuẩn In và cắt',
