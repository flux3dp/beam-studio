  ...
  beambox: {
    ...
    material_browser: {
      ...
      editor: {
        ...
        parent_hint: 'Nếu được thiết lập, vật liệu sẽ hiển thị như một biến thể độ dày của vật liệu cha (không hiển thị ở lưới chính).',
        parent_material: 'Vật liệu cha',
        photo: 'Ảnh',
        tags: 'Thẻ',
        thickness_inch: 'Độ dày (inch)',
        thickness_inch_hint: 'Có thể nhập dạng phân số',
