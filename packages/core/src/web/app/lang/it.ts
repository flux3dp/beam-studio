...
const lang: ILang = {
  ...
  settings: {
    ...
    module_offset_4c: 'Offset stampa (4C)',
    ...
    module_offset_uv_varnish: 'Offset vernice',
    module_offset_uv_white_ink: 'Offset inchiostro bianco',
    none: 'Nessuno',
    normal: 'Normale',
  ...
  topbar: {
    ...
    menu: {
      ...
      import_beamo_2_printing_example_full: 'Esempio di stampa beamo II - Colore completo',
