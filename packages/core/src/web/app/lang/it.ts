...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_1: 'Stampa la scacchiera (A4/Letter).',
    put_chessboard_2: 'Incollala piatta su una tavola rigida.',
    put_chessboard_3: "Posiziona al centro ed esegui l'autofocus.",
