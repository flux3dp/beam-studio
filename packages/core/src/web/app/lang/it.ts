...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: 'Scarica e stampa il seguente file su carta A4 per la calibrazione della fotocamera.',
    put_chessboard_bm2_2: 'Posiziona il foglio di calibrazione in piano nella posizione designata sull’area di lavoro.',
