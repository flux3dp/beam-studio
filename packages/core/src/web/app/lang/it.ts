...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Posizione: Allineare con il punto inciso in alto a sinistra.',
    align_4_1: 'Posizione: Allineare con il punto inciso in alto a destra.',
    align_4_2: 'Posizione: Allineare con il punto inciso in basso a sinistra.',
    align_4_3: 'Posizione: Allineare con il punto inciso in basso a destra.',
    align_8_0: 'Posizione: Allineare con il punto inciso in alto a sinistra esterno.',
    align_8_1: 'Posizione: Allineare con il punto inciso in alto a destra esterno.',
    align_8_2: 'Posizione: Allineare con il punto inciso in basso a sinistra esterno.',
    align_8_3: 'Posizione: Allineare con il punto inciso in basso a destra esterno.',
    align_8_4: 'Posizione: Allineare con il punto inciso in alto a sinistra interno.',
    align_8_5: 'Posizione: Allineare con il punto inciso in alto a destra interno.',
    align_8_6: 'Posizione: Allineare con il punto inciso in basso a sinistra interno.',
    align_8_7: 'Posizione: Allineare con il punto inciso in basso a destra interno.',
    ...
    charuco_open_the_machine_lid: 'Apri il coperchio della macchina.',
    charuco_place_charuco: 'Posiziona il modello di calibrazione stampato orizzontalmente nella <b>%s</b> dell’area di lavoro.',
    ...
    check_pnp_desc: 'Abbiamo ripreso le immagini in base ai risultati della calibrazione e contrassegnato i punti di riferimento per l\'incisione.\nVerifica se i segni rossi corrispondono ai punti effettivi di incisione.\nSe noti una discrepanza evidente, fai clic su "Ricalibra" per riprovare.',
    ...
    solve_pnp_keep_door_closed: 'Tieni la porta chiusa durante il processo successivo. Se viene aperta, il sistema tenterà di riposizionare la fotocamera.',
    ...
    solve_pnp_relocate_camera: 'Fai clic su "Riposiziona fotocamera" se la testa laser non è ancora centrata orizzontalmente.',
