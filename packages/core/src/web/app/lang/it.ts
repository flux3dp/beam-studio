...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'La dimensione di output (%s) supera il massimo consigliato di %d × %d px. L’elaborazione può richiedere diversi minuti e il risultato può rallentare Beam Studio. Continuare comunque?',
