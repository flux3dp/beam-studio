...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: "Utilizzare velocità troppo elevate per i livelli contenenti oggetti con curve 3D può ridurre la precisione dell'incisione.\nSi consiglia di mantenere la velocità sotto %(limit)s per ottenere risultati ottimali con oggetti con curve 3D.",
      too_fast_for_curve_and_constrain: 'I seguenti livelli: %(layers)s superano il limite di velocità di %(limit)s.\nLa velocità di incisione per gli oggetti con curve 3D sarà limitata a %(limit)s. Puoi rimuovere questo limite nelle Impostazioni delle Preferenze.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'La velocità di incisione degli oggetti a curva 3D sarà limitata a %(limit)s. Puoi rimuovere questo limite nelle Impostazioni delle Preferenze.',
