    ...
    material_browser: {
      ...
      catalog: {
        ...
        presets: {
          ...
          engraving_quality: 'Incisione (qualità)',
      ...
      editor: {
        ...
        parent_hint: 'Se impostato, viene mostrato come variante di spessore sotto il materiale principale (non nella griglia principale).',
        parent_material: 'Materiale principale',
        photo: 'Foto',
        tags: 'Tag',
        thickness_inch: 'Spessore (pollici)',
        thickness_inch_hint: 'È consentito inserire frazioni',
