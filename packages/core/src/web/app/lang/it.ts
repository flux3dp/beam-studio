...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Come migliorare la precisione del rilevamento?',
    ...
    retake: 'Riprendi foto',
    retake_tooltip: 'Riprendi la foto alla posizione di ogni oggetto per un migliore rilevamento',
    retry_with_remove_bg: 'Rimuovi sfondo',
    retry_with_remove_bg_tooltip: "Rimuovi lo sfondo dall'immagine di anteprima per migliorare il rilevamento dei contorni",
    rotation: 'Ruota',
    ...
    use_original_image_tooltip: "Ripristina l'immagine di anteprima originale senza rimozione dello sfondo",
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s crediti AI',
      credit_balance: 'Saldo crediti AI',
      credit_cost: 'Crediti AI utilizzati',
      description: 'Aumenta risoluzione e dettagli dell’immagine con l’IA. L’immagine ingrandita sostituirà l’originale sulla tela.',
      done: 'Upscaling generativo completato',
      dpi_recommended: 'Consigliato per il DPI del livello corrente: %dx.',
      dpi_recommended_capped: 'Consigliato per il DPI del livello corrente: %dx, ma %dx è il massimo entro la dimensione di output consigliata.',
      failed: 'Impossibile completare l’upscaling generativo. Controlla la connessione di rete e riprova.',
      insufficient_credit: 'Crediti AI insufficienti per eseguire l’upscaling generativo.',
      layer_dpi: 'DPI del livello',
      original_size: 'Dimensione originale',
      output_size: 'Dimensione di output',
      oversize_warning: 'La dimensione di output (%s) supera il massimo consigliato di %dpx x %dpx. L’elaborazione può richiedere diversi minuti e il risultato può rallentare Beam Studio. Continuare comunque?',
      processing: 'Upscaling in corso…',
      processing_hint: 'Il tempo di elaborazione dipende dalla dimensione dell’immagine e dalla rete.',
      recommended: 'Consigliato',
      retry: 'Riprova',
      start: 'Avvia upscaling',
    },
    announcement_panel: {
      title: 'Annuncio',
    },
    ...
    document_panel: {
      ...
      prespray_times: 'Numero di spurghi',
    ...
    left_panel: {
      ...
      label: {
        ...
        preview_precise: 'Anteprima fotocamera precisa',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Associa a un materiale',
        bucket_hint: 'Salvato nella tua raccolta “I miei materiali” (Altri). Potrai spostarlo in un materiale in seguito.',
        create_new: 'Crea nuovo materiale…',
        new_material_name: 'Nome del nuovo materiale',
        preset_name: 'Nome del preset',
        settings_from_layer: 'Impostazioni copiate dal livello corrente',
        title: 'Salva le impostazioni del livello corrente come preset',
      },
      add_material: 'Aggiungi materiale',
      add_preset: 'Aggiungi preset',
      apply: 'Applica',
      back_to_catalog: 'Torna al catalogo',
      buy_on_shop: 'Acquista nello shop',
      catalog: {
        materials: {
        ...
        presets: {
          cutting: 'Taglio',
          engraving: 'Incisione',
          engraving_diode: 'Incisione (diodo)',
          engraving_fiber: 'Incisione (fibra)',
          engraving_spray: 'Incisione (spray)',
          kiss_cut: 'Taglio superficiale',
          marking: 'Marcatura',
      ...
      editor: {
        appearance: 'Aspetto',
        appearance_hint: 'Nessuna foto? Scegli invece un colore di copertina.',
        category: 'Categoria',
        category_required: 'Scegli una categoria',
        color: 'Colore',
        name: 'Nome del materiale',
        name_required: 'Il nome è obbligatorio',
        photo: 'Foto',
        tags: 'Tag',
        title_add: 'Aggiungi materiale',
        title_edit: 'Modifica materiale',
        upload_hint: "Fai clic o trascina una foto. Nella galleria viene mostrata un'anteprima grande.",
      },
      enable: 'Attiva',
      export: 'Esporta',
      favorites: 'Preferiti',
      from_current_layer: 'Dal livello corrente',
      import: 'Importa',
      machine: 'Macchina',
      manual: 'Manuale',
      manual_settings: 'Impostazioni manuali',
      modified: "Parametri modificati dopo l'applicazione del preset",
      move_to_material: 'Sposta in un materiale…',
      new_preset_manual: 'Nuovo preset…',
      no_materials_in_category: 'Non ci sono ancora materiali qui per %s.',
      no_presets_for_machine: 'Non ci sono ancora impostazioni per %s.',
      no_search_match: 'Nessun materiale corrisponde a “%s”.',
      preset_editor: {
        name: 'Nome del preset',
        name_required: 'Il nome è obbligatorio',
        title_edit: 'Modifica preset',
        title_new: 'Nuovo preset',
      },
      presets: 'Preset',
      recents: 'Recenti',
      recents_empty: 'I materiali applicati di recente appariranno qui.',
      regions: {
        auto: 'Automatico',
        eu: 'Europa',
        global: 'Globale',
      ...
      restore_default: 'Ripristina i valori predefiniti FLUX',
      result: 'Risultato',
      search_placeholder: 'Cerca materiali, tag, categorie…',
      settings_region: 'Regione del catalogo materiali',
      settings_use: 'Usa il browser materiali',
      showing_bundled: 'Visualizzazione del catalogo integrato',
      state_customized: 'Personalizzato',
      state_default: 'Predefinito',
      state_disabled: 'Disattivato',
      state_user: "Definito dall'utente",
      storage_full: 'Lo spazio di archiviazione è pieno, impossibile salvare la libreria dei materiali. Usa copertine colorate invece delle foto.',
      sure_to_delete_material: 'Eliminare questo materiale e tutti i suoi preset?',
      sure_to_delete_preset: 'Eliminare questo preset?',
      sure_to_delete_variant: 'Eliminare questo spessore e i relativi preset?',
      sure_to_import: "L'importazione unirà il file alla tua libreria di materiali. Continuare?",
      thickness: 'Spessore',
      title: 'Browser materiali',
      variant_exists: 'Esiste già una variante con questo spessore.',
      variants: '%d varianti',
    },
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: 'Generazione lavori più veloce disponibile',
        keep_current: 'Mantieni attuale',
        message: 'Abbiamo aggiornato il motore di calcolo dei lavori per migliorare le prestazioni e velocizzare la generazione dei lavori.\nVuoi passare al nuovo motore accelerato?\nPuoi disattivarlo in qualsiasi momento in %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'In modalità incisione curva, la velocità attuale potrebbe essere troppo alta e potrebbe influire sui dettagli di incisione per i livelli: %(layers)s.\nConsidera di ridurre la velocità per una migliore qualità.',
    ...
    right_panel: {
      laser_panel: {
        ...
        dropdown: {
          inches: {
            ...
            acrylic_7mm_cutting: 'Acrilico - 1/4″ Taglio',
            ...
            mdf_7mm_cutting: 'Nuova Zelanda MDF - 1/4″ Taglio',
          ...
          mm: {
            ...
            acrylic_7mm_cutting: 'Acrilico - 7mm Taglio',
            ...
            mdf_7mm_cutting: 'MDF Nuova Zelanda - 7mm Taglio',
        ...
        strength: 'Potenza',
        texture: 'Texture',
        texture_angle: 'Angolo',
        texture_intensity: 'Intensità',
        texture_interval: 'Intervallo',
        texture_random: 'Casuale',
        texture_stripe: 'Strisce',
        times: 'volte',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Upscaling generativo',
          ai_upscale_short: 'Upscaling',
          ai_upscale_too_large: "Questa immagine è troppo grande per l'upscaling con IA. La dimensione massima supportata è %dpx x %dpx.",
          array: 'Array',
          ...
          disabled_by_noun_project: 'Questa forma è protetta dalla legge sulla proprietà intellettuale, quindi il suo tracciato non può essere modificato.',
        ...
        option_panel: {
          ...
          text_align_justify: 'Giustifica',
          text_align_left: 'Sinistra',
          text_align_right: 'Destra',
          text_content_placeholder: 'Inserisci testo',
  ...
  boxgen: {
    ...
    inner: 'Interno',
    joints: 'Giunzione',
    max_dimension_tooltip: 'La larghezza massima è %s, impostazione max altezza/profondità è %s.',
    merge: 'Unisci',
    outer: 'Esterno',
    reset: 'Ripristina',
    tCount: 'Conteggio T',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Sposta la testa del laser per allineare la luce rossa con il centro del <b>punto A</b>.',
    charuco_move_to_point_b: 'Sposta la testa del laser orizzontalmente per allineare la luce rossa con il centro del <b>punto B</b>.',
    ...
    check_pnp_desc: 'Assicurarsi che i marcatori rossi siano allineati con i punti di incisione\nIn caso contrario, fare clic su "Indietro" per regolare.\nSe è tutto a posto, ottimo lavoro! 🎉',
    ...
    put_charuco: 'Posiziona il motivo di calibrazione',
    put_charuco_1: 'Stampa il motivo di calibrazione (A4/Letter).',
    put_charuco_2: 'Incollala piatta su una tavola rigida.',
    put_charuco_3: "Posiziona al centro ed esegui l'autofocus.",
    put_charuco_bm2_1: 'Stampa il file del motivo di calibrazione su carta formato A4 (Letter) per la calibrazione.',
    put_charuco_bm2_2: 'Fai clic su “Avanti” e segui la guida per posizionare il foglio.',
    put_charuco_promark_2: "Assicurati che il foglio di calibrazione sia chiaramente visibile senza riflessi. Clicca su 'Avanti' per scattare una foto.",
    put_charuco_promark_desc_1: 'Utilizza il foglio di calibrazione fornito nella scatola degli accessori, oppure stampa il seguente motivo di calibrazione su carta A4 per la calibrazione della fotocamera.',
    ...
    put_paper_promark: 'Metti Cartoncino Nero',
    put_paper_promark_1: 'Posiziona il cartoncino nero dalla scatola degli accessori sulla piattaforma di lavoro.',
    put_paper_promark_2: 'Regola correttamente la messa a fuoco, quindi fai clic su "Avvia Intaglio" per procedere.',
  ...
  cloud_sync: {
    import_config: 'Trovate impostazioni cloud per questo dispositivo. Vuoi importarle?',
    import_failed: 'Impossibile leggere le impostazioni cloud.',
    sync_config: 'Vuoi sincronizzare queste impostazioni nel cloud?',
    sync_failed: 'Sincronizzazione delle impostazioni nel cloud non riuscita.',
    sync_success: 'Impostazioni sincronizzate nel cloud con successo.',
  },
  code_generator: {
  ...
  connection_issue_guide: {
    alert_link: 'Si disconnette? Prova questo metodo di risoluzione dei problemi.',
    connect_computer: {
      content: 'Il tuo computer deve essere sulla stessa rete della macchina.',
      macos_steps: "Fai clic sull'icona Wi-Fi nella barra dei menu. Poi seleziona l'hotspot del tuo telefono.",
      macos_title: 'macOS',
      title: 'Connetti il tuo computer',
      windows_steps: "Fai clic sull'icona di rete nella barra delle applicazioni. Poi seleziona l'hotspot del tuo telefono.",
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'La macchina non trova il mio hotspot',
      dont_know_hotspot_name: 'Non conosco il nome del mio hotspot',
      step1: '1. Sul pannello touch della tua macchina, vai su: Rete → Connetti al Wi-Fi.',
      step2: "2. Trova e seleziona il nome dell'hotspot del tuo telefono dall'elenco Wi-Fi.",
      step3: "3. Inserisci la password dell'hotspot e connetti.",
    ...
    enter_ip: {
      ...
      step1: "Inserisci l'indirizzo IP trovato nel passaggio precedente.",
      step2: 'Fai clic su "Verifica" per testare la connessione.',
      step3: 'Beam Studio verificherà:',
      title: "Inserisci l'indirizzo IP della tua macchina",
      verify: 'Verifica',
    },
    fail: {
      bullet1: '• Il modello e il numero di serie della tua macchina',
    ...
    hotspot: {
      android_steps: 'Impostazioni → Connessioni → Router Wi-Fi e tethering → Router Wi-Fi',
      android_title: 'Android',
      ios_steps: 'Impostazioni → Hotspot personale → Consenti agli altri',
      ios_title: 'iPhone (iOS)',
      tip: 'Suggerimento: Usa un nome hotspot semplice in inglese e una password numerica (es. Nome: FLUX_Test   Password: 12345678)',
      warning_2_4ghz: 'Importante: Le macchine FLUX supportano solo il Wi-Fi a 2.4GHz. Imposta il tuo hotspot su 2.4GHz prima di procedere.',
    },
    how_it_works: 'Come funziona il test:',
    how_it_works_step1: '1. Configura il tuo telefono come hotspot Wi-Fi.',
    how_it_works_step2: "2. Connetti la macchina all'hotspot.",
    how_it_works_step3: '3. Connetti il tuo computer allo stesso hotspot.',
    how_it_works_step4: '4. Testa la connessione in Beam Studio.',
    intro: "Facciamo un test rapido per verificare se la tua macchina funziona correttamente. Connetteremo la tua macchina e il tuo computer tramite l'hotspot del tuo telefono per capire se il problema riguarda la tua rete o la macchina stessa.",
    ip_address: {
      step1: 'Sul pannello touch della macchina, vai su:\nRete → Cerca "IP Address"',
      step2: "L'IP di solito appare come: 172.20.10.x o 192.168.x.x\n(Dipende dall'hotspot del tuo telefono)",
      step3: 'Annota questo indirizzo IP per il passaggio successivo.',
      title: "Trova l'indirizzo IP della tua macchina",
      warning: "Se l'IP inizia con 169.254, la connessione è fallita. Torna al Passaggio 1 e riprova.",
    },
    success: {
      cause: "Il problema di connessione riscontrato è molto probabilmente causato dall'ambiente della tua rete locale, non dalla macchina stessa.",
      intro: 'Hai completato con successo il test di connessione Wi-Fi, ottimo lavoro! Questo conferma che la tua macchina FLUX funziona perfettamente.',
      recommend1: '• Contatta il tuo provider di servizi Internet (ISP) o il produttore del router per assistenza con le impostazioni Wi-Fi',
      recommend2: '• Chiedi al tuo amministratore di rete se ti trovi in una scuola, un ufficio o uno spazio di lavoro condiviso',
      recommend3: '• Verifica se il tuo router supporta il 2.4GHz e prova a riavviarlo',
      recommend_title: 'Cosa consigliamo:',
      title: 'Ottimo lavoro! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'Generatore di portachiavi',
    material_test_generator: 'Generatore di Test Materiale',
    puzzle_generator: 'Generatore di puzzle',
    title: 'Generatori',
  },
  generic_error: {
  ...
  initialize: {
    ...
    Macchine > "Nome Promark" > Impostazioni Promark`,
      ...
      setting_completed_ask_camera_calibration: "La configurazione dell'obiettivo di campo di Promark è stata completata con successo! Vuoi procedere con la calibrazione della fotocamera?",
    ...
    select_hexa: 'Seleziona il tuo HEXA',
    select_language: 'Seleziona lingua',
    select_machine_type: 'Seleziona il tuo modello',
    select_promark: 'Seleziona il tuo Promark',
    setting_completed: {
      back: 'Indietro',
  ...
  machine_linking: {
    continue: 'Continua',
    i_have_read: 'Ho letto',
    input_birthday_to_link: 'Inserisci la tua data di nascita per completare il collegamento del dispositivo',
    input_birthday_to_link_note: '*Utilizzato per verificare se la tua età soddisfa i requisiti di idoneità',
    link_failed: 'Collegamento fallito.',
    link_failed_already_linked: 'Questo dispositivo è attualmente collegato a un altro FLUX ID. Puoi continuare a usarlo o collegarlo al tuo account.',
    link_failed_cannot_set_secret: 'Impossibile salvare le informazioni di collegamento sul dispositivo. Controlla la connessione tra il computer e il dispositivo.',
    link_failed_under_age: 'Attualmente non hai i requisiti per utilizzare questo servizio e non puoi completare il collegamento del dispositivo.',
    link_machine: 'Collega FLUX ID',
    link_machine_to_account: 'Connesso a %(name)s. Vuoi collegare questo dispositivo al tuo account?',
    link_success: 'Collegamento riuscito.',
    link_to_my_flux_id: 'Collega al mio FLUX ID',
    privacy_policy: 'Informativa sulla privacy',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Collegamento…',
    use_without_linking: 'Usa senza collegare',
  },
  machine_status: {
  ...
  maintenance: {
    ...
    areas: {
      back_cover: 'Coperchio posteriore',
      modules: 'Moduli',
      optics: 'Ottiche',
      panel: 'Pannello',
    ...
    cadence: {
      ...
      day: 'Ogni giorno',
      days: 'Ogni %s giorni',
      each_operation: 'Ogni utilizzo',
      every_1_2_weeks: 'Ogni 1–2 settimane',
      month: 'Ogni mese',
      months: 'Ogni %s mesi',
      upon_unboxing: 'Al primo disimballaggio',
      week: 'Ogni settimana',
      weeks: 'Ogni %s settimane',
    },
    celebration: {
      subtitle: 'Il tuo %s è in ottima forma — continua così.',
      title: 'Manutenzione essenziale completata!',
    },
    columns: {
      cadence: 'Frequenza',
      status: 'Stato',
    ...
    empty_no_machine: 'Collega o seleziona una macchina per vedere il suo programma di manutenzione.',
    empty_no_schedule: 'Nessuna lista di manutenzione è ancora disponibile per questo modello.',
    essential: 'Essenziale',
    essential_health: 'Salute essenziale',
    essential_hint: 'incide sulla salute',
    feedback: {
      checked: '%s verificato.',
      done: '%s è aggiornato. Prossima scadenza %s.',
      done_no_date: '%s completato.',
      fail_warning: '%s: contrassegnato per la sostituzione del tubo. Apri la guida per i passaggi.',
      passed: '%s superato — il tubo è in salute!',
    },
    footer_tip: 'Suggerimento: incidi un file di prova ogni mese per mantenere la macchina in salute.',
    history_hint: 'Per ogni attività vengono conservate solo le %s voci più recenti.',
    intro: 'Tieni traccia di ogni attività di manutenzione di questa macchina e segnala come fatta con un clic.',
    legend: {
    ...
    machine_groups: {
      my_machines: 'Le mie macchine',
      other_models: 'Altri modelli',
    },
    ...
    status: {
      ...
      healthy: 'In salute',
      last: 'Ultima volta',
      never_done: 'Mai eseguito',
      next: 'Prossima scadenza',
      not_checked: 'Non verificato',
      not_logged: 'Non registrato',
      overdue: 'Scaduto',
      replace_tube: 'Sostituisci tubo',
    },
    tasks: {
      align: {
        keyPoints: 'Regola quando il percorso ottico è disallineato.',
        name: 'Allineamento del percorso ottico',
      },
      chassis: {
        keyPoints: 'Rimuovi residui e olio catramoso dal telaio e dal coperchio inferiore.',
        name: 'Pulizia del telaio',
      },
      door: {
        keyPoints: 'Rimuovi il grasso dal coperchio dello sportello.',
        name: 'Pulizia dello sportello',
      },
      exhaust: {
        keyPoints: 'Pulisci la polvere dalle pale della ventola.',
        name: 'Pulizia della ventola di scarico',
      },
      fan: {
        keyPoints: 'Rimuovi la polvere dalle pale della ventola di ventilazione.',
        name: 'Pulizia della ventola di ventilazione',
      },
      fieldlens: {
        keyPoints: "Pulisci la lente di campo, strofinando dal centro verso l'esterno in senso orario.",
        name: 'Pulizia della lente di campo',
      },
      honeycomb_plate: {
        keyPoints: "Rimuovi residui e catrame dalle griglie della piastra a nido d'ape.",
        name: "Pulizia della piastra a nido d'ape",
      },
      honeycomb_table: {
        keyPoints: "Rimuovi residui e olio catramoso dalla rete a nido d'ape.",
      ...
      maintain_test: {
        keyPoints: 'Controlla il display di stato e gli interruttori.',
        name: 'Pagina MAINTAIN',
      },
      mirrors_combiner: {
        keyPoints: "Rimuovi lo sporco da lenti/specchi; verifica l'ossidazione. Nessun residuo di alcol o aloni.",
        name: 'Specchi, lente di messa a fuoco e combinatore di fascio',
      },
      mirrors_lens: {
        keyPoints: 'Pulisci i 4 specchi e la lente; assicurati che non vi siano ossidazioni o aloni.',
        name: 'Pulizia di specchi e lente',
      },
      mod_diode: {
        keyPoints: 'Pulisci la ventola, la lente di messa a fuoco e il POGO pin.',
        name: 'Modulo laser a diodi',
      },
      mod_ir: {
        keyPoints: 'Pulisci la lente di messa a fuoco.',
        name: 'Modulo laser a infrarossi',
      },
      optical_inspection: {
        keyPoints: 'Ispeziona il percorso ottico; anche al disimballaggio e dopo la sostituzione del tubo.',
        name: 'Ispezione del percorso ottico',
      },
      optical_unboxing: {
        keyPoints: 'Assicurati che il percorso ottico sia preciso. Controlla al primo disimballaggio.',
        name: 'Ispezione del percorso ottico',
      },
      screen: {
        keyPoints: 'Pulisci la polvere e il grasso sul pannello.',
        name: 'Pulizia dello schermo',
      },
      tube: {
        keyPoints: "Se l'acrilico da 3 mm non si taglia al 70% di potenza, sostituisci il tubo.",
        name: 'Controllo salute del tubo laser',
      },
      water: {
        keyPoints: "Aggiungi acqua fino a oltre l'80% senza bolle d'aria.",
        name: 'Sostituzione acqua di raffreddamento',
      },
      worktable: {
        keyPoints: 'Spruzza alcol su un panno, poi pulisci il piano di lavoro.',
        name: 'Pulizia del piano di lavoro',
      },
      zaxis: {
        keyPoints: "Pulisci la vite della colonna dell'asse Z, poi applica il lubrificante in modo uniforme con un cotton fioc.",
        name: "Lubrificazione della colonna dell'asse Z",
      },
    },
    title: 'Lista di manutenzione',
  },
  ...
  monitor: {
    ...
    HARDWARE_ERROR_PUMP_ERROR: '#900 Basso flusso di refrigerante. Controllare serbatoio acqua.',
    HARDWARE_ERROR_REMOTE_INTERLOCK_OPENED: "#927 Interblocco remoto attivato\nControllare il connettore dell'interblocco remoto e assicurarsi che sia collegato saldamente prima di riavviare il lavoro.",
  ...
  params_label: {
    ...
    placeholder: 'Etichetta parametri',
    preview_hint: "Questa è un'anteprima. Il contenuto del testo verrà aggiornato automaticamente prima di inviare un'attività",
    save_as_default: 'Salva come predefinito',
    settings: 'Impostazioni etichetta parametri',
    update: 'Aggiorna',
    updated: 'Etichetta parametri aggiornata',
    use_default: 'Usa predefinito salvato',
    use_recommended: 'Usa consigliati',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      ...
      capturing: 'Acquisizione immagine',
      completing: 'Completamento in corso',
      detecting: 'Rilevamento dei marcatori di allineamento',
      locating: 'Ricerca dei marcatori di allineamento',
      preparing: 'Preparazione della fotocamera',
      refining: 'Perfezionamento della posizione dei marcatori',
    },
    alignment: {
    ...
    calibration: {
      align_desc: '1. Posiziona il foglio di calibrazione stampato nell’area di lavoro, fissalo con nastro adesivo o nastro di carta perché non si muova e metti a fuoco.\n2. Fai clic su «Anteprima e allineamento» per eseguire l’allineamento con la fotocamera.\n3. Una volta trovati i segni, fai clic su «Incidi scale» per tracciare le linee di riferimento sul foglio a bassa potenza.',
      aligned: 'Segni di allineamento rilevati. Pronto per incidere.',
      auto_read: 'Leggi le scale con la fotocamera',
      auto_read_failed: 'Impossibile leggere le scale automaticamente. Leggile a occhio e inserisci i valori.',
      auto_read_hint: 'La lettura della fotocamera può discostarsi fino a ±2; verificala sul foglio.',
      current_offset: 'Offset attuale: X %s mm, Y %s mm',
      export_pdf: 'Esporta PDF di calibrazione',
      power: 'Potenza',
      print_desc: '1. Esporta il PDF del foglio di calibrazione. Contiene i quattro segni di allineamento e due scale.\n2. Stampa il foglio al 100% (dimensione reale).',
      reading_desc: '1. Trova la linea incisa più lunga (quella centrale) e osserva da quale lato della linea 0 stampata si trova.\n2. Procedi linea per linea verso quel lato finché una linea incisa e una stampata non coincidono esattamente.\n3. Conta da 0 fino a quella linea stampata (i numeri sono stampati ogni 5 linee; conta anche le linee senza numero intermedie).',
      reading_x: 'Lettura X',
      reading_y: 'Lettura Y',
      scratch: 'Incidi scale',
      speed: 'Velocità',
      title: 'Calibrazione Stampa e taglia',
    },
    ...
    finish: 'Termina',
    fit_content: 'Adatta al contenuto',
    generate_from_contour: 'Genera dal contorno',
    grid_columns: 'Colonne',
    grid_rows: 'Righe',
    ...
    paper_size: 'Dimensione di output',
    paper_too_small: 'L’area di output è troppo piccola. Il design (compresi i marcatori di allineamento) richiede almeno %s mm di margine dal bordo del materiale per rimanere nell’area stampabile della stampante. Scegli una dimensione di output maggiore, altrimenti la stampa verrà tagliata o ridotta.',
    preview_and_align: 'Anteprima e allineamento',
    resume_desc: 'Questo design è già pronto per Stampa e taglia.\nInserisci il materiale stampato successivo nella macchina e prosegui con l’allineamento tramite fotocamera, oppure ricomincia per cambiare design, dimensione di output o percorso di taglio.',
    resume_title: 'Riprendi Stampa e taglia',
    select_cut_layer: 'Livello del percorso di taglio',
    ...
    step_setup: 'Percorsi di taglio e marcatori',
    ...
    uv_print_file_disabled: 'Stampa e taglia stampa il contenuto dei livelli di stampa UV. Abilita «Abilita file di stampa UV» nelle preferenze, poi aggiungi il tuo design a un livello di stampa UV.',
  ...
  puzzle_generator: {
    ...
    export_engrave: 'Livello di incisione',
    export_failed: 'Impossibile importare il puzzle sulla tela. Riprova o modifica le impostazioni del puzzle.',
    export_none: 'Nessuno',
    export_print: 'Livello di stampa',
    file_too_large: 'Il file selezionato supera la dimensione massima consentita.',
    guide_lines: 'Linee guida',
    heart_sharpness: 'Nitidezza della punta',
    image: 'Immagine',
    ...
    piece_size: 'Dimensione pezzi',
    preview_placeholder: 'Anteprima puzzle',
    puzzle_board: 'Tavola del puzzle',
    puzzle_pieces: 'Pezzi del puzzle',
    radius: 'Raggio',
    raised_edges: 'Bordi rialzati',
    ...
    types: {
      ...
      heart_jigsaw: 'Puzzle a forma di cuore',
      hex_jigsaw: 'Puzzle esagonale',
      rectangle_jigsaw: 'Puzzle rettangolare',
    },
    unsupported_file_type: 'Tipo di file non supportato. Utilizzare JPG, PNG o WebP.',
    upload_hint: 'JPG, PNG, WebP (max 10MB)',
    upload_image: 'Clicca o trascina per caricare',
    zoom: 'Zoom',
  },
  qr_code_generator: {
  ...
  settings: {
    ...
    show_banners: 'Mostra banner della home',
  ...
  tips: {
    canvas_hold_space_to_pan: 'Tieni premuta la barra spaziatrice e trascina per spostarti sulla tela.',
    feature_auto_fit: "Dopo l'anteprima della fotocamera, usa Azioni → Adattamento automatico per posizionare automaticamente gli oggetti sul materiale.",
    feature_box_generator: 'Usa Generatori → Generatore di scatole per creare scatole di dimensioni personalizzate in pochi secondi.',
    feature_code_generator: 'Usa Generatori → Generatore di codici a barre per creare codici QR e codici a barre.',
    feature_elements: "Il pannello Elementi ora include oltre un milione di grafici pronti all'uso.",
    feature_layer_color_configurations: 'Mappa i colori dei livelli SVG a velocità e potenza tramite Modifica → Livello → Impostazioni colore.',
    feature_material_test: 'Usa Generatori → Generatore di test materiali nella barra degli strumenti a sinistra per trovare rapidamente le migliori impostazioni per un materiale.',
    layer_execution_order: "L'ordine dei livelli determina l'ordine di lavoro. I lavori vengono eseguiti dall'alto verso il basso.",
    machine_clean_mirror: "Controlla regolarmente gli specchi e la lente di messa a fuoco e puliscili quando necessario per evitare l'accumulo di fumo.",
    machine_no_unattended_operation: 'Non lasciare mai la macchina in funzione incustodita.',
    machine_regular_start: 'Esegui un lavoro laser almeno una volta ogni due settimane per prolungare la durata del tubo laser.',
    object_edit_image_to_erase: "Usa Immagine → Azioni → Modifica immagine per cancellare aree indesiderate in un'immagine.",
    object_polygon_sides: 'Regola il numero di lati nel pannello delle proprietà del poligono.',
    object_rounded_rectangle: 'Imposta il raggio degli angoli di un rettangolo arrotondato nel pannello delle proprietà del rettangolo.',
    object_sharpen_portrait: 'Migliora le incisioni di ritratti con Immagine → Azioni → Nitidezza.',
    settings_auto_save: 'Abilita Salvataggio automatico nelle Preferenze per evitare di perdere il tuo lavoro.',
    settings_default_text_font: 'Puoi impostare il carattere predefinito per lo strumento Testo nelle Preferenze.',
    task_focus_lower_for_cutting: 'Per materiali più spessi, mettere a fuoco circa 2 mm sotto la superficie può migliorare i risultati di taglio.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Impossibile stabilire la connessione con la videocamera della macchina. Riavviare la macchina o Beam Studio. Se l\'errore persiste, seguire <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">questa guida</a>.',
      ...
      fail_to_start_preview: '#803 Impossibile avviare la modalità anteprima. Riavviare la macchina o Beam Studio. Se l\'errore persiste, seguire <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">questa guida</a>.',
      ...
      start_preview_timeout: '#803 Timeout durante l\'avvio della modalità anteprima. Riavviare la macchina o Beam Studio. Se l\'errore persiste, seguire <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">questa guida</a>.',
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Calibra Stampa e taglia',
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Esporta dati di calibrazione',
      ...
      import_acrylic_focus_probe: 'Sonda di Messa a Fuoco beamo & Beambox - 3 mm',
      ...
      import_hexa_rf_example: 'Esempio di HEXA RF',
      ...
      import_promark_engraving_example_1: 'Esempio di incisione Promark I',
      import_promark_engraving_example_2: 'Esempio di incisione Promark II',
      ...
      machines: 'Macchine',
      maintenance_checklist: 'Lista di manutenzione',
    ...
    tag_names: {
      ...
      params_label: 'Etichetta parametri',
