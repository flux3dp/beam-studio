...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    hole: 'Foro',
    hole_diameter: 'Diametro',
    hole_offset: 'Offset',
    hole_position: 'Posizione',
    hole_thickness: 'Spessore',
    hole_type: 'Tipo',
    hole_type_punch: 'Foro',
    ...
    position_ref: 'Posizione',
    position_ref_bottom_center: 'Basso',
    position_ref_left_center: 'Sinistra',
    position_ref_right_center: 'Destra',
    position_ref_top_center: 'Alto',
    ...
    types: {
      hotel_key_chain: 'Portachiavi da hotel',
