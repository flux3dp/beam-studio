...
const lang: ILang = {
  ...
  beambox: {
    ...
    document_panel: {
      ...
      scale: 'Échelle',
      skip_prespray: 'Ignorer la pré-pulvérisation',
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: 'Veuillez télécharger et imprimer le fichier suivant sur du papier A4 pour la calibration de la caméra.',
    put_chessboard_bm2_2: 'Veuillez placer le papier de calibration bien à plat à l’emplacement désigné sur la zone de travail.',
    ...
    put_paper_bm2_1: 'Placez deux feuilles blanches propres au format A4 ou Lettre côte à côte et aplatissez-les dans la zone de travail.',
