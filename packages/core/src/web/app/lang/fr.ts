    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          diabled_by_gradient: "Veuillez désactiver le dégradé avant d'utiliser cette fonctionnalité.",
          diabled_by_infilled: "Veuillez désactiver le remplissage avant d'utiliser cette fonctionnalité.",
          diabled_by_infilled_and_variable_text: "Veuillez désactiver le remplissage et le texte variable avant d'utiliser cette fonctionnalité.",
          diabled_by_variable_text: "Veuillez désactiver le texte variable avant d'utiliser cette fonctionnalité.",
