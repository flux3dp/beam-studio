    ...
    material_browser: {
      ...
      catalog: {
        ...
        presets: {
          ...
          engraving_quality: 'Gravure (qualité)',
      ...
      editor: {
        ...
        parent_hint: "Si défini, affiché comme variante d'épaisseur sous son matériau parent (pas dans la grille principale).",
        parent_material: 'Matériau parent',
        photo: 'Photo',
        tags: 'Étiquettes',
        thickness_inch: 'Épaisseur (pouce)',
        thickness_inch_hint: 'Les fractions sont acceptées',
