...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'La taille de sortie (%s) dépasse le maximum recommandé de %d × %d px. Le traitement peut prendre plusieurs minutes et le résultat peut ralentir Beam Studio. Continuer quand même ?',
