...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Comment améliorer la précision de la détection ?',
    ...
    retake_tooltip: 'Reprendre la photo à la position de chaque objet pour une meilleure détection',
    retry_with_remove_bg: "Supprimer l'arrière-plan",
    retry_with_remove_bg_tooltip: "Supprimer l'arrière-plan de l'image de prévisualisation pour améliorer la détection des contours",
    rotation: 'Pivoter',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s crédits IA',
      credit_balance: 'Solde de crédits IA',
      credit_cost: 'Crédits IA utilisés',
      description: 'Augmentez la résolution et les détails de l’image grâce à l’IA. L’image agrandie remplacera l’original sur le canevas.',
      done: 'Agrandissement génératif terminé',
      dpi_recommended: 'Recommandé pour le DPI du calque actuel : %dx.',
      dpi_recommended_capped: 'Recommandé pour le DPI du calque actuel : %dx, mais %dx est le maximum dans la taille de sortie recommandée.',
      failed: 'L’agrandissement génératif n’a pas pu être effectué. Vérifiez votre connexion réseau et réessayez.',
      insufficient_credit: 'Crédits IA insuffisants pour lancer l’agrandissement génératif.',
      layer_dpi: 'DPI du calque',
      original_size: 'Taille d’origine',
      output_size: 'Taille de sortie',
      oversize_warning: 'La taille de sortie (%s) dépasse le maximum recommandé de %dpx x %dpx. Le traitement peut prendre plusieurs minutes et le résultat peut ralentir Beam Studio. Continuer quand même ?',
      processing: 'Agrandissement en cours…',
      processing_hint: 'Le temps de traitement dépend de la taille de l’image et de l’état du réseau.',
      recommended: 'Recommandé',
      retry: 'Réessayer',
      start: 'Lancer l’agrandissement',
    },
    announcement_panel: {
      title: 'Annonce',
    },
    ...
    document_panel: {
      ...
      prespray_times: 'Nombre de purges',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Associer à un matériau',
        bucket_hint: 'Enregistré dans votre collection « Mes matériaux » (Autres). Vous pourrez le déplacer vers un matériau plus tard.',
        create_new: 'Créer un matériau…',
        new_material_name: 'Nom du nouveau matériau',
        preset_name: 'Nom du préréglage',
        settings_from_layer: 'Paramètres copiés depuis le calque actuel',
        title: 'Enregistrer les paramètres du calque actuel comme préréglage',
      },
      add_material: 'Ajouter un matériau',
      add_preset: 'Ajouter un préréglage',
      apply: 'Appliquer',
      back_to_catalog: 'Retour au catalogue',
      buy_on_shop: 'Acheter en boutique',
      catalog: {
        materials: {
          acrylic: 'Acrylique transparent',
          acrylic_with_film: 'Acrylique (avec film protecteur)',
          aluminum: 'Aluminium',
          bamboo: 'Bambou',
          basswood_sheet: 'Planche de tilleul',
          black_abs: 'ABS noir',
          black_acrylic: 'Acrylique noir',
          brass: 'Laiton',
          canvas: 'Toile',
          cardboard: 'Carton',
          cardstock: 'Papier cartonné',
          ceramic_tile: 'Carreau de céramique',
          copper: 'Cuivre',
          cork: 'Liège',
          denim: 'Denim',
          eva_foam: 'Mousse EVA',
          ...
          felt: 'Feutre',
          fluorescent_acrylic: 'Acrylique fluorescent',
          glass: 'Verre',
          glitter_acrylic: 'Acrylique pailleté',
          gloss_leather: 'Cuir brillant',
          gold: 'Or',
          iron: 'Fer',
          kraft_paper: 'Papier kraft',
          leather: 'Cuir véritable',
          mdf: 'MDF',
          metal: 'Métal',
        ...
        presets: {
          cutting: 'Découpe',
          engraving: 'Gravure',
          engraving_diode: 'Gravure (diode)',
          engraving_fiber: 'Gravure (fibre)',
          engraving_spray: 'Gravure (spray)',
          kiss_cut: 'Découpe partielle',
          marking: 'Marquage',
          marking_dark: 'Marquage foncé',
          marking_light: 'Marquage clair',
          printing: 'Impression',
          printing_fabric: 'Impression (tissu)',
        },
      },
      categories: {
        acrylic: 'Acryliques',
      ...
      editor: {
        ...
        appearance_hint: 'Pas de photo ? Choisissez plutôt une couleur de couverture.',
        category: 'Catégorie',
        ...
        photo: 'Photo',
        tags: 'Étiquettes',
        title_add: 'Ajouter un matériau',
        title_edit: 'Modifier le matériau',
        upload_hint: 'Cliquez ou faites glisser une photo. Un grand aperçu est affiché dans la galerie.',
      },
      enable: 'Activer',
      export: 'Exporter',
      favorites: 'Favoris',
      from_current_layer: 'Depuis le calque actuel',
      import: 'Importer',
      machine: 'Machine',
      manual: 'Manuel',
      manual_settings: 'Paramètres manuels',
      modified: "Paramètres modifiés depuis l'application du préréglage",
      move_to_material: 'Déplacer vers un matériau…',
      new_preset_manual: 'Nouveau préréglage…',
      no_materials_in_category: 'Aucun matériau ici pour %s pour le moment.',
      no_presets_for_machine: 'Aucun paramètre pour %s pour le moment.',
      no_search_match: 'Aucun matériau ne correspond à « %s ».',
      preset_editor: {
        name: 'Nom du préréglage',
        name_required: 'Le nom est obligatoire',
        title_edit: 'Modifier le préréglage',
        title_new: 'Nouveau préréglage',
      },
      presets: 'Préréglages',
      recents: 'Récents',
      recents_empty: 'Les matériaux récemment appliqués apparaîtront ici.',
      regions: {
        auto: 'Auto',
        eu: 'Europe',
        global: 'Global',
      ...
      restore_default: 'Restaurer les valeurs FLUX par défaut',
      result: 'Résultat',
      search_placeholder: 'Rechercher des matériaux, étiquettes, catégories…',
      settings_region: 'Région du catalogue de matériaux',
      settings_use: 'Utiliser le navigateur de matériaux',
      showing_bundled: 'Affichage du catalogue intégré',
      state_customized: 'Personnalisé',
      state_default: 'Par défaut',
      state_disabled: 'Désactivé',
      state_user: "Défini par l'utilisateur",
      storage_full: "Le stockage est plein, la bibliothèque de matériaux n'a pas pu être enregistrée. Utilisez des couvertures de couleur au lieu de photos.",
      sure_to_delete_material: 'Supprimer ce matériau et tous ses préréglages ?',
      sure_to_delete_preset: 'Supprimer ce préréglage ?',
      sure_to_delete_variant: 'Supprimer cette épaisseur et ses préréglages ?',
      sure_to_import: "L'importation fusionnera le fichier dans votre bibliothèque de matériaux. Continuer ?",
      thickness: 'Épaisseur',
      title: 'Navigateur de matériaux',
      variant_exists: 'Une variante de cette épaisseur existe déjà.',
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: 'Génération de tâches plus rapide disponible',
        keep_current: "Conserver l'actuel",
        message: 'Nous avons amélioré le moteur de calcul des tâches pour améliorer les performances et accélérer la génération des tâches.\nSouhaitez-vous passer au nouveau moteur accéléré ?\nVous pouvez le désactiver à tout moment dans %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'En mode gravure courbe, la vitesse actuelle peut être trop élevée et pourrait affecter les détails de gravure des calques : %(layers)s.\nEnvisagez de réduire la vitesse pour une meilleure qualité.',
    ...
    right_panel: {
      laser_panel: {
        ...
        dropdown: {
          inches: {
            ...
            acrylic_7mm_cutting: 'Acrylique - 1/4″ Découpe',
            ...
            mdf_7mm_cutting: 'MDF - 1/4″ Découpe',
          ...
          mm: {
            ...
            acrylic_7mm_cutting: 'Acrylique - 7mm Découpe',
            ...
            mdf_7mm_cutting: 'MDF - 7mm Découpe',
            mdf_engraving: 'MDF - Gravure',
            mdf_printing: 'MDF - Impression',
            metal_bw_engraving: 'Métal - Gravure',
            opaque_acrylic: 'Acrylique opaque',
        ...
        texture: 'Texture',
        texture_angle: 'Angle',
        texture_intensity: 'Intensité',
        texture_interval: 'Intervalle',
        texture_random: 'Aléatoire',
        texture_stripe: 'Rayures',
        times: 'fois',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Agrandissement génératif',
          ai_upscale_short: 'Agrandissement',
          ai_upscale_too_large: "Cette image est trop grande pour l'agrandissement par IA. La taille maximale prise en charge est de %dpx x %dpx.",
          array: 'Tableau',
          ...
          disabled_by_noun_project: 'Cette forme est protégée par le droit de la propriété intellectuelle, son tracé ne peut donc pas être modifié.',
  ...
  boxgen: {
    ...
    inner: 'Intérieur',
    joints: 'Joint',
    max_dimension_tooltip: 'La largeur maximale est de %s, la hauteur/profondeur maximale est de %s.',
    merge: 'Fusionner',
    outer: 'Extérieur',
    reset: 'Réinitialiser',
    tCount: 'Nombre de T',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Déplacez la tête laser pour aligner la lumière rouge avec le centre du <b>point A</b>.',
    charuco_move_to_point_b: 'Déplacez la tête laser horizontalement pour aligner la lumière rouge avec le centre du <b>point B</b>.',
    ...
    check_pnp_desc: 'Assurez-vous que les marqueurs rouges sont alignés avec les points de gravure\nSinon, cliquez sur « Retour » pour ajuster.\nSi tout est bon, bravo ! 🎉',
    ...
    put_charuco: 'Placer le motif de calibration',
    put_charuco_1: 'Imprimez le motif de calibration (A4/Letter).',
    put_charuco_2: 'Collez-le à plat sur une planche rigide.',
    put_charuco_3: 'Placez au centre et effectuez la mise au point automatique.',
    put_charuco_bm2_1: 'Imprimez le fichier du motif de calibration sur du papier A4 (format Lettre) pour la calibration.',
    put_charuco_bm2_2: 'Cliquez sur “Suivant” et suivez le guide pour positionner le papier.',
    put_charuco_promark_2: 'Veuillez vous assurer que le papier de calibration est clairement visible sans éblouissement. Cliquez sur « Suivant » pour prendre une photo.',
    put_charuco_promark_desc_1: "Veuillez utiliser le papier de calibration fourni dans la boîte d'accessoires ou imprimer le motif de calibration suivant sur papier A4 pour la calibration de la caméra.",
    ...
    put_paper_promark: 'Mettre le carton noir',
    put_paper_promark_1: "Placez le carton noir de la boîte d'accessoires sur la plateforme de travail.",
    put_paper_promark_2: 'Ajustez la mise au point correctement, puis cliquez sur "Commencer Gravure" pour continuer.',
  ...
  cloud_sync: {
    import_config: 'Des paramètres cloud ont été trouvés pour cet appareil. Voulez-vous les importer ?',
    import_failed: 'Échec de la lecture des paramètres cloud.',
    sync_config: 'Voulez-vous synchroniser ces paramètres vers le cloud ?',
    sync_failed: 'Échec de la synchronisation des paramètres vers le cloud.',
    sync_success: 'Paramètres synchronisés vers le cloud avec succès.',
  },
  code_generator: {
    barcode: 'Code-barres',
    content: 'Contenu',
  ...
  connection_issue_guide: {
    alert_link: 'Déconnexion ? Essayez cette méthode de dépannage.',
    connect_computer: {
      content: 'Votre ordinateur doit être sur le même réseau que la machine.',
      macos_steps: "Cliquez sur l'icône Wi-Fi dans la barre de menus. Puis sélectionnez le partage de connexion de votre téléphone.",
      macos_title: 'macOS',
      title: 'Connectez votre ordinateur',
      windows_steps: "Cliquez sur l'icône réseau dans la barre des tâches. Puis sélectionnez le partage de connexion de votre téléphone.",
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'La machine ne trouve pas mon partage de connexion',
      dont_know_hotspot_name: 'Je ne connais pas le nom de mon partage de connexion',
      step1: "1. Sur l'écran tactile de votre machine, allez dans : Réseau → Se connecter au Wi-Fi.",
      step2: '2. Trouvez et sélectionnez le nom du partage de connexion de votre téléphone dans la liste Wi-Fi.',
      step3: '3. Saisissez le mot de passe du partage de connexion et connectez-vous.',
    ...
    enter_ip: {
      ...
      step1: "Saisissez l'adresse IP que vous avez trouvée à l'étape précédente.",
      step2: 'Cliquez sur « Vérifier » pour tester la connexion.',
      step3: 'Beam Studio vérifiera :',
      title: "Saisissez l'adresse IP de votre machine",
      verify: 'Vérifier',
    },
    fail: {
      bullet1: '• Le modèle et le numéro de série de votre machine',
      bullet2: "• L'adresse IP affichée sur l'écran tactile",
      bullet3: "• Une description de l'erreur rencontrée",
      contact_title: "Lorsque vous contactez le support, il est utile d'avoir :",
      intro: "Ne vous inquiétez pas : cela ne signifie pas forcément qu'il y a un problème avec votre machine. D'autres facteurs peuvent affecter la connexion. Notre équipe de support est là pour vous aider à le résoudre.",
      title: "Nous n'avons pas pu terminer le test",
    },
    hotspot: {
      android_steps: "Paramètres → Connexions → Point d'accès mobile et modem → Point d'accès mobile",
      android_title: 'Android',
      ios_steps: "Réglages → Partage de connexion → Autoriser d'autres utilisateurs à se connecter",
      ios_title: 'iPhone (iOS)',
      tip: 'Astuce : Utilisez un nom de partage de connexion simple en anglais et un mot de passe numérique (par ex. Nom : FLUX_Test   Mot de passe : 12345678)',
      warning_2_4ghz: 'Important : Les machines FLUX ne prennent en charge que le Wi-Fi 2.4GHz. Réglez votre partage de connexion sur 2.4GHz avant de continuer.',
    },
    how_it_works: 'Comment fonctionne le test :',
    how_it_works_step1: "1. Configurez votre téléphone comme point d'accès Wi-Fi.",
    ...
    ip_address: {
      ...
      step3: "Notez cette adresse IP pour l'étape suivante.",
      title: "Trouvez l'adresse IP de votre machine",
      warning: "Si l'IP commence par 169.254, la connexion a échoué. Retournez à l'étape 1 et réessayez.",
    },
    success: {
      cause: "Le problème de connexion que vous avez rencontré est très probablement dû à l'environnement de votre réseau local, et non à la machine elle-même.",
      intro: 'Vous avez réussi le test de connexion Wi-Fi, beau travail ! Cela confirme que votre machine FLUX fonctionne parfaitement.',
      recommend1: "• Contactez votre fournisseur d'accès à Internet (ISP) ou le fabricant de votre routeur pour obtenir de l'aide sur vos paramètres Wi-Fi",
      recommend2: '• Demandez à votre administrateur réseau si vous êtes dans une école, un bureau ou un espace de travail partagé',
      recommend3: '• Vérifiez si votre routeur prend en charge le 2.4GHz et essayez de le redémarrer',
      recommend_title: 'Ce que nous recommandons :',
      title: 'Bravo ! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'Générateur de porte-clés',
  ...
  initialize: {
    ...
    select_promark: 'Sélectionnez votre Promark',
    setting_completed: {
      back: 'Retour',
  ...
  keychain_generator: {
    ...
    types: {
      ...
      dialog_box: 'Style bulle de dialogue',
      geometry: 'Style géométrique',
      oval: 'Style ovale',
      pet: 'Style animal de compagnie',
      plant: 'Style plante',
  ...
  machine_linking: {
    continue: 'Continuer',
    i_have_read: "J'ai lu",
    input_birthday_to_link: "Veuillez entrer votre date de naissance pour compléter la liaison de l'appareil",
    input_birthday_to_link_note: "*Utilisé pour vérifier si votre âge répond aux critères d'éligibilité",
    link_failed: 'Échec de la liaison.',
    link_failed_already_linked: "Cet appareil est actuellement lié à un autre FLUX ID. Vous pouvez continuer à l'utiliser ou le lier à votre compte.",
    link_failed_cannot_set_secret: "Impossible d'enregistrer les informations de liaison sur l'appareil. Veuillez vérifier la connexion entre votre ordinateur et l'appareil.",
    link_failed_under_age: "Vous ne remplissez actuellement pas les conditions requises pour utiliser ce service et ne pouvez pas compléter la liaison de l'appareil.",
    link_machine: 'Lier FLUX ID',
    link_machine_to_account: 'Connecté à %(name)s. Souhaitez-vous lier cet appareil à votre compte ?',
    link_success: 'Liaison réussie.',
    link_to_my_flux_id: 'Lier à mon FLUX ID',
    privacy_policy: 'Politique de confidentialité',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Liaison…',
    use_without_linking: 'Utiliser sans lier',
  },
  machine_status: {
  ...
  maintenance: {
    ...
    areas: {
      back_cover: 'Capot arrière',
      modules: 'Modules',
      optics: 'Optique',
      panel: 'Panneau',
      working_area: 'Zone de travail',
    },
    cadence: {
      by_material: 'Par matériau',
      condition: "Selon l'état",
      day: 'Tous les jours',
      days: 'Tous les %s jours',
      each_operation: 'À chaque utilisation',
      every_1_2_weeks: 'Toutes les 1–2 semaines',
      month: 'Tous les mois',
      months: 'Tous les %s mois',
      upon_unboxing: 'Au premier déballage',
      week: 'Toutes les semaines',
      weeks: 'Toutes les %s semaines',
    },
    celebration: {
    ...
    essential: 'Essentiel',
    essential_health: 'Santé essentielle',
    essential_hint: 'compte pour la santé',
    feedback: {
      checked: '%s : vérifié.',
      done: '%s : à jour. Prochaine échéance %s.',
      done_no_date: '%s : terminé.',
      fail_warning: '%s : tube à remplacer. Ouvrez le guide pour les étapes.',
      passed: '%s : réussi — le tube est en bon état !',
    },
    footer_tip: 'Astuce : gravez un fichier test chaque mois pour garder la machine en bon état.',
    history_hint: 'Seules les %s entrées les plus récentes sont conservées pour chaque tâche.',
    intro: 'Suivez chaque tâche de maintenance de cette machine et marquez-la comme faite en un clic.',
    legend: {
    ...
    status: {
      ...
      healthy: 'Bon état',
      last: 'Dernier',
      never_done: 'Jamais faite',
      next: 'Prochaine échéance',
      not_checked: 'Non vérifié',
      not_logged: 'Non enregistré',
      overdue: 'En retard',
      replace_tube: 'Remplacer le tube',
    },
    tasks: {
      align: {
        keyPoints: 'Ajustez lorsque le chemin optique est mal aligné.',
        name: 'Alignement du chemin optique',
      },
      chassis: {
        keyPoints: 'Retirez les résidus et le goudron du châssis et du capot inférieur.',
        name: 'Nettoyage du châssis',
      },
      door: {
        keyPoints: 'Retirez la graisse du capot de la porte.',
        name: 'Nettoyage du capot de la porte',
      },
      exhaust: {
        keyPoints: 'Nettoyez la poussière sur les pales du ventilateur.',
        name: "Nettoyage du ventilateur d'extraction",
      },
      fan: {
        keyPoints: 'Retirez la poussière des pales du ventilateur de ventilation.',
        name: 'Nettoyage du ventilateur de ventilation',
      },
      fieldlens: {
        keyPoints: "Nettoyez la lentille de champ en essuyant du centre vers l'extérieur, dans le sens des aiguilles d'une montre.",
        name: 'Nettoyage de la lentille de champ',
      },
      honeycomb_plate: {
        keyPoints: "Retirez les résidus et le goudron des grilles de la plaque en nid d'abeille.",
        name: "Nettoyage de la plaque en nid d'abeille",
      },
      honeycomb_table: {
        keyPoints: "Retirez les résidus et le goudron du treillis en nid d'abeille.",
      ...
      maintain_test: {
        keyPoints: "Vérifiez l'affichage d'état et les interrupteurs.",
        name: 'Page MAINTAIN',
      },
      mirrors_combiner: {
        keyPoints: "Retirez la saleté des lentilles/miroirs ; vérifiez l'oxydation. Aucune trace d'alcool ou d'eau ne doit rester.",
        name: 'Miroirs, lentille de focalisation et combineur de faisceau',
      },
      mirrors_lens: {
        keyPoints: "Nettoyez les 4 miroirs et la lentille ; assurez-vous qu'il n'y a ni oxydation ni trace d'eau.",
        name: 'Nettoyage des miroirs et de la lentille',
      },
      mod_diode: {
        keyPoints: 'Nettoyez le ventilateur, la lentille de focalisation et le POGO pin.',
        name: 'Module laser à diode',
      },
      mod_ir: {
        keyPoints: 'Nettoyez la lentille de focalisation.',
        name: 'Module laser infrarouge',
      },
      optical_inspection: {
        keyPoints: 'Inspectez le chemin optique ; également au déballage et après le remplacement du tube.',
        name: 'Inspection du chemin optique',
      },
      optical_unboxing: {
        keyPoints: 'Assurez-vous que le chemin optique est précis. À vérifier lors du premier déballage.',
        name: 'Inspection du chemin optique',
      },
      screen: {
        keyPoints: 'Nettoyez la poussière et la graisse sur le panneau.',
        name: "Nettoyage de l'écran",
      },
      tube: {
        keyPoints: "Si l'acrylique de 3 mm ne peut pas être découpé à 70 % de puissance, remplacez le tube.",
        name: 'Contrôle de santé du tube laser',
      },
      water: {
        keyPoints: "Ajoutez de l'eau jusqu'à plus de 80 % du volume, sans bulles d'air.",
        name: "Remplacement de l'eau de refroidissement",
      },
      worktable: {
        keyPoints: "Vaporisez de l'alcool sur un mouchoir, puis essuyez le plan de travail.",
        name: 'Nettoyage du plan de travail',
      },
      zaxis: {
        keyPoints: "Essuyez la vis de la colonne de l'axe Z, puis appliquez le lubrifiant uniformément avec un coton-tige.",
        name: "Lubrification de la colonne de l'axe Z",
      },
    },
    title: 'Liste de contrôle de maintenance',
  },
  ...
  message: {
    ...
    camera: {
      ...
      fail_to_transmit_image: '#845 Quelque chose s\'est mal passé avec la transmission de l\'image. Veuillez redémarrer votre machine ou Beam Studio. Si cette erreur persiste, veuillez suivre <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">ce guide</a>.',
      switching_camera: 'Changement de caméra...',
      wide_angle_open_door: 'Ouvrir le couvercle de protection',
      wide_angle_open_door_text: 'Veuillez ouvrir le couvercle de protection avant de passer à la caméra grand angle.',
  ...
  params_label: {
    ...
    placeholder: 'Étiquette de paramètres',
    preview_hint: "Ceci est un aperçu. Le contenu du texte sera automatiquement mis à jour avant l'envoi d'une tâche",
    save_as_default: 'Enregistrer par défaut',
    settings: "Réglages de l'étiquette de paramètres",
    update: 'Mettre à jour',
    updated: 'Étiquette de paramètres mise à jour',
    use_default: 'Utiliser la valeur par défaut enregistrée',
    use_recommended: 'Utiliser les recommandations',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      ...
      completing: 'Finalisation',
      detecting: 'Détection des repères d’alignement',
      locating: 'Recherche des repères d’alignement',
      preparing: 'Préparation de la caméra',
      refining: 'Affinage de la position des repères',
    },
    alignment: {
    ...
    calibration: {
      align_desc: '1. Placez la feuille de calibration imprimée dans la zone de travail, fixez-la avec du ruban adhésif ou du ruban de masquage pour qu’elle ne glisse pas, puis faites la mise au point.\n2. Cliquez sur « Aperçu et alignement » pour lancer l’alignement par caméra.\n3. Une fois les repères détectés, cliquez sur « Graver les échelles » pour tracer les lignes de référence sur la feuille à faible puissance.',
      aligned: 'Repères d’alignement détectés. Prêt à graver.',
      auto_read: 'Lire les échelles par caméra',
      auto_read_failed: 'Les échelles n’ont pas pu être lues automatiquement. Veuillez les lire à l’œil et saisir les valeurs.',
      auto_read_hint: 'La lecture par caméra peut être décalée de ±2 ; vérifiez-la sur la feuille.',
      current_offset: 'Décalage actuel : X %s mm, Y %s mm',
      export_pdf: 'Exporter le PDF de calibration',
      power: 'Puissance',
      print_desc: '1. Exportez le PDF de la feuille de calibration. Il contient les quatre repères d’alignement et deux échelles.\n2. Imprimez la feuille à 100 % (taille réelle).',
      reading_desc: '1. Repérez la ligne gravée la plus longue (celle du milieu) et notez de quel côté de la ligne 0 imprimée elle se trouve.\n2. Avancez ligne par ligne vers ce côté jusqu’à ce qu’une ligne gravée et une ligne imprimée coïncident exactement.\n3. Comptez de 0 jusqu’à cette ligne imprimée (les nombres sont imprimés toutes les 5 lignes ; comptez aussi les lignes non numérotées entre elles).',
      reading_x: 'Lecture X',
      reading_y: 'Lecture Y',
      scratch: 'Graver les échelles',
      speed: 'Vitesse',
      title: 'Calibration Impression et découpe',
    },
    ...
    generate_from_contour: 'Générer à partir du contour',
    ...
    paper_size: 'Taille de sortie',
    paper_too_small: 'La zone de sortie est trop petite. Le design (repères d’alignement compris) nécessite au moins %s mm de marge par rapport au bord du matériau pour rester dans la zone imprimable de l’imprimante. Choisissez une taille de sortie plus grande, sinon l’impression sera rognée ou réduite.',
    preview_and_align: 'Aperçu et alignement',
    resume_desc: 'Ce design est déjà préparé pour Impression et découpe.\nPlacez le matériau imprimé suivant dans la machine et poursuivez avec l’alignement par caméra, ou recommencez pour changer le design, la taille de sortie ou le tracé de découpe.',
    resume_title: 'Reprendre Impression et découpe',
    select_cut_layer: 'Calque du tracé de découpe',
    ...
    step_setup: 'Tracés de découpe et repères',
    ...
    uv_print_file_disabled: 'Impression et découpe imprime le contenu des calques d’impression UV. Veuillez activer « Activer le fichier d’impression UV » dans les préférences, puis ajouter votre design à un calque d’impression UV.',
  ...
  puzzle_generator: {
    ...
    export_engrave: 'Couche de gravure',
    export_failed: "Échec de l'importation du puzzle sur le canevas. Veuillez réessayer ou ajuster les paramètres du puzzle.",
    export_none: 'Aucun',
    export_print: "Couche d'impression",
    file_too_large: 'Le fichier sélectionné dépasse la taille maximale autorisée.',
    guide_lines: 'Lignes de guide',
    ...
    piece_size: 'Taille des pièces',
    preview_placeholder: 'Aperçu du puzzle',
    puzzle_board: 'Plateau de puzzle',
    puzzle_pieces: 'Pièces du puzzle',
    radius: 'Rayon',
    raised_edges: 'Bords surélevés',
    ...
    types: {
      ...
      heart_jigsaw: 'Puzzle en forme de cœur',
      hex_jigsaw: 'Puzzle hexagonal',
      rectangle_jigsaw: 'Puzzle rectangulaire',
    },
    unsupported_file_type: 'Type de fichier non pris en charge. Veuillez utiliser JPG, PNG ou WebP.',
    upload_hint: 'JPG, PNG, WebP (max 10Mo)',
    upload_image: 'Cliquez ou glissez pour télécharger',
    zoom: 'Zoom',
  },
  qr_code_generator: {
  ...
  settings: {
    ...
    cancel: 'Annuler',
    caption: 'Paramètres',
    check_updates: 'Vérifier automatiquement les mises à jour',
    close: 'Fermer',
    ...
    show_banners: "Afficher la bannière d'accueil",
    simplify_clipper_path: "Optimisation des points d'ancrage",
  ...
  tips: {
    canvas_hold_space_to_pan: "Maintenez la barre d'espace et faites glisser pour déplacer la vue sur le canevas.",
    feature_auto_fit: "Après l'aperçu de la caméra, utilisez Actions → Ajustement automatique pour placer automatiquement les objets sur votre matériau.",
    feature_box_generator: 'Utilisez Générateurs → Générateur de boîtes pour créer des boîtes de taille personnalisée en quelques secondes.',
    feature_code_generator: 'Utilisez Générateurs → Générateur de codes-barres pour créer des codes QR et des codes-barres.',
    feature_elements: "Le panneau Éléments comprend désormais plus d'un million de graphiques prêts à l'emploi.",
    feature_layer_color_configurations: 'Associez les couleurs des calques SVG à la vitesse et à la puissance via Édition → Calque → Paramètres de couleur.',
    feature_material_test: "Utilisez Générateurs → Générateur de test de matériau dans la barre d'outils de gauche pour trouver rapidement les meilleurs paramètres pour un matériau.",
    layer_execution_order: "L'ordre des calques détermine l'ordre des tâches. Les tâches s'exécutent de haut en bas.",
    machine_clean_mirror: "Vérifiez régulièrement les miroirs et la lentille de focalisation et nettoyez-les si nécessaire pour éviter l'accumulation de fumée.",
    machine_no_unattended_operation: 'Ne laissez jamais la machine fonctionner sans surveillance.',
    machine_regular_start: 'Exécutez un travail laser au moins une fois toutes les deux semaines pour prolonger la durée de vie du tube laser.',
    object_edit_image_to_erase: "Utilisez Image → Actions → Modifier l'image pour effacer les zones indésirables d'une image.",
    object_polygon_sides: 'Ajustez le nombre de côtés dans le panneau de propriétés du polygone.',
    object_rounded_rectangle: "Définissez le rayon des coins d'un rectangle arrondi dans le panneau de propriétés du rectangle.",
    object_sharpen_portrait: 'Améliorez les gravures de portraits avec Image → Actions → Accentuation.',
    settings_auto_save: 'Activez la sauvegarde automatique dans les préférences pour éviter de perdre votre travail.',
    settings_default_text_font: "Vous pouvez définir votre police par défaut pour l'outil Texte dans les préférences.",
    task_focus_lower_for_cutting: 'Pour les matériaux plus épais, une focalisation environ 2 mm sous la surface peut améliorer les résultats de coupe.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Échec de la connexion avec la caméra de la machine. Veuillez redémarrer votre machine ou Beam Studio. Si cette erreur persiste, veuillez suivre <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">ce guide</a>.',
      fail_to_get_door_status: 'Veuillez vous assurer que le couvercle de protection est fermé pour activer le laser de découpe.',
      fail_to_start_preview: '#803 Échec du démarrage du mode aperçu. Veuillez redémarrer votre machine ou Beam Studio. Si cette erreur persiste, veuillez suivre <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">ce guide</a>.',
      ...
      start_preview_timeout: '#803 Délai d’attente dépassé lors du démarrage du mode aperçu. Veuillez redémarrer votre machine ou Beam Studio. Si cette erreur persiste, veuillez suivre <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">ce guide</a>.',
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Calibrer Impression et découpe',
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Exporter les données de calibration',
      ...
      machines: 'Machines',
      maintenance_checklist: 'Liste de contrôle de maintenance',
      ...
      tab_layers: 'Calques',
      tab_objects: 'Objets',
      tab_path_edit: 'Édition de chemin',
      tools: {
        title: 'Outils',
      },
    ...
    tag_names: {
      ...
      params_label: 'Étiquette de paramètres',
