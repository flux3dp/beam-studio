...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Position : Alignez avec le point gravé en haut à gauche.',
    align_4_1: 'Position : Alignez avec le point gravé en haut à droite.',
    align_4_2: 'Position : Alignez avec le point gravé en bas à gauche.',
    align_4_3: 'Position : Alignez avec le point gravé en bas à droite.',
    align_8_0: 'Position: Alignez avec le point gravé en haut à gauche extérieur.',
    align_8_1: 'Position: Alignez avec le point gravé en haut à droite extérieur.',
    align_8_2: 'Position: Alignez avec le point gravé en bas à gauche extérieur.',
    align_8_3: 'Position: Alignez avec le point gravé en bas à droite extérieur.',
    align_8_4: 'Position: Alignez avec le point gravé en haut à gauche intérieur.',
    align_8_5: 'Position: Alignez avec le point gravé en haut à droite intérieur.',
    align_8_6: 'Position: Alignez avec le point gravé en bas à gauche intérieur.',
    align_8_7: 'Position: Alignez avec le point gravé en bas à droite intérieur.',
    ...
    charuco_open_the_machine_lid: 'Ouvrez le couvercle de la machine.',
    charuco_place_charuco: 'Placez le motif de calibration imprimé horizontalement sur la <b>%s</b> de la zone de travail.',
    charuco_position_bottom_left: 'en bas à gauche',
    charuco_position_bottom_right: 'en bas à droite',
    charuco_position_center: 'centre',
    charuco_position_left: 'gauche',
    charuco_position_right: 'droite',
    charuco_position_top_left: 'en haut à gauche',
    charuco_position_top_right: 'en haut à droite',
    check_checkpoint_data: 'Données de point de contrôle',
    check_device_pictures: "Vérifier les images de l'appareil",
    check_pnp_desc: 'Nous avons repris les images en fonction des résultats de la calibration et marqué les points de référence de gravure.\nVeuillez vérifier si les marqueurs rouges correspondent aux emplacements réels de gravure.\nEn cas de décalage évident, cliquez simplement sur "Recalibrer" pour réessayer.',
    ...
    solve_pnp_keep_door_closed: 'Gardez la porte fermée pendant le processus suivant. Si elle est ouverte, le système tentera de repositionner la caméra.',
    ...
    solve_pnp_relocate_camera: "Cliquez sur « Repositionner la caméra » si la tête laser n'est toujours pas centrée horizontalement.",
  ...
  settings: {
    ...
    module_offset_4c: 'Décalage impression (4C)',
    ...
    module_offset_uv_varnish: 'Décalage vernis',
    module_offset_uv_white_ink: 'Décalage encre blanche',
    none: 'Aucun',
    normal: 'Normal',
  ...
  topbar: {
    ...
    menu: {
      ...
      import_beamo_2_printing_example_full: "Exemple d'impression beamo II - Couleurs complètes",
