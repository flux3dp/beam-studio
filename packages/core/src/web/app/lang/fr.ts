...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_1: 'Imprimez l’échiquier (A4/Letter).',
    put_chessboard_2: 'Collez-le à plat sur une planche rigide.',
    put_chessboard_3: 'Placez au centre et effectuez la mise au point automatique.',
