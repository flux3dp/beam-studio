...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Utiliser des vitesses trop élevées pour les couches contenant des objets de courbe 3D peut réduire la précision de gravure.\nNous recommandons de maintenir la vitesse en dessous de %(limit)s pour des résultats optimaux avec des objets de courbe 3D.',
      too_fast_for_curve_and_constrain: 'Les couches suivantes: %(layers)s dépassent la limite de vitesse de %(limit)s.\nLa vitesse de gravure pour les objets de courbe 3D sera limitée à %(limit)s. Vous pouvez supprimer cette limite dans les Paramètres des Préférences.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'La vitesse de gravure des objets en courbe 3D sera limitée à %(limit)s. Vous pouvez supprimer cette limite dans les Préférences.',
