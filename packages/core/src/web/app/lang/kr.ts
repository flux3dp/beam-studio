...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: '감지 정확도를 높이려면 어떻게 해야 하나요?',
    ...
    retake: '사진 다시 촬영',
    retake_tooltip: '더 나은 감지를 위해 각 객체 위치에서 카메라 사진을 다시 촬영합니다',
    retry_with_remove_bg: '배경 제거',
    retry_with_remove_bg_tooltip: '윤곽 감지를 개선하기 위해 미리보기 이미지에서 배경을 제거합니다',
    rotation: '회전',
    ...
    use_original_image_tooltip: '배경 제거 없이 원본 미리보기 이미지를 복원합니다',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s AI 크레딧',
      credit_balance: 'AI 크레딧 잔액',
      credit_cost: '사용 AI 크레딧',
      description: 'AI로 이미지 해상도와 디테일을 높입니다. 업스케일된 이미지가 캔버스의 원본을 대체합니다.',
      done: '생성형 업스케일 완료',
      dpi_recommended: '현재 레이어 DPI에는 %dx를 권장합니다.',
      dpi_recommended_capped: '현재 레이어 DPI에는 %dx를 권장하지만, 권장 출력 크기 내 최대 배율은 %dx입니다.',
      failed: '생성형 업스케일을 완료할 수 없습니다. 네트워크 연결을 확인한 후 다시 시도하세요.',
      insufficient_credit: 'AI 크레딧이 부족하여 생성형 업스케일을 실행할 수 없습니다.',
      layer_dpi: '레이어 DPI',
      original_size: '원본 크기',
      output_size: '출력 크기',
      oversize_warning: '출력 크기(%s)가 권장 최대치인 %dpx x %dpx를 초과합니다. 처리에 몇 분이 걸릴 수 있으며 결과물로 인해 Beam Studio가 느려질 수 있습니다. 계속하시겠습니까?',
      processing: '생성형 업스케일 처리 중…',
      processing_hint: '처리 시간은 이미지 크기와 네트워크 상태에 따라 다릅니다.',
      recommended: '권장',
      retry: '다시 시도',
      start: '업스케일 시작',
    },
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: '더 빠른 작업 생성 가능',
        keep_current: '현재 유지',
        message: '작업 계산 엔진을 업그레이드하여 성능을 개선하고 작업 생성 속도를 높였습니다.\n새로운 가속 엔진으로 전환하시겠습니까?\n%(preferences)s > %(editor)s > %(path_acceleration)s에서 언제든지 끌 수 있습니다.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: '곡선 조각 모드에서 현재 속도가 너무 높아 레이어 %(layers)s의 조각 디테일에 영향을 줄 수 있습니다.\n더 나은 품질을 위해 속도를 낮추는 것을 고려해 주세요.',
    ...
    right_panel: {
      laser_panel: {
        ...
        dropdown: {
          inches: {
            ...
            acrylic_7mm_cutting: '아크릴 - 1/4″ 절단',
            ...
            mdf_7mm_cutting: '뉴질랜드 MDF - 1/4″ 절단',
          ...
          mm: {
            ...
            acrylic_7mm_cutting: '아크릴 - 7mm 절단',
            ...
            mdf_7mm_cutting: '뉴질랜드 MDF - 7mm 절단',
            mdf_engraving: '뉴질랜드 MDF - 각인',
            mdf_printing: '뉴질랜드 MDF - 인쇄',
            metal_bw_engraving: '금속 - 각인',
            opaque_acrylic: '불투명 아크릴',
        ...
        texture: '텍스처',
        texture_angle: '각도',
        texture_intensity: '강도',
        texture_interval: '간격',
        texture_random: '랜덤',
        texture_stripe: '스트라이프',
        times: '회',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale_too_large: '이 이미지는 AI 업스케일에 너무 큽니다. 지원되는 최대 크기는 %dpx x %dpx입니다.',
          array: '어레이',
          auto_fit: '자동 맞춤',
          bevel: '경계선 처리',
          brightness: '밝기',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: '레이저 헤드를 이동하여 빨간 빛을 <b>A 점</b> 의 중심에 맞추세요.',
    charuco_move_to_point_b: '레이저 헤드를 수평으로 이동하여 빨간 빛을 <b>B 점</b> 의 중심에 맞추세요.',
    ...
    check_pnp_desc: '빨간색 마커가 조각 위치와 정렬되는지 확인하세요\n그렇지 않으면 "뒤로"를 클릭하여 조정하세요.\n모든 것이 정상이라면, 잘하셨습니다! 🎉',
    ...
    put_charuco: '교정 패턴 배치',
    put_charuco_1: '교정 패턴을 인쇄하세요 (A4/Letter).',
    put_charuco_2: '단단한 판에 평평하게 붙이세요.',
    put_charuco_3: '중앙에 놓고 오토포커스하세요.',
    put_charuco_bm2_1: '보정용으로 A4(레터 크기) 용지에 교정 패턴 파일을 인쇄하세요.',
    put_charuco_bm2_2: '“다음”을 클릭하고 안내에 따라 용지를 배치하세요.',
    put_charuco_promark_2: "보정 용지가 반사 없이 선명하게 보이는지 확인하세요. '다음'을 클릭하여 사진을 찍으세요.",
    put_charuco_promark_desc_1: '액세서리 박스에 들어있는 보정 용지를 사용하거나 아래 보정 패턴을 A4 용지에 인쇄하여 카메라를 보정하세요.',
    ...
    put_paper_promark: '검은색 판지를 놓으세요',
    put_paper_promark_1: '액세서리 박스에서 검은색 판지를 작업 플랫폼에 놓으세요.',
    put_paper_promark_2: '초점을 제대로 맞추고 "각인 시작"을 클릭하여 진행하세요.',
  ...
  connection_issue_guide: {
    alert_link: '연결이 끊기나요? 이 문제 해결 방법을 시도해 보세요.',
    connect_computer: {
      content: '컴퓨터는 기기와 동일한 네트워크에 연결되어 있어야 합니다.',
      macos_steps: '메뉴 막대에서 Wi-Fi 아이콘을 클릭한 다음, 휴대폰의 핫스팟을 선택하세요.',
      macos_title: 'macOS',
      title: '컴퓨터 연결하기',
      windows_steps: '작업 표시줄에서 네트워크 아이콘을 클릭한 다음, 휴대폰의 핫스팟을 선택하세요.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: '기기가 내 핫스팟을 찾지 못해요',
      dont_know_hotspot_name: '내 핫스팟 이름을 모르겠어요',
      step1: '1. 기기의 터치 패널에서 네트워크 → Wi-Fi 연결로 이동하세요.',
      step2: '2. Wi-Fi 목록에서 휴대폰의 핫스팟 이름을 찾아 선택하세요.',
      step3: '3. 핫스팟 비밀번호를 입력하고 연결하세요.',
    ...
    enter_ip: {
      ...
      placeholder: 'IP 주소',
      step1: '이전 단계에서 찾은 IP 주소를 입력하세요.',
      step2: '"확인"을 클릭하여 연결을 테스트하세요.',
      step3: 'Beam Studio가 다음 항목을 확인합니다:',
      title: '기기의 IP 주소 입력하기',
      verify: '확인',
    },
    fail: {
      bullet1: '• 기기 모델명 및 일련번호',
      bullet2: '• 터치 패널에 표시된 IP 주소',
      bullet3: '• 발생한 오류에 대한 설명',
      contact_title: '고객 지원에 문의할 때 다음 정보가 있으면 도움이 됩니다:',
      intro: '걱정하지 마세요. 이것이 반드시 기기에 문제가 있다는 뜻은 아닙니다. 연결에 영향을 주는 다른 요인이 있을 수 있습니다. 저희 지원팀이 원인을 파악하는 데 도움을 드리겠습니다.',
      title: '테스트를 완료할 수 없습니다',
    },
    hotspot: {
      android_steps: '설정 → 연결 → 모바일 핫스팟 및 테더링 → 모바일 핫스팟',
      android_title: 'Android',
      ios_steps: '설정 → 개인용 핫스팟 → 다른 사람의 연결 허용',
      ios_title: 'iPhone (iOS)',
      tip: '팁: 간단한 영문 핫스팟 이름과 숫자 비밀번호를 사용하세요 (예: 이름: FLUX_Test   비밀번호: 12345678)',
      warning_2_4ghz: '중요: FLUX 기기는 2.4GHz Wi-Fi만 지원합니다. 계속하기 전에 핫스팟을 2.4GHz로 설정하세요.',
    },
    how_it_works: '테스트 진행 방식:',
    how_it_works_step1: '1. 휴대폰을 Wi-Fi 핫스팟으로 설정합니다.',
    how_it_works_step2: '2. 기기를 핫스팟에 연결합니다.',
    how_it_works_step3: '3. 컴퓨터를 동일한 핫스팟에 연결합니다.',
    how_it_works_step4: '4. Beam Studio에서 연결을 테스트합니다.',
    intro: '기기가 정상적으로 작동하는지 확인하기 위해 간단한 테스트를 진행해 보겠습니다. 휴대폰의 핫스팟을 통해 기기와 컴퓨터를 연결하여 문제가 네트워크에 있는지, 아니면 기기 자체에 있는지 판단합니다.',
    ip_address: {
      step1: '기기의 터치 패널에서 다음으로 이동하세요:\n네트워크 → "IP 주소" 찾기',
      step2: 'IP 주소는 보통 172.20.10.x 또는 192.168.x.x와 같은 형태입니다\n(휴대폰 핫스팟에 따라 다릅니다)',
      step3: '다음 단계를 위해 이 IP 주소를 적어 두세요.',
      title: '기기의 IP 주소 찾기',
      warning: 'IP 주소가 169.254로 시작하면 연결에 실패한 것입니다. 1단계로 돌아가 다시 시도하세요.',
    },
    success: {
      cause: '겪으신 연결 문제는 기기 자체가 아니라 로컬 네트워크 환경 때문일 가능성이 높습니다.',
      intro: 'Wi-Fi 연결 테스트를 성공적으로 완료하셨습니다. 수고하셨습니다! 이는 FLUX 기기가 완벽하게 작동하고 있음을 확인해 줍니다.',
      recommend1: '• Wi-Fi 설정에 대한 도움을 받으려면 인터넷 서비스 제공업체(ISP)나 공유기 제조사에 문의하세요',
      recommend2: '• 학교, 사무실 또는 공유 작업 공간에 계신 경우 네트워크 관리자에게 문의하세요',
      recommend3: '• 공유기가 2.4GHz를 지원하는지 확인하고 재시작해 보세요',
      recommend_title: '권장 사항:',
      title: '훌륭합니다! 🎉',
    },
    title: '연결 문제가 있으신가요?',
  },
  ...
  initialize: {
    ...
    connect_wifi: {
      ...
      what_if_1_content: '1. Wi-Fi 암호화 모드는 WPA2 또는 비밀번호가 없어야 합니다. 2. 암호화 모드는 Wi-Fi 라우터 관리 인터페이스에서 설정할 수 있습니다. 라우터가 WPA2를 지원하지 않고 적합한 라우터를 선택하는 데 도움이 필요하면 FLUX 지원팀에 문의하십시오. 3. Wi-Fi 채널은 2.4Ghz여야 합니다(5Ghz는 지원되지 않음).',
      what_if_2: 'Wi-Fi를 전혀 찾지 못하면 어떻게 하나요?',
      what_if_2_content: '1. Wi-Fi 동글이 완전히 꽂혀 있는지 확인하세요. 2. 터치스크린에 무선 네트워크의 MAC 주소가 없으면 FLUX 지원팀에 문의하십시오.',
    },
    connect_wired: {
      title: '유선 네트워크 연결 중',
    ...
    기계 > "Promark 이름" > Promark 설정`,
      ...
      setting_completed_ask_camera_calibration: 'Promark 필드 렌즈 설정이 성공적으로 완료되었습니다! 카메라 보정을 진행하시겠습니까?',
      settings: 'Promark 설정',
    },
    retry: '재시도',
    ...
    select_hexa: 'HEXA를 선택하세요',
    select_language: '언어 선택',
    select_machine_type: '모델 선택',
    select_promark: 'Promark를 선택하세요',
    setting_completed: {
      back: '뒤로',
  ...
  machine_linking: {
    continue: '계속',
    i_have_read: '읽었습니다',
    input_birthday_to_link: '기기 연결을 완료하려면 생년월일을 입력해 주세요',
    input_birthday_to_link_note: '*나이가 이용 자격 요건을 충족하는지 확인하는 데 사용됩니다',
    link_failed: '연결 실패.',
    link_failed_already_linked: '이 장치는 현재 다른 FLUX ID에 연결되어 있습니다. 계속 사용하거나 본인 계정에 연결할 수 있습니다.',
    link_failed_cannot_set_secret: '연결 정보를 장치에 저장할 수 없습니다. 컴퓨터와 장치의 연결 상태를 확인하세요.',
    link_failed_under_age: '현재 이용 자격이 충족되지 않아 기기 연결을 완료할 수 없습니다.',
    link_machine: 'FLUX ID 연결',
    link_machine_to_account: '%(name)s에 연결되었습니다. 이 장치를 계정에 연결하시겠습니까?',
    link_success: '연결 성공.',
    link_to_my_flux_id: '내 FLUX ID에 연결',
    privacy_policy: '개인정보 처리방침',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: '연결 중…',
    use_without_linking: '연결 없이 사용',
  },
  machine_status: {
  ...
  maintenance: {
    ...
    cadence: {
      ...
      day: '매일',
      days: '%s일마다',
      each_operation: '작업할 때마다',
      every_1_2_weeks: '매 1–2주',
      month: '매월',
      months: '%s개월마다',
      upon_unboxing: '최초 개봉 시',
      week: '매주',
      weeks: '%s주마다',
    },
    celebration: {
    ...
    feedback: {
      ...
      done_no_date: '%s 완료.',
      fail_warning: '%s: 레이저 튜브 교체 대상으로 표시했습니다. 가이드에서 단계를 확인하세요.',
      passed: '%s 통과 — 레이저 튜브가 정상입니다!',
    },
    footer_tip: '팁: 매월 샘플 파일을 조각하면 기계를 좋은 상태로 유지할 수 있습니다.',
    history_hint: '각 항목당 최근 %s개의 기록만 보관됩니다.',
    intro: '이 기계의 유지보수 항목을 관리하고 클릭 한 번으로 완료를 표시하세요.',
    legend: {
      due_soon: '기한 임박',
      overdue: '기한 초과',
      up_to_date: '정상',
    ...
    status: {
      ...
      not_logged: '미기록',
      overdue: '기한 초과',
      replace_tube: '레이저 튜브 교체',
    },
    tasks: {
      align: {
        keyPoints: '광로가 틀어졌을 때 조정하세요.',
        name: '광로 정렬',
      },
      chassis: {
        keyPoints: '본체와 바닥 덮개의 잔여물과 타르를 제거하세요.',
        name: '본체 청소',
      },
      door: {
        keyPoints: '도어 덮개의 기름때를 제거하세요.',
        name: '도어 덮개 청소',
      },
      exhaust: {
        keyPoints: '팬 날개의 먼지를 제거하세요.',
        name: '배기 팬 청소',
      },
      fan: {
        keyPoints: '환기 팬 날개의 먼지를 제거하세요.',
        name: '환기 팬 청소',
      },
      fieldlens: {
        keyPoints: '필드 렌즈를 중심에서 바깥쪽으로 시계 방향으로 닦아 청소하세요.',
        name: '필드 렌즈 청소',
      },
      honeycomb_plate: {
        keyPoints: '허니컴 판 격자의 잔여물과 타르를 제거하세요.',
        name: '허니컴 판 청소',
      },
      honeycomb_table: {
        keyPoints: '허니컴 망의 잔여물과 타르를 제거하세요.',
        name: '허니컴 테이블 청소',
      },
      lube: {
      ...
      maintain_test: {
        keyPoints: '상태 표시와 스위치를 확인하세요.',
        name: 'MAINTAIN 페이지',
      },
      mirrors_combiner: {
        keyPoints: '렌즈/거울의 오염을 제거하고 산화 여부를 확인하세요. 알코올이나 물 자국이 남지 않게 하세요.',
        name: '거울, 초점 렌즈 및 빔 컴바이너',
      },
      mirrors_lens: {
        keyPoints: '거울 4개와 렌즈를 청소하고 산화나 물 자국이 없는지 확인하세요.',
        name: '거울 및 렌즈 청소',
      },
      mod_diode: {
        keyPoints: '팬, 초점 렌즈, POGO pin을 청소하세요.',
        name: '다이오드 레이저 모듈',
      },
      mod_ir: {
        keyPoints: '초점 렌즈를 청소하세요.',
        name: '적외선 레이저 모듈',
      },
      optical_inspection: {
        keyPoints: '광로를 점검하세요. 개봉 시와 레이저 튜브 교체 후에도 점검하세요.',
        name: '광로 점검',
      },
      optical_unboxing: {
        keyPoints: '광로가 정확한지 확인하세요. 최초 개봉 시 점검하세요.',
        name: '광로 점검',
      },
      screen: {
        keyPoints: '패널의 먼지와 기름때를 청소하세요.',
        name: '화면 청소',
      },
      tube: {
        keyPoints: '3mm 아크릴을 70% 파워로 절단할 수 없다면 레이저 튜브를 교체하세요.',
        name: '레이저 튜브 상태 점검',
      },
      water: {
        keyPoints: '기포 없이 80% 이상 찰 때까지 물을 채우세요.',
        name: '냉각수 교체',
      },
      worktable: {
        keyPoints: '휴지에 알코올을 뿌린 뒤 작업대를 닦으세요.',
        name: '작업대 청소',
      },
      zaxis: {
        keyPoints: 'Z축 기둥 나사를 닦은 뒤 면봉으로 윤활유를 고르게 바르세요.',
        name: 'Z축 기둥 윤활',
      },
    },
    title: '유지보수 체크리스트',
  ...
  message: {
    ...
    camera: {
      ...
      fail_to_transmit_image: '#845 이미지 전송 중 오류가 발생했습니다. 기계나 Beam Studio를 다시 시작해주세요. 만약 이 오류가 계속 발생한다면, <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">이 가이드</a>를 따라주세요.',
      switching_camera: '카메라 전환 중...',
      wide_angle_open_door: '문을 열어주세요',
      wide_angle_open_door_text: '광각 카메라로 전환하기 전에 문을 열어주세요.',
  ...
  params_label: {
    ...
    layer_name: '레이어 이름',
    placeholder: '파라미터 라벨',
    preview_hint: '미리보기입니다. 작업을 전송하기 전에 현재 레이어 파라미터로 자동 업데이트됩니다',
    save_as_default: '기본값으로 저장',
    settings: '파라미터 라벨 설정',
    update: '업데이트',
    updated: '파라미터 라벨이 업데이트되었습니다',
    use_default: '저장된 기본값 사용',
    use_recommended: '권장 항목 사용',
  },
  pass_through: {
    export: '작업 영역으로 내보내기',
    exporting: '내보내는 중...',
  ...
  print_and_cut: {
    ...
    finish: '완료',
    fit_content: '내용에 맞추기',
    generate_from_contour: '윤곽선에서 생성',
    grid_columns: '열',
    grid_rows: '행',
    grid_spacing: '간격 (mm)',
    ...
    paper_size: '출력 크기',
    paper_too_small: '출력 범위가 너무 작습니다. 디자인(정렬 마크 포함)이 프린터의 인쇄 가능 영역 안에 들어가려면 소재 가장자리에서 최소 %s mm의 여백이 필요합니다. 더 큰 출력 크기를 선택하지 않으면 인쇄물이 잘리거나 축소됩니다.',
    preview_and_align: '미리보기 및 정렬',
    resume_desc: '이 디자인은 이미 인쇄 후 커팅 준비가 완료되었습니다.\n다음 인쇄된 소재를 기기에 넣고 카메라 정렬을 계속하거나, 처음부터 다시 시작하여 디자인, 출력 크기 또는 커팅 경로를 변경하세요.',
    resume_title: '인쇄 후 커팅 이어하기',
    select_cut_layer: '커팅 경로 레이어',
    start_over: '처음부터 다시 시작',
    step_align: '카메라 정렬',
    step_align_desc: '인쇄된 소재를 기기에 넣고 카메라 미리보기를 실행하세요.\n마크가 감지되고 커팅 선이 인쇄물에 자동으로 정렬됩니다.\n“완료”를 클릭하면 정렬된 커팅 레이어가 캔버스에 추가되고 원본 디자인 레이어는 숨겨집니다.\n그런 다음 편집기에서 작업을 전송하세요.',
    step_export: 'PDF 내보내기 및 인쇄',
    step_export_desc: '디자인과 정렬 마크가 포함된 PDF를 내보낸 후, 프린터에서 100% 배율(실제 크기)로 인쇄하세요.\n“페이지에 맞추기”를 사용하면 커팅 경로가 인쇄물과 일치하지 않습니다.\n오프셋된 커팅 경로는 레이저 커터에서만 사용되므로 포함되지 않습니다.',
    step_paper: '출력 크기',
    step_paper_desc: '내보낼 PDF의 출력 크기를 선택하세요.\n행과 열을 설정하면 한 장의 소재에 여러 개의 디자인을 인쇄하고 커팅할 수 있습니다.\n미리보기에는 내용을 둘러싼 출력 범위가 표시됩니다.',
    step_setup: '커팅 경로 및 마크',
    step_setup_desc: '커팅 경로를 만드는 방법을 선택하세요: 디자인 전체를 둘러싸는 윤곽선을 생성하거나 기존 레이어를 커팅 경로로 사용합니다.',
    title: '인쇄 후 커팅',
    use_layer_as_cut_path: '레이어 사용',
    uv_print_file_disabled: '인쇄 후 커팅은 UV 인쇄 레이어의 내용을 인쇄합니다. 환경설정에서 "UV 인쇄 파일 활성화"를 켠 다음 디자인을 UV 인쇄 레이어에 추가해 주세요.',
  ...
  puzzle_generator: {
    ...
    exploded_view: '분해도',
    export_as: '내보내기',
    export_engrave: '조각 레이어',
    export_failed: '퍼즐을 캔버스로 가져올 수 없습니다. 다시 시도하거나 퍼즐 설정을 조정하십시오.',
    export_none: '없음',
    export_print: '인쇄 레이어',
    file_too_large: '선택한 파일이 허용된 최대 크기를 초과합니다.',
    guide_lines: '가이드 라인',
    heart_sharpness: '뾰족함',
    image: '이미지',
    ...
    offset_y: 'Y 오프셋',
    orientation: '조각 방향',
    orientation_type_1: '유형 1',
    orientation_type_2: '유형 2',
    orientation_type_3: '유형 3',
    orientation_type_4: '유형 4',
    piece_size: '조각 크기',
    preview_placeholder: '퍼즐 미리보기',
    puzzle_board: '퍼즐 보드',
    puzzle_pieces: '퍼즐 조각',
    radius: '반경',
    ...
    types: {
      ...
      heart_jigsaw: '하트 퍼즐',
      hex_jigsaw: '육각형 퍼즐',
      rectangle_jigsaw: '직사각형 퍼즐',
    },
    unsupported_file_type: '지원되지 않는 파일 형식입니다. JPG, PNG 또는 WebP를 사용하십시오.',
    upload_hint: 'JPG, PNG, WebP (최대 10MB)',
    upload_image: '클릭하거나 드래그하여 업로드',
    zoom: '확대/축소',
  },
  qr_code_generator: {
  ...
  tips: {
    canvas_hold_space_to_pan: '스페이스 키를 누른 채로 드래그하여 캔버스를 이동할 수 있습니다.',
    feature_auto_fit: '카메라 미리보기 후 액션 → 자동 맞춤을 사용하여 재료에 자동으로 객체를 배치할 수 있습니다.',
    feature_box_generator: '생성기 → 박스 생성기를 사용하여 맞춤형 크기의 박스를 몇 초 만에 만들 수 있습니다.',
    feature_code_generator: '생성기 → 바코드 생성기를 사용하여 QR 코드와 바코드를 만들 수 있습니다.',
    feature_elements: '요소 패널에는 이제 백만 개 이상의 그래픽이 사용 가능합니다.',
    feature_layer_color_configurations: '편집 → 레이어 → 색상 설정을 통해 SVG 레이어 색상을 속도 및 출력에 매핑할 수 있습니다.',
    feature_material_test: '왼쪽 도구 모음의 생성기 → 재료 테스트 생성기를 사용하여 재료에 가장 적합한 설정을 빠르게 찾을 수 있습니다.',
    layer_execution_order: '레이어 순서가 작업 순서를 결정합니다. 작업은 위에서 아래로 실행됩니다.',
    machine_clean_mirror: '거울과 초점 렌즈를 정기적으로 확인하고 필요시 청소하여 연기 축적을 방지하십시오.',
    machine_no_unattended_operation: '기계를 무인 상태로 작동시키지 마십시오.',
    machine_regular_start: '최소 2주에 한 번 레이저 작업을 실행하면 레이저 튜브 수명 연장에 도움이 됩니다.',
    object_edit_image_to_erase: '이미지 → 액션 → 이미지 편집을 사용하여 이미지에서 원치 않는 영역을 지울 수 있습니다.',
    object_polygon_sides: '다각형의 속성 패널에서 변의 수를 조정할 수 있습니다.',
    object_rounded_rectangle: '사각형의 속성 패널에서 둥근 사각형의 모서리 반경을 설정할 수 있습니다.',
    object_sharpen_portrait: '이미지 → 액션 → 선명하게를 사용하여 인물 조각을 향상시킬 수 있습니다.',
    settings_auto_save: '환경 설정에서 자동 저장을 활성화하여 작업 손실을 방지하십시오.',
    settings_default_text_font: '환경 설정에서 텍스트 도구의 기본 글꼴을 설정할 수 있습니다.',
    task_focus_lower_for_cutting: '두꺼운 재료의 경우 표면 아래 약 2mm에 초점을 맞추면 절단 결과가 향상될 수 있습니다.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 기계의 카메라와의 접속을 설정하지 못했습니다. 기계 또는 빔스튜디오를 다시 시작해 주세요. 이 에러가 지속된다면 다음 가이드를 따라 주세요.<a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">this guide</a>',
      fail_to_get_door_status: '문이 닫혀 있는지 확인하여 저전력 레이저를 활성화하고 프레임을 실행하세요.',
      fail_to_start_preview: '#803 미리보기 모드 시작 실패. 기계 또는 빔스튜디오를 다시 시작해 주세요. 이 에러가 지속된다면 다음 가이드를 따라 주세요. <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">this guide</a>',
      ...
      start_preview_timeout: '#803 미리보기 모드로 시작할 때 시간초과가 발생합니다. 기계 또는 빔스튜디오를 다시 시작해 주세요. 이 에러가 지속된다면 다음 가이드를 따라주세요. <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">this guide</a>',
    ...
    menu: {
      ...
      example_files: '예제 파일',
      export_BVG: 'BVG',
      export_calibration_data: '보정 데이터 내보내기',
      ...
      import_beamo_2_printing_test: 'beamo II 인쇄 테스트',
      import_calibration_data: '보정 데이터 가져오기',
      import_hello_beambox: 'Beambox 예시',
      import_hello_beamo: '비모 예시',
      import_hexa_example: 'HEXA 예제',
      import_hexa_rf_example: 'HEXA RF 예제',
      ...
      machine_info: '기계 정보',
      machines: '기계',
      maintenance_checklist: '유지보수 체크리스트',
