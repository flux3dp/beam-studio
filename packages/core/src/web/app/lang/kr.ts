...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: '카메라 보정을 위해 아래 파일을 A4 용지에 다운로드하여 인쇄해 주세요.',
    put_chessboard_bm2_2: '작업 영역의 지정된 위치에 보정 용지를 평평하게 놓아 주세요.',
    ...
    put_paper: '종이를 놓으세요',
    put_paper_bm2_1: '작업 영역에 깨끗한 A4 또는 레터 크기의 흰 종이 두 장을 나란히 놓고 평평하게 펴주세요.',
