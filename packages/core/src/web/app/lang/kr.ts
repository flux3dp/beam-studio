...
const lang: ILang = {
  ...
  beambox: {
    ...
    material_browser: {
      add_from_layer: {
        attach_to: '소재에 추가',
        bucket_hint: '「내 소재」 컬렉션(기타)에 저장되었습니다. 나중에 다른 소재로 옮길 수 있습니다.',
        create_new: '새 소재 만들기…',
        new_material_name: '새 소재 이름',
        preset_name: '프리셋 이름',
        settings_from_layer: '현재 레이어에서 복사한 설정',
        title: '현재 레이어 설정을 프리셋으로 저장',
      },
      add_material: '소재 추가',
      add_preset: '프리셋 추가',
      apply: '적용',
      ...
      editor: {
        appearance: '외관',
        appearance_hint: '사진이 없나요? 대신 커버 색상을 선택하세요.',
        category: '카테고리',
        category_required: '카테고리를 선택하세요',
        color: '색상',
        name: '소재 이름',
        ...
        title_add: '소재 추가',
        title_edit: '소재 편집',
        upload_hint: '사진을 클릭하거나 끌어다 놓으세요. 갤러리에 큰 미리보기가 표시됩니다.',
      },
      enable: '활성화',
      export: '내보내기',
      favorites: '즐겨찾기',
      from_current_layer: '현재 레이어에서',
      import: '가져오기',
      machine: '기기',
      manual: '수동',
      manual_settings: '수동 설정',
      modified: '프리셋 적용 후 수정됨',
      move_to_material: '소재로 이동…',
      new_preset_manual: '새 프리셋…',
      no_materials_in_category: '%s에 사용할 수 있는 소재가 아직 없습니다.',
      no_presets_for_machine: '%s용 설정이 아직 없습니다.',
      no_search_match: '「%s」와(과) 일치하는 소재가 없습니다.',
      preset_editor: {
        name: '프리셋 이름',
        name_required: '이름을 입력하세요',
        title_edit: '프리셋 편집',
      ...
      presets: '프리셋',
      recents: '최근 사용',
      recents_empty: '최근에 적용한 소재가 여기에 표시됩니다.',
      regions: {
        auto: '자동',
        eu: '유럽',
        global: '글로벌',
      ...
      restore_default: 'FLUX 기본값 복원',
      result: '검색 결과',
      search_placeholder: '소재, 태그, 카테고리 검색…',
      settings_region: '소재 카탈로그 지역',
      settings_use: '소재 브라우저 사용',
      showing_bundled: '내장 카탈로그 표시 중',
      state_customized: '사용자 지정됨',
      state_default: '기본',
      state_disabled: '비활성화됨',
      state_user: '사용자 정의',
      storage_full: '저장 공간이 부족하여 재료 라이브러리를 저장하지 못했습니다. 사진 대신 색상 커버를 사용해 보세요.',
      sure_to_delete_material: '이 소재와 모든 프리셋을 삭제하시겠습니까?',
      sure_to_delete_preset: '이 프리셋을 삭제하시겠습니까?',
      sure_to_delete_variant: '이 두께와 해당 프리셋을 삭제하시겠습니까?',
      sure_to_import: '가져오기를 실행하면 파일이 소재 라이브러리에 병합됩니다. 계속하시겠습니까?',
      thickness: '두께',
      title: '소재 브라우저',
      variant_exists: '이 두께의 변형이 이미 있습니다.',
      variants: '%d개 규격',
    },
    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          disabled_by_noun_project: '이 도형은 지적 재산권법으로 보호되므로 경로를 편집할 수 없습니다.',
  ...
  print_and_cut: {
    ...
    calibration: {
      align_desc: '1. 인쇄한 보정 시트를 작업 영역에 놓고, 밀리지 않도록 테이프나 마스킹 테이프로 고정한 뒤 초점을 맞추세요.\n2. “미리보기 및 정렬”을 클릭하여 카메라 정렬을 실행하세요.\n3. 마크가 감지되면 “눈금 새기기”를 클릭하여 낮은 출력으로 시트에 기준선을 새깁니다.',
      aligned: '정렬 마크를 감지했습니다. 새길 준비가 되었습니다.',
      auto_read: '카메라로 눈금 읽기',
      auto_read_failed: '눈금을 자동으로 읽을 수 없습니다. 눈으로 확인하여 값을 입력해 주세요.',
      auto_read_hint: '카메라 판독값은 ±2눈금까지 오차가 있을 수 있습니다. 교정 시트와 대조해 확인하세요.',
      current_offset: '현재 오프셋: X %s mm, Y %s mm',
      export_pdf: '보정 PDF 내보내기',
      power: '출력',
      print_desc: '1. 보정 시트 PDF를 내보내세요. 시트에는 네 개의 정렬 마크와 두 개의 눈금이 있습니다.\n2. 시트를 100% 배율(실제 크기)로 인쇄하세요.',
      reading_desc: '1. 가장 긴 새겨진 선(가운데 선)을 찾아 인쇄된 0 선의 어느 쪽에 있는지 확인하세요.\n2. 그 방향으로 한 선씩 따라가며 새겨진 선과 인쇄된 선이 정확히 일치하는 위치를 찾으세요.\n3. 0에서 그 인쇄된 선까지 세세요(숫자는 5선마다 인쇄되어 있으며, 그 사이의 숫자 없는 선도 함께 세세요).',
      reading_x: 'X 읽기값',
      reading_y: 'Y 읽기값',
      scratch: '눈금 새기기',
      speed: '속도',
  ...
  topbar: {
    ...
    menu: {
      ...
      calibrate_print_and_cut: '프린트 앤 컷 보정',
