    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          diabled_by_gradient: '이 기능을 사용하기 전에 그라데이션을 비활성화하세요.',
          diabled_by_infilled: '이 기능을 사용하기 전에 인필을 먼저 종료하세요。',
          diabled_by_infilled_and_variable_text: '이 기능을 사용하기 전에 인필과 가변 텍스트를 먼저 종료하세요。',
          diabled_by_variable_text: '이 기능을 사용하기 전에 가변 텍스트를 먼저 종료하세요。',
          disassemble_use: '해체',
          disassembling: '분해 중...',
          edit_path: '경로 편집',
