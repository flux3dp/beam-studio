...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: '위치: 왼쪽 상단에 새겨진 지점에 맞추세요.',
    align_4_1: '위치: 오른쪽 상단에 새겨진 지점에 맞추세요.',
    align_4_2: '위치: 왼쪽 하단에 새겨진 지점에 맞추세요.',
    align_4_3: '위치: 오른쪽 하단에 새겨진 지점에 맞추세요.',
    align_8_0: '위치: 외부 왼쪽 위에 새겨진 점에 맞추십시오.',
    align_8_1: '위치: 외부 오른쪽 위에 새겨진 점에 맞추십시오.',
    align_8_2: '위치: 외부 왼쪽 아래에 새겨진 점에 맞추십시오.',
    align_8_3: '위치: 외부 오른쪽 아래에 새겨진 점에 맞추십시오.',
    align_8_4: '위치: 내부 왼쪽 위에 새겨진 점에 맞추십시오.',
    align_8_5: '위치: 내부 오른쪽 위에 새겨진 점에 맞추십시오.',
    align_8_6: '위치: 내부 왼쪽 아래에 새겨진 점에 맞추십시오.',
    align_8_7: '위치: 내부 오른쪽 아래에 새겨진 점에 맞추십시오.',
    ...
    charuco_open_the_machine_lid: '기계의 뚜껑을 여세요.',
    charuco_place_charuco: '인쇄된 보정 패턴을 작업 영역의 <b>%s</b>에 수평으로 배치하세요.',
    charuco_position_bottom_left: '왼쪽 하단',
    charuco_position_bottom_right: '오른쪽 하단',
    charuco_position_center: '중앙',
    charuco_position_left: '왼쪽',
    charuco_position_right: '오른쪽',
    charuco_position_top_left: '왼쪽 상단',
    charuco_position_top_right: '오른쪽 상단',
    check_checkpoint_data: '체크포인트 데이터',
    check_device_pictures: '장치 사진 확인',
    check_pnp_desc: '보정 결과를 기반으로 이미지를 다시 촬영하고 조각 기준점을 표시했습니다.\n빨간색 마커가 실제 조각 위치와 일치하는지 확인하세요.\n명확한 불일치가 보이면 "재보정"을 클릭하여 다시 시도하세요.',
    ...
    skip: '건너 뛰기',
    solve_pnp_keep_door_closed: '다음 과정 중에는 문을 닫아 두세요. 문이 열리면 시스템이 카메라 위치를 다시 조정하려고 합니다.',
    ...
    solve_pnp_relocate_camera: '레이저 헤드가 아직 수평으로 중앙에 오지 않았다면 "카메라 재배치"를 클릭하세요.',
  ...
  settings: {
    ...
    module_offset_uv_varnish: '바니시 오프셋',
    module_offset_uv_white_ink: '화이트 잉크 오프셋',
    none: '없음',
    normal: '보통',
    notification_off: '끄기',
    notification_on: '켜기',
