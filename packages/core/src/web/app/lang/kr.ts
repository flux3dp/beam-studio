...
const lang: ILang = {
  ...
  beambox: {
    ...
    document_panel: {
      ...
      rotary_mode: '로터리',
      rotary_overlap_size: 'Overlap',
      rotary_scale: '회전 스케일',
      rotary_split_setting: 'Split Setup',
      rotary_split_setting_url: 'Some help center url',
      rotary_split_size: 'Split Size',
      start_from: '에서 시작',
    ...
    popup: {
      ...
      too_fast_for_curve: '3D 곡선 객체가 포함된 레이어에서 너무 높은 속도를 사용하면 조각 정밀도가 떨어질 수 있습니다.\n3D 곡선 객체에서 최적의 결과를 얻으려면 속도를 %(limit)s 이하로 유지하는 것이 좋습니다.',
      too_fast_for_curve_and_constrain: '다음 레이어: %(layers)s가 속도 제한 %(limit)s를 초과했습니다.\n3D 곡선 객체의 조각 속도가 %(limit)s로 제한됩니다. 이 제한은 환경 설정에서 제거할 수 있습니다.',
    ...
    right_panel: {
      laser_panel: {
        ...
        color_strength: '강도',
        cross_hatch: '교차 해칭',
        curve_engraving_speed_contrain_warning: '3D 곡선 객체의 조각 속도가 %(limit)s로 제한됩니다. 환경 설정에서 이 제한을 제거할 수 있습니다.',
  ...
  framing: {
    ...
    rotateaxis_desc: 'Locate the rotation axis.',
    start_task: '작업 시작',
