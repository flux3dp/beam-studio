...
const lang: ILang = {
  ...
  beambox: {
    ...
    material_browser: {
      add_from_layer: {
        attach_to: '附加到材质',
        bucket_hint: '已保存至「我的材质」集合（其他分类），之后可再移动到其他材质。',
        create_new: '创建新材质…',
        new_material_name: '新材质名称',
        preset_name: '参数名称',
        settings_from_layer: '复制自当前图层的设置',
        title: '将当前图层设置保存为参数',
      },
      add_material: '新增材质',
      add_preset: '新增参数',
      ...
      catalog: {
        ...
        presets: {
          cutting: '切割',
          engraving: '雕刻',
          engraving_diode: '雕刻（二极管激光）',
          engraving_fiber: '雕刻（光纤激光）',
          engraving_spray: '雕刻（喷剂）',
          kiss_cut: '半切',
          marking: '打标',
          marking_dark: '深色打标',
          marking_light: '浅色打标',
      ...
      editor: {
        ...
        title_add: '新增材质',
        title_edit: '编辑材质',
        upload_hint: '点击或拖曳照片，将显示于材质目录的大型预览。',
      },
      enable: '启用',
      export: '导出',
      favorites: '收藏',
      from_current_layer: '自当前图层',
      import: '导入',
      machine: '机器',
      manual: '手动',
      manual_settings: '手动设置',
      modified: '应用参数后已手动调整',
      move_to_material: '移动到材质…',
      new_preset_manual: '新增参数…',
      no_materials_in_category: '此分类暂无 %s 适用的材质。',
      no_presets_for_machine: '暂无 %s 适用的参数。',
      no_search_match: '找不到符合「%s」的材质。',
      preset_editor: {
        name: '参数名称',
        name_required: '请输入名称',
        title_edit: '编辑参数',
      ...
      restore_default: '还原 FLUX 默认值',
      result: '搜索结果',
      search_placeholder: '搜索材质、标签、分类…',
      settings_region: '材质目录地区',
      settings_use: '使用材质浏览器',
      showing_bundled: '当前显示内置材质目录',
      state_customized: '已自定义',
      state_default: '默认',
      state_disabled: '已停用',
      state_user: '用户自定义',
      storage_full: '存储空间已满，材质库无法保存。请改用颜色封面，或删除部分材质照片。',
      sure_to_delete_material: '确定要删除此材质与其所有参数吗？',
      sure_to_delete_preset: '确定要删除此参数吗？',
      sure_to_delete_variant: '确定要删除此厚度规格及其参数吗？',
      sure_to_import: '导入将会合并到你的材质库，是否继续？',
      thickness: '厚度',
      title: '材质浏览器',
      variant_exists: '已有相同厚度的规格。',
      variants: '%d 种规格',
    },
  ...
  noun_project_panel: {
    ...
    export_svg_warning: '专案中含有受知识产权法律的保护的元素物件，因此汇出时Beam Studio 会自动帮您排除这类型之物件，您仍可以透过储存场景(.beam 档) 的方式保留您的专案，请问是否要继续汇出？',
    learn_more: '更多资讯',
  ...
  print_and_cut: {
    ...
    calibration: {
      align_desc: '1. 将打印好的校准纸放入工作区，用胶带或美纹纸胶带固定以免滑动，并进行对焦。\n2. 点击“预览并对位”进行相机对位。\n3. 找到定位点后点击“刻划刻度”，以低功率在纸上刻出参考线。',
      aligned: '已检测到定位点，可以开始刻划。',
      auto_read: '以相机读取刻度',
      auto_read_failed: '无法自动读取刻度，请目视判读后输入数值。',
      auto_read_hint: '相机读数可能有 ±2 格的误差，请对照校正纸确认。',
      current_offset: '当前偏移：X %s mm，Y %s mm',
      export_pdf: '导出校准 PDF',
      power: '功率',
      print_desc: '1. 导出校准纸 PDF，校准纸包含四个定位点和两组刻度。\n2. 将校准纸以 100% 比例（实际大小）打印。',
      reading_desc: '1. 找出最长的激光刻线（中线），看它相对于打印的 0 刻线偏向哪一侧。\n2. 向该侧逐格比对，找到激光刻线与打印刻线完全对齐的位置。\n3. 从 0 数到该打印刻线（每 5 格印有数字，其间的刻线请自行计数）。',
      reading_x: 'X 读数',
      reading_y: 'Y 读数',
      scratch: '刻划刻度',
      speed: '速度',
  ...
  topbar: {
    ...
    menu: {
      ...
      calibrate_print_and_cut: '校准打印切割',
