...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    reset_position: '重置位置',
    retake: '重新拍摄',
    retake_tooltip: '在各物件位置重新拍摄照片以提升检测效果',
    retry_with_remove_bg: '移除背景',
    retry_with_remove_bg_tooltip: '移除预览图片背景以提升轮廓检测准确度',
    rotation: '旋转',
    ...
    use_original_image_tooltip: '还原为未移除背景的原始预览图片',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s 点 AI 点数',
      credit_balance: 'AI 点数余额',
      credit_cost: '本次使用',
      description: '通过 AI 模型提升图片分辨率与细节，放大后的图片将取代画布上的原图。',
      done: '生成式放大已完成',
      dpi_recommended: '当前图层 DPI 推荐使用 %dx。',
      dpi_recommended_capped: '当前图层 DPI 推荐使用 %dx，但 %dx 为建议输出尺寸内的最大倍率。',
      failed: '无法完成生成式放大，请检查网络连接后再试一次。',
      insufficient_credit: 'AI 点数不足，无法执行生成式放大。',
      layer_dpi: '图层 DPI',
      original_size: '原始尺寸',
      output_size: '输出尺寸',
      oversize_warning: '输出尺寸（%s）超过建议上限 %dpx x %dpx。处理可能需要数分钟，且结果可能导致 Beam Studio 运行变慢。仍要继续吗？',
      processing: '生成式放大处理中…',
      processing_hint: '实际处理时间依图片大小与网络状况而定',
      recommended: '建议',
      retry: '重试',
      start: '开始放大',
    },
    ...
    popup: {
      ...
      import_stl: {
        advice_message: '导入可能需要较长时间，过程中软件可能没有响应。',
        advice_message_strong: '此模型非常大，强烈建议先简化模型再导入。',
        confirmation_message: '是否继续？',
        face_count_warning: '预估面数：%s（建议：< %s）。',
        file_size_warning: '文件大小：%sMB（建议：< %sMB）。',
        intro_message: '此模型可能过大或过于复杂：',
        scene_face_count_warning: '导入后此文件的总面数：%s（建议：< %s）。',
        title: '文件导入警告',
      },
      import_svg: {
    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_credit_reminder: '按下按钮将立即使用 %s Credit，是否继续？',
          ai_upscale: '生成式放大',
          ai_upscale_short: '生成式放大',
          ai_upscale_too_large: '图片尺寸过大，无法使用 AI 放大，最大支持尺寸为 %dpx x %dpx。',
          array: '阵列',
          auto_fit: '自动适配',
          bevel: '生成斜角',
          brightness: '亮度对比',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: '移动激光头，将红光对准 <b>A 点</b> 的中心。',
    charuco_move_to_point_b: '水平移动激光头，将红光对准 <b>B 点</b> 的中心。',
    ...
    check_pnp_desc: '请确认红色标记是否对齐雕刻位置\n如果没有，请点击"上一步"进行调整。\n如果一切正常，太棒了！🎉',
    ...
    put_charuco: '放置校准图案',
    put_charuco_1: '打印校准图案（A4/Letter）。',
    put_charuco_2: '将其平整粘贴在硬板上。',
    put_charuco_3: '放置于中央并自动对焦。',
    put_charuco_bm2_1: '请将校准图案文件打印在 A4（或 Letter）纸上用于校准。',
    put_charuco_bm2_2: '点击“下一步”并按照指南放置纸张。',
    put_charuco_promark_2: '请确保校准纸清晰可见且无反光。点击"下一步"拍照。',
    put_charuco_promark_desc_1: '请使用附件盒中提供的校准纸，或将以下校准图案打印在 A4 纸上用于相机校准。',
    ...
    put_paper_bm2_4: '点击"开始绘制校正图片"。',
    put_paper_promark: '放置黑色硬纸板',
    put_paper_promark_1: '将配件盒中的黑色硬纸板放置在工作平台上。',
    put_paper_promark_2: '正确调整焦距，然后点击“开始绘制校正图片”以继续。',
  ...
  canvas_control: {
    ...
    canvas_zoom: '画布调整',
    exposure: '曝光值',
    inner_engraving_object_control: '内雕物件控制方式',
    inner_engraving_view_control: '内雕视角控制',
    not_supported: '不支持',
    opacity: '透明度',
  },
  caption: {
  ...
  connection_issue_guide: {
    alert_link: '连接断开？试试这个故障排除方法。',
    connect_computer: {
      content: '您的电脑必须与机器连接至相同的网络。',
      macos_steps: '点击菜单栏上的 Wi-Fi 图标，然后选择您手机的热点。',
      macos_title: 'macOS',
      title: '连接您的电脑',
      windows_steps: '点击任务栏上的网络图标，然后选择您手机的热点。',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: '机器找不到我的热点',
      dont_know_hotspot_name: '我不知道我的热点名称',
      step1: '1. 在机器的触控面板上，前往：网络 → 连接 Wi-Fi。',
      step2: '2. 从 Wi-Fi 列表中找到并选择您手机的热点名称。',
      step3: '3. 输入热点密码并连接。',
      title: '将机器连接至手机热点',
    },
    enter_ip: {
      ...
      placeholder: 'IP 地址',
      step1: '输入您在上一步中找到的 IP 地址。',
      step2: '点击“验证”以测试连接。',
      step3: 'Beam Studio 将检查：',
      title: '输入机器的 IP 地址',
      verify: '验证',
    },
    fail: {
      bullet1: '• 您的机器型号与序列号',
      bullet2: '• 触控面板上显示的 IP 地址',
      bullet3: '• 您遇到的错误描述',
      contact_title: '联系客服时，提供以下信息会有帮助：',
      intro: '别担心 — 这并不一定代表您的机器有问题。可能还有其他因素影响连接。我们的客服团队很乐意协助您找出原因。',
      title: '我们无法完成测试',
    },
    hotspot: {
      android_steps: '设置 → 连接 → 移动热点和网络共享 → 移动热点',
      android_title: 'Android',
      ios_steps: '设置 → 个人热点 → 允许其他人加入',
      ios_title: 'iPhone (iOS)',
      tip: '提示：请使用简单的英文热点名称和数字密码（例如：名称：FLUX_Test   密码：12345678）',
      warning_2_4ghz: '重要：FLUX 机器仅支持 2.4GHz Wi-Fi，请在继续之前将热点设置为 2.4GHz。',
    },
    how_it_works: '测试方式：',
    how_it_works_step1: '1. 将您的手机设置为 Wi-Fi 热点。',
    how_it_works_step2: '2. 将机器连接至热点。',
    how_it_works_step3: '3. 将您的电脑连接至相同的热点。',
    how_it_works_step4: '4. 在 Beam Studio 中测试连接。',
    intro: '让我们运行一个快速测试，检查您的机器是否正常工作。我们会通过您手机的热点连接机器与电脑，以判断问题是出在网络还是机器本身。',
    ip_address: {
      step1: '在机器的触控面板上，前往：\n网络 → 查找“IP 地址”',
      step2: 'IP 地址通常类似：172.20.10.x 或 192.168.x.x\n（取决于您手机的热点）',
      step3: '记下这个 IP 地址，以供下一步使用。',
      title: '查找机器的 IP 地址',
      warning: '如果 IP 地址以 169.254 开头，表示连接失败。请返回步骤 1 重试。',
    },
    success: {
      cause: '您遇到的连接问题很可能是由您的本地网络环境造成的，而非机器本身。',
      intro: '您已成功完成 Wi-Fi 连接测试，做得好！这确认您的 FLUX 机器运行完全正常。',
      recommend1: '• 联系您的互联网服务提供商（ISP）或路由器制造商，协助处理 Wi-Fi 设置',
      recommend2: '• 如果您在学校、办公室或共享工作空间，请咨询您的网络管理员',
      recommend3: '• 确认您的路由器是否支持 2.4GHz，并尝试重新启动',
      recommend_title: '我们的建议：',
      title: '做得好！🎉',
    },
    title: '连接问题？',
  },
  ...
  framing: {
    ...
    material: '材料',
    material_desc: '预览材料的外框，方便在雕刻前对位。',
    repeat: '连续预览',
    rotate_axis: '旋转轴',
  ...
  initialize: {
    ...
    机器 > “Promark 名称” > Promark 设置`,
      ...
      setting_completed_ask_camera_calibration: '已成功完成 Promark 场镜设置！是否要进行相机校准？',
      settings: 'Promark 设置',
    },
    retry: '重试',
  ...
  inner_engraving: {
    auto_fit_message: '模型大于可加工范围，是否缩小至可容纳的尺寸？超出范围的部分无法雕刻。',
    auto_fit_title: '自适应缩放',
    canvas_controls: {
      back: '后视图',
      bottom: '底视图',
      custom: '自定义视角',
    ...
    continue_export: '继续送出工作？',
    disable_mode: '内雕模式无法导入此文件，是否关闭内雕模式并继续导入？',
    enable_mode: 'STL 文件只能在内雕模式下导入，是否开启内雕模式？',
    enable_mode_with_workarea: 'STL 文件只能在内雕模式下导入。是否应用所需的 Promark UV 激光源与 70 × 70 mm 工作区域设置？',
    export_warning_title: '内雕工作检查',
    file_needs_workarea: '此文件使用内雕模式。是否应用所需的 Promark UV 激光源与 70 × 70 mm 工作区域设置？',
    invalid_engraving_area: '没有有效的可雕刻范围。',
    mode_switch_title: '切换画布模式',
    mode_unavailable: '此机型不支持内雕模式。',
    objects_below_previous_layer: '后续图层中有 %(count)s 组物件位于先执行物件的下方。',
    objects_out_of_range: '有 %(count)s 个物件超出可雕刻范围。',
    objects_overlap: '有 %(count)s 组物件彼此重叠。',
    parsing_mesh: '正在解析模型...',
    placing_object: '正在放置对象...',
    reading_file: '正在读取文件...',
  },
  inner_engraving_settings: {
    adaptive_layer_height: '动态层高',
    adaptive_layer_height_hint: '依表面细节，在最小与最大层高之间动态调整切层间距。',
    adjust_hint: '输入数值后按 Enter，依目前的值调整',
    anchor: '参考点',
    bottom_left: '材料左下角',
    center: '材料中心',
    center_on_engravable: '居中于可加工位置',
    center_on_workarea: '居中于工作范围',
    circumference: '圆周',
    depth: '宽',
    diameter: '直径',
    engraving_mode: '雕刻模式',
    euler_order: 'XYZ',
    fill: '填充',
    fit_to_engravable: '自适应',
    flip: '翻转',
    focal_length: '对焦距离',
    focal_length_hint: '镜头的焦距，用于补偿激光在工件内的折射。',
    focus_reminder: '机器无法读取当前 Z 轴位置，开始工作前请先手动将激光对焦至工作平台。',
    height: '高',
    layer_height: '层高',
    layer_height_hint_dot_fill: '打点并填充时，此值为向内缩排的壳层间距。',
    layer_height_hint_line: '打线模式下，此值为固定层间距；开启动态层高后则为最大层高。',
    material_position: '材料位置',
    material_shape: '材料形状',
    material_size: '材料大小',
    min_layer_height: '最小层高',
    min_layer_height_hint: '动态层高使用的最小切层间距，必须小于层高。',
    mode_dot: '打点',
    mode_line: '打线',
    no_engravable_area: '没有可加工范围：安全距离已涵盖整个材料。',
    point_spacing: '点间距',
    position: '位置',
    range: '范围',
    ...
    sphere_base_height_hint: '球体最低点与工作平台之间的高度差。',
    sphere_height_hint: '专用液体表面与工作平台之间的高度差。',
    sphere_liquid_alert: '请将专用液体倒入固定杯中，并确保液面完全淹没雕刻材料。',
    title: '内雕材料设置',
    width: '长',
  },
  ...
  machine_linking: {
    continue: '继续',
    i_have_read: '我已阅读',
    input_birthday_to_link: '请输入您的出生日期以完成设备连接',
    input_birthday_to_link_note: '*用于确认您的年龄是否符合使用资格',
    link_failed: '连结失败。',
    link_failed_already_linked: '此设备目前已连结至其他 FLUX ID，您可以选择继续使用或连结至您的帐号。',
    link_failed_cannot_set_secret: '无法将连结结果存入设备。请确认电脑与设备的连线状态。',
    link_failed_under_age: '您目前不符合使用资格，无法完成设备连接。',
    link_machine: '连结 FLUX ID',
    link_machine_to_account: '已成功连接至 %(name)s，是否要将此设备连结至您的帐号？',
    link_success: '连结成功。',
    link_to_my_flux_id: '连结至我的 FLUX ID',
    privacy_policy: '《隐私政策》',
  ...
  maintenance: {
    ...
    essential: '必要',
    essential_health: '必要项目健康度',
    essential_hint: '计入健康度',
    feedback: {
      checked: '%s 已检查。',
      done: '%s 已完成。下次到期 %s。',
      done_no_date: '%s 已完成。',
      fail_warning: '%s：已标记需更换激光管。打开教程查看步骤。',
      passed: '%s 通过 — 激光管很健康！',
    },
    footer_tip: '小提示：每月雕刻一个示例文件，保持机器健康。',
    history_hint: '每个项目仅保留最近 %s 条记录。',
    intro: '追踪这台机器的每项维护工作，一键标记完成。',
    legend: {
      due_soon: '即将到期',
      overdue: '已逾期',
      up_to_date: '正常',
    ...
    tasks: {
      ...
      fan: {
        keyPoints: '清除通风扇叶片上的灰尘。',
        name: '通风扇清洁',
      },
      fieldlens: {
        keyPoints: '清洁场镜，由中心向外顺时针方向擦拭。',
        name: '场镜清洁',
      },
      honeycomb_plate: {
        keyPoints: '清除蜂窝板格栅上的残渣与焦油。',
        name: '蜂窝板清洁',
      },
      honeycomb_table: {
        keyPoints: '清除蜂窝网上的残渣与焦油。',
        name: '蜂窝板清洁',
      },
      lube: {
        keyPoints: '清洁导杆、线性滑轨与对焦机构，然后重新上润滑油。润滑频率会因切割的材质而异。',
        name: '润滑',
      },
      maintain_test: {
        keyPoints: '检查状态显示与开关。',
      ...
      mirrors_combiner: {
        keyPoints: '清除镜片/反射镜上的脏污；检查氧化情况。请勿残留酒精或水痕。',
        name: '反射镜、聚焦镜与合光镜',
      },
      mirrors_lens: {
        keyPoints: '清洁 4 面反射镜与镜片；确保无氧化或水痕。',
        name: '反射镜与镜片清洁',
      },
      mod_diode: {
        keyPoints: '清洁风扇、聚焦镜与 POGO 针。',
        name: '二极管激光模块',
      },
      mod_ir: {
        keyPoints: '清洁聚焦镜。',
      ...
      optical_inspection: {
        keyPoints: '检查光路；开箱时与更换激光管后也需检查。',
        name: '光路检查',
      },
      optical_unboxing: {
        keyPoints: '确保光路准确。首次开箱时检查。',
        name: '光路检查',
      },
      screen: {
        keyPoints: '清除面板上的灰尘与油污。',
        name: '屏幕清洁',
      },
      tube: {
        keyPoints: '若 3mm 亚克力无法以 70% 功率切割，请更换激光管。',
        name: '激光管健康检查',
      },
      water: {
        keyPoints: '加水至 80% 以上且无气泡。',
        name: '冷却水更换',
      },
      worktable: {
        keyPoints: '将酒精喷在纸巾上，然后擦拭工作台。',
        name: '工作台清洁',
      },
      zaxis: {
        keyPoints: '擦拭 Z 轴柱丝杆，再用棉签均匀涂上润滑油。',
        name: 'Z 轴柱润滑',
      },
    },
    title: '维护检查表',
  ...
  message: {
    ...
    camera: {
      ...
      fail_to_transmit_image: '#845 相机传输照片异常，请将机器重新开机。如果问题持续发生，請參考<a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">此则引导</a>。',
      switching_camera: '切换相机中...',
      wide_angle_open_door: '请打开门盖',
      wide_angle_open_door_text: '切换至广角相机前，请先打开门盖。',
      ws_closed_unexpectedly: '#844 与机器相机的连线无预期的中断。如果问题持续发生，請參考<a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402755805071">此则引导</a>。',
    },
    cancelling: '取消中...',
  ...
  params_label: {
    ...
    layer_name: '图层名称',
    placeholder: '参数标签',
    preview_hint: '此为预览内容，送出工作前会自动更新为当下的图层参数',
    save_as_default: '保存为预设',
    settings: '参数标签设置',
    update: '更新',
    updated: '已更新参数标签',
    use_default: '使用已保存的预设',
    use_recommended: '使用建议项目',
  },
  pass_through: {
    export: '导出到工作区域',
    exporting: '导出中...',
  ...
  print_and_cut: {
    ...
    paper_size: '输出尺寸',
    paper_too_small: '输出范围太小。设计范围（含定位标记）与材料边缘至少需保留 %s mm 边距，以避开打印机无法打印的区域。请选择较大的输出尺寸，否则打印时内容可能被裁切或缩小。',
    preview_and_align: '预览并对位',
    resume_desc: '此设计已完成精准对位的准备。\n请将下一份打印好的材料放入机器并继续进行相机对位，\n若要更换设计、输出尺寸或切割路径，请选择重新开始。',
    resume_title: '继续精准对位',
    select_cut_layer: '切割路径图层',
    start_over: '重新开始',
    step_align: '相机对位',
    step_align_desc: '请将打印好的材料放入机器并执行相机预览。\n系统会自动检测定位标记并将切割线与打印结果对位。\n点击“完成”后会在画布中添加对位后的切割图层，原始设计图层将被隐藏。\n随后即可回到编辑器发送工作。',
    step_export: '导出 PDF 并打印',
    step_export_desc: '导出包含设计与定位标记的 PDF，并以 100%（实际大小）打印。\n请勿使用“缩放至页面”，否则切割路径将与打印结果不符。\n外框切割路径仅供激光切割使用，不会包含在 PDF 中。',
    step_paper: '输出尺寸',
    step_paper_desc: '选择导出 PDF 的输出尺寸。\n设置行数与列数即可在同一份材料上打印并切割多份设计。\n预览会显示输出范围边界。',
    step_setup: '切割路径与定位标记',
    step_setup_desc: '选择切割路径的生成方式：自动生成整体设计的外框轮廓，或使用现有图层作为切割路径。',
    title: '精准对位',
    use_layer_as_cut_path: '使用图层',
    uv_print_file_disabled: '精准对位会打印 UV 打印图层的内容，请先在偏好设定中启用“启用 UV 打印文件”，并将设计加入 UV 打印图层。',
    white_mark_base: '定位标记白色底色',
  },
  ...
  tips: {
    canvas_hold_space_to_pan: '按住 Space 可拖曳整张画布。',
    feature_auto_fit: '相机预览后，可使用「动作 → 自动对位」将物件自动对齐到材料上。',
    feature_box_generator: '使用「生成器 → 盒子生成器」可快速生成自定义尺寸的盒子。',
    feature_code_generator: '使用「生成器 → 条码生成器」可生成 QR Code 与条码。',
    feature_elements: '「元素面板」现在提供超过一百万个图像元素可使用。',
    feature_layer_color_configurations: '可在「编辑 → 图层 → 颜色设置」中设置 SVG 导入时的颜色对应功率与速度。',
    feature_material_test: '使用「左侧工具栏 → 生成器 → 材质测试生成器」快速找到材料的最佳参数。',
    layer_execution_order: '图层顺序即为加工顺序，工作会由上往下执行。',
    machine_clean_mirror: '定期检查反射镜与聚焦镜，必要时请清洁，以避免烟雾沉积。',
    machine_no_unattended_operation: '避免在无人看管的情况下让机器运行。',
    machine_regular_start: '至少每两周启动一次激光工作，有助于延长激光管寿命。',
    object_edit_image_to_erase: '「图片 → 动作 → 编辑图片」可擦除图片中不需要的区域。',
    object_polygon_sides: '在多边形的属性面板中，可以设置边数。',
    object_rounded_rectangle: '在矩形的属性面板中，可以设置圆角矩形的圆角半径。',
    object_sharpen_portrait: '雕刻人像照片时，可使用「图片 → 动作 → 锐化」加强轮廓。',
    settings_auto_save: '在偏好设置中开启「自动保存」，避免编辑内容遗失。',
    settings_default_text_font: '您可在偏好设置中设置文字工具的默认字体。',
    task_focus_lower_for_cutting: '切割时将焦点设在材料表面下方约 2 mm，通常能获得更好的效果。',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 与机器相机建立连线时失败，请重新开启您的机器或是 Beam Studio ，如果此错误持续发生，请参考<a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">此則引導</a>。',
      fail_to_get_door_status: '请确保门盖关闭以进入低激光模式。',
      fail_to_start_preview: '#803 启动相机预览失败，请重新开启您的机器或是 Beam Studio，如果此错误持续发生，请参考<a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">此则引导</a>。',
      ...
      start_preview_timeout: '#803 启动相机预览时超时，请重新开启您的机器或是 Beam Studio ，如果此错误持续发生，请参考<a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">此则引导</a>。',
    ...
    menu: {
      ...
      example_files: '示例文件',
      export_BVG: 'BVG',
      export_calibration_data: '导出校正数据',
      ...
      import_promark_engraving_example_1: 'Promark 雕刻范例 I',
      import_promark_engraving_example_2: 'Promark 雕刻范例 II',
