    ...
    right_panel: {
      ...
      object_panel: {
        ...
        option_panel: {
          ...
          text_transform_lowercase: '小写',
          text_transform_none: '原样',
          text_transform_sentence: '句首大写',
          text_transform_title: '每个单词首字母大写',
          text_transform_toggle: '切换大小写',
          text_transform_uppercase: '大写',
          threshold: '曝光阈值',
          threshold_short: '临界值',
          variable_text: '可变文字',
