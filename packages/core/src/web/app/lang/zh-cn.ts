...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: '位置：对准左上角的雕刻点。',
    align_4_1: '位置：对准右上角的雕刻点。',
    align_4_2: '位置：对准左下角的雕刻点。',
    align_4_3: '位置：对准右下角的雕刻点。',
    align_8_0: '位置：对齐左上角外侧的雕刻点。',
    align_8_1: '位置：对齐右上角外侧的雕刻点。',
    align_8_2: '位置：对齐左下角外侧的雕刻点。',
    align_8_3: '位置：对齐右下角外侧的雕刻点。',
    align_8_4: '位置：对齐左上角内侧的雕刻点。',
    align_8_5: '位置：对齐右上角内侧的雕刻点。',
    align_8_6: '位置：对齐左下角内侧的雕刻点。',
    align_8_7: '位置：对齐右下角内侧的雕刻点。',
    ...
    charuco_open_the_machine_lid: '打开机器盖子。',
    charuco_place_charuco: '请将打印好的标定图水平放置在工作区域的<b>%s</b>。',
    ...
    check_pnp_desc: '我们根据校准结果重新拍摄了图像，并标记了雕刻参考点。\n请检查红色标记是否与实际雕刻点匹配。\n如果发现明显不匹配，请点击“重新校准”再试一次。',
    ...
    skip: '跳過',
    solve_pnp_keep_door_closed: '接下来的流程中请保持门盖关闭。若门盖开启，系统将重新定位相机。',
    solve_pnp_move_platform: '机器将自动向下移动并拍摄另一张照片。请在此过程中不要移动校准纸。',
    solve_pnp_open_the_lid: '请打开門盖以拍照。',
    solve_pnp_relocate_camera: '若激光头尚未水平置中，请点击"重新定位相机"。',
