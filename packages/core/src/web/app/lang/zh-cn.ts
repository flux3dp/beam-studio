    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          diabled_by_gradient: '请先关闭渐层后再使用此功能。',
          diabled_by_infilled: '请先关闭填充后再使用此功能。',
          diabled_by_infilled_and_variable_text: '请先关闭填充和可变文字后再使用此功能。',
          diabled_by_variable_text: '请先关闭可变文字后再使用此功能。',
