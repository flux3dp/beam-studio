...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'Utdatastørrelsen (%s) overstiger anbefalt maksimum på %d × %d px. Behandlingen kan ta flere minutter, og resultatet kan gjøre Beam Studio tregere. Fortsette likevel?',
