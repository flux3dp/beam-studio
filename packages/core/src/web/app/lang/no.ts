  ...
  beambox: {
    ...
    material_browser: {
      ...
      editor: {
        ...
        parent_hint: 'Hvis angitt, vises det som en tykkelsesvariant under det overordnede materialet (ikke i det øverste rutenettet).',
        parent_material: 'Overordnet materiale',
        photo: 'Bilde',
        tags: 'Tagger',
        thickness_inch: 'Tykkelse (tomme)',
        thickness_inch_hint: 'Brøker er tillatt',
