...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Hvordan forbedre nøyaktigheten til deteksjonen?',
    ...
    retake_tooltip: 'Ta kamerabilde på nytt ved hvert objekts posisjon for bedre deteksjon',
    retry_with_remove_bg: 'Fjern bakgrunn',
    retry_with_remove_bg_tooltip: 'Fjern bakgrunn fra forhåndsvisningsbildet for å forbedre konturdeteksjon',
    rotation: 'Roter',
    ...
    use_original_image_tooltip: 'Gjenopprett det originale forhåndsvisningsbildet uten bakgrunnsfjerning',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      credit_balance: 'AI-kredittsaldo',
      credit_cost: 'Brukte AI-kreditter',
      description: 'Øk bildets oppløsning og detaljer med AI. Det oppskalerte bildet erstatter originalen på lerretet.',
      done: 'Generativ oppskalering fullført',
      dpi_recommended: 'Anbefalt for gjeldende lag-DPI: %dx.',
      dpi_recommended_capped: 'Anbefalt for gjeldende lag-DPI: %dx, men %dx er det største innenfor anbefalt utdatastørrelse.',
      failed: 'Generativ oppskalering kunne ikke fullføres. Kontroller nettverkstilkoblingen og prøv igjen.',
      insufficient_credit: 'Ikke nok AI-kreditter til å kjøre generativ oppskalering.',
      layer_dpi: 'Lag-DPI',
      original_size: 'Opprinnelig størrelse',
      output_size: 'Utdatastørrelse',
      oversize_warning: 'Utdatastørrelsen (%s) overstiger anbefalt maksimum på %dpx x %dpx. Behandlingen kan ta flere minutter, og resultatet kan gjøre Beam Studio tregere. Fortsette likevel?',
      processing: 'Skalerer opp…',
      processing_hint: 'Behandlingstiden avhenger av bildestørrelse og nettverksforhold.',
      recommended: 'Anbefalt',
      retry: 'Prøv igjen',
      start: 'Start oppskalering',
    },
    announcement_panel: {
      title: 'Kunngjøring',
    },
    banner: {
      ...
      firmware_warning: {
        message: 'Din %s kjører fastvare v%s, noe som kan påvirke systemstabiliteten. Vi anbefaler å oppdatere til den nyeste versjonen.',
    ...
    left_panel: {
      ...
      label: {
        ...
        preview_precise: 'Presis kameraforhåndsvisning',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Knytt til materiale',
        bucket_hint: 'Lagret i samlingen din “Mine materialer” (Andre). Du kan flytte det til et materiale senere.',
        create_new: 'Opprett nytt materiale…',
        new_material_name: 'Navn på nytt materiale',
        preset_name: 'Navn på forhåndsinnstilling',
        settings_from_layer: 'Innstillinger kopiert fra gjeldende lag',
        title: 'Lagre gjeldende laginnstillinger som forhåndsinnstilling',
      },
      add_material: 'Legg til materiale',
      add_preset: 'Legg til forhåndsinnstilling',
      apply: 'Bruk',
      back_to_catalog: 'Tilbake til katalogen',
      buy_on_shop: 'Kjøp i butikken',
      catalog: {
        materials: {
      ...
      editor: {
        appearance: 'Utseende',
        appearance_hint: 'Ingen bilde? Velg heller en omslagsfarge.',
        category: 'Kategori',
        ...
        photo: 'Bilde',
        tags: 'Tagger',
        title_add: 'Legg til materiale',
        title_edit: 'Rediger materiale',
        upload_hint: 'Klikk eller dra et bilde hit. Stor forhåndsvisning vises i galleriet.',
      },
      enable: 'Aktiver',
      export: 'Eksporter',
      favorites: 'Favoritter',
      from_current_layer: 'Fra gjeldende lag',
      import: 'Importer',
      machine: 'Maskin',
      manual: 'Manuell',
      manual_settings: 'Manuelle innstillinger',
      modified: 'Parametere er endret siden forhåndsinnstillingen ble brukt',
      move_to_material: 'Flytt til materiale…',
      new_preset_manual: 'Ny forhåndsinnstilling…',
      no_materials_in_category: 'Ingen materialer her for %s ennå.',
      no_presets_for_machine: 'Ingen innstillinger for %s ennå.',
      no_search_match: 'Ingen materialer samsvarer med “%s”.',
      preset_editor: {
        name: 'Navn på forhåndsinnstilling',
        name_required: 'Navn er påkrevd',
        title_edit: 'Rediger forhåndsinnstilling',
        title_new: 'Ny forhåndsinnstilling',
      },
      presets: 'Forhåndsinnstillinger',
      recents: 'Nylige',
      recents_empty: 'Nylig brukte materialer vises her.',
      regions: {
        auto: 'Automatisk',
        eu: 'Europa',
        global: 'Global',
      ...
      restore_default: 'Gjenopprett FLUX-standard',
      result: 'Resultat',
      search_placeholder: 'Søk i materialer, tagger, kategorier…',
      settings_region: 'Region for materialkatalog',
      settings_use: 'Bruk materialutforsker',
      showing_bundled: 'Viser innebygd katalog',
      state_customized: 'Tilpasset',
      state_default: 'Standard',
      state_disabled: 'Deaktivert',
      state_user: 'Brukerdefinert',
      storage_full: 'Lagringsplassen er full, materialbiblioteket kunne ikke lagres. Bruk fargeomslag i stedet for bilder.',
      sure_to_delete_material: 'Vil du slette dette materialet og alle forhåndsinnstillingene?',
      sure_to_delete_preset: 'Vil du slette denne forhåndsinnstillingen?',
      sure_to_delete_variant: 'Slette denne tykkelsen og dens forhåndsinnstillinger?',
      sure_to_import: 'Import vil slå filen sammen med materialbiblioteket ditt. Vil du fortsette?',
      thickness: 'Tykkelse',
      title: 'Materialutforsker',
      variant_exists: 'En variant med denne tykkelsen finnes allerede.',
    ...
    right_panel: {
      laser_panel: {
        ...
        high_quality_desc: 'Gjelder bare for fylte vektorgravering og bildeobjekter. Aktivering av dette vil redusere graveringsakselerasjon for finere resultater.',
        ...
        texture_random: 'Tilfeldig',
        texture_stripe: 'Striper',
        times: 'ganger',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Generativ oppskalering',
          ai_upscale_short: 'Oppskalering',
          ai_upscale_too_large: 'Dette bildet er for stort for AI-oppskalering. Maksimal støttet størrelse er %dpx x %dpx.',
          array: 'Matrise',
          ...
          disabled_by_noun_project: 'Denne formen er beskyttet av åndsverkloven, derfor kan ikke banen redigeres.',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Flytt laserhodet for å justere det røde lyset med senteret av <b>punkt A</b>.',
    charuco_move_to_point_b: 'Flytt laserhodet horisontalt for å justere det røde lyset med senteret av <b>punkt B</b>.',
    ...
    check_pnp_desc: 'Sørg for at de røde markørene er justert med graveringspunktene\nHvis ikke, klikk på "Tilbake" for å justere.\nHvis alt ser bra ut, godt jobbet! 🎉',
    ...
    next: 'Neste',
    no_picture_found: '#852 Enheten din har ingen tilgjengelige rå bilder for kalibrering. Vennligst utfør "Kalibrer kamera (Avansert)".',
    ...
    put_charuco: 'Plasser kalibreringsmønster',
    put_charuco_1: 'Skriv ut kalibreringsmønsteret (A4/Letter).',
    put_charuco_2: 'Fest det flatt på en stiv plate.',
    put_charuco_3: 'Plasser i midten og utfør autofokus.',
    put_charuco_bm2_1: 'Skriv ut kalibreringsmønsterfilen på A4- (Letter-størrelse) papir for kalibrering.',
    put_charuco_bm2_2: 'Klikk på “Neste” og følg veiledningen for å plassere papiret.',
    put_charuco_promark_2: "Sørg for at kalibreringspapiret er tydelig synlig uten gjenskinn. Klikk 'Neste' for å ta et bilde.",
    put_charuco_promark_desc_1: 'Bruk kalibreringspapiret fra tilbehørskassen, eller skriv ut følgende kalibreringsmønster på A4‑papir for kamerakalibrering.',
    ...
    put_paper_promark: 'Legg svart papp',
    put_paper_promark_1: 'Plasser den svarte pappen fra tilbehørsboksen på arbeidsplattformen.',
    put_paper_promark_2: 'Juster fokus riktig, og klikk deretter på "Start Gravering" for å fortsette.',
  ...
  cloud_sync: {
    import_config: 'Skyinnstillinger funnet for denne enheten. Vil du importere dem?',
    import_failed: 'Kunne ikke lese skyinnstillinger.',
    sync_config: 'Vil du synkronisere disse innstillingene til skyen?',
    sync_failed: 'Synkronisering av innstillinger til skyen mislyktes.',
    sync_success: 'Innstillinger synkronisert til skyen.',
  },
  code_generator: {
    barcode: 'Strekkode',
    content: 'Innhold',
  ...
  connection_issue_guide: {
    alert_link: 'Kobler den fra? Prøv denne feilsøkingsmetoden.',
    connect_computer: {
      content: 'Datamaskinen din må være på samme nettverk som maskinen.',
      macos_steps: 'Klikk på Wi-Fi-ikonet i menylinjen. Velg deretter telefonens hotspot.',
      macos_title: 'macOS',
      title: 'Koble til datamaskinen din',
      windows_steps: 'Klikk på nettverksikonet på oppgavelinjen. Velg deretter telefonens hotspot.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Maskinen finner ikke hotspotet mitt',
      dont_know_hotspot_name: 'Jeg vet ikke navnet på hotspotet mitt',
      step1: '1. Gå til følgende på maskinens berøringspanel: Nettverk → Koble til Wi-Fi.',
      step2: '2. Finn og velg telefonens hotspot-navn fra Wi-Fi-listen.',
      step3: '3. Skriv inn hotspot-passordet og koble til.',
      title: 'Koble maskinen til telefonens hotspot',
    },
    enter_ip: {
      check_firmware: 'Fastvareversjon',
      check_ip_reachable: 'IP tilgjengelig',
      check_machine_responds: 'Maskinen svarer',
      placeholder: 'IP-adresse',
      step1: 'Skriv inn IP-adressen du fant i forrige trinn.',
      step2: 'Klikk på "Bekreft" for å teste tilkoblingen.',
      step3: 'Beam Studio kontrollerer:',
      title: 'Skriv inn maskinens IP-adresse',
      verify: 'Bekreft',
    },
    fail: {
      bullet1: '• Maskinmodellen og serienummeret ditt',
      bullet2: '• IP-adressen som vises på berøringspanelet',
      bullet3: '• En beskrivelse av feilen du støtte på',
      contact_title: 'Når du kontakter kundestøtte, er det nyttig å ha følgende klart:',
      intro: 'Ikke bekymre deg — dette betyr ikke nødvendigvis at det er noe galt med maskinen din. Det kan være flere faktorer som påvirker tilkoblingen. Kundestøtteteamet vårt er her for å hjelpe deg med å finne ut av det.',
      title: 'Vi kunne ikke fullføre testen',
    },
    hotspot: {
      android_steps: 'Innstillinger → Tilkoblinger → Mobil hotspot og deling → Mobil hotspot',
      android_title: 'Android',
      ios_steps: 'Innstillinger → Personlig hotspot → Tillat andre å koble til',
      ios_title: 'iPhone (iOS)',
      tip: 'Tips: Bruk et enkelt engelsk hotspot-navn og et numerisk passord (f.eks. Navn: FLUX_Test   Passord: 12345678)',
      warning_2_4ghz: 'Viktig: FLUX-maskiner støtter kun 2.4GHz Wi-Fi. Sett hotspotet ditt til 2.4GHz før du fortsetter.',
    },
    how_it_works: 'Slik fungerer testen:',
    how_it_works_step1: '1. Konfigurer telefonen din som et Wi-Fi-hotspot.',
    how_it_works_step2: '2. Koble maskinen til hotspotet.',
    how_it_works_step3: '3. Koble datamaskinen din til det samme hotspotet.',
    how_it_works_step4: '4. Test tilkoblingen i Beam Studio.',
    intro: 'La oss kjøre en rask test for å sjekke om maskinen din fungerer som den skal. Vi kobler maskinen og datamaskinen din via mobiltelefonens hotspot for å avgjøre om problemet ligger i nettverket ditt eller i selve maskinen.',
    ip_address: {
      step1: 'Gå til følgende på maskinens berøringspanel:\nNettverk → Se etter "IP-adresse"',
      step2: 'IP-adressen ser vanligvis slik ut: 172.20.10.x eller 192.168.x.x\n(Dette avhenger av telefonens hotspot)',
      step3: 'Skriv ned denne IP-adressen til neste trinn.',
      title: 'Finn maskinens IP-adresse',
      warning: 'Hvis IP-adressen begynner med 169.254, mislyktes tilkoblingen. Gå tilbake til Trinn 1 og prøv igjen.',
    },
    success: {
      cause: 'Tilkoblingsproblemet du opplevde, skyldes mest sannsynlig det lokale nettverksmiljøet ditt, og ikke selve maskinen.',
      intro: 'Du har fullført Wi-Fi-tilkoblingstesten — bra jobbet! Dette bekrefter at FLUX-maskinen din fungerer helt fint.',
      recommend1: '• Kontakt internettleverandøren din (ISP) eller ruterprodusenten for hjelp med Wi-Fi-innstillingene dine',
      recommend2: '• Spør nettverksadministratoren din hvis du er på en skole, et kontor eller en delt arbeidsplass',
      recommend3: '• Sjekk om ruteren din støtter 2.4GHz, og prøv å starte den på nytt',
      recommend_title: 'Det vi anbefaler:',
      title: 'Bra jobbet! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'Nøkkelringgenerator',
    material_test_generator: 'Materialtestgenerator',
    puzzle_generator: 'Puslespillgenerator',
    title: 'Generatorer',
  },
  generic_error: {
  ...
  initialize: {
    ...
    select_promark: 'Velg din Promark',
    setting_completed: {
      back: 'Tilbake',
  ...
  keychain_generator: {
    ...
    text_options: {
      ...
      font_settings: 'Skriftinnstillinger',
      font_size: 'Skriftstørrelse',
  ...
  machine_linking: {
    continue: 'Fortsett',
    i_have_read: 'Jeg har lest',
    input_birthday_to_link: 'Skriv inn fødselsdatoen din for å fullføre enhetstilknytning',
    input_birthday_to_link_note: '*Brukes til å bekrefte om alderen din oppfyller kvalifikasjonskravene',
    link_failed: 'Tilknytning mislyktes.',
    link_failed_already_linked: 'Denne enheten er for øyeblikket knyttet til en annen FLUX ID. Du kan fortsette å bruke den eller knytte den til kontoen din.',
    link_failed_cannot_set_secret: 'Kan ikke lagre tilknytningsinformasjon på enheten. Kontroller tilkoblingen mellom datamaskinen og enheten.',
    link_failed_under_age: 'Du oppfyller for øyeblikket ikke kravene for å bruke denne tjenesten og kan ikke fullføre enhetstilknytningen.',
    link_machine: 'Knytt FLUX ID',
    link_machine_to_account: 'Tilkoblet %(name)s. Vil du knytte denne enheten til kontoen din?',
    link_success: 'Tilknytning vellykket.',
    link_to_my_flux_id: 'Knytt til min FLUX ID',
    privacy_policy: 'Personvernregler',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Knytter…',
    use_without_linking: 'Bruk uten å knytte',
  },
  machine_status: {
    '-17': 'Patron IO-modus',
  ...
  maintenance: {
    actions: {
      ...
      fail: 'Ikke bestått',
      history: 'Historikk',
      open_guide: 'Åpne guide',
      pass: 'Bestått',
      print: 'Skriv ut / PDF',
    },
    areas: {
      back_cover: 'Bakdeksel',
      modules: 'Moduler',
      optics: 'Optikk',
      panel: 'Panel',
      working_area: 'Arbeidsområde',
    },
    cadence: {
      by_material: 'Etter materiale',
      condition: 'Ved behov',
      day: 'Hver dag',
      days: 'Hver %s dag',
      each_operation: 'Hver bruk',
      every_1_2_weeks: 'Hver 1–2 uker',
      month: 'Hver måned',
      months: 'Hver %s måned',
      upon_unboxing: 'Ved første utpakking',
      week: 'Hver uke',
      weeks: 'Hver %s uke',
    },
    celebration: {
    ...
    feedback: {
      ...
      fail_warning: '%s: merket for rørbytte. Åpne guiden for fremgangsmåten.',
      passed: '%s bestått — laserrøret er i god stand!',
    },
    footer_tip: 'Tips: Graver en prøvefil hver måned for å holde maskinen i god stand.',
    history_hint: 'Bare de %s nyeste oppføringene beholdes for hver oppgave.',
    intro: 'Følg med på hver vedlikeholdsoppgave for denne maskinen, og merk den som utført med ett klikk.',
    legend: {
      due_soon: 'Snart forfall',
      overdue: 'Forfalt',
    ...
    status: {
      ...
      healthy: 'God stand',
      last: 'Sist utført',
      never_done: 'Aldri utført',
      next: 'Neste forfall',
      not_checked: 'Ikke sjekket',
      not_logged: 'Ikke registrert',
      overdue: 'Forfalt',
      replace_tube: 'Bytt laserrør',
    },
    tasks: {
      align: {
        keyPoints: 'Juster når den optiske banen er feiljustert.',
        name: 'Justering av optisk bane',
      },
      chassis: {
        keyPoints: 'Fjern rester og tjæreolje fra chassiset og bunndekselet.',
        name: 'Rengjøring av chassis',
      },
      door: {
        keyPoints: 'Fjern fett fra dørdekselet.',
        name: 'Rengjøring av dørdeksel',
      },
      exhaust: {
        keyPoints: 'Fjern støv fra viftebladene.',
        name: 'Rengjøring av avtrekksvifte',
      },
      fan: {
        keyPoints: 'Fjern støv fra ventilasjonsviftens blader.',
        name: 'Rengjøring av ventilasjonsvifte',
      },
      fieldlens: {
        keyPoints: 'Rengjør feltlinsen ved å tørke fra midten og utover med klokken.',
        name: 'Rengjøring av feltlinse',
      },
      honeycomb_plate: {
        keyPoints: 'Fjern rester og tjære fra rutene i bikakeplaten.',
        name: 'Rengjøring av bikakeplate',
      },
      honeycomb_table: {
        keyPoints: 'Fjern rester og tjæreolje fra bikakenettet.',
      ...
      maintain_test: {
        keyPoints: 'Kontroller statusvisningen og bryterne.',
        name: 'MAINTAIN-siden',
      },
      mirrors_combiner: {
        keyPoints: 'Fjern smuss fra linser/speil, og se etter oksidering. Ingen alkohol- eller vannmerker skal være igjen.',
        name: 'Speil, fokuseringslinse og strålekombinerer',
      },
      mirrors_lens: {
        keyPoints: 'Rengjør de 4 speilene og linsen, og sørg for at det ikke er oksidering eller vannmerker.',
        name: 'Rengjøring av speil og linse',
      },
      mod_diode: {
        keyPoints: 'Rengjør viften, fokuseringslinsen og POGO pin.',
        name: 'Diodelasermodul',
      },
      mod_ir: {
        keyPoints: 'Rengjør fokuseringslinsen.',
        name: 'Infrarød lasermodul',
      },
      optical_inspection: {
        keyPoints: 'Inspiser den optiske banen, også ved utpakking og etter rørbytte.',
        name: 'Inspeksjon av optisk bane',
      },
      optical_unboxing: {
        keyPoints: 'Sørg for at den optiske banen er nøyaktig. Kontroller ved første utpakking.',
        name: 'Inspeksjon av optisk bane',
      },
      screen: {
        keyPoints: 'Fjern støv og fett på panelet.',
        name: 'Rengjøring av skjerm',
      },
      tube: {
        keyPoints: 'Hvis 3 mm akryl ikke kan kuttes ved 70% effekt, bytt laserrøret.',
        name: 'Helsesjekk av laserrør',
      },
      water: {
        keyPoints: 'Fyll på vann til over 80% fullt, uten luftbobler.',
        name: 'Bytte av kjølevann',
      },
      worktable: {
        keyPoints: 'Spray alkohol på et papir, og tørk deretter av arbeidsbordet.',
        name: 'Rengjøring av arbeidsbord',
      },
      zaxis: {
        keyPoints: 'Tørk av skruen i Z-aksesøylen, og påfør deretter smøremiddel jevnt med en bomullspinne.',
        name: 'Smøring av Z-aksesøyle',
      },
    },
    title: 'Vedlikeholdssjekkliste',
  },
  ...
  message: {
    ...
    camera: {
      ...
      calibration_data_missing_message: 'Kamerakalibreringsdataene mangler.\nImporter de lagrede kalibreringsdataene dine eller utfør kamerakalibrering.',
      ...
      wide_angle_open_door: 'Åpne dørdekselet',
      wide_angle_open_door_text: 'Åpne dørdekselet før du bytter til vidvinkelkameraet.',
  ...
  monitor: {
    ...
    USER_OPERATION_CARTRIDGE_INK_EMPTY: 'Patron tom\nPatronen er tom for blekk. Bytt patronen for å fortsette utskriften.',
    USER_OPERATION_CARTRIDGE_INK_LOW: 'Lavt blekknivå\nBlekket i patronen er i ferd med å gå tomt. Vi anbefaler å bytte patronen snart.',
    ...
    USER_OPERATION_USER_Z_AXIS_CHECK_REQUIRED: 'Fokuspåminnelse\nFokuser på nytt før du starter en ny jobb for å sikre nøyaktige resultater.',
  },
  my_cloud: {
    action: {
  ...
  params_label: {
    ...
    preview_hint: 'Dette er en forhåndsvisning. Tekstinnholdet oppdateres automatisk før en jobb sendes',
    save_as_default: 'Lagre som standard',
    settings: 'Innstillinger for parameteretikett',
    update: 'Oppdater',
    updated: 'Parameteretikett oppdatert',
    use_default: 'Bruk lagret standard',
    use_recommended: 'Bruk anbefalte',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      calculating: 'Beregner…',
      capturing: 'Tar bilde',
      completing: 'Fullfører snart',
      detecting: 'Oppdager justeringsmerker',
      locating: 'Finner justeringsmerker',
      preparing: 'Forbereder kameraet',
      refining: 'Finjusterer merkenes posisjon',
    },
    alignment: {
      detect_failed: 'Det ble ikke oppdaget nok justeringsmerker. Ta kameraforhåndsvisningen på nytt, og prøv igjen.',
      fit_error: 'Tilpasningsfeil (X / Y)',
    ...
    calibration: {
      align_desc: '1. Legg det utskrevne kalibreringsarket i arbeidsområdet, fest det med tape eller maskeringstape så det ikke sklir, og fokuser.\n2. Klikk på «Forhåndsvis og juster» for å kjøre kamerajusteringen.\n3. Når merkene er funnet, klikker du på «Riss skalaer» for å risse referanselinjene på arket med lav effekt.',
      aligned: 'Justeringsmerker funnet. Klar til å risse.',
      auto_read: 'Les av skalaer med kamera',
      auto_read_failed: 'Skalaene kunne ikke leses av automatisk. Les dem av med øyet og skriv inn verdiene.',
      auto_read_hint: 'Kameraavlesningen kan avvike med opptil ±2; kontroller den mot arket.',
      current_offset: 'Nåværende forskyvning: X %s mm, Y %s mm',
      export_pdf: 'Eksporter kalibrerings-PDF',
      power: 'Effekt',
      print_desc: '1. Eksporter PDF-en med kalibreringsarket. Den inneholder de fire justeringsmerkene og to skalaer.\n2. Skriv ut arket i 100 % (faktisk størrelse).',
      reading_desc: '1. Finn den lengste rissede linjen (den midterste), og merk deg hvilken side av den utskrevne 0-linjen den ligger på.\n2. Gå linje for linje mot den siden til en risset linje og en utskrevet linje flukter nøyaktig.\n3. Tell fra 0 til den utskrevne linjen (tall er skrevet ut ved hver 5. linje; tell også de unummererte linjene imellom).',
      reading_x: 'X-avlesning',
      reading_y: 'Y-avlesning',
      scratch: 'Riss skalaer',
      speed: 'Hastighet',
      title: 'Skriv ut og skjær-kalibrering',
    },
    ...
    finish: 'Fullfør',
    fit_content: 'Tilpass til innhold',
    generate_from_contour: 'Generer fra kontur',
    grid_columns: 'Kolonner',
    grid_rows: 'Rader',
    grid_spacing: 'Mellomrom (mm)',
    no_content: 'Det er ikke noe innhold i UV-utskriftslagene. Legg designet ditt til et UV-utskriftslag før du bruker Skriv ut og skjær.',
    no_layer_with_path: 'Ingen laserlag inneholder en vektorbane. Forbered et laserlag med skjærebanen for å bruke det som kontur.',
    no_uv_layer: 'Fant ikke noe UV-utskriftslag. Endre modulen til designlaget ditt til "UV-utskrift" for å bruke Skriv ut og skjær.',
    open_preferences: 'Åpne innstillinger',
    orientation: 'Retning',
    orientation_landscape: 'Liggende',
    orientation_portrait: 'Stående',
    paper_size: 'Utdatastørrelse',
    paper_too_small: 'Utdataområdet er for lite. Designet (inkludert justeringsmerker) trenger minst %s mm marg fra materialkanten for å holde seg innenfor skriverens utskrivbare område. Velg en større utdatastørrelse, ellers blir utskriften beskåret eller forminsket.',
    preview_and_align: 'Forhåndsvis og juster',
    resume_desc: 'Dette designet er allerede forberedt for Skriv ut og skjær.\nLegg det neste utskrevne materialet i maskinen og fortsett til kamerajustering, eller start på nytt for å endre design, utdatastørrelse eller skjærebane.',
    resume_title: 'Gjenoppta Skriv ut og skjær',
    select_cut_layer: 'Lag med skjærebane',
    start_over: 'Start på nytt',
    step_align: 'Kamerajustering',
    step_align_desc: 'Legg det utskrevne materialet i maskinen og kjør en kameraforhåndsvisning.\nMerkene oppdages, og skjærelinjene justeres automatisk etter utskriften.\nKlikk på «Fullfør» for å legge det justerte skjærelaget til lerretet; de opprinnelige designlagene skjules.\nSend deretter oppgaven fra redigeringsprogrammet.',
    step_export: 'Eksporter og skriv ut PDF',
    step_export_desc: 'Eksporter en PDF med designet ditt og justeringsmerkene, og skriv den ut på skriveren i 100 % skala (faktisk størrelse).\nIkke bruk «Tilpass til side», ellers vil ikke skjærebanen samsvare med utskriften.\nDe forskjøvne skjærebanene er ikke inkludert, siden de bare brukes av laserkutteren.',
    step_paper: 'Utdatastørrelse',
    step_paper_desc: 'Velg utdatastørrelsen for den eksporterte PDF-en.\nAngi rader og kolonner for å skrive ut og skjære flere kopier av designet ditt på ett stykke materiale.\nForhåndsvisningen viser utdatagrensen rundt innholdet.',
    step_setup: 'Skjærebaner og merker',
    ...
    uv_print_file_disabled: 'Skriv ut og skjær skriver ut innholdet i UV-utskriftslagene. Aktiver "Aktiver UV-utskriftsfil" i innstillingene, og legg deretter designet ditt til et UV-utskriftslag.',
  ...
  puzzle_generator: {
    ...
    board_radius: 'Rammeradius',
    board_width: 'Rammebredde',
    change_image: 'Klikk for å endre bilde',
    columns: 'Kolonner',
    design_preview: 'Designforhåndsvisning',
    exploded_view: 'Eksplodert visning',
    export_as: 'Eksporter som',
    export_engrave: 'Graveringslag',
    export_failed: 'Kunne ikke importere puslespill til lerret. Prøv igjen eller juster puslespillinnstillinger.',
    export_none: 'Ingen',
    export_print: 'Utskriftslag',
    file_too_large: 'Den valgte filen overskrider maksimalt tillatt størrelse.',
    guide_lines: 'Hjelpelinjer',
    heart_sharpness: 'Spissskarphet',
    image: 'Bilde',
    ...
    preview_placeholder: 'Puslespillforhåndsvisning',
    puzzle_board: 'Puslespillbrett',
    puzzle_pieces: 'Puslespillbrikker',
    radius: 'Radius',
    raised_edges: 'Hevede kanter',
    reset_to_default: 'Tilbakestill til standard',
    rows: 'Rader',
    switch_type_warning: 'Dine nåværende innstillinger er ikke importert til lerretet ennå.\nBytte av puslespilltype vil tilbakestille alle innstillinger til standardverdier.',
    tab_size: 'Fanestørrelse',
    types: {
      circle_jigsaw: 'Rundt puslespill',
      heart_jigsaw: 'Hjerteformet puslespill',
      hex_jigsaw: 'Sekskant puslespill',
      rectangle_jigsaw: 'Rektangulært puslespill',
    },
    unsupported_file_type: 'Ikke-støttet filtype. Bruk JPG, PNG eller WebP.',
    upload_hint: 'JPG, PNG, WebP (maks 10MB)',
    upload_image: 'Klikk eller dra for å laste opp',
    zoom: 'Zoom',
  },
  qr_code_generator: {
  ...
  tips: {
    canvas_hold_space_to_pan: 'Hold mellomromstasten og dra for å panorere over lerretet.',
    feature_auto_fit: 'Etter kameraforhåndsvisning, bruk Handlinger → Auto Fit for automatisk å plassere objekter på materialet ditt.',
    feature_box_generator: 'Bruk Generatorer → Boksegenerator for å lage esker i tilpasset størrelse på sekunder.',
    feature_code_generator: 'Bruk Generatorer → Strekkodegenerator for å lage QR-koder og strekkoder.',
    feature_elements: 'Elements-panelet inneholder nå over en million grafikk klare til bruk.',
    feature_layer_color_configurations: 'Koble SVG-lagfarger til hastighet og effekt via Rediger → Lag → Fargeinnstillinger.',
    feature_material_test: 'Bruk Generatorer → Materialtestgenerator i venstre verktøylinje for raskt å finne de beste innstillingene for et materiale.',
    layer_execution_order: 'Lagrekkefølgen bestemmer jobbrekkefølgen. Jobber kjører fra topp til bunn.',
    machine_clean_mirror: 'Kontroller speilene og fokuseringslinsen regelmessig og rengjør dem ved behov for å forhindre røykopphopning.',
    machine_no_unattended_operation: 'La aldri maskinen kjøre uten tilsyn.',
    machine_regular_start: 'Kjør en laserjobb minst én gang hver annen uke for å bidra til å forlenge laserrørets levetid.',
    object_edit_image_to_erase: 'Bruk Bilde → Handlinger → Rediger bilde for å slette uønskede områder i et bilde.',
    object_polygon_sides: 'Juster antall sider i polygonets egenskapspanel.',
    object_rounded_rectangle: 'Sett hjørneradius for et avrundet rektangel i rektanglets egenskapspanel.',
    object_sharpen_portrait: 'Forbedre portrettgraveringer med Bilde → Handlinger → Skjerpe.',
    settings_auto_save: 'Aktiver Autolagre i Innstillinger for å unngå å miste arbeidet ditt.',
    settings_default_text_font: 'Du kan angi standardfonten for tekstverktøyet i Innstillinger.',
    task_focus_lower_for_cutting: 'For tykkere materialer kan fokusering ca. 2 mm under overflaten forbedre skjæringsresultatene.',
  ...
  topbar: {
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Kalibrer Skriv ut og skjær',
      ...
      machines: 'Maskiner',
      maintenance_checklist: 'Vedlikeholdssjekkliste',
      ...
      tab_path_edit: 'Stibane redigering',
      tools: {
        title: 'Verktøy',
      },
