...
const lang: ILang = {
  ...
  settings: {
    ...
    curve_engraving_speed_limit: 'Hastighetsgrense for 3D-kurve',
  ...
  z_speed_limit_test: {
    alert_before: 'Før du starter 3D-kurvegravering, vil systemet utføre en belastningstest for å forhindre tap av trinn på grunn av overflødig vekt.',
