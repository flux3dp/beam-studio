...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Å bruke for høy hastighet på lag som inneholder 3D-kurveobjekter kan redusere graveringens presisjon.\nVi anbefaler å holde hastigheten under %(limit)s for optimale resultater med 3D-kurveobjekter.',
      too_fast_for_curve_and_constrain: 'Følgende lag: %(layers)s overstiger hastighetsgrensen på %(limit)s.\nGraveringshastigheten for 3D-kurveobjekter vil bli begrenset til %(limit)s. Du kan fjerne denne begrensningen i Innstillinger.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'Graveringshastigheten for 3D-kurveobjekter vil bli begrenset til %(limit)s. Du kan fjerne denne begrensningen i Preferanseinnstillingene.',
  ...
  framing: {
    ...
    frame_preview_warning: 'Rammeforhåndsvisningen vil rotere én gang. Unngå å stoppe midtveis for å forhindre feiljustering av markeringsposisjonen. For å forhåndsvise på nytt, vent til rotasjonen er ferdig før du klikker igjen.',
    framing: 'Innramming',
