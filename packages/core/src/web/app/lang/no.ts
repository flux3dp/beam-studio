...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Posisjon: Juster etter det graverte punktet øverst til venstre.',
    align_4_1: 'Posisjon: Juster etter det graverte punktet øverst til høyre.',
    align_4_2: 'Posisjon: Juster etter det graverte punktet nederst til venstre.',
    align_4_3: 'Posisjon: Juster etter det graverte punktet nederst til høyre.',
    align_8_0: 'Posisjon: Juster med det graverte punktet øverst til venstre på utsiden.',
    align_8_1: 'Posisjon: Juster med det graverte punktet øverst til høyre på utsiden.',
    align_8_2: 'Posisjon: Juster med det graverte punktet nederst til venstre på utsiden.',
    align_8_3: 'Posisjon: Juster med det graverte punktet nederst til høyre på utsiden.',
    align_8_4: 'Posisjon: Juster med det graverte punktet øverst til venstre på innsiden.',
    align_8_5: 'Posisjon: Juster med det graverte punktet øverst til høyre på innsiden.',
    align_8_6: 'Posisjon: Juster med det graverte punktet nederst til venstre på innsiden.',
    align_8_7: 'Posisjon: Juster med det graverte punktet nederst til høyre på innsiden.',
    ...
    charuco_open_the_machine_lid: 'Åpne maskinlokket.',
    charuco_place_charuco: 'Plasser det utskrevne kalibreringsmønsteret horisontalt på <b>%s</b> av arbeidsområdet.',
    charuco_position_bottom_left: 'nederst til venstre',
    charuco_position_bottom_right: 'nederst til høyre',
    charuco_position_center: 'midt',
    charuco_position_left: 'venstre',
    charuco_position_right: 'høyre',
    charuco_position_top_left: 'øverst til venstre',
    charuco_position_top_right: 'øverst til høyre',
    check_checkpoint_data: 'Kontrollpunktdata',
    check_device_pictures: 'Sjekk enhetsbilder',
    check_pnp_desc: 'Vi har tatt bildene på nytt basert på kalibreringsresultatene og merket graveringsreferansepunktene.\nVennligst sjekk om de røde markørene samsvarer med de faktiske graveringspunktene.\nHvis du ser noen åpenbare avvik, klikk på "Kalibrer på nytt" for å prøve igjen.',
    ...
    solve_pnp_keep_door_closed: 'Hold døren lukket under den følgende prosessen. Hvis døren åpnes, vil systemet forsøke å flytte kameraet på nytt.',
    ...
    solve_pnp_relocate_camera: 'Klikk på "Flytt kamera" hvis laserhodet fortsatt ikke er sentrert horisontalt.',
  ...
  layer_module: {
    ...
    notification: {
      ...
      importedDocumentContainsPrinting4C: 'Dokumentet inneholder utskriftslag (4C), vil du endre arbeidsområde til beamo II?',
  ...
  settings: {
    ...
    module_offset_4c: 'Utskriftsforskyvning (4C)',
    ...
    module_offset_uv_varnish: 'Lakkforskyvning',
    module_offset_uv_white_ink: 'Hvit blekkforskyvning',
    none: 'Ingen',
    normal: 'Normal',
    notification_off: 'Av',
    notification_on: 'På',
  ...
  topbar: {
    ...
    menu: {
      ...
      import_beamo_2_printing_example_full: 'Eksempel på beamo II-utskrift - Fullfarge',
