...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'Rozmiar wyjściowy (%s) przekracza zalecane maksimum %d × %d px. Przetwarzanie może potrwać kilka minut, a wynik może spowolnić Beam Studio. Kontynuować mimo to?',
