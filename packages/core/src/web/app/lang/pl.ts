    ...
    material_browser: {
      ...
      catalog: {
        materials: {
          ...
          brass: 'Mosiądz',
          canvas: 'Płótno',
          canvas_fabric: 'Tkanina płócienna',
          cardboard: 'Tektura',
          cardstock: 'Karton',
          copper: 'Miedź',
          cork: 'Korek',
        ...
        presets: {
          ...
          engraving_quality: 'Grawerowanie (jakość)',
      ...
      editor: {
        ...
        parent_hint: 'Jeśli zostanie ustawiony, materiał pojawi się jako wariant grubości w materiale nadrzędnym (nie w głównej siatce).',
        parent_material: 'Materiał nadrzędny',
        photo: 'Zdjęcie',
        tags: 'Tagi',
        thickness_inch: 'Grubość (cale)',
        thickness_inch_hint: 'Można wpisać ułamek',
