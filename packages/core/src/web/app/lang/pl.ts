...
const lang: ILang = {
  ...
  beambox: {
    ...
    tool_panels: {
      ...
      _offset: { corner_type: 'Narożniki', direction: 'Kierunek przesunięcia', dist: 'Odległość przesunięcia', expand: 'Rozwinięcie', fail_message: 'Nie udało się przesunąć ścieżki obiektów.', inward: 'Na zewnątrz', not_support_message: 'Wybrane elementy zawierają nieobsługiwany tag SVG: Obraz, Grupę, Tekst i Zaimportowany obiekt. ', outward: 'Do wewnątrz', round: 'Okrągłe', sharp: 'Ostre', shrink: 'Zwinięcie' },
