...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    font_size: 'Rozmiar czcionki',
    hole: 'Otwór',
    hole_diameter: 'Średnica',
    hole_offset: 'Przesunięcie',
    hole_position: 'Pozycja',
    hole_thickness: 'Grubość',
    hole_type: 'Typ',
    hole_type_punch: 'Otwór',
    ...
    position_ref: 'Pozycja',
    position_ref_bottom_center: 'Dół',
    position_ref_left_center: 'Lewo',
    position_ref_right_center: 'Prawo',
    position_ref_top_center: 'Góra',
