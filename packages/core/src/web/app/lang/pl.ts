...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_1: 'Wydrukuj szachownicę (A4/Letter).',
    put_chessboard_2: 'Przyklej ją płasko na sztywnej tablicy.',
    put_chessboard_3: 'Umieść na środku i wykonaj autofokus.',
