...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Używanie zbyt wysokiej prędkości dla warstw zawierających obiekty 3D krzywych może obniżyć precyzję grawerowania.\nZalecamy utrzymanie prędkości poniżej %(limit)s dla optymalnych rezultatów z obiektami 3D krzywych.',
      too_fast_for_curve_and_constrain: 'Następujące warstwy: %(layers)s przekraczają limit prędkości %(limit)s.\nPrędkość grawerowania dla obiektów 3D krzywych zostanie ograniczona do %(limit)s. Możesz usunąć to ograniczenie w Ustawieniach Preferencji.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'Prędkość grawerowania obiektów 3D krzywej zostanie ograniczona do %(limit)s. Możesz usunąć to ograniczenie w Ustawieniach preferencji.',
