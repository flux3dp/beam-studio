...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Jak poprawić dokładność wykrywania?',
    ...
    retake_tooltip: 'Ponowne zdjęcie z kamery na pozycji każdego obiektu dla lepszej detekcji',
    retry_with_remove_bg: 'Usuń tło',
    retry_with_remove_bg_tooltip: 'Usuń tło z obrazu podglądu, aby poprawić wykrywanie konturów',
    rotation: 'Obróć',
    ...
    use_original_image_tooltip: 'Przywróć oryginalny obraz podglądu bez usuwania tła',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s kredytów AI',
      credit_balance: 'Saldo kredytów AI',
      credit_cost: 'Zużyte kredyty AI',
      description: 'Zwiększ rozdzielczość i szczegółowość obrazu za pomocą AI. Przeskalowany obraz zastąpi oryginał na płótnie.',
      done: 'Generatywne skalowanie zakończone',
      dpi_recommended: 'Zalecane dla bieżącego DPI warstwy: %dx.',
      dpi_recommended_capped: 'Zalecane dla bieżącego DPI warstwy: %dx, ale %dx to maksimum w zalecanym rozmiarze wyjściowym.',
      failed: 'Nie udało się ukończyć generatywnego skalowania. Sprawdź połączenie sieciowe i spróbuj ponownie.',
      insufficient_credit: 'Za mało kredytów AI, aby uruchomić generatywne skalowanie.',
      layer_dpi: 'DPI warstwy',
      original_size: 'Rozmiar oryginalny',
      output_size: 'Rozmiar wyjściowy',
      oversize_warning: 'Rozmiar wyjściowy (%s) przekracza zalecane maksimum %dpx x %dpx. Przetwarzanie może potrwać kilka minut, a wynik może spowolnić Beam Studio. Kontynuować mimo to?',
      processing: 'Skalowanie…',
      processing_hint: 'Czas przetwarzania zależy od rozmiaru obrazu i stanu sieci.',
      recommended: 'Zalecane',
      retry: 'Ponów',
      start: 'Rozpocznij skalowanie',
    },
    announcement_panel: {
      title: 'Ogłoszenie',
    },
    ...
    document_panel: {
      ...
      prespray_times: 'Liczba czyszczeń',
    ...
    left_panel: {
      ...
      label: {
        ...
        preview_precise: 'Precyzyjny podgląd kamery',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Przypisz do materiału',
        bucket_hint: 'Zapisano w Twojej kolekcji „Moje materiały” (Inne). Możesz później przenieść to ustawienie do materiału.',
        create_new: 'Utwórz nowy materiał…',
        new_material_name: 'Nazwa nowego materiału',
        preset_name: 'Nazwa ustawienia wstępnego',
        settings_from_layer: 'Ustawienia skopiowane z bieżącej warstwy',
        title: 'Zapisz ustawienia bieżącej warstwy jako ustawienie wstępne',
      },
      add_material: 'Dodaj materiał',
      add_preset: 'Dodaj ustawienie wstępne',
      apply: 'Zastosuj',
      back_to_catalog: 'Powrót do katalogu',
      buy_on_shop: 'Kup w sklepie',
      catalog: {
        materials: {
        ...
        presets: {
          ...
          engraving_diode: 'Grawerowanie (dioda)',
          engraving_fiber: 'Grawerowanie (światłowód)',
          engraving_spray: 'Grawerowanie (spray)',
          kiss_cut: 'Nacięcie (Kiss Cut)',
          marking: 'Znakowanie',
          marking_dark: 'Ciemne znakowanie',
          marking_light: 'Jasne znakowanie',
          printing: 'Drukowanie',
          printing_fabric: 'Drukowanie (tkanina)',
        },
      },
      categories: {
        acrylic: 'Akryle',
      ...
      editor: {
        appearance: 'Wygląd',
        appearance_hint: 'Brak zdjęcia? Wybierz zamiast niego kolor okładki.',
        category: 'Kategoria',
        ...
        photo: 'Zdjęcie',
        tags: 'Tagi',
        title_add: 'Dodaj materiał',
        title_edit: 'Edytuj materiał',
        upload_hint: 'Kliknij lub przeciągnij zdjęcie. W galerii wyświetlany jest duży podgląd.',
      },
      enable: 'Włącz',
      export: 'Eksportuj',
      favorites: 'Ulubione',
      from_current_layer: 'Z bieżącej warstwy',
      import: 'Importuj',
      machine: 'Urządzenie',
      manual: 'Ręcznie',
      manual_settings: 'Ustawienia ręczne',
      modified: 'Parametry zostały zmienione od zastosowania ustawienia wstępnego',
      move_to_material: 'Przenieś do materiału…',
      new_preset_manual: 'Nowe ustawienie wstępne…',
      no_materials_in_category: 'Nie ma tu jeszcze materiałów dla %s.',
      no_presets_for_machine: 'Nie ma jeszcze ustawień dla %s.',
      no_search_match: 'Żaden materiał nie pasuje do „%s”.',
      preset_editor: {
        name: 'Nazwa ustawienia wstępnego',
        name_required: 'Nazwa jest wymagana',
        title_edit: 'Edytuj ustawienie wstępne',
        title_new: 'Nowe ustawienie wstępne',
      },
      presets: 'Ustawienia wstępne',
      recents: 'Ostatnio używane',
      recents_empty: 'Ostatnio zastosowane materiały pojawią się tutaj.',
      regions: {
        auto: 'Automatycznie',
        eu: 'Europa',
        global: 'Globalny',
      ...
      restore_default: 'Przywróć domyślne ustawienia FLUX',
      result: 'Wynik',
      search_placeholder: 'Szukaj materiałów, tagów, kategorii…',
      settings_region: 'Region katalogu materiałów',
      settings_use: 'Używaj przeglądarki materiałów',
      showing_bundled: 'Wyświetlanie katalogu wbudowanego',
      state_customized: 'Dostosowane',
      state_default: 'Domyślne',
      state_disabled: 'Wyłączone',
      state_user: 'Zdefiniowane przez użytkownika',
      storage_full: 'Pamięć jest pełna, nie udało się zapisać biblioteki materiałów. Zamiast zdjęć użyj okładek w kolorze.',
      sure_to_delete_material: 'Usunąć ten materiał i wszystkie jego ustawienia wstępne?',
      sure_to_delete_preset: 'Usunąć to ustawienie wstępne?',
      sure_to_delete_variant: 'Usunąć tę grubość i jej ustawienia wstępne?',
      sure_to_import: 'Import scali plik z Twoją biblioteką materiałów. Kontynuować?',
      thickness: 'Grubość',
      title: 'Przeglądarka materiałów',
      variant_exists: 'Wariant o tej grubości już istnieje.',
      variants: '%d wariantów',
    },
    ...
    popup: {
      ...
      disassemble_use: {
        ...
        variable_text_warning: 'Obiekty z tekstem zmiennym zostały pominięte. Wyłącz tekst zmienny przed ich rozłożeniem.',
      },
      ...
      path_engine_upgrade: {
        caption: 'Dostępne szybsze generowanie zadań',
        keep_current: 'Zachowaj obecne',
        message: 'Ulepszyliśmy silnik obliczeniowy zadań, aby poprawić wydajność i przyspieszyć generowanie zadań.\nCzy chcesz przełączyć się na nowy przyspieszony silnik?\nMożesz go wyłączyć w dowolnym momencie w %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'W trybie grawerowania krzywoliniowego aktualna prędkość może być zbyt wysoka i może wpływać na szczegóły grawerowania warstw: %(layers)s.\nRozważ zmniejszenie prędkości dla lepszej jakości.',
    ...
    right_panel: {
      laser_panel: {
        ...
        dropdown: {
          inches: {
            ...
            acrylic_7mm_cutting: 'Akryl - 1/4″ cięcie',
            ...
            mdf_7mm_cutting: 'MDF - 1/4″ cięcie',
          ...
          mm: {
            ...
            acrylic_7mm_cutting: 'Akryl - 7mm cięcie',
            ...
            mdf_7mm_cutting: 'MDF - 7mm cięcie',
            mdf_engraving: 'MDF - grawerowanie',
            mdf_printing: 'MDF - druk',
            metal_bw_engraving: 'Metal - grawerowanie',
            opaque_acrylic: 'Nieprzezroczysty akryl',
        ...
        texture: 'Tekstura',
        texture_angle: 'Kąt',
        texture_intensity: 'Intensywność',
        texture_interval: 'Odstęp',
        texture_random: 'Losowy',
        texture_stripe: 'Paski',
        times: 'czasy',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Generatywne skalowanie',
          ai_upscale_short: 'Skalowanie',
          ai_upscale_too_large: 'Ten obraz jest zbyt duży do powiększania AI. Maksymalny obsługiwany rozmiar to %dpx x %dpx.',
          array: 'Szyk',
  ...
  boxgen: {
    ...
    inner: 'Wewnętrzny',
    joints: 'Połączenie',
    max_dimension_tooltip: 'Maksymalna szerokość to %s, maksymalna wysokość/głębokość ustawiona na %s.',
    merge: 'Scal',
    outer: 'Zewnętrzny',
    reset: 'Resetuj',
    tCount: 'Liczba T',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Przesuń głowicę lasera, aby wyrównać czerwone światło ze środkiem <b>punktu A</b>.',
    charuco_move_to_point_b: 'Przesuń głowicę lasera poziomo, aby wyrównać czerwone światło ze środkiem <b>punktu B</b>.',
    ...
    check_pnp_desc: 'Upewnij się, że czerwone znaczniki są wyrównane z punktami grawerowania\nJeśli nie, kliknij „Wróć", aby dostosować.\nJeśli wszystko jest w porządku, świetna robota! 🎉',
    ...
    put_charuco: 'Umieść wzór kalibracyjny',
    put_charuco_1: 'Wydrukuj wzór kalibracyjny (A4/Letter).',
    put_charuco_2: 'Przyklej ją płasko na sztywnej tablicy.',
    put_charuco_3: 'Umieść na środku i wykonaj autofokus.',
    put_charuco_bm2_1: 'Wydrukuj plik wzoru kalibracyjnego na papierze A4 (Letter) do kalibracji.',
    put_charuco_bm2_2: 'Kliknij „Dalej” i postępuj zgodnie z instrukcjami, aby umieścić papier.',
    put_charuco_promark_2: 'Upewnij się, że papier kalibracyjny jest wyraźnie widoczny i bez odblasków. Kliknij „Dalej“, aby zrobić zdjęcie.',
    put_charuco_promark_desc_1: 'Użyj papieru kalibracyjnego dostarczonego w pudełku z akcesoriami lub wydrukuj poniższy wzór kalibracyjny na papierze A4 do kalibracji kamery.',
    ...
    put_paper_promark: 'Połóż Czarną Tekturę',
    put_paper_promark_1: 'Umieść czarną tekturę z pudełka z akcesoriami na platformie roboczej.',
    put_paper_promark_2: 'Ustaw ostrość prawidłowo, a następnie kliknij "Rozpocznij Grawerować", aby kontynuować.',
  ...
  connection_issue_guide: {
    alert_link: 'Rozłącza się? Wypróbuj tę metodę rozwiązywania problemów.',
    connect_computer: {
      content: 'Twój komputer musi być w tej samej sieci co urządzenie.',
      macos_steps: 'Kliknij ikonę Wi-Fi na pasku menu. Następnie wybierz hotspot swojego telefonu.',
      macos_title: 'macOS',
      title: 'Podłącz swój komputer',
      windows_steps: 'Kliknij ikonę sieci na pasku zadań. Następnie wybierz hotspot swojego telefonu.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Urządzenie nie może znaleźć mojego hotspotu',
      dont_know_hotspot_name: 'Nie znam nazwy mojego hotspotu',
      step1: '1. Na panelu dotykowym urządzenia przejdź do: Sieć → Połącz z Wi-Fi.',
      step2: '2. Znajdź i wybierz nazwę hotspotu swojego telefonu z listy Wi-Fi.',
      step3: '3. Wprowadź hasło hotspotu i połącz się.',
    ...
    enter_ip: {
      ...
      step1: 'Wprowadź adres IP znaleziony w poprzednim kroku.',
      step2: 'Kliknij „Zweryfikuj", aby przetestować połączenie.',
      step3: 'Beam Studio sprawdzi:',
      title: 'Wprowadź adres IP swojego urządzenia',
      verify: 'Zweryfikuj',
    },
    fail: {
      bullet1: '• Model i numer seryjny Twojego urządzenia',
      bullet2: '• Adres IP wyświetlany na panelu dotykowym',
      bullet3: '• Opis napotkanego błędu',
      contact_title: 'Kontaktując się z pomocą techniczną, warto mieć przygotowane:',
      intro: 'Nie martw się — nie musi to oznaczać, że z Twoim urządzeniem jest coś nie tak. Na połączenie mogą wpływać dodatkowe czynniki. Nasz zespół pomocy technicznej chętnie pomoże Ci to rozwiązać.',
      title: 'Nie udało nam się ukończyć testu',
    },
    hotspot: {
      android_steps: 'Ustawienia → Połączenia → Hotspot i tethering → Hotspot Wi-Fi',
      android_title: 'Android',
      ios_steps: 'Ustawienia → Hotspot osobisty → Zezwól innym na dołączanie',
      ios_title: 'iPhone (iOS)',
      tip: 'Wskazówka: Użyj prostej angielskiej nazwy hotspotu i numerycznego hasła (np. Nazwa: FLUX_Test   Hasło: 12345678)',
      warning_2_4ghz: 'Ważne: Urządzenia FLUX obsługują tylko Wi-Fi 2.4GHz. Przed kontynuowaniem ustaw hotspot na 2.4GHz.',
    },
    how_it_works: 'Jak działa test:',
    how_it_works_step1: '1. Skonfiguruj swój telefon jako hotspot Wi-Fi.',
    how_it_works_step2: '2. Połącz urządzenie z hotspotem.',
    how_it_works_step3: '3. Połącz komputer z tym samym hotspotem.',
    how_it_works_step4: '4. Przetestuj połączenie w Beam Studio.',
    intro: 'Przeprowadźmy szybki test, aby sprawdzić, czy Twoje urządzenie działa prawidłowo. Połączymy urządzenie i komputer przez hotspot Twojego telefonu, aby ustalić, czy problem dotyczy Twojej sieci, czy samego urządzenia.',
    ip_address: {
      step1: 'Na panelu dotykowym urządzenia przejdź do:\nSieć → Poszukaj „Adres IP"',
      step2: 'IP zwykle wygląda tak: 172.20.10.x lub 192.168.x.x\n(Zależy to od hotspotu Twojego telefonu)',
      step3: 'Zapisz ten adres IP do następnego kroku.',
      title: 'Znajdź adres IP swojego urządzenia',
      warning: 'Jeśli IP zaczyna się od 169.254, połączenie się nie powiodło. Wróć do Kroku 1 i spróbuj ponownie.',
    },
    success: {
      cause: 'Problem z połączeniem, którego doświadczyłeś, jest najprawdopodobniej spowodowany środowiskiem Twojej sieci lokalnej, a nie samym urządzeniem.',
      intro: 'Pomyślnie ukończyłeś test połączenia Wi-Fi — świetna robota! To potwierdza, że Twoje urządzenie FLUX działa idealnie.',
      recommend1: '• Skontaktuj się ze swoim dostawcą usług internetowych (ISP) lub producentem routera, aby uzyskać pomoc w ustawieniach Wi-Fi',
      recommend2: '• Zapytaj administratora sieci, jeśli jesteś w szkole, biurze lub współdzielonej przestrzeni roboczej',
      recommend3: '• Sprawdź, czy Twój router obsługuje 2.4GHz i spróbuj go zrestartować',
      recommend_title: 'Co zalecamy:',
  ...
  generators: {
    ...
    keychain_generator: 'Generator breloków',
    material_test_generator: 'Generator Testu Materiału',
    puzzle_generator: 'Generator puzzli',
    title: 'Generatory',
  },
  generic_error: {
  ...
  initialize: {
    ...
    select_promark: 'Wybierz swój Promark',
    setting_completed: {
      back: 'Wróć',
  ...
  keychain_generator: {
    ...
    types: {
      animal: 'Styl zwierzęcy',
      capsule: 'Styl kapsułki',
      dialog_box: 'Styl dymka dialogowego',
      geometry: 'Styl geometryczny',
      oval: 'Styl owalny',
      pet: 'Styl zwierzaka',
      plant: 'Styl roślinny',
  ...
  machine_linking: {
    continue: 'Kontynuuj',
    i_have_read: 'Przeczytałem',
    input_birthday_to_link: 'Wprowadź datę urodzenia, aby zakończyć łączenie urządzenia',
    input_birthday_to_link_note: '*Służy do weryfikacji, czy Twój wiek spełnia wymagania kwalifikacyjne',
    link_failed: 'Łączenie nie powiodło się.',
    link_failed_already_linked: 'To urządzenie jest obecnie połączone z innym FLUX ID. Możesz nadal go używać lub połączyć je ze swoim kontem.',
    link_failed_cannot_set_secret: 'Nie można zapisać informacji o połączeniu w urządzeniu. Sprawdź połączenie między komputerem a urządzeniem.',
    link_failed_under_age: 'Obecnie nie spełniasz wymagań do korzystania z tej usługi i nie możesz zakończyć łączenia urządzenia.',
    link_machine: 'Połącz FLUX ID',
    link_machine_to_account: 'Połączono z %(name)s. Czy chcesz połączyć to urządzenie ze swoim kontem?',
    link_success: 'Łączenie powiodło się.',
    link_to_my_flux_id: 'Połącz z moim FLUX ID',
    privacy_policy: 'Polityka prywatności',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Łączenie…',
    use_without_linking: 'Użyj bez łączenia',
  },
  machine_status: {
    '-17': 'Tryb I/O kasety',
    '-10': 'Tryb utrzymania',
  ...
  maintenance: {
    actions: {
      ...
      fail: 'Niezdany',
      history: 'Historia',
      open_guide: 'Otwórz poradnik',
      pass: 'Zdany',
      print: 'Drukuj / PDF',
    },
    areas: {
      back_cover: 'Tylna pokrywa',
      modules: 'Moduły',
      optics: 'Optyka',
      panel: 'Panel',
      working_area: 'Obszar roboczy',
    },
    cadence: {
      by_material: 'Wg materiału',
      condition: 'Warunkowo',
      day: 'Codziennie',
      days: 'Co %s dni',
      each_operation: 'Przy każdym użyciu',
      every_1_2_weeks: 'Co 1–2 tygodnie',
      month: 'Co miesiąc',
      months: 'Co %s miesiące',
      upon_unboxing: 'Przy pierwszym rozpakowaniu',
      week: 'Co tydzień',
      weeks: 'Co %s tygodnie',
    },
    celebration: {
    ...
    feedback: {
      ...
      fail_warning: '%s: oznaczono do wymiany tuby. Otwórz poradnik, aby poznać kroki.',
      passed: '%s: test zdany — tuba jest sprawna!',
    },
    footer_tip: 'Wskazówka: graweruj przykładowy plik raz w miesiącu, aby utrzymać maszynę w dobrej kondycji.',
    history_hint: 'Dla każdego zadania przechowywanych jest tylko %s ostatnich wpisów.',
    intro: 'Śledź każdą czynność konserwacyjną tej maszyny i oznaczaj ją jako wykonaną jednym kliknięciem.',
    legend: {
    ...
    status: {
      ...
      next: 'Następny termin',
      not_checked: 'Niesprawdzone',
      not_logged: 'Brak wpisu',
      overdue: 'Po terminie',
      replace_tube: 'Wymień tubę',
    },
    tasks: {
      align: {
        keyPoints: 'Wyreguluj, gdy tor optyczny jest rozregulowany.',
        name: 'Regulacja toru optycznego',
      },
      chassis: {
        keyPoints: 'Usuń osad i smolisty olej z obudowy i dolnej pokrywy.',
        name: 'Czyszczenie obudowy',
      },
      door: {
        keyPoints: 'Usuń tłuszcz z pokrywy drzwi.',
        name: 'Czyszczenie pokrywy drzwi',
      },
      exhaust: {
        keyPoints: 'Oczyść łopatki wentylatora z kurzu.',
        name: 'Czyszczenie wentylatora wyciągowego',
      },
      fan: {
        keyPoints: 'Usuń kurz z łopatek wentylatora wentylacyjnego.',
        name: 'Czyszczenie wentylatora wentylacyjnego',
      },
      fieldlens: {
        keyPoints: 'Wyczyść soczewkę polową, wycierając od środka na zewnątrz zgodnie z ruchem wskazówek zegara.',
        name: 'Czyszczenie soczewki polowej',
      },
      honeycomb_plate: {
        keyPoints: 'Usuń osad i smołę z kratek płyty o strukturze plastra miodu.',
        name: 'Czyszczenie płyty o strukturze plastra miodu',
      },
      honeycomb_table: {
        keyPoints: 'Usuń osad i smolisty olej z siatki plastra miodu.',
      ...
      maintain_test: {
        keyPoints: 'Sprawdź wyświetlacz stanu i przełączniki.',
        name: 'Strona MAINTAIN',
      },
      mirrors_combiner: {
        keyPoints: 'Usuń zabrudzenia z soczewek/luster; sprawdź, czy nie ma utlenienia. Bez śladów alkoholu i wody.',
        name: 'Lustra, soczewka ogniskująca i łącznik wiązki',
      },
      mirrors_lens: {
        keyPoints: 'Wyczyść 4 lustra i soczewkę; upewnij się, że nie ma utlenienia ani zacieków.',
        name: 'Czyszczenie luster i soczewki',
      },
      mod_diode: {
        keyPoints: 'Wyczyść wentylator, soczewkę ogniskującą i POGO pin.',
        name: 'Moduł lasera diodowego',
      },
      mod_ir: {
        keyPoints: 'Wyczyść soczewkę ogniskującą.',
        name: 'Moduł podczerwieni',
      },
      optical_inspection: {
        keyPoints: 'Sprawdź tor optyczny; także przy rozpakowaniu i po wymianie tuby.',
        name: 'Kontrola toru optycznego',
      },
      optical_unboxing: {
        keyPoints: 'Upewnij się, że tor optyczny jest prawidłowy. Sprawdź przy pierwszym rozpakowaniu.',
        name: 'Kontrola toru optycznego',
      },
      screen: {
        keyPoints: 'Usuń kurz i tłuszcz z panelu.',
        name: 'Czyszczenie ekranu',
      },
      tube: {
        keyPoints: 'Jeśli akryl 3 mm nie daje się przeciąć przy 70% mocy, wymień tubę.',
        name: 'Kontrola stanu tuby laserowej',
      },
      water: {
        keyPoints: 'Dolej wody do ponad 80% pojemności, bez pęcherzyków powietrza.',
        name: 'Wymiana wody chłodzącej',
      },
      worktable: {
        keyPoints: 'Spryskaj chusteczkę alkoholem, a następnie przetrzyj stół roboczy.',
        name: 'Czyszczenie stołu roboczego',
      },
      zaxis: {
        keyPoints: 'Przetrzyj śrubę kolumny osi Z, a następnie równomiernie nałóż smar patyczkiem kosmetycznym.',
        name: 'Smarowanie kolumny osi Z',
      },
    },
    title: 'Lista czynności konserwacyjnych',
  },
  ...
  message: {
    ...
    camera: {
      ...
      fail_to_transmit_image: '#845 Coś poszło nie tak z transmisją obrazu. Uruchom ponownie komputer i Beam Studio. Jeśli ten błąd będzie się powtarzał, postępuj zgodnie z <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">tym przewodnikiem</a>.',
      switching_camera: 'Przełączanie kamery...',
      wide_angle_open_door: 'Otwórz pokrywę drzwi',
      wide_angle_open_door_text: 'Otwórz pokrywę drzwi przed przełączeniem na kamerę szerokokątną.',
  ...
  monitor: {
    ...
    HARDWARE_ERROR_PUMP_ERROR: '#900 Niski przepływ chłodziwa. Sprawdź w swoim zbiorniku na wodę.',
  ...
  params_label: {
    ...
    placeholder: 'Etykieta parametrów',
    preview_hint: 'To jest podgląd. Treść tekstu zostanie automatycznie zaktualizowana przed wysłaniem zadania',
    save_as_default: 'Zapisz jako domyślne',
    settings: 'Ustawienia etykiety parametrów',
    update: 'Aktualizuj',
    updated: 'Zaktualizowano etykietę parametrów',
    use_default: 'Użyj zapisanych domyślnych',
    use_recommended: 'Użyj zalecanych',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      calculating: 'Obliczanie…',
      capturing: 'Przechwytywanie obrazu',
      completing: 'Wkrótce zakończone',
      detecting: 'Wykrywanie znaczników wyrównania',
      locating: 'Lokalizowanie znaczników wyrównania',
      preparing: 'Przygotowywanie kamery',
      refining: 'Uściślanie pozycji znaczników',
    },
    alignment: {
    ...
    calibration: {
      align_desc: '1. Umieść wydrukowany arkusz kalibracyjny w obszarze roboczym, przyklej go taśmą lub taśmą malarską, aby się nie przesuwał, i ustaw ostrość.\n2. Kliknij „Podgląd i wyrównanie”, aby uruchomić wyrównanie kamerą.\n3. Po wykryciu znaczników kliknij „Wyryj skale”, aby przy niskiej mocy wyryć na arkuszu linie odniesienia.',
      aligned: 'Wykryto znaczniki wyrównania. Gotowe do rycia.',
      auto_read: 'Odczytaj skale kamerą',
      auto_read_failed: 'Nie udało się automatycznie odczytać skal. Odczytaj je wzrokowo i wpisz wartości.',
      auto_read_hint: 'Odczyt z kamery może różnić się o maksymalnie ±2; sprawdź go na arkuszu.',
      current_offset: 'Bieżące przesunięcie: X %s mm, Y %s mm',
      export_pdf: 'Eksportuj PDF kalibracji',
      power: 'Moc',
      print_desc: '1. Wyeksportuj PDF arkusza kalibracyjnego. Zawiera cztery znaczniki wyrównania i dwie skale.\n2. Wydrukuj arkusz w skali 100% (rzeczywisty rozmiar).',
      reading_desc: '1. Znajdź najdłuższą wyrytą linię (środkową) i sprawdź, po której stronie wydrukowanej linii 0 się znajduje.\n2. Przesuwaj się linia po linii w tę stronę, aż wyryta linia pokryje się dokładnie z wydrukowaną.\n3. Policz od 0 do tej wydrukowanej linii (liczby są wydrukowane co 5 linii; policz też nienumerowane linie pomiędzy).',
      reading_x: 'Odczyt X',
      reading_y: 'Odczyt Y',
      scratch: 'Wyryj skale',
      speed: 'Prędkość',
      title: 'Kalibracja Drukuj i tnij',
    },
    ...
    finish: 'Zakończ',
    fit_content: 'Dopasuj do zawartości',
    generate_from_contour: 'Generuj z konturu',
    grid_columns: 'Kolumny',
    grid_rows: 'Rzędy',
    ...
    orientation_landscape: 'Pozioma',
    orientation_portrait: 'Pionowa',
    paper_size: 'Rozmiar wydruku',
    paper_too_small: 'Obszar wydruku jest za mały. Projekt (wraz ze znacznikami wyrównania) wymaga co najmniej %s mm marginesu od krawędzi materiału, aby zmieścić się w obszarze drukowania drukarki. Wybierz większy rozmiar wydruku, w przeciwnym razie wydruk zostanie przycięty lub pomniejszony.',
    preview_and_align: 'Podgląd i wyrównanie',
    resume_desc: 'Ten projekt jest już przygotowany do funkcji Drukuj i tnij.\nUmieść kolejny zadrukowany materiał w maszynie i przejdź do wyrównania kamerą lub zacznij od nowa, aby zmienić projekt, rozmiar wydruku lub ścieżkę cięcia.',
    resume_title: 'Wznów Drukuj i tnij',
    select_cut_layer: 'Warstwa ze ścieżką cięcia',
    ...
    step_setup: 'Ścieżki cięcia i znaczniki',
    ...
    uv_print_file_disabled: 'Funkcja Drukuj i tnij drukuje zawartość warstw druku UV. Włącz „Włącz plik druku UV” w preferencjach, a następnie dodaj swój projekt do warstwy druku UV.',
  ...
  puzzle_generator: {
    ...
    export_engrave: 'Warstwa grawerowania',
    export_failed: 'Nie udało się zaimportować puzzli na płótno. Spróbuj ponownie lub dostosuj ustawienia puzzli.',
    export_none: 'Brak',
    export_print: 'Warstwa druku',
    file_too_large: 'Wybrany plik przekracza maksymalny dozwolony rozmiar.',
    ...
    piece_size: 'Rozmiar elementów',
    preview_placeholder: 'Podgląd puzzli',
    puzzle_board: 'Plansza puzzli',
    puzzle_pieces: 'Elementy puzzli',
    radius: 'Promień',
    ...
    types: {
      ...
      heart_jigsaw: 'Puzzle w kształcie serca',
      hex_jigsaw: 'Sześciokątne puzzle',
      rectangle_jigsaw: 'Prostokątne puzzle',
    },
    unsupported_file_type: 'Nieobsługiwany typ pliku. Użyj JPG, PNG lub WebP.',
    upload_hint: 'JPG, PNG, WebP (maks. 10MB)',
    upload_image: 'Kliknij lub przeciągnij, aby przesłać',
    zoom: 'Powiększenie',
  },
  qr_code_generator: {
  ...
  settings: {
    ...
    show_banners: 'Wyświetl baner na stronie głównej',
    simplify_clipper_path: 'Optymalizacja punktów kotwiczenia',
  ...
  tips: {
    canvas_hold_space_to_pan: 'Przytrzymaj spację i przeciągnij, aby przesuwać widok po płótnie.',
    feature_auto_fit: 'Po podglądzie kamery użyj Akcje → Automatyczne dopasowanie, aby automatycznie umieścić obiekty na materiale.',
    feature_box_generator: 'Użyj Generatory → Generator pudełek, aby w kilka sekund utworzyć pudełka o niestandardowych rozmiarach.',
    feature_code_generator: 'Użyj Generatory → Generator kodów kreskowych, aby tworzyć kody QR i kody kreskowe.',
    feature_elements: 'Panel Elementy zawiera teraz ponad milion grafik gotowych do użycia.',
    feature_layer_color_configurations: 'Mapuj kolory warstw SVG na prędkość i moc poprzez Edycja → Warstwa → Ustawienia kolorów.',
    feature_material_test: 'Użyj Generatory → Generator testu materiału na lewym pasku narzędzi, aby szybko znaleźć najlepsze ustawienia dla materiału.',
    layer_execution_order: 'Kolejność warstw określa kolejność zadań. Zadania są wykonywane od góry do dołu.',
    machine_clean_mirror: 'Regularnie sprawdzaj lustra i soczewkę ogniskującą i czyść je w razie potrzeby, aby zapobiec gromadzeniu się dymu.',
    machine_no_unattended_operation: 'Nigdy nie zostawiaj pracującej maszyny bez nadzoru.',
    machine_regular_start: 'Wykonuj zadanie laserowe co najmniej raz na dwa tygodnie, aby pomóc wydłużyć żywotność tuby laserowej.',
    object_edit_image_to_erase: 'Użyj Obraz → Akcje → Edytuj obraz, aby wymazać niechciane obszary na obrazie.',
    object_polygon_sides: 'Dostosuj liczbę boków w panelu właściwości wielokąta.',
    object_rounded_rectangle: 'Ustaw promień narożnika zaokrąglonego prostokąta w panelu właściwości prostokąta.',
    object_sharpen_portrait: 'Ulepsz grawerowanie portretów za pomocą Obraz → Akcje → Wyostrz.',
    settings_auto_save: 'Włącz Automatyczny zapis w Preferencjach, aby uniknąć utraty pracy.',
    settings_default_text_font: 'Możesz ustawić domyślną czcionkę dla narzędzia Tekst w Preferencjach.',
    task_focus_lower_for_cutting: 'W przypadku grubszych materiałów ustawienie ostrości około 2 mm poniżej powierzchni może poprawić wyniki cięcia.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Nie udało się nawiązać połączenia z kamerą maszyny. Uruchom ponownie komputer i Beam Studio. Jeśli błąd będzie się powtarzał, postępuj zgodnie z <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">tym przewodnikiem</a>.',
      fail_to_get_door_status: 'Upewnij się, że pokrywa drzwi jest zamknięta, aby włączyć niską moc lasera do uruchomienia ramki.',
      fail_to_start_preview: '#803 Nie udało się uruchomić trybu podglądu. Uruchom ponownie komputer i Beam Studio. Jeśli błąd będzie się powtarzał, postępuj zgodnie z <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">tym przewodnikiem</a>.',
      ...
      start_preview_timeout: '#803 Upłynął limit czasu podczas uruchamiania trybu podglądu. Uruchom ponownie komputer i Beam Studio. Jeśli błąd będzie się powtarzał, postępuj zgodnie z <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">tym przewodnikiem</a>.',
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Kalibruj Drukuj i tnij',
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Eksportuj dane kalibracji',
      ...
      import_beamo_2_printing_test: 'Test druku beamo II',
      import_calibration_data: 'Importuj dane kalibracji',
      ...
      import_promark_engraving_example_1: 'Przykład grawerowania Promark I',
      import_promark_engraving_example_2: 'Przykład grawerowania Promark II',
      ...
      machines: 'Maszyny',
      maintenance_checklist: 'Lista czynności konserwacyjnych',
    ...
    tag_names: {
      ...
      params_label: 'Etykieta parametrów',
