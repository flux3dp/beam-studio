...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Pozycja: Wyrównaj do punktu grawerowanego w lewym górnym rogu.',
    align_4_1: 'Pozycja: Wyrównaj do punktu grawerowanego w prawym górnym rogu.',
    align_4_2: 'Pozycja: Wyrównaj do punktu grawerowanego w lewym dolnym rogu.',
    align_4_3: 'Pozycja: Wyrównaj do punktu grawerowanego w prawym dolnym rogu.',
    align_8_0: 'Pozycja: Wyrównaj do punktu wyrytego na zewnątrz po lewej górnej stronie.',
    align_8_1: 'Pozycja: Wyrównaj do punktu wyrytego na zewnątrz po prawej górnej stronie.',
    align_8_2: 'Pozycja: Wyrównaj do punktu wyrytego na zewnątrz po lewej dolnej stronie.',
    align_8_3: 'Pozycja: Wyrównaj do punktu wyrytego na zewnątrz po prawej dolnej stronie.',
    align_8_4: 'Pozycja: Wyrównaj do punktu wyrytego na wewnętrznej lewej górnej stronie.',
    align_8_5: 'Pozycja: Wyrównaj do punktu wyrytego na wewnętrznej prawej górnej stronie.',
    align_8_6: 'Pozycja: Wyrównaj do punktu wyrytego na wewnętrznej lewej dolnej stronie.',
    align_8_7: 'Pozycja: Wyrównaj do punktu wyrytego na wewnętrznej prawej dolnej stronie.',
    ...
    charuco_open_the_machine_lid: 'Otwórz pokrywę urządzenia.',
    charuco_place_charuco: 'Umieść wydrukowany wzorzec kalibracyjny poziomo w <b>%s</b> obszaru roboczego.',
    ...
    check_pnp_desc: 'Ponownie wykonaliśmy zdjęcia na podstawie wyników kalibracji i oznaczyliśmy punkty odniesienia grawerowania.\nSprawdź, czy czerwone znaczniki odpowiadają rzeczywistym punktom grawerowania.\nJeśli zauważysz wyraźne niezgodności, kliknij „Kalibruj ponownie”, aby spróbować ponownie.',
    ...
    solve_pnp_keep_door_closed: 'Podczas poniższego procesu trzymaj drzwi zamknięte. Jeśli drzwi zostaną otwarte, system spróbuje ponownie ustawić kamerę.',
    ...
    solve_pnp_relocate_camera: 'Kliknij „Przenieś kamerę", jeśli głowica lasera nadal nie jest wyśrodkowana w poziomie.',
  ...
  settings: {
    ...
    module_offset_4c: 'Przesunięcie druku (4C)',
    ...
    module_offset_uv_varnish: 'Przesunięcie lakieru',
    module_offset_uv_white_ink: 'Przesunięcie białego tuszu',
    none: 'Żaden',
    normal: 'Normalny',
  ...
  topbar: {
    ...
    menu: {
      ...
      import_beamo_2_printing_example_full: 'Przykład druku beamo II - cały kolor',
