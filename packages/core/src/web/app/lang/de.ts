...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    font_size: 'Schriftgröße',
    hole: 'Loch',
    hole_diameter: 'Durchmesser',
    hole_offset: 'Versatz',
    hole_position: 'Position',
    hole_thickness: 'Dicke',
    hole_type: 'Typ',
    hole_type_punch: 'Stanzloch',
    hole_type_ring: 'Ring',
    ...
    position_ref_bottom_center: 'Unten',
    position_ref_left_center: 'Links',
    position_ref_right_center: 'Rechts',
    position_ref_top_center: 'Oben',
    ...
    types: {
      hotel_key_chain: 'Hotel-Schlüsselanhänger',
      rectangle: 'Rechteck',
      text: 'Text',
    },
  },
