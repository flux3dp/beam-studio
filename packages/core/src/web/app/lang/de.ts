...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'Die Ausgabegröße (%s) überschreitet das empfohlene Maximum von %d × %d px. Die Verarbeitung kann mehrere Minuten dauern und das Ergebnis kann Beam Studio verlangsamen. Trotzdem fortfahren?',
