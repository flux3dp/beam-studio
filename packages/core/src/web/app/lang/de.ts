...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Wie kann die Erkennungsgenauigkeit verbessert werden?',
    ...
    retake_tooltip: 'Kamerafoto an der Position jedes Objekts erneut aufnehmen für bessere Erkennung',
    retry_with_remove_bg: 'Hintergrund entfernen',
    retry_with_remove_bg_tooltip: 'Hintergrund aus dem Vorschaubild entfernen, um die Konturerkennung zu verbessern',
    rotation: 'Drehen',
    ...
    use_original_image_tooltip: 'Das ursprüngliche Vorschaubild ohne Hintergrundentfernung wiederherstellen',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      credit_balance: 'AI-Credit-Guthaben',
      credit_cost: 'Verwendete AI-Credits',
      description: 'Erhöhen Sie Auflösung und Details des Bildes mit KI. Das hochskalierte Bild ersetzt das Original auf der Zeichenfläche.',
      done: 'Generatives Hochskalieren abgeschlossen',
      dpi_recommended: 'Für die aktuelle Ebenen-DPI empfohlen: %dx.',
      dpi_recommended_capped: 'Für die aktuelle Ebenen-DPI empfohlen: %dx, aber %dx ist das Maximum innerhalb der empfohlenen Ausgabegröße.',
      failed: 'Generatives Hochskalieren konnte nicht abgeschlossen werden. Bitte prüfen Sie Ihre Netzwerkverbindung und versuchen Sie es erneut.',
      insufficient_credit: 'Nicht genügend AI-Credits für Generatives Hochskalieren.',
      layer_dpi: 'Ebenen-DPI',
      original_size: 'Originalgröße',
      output_size: 'Ausgabegröße',
      oversize_warning: 'Die Ausgabegröße (%s) überschreitet das empfohlene Maximum von %dpx x %dpx. Die Verarbeitung kann mehrere Minuten dauern und das Ergebnis kann Beam Studio verlangsamen. Trotzdem fortfahren?',
      processing: 'Hochskalierung läuft…',
      processing_hint: 'Die Verarbeitungszeit hängt von Bildgröße und Netzwerkbedingungen ab.',
      recommended: 'Empfohlen',
      retry: 'Erneut versuchen',
      start: 'Hochskalieren starten',
    },
    announcement_panel: {
      title: 'Ankündigung',
    },
    ...
    document_panel: {
      ...
      prespray_times: 'Reinigungszyklen',
    ...
    left_panel: {
      ...
      label: {
        ...
        preview_precise: 'Präzise Kameravorschau',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Einem Material zuordnen',
        bucket_hint: 'In Ihrer Sammlung “Meine Materialien” (Sonstige) gespeichert. Sie können es später einem Material zuordnen.',
        create_new: 'Neues Material erstellen…',
        new_material_name: 'Name des neuen Materials',
        preset_name: 'Name der Voreinstellung',
        settings_from_layer: 'Einstellungen aus der aktuellen Ebene übernommen',
        title: 'Aktuelle Ebeneneinstellungen als Voreinstellung speichern',
      },
      ...
      catalog: {
        ...
        presets: {
          cutting: 'Schneiden',
          engraving: 'Gravieren',
          engraving_diode: 'Gravieren (Diode)',
          engraving_fiber: 'Gravieren (Faser)',
          engraving_spray: 'Gravieren (Spray)',
          kiss_cut: 'Kiss Cut',
          marking: 'Markieren',
          marking_dark: 'Dunkle Markierung',
          marking_light: 'Helle Markierung',
          printing: 'Drucken',
          printing_fabric: 'Drucken (Stoff)',
        },
      },
      categories: {
        acrylic: 'Acryle',
      ...
      editor: {
        ...
        appearance_hint: 'Kein Foto? Wählen Sie stattdessen eine Titelfarbe.',
        category: 'Kategorie',
        ...
        photo: 'Foto',
        tags: 'Tags',
        title_add: 'Material hinzufügen',
        title_edit: 'Material bearbeiten',
        upload_hint: 'Foto klicken oder hierher ziehen. Große Vorschau wird in der Galerie angezeigt.',
      },
      enable: 'Aktivieren',
      export: 'Exportieren',
      favorites: 'Favoriten',
      from_current_layer: 'Aus aktueller Ebene',
      import: 'Importieren',
      machine: 'Maschine',
      manual: 'Manuell',
      manual_settings: 'Manuelle Einstellungen',
      modified: 'Parameter wurden seit dem Anwenden der Voreinstellung geändert',
      move_to_material: 'Zu Material verschieben…',
      new_preset_manual: 'Neue Voreinstellung…',
      no_materials_in_category: 'Hier gibt es noch keine Materialien für %s.',
      no_presets_for_machine: 'Noch keine Einstellungen für %s.',
      no_search_match: 'Keine Materialien passen zu “%s”.',
      preset_editor: {
        name: 'Name der Voreinstellung',
        name_required: 'Name ist erforderlich',
        title_edit: 'Voreinstellung bearbeiten',
        title_new: 'Neue Voreinstellung',
      },
      presets: 'Voreinstellungen',
      recents: 'Zuletzt verwendet',
      recents_empty: 'Zuletzt angewendete Materialien erscheinen hier.',
      regions: {
        auto: 'Automatisch',
        eu: 'Europa',
        global: 'Global',
      ...
      restore_default: 'FLUX-Standard wiederherstellen',
      result: 'Ergebnis',
      search_placeholder: 'Materialien, Tags, Kategorien suchen…',
      settings_region: 'Region des Materialkatalogs',
      settings_use: 'Material-Browser verwenden',
      showing_bundled: 'Integrierter Katalog wird angezeigt',
      state_customized: 'Angepasst',
      state_default: 'Standard',
      state_disabled: 'Deaktiviert',
      state_user: 'Benutzerdefiniert',
      storage_full: 'Der Speicher ist voll, die Materialbibliothek konnte nicht gespeichert werden. Verwenden Sie Farbcover statt Fotos.',
      sure_to_delete_material: 'Dieses Material und alle zugehörigen Voreinstellungen löschen?',
      sure_to_delete_preset: 'Diese Voreinstellung löschen?',
      sure_to_delete_variant: 'Diese Stärke und ihre Voreinstellungen löschen?',
      sure_to_import: 'Beim Import wird die Datei mit Ihrer Materialbibliothek zusammengeführt. Fortfahren?',
      thickness: 'Dicke',
      title: 'Material-Browser',
      variant_exists: 'Eine Variante mit dieser Stärke existiert bereits.',
      variants: '%d Varianten',
    },
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: 'Schnellere Auftragsgenerierung verfügbar',
        keep_current: 'Aktuell beibehalten',
        message: 'Wir haben die Auftragsberechnungs-Engine aktualisiert, um die Leistung zu verbessern und die Auftragsgenerierung zu beschleunigen.\nMöchten Sie zur neuen beschleunigten Engine wechseln?\nSie können dies jederzeit unter %(preferences)s > %(editor)s > %(path_acceleration)s deaktivieren.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'Im Kurvengravurmodus könnte die aktuelle Geschwindigkeit zu hoch sein und die Gravurdetails für Ebenen beeinträchtigen: %(layers)s.\nErwägen Sie, die Geschwindigkeit für bessere Qualität zu reduzieren.',
    ...
    right_panel: {
      laser_panel: {
        ...
        dropdown: {
          inches: {
            ...
            acrylic_7mm_cutting: 'Acryl- 1/4″ Schneiden',
            ...
            mdf_7mm_cutting: 'Neuseeland MDF - 1/4″ Schneiden',
          ...
          mm: {
            ...
            acrylic_7mm_cutting: 'Acryl - 7mm Schneiden',
            ...
            mdf_7mm_cutting: 'Neuseeland MDF - 7mm Schneiden',
            mdf_engraving: 'Neuseeland MDF - Gravur',
            mdf_printing: 'Neuseeland MDF - Drucken',
            metal_bw_engraving: 'Metall - Gravur',
            opaque_acrylic: 'Undurchsichtiges Acryl',
        ...
        strength: 'Leistung',
        texture: 'Textur',
        texture_angle: 'Winkel',
        texture_intensity: 'Intensität',
        texture_interval: 'Abstand',
        texture_random: 'Zufällig',
        texture_stripe: 'Streifen',
        times: 'mal',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Generatives Hochskalieren',
          ai_upscale_short: 'Hochskalieren',
          ai_upscale_too_large: 'Dieses Bild ist zu groß für die KI-Hochskalierung. Die maximal unterstützte Größe beträgt %dpx x %dpx.',
          array: 'Anordnung',
  ...
  boxgen: {
    ...
    inner: 'Innere',
    joints: 'Verbindung',
    max_dimension_tooltip: 'Max. Breite ist %s, Max. Höhe/Tiefe Einstellung ist %s.',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Bewegen Sie den Laserkopf, um das rote Licht auf die Mitte von <b>Punkt A</b> auszurichten.',
    charuco_move_to_point_b: 'Bewegen Sie den Laserkopf horizontal, um das rote Licht auf die Mitte von <b>Punkt B</b> auszurichten.',
    ...
    check_pnp_desc: 'Stellen Sie sicher, dass die roten Markierungen mit den Gravurpunkten übereinstimmen\nFalls nicht, klicken Sie auf „Zurück", um anzupassen.\nWenn alles passt, gut gemacht! 🎉',
    ...
    put_charuco: 'Kalibriermuster Platzieren',
    put_charuco_1: 'Kalibriermuster drucken (A4/Letter).',
    put_charuco_2: 'Flach auf eine feste Platte kleben.',
    put_charuco_3: 'Mittig platzieren und Autofokus durchführen.',
    put_charuco_bm2_1: 'Drucken Sie die Kalibriermusterdatei auf A4- (Letter-Größe) Papier zur Kalibrierung aus.',
    put_charuco_bm2_2: 'Klicken Sie auf „Weiter“ und folgen Sie der Anleitung, um das Papier zu positionieren.',
    put_charuco_promark_2: 'Bitte stellen Sie sicher, dass das Kalibrierungspapier ohne Blendung klar sichtbar ist. Klicken Sie auf „Weiter“, um ein Foto zu machen.',
    put_charuco_promark_desc_1: 'Bitte verwenden Sie das im Zubehörkasten bereitgestellte Kalibrierungspapier oder drucken Sie das folgende Kalibrierungsmuster auf A4-Papier zur Kamerakalibrierung aus.',
    ...
    put_chessboard_promark_desc_2: 'Bitte legen Sie das Schachbrettmuster flach und zentriert auf die Arbeitsplattform.',
    ...
    put_paper_bm2_4: 'Klicken Sie auf "Gravur starten".',
    put_paper_promark: 'Schwarzen Karton einlegen',
    put_paper_promark_1: 'Legen Sie den schwarzen Karton aus dem Zubehörkasten auf die Arbeitsplattform.',
    put_paper_promark_2: 'Stellen Sie den Fokus richtig ein und klicken Sie dann auf "Gravur starten", um fortzufahren.',
    ...
    put_paper_step3: 'Klicken Sie auf "Gravur starten".',
  ...
  cloud_sync: {
    import_config: 'Cloud-Einstellungen für dieses Gerät gefunden. Möchten Sie sie importieren?',
    import_failed: 'Cloud-Einstellungen konnten nicht gelesen werden.',
    sync_config: 'Möchten Sie diese Einstellungen in die Cloud synchronisieren?',
    sync_failed: 'Synchronisierung der Einstellungen in die Cloud fehlgeschlagen.',
    sync_success: 'Einstellungen erfolgreich in die Cloud synchronisiert.',
  },
  code_generator: {
    barcode: 'Barcode',
    content: 'Inhalt',
  ...
  connection_issue_guide: {
    alert_link: 'Verbindung wird getrennt? Probieren Sie diese Methode zur Fehlerbehebung.',
    connect_computer: {
      content: 'Ihr Computer muss sich im selben Netzwerk wie die Maschine befinden.',
      macos_steps: 'Klicken Sie auf das Wi-Fi-Symbol in der Menüleiste. Wählen Sie dann den Hotspot Ihres Telefons aus.',
      macos_title: 'macOS',
      title: 'Verbinden Sie Ihren Computer',
      windows_steps: 'Klicken Sie auf das Netzwerksymbol in der Taskleiste. Wählen Sie dann den Hotspot Ihres Telefons aus.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Maschine kann meinen Hotspot nicht finden',
      dont_know_hotspot_name: 'Ich kenne meinen Hotspot-Namen nicht',
      step1: '1. Gehen Sie auf dem Touch-Panel Ihrer Maschine zu: Netzwerk → Mit Wi-Fi verbinden.',
      step2: '2. Suchen und wählen Sie den Hotspot-Namen Ihres Telefons aus der Wi-Fi-Liste.',
      step3: '3. Geben Sie das Hotspot-Passwort ein und stellen Sie die Verbindung her.',
    ...
    enter_ip: {
      ...
      step1: 'Geben Sie die IP-Adresse ein, die Sie im vorherigen Schritt gefunden haben.',
      step2: 'Klicken Sie auf „Überprüfen", um die Verbindung zu testen.',
      step3: 'Beam Studio überprüft:',
      title: 'Geben Sie die IP-Adresse Ihrer Maschine ein',
      verify: 'Überprüfen',
    },
    fail: {
      bullet1: '• Ihr Maschinenmodell und Ihre Seriennummer',
      bullet2: '• Die auf dem Touch-Panel angezeigte IP-Adresse',
      bullet3: '• Eine Beschreibung des aufgetretenen Fehlers',
      contact_title: 'Wenn Sie sich an den Support wenden, ist es hilfreich, Folgendes bereitzuhalten:',
      intro: 'Keine Sorge — das bedeutet nicht unbedingt, dass mit Ihrer Maschine etwas nicht stimmt. Möglicherweise gibt es weitere Faktoren, die die Verbindung beeinträchtigen. Unser Support-Team hilft Ihnen gerne dabei, das Problem zu lösen.',
      title: 'Wir konnten den Test nicht abschließen',
    },
    hotspot: {
      android_steps: 'Einstellungen → Verbindungen → Mobiler Hotspot und Tethering → Mobiler Hotspot',
      android_title: 'Android',
      ios_steps: 'Einstellungen → Persönlicher Hotspot → Anderen den Zutritt erlauben',
      ios_title: 'iPhone (iOS)',
      tip: 'Tipp: Verwenden Sie einen einfachen englischen Hotspot-Namen und ein numerisches Passwort (z. B. Name: FLUX_Test   Passwort: 12345678)',
      warning_2_4ghz: 'Wichtig: FLUX-Maschinen unterstützen nur 2.4GHz-Wi-Fi. Stellen Sie Ihren Hotspot auf 2.4GHz ein, bevor Sie fortfahren.',
    },
    how_it_works: 'So funktioniert der Test:',
    how_it_works_step1: '1. Richten Sie Ihr Telefon als Wi-Fi-Hotspot ein.',
    how_it_works_step2: '2. Verbinden Sie die Maschine mit dem Hotspot.',
    how_it_works_step3: '3. Verbinden Sie Ihren Computer mit demselben Hotspot.',
    how_it_works_step4: '4. Testen Sie die Verbindung in Beam Studio.',
    intro: 'Lassen Sie uns einen kurzen Test durchführen, um zu prüfen, ob Ihre Maschine ordnungsgemäß funktioniert. Wir verbinden Ihre Maschine und Ihren Computer über den Hotspot Ihres Mobiltelefons, um festzustellen, ob das Problem bei Ihrem Netzwerk oder der Maschine selbst liegt.',
    ip_address: {
      step1: 'Gehen Sie auf dem Touch-Panel der Maschine zu:\nNetzwerk → Suchen Sie nach „IP-Adresse"',
      step2: 'Die IP sieht normalerweise so aus: 172.20.10.x oder 192.168.x.x\n(Dies hängt vom Hotspot Ihres Telefons ab)',
      step3: 'Notieren Sie sich diese IP-Adresse für den nächsten Schritt.',
      title: 'Finden Sie die IP-Adresse Ihrer Maschine',
      warning: 'Wenn die IP mit 169.254 beginnt, ist die Verbindung fehlgeschlagen. Kehren Sie zu Schritt 1 zurück und versuchen Sie es erneut.',
    },
    success: {
      cause: 'Das aufgetretene Verbindungsproblem wird höchstwahrscheinlich durch Ihre lokale Netzwerkumgebung verursacht und nicht durch die Maschine selbst.',
      intro: 'Sie haben den Wi-Fi-Verbindungstest erfolgreich abgeschlossen — gut gemacht! Dies bestätigt, dass Ihre FLUX-Maschine einwandfrei funktioniert.',
      recommend1: '• Wenden Sie sich an Ihren Internetdienstanbieter (ISP) oder Router-Hersteller, um Hilfe bei Ihren Wi-Fi-Einstellungen zu erhalten',
      recommend2: '• Fragen Sie Ihren Netzwerkadministrator, wenn Sie sich in einer Schule, einem Büro oder einem gemeinsam genutzten Arbeitsbereich befinden',
      recommend3: '• Prüfen Sie, ob Ihr Router 2.4GHz unterstützt, und starten Sie ihn neu',
      recommend_title: 'Unsere Empfehlung:',
      title: 'Großartig! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'Schlüsselanhänger-Generator',
  ...
  initialize: {
    ...
    Maschinen > „Promark Name“ > Promark-Einstellungen`,
      ...
      setting_completed_ask_camera_calibration: 'Die Promark-Feldobjektiv-Einrichtung wurde erfolgreich abgeschlossen! Möchten Sie mit der Kamerakalibrierung fortfahren?',
    ...
    select_hexa: 'Wählen Sie Ihren HEXA',
    select_language: 'Sprache auswählen',
    select_machine_type: 'Wählen Sie Ihr Modell',
    select_promark: 'Wählen Sie Ihren Promark',
    setting_completed: {
      back: 'Zurück',
  ...
  keychain_generator: {
    ...
    types: {
      animal: 'Tier-Stil',
      capsule: 'Kapsel-Stil',
      dialog_box: 'Dialogfeld-Stil',
      geometry: 'Geometrie-Stil',
      oval: 'Oval-Stil',
      pet: 'Haustier-Stil',
      plant: 'Pflanzen-Stil',
  ...
  machine_linking: {
    continue: 'Fortfahren',
    i_have_read: 'Ich habe gelesen',
    input_birthday_to_link: 'Bitte geben Sie Ihr Geburtsdatum ein, um die Geräteverknüpfung abzuschließen',
    input_birthday_to_link_note: '*Wird verwendet, um zu überprüfen, ob Ihr Alter die Berechtigungsvoraussetzungen erfüllt',
    link_failed: 'Verknüpfung fehlgeschlagen.',
    link_failed_already_linked: 'Dieses Gerät ist derzeit mit einer anderen FLUX-ID verknüpft. Sie können es weiter verwenden oder mit Ihrem Konto verknüpfen.',
    link_failed_cannot_set_secret: 'Verknüpfungsinformationen können nicht auf dem Gerät gespeichert werden. Bitte überprüfen Sie die Verbindung zwischen Computer und Gerät.',
    link_failed_under_age: 'Sie erfüllen derzeit nicht die Voraussetzungen für die Nutzung dieses Dienstes und können die Geräteverknüpfung nicht abschließen.',
    link_machine: 'FLUX-ID verknüpfen',
    link_machine_to_account: 'Verbunden mit %(name)s. Möchten Sie dieses Gerät mit Ihrem Konto verknüpfen?',
    link_success: 'Verknüpfung erfolgreich.',
    link_to_my_flux_id: 'Mit meiner FLUX-ID verknüpfen',
    privacy_policy: 'Datenschutzrichtlinie',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Verknüpfen…',
    use_without_linking: 'Ohne Verknüpfung verwenden',
  },
  machine_status: {
  ...
  maintenance: {
    ...
    cadence: {
      ...
      day: 'Jeden Tag',
      days: 'Alle %s Tage',
      each_operation: 'Bei jedem Einsatz',
      every_1_2_weeks: 'Alle 1–2 Wochen',
      month: 'Jeden Monat',
      months: 'Alle %s Monate',
      upon_unboxing: 'Beim ersten Auspacken',
      week: 'Jede Woche',
      weeks: 'Alle %s Wochen',
    },
    celebration: {
    ...
    feedback: {
      ...
      fail_warning: '%s: zum Austausch der Laserröhre markiert. Öffnen Sie die Anleitung für die Schritte.',
      passed: '%s bestanden — die Laserröhre ist in Ordnung!',
    },
    footer_tip: 'Tipp: Gravieren Sie monatlich eine Beispieldatei, um die Maschine in gutem Zustand zu halten.',
    history_hint: 'Pro Aufgabe werden nur die %s neuesten Einträge gespeichert.',
    intro: 'Verfolgen Sie jede Wartungsaufgabe für diese Maschine und markieren Sie sie mit einem Klick als erledigt.',
    legend: {
    ...
    machine_groups: {
      my_machines: 'Meine Maschinen',
      other_models: 'Andere Modelle',
    },
    ...
    status: {
      ...
      not_logged: 'Nicht erfasst',
      overdue: 'Überfällig',
      replace_tube: 'Röhre tauschen',
    },
    tasks: {
      align: {
        keyPoints: 'Justieren Sie, wenn der Strahlengang nicht ausgerichtet ist.',
        name: 'Justierung des Strahlengangs',
      },
      chassis: {
        keyPoints: 'Entfernen Sie Rückstände und Teeröl vom Gehäuse und von der Bodenabdeckung.',
        name: 'Gehäusereinigung',
      },
      door: {
        keyPoints: 'Entfernen Sie Fett von der Türabdeckung.',
        name: 'Reinigung der Türabdeckung',
      },
      exhaust: {
        keyPoints: 'Reinigen Sie die Lüfterflügel von Staub.',
        name: 'Reinigung des Abluftlüfters',
      },
      fan: {
        keyPoints: 'Entfernen Sie Staub von den Flügeln des Lüftungslüfters.',
        name: 'Reinigung des Lüftungslüfters',
      },
      fieldlens: {
        keyPoints: 'Reinigen Sie das Feldobjektiv, indem Sie von der Mitte nach außen im Uhrzeigersinn wischen.',
        name: 'Reinigung des Feldobjektivs',
      },
      honeycomb_plate: {
        keyPoints: 'Entfernen Sie Rückstände und Teer aus den Gittern der Wabenplatte.',
        name: 'Reinigung der Wabenplatte',
      },
      honeycomb_table: {
        keyPoints: 'Entfernen Sie Rückstände und Teeröl vom Wabengitter.',
      ...
      maintain_test: {
        keyPoints: 'Prüfen Sie die Statusanzeige und die Schalter.',
        name: 'MAINTAIN-Seite',
      },
      mirrors_combiner: {
        keyPoints: 'Entfernen Sie Schmutz von Linsen/Spiegeln und prüfen Sie sie auf Oxidation. Es dürfen keine Alkohol- oder Wasserflecken zurückbleiben.',
        name: 'Spiegel, Fokuslinse & Strahlkombinierer',
      },
      mirrors_lens: {
        keyPoints: 'Reinigen Sie die 4 Spiegel und die Linse; achten Sie darauf, dass keine Oxidation oder Wasserflecken bleiben.',
        name: 'Reinigung der Spiegel & Linse',
      },
      mod_diode: {
        keyPoints: 'Reinigen Sie den Lüfter, die Fokuslinse und den POGO pin.',
        name: 'Diodenlasermodul',
      },
      mod_ir: {
        keyPoints: 'Reinigen Sie die Fokuslinse.',
        name: 'Infrarot-Lasermodul',
      },
      optical_inspection: {
        keyPoints: 'Prüfen Sie den Strahlengang; auch beim Auspacken und nach einem Röhrenwechsel.',
        name: 'Prüfung des Strahlengangs',
      },
      optical_unboxing: {
        keyPoints: 'Stellen Sie sicher, dass der Strahlengang exakt ist. Prüfen Sie dies beim ersten Auspacken.',
        name: 'Prüfung des Strahlengangs',
      },
      screen: {
        keyPoints: 'Entfernen Sie Staub und Fett vom Bedienfeld.',
        name: 'Bildschirmreinigung',
      },
      tube: {
        keyPoints: 'Wenn 3 mm Acryl bei 70% Leistung nicht geschnitten werden kann, tauschen Sie die Laserröhre.',
        name: 'Zustandsprüfung der Laserröhre',
      },
      water: {
        keyPoints: 'Füllen Sie Wasser nach, bis über 80% gefüllt sind und keine Luftblasen vorhanden sind.',
        name: 'Kühlwasserwechsel',
      },
      worktable: {
        keyPoints: 'Sprühen Sie Alkohol auf ein Tuch und wischen Sie damit den Arbeitstisch ab.',
        name: 'Reinigung des Arbeitstisches',
      },
      zaxis: {
        keyPoints: 'Wischen Sie die Spindel der Z-Achsen-Säule ab und tragen Sie das Schmiermittel mit einem Wattestäbchen gleichmäßig auf.',
        name: 'Schmierung der Z-Achsen-Säule',
      },
    },
  ...
  params_label: {
    ...
    placeholder: 'Parameterbeschriftung',
    preview_hint: 'Dies ist eine Vorschau. Die Textinhalte werden vor dem Senden eines Auftrags automatisch aktualisiert',
    save_as_default: 'Als Standard speichern',
    settings: 'Einstellungen für Parameterbeschriftung',
    update: 'Aktualisieren',
    updated: 'Parameterbeschriftung aktualisiert',
    use_default: 'Gespeicherten Standard verwenden',
    use_recommended: 'Empfohlene verwenden',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      ...
      capturing: 'Bild wird aufgenommen',
      completing: 'Wird gleich abgeschlossen',
      detecting: 'Passermarken werden erkannt',
      locating: 'Passermarken werden gesucht',
      preparing: 'Kamera wird vorbereitet',
      refining: 'Markenposition wird verfeinert',
    },
    alignment: {
    ...
    calibration: {
      align_desc: '1. Legen Sie das gedruckte Kalibrierblatt in den Arbeitsbereich, fixieren Sie es mit Klebeband oder Malerkrepp, damit es nicht verrutscht, und stellen Sie den Fokus ein.\n2. Klicken Sie auf „Vorschau und Ausrichtung“, um die Kameraausrichtung zu starten.\n3. Sobald die Marken gefunden wurden, klicken Sie auf „Skalen ritzen“, um die Referenzlinien mit niedriger Leistung auf das Blatt zu ritzen.',
      aligned: 'Passermarken erkannt. Bereit zum Ritzen.',
      auto_read: 'Skalen per Kamera ablesen',
      auto_read_failed: 'Die Skalen konnten nicht automatisch abgelesen werden. Bitte von Hand ablesen und die Werte eingeben.',
      auto_read_hint: 'Der Kamerawert kann um bis zu ±2 abweichen; bitte am Blatt überprüfen.',
      current_offset: 'Aktueller Versatz: X %s mm, Y %s mm',
      export_pdf: 'Kalibrier-PDF exportieren',
      power: 'Leistung',
      print_desc: '1. Exportieren Sie das PDF des Kalibrierblatts. Es enthält die vier Passermarken und zwei Skalen.\n2. Drucken Sie das Blatt in 100 % (Originalgröße).',
      reading_desc: '1. Suchen Sie die längste geritzte Linie (die mittlere) und merken Sie sich, auf welcher Seite der gedruckten 0-Linie sie liegt.\n2. Gehen Sie Linie für Linie in diese Richtung, bis eine geritzte und eine gedruckte Linie genau fluchten.\n3. Zählen Sie von 0 bis zu dieser gedruckten Linie (Zahlen sind an jeder 5. Linie gedruckt; zählen Sie die unnummerierten dazwischen mit).',
      reading_x: 'Ablesung X',
      reading_y: 'Ablesung Y',
      scratch: 'Skalen ritzen',
      speed: 'Geschwindigkeit',
      title: 'Drucken und Schneiden-Kalibrierung',
    },
    ...
    fit_content: 'An Inhalt anpassen',
    generate_from_contour: 'Aus Kontur erzeugen',
    ...
    paper_size: 'Ausgabegröße',
    paper_too_small: 'Der Ausgabebereich ist zu klein. Das Design (einschließlich Passermarken) benötigt mindestens %s mm Abstand zum Materialrand, um innerhalb des druckbaren Bereichs des Druckers zu bleiben. Wählen Sie eine größere Ausgabegröße, sonst wird der Druck beschnitten oder verkleinert.',
    preview_and_align: 'Vorschau und Ausrichtung',
    resume_desc: 'Dieses Design ist bereits für Drucken und Schneiden vorbereitet.\nLegen Sie das nächste bedruckte Material in die Maschine und fahren Sie mit der Kameraausrichtung fort, oder beginnen Sie neu, um Design, Ausgabegröße oder Schneidpfad zu ändern.',
    resume_title: 'Drucken und Schneiden fortsetzen',
    select_cut_layer: 'Ebene mit Schneidpfad',
    ...
    step_setup: 'Schneidpfade & Marken',
    ...
    uv_print_file_disabled: 'Drucken und Schneiden druckt den Inhalt der UV-Druck-Ebenen. Bitte aktivieren Sie „UV-Druckdatei aktivieren“ in den Einstellungen und fügen Sie Ihr Design dann einer UV-Druck-Ebene hinzu.',
  ...
  puzzle_generator: {
    ...
    export_engrave: 'Gravurebene',
    export_failed: 'Puzzle konnte nicht auf Leinwand importiert werden. Bitte versuchen Sie es erneut oder passen Sie die Puzzle-Einstellungen an.',
    export_none: 'Keine',
    export_print: 'Druckebene',
    file_too_large: 'Die ausgewählte Datei überschreitet die maximal zulässige Größe.',
    ...
    piece_size: 'Teilegröße',
    preview_placeholder: 'Puzzle-Vorschau',
    puzzle_board: 'Puzzle-Brett',
    puzzle_pieces: 'Puzzleteile',
    radius: 'Radius',
    ...
    types: {
      ...
      heart_jigsaw: 'Herzförmiges Puzzle',
      hex_jigsaw: 'Sechseckiges Puzzle',
      rectangle_jigsaw: 'Rechteckiges Puzzle',
    },
    unsupported_file_type: 'Nicht unterstützter Dateityp. Bitte verwenden Sie JPG, PNG oder WebP.',
    upload_hint: 'JPG, PNG, WebP (max. 10MB)',
    upload_image: 'Klicken oder ziehen zum Hochladen',
    zoom: 'Zoom',
  },
  qr_code_generator: {
  ...
  settings: {
    ...
    check_updates: 'Automatisch nach Updates suchen',
    close: 'Schließen',
    ...
    show_banners: 'Startseitenbanner anzeigen',
  ...
  tips: {
    canvas_hold_space_to_pan: 'Halten Sie die Leertaste gedrückt und ziehen Sie, um über die Leinwand zu schwenken.',
    feature_auto_fit: 'Nach der Kameravorschau verwenden Sie Aktionen → Auto Fit, um Objekte automatisch auf Ihrem Material zu platzieren.',
    feature_box_generator: 'Verwenden Sie Generatoren → Box-Generator, um in Sekunden Boxen in individueller Größe zu erstellen.',
    feature_code_generator: 'Verwenden Sie Generatoren → Barcode-Generator, um QR-Codes und Barcodes zu erstellen.',
    feature_elements: 'Das Elements-Panel enthält jetzt über eine Million Grafiken, die sofort einsatzbereit sind.',
    feature_layer_color_configurations: 'Ordnen Sie SVG-Ebenenfarben über Bearbeiten → Ebene → Farbeinstellungen zu Geschwindigkeit und Leistung zu.',
    feature_material_test: 'Verwenden Sie Generatoren → Material-Test-Generator in der linken Symbolleiste, um schnell die besten Einstellungen für ein Material zu finden.',
    layer_execution_order: 'Die Ebenenreihenfolge bestimmt die Auftragsreihenfolge. Aufträge werden von oben nach unten ausgeführt.',
    machine_clean_mirror: 'Überprüfen Sie regelmäßig die Spiegel und Fokuslinse und reinigen Sie sie bei Bedarf, um Rauchansammlungen zu verhindern.',
    machine_no_unattended_operation: 'Lassen Sie die Maschine niemals unbeaufsichtigt laufen.',
    machine_regular_start: 'Führen Sie mindestens alle zwei Wochen einen Laserauftrag aus, um die Lebensdauer der Laserröhre zu verlängern.',
    object_edit_image_to_erase: 'Verwenden Sie Bild → Aktionen → Bild bearbeiten, um unerwünschte Bereiche in einem Bild zu löschen.',
    object_polygon_sides: 'Passen Sie die Anzahl der Seiten im Eigenschaften-Panel des Polygons an.',
    object_rounded_rectangle: 'Legen Sie den Eckradius eines abgerundeten Rechtecks im Eigenschaften-Panel des Rechtecks fest.',
    object_sharpen_portrait: 'Verbessern Sie Portraitgravuren mit Bild → Aktionen → Schärfen.',
    settings_auto_save: 'Aktivieren Sie Automatisches Speichern in den Einstellungen, um den Verlust Ihrer Arbeit zu vermeiden.',
    settings_default_text_font: 'Sie können Ihre Standardschriftart für das Text-Tool in den Einstellungen festlegen.',
    task_focus_lower_for_cutting: 'Bei dickeren Materialien kann eine Fokussierung etwa 2 mm unterhalb der Oberfläche die Schneideergebnisse verbessern.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Verbindung zur Maschinenkamera konnte nicht hergestellt werden. Bitte starten Sie Ihren Maschinen oder Beam Studio neu. Wenn dieser Fehler weiterhin besteht, befolgen Sie <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">diese Anleitung</a>.',
      ...
      fail_to_start_preview: '#803 Fehler beim Starten des Vorschaumodus. Bitte starten Sie Ihren Maschinen oder Beam Studio neu. Wenn dieser Fehler weiterhin besteht, befolgen Sie <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">diese Anleitung</a>.',
      ...
      start_preview_timeout: '#803 Beim Starten des Vorschaumodus ist eine Zeitüberschreitung aufgetreten. Bitte starten Sie Ihren Maschinen oder Beam Studio neu. Wenn dieser Fehler weiterhin besteht, befolgen Sie <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">diese Anleitung</a>.',
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Drucken und Schneiden kalibrieren',
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Kalibrierungsdaten exportieren',
      ...
      import_hexa_rf_example: 'Beispiel für HEXA RF',
      ...
      import_promark_engraving_example_1: 'Promark-Gravurbeispiel I',
      import_promark_engraving_example_2: 'Promark-Gravurbeispiel II',
      ...
      machines: 'Maschinen',
      maintenance_checklist: 'Wartungs-Checkliste',
    ...
    tag_names: {
      ...
      params_label: 'Parameterbeschriftung',
