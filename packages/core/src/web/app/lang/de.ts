...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Position: Richten Sie sich am gravierten Punkt oben links aus.',
    align_4_1: 'Position: Richten Sie sich am gravierten Punkt oben rechts aus.',
    align_4_2: 'Position: Richten Sie sich am gravierten Punkt unten links aus.',
    align_4_3: 'Position: Richten Sie sich am gravierten Punkt unten rechts aus.',
    align_8_0: 'Position: Richten Sie sich am gravierten Punkt oben links außen aus.',
    align_8_1: 'Position: Richten Sie sich am gravierten Punkt oben rechts außen aus.',
    align_8_2: 'Position: Richten Sie sich am gravierten Punkt unten links außen aus.',
    align_8_3: 'Position: Richten Sie sich am gravierten Punkt unten rechts außen aus.',
    align_8_4: 'Position: Richten Sie sich am gravierten Punkt oben links innen.',
    align_8_5: 'Position: Richten Sie sich am gravierten Punkt oben rechts innen.',
    align_8_6: 'Position: Richten Sie sich am gravierten Punkt unten links innen.',
    align_8_7: 'Position: Richten Sie sich am gravierten Punkt unten rechts innen.',
    ...
    charuco_open_the_machine_lid: 'Öffnen Sie den Maschinen-Deckel.',
    charuco_place_charuco: 'Platzieren Sie das gedruckte Kalibrierungsmuster waagerecht am <b>%s</b> des Arbeitsbereichs.',
    ...
    check_pnp_desc: 'Wir haben die Bilder basierend auf den Kalibrierungsergebnissen erneut aufgenommen und die Referenzpunkte für die Gravur markiert.\nBitte überprüfen Sie, ob die roten Markierungen mit den tatsächlichen Gravurpunkten übereinstimmen.\nWenn Sie eine deutliche Abweichung feststellen, klicken Sie einfach auf „Erneut kalibrieren“, um es erneut zu versuchen.',
    ...
    recalibrate: 'Erneut kalibrieren',
    ...
    solve_pnp_keep_door_closed: 'Halten Sie die Tür während des folgenden Vorgangs geschlossen. Wenn die Tür geöffnet wird, versucht das System, die Kamera neu zu positionieren.',
    ...
    solve_pnp_relocate_camera: 'Klicken Sie auf „Kamera neu positionieren", wenn der Laserkopf noch nicht horizontal zentriert ist.',
  ...
  settings: {
    ...
    module_offset_4c: 'Druck (4C) Versatz',
    ...
    module_offset_uv_varnish: 'Lack-Versatz',
    module_offset_uv_white_ink: 'Weißtinten-Versatz',
    none: 'Keiner',
    normal: 'Normal',
