...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Die Verwendung zu hoher Geschwindigkeiten für Schichten mit 3D-Kurvenobjekten kann die Gravurpräzision verringern.\nWir empfehlen, die Geschwindigkeit unter %(limit)s zu halten, um optimale Ergebnisse mit 3D-Kurvenobjekten zu erzielen.',
      too_fast_for_curve_and_constrain: 'Folgende Schichten: %(layers)s überschreiten das Geschwindigkeitslimit von %(limit)s.\nDie Gravurgeschwindigkeit für 3D-Kurvenobjekte wird auf %(limit)s begrenzt. Sie können dieses Limit in den Einstellungen entfernen.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'Die Gravurgeschwindigkeit von 3D-Kurvenobjekten wird auf %(limit)s begrenzt. Sie können diese Begrenzung in den Voreinstellungen entfernen.',
