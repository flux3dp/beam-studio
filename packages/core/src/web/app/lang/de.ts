    ...
    material_browser: {
      ...
      catalog: {
        ...
        presets: {
          ...
          engraving_quality: 'Gravur (Qualität)',
      ...
      editor: {
        ...
        parent_hint: 'Falls gesetzt, wird es als Dickenvariante unter dem übergeordneten Material angezeigt (nicht im oberen Raster).',
        parent_material: 'Übergeordnetes Material',
        photo: 'Foto',
        tags: 'Tags',
        thickness_inch: 'Dicke (Zoll)',
        thickness_inch_hint: 'Bruchzahlen sind erlaubt',
