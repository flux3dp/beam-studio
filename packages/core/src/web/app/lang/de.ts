...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_1: 'Schachbrett drucken (A4/Letter).',
    put_chessboard_2: 'Flach auf eine feste Platte kleben.',
    put_chessboard_3: 'Mittig platzieren und Autofokus durchführen.',
