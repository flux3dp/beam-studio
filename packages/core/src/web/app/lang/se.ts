...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Position: Justera efter det graverade punkten i övre vänstra hörnet.',
    align_4_1: 'Position: Justera efter det graverade punkten i övre högra hörnet.',
    align_4_2: 'Position: Justera efter det graverade punkten i nedre vänstra hörnet.',
    align_4_3: 'Position: Justera efter det graverade punkten i nedre högra hörnet.',
    align_8_0: 'Position: Justera med den graverade punkten på utsidan uppe till vänster.',
    align_8_1: 'Position: Justera med den graverade punkten på utsidan uppe till höger.',
    align_8_2: 'Position: Justera med den graverade punkten på utsidan nere till vänster.',
    align_8_3: 'Position: Justera med den graverade punkten på utsidan nere till höger.',
    align_8_4: 'Position: Justera med den graverade punkten på insidan uppe till vänster.',
    align_8_5: 'Position: Justera med den graverade punkten på insidan uppe till höger.',
    align_8_6: 'Position: Justera med den graverade punkten på insidan nere till vänster.',
    align_8_7: 'Position: Justera med den graverade punkten på insidan nere till höger.',
    ...
    charuco_open_the_machine_lid: 'Öppna maskinens lock.',
    charuco_place_charuco: 'Placera det utskrivna kalibreringsmönstret horisontellt på <b>%s</b> av arbetsytan.',
    ...
    check_pnp_desc: 'Vi har tagit om bilderna baserat på kalibreringsresultaten och markerat graveringsreferenspunkterna.\nKontrollera om de röda markörerna stämmer överens med de faktiska graveringspunkterna.\nOm du ser någon tydlig avvikelse, klicka bara på "Kalibrera om" för att försöka igen.',
    ...
    solve_pnp_keep_door_closed: 'Håll dörren stängd under följande process. Om dörren öppnas försöker systemet flytta kameran igen.',
    ...
    solve_pnp_relocate_camera: 'Klicka på "Flytta kamera" om laserhuvudet fortfarande inte är horisontellt centrerat.',
  ...
  settings: {
    ...
    module_offset_4c: 'Utskriftsförskjutning (4C)',
    ...
    module_offset_uv_varnish: 'Lackförskjutning',
    module_offset_uv_white_ink: 'Vit bläckförskjutning',
    none: 'Ingen',
    normal: 'Normal',
    notification_off: 'Av',
    notification_on: 'På',
  ...
  topbar: {
    ...
    menu: {
      ...
      import_beamo_2_printing_example_full: 'Exempel på beamo II Utskrift - Flerfärg',
