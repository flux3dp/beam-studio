...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'Utdatastorleken (%s) överskrider det rekommenderade maxvärdet %d × %d px. Bearbetningen kan ta flera minuter och resultatet kan göra Beam Studio långsammare. Fortsätt ändå?',
