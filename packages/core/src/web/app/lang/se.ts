    ...
    material_browser: {
      ...
      catalog: {
        ...
        presets: {
          ...
          engraving_quality: 'Gravyr (kvalitet)',
      ...
      editor: {
        ...
        parent_hint: 'Om det anges visas det som en tjockleksvariant under sitt överordnade material (inte i det övre rutnätet).',
        parent_material: 'Överordnat material',
        photo: 'Foto',
        tags: 'Taggar',
        thickness_inch: 'Tjocklek (tum)',
        thickness_inch_hint: 'Bråktal är tillåtna',
