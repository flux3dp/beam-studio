...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Hur kan detektionsnoggrannheten förbättras?',
    ...
    retake: 'Ta om bild',
    retake_tooltip: 'Ta om kamerafoto vid varje objekts position för bättre detektering',
    retry_with_remove_bg: 'Ta bort bakgrund',
    retry_with_remove_bg_tooltip: 'Ta bort bakgrund från förhandsvisningsbilden för att förbättra konturdetektering',
    rotation: 'Rotera',
    ...
    use_original_image_tooltip: 'Återställ den ursprungliga förhandsvisningsbilden utan bakgrundsborttagning',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s AI-krediter',
      credit_balance: 'AI-kreditsaldo',
      credit_cost: 'Använda AI-krediter',
      description: 'Öka bildens upplösning och detaljer med AI. Den uppskalade bilden ersätter originalet på arbetsytan.',
      done: 'Generativ uppskalning slutförd',
      dpi_recommended: 'Rekommenderas för aktuell lager-DPI: %dx.',
      dpi_recommended_capped: 'Rekommenderas för aktuell lager-DPI: %dx, men %dx är det största inom rekommenderad utdatastorlek.',
      failed: 'Generativ uppskalning kunde inte slutföras. Kontrollera din nätverksanslutning och försök igen.',
      insufficient_credit: 'Otillräckliga AI-krediter för att köra generativ uppskalning.',
      layer_dpi: 'Lager-DPI',
      original_size: 'Ursprunglig storlek',
      output_size: 'Utdatastorlek',
      oversize_warning: 'Utdatastorleken (%s) överskrider det rekommenderade maxvärdet %dpx x %dpx. Bearbetningen kan ta flera minuter och resultatet kan göra Beam Studio långsammare. Fortsätt ändå?',
      processing: 'Skalar upp…',
      processing_hint: 'Bearbetningstiden beror på bildstorlek och nätverksförhållanden.',
      recommended: 'Rekommenderas',
      retry: 'Försök igen',
      start: 'Starta uppskalning',
    },
    announcement_panel: {
      title: 'Meddelande',
    },
    ...
    document_panel: {
      ...
      prespray_times: 'Antal rengöringar',
    ...
    left_panel: {
      ...
      label: {
        ...
        preview_precise: 'Exakt kameraförhandsgranskning',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Koppla till material',
        bucket_hint: 'Sparat i din samling “Mina material” (Övrigt). Du kan flytta det till ett material senare.',
        create_new: 'Skapa nytt material…',
        new_material_name: 'Namn på nytt material',
        preset_name: 'Namn på förinställning',
        settings_from_layer: 'Inställningar kopierade från aktuellt lager',
        title: 'Spara aktuella lagerinställningar som förinställning',
      },
      add_material: 'Lägg till material',
      add_preset: 'Lägg till förinställning',
      apply: 'Tillämpa',
      back_to_catalog: 'Tillbaka till katalogen',
      buy_on_shop: 'Köp i butiken',
      catalog: {
        materials: {
        ...
        presets: {
          cutting: 'Skärning',
          engraving: 'Gravering',
          engraving_diode: 'Gravering (diod)',
          engraving_fiber: 'Gravering (fiber)',
          engraving_spray: 'Gravering (spray)',
          kiss_cut: 'Kiss cut',
          marking: 'Märkning',
          marking_dark: 'Mörk märkning',
          marking_light: 'Ljus märkning',
          printing: 'Utskrift',
          printing_fabric: 'Utskrift (tyg)',
        },
      },
      categories: {
        acrylic: 'Akryl',
      ...
      editor: {
        appearance: 'Utseende',
        appearance_hint: 'Inget foto? Välj en omslagsfärg i stället.',
        category: 'Kategori',
        ...
        photo: 'Foto',
        tags: 'Taggar',
        title_add: 'Lägg till material',
        title_edit: 'Redigera material',
        upload_hint: 'Klicka eller dra ett foto hit. Stor förhandsvisning visas i galleriet.',
      },
      enable: 'Aktivera',
      export: 'Exportera',
      favorites: 'Favoriter',
      from_current_layer: 'Från aktuellt lager',
      import: 'Importera',
      machine: 'Maskin',
      manual: 'Manuell',
      manual_settings: 'Manuella inställningar',
      modified: 'Parametrar har ändrats sedan förinställningen tillämpades',
      move_to_material: 'Flytta till material…',
      new_preset_manual: 'Ny förinställning…',
      no_materials_in_category: 'Inga material här för %s ännu.',
      no_presets_for_machine: 'Inga inställningar för %s ännu.',
      no_search_match: 'Inga material matchar “%s”.',
      preset_editor: {
        name: 'Namn på förinställning',
        name_required: 'Namn krävs',
        title_edit: 'Redigera förinställning',
        title_new: 'Ny förinställning',
      },
      presets: 'Förinställningar',
      recents: 'Senaste',
      recents_empty: 'Nyligen tillämpade material visas här.',
      regions: {
        auto: 'Automatisk',
        eu: 'Europa',
        global: 'Global',
      ...
      restore_default: 'Återställ FLUX-standard',
      result: 'Resultat',
      search_placeholder: 'Sök material, taggar, kategorier…',
      settings_region: 'Region för materialkatalog',
      settings_use: 'Använd materialbläddrare',
      showing_bundled: 'Visar inbyggd katalog',
      state_customized: 'Anpassad',
      state_default: 'Standard',
      state_disabled: 'Inaktiverad',
      state_user: 'Användardefinierad',
      storage_full: 'Lagringsutrymmet är fullt, materialbiblioteket kunde inte sparas. Använd färgomslag i stället för foton.',
      sure_to_delete_material: 'Vill du ta bort detta material och alla dess förinställningar?',
      sure_to_delete_preset: 'Vill du ta bort denna förinställning?',
      sure_to_delete_variant: 'Ta bort denna tjocklek och dess förinställningar?',
      sure_to_import: 'Import kommer att slå samman filen med ditt materialbibliotek. Vill du fortsätta?',
      thickness: 'Tjocklek',
      title: 'Materialbläddrare',
      variant_exists: 'En variant med denna tjocklek finns redan.',
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: 'Snabbare jobbgenerering tillgänglig',
        keep_current: 'Behåll nuvarande',
        message: 'Vi har uppgraderat jobbberäkningsmotorn för att förbättra prestanda och snabba upp jobbgenereringen.\nVill du byta till den nya accelererade motorn?\nDu kan stänga av den när som helst i %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'I kurvgraveringsläge kan den aktuella hastigheten vara för hög och kan påverka graveringsdetaljerna för lager: %(layers)s.\nÖverväg att minska hastigheten för bättre kvalitet.',
    ...
    right_panel: {
      laser_panel: {
        ...
        texture_interval: 'Intervall',
        texture_random: 'Slumpmässig',
        texture_stripe: 'Ränder',
        times: 'gånger',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Generativ uppskalning',
          ai_upscale_short: 'Uppskalning',
          ai_upscale_too_large: 'Denna bild är för stor för AI-uppskalning. Den största storleken som stöds är %dpx x %dpx.',
          array: 'Fält',
          auto_fit: 'Auto Fit',
          bevel: 'Fasa',
          brightness: 'Ljusstyrka',
          ...
          disabled_by_noun_project: 'Denna form skyddas av immaterialrättslagen, därför kan dess bana inte redigeras.',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Flytta laserhuvudet för att rikta det röda ljuset mot mitten av <b>punkt A</b>.',
    charuco_move_to_point_b: 'Flytta laserhuvudet horisontellt för att rikta det röda ljuset mot mitten av <b>punkt B</b>.',
    ...
    check_pnp_desc: 'Se till att de röda markörerna är justerade med graveringspunkterna\nOm inte, klicka på "Bakåt" för att justera.\nOm allt ser bra ut, bra jobbat! 🎉',
    ...
    put_charuco: 'Placera kalibreringsmönstret',
    put_charuco_1: 'Skriv ut kalibreringsmönstret (A4/Letter).',
    put_charuco_2: 'Fäst det platt på en styv skiva.',
    put_charuco_3: 'Placera i mitten och utför autofokus.',
    put_charuco_bm2_1: 'Skriv ut kalibreringsmönsterfilen på A4- (Letter Size) papper för kalibrering.',
    put_charuco_bm2_2: 'Klicka på “Nästa” och följ guiden för att placera pappret.',
    put_charuco_promark_2: "Se till att kalibreringspapperet är tydligt synligt utan bländning. Klicka på 'Nästa' för att ta ett foto.",
    put_charuco_promark_desc_1: 'Använd kalibreringspapperet från tillbehörslådan eller skriv ut följande kalibreringsmönster på A4‑papper för kamerakalibrering.',
    ...
    put_paper_promark: 'Lägg Svart Kartong',
    put_paper_promark_1: 'Placera det svarta kartongarket från tillbehörslådan på arbetsplattformen.',
    put_paper_promark_2: 'Justera fokuset korrekt och klicka sedan på "Starta Gravyr" för att fortsätta.',
    ...
    res_poor: 'Dålig',
    reset_points: 'Återställ punkter',
    retake: 'Ta om bild',
  ...
  connection_issue_guide: {
    alert_link: 'Kopplas den frånkopplad? Prova den här felsökningsmetoden.',
    connect_computer: {
      content: 'Din dator måste vara på samma nätverk som maskinen.',
      macos_steps: 'Klicka på Wi-Fi-ikonen i menyraden. Välj sedan din telefons hotspot.',
      macos_title: 'macOS',
      title: 'Anslut din dator',
      windows_steps: 'Klicka på nätverksikonen i aktivitetsfältet. Välj sedan din telefons hotspot.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Maskinen kan inte hitta min hotspot',
      dont_know_hotspot_name: 'Jag vet inte namnet på min hotspot',
      step1: '1. Gå till följande på maskinens pekskärm: Nätverk → Anslut till Wi-Fi.',
      step2: '2. Hitta och välj din telefons hotspot-namn i Wi-Fi-listan.',
      step3: '3. Ange hotspot-lösenordet och anslut.',
      title: 'Anslut maskinen till telefonens hotspot',
    },
    enter_ip: {
      check_firmware: 'Firmware-version',
      check_ip_reachable: 'IP nåbar',
      check_machine_responds: 'Maskinen svarar',
      placeholder: 'IP-adress',
      step1: 'Ange IP-adressen som du hittade i föregående steg.',
      step2: 'Klicka på "Verifiera" för att testa anslutningen.',
      step3: 'Beam Studio kontrollerar:',
      title: 'Ange maskinens IP-adress',
      verify: 'Verifiera',
    },
    fail: {
      bullet1: '• Din maskinmodell och serienummer',
      bullet2: '• IP-adressen som visas på pekskärmen',
      bullet3: '• En beskrivning av felet du stötte på',
      contact_title: 'När du kontaktar supporten är det bra att ha följande till hands:',
      intro: 'Oroa dig inte — detta betyder inte nödvändigtvis att något är fel med din maskin. Det kan finnas ytterligare faktorer som påverkar anslutningen. Vårt supportteam finns här för att hjälpa dig att reda ut det.',
      title: 'Vi kunde inte slutföra testet',
    },
    hotspot: {
      android_steps: 'Inställningar → Anslutningar → Mobil hotspot och internetdelning → Mobil hotspot',
      android_title: 'Android',
      ios_steps: 'Inställningar → Internetdelning → Tillåt andra att ansluta',
      ios_title: 'iPhone (iOS)',
      tip: 'Tips: Använd ett enkelt engelskt hotspot-namn och ett numeriskt lösenord (t.ex. Namn: FLUX_Test   Lösenord: 12345678)',
      warning_2_4ghz: 'Viktigt: FLUX-maskiner stöder endast 2.4GHz Wi-Fi. Ställ in din hotspot på 2.4GHz innan du fortsätter.',
    },
    how_it_works: 'Så här fungerar testet:',
    how_it_works_step1: '1. Konfigurera din telefon som en Wi-Fi-hotspot.',
    how_it_works_step2: '2. Anslut maskinen till hotspotten.',
    how_it_works_step3: '3. Anslut din dator till samma hotspot.',
    how_it_works_step4: '4. Testa anslutningen i Beam Studio.',
    intro: 'Låt oss köra ett snabbt test för att kontrollera om din maskin fungerar som den ska. Vi ansluter din maskin och dator via din mobiltelefons hotspot för att avgöra om problemet ligger i ditt nätverk eller i själva maskinen.',
    ip_address: {
      step1: 'Gå till följande på maskinens pekskärm:\nNätverk → Leta efter "IP-adress"',
      step2: 'IP-adressen ser vanligtvis ut så här: 172.20.10.x eller 192.168.x.x\n(Detta beror på din telefons hotspot)',
      step3: 'Skriv ner denna IP-adress för nästa steg.',
      title: 'Hitta maskinens IP-adress',
      warning: 'Om IP-adressen börjar med 169.254 misslyckades anslutningen. Gå tillbaka till Steg 1 och försök igen.',
    },
    success: {
      cause: 'Anslutningsproblemet du upplevde beror troligtvis på din lokala nätverksmiljö och inte på själva maskinen.',
      intro: 'Du har slutfört Wi-Fi-anslutningstestet — bra jobbat! Detta bekräftar att din FLUX-maskin fungerar perfekt.',
      recommend1: '• Kontakta din internetleverantör (ISP) eller routertillverkare för hjälp med dina Wi-Fi-inställningar',
      recommend2: '• Fråga din nätverksadministratör om du är på en skola, ett kontor eller en delad arbetsplats',
      recommend3: '• Kontrollera om din router stöder 2.4GHz och försök starta om den',
      recommend_title: 'Vad vi rekommenderar:',
      title: 'Bra jobbat! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'Nyckelringsgenerator',
    material_test_generator: 'Materialtestgenerator',
    puzzle_generator: 'Pusselgenerator',
    title: 'Generatorer',
  },
  generic_error: {
  ...
  initialize: {
    ...
    Maskiner > "Promark Namn" > Promark-inställningar`,
      ...
      setting_completed_ask_camera_calibration: 'Promark-fältlinsinstallationen har slutförts! Vill du fortsätta med kamerakalibrering?',
    ...
    select_promark: 'Välj din Promark',
    setting_completed: {
      back: 'Tillbaka',
  ...
  keychain_generator: {
    ...
    text_options: {
      ...
      font_settings: 'Teckensnittsinställningar',
      font_size: 'Teckenstorlek',
      font_style: 'Teckensnittstil',
  ...
  machine_linking: {
    continue: 'Fortsätt',
    i_have_read: 'Jag har läst',
    input_birthday_to_link: 'Ange ditt födelsedatum för att slutföra enhetslänkningen',
    input_birthday_to_link_note: '*Används för att verifiera om din ålder uppfyller behörighetskraven',
    link_failed: 'Länkning misslyckades.',
    link_failed_already_linked: 'Den här enheten är för närvarande länkad till ett annat FLUX ID. Du kan fortsätta använda den eller länka den till ditt konto.',
    link_failed_cannot_set_secret: 'Kan inte spara länkinformation på enheten. Kontrollera anslutningen mellan datorn och enheten.',
    link_failed_under_age: 'Du uppfyller för närvarande inte kraven för att använda denna tjänst och kan inte slutföra enhetslänkningen.',
    link_machine: 'Länka FLUX ID',
    link_machine_to_account: 'Ansluten till %(name)s. Vill du länka denna enhet till ditt konto?',
    link_success: 'Länkning lyckades.',
    link_to_my_flux_id: 'Länka till mitt FLUX ID',
    privacy_policy: 'Integritetspolicy',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Länkar…',
    use_without_linking: 'Använd utan länkning',
  },
  machine_status: {
    '-17': 'Patron I/O-läge',
    '-10': 'Underhållsläge',
  ...
  maintenance: {
    ...
    areas: {
      back_cover: 'Bakre lucka',
      modules: 'Moduler',
      optics: 'Optik',
      panel: 'Panel',
      working_area: 'Arbetsområde',
    },
    cadence: {
      by_material: 'Efter material',
      condition: 'Vid behov',
      day: 'Varje dag',
      days: 'Var %s dag',
      each_operation: 'Vid varje användning',
      every_1_2_weeks: 'Var 1–2 veckor',
      month: 'Varje månad',
      months: 'Var %s månad',
      upon_unboxing: 'Vid första uppackningen',
      week: 'Varje vecka',
      weeks: 'Var %s vecka',
    },
    celebration: {
    ...
    feedback: {
      ...
      fail_warning: '%s: markerad för rörbyte. Öppna guiden för stegen.',
      passed: '%s godkänd — röret är friskt!',
    },
    footer_tip: 'Tips: gravera en provfil varje månad för att hålla maskinen i gott skick.',
    history_hint: 'Endast de %s senaste posterna sparas för varje uppgift.',
    intro: 'Följ varje underhållsuppgift för den här maskinen och markera den som klar med ett klick.',
    legend: {
      due_soon: 'Snart dags',
      overdue: 'Försenad',
    ...
    status: {
      ...
      healthy: 'Frisk',
      last: 'Senast utförd',
      never_done: 'Aldrig utförd',
      next: 'Nästa gång',
      not_checked: 'Inte kontrollerad',
      not_logged: 'Inte loggad',
      overdue: 'Försenad',
      replace_tube: 'Byt rör',
    },
    tasks: {
      align: {
        keyPoints: 'Justera när strålgången är felinriktad.',
        name: 'Justering av strålgång',
      },
      chassis: {
        keyPoints: 'Ta bort rester och tjärolja från chassit och bottenplattan.',
        name: 'Rengöring av chassi',
      },
      door: {
        keyPoints: 'Ta bort fett från dörrluckan.',
        name: 'Rengöring av dörrlucka',
      },
      exhaust: {
        keyPoints: 'Rengör fläktbladen från damm.',
        name: 'Rengöring av utsugsfläkt',
      },
      fan: {
        keyPoints: 'Ta bort damm från ventilationsfläktens blad.',
        name: 'Rengöring av ventilationsfläkt',
      },
      fieldlens: {
        keyPoints: 'Rengör fältlinsen, torka från mitten och utåt medurs.',
        name: 'Rengöring av fältlins',
      },
      honeycomb_plate: {
        keyPoints: 'Ta bort rester och tjära från honungskakeplattans rutor.',
        name: 'Rengöring av honungskakeplatta',
      },
      honeycomb_table: {
        keyPoints: 'Ta bort rester och tjärolja från honungskakenätet.',
      ...
      maintain_test: {
        keyPoints: 'Kontrollera statusdisplayen och strömbrytarna.',
        name: 'MAINTAIN-sidan',
      },
      mirrors_combiner: {
        keyPoints: 'Ta bort smuts från linser/speglar; kontrollera oxidering. Inga alkohol- eller vattenfläckar kvar.',
        name: 'Speglar, fokuslins och strålkombinerare',
      },
      mirrors_lens: {
        keyPoints: 'Rengör de 4 speglarna och linsen; se till att det inte finns oxidering eller vattenfläckar.',
        name: 'Rengöring av speglar och lins',
      },
      mod_diode: {
        keyPoints: 'Rengör fläkten, fokuslinsen och POGO pin.',
        name: 'Diodlasermodul',
      },
      mod_ir: {
        keyPoints: 'Rengör fokuslinsen.',
        name: 'Infraröd lasermodul',
      },
      optical_inspection: {
        keyPoints: 'Inspektera strålgången; även vid uppackning och efter rörbyte.',
        name: 'Inspektion av strålgång',
      },
      optical_unboxing: {
        keyPoints: 'Se till att strålgången är korrekt. Kontrollera vid första uppackningen.',
        name: 'Inspektion av strålgång',
      },
      screen: {
        keyPoints: 'Rengör damm och fett på panelen.',
        name: 'Rengöring av skärm',
      },
      tube: {
        keyPoints: 'Om 3 mm akryl inte kan skäras vid 70% effekt, byt röret.',
        name: 'Hälsokontroll av laserrör',
      },
      water: {
        keyPoints: 'Fyll på vatten tills det är över 80% fullt utan luftbubblor.',
        name: 'Byte av kylvatten',
      },
      worktable: {
        keyPoints: 'Spraya alkohol på en pappersduk och torka sedan av arbetsbordet.',
        name: 'Rengöring av arbetsbord',
      },
      zaxis: {
        keyPoints: 'Torka av Z-axelns pelarskruv och applicera sedan smörjmedel jämnt med en bomullspinne.',
        name: 'Smörjning av Z-axelpelare',
      },
    },
  ...
  message: {
    ...
    camera: {
      ...
      fail_to_transmit_image: '#845 Något gick fel med bildöverföringen. Starta om din maskin eller Beam Studio. Om felet kvarstår, följ <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">denna guide</a>.',
      switching_camera: 'Byter kamera...',
      wide_angle_open_door: 'Öppna luckan',
      wide_angle_open_door_text: 'Öppna luckan innan du byter till vidvinkelkameran.',
  ...
  monitor: {
    ...
    HARDWARE_ERROR_KEY_OFF: '#929 Säkerhetsnyckel ej upptäckt\nSäkerhetsnyckeln upptäcks inte eller har avaktiverats. För din säkerhet kan maskinen inte användas förrän nyckeln är korrekt påslagen.\nSätt in säkerhetsnyckeln och slå på den innan du startar om arbetet.',
    HARDWARE_ERROR_LASER_TEMPERATURE_ABNORMAL: '#933 Onormal lasertemperatur\nLasertemperaturen är för hög. Stoppa arbetet och låt lasern svalna innan du startar om.',
    ...
    HARDWARE_ERROR_LIMIT_SWITCH_TRIGGERED: '#934 Maskinen stoppad — laserhuvudet nådde arbetsområdets gräns.',
  ...
  params_label: {
    ...
    placeholder: 'Parameteretikett',
    preview_hint: 'Detta är en förhandsvisning. Textinnehållet uppdateras automatiskt innan ett jobb skickas',
    save_as_default: 'Spara som standard',
    settings: 'Inställningar för parameteretikett',
    update: 'Uppdatera',
    updated: 'Parameteretikett uppdaterad',
    use_default: 'Använd sparad standard',
    use_recommended: 'Använd rekommenderade',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      calculating: 'Beräknar…',
      capturing: 'Tar bild',
      completing: 'Slutförs snart',
      detecting: 'Identifierar justeringsmarkeringar',
      locating: 'Söker justeringsmarkeringar',
      preparing: 'Förbereder kameran',
      refining: 'Finjusterar markeringarnas position',
    },
    alignment: {
    ...
    calibration: {
      align_desc: '1. Lägg det utskrivna kalibreringsarket i arbetsområdet, fäst det med tejp eller maskeringstejp så att det inte glider, och fokusera.\n2. Klicka på ”Förhandsgranska och justera” för att köra kamerajusteringen.\n3. När markeringarna har hittats klickar du på ”Rispa skalor” för att rispa referenslinjerna på arket med låg effekt.',
      aligned: 'Justeringsmärken hittade. Redo att rispa.',
      auto_read: 'Läs av skalor med kamera',
      auto_read_failed: 'Skalorna kunde inte läsas av automatiskt. Läs av dem med ögat och ange värdena.',
      auto_read_hint: 'Kameraavläsningen kan avvika med upp till ±2; kontrollera den mot arket.',
      current_offset: 'Aktuell förskjutning: X %s mm, Y %s mm',
      export_pdf: 'Exportera kalibrerings-PDF',
      power: 'Effekt',
      print_desc: '1. Exportera kalibreringsarkets PDF. Den innehåller de fyra justeringsmärkena och två skalor.\n2. Skriv ut arket i 100 % (verklig storlek).',
      reading_desc: '1. Hitta den längsta rispade linjen (den mittersta) och notera på vilken sida av den tryckta 0-linjen den ligger.\n2. Gå linje för linje åt den sidan tills en rispad linje och en tryckt linje ligger exakt i linje.\n3. Räkna från 0 till den tryckta linjen (siffror är tryckta vid var 5:e linje; räkna även de onumrerade linjerna emellan).',
      reading_x: 'X-avläsning',
      reading_y: 'Y-avläsning',
      scratch: 'Rispa skalor',
      speed: 'Hastighet',
      title: 'Skriv ut och skär-kalibrering',
    },
    ...
    finish: 'Slutför',
    fit_content: 'Anpassa till innehåll',
    generate_from_contour: 'Generera från kontur',
    grid_columns: 'Kolumner',
    grid_rows: 'Rader',
    ...
    orientation_landscape: 'Liggande',
    orientation_portrait: 'Stående',
    paper_size: 'Utdatastorlek',
    paper_too_small: 'Utdataområdet är för litet. Designen (inklusive justeringsmarkeringar) behöver minst %s mm marginal från materialets kant för att hållas inom skrivarens utskrivbara område. Välj en större utdatastorlek, annars beskärs eller förminskas utskriften.',
    preview_and_align: 'Förhandsgranska och justera',
    resume_desc: 'Den här designen är redan förberedd för Skriv ut och skär.\nLägg nästa utskrivna material i maskinen och fortsätt till kamerajustering, eller börja om för att ändra design, utdatastorlek eller skärbana.',
    resume_title: 'Återuppta Skriv ut och skär',
    select_cut_layer: 'Lager med skärbana',
    start_over: 'Börja om',
    ...
    step_setup: 'Skärbanor och markeringar',
    ...
    uv_print_file_disabled: 'Skriv ut och skär skriver ut innehållet i UV-utskriftslagren. Aktivera "Aktivera UV-utskriftsfil" i inställningarna och lägg sedan till din design i ett UV-utskriftslager.',
  ...
  puzzle_generator: {
    bleed: 'Utfall',
    board_base: 'Brädbas',
    board_radius: 'Ramradie',
    board_width: 'Rambredd',
    change_image: 'Klicka för att ändra bild',
    columns: 'Kolumner',
    design_preview: 'Designförhandsgranskning',
    exploded_view: 'Sprängskiss',
    export_as: 'Exportera som',
    export_engrave: 'Graveringslager',
    export_failed: 'Kunde inte importera pusselbit till arbetsytan. Försök igen eller justera pusslinställningar.',
    export_none: 'Ingen',
    export_print: 'Utskriftslager',
    file_too_large: 'Den valda filen överskrider maximalt tillåten storlek.',
    guide_lines: 'Hjälplinjer',
    heart_sharpness: 'Spetsskärpa',
    image: 'Bild',
    ...
    orientation_type_1: 'Typ 1',
    orientation_type_2: 'Typ 2',
    orientation_type_3: 'Typ 3',
    orientation_type_4: 'Typ 4',
    piece_size: 'Bitarnas storlek',
    preview_placeholder: 'Pusselförhandsgranskning',
    puzzle_board: 'Pusselbräda',
    puzzle_pieces: 'Pusselb itar',
    radius: 'Radie',
    raised_edges: 'Upphöjda kanter',
    reset_to_default: 'Återställ till standard',
    rows: 'Rader',
    ...
    types: {
      ...
      heart_jigsaw: 'Hjärtformat pussel',
      hex_jigsaw: 'Hexagonalt pussel',
      rectangle_jigsaw: 'Rektangulärt pussel',
    },
    unsupported_file_type: 'Filtypen stöds inte. Använd JPG, PNG eller WebP.',
    upload_hint: 'JPG, PNG, WebP (max 10MB)',
    upload_image: 'Klicka eller dra för att ladda upp',
    zoom: 'Zoom',
  },
  qr_code_generator: {
  ...
  settings: {
    ...
    show_banners: 'Visa startsidesbanner',
    ...
    vector_order_optimization: 'Vektorordningsoptimering',
  ...
  tips: {
    canvas_hold_space_to_pan: 'Håll ner mellanslag och dra för att panorera över duken.',
    feature_auto_fit: 'Efter kameraförhandsgranskning, använd Åtgärder → Automatisk anpassning för att automatiskt placera objekt på ditt material.',
    feature_box_generator: 'Använd Generatorer → Lådgenerator för att skapa lådor i anpassad storlek på några sekunder.',
    feature_code_generator: 'Använd Generatorer → Streckkodsgenenerator för att skapa QR-koder och streckkoder.',
    feature_elements: 'Elements-panelen innehåller nu över en miljon grafik redo att använda.',
    feature_layer_color_configurations: 'Mappa SVG-lagerfärger till hastighet och effekt via Redigera → Lager → Färginställningar.',
    feature_material_test: 'Använd Generatorer → Materialtestgenerator i den vänstra verktygsfältet för att snabbt hitta de bästa inställningarna för ett material.',
    layer_execution_order: 'Lagerordning bestämmer jobbordning. Jobb körs från topp till botten.',
    machine_clean_mirror: 'Kontrollera speglarna och fokuslins regelbundet och rengör dem vid behov för att förhindra rökansamling.',
    machine_no_unattended_operation: 'Lämna aldrig maskinen igång obevakad.',
    machine_regular_start: 'Kör ett laserjobb minst en gång varannan vecka för att förlänga laserrörens livslängd.',
    object_edit_image_to_erase: 'Använd Bild → Åtgärder → Redigera bild för att radera oönskade områden i en bild.',
    object_polygon_sides: 'Justera antalet sidor i polygonens egenskapspanel.',
    object_rounded_rectangle: 'Ange hörnradien för en avrundad rektangel i rektangelns egenskapspanel.',
    object_sharpen_portrait: 'Förbättra porträttgravyrer med Bild → Åtgärder → Skärpa.',
    settings_auto_save: 'Aktivera Autospara i Inställningar för att undvika att förlora ditt arbete.',
    settings_default_text_font: 'Du kan ställa in ditt standardteckensnitt för textverktyget i Inställningar.',
    task_focus_lower_for_cutting: 'För tjockare material kan fokusering cirka 2 mm under ytan förbättra skärresultaten.',
    task_leather_moisten_reduce_burn: 'Fukta lätt läder innan skärning för att minska brännskador.',
    task_parameters_for_promark_color: 'Justera pulsbredd och frekvens på MOPA-lasrar för att producera färger på rostfritt stål eller titan.',
    task_slower_for_smoother_acrylic_edge: 'Att minska skärhastigheten något kan ge jämnare akrylkanter.',
    tips: 'Tips:',
  },
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Det gick inte att ansluta till maskinkameran. Starta om din maskin eller Beam Studio. Om felet kvarstår, följ <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">denna guide</a>.',
      fail_to_get_door_status: 'Kontrollera att luckan är stängd för att aktivera lågeffektslaser för skärning.',
      fail_to_start_preview: '#803 Det gick inte att starta förhandsgranskningsläget. Starta om din dator eller Beam Studio. Om felet kvarstår, följ <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">denna guide</a>.',
      ...
      start_preview_timeout: '#803 Timeout uppstod när förhandsgranskningsläget startades. Starta om din dator eller Beam Studio. Om felet kvarstår, följ <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">denna guide</a>.',
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Kalibrera Skriv ut och skär',
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Exportera kalibreringsdata',
      ...
      import_acrylic_focus_probe: 'beamo & Beambox Fokussond - 3 mm',
      ...
      import_beamo_2_printing_test: 'beamo II utskriftstest',
      import_calibration_data: 'Importera kalibreringsdata',
      ...
      import_promark_engraving_example_1: 'Exempel på Promark-gravering I',
      import_promark_engraving_example_2: 'Exempel på Promark-gravering II',
      ...
      machines: 'Maskiner',
      maintenance_checklist: 'Underhållschecklista',
      ...
      tab_layers: 'Lager',
      tab_objects: 'Objekt',
      tab_path_edit: 'Banas redigering',
      tools: {
        title: 'Verktyg',
      },
