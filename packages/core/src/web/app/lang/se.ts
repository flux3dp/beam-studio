...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: 'Ladda ner och skriv ut följande fil på A4-papper för kamerakalibrering.',
    put_chessboard_bm2_2: 'Placera kalibreringspappret plant på den angivna platsen i arbetsområdet.',
