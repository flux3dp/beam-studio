...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    hole_offset: 'Förskjutning',
    hole_position: 'Position',
    hole_thickness: 'Tjocklek',
    hole_type: 'Typ',
    hole_type_punch: 'Hålslag',
    hole_type_ring: 'Ring',
    ...
    position_ref_bottom_center: 'Nedre',
    position_ref_left_center: 'Vänster',
    position_ref_right_center: 'Höger',
    position_ref_top_center: 'Övre',
