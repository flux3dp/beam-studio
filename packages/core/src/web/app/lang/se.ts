...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Att använda för höga hastigheter för lager som innehåller 3D-kurvobjekt kan minska gravyrprecisionen.\nVi rekommenderar att hålla hastigheten under %(limit)s för optimala resultat med 3D-kurvobjekt.',
      too_fast_for_curve_and_constrain: 'Följande lager: %(layers)s överskrider hastighetsgränsen på %(limit)s.\nGraveringshastigheten för 3D-kurvobjekt kommer att begränsas till %(limit)s. Du kan ta bort denna gräns i Inställningar.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'Graveringshastigheten för 3D-kurvobjekt kommer att begränsas till %(limit)s. Du kan ta bort denna begränsning i Preferensinställningar.',
