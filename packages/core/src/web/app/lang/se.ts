    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          diabled_by_gradient: 'Inaktivera övertoning innan du använder den här funktionen.',
          diabled_by_infilled: 'Stäng fyllningen innan du använder denna funktion.',
          diabled_by_infilled_and_variable_text: 'Stäng fyllningen och den variabla texten innan du använder denna funktion.',
          diabled_by_variable_text: 'Stäng den variabla texten innan du använder denna funktion.',
