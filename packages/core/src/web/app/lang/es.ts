...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: 'Descargue e imprima el siguiente archivo en papel A4 para la calibración de la cámara.',
    put_chessboard_bm2_2: 'Coloque el papel de calibración plano en la posición designada en la plataforma de trabajo.',
