...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Posición: Alinear con el punto grabado en la parte superior izquierda.',
    align_4_1: 'Posición: Alinear con el punto grabado en la parte superior derecha.',
    align_4_2: 'Posición: Alinear con el punto grabado en la parte inferior izquierda.',
    align_4_3: 'Posición: Alinear con el punto grabado en la parte inferior derecha.',
    align_8_0: 'Posición: Alinee con el punto grabado en la parte superior izquierda exterior.',
    align_8_1: 'Posición: Alinee con el punto grabado en la parte superior derecha exterior.',
    align_8_2: 'Posición: Alinee con el punto grabado en la parte inferior izquierda exterior.',
    align_8_3: 'Posición: Alinee con el punto grabado en la parte inferior derecha exterior.',
    align_8_4: 'Posición: Alinee con el punto grabado en la parte superior izquierda interior.',
    align_8_5: 'Posición: Alinee con el punto grabado en la parte superior derecha interior.',
    align_8_6: 'Posición: Alinee con el punto grabado en la parte inferior izquierda interior.',
    align_8_7: 'Posición: Alinee con el punto grabado en la parte inferior derecha interior.',
    ...
    charuco_open_the_machine_lid: 'Abra la tapa de la máquina.',
    charuco_place_charuco: 'Coloca el patrón de calibración impreso horizontalmente en la <b>%s</b> del área de trabajo.',
    ...
    check_pnp_desc: 'Hemos vuelto a tomar las imágenes basándonos en los resultados de la calibración y marcado los puntos de referencia para el grabado.\nVerifica si las marcas rojas coinciden con los puntos reales de grabado.\nSi notas alguna discrepancia evidente, simplemente haz clic en "Recalibrar" para intentarlo de nuevo.',
    ...
    solve_pnp_keep_door_closed: 'Mantén la puerta cerrada durante el siguiente proceso. Si se abre, el sistema intentará reubicar la cámara.',
    ...
    solve_pnp_relocate_camera: 'Haz clic en "Reubicar cámara" si el cabezal láser aún no está centrado horizontalmente.',
