...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Usar velocidades demasiado altas para capas que contienen objetos de curva 3D puede reducir la precisión del grabado.\nRecomendamos mantener la velocidad por debajo de %(limit)s para obtener resultados óptimos con objetos de curva 3D.',
      too_fast_for_curve_and_constrain: 'Las siguientes capas: %(layers)s exceden el límite de velocidad de %(limit)s.\nLa velocidad de grabado para objetos de curva 3D se limitará a %(limit)s. Puede eliminar este límite en Configuración de Preferencias.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'La velocidad de grabado de los objetos de curva 3D estará limitada a %(limit)s. Puedes eliminar este límite en Configuración de Preferencias.',
