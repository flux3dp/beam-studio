...
const lang: ILang = {
  ...
  settings: {
    ...
    module_offset_4c: 'Desplazamiento de impresión (4C)',
    ...
    module_offset_uv_varnish: 'Desplazamiento de barniz',
    module_offset_uv_white_ink: 'Desplazamiento de tinta blanca',
    none: 'Ninguno',
    normal: 'Normal',
  ...
  topbar: {
    ...
    menu: {
      ...
      import_beamo_2_printing_example_full: 'Ejemplo de beamo II Impresión - Color Completo',
