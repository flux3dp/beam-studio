...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Placering: Justér med det graverede punkt øverst til venstre.',
    align_4_1: 'Placering: Justér med det graverede punkt øverst til højre.',
    align_4_2: 'Placering: Justér med det graverede punkt nederst til venstre.',
    align_4_3: 'Placering: Justér med det graverede punkt nederst til højre.',
    align_8_0: 'Position: Justér med graveringpunktet på den ydre øverste venstre.',
    align_8_1: 'Position: Justér med graveringspunktet på den ydre øverste højre side.',
    align_8_2: 'Position: Justér med graveringspunktet på den ydre nederste venstre side.',
    align_8_3: 'Position: Justér med graveringspunktet på den ydre nederste højre side.',
    align_8_4: 'Position: Justér med graveringpunktet på den indre øverste venstre.',
    align_8_5: 'Position: Justér med graveringspunktet på den indre øverste højre side.',
    align_8_6: 'Position: Justér med graveringspunktet på den indre nederste venstre side.',
    align_8_7: 'Position: Justér med graveringspunktet på den indre nederste højre side.',
    ...
    charuco_open_the_machine_lid: 'Åbn maskinens låg.',
    charuco_place_charuco: 'Placer det udskrevne kalibreringsmønster vandret i <b>%s</b> af arbejdsområdet.',
    charuco_position_bottom_left: 'nederste venstre',
    charuco_position_bottom_right: 'nederste højre',
    charuco_position_center: 'center',
    charuco_position_left: 'venstre',
    charuco_position_right: 'højre',
    charuco_position_top_left: 'øverste venstre',
    charuco_position_top_right: 'øverste højre',
    check_checkpoint_data: 'Kontrolpunktdata',
    check_device_pictures: 'Kontroller enhedens billeder',
    check_pnp_desc: 'Vi har taget billederne igen baseret på kalibreringsresultaterne og markeret graveringsreferencepunkterne.\nTjek venligst, om de røde markeringer matcher de faktiske graveringspunkter.\nHvis du ser nogen tydelig uoverensstemmelse, skal du blot klikke på "Kalibrer igen" for at prøve igen.',
    ...
    solve_pnp_keep_door_closed: 'Hold døren lukket under den følgende proces. Hvis døren åbnes, forsøger systemet at genplacere kameraet.',
    ...
    solve_pnp_relocate_camera: 'Klik på "Flyt kamera" hvis laserhovedet stadig ikke er centreret vandret.',
