...
const lang: ILang = {
  ...
  settings: {
    ...
    module_offset_4c: 'Udskrivning (4C) forskydning',
    ...
    module_offset_uv_varnish: 'Lakforskydning',
    module_offset_uv_white_ink: 'Hvid blæk forskydning',
    none: 'Ingen',
    normal: 'Normal',
  ...
  topbar: {
    ...
    menu: {
      ...
      import_beamo_2_printing_example_full: 'Eksempel på beamo II Print - Fuld farve',
