...
const lang: ILang = {
  ...
  maintenance: {
    actions: {
      fail: 'Fejlet',
      history: 'Historik',
      mark_checked: 'Marker kontrolleret',
      mark_done: 'Marker udført',
    ...
    feedback: {
      all_essential: 'Al essentiel vedligeholdelse er opdateret — din %s er i topform!',
    ...
    tasks: {
      ...
      lube: {
        keyPoints: 'Rengør styrestængerne, lineærskinnen og fokuseringsmekanismen, og smør dem derefter igen.',
        name: 'Smøring',
      },
      maintain_test: {
