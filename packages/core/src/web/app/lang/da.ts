...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Hvordan forbedres detektionsnøjagtigheden?',
    ...
    retake_tooltip: 'Tag kamerafoto igen ved hvert objekts position for bedre registrering',
    retry_with_remove_bg: 'Fjern baggrund',
    retry_with_remove_bg_tooltip: 'Fjern baggrund fra forhåndsvisningsbillede for at forbedre konturregistrering',
    rotation: 'Drej',
    ...
    use_original_image_tooltip: 'Gendan det originale forhåndsvisningsbillede uden baggrundsfjernelse',
  ...
  autosave: {
    ...
    path_not_correct: 'Placeringen for automatisk lagring findes ikke længere.',
    path_not_correct_desc: 'Vælg venligst en ny mappe i <b>%(preferences)s > %(autosave)s > %(path)s</b> for at fortsætte med at gemme dit arbejde.',
  },
  barcode_generator: {
  ...
  beambox: {
    ai_generate: {
      dimensions: {
        ...
        title: 'Billeddimensioner',
      },
      error: {
        config_description: 'Kunne ikke indlæse AI-konfiguration',
        config_message: 'Kunne ikke indlæse AI-stilarter',
        generation_failed: 'Generering mislykkedes',
        import_failed: 'Import mislykkedes',
        insufficient_credits: 'Utilstrækkelige kreditter',
      },
      form: {
        count: 'Antal',
        credit_required: 'Krævede kreditter',
        editor: 'Redaktør',
        generate: 'Generer',
        laser_friendly: 'Laservenlig',
      },
      header: {
        history_tooltip: 'Historik',
        reset_tooltip: 'Nulstil alt',
        title: 'AI-skabelse',
      },
      history: {
        detail: 'Detaljer',
        empty_description: 'Ingen genereringshistorik endnu. Begynd at skabe!',
        error_message: 'Kunne ikke indlæse historik',
        not_generated: '❌ Ikke genereret',
        recreate: 'Genskab',
        status_failed: 'Mislykket',
        status_generating: 'Genererer',
        status_success: 'Succesfuld',
        storage_notice: 'Op til 10 seneste poster gemmes. Genererede billeder opbevares i 3 dage.',
        title: 'Genereringshistorik',
      },
      loading: {
        history: 'Indlæser historik...',
        styles: 'Indlæser AI-stilarter...',
        tip_0: 'Starter den kreative motor…',
        tip_1: 'Polerer pixels… ✨',
        tip_2: 'Næsten færdig, finpudser detaljerne',
        tip_3: 'Arbejder stadig, denne del tager lidt længere tid',
        tip_4: 'Store idéer tager tid, tak for din tålmodighed',
      },
      results: {
        download: 'Download',
        import: 'Importer',
      ...
      style: {
        apply: 'Anvend stil',
        choose: 'Vælg stil',
        custom_creation: 'Brugerdefineret skabelse',
        customize: 'Tilpas',
        select: 'Vælg skabelsesstil',
      },
      upload: {
        add: 'Tilføj',
        click_or_drag: 'Klik eller træk billeder hertil',
        error: 'Upload-fejl',
        file_size_error: '%s: Filstørrelsen skal være mindre end %sMB',
        file_type_error: '%s: Kun JPEG-, PNG- og WebP-billeder understøttes',
        from_history: 'Fra historik',
        images: 'Upload billeder',
        max_images_error: 'Maksimalt %s billeder tilladt',
        selected: '%s / %s valgt',
        supported_formats: 'JPEG, PNG, WebP • Maks %s',
      },
      validation: {
        description_or_image_required: 'Angiv venligst en beskrivelse eller upload mindst ét billede',
        field_exceeds_max_length: '"%s" overskrider den maksimale længde på %s tegn.',
        field_required: '"%s" er påkrævet. Udfyld venligst dette felt.',
        login_required: 'Log venligst ind for at bruge AI-generering.',
        max_images: 'Maksimalt %s billeder tilladt',
      },
    },
    ai_upscale_panel: {
      credit_amount: '%s AI-kreditter',
      credit_balance: 'AI-kreditsaldo',
      credit_cost: 'Brugte AI-kreditter',
      description: 'Øg billedets opløsning og detaljer med AI. Det opskalerede billede erstatter originalen på lærredet.',
      done: 'Generativ opskalering fuldført',
      dpi_recommended: 'Anbefalet til det aktuelle lag-DPI: %dx.',
      dpi_recommended_capped: 'Anbefalet til det aktuelle lag-DPI: %dx, men %dx er det største inden for den anbefalede outputstørrelse.',
      failed: 'Generativ opskalering kunne ikke fuldføres. Kontrollér din netværksforbindelse, og prøv igen.',
      insufficient_credit: 'Ikke nok AI-kreditter til at køre generativ opskalering.',
      layer_dpi: 'Lag-DPI',
      original_size: 'Oprindelig størrelse',
      output_size: 'Outputstørrelse',
      oversize_warning: 'Outputstørrelsen (%s) overstiger det anbefalede maksimum på %dpx x %dpx. Behandlingen kan tage flere minutter, og resultatet kan gøre Beam Studio langsommere. Fortsæt alligevel?',
      processing: 'Opskalerer…',
      processing_hint: 'Behandlingstiden afhænger af billedstørrelse og netværksforhold.',
      recommended: 'Anbefalet',
      retry: 'Prøv igen',
      start: 'Start opskalering',
    },
    announcement_panel: {
      title: 'Meddelelse',
    },
    ...
    document_panel: {
      ...
      prespray_times: 'Antal rensninger',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Knyt til materiale',
        bucket_hint: 'Gemt i din samling “Mine materialer” (Andre). Du kan flytte det til et materiale senere.',
        create_new: 'Opret nyt materiale…',
        new_material_name: 'Navn på nyt materiale',
        preset_name: 'Navn på forudindstilling',
        settings_from_layer: 'Indstillinger kopieret fra det aktuelle lag',
        title: 'Gem aktuelle lagindstillinger som forudindstilling',
      },
      add_material: 'Tilføj materiale',
      ...
      catalog: {
        materials: {
          ...
          aluminum: 'Aluminium',
          bamboo: 'Bambus',
          basswood_sheet: 'Lindetræsplade',
          black_abs: 'Sort ABS',
          black_acrylic: 'Sort akryl',
          brass: 'Messing',
          canvas: 'Lærred',
          cardboard: 'Pap',
          cardstock: 'Karton',
          ceramic_tile: 'Keramisk flise',
          copper: 'Kobber',
          cork: 'Kork',
          denim: 'Denim',
          eva_foam: 'EVA-skum',
          fabric: 'Stof',
          faux_leather: 'Kunstlæder',
          felt: 'Filt',
          fluorescent_acrylic: 'Fluorescerende akryl',
          glass: 'Glas',
          glitter_acrylic: 'Glimmerakryl',
          gloss_leather: 'Blankt læder',
          gold: 'Guld',
          iron: 'Jern',
        ...
        presets: {
          ...
          kiss_cut: 'Kiss cut',
          marking: 'Mærkning',
          marking_dark: 'Mørk mærkning',
          marking_light: 'Lys mærkning',
          printing: 'Print',
          printing_fabric: 'Print (stof)',
        },
      },
      categories: {
        acrylic: 'Akryl',
      ...
      editor: {
        appearance: 'Udseende',
        appearance_hint: 'Intet foto? Vælg en omslagsfarve i stedet.',
        category: 'Kategori',
        category_required: 'Vælg en kategori',
        color: 'Farve',
        name: 'Materialenavn',
        name_required: 'Navn er påkrævet',
        photo: 'Foto',
        tags: 'Tags',
        title_add: 'Tilføj materiale',
        title_edit: 'Rediger materiale',
        upload_hint: 'Klik eller træk et foto hertil. Stor forhåndsvisning vises i galleriet.',
      },
      enable: 'Aktivér',
      export: 'Eksportér',
      favorites: 'Favoritter',
      from_current_layer: 'Fra aktuelt lag',
      import: 'Importér',
      machine: 'Maskine',
      manual: 'Manuel',
      manual_settings: 'Manuelle indstillinger',
      modified: 'Parametre er ændret, siden forudindstillingen blev anvendt',
      move_to_material: 'Flyt til materiale…',
      new_preset_manual: 'Ny forudindstilling…',
      no_materials_in_category: 'Ingen materialer her til %s endnu.',
      no_presets_for_machine: 'Ingen indstillinger til %s endnu.',
      no_search_match: 'Ingen materialer matcher “%s”.',
      preset_editor: {
        name: 'Navn på forudindstilling',
        name_required: 'Navn er påkrævet',
        title_edit: 'Rediger forudindstilling',
        title_new: 'Ny forudindstilling',
      },
      presets: 'Forudindstillinger',
      recents: 'Seneste',
      recents_empty: 'Senest anvendte materialer vises her.',
      regions: {
        auto: 'Automatisk',
        eu: 'Europa',
        global: 'Global',
      ...
      restore_default: 'Gendan FLUX-standard',
      result: 'Resultat',
      search_placeholder: 'Søg efter materialer, tags, kategorier…',
      settings_region: 'Region for materialekatalog',
      settings_use: 'Brug materialebrowser',
      showing_bundled: 'Viser indbygget katalog',
      state_customized: 'Tilpasset',
      state_default: 'Standard',
      state_disabled: 'Deaktiveret',
      state_user: 'Brugerdefineret',
      storage_full: 'Lagerpladsen er fuld, materialebiblioteket kunne ikke gemmes. Brug farveomslag i stedet for billeder.',
      sure_to_delete_material: 'Vil du slette dette materiale og alle dets forudindstillinger?',
      sure_to_delete_preset: 'Vil du slette denne forudindstilling?',
      sure_to_delete_variant: 'Slet denne tykkelse og dens forudindstillinger?',
      sure_to_import: 'Import vil flette filen ind i dit materialebibliotek. Fortsæt?',
      thickness: 'Tykkelse',
      title: 'Materialebrowser',
      variant_exists: 'Der findes allerede en variant med denne tykkelse.',
      variants: '%d varianter',
    },
    ...
    popup: {
      ai_credit: {
        ...
        insufficient_credit: 'Utilstrækkelig kredit',
        insufficient_credit_msg: 'Denne funktion kræver %s AI-kreditter, men du har kun %s AI-kreditter tilbage.\nKøb venligst flere kreditter og prøv igen.',
      ...
      path_engine_upgrade: {
        caption: 'Hurtigere jobgenerering tilgængelig',
        keep_current: 'Behold nuværende',
        message: 'Vi har opgraderet jobberegnings-motoren for at forbedre ydeevnen og fremskynde jobgenereringen.\nVil du skifte til den nye accelererede motor?\nDu kan slå den fra når som helst under %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'I kurvegraveringtilstand kan den aktuelle hastighed være for høj og kan påvirke graveringsdetaljerne for lag: %(layers)s.\nOvervej at reducere hastigheden for bedre kvalitet.',
    ...
    right_panel: {
      laser_panel: {
        ...
        dropdown: {
          inches: {
            ...
            acrylic_7mm_cutting: 'Akryl - 1/4″ Skæring',
            ...
            mdf_7mm_cutting: 'MDF - 1/4″ Skæring',
          ...
          mm: {
            ...
            acrylic_7mm_cutting: 'Akryl - 7 mm Skæring',
            ...
            mdf_7mm_cutting: 'New Zealand MDF - 7 mm Skæring',
        ...
        high_quality_desc: 'Gælder kun for fyldte vektorgravering og billedobjekter. Aktivering af dette vil reducere graveringshastigheden for finere resultater.',
        ...
        strength: 'Effekt',
        texture: 'Tekstur',
        texture_angle: 'Vinkel',
        texture_intensity: 'Intensitet',
        texture_interval: 'Interval',
        texture_random: 'Tilfældig',
        texture_stripe: 'Striber',
        times: 'gange',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_credit_reminder: 'Tryk på knappen vil straks bruge %s kredit. Vil du fortsætte?',
          ai_upscale: 'Generativ opskalering',
          ai_upscale_short: 'Opskalering',
          ai_upscale_too_large: 'Dette billede er for stort til AI-opskalering. Den maksimalt understøttede størrelse er %dpx x %dpx.',
          array: 'Array',
          auto_fit: 'Auto Fit',
          bevel: 'Fas',
          brightness: 'Lysstyrke',
          ...
          disabled_by_noun_project: 'Denne form er beskyttet af loven om immaterielle rettigheder, derfor kan dens sti ikke redigeres.',
        ...
        option_panel: {
          ...
          text_align_center: 'Centreret',
          text_align_justify: 'Lige marginer',
          text_align_left: 'Venstre',
          text_align_right: 'Højre',
          text_content_placeholder: 'Indtast tekst',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Flyt laserhovedet for at justere det røde lys med midten af <b>punkt A</b>.',
    charuco_move_to_point_b: 'Flyt laserhovedet vandret for at justere det røde lys med midten af <b>punkt B</b>.',
    ...
    check_pnp_desc: 'Sørg for, at de røde markeringer er justeret med graveringspunkterne\nHvis ikke, klik på "Tilbage" for at justere.\nHvis alt ser godt ud, godt klaret! 🎉',
    ...
    next: 'Næste',
    no_picture_found: '#852 Din enhed har ikke nogen tilgængelige rå fotos til kalibrering. Udfør venligst "Kalibrér kamera (Avanceret)".',
    ...
    put_charuco: 'Placer kalibreringsmønster',
    put_charuco_1: 'Udskriv kalibreringsmønsteret (A4/Letter).',
    put_charuco_2: 'Sæt det fladt fast på en stiv plade.',
    put_charuco_3: 'Placer i midten og udfør autofokus.',
    put_charuco_bm2_1: 'Udskriv kalibreringsmønsterfilen på A4 (Letter Size) papir til kalibrering.',
    put_charuco_bm2_2: 'Klik på “Næste” og følg vejledningen for at placere papiret.',
    put_charuco_promark_2: "Sørg for, at kalibreringspapiret er tydeligt synligt uden genskin. Klik på 'Næste' for at tage et billede.",
    put_charuco_promark_desc_1: 'Brug kalibreringspapiret fra tilbehørsæsken, eller print følgende kalibreringsmønster på A4‑papir til kamerakalibrering.',
    ...
    put_chessboard_promark_desc_2: 'Placer skakbrættet fladt og centreret på arbejdsplatformen.',
    put_paper: 'Læg papir',
    ...
    put_paper_promark: 'Læg sort pap',
    put_paper_promark_1: 'Placer det sorte pap fra tilbehørskassen på arbejdsplatformen.',
    put_paper_promark_2: 'Juster fokus korrekt, og klik derefter på "Start Gravering" for at fortsætte.',
  ...
  connection_issue_guide: {
    alert_link: 'Afbrydes forbindelsen? Prøv denne fejlfindingsmetode.',
    connect_computer: {
      content: 'Din computer skal være på samme netværk som maskinen.',
      macos_steps: 'Klik på Wi-Fi-ikonet i menulinjen. Vælg derefter din telefons hotspot.',
      macos_title: 'macOS',
      title: 'Tilslut din computer',
      windows_steps: 'Klik på netværksikonet på proceslinjen. Vælg derefter din telefons hotspot.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Maskinen kan ikke finde mit hotspot',
      dont_know_hotspot_name: 'Jeg kender ikke navnet på mit hotspot',
      step1: '1. Gå til følgende på din maskines touchpanel: Netværk → Opret forbindelse til Wi-Fi.',
      step2: '2. Find og vælg din telefons hotspotnavn på Wi-Fi-listen.',
      step3: '3. Indtast hotspotadgangskoden, og opret forbindelse.',
    ...
    enter_ip: {
      ...
      step1: 'Indtast den IP-adresse, du fandt i det forrige trin.',
      step2: 'Klik på "Bekræft" for at teste forbindelsen.',
      step3: 'Beam Studio kontrollerer:',
      title: 'Indtast din maskines IP-adresse',
      verify: 'Bekræft',
    },
    fail: {
      bullet1: '• Din maskinmodel og serienummer',
      bullet2: '• Den IP-adresse, der vises på touchpanelet',
      bullet3: '• En beskrivelse af den fejl, du stødte på',
      contact_title: 'Når du kontakter support, er det en hjælp at have følgende klar:',
      intro: 'Bare rolig — dette betyder ikke nødvendigvis, at der er noget galt med din maskine. Der kan være yderligere faktorer, der påvirker forbindelsen. Vores supportteam er her for at hjælpe dig med at finde ud af det.',
      title: 'Vi kunne ikke fuldføre testen',
    },
    hotspot: {
      android_steps: 'Indstillinger → Forbindelser → Mobilt hotspot og deling → Mobilt hotspot',
      android_title: 'Android',
      ios_steps: 'Indstillinger → Personligt hotspot → Tillad andre at oprette forbindelse',
      ios_title: 'iPhone (iOS)',
      tip: 'Tip: Brug et enkelt engelsk hotspotnavn og en numerisk adgangskode (f.eks. Navn: FLUX_Test   Adgangskode: 12345678)',
      warning_2_4ghz: 'Vigtigt: FLUX-maskiner understøtter kun 2.4GHz Wi-Fi. Indstil dit hotspot til 2.4GHz, før du fortsætter.',
    },
    how_it_works: 'Sådan fungerer testen:',
    how_it_works_step1: '1. Konfigurer din telefon som et Wi-Fi-hotspot.',
    how_it_works_step2: '2. Tilslut maskinen til hotspottet.',
    how_it_works_step3: '3. Tilslut din computer til det samme hotspot.',
    how_it_works_step4: '4. Test forbindelsen i Beam Studio.',
    intro: 'Lad os køre en hurtig test for at kontrollere, om din maskine fungerer korrekt. Vi forbinder din maskine og computer via din mobiltelefons hotspot for at afgøre, om problemet ligger i dit netværk eller i selve maskinen.',
    ip_address: {
      step1: 'Gå til følgende på maskinens touchpanel:\nNetværk → Se efter "IP-adresse"',
      step2: 'IP-adressen ser normalt sådan ud: 172.20.10.x eller 192.168.x.x\n(Dette afhænger af din telefons hotspot)',
      step3: 'Skriv denne IP-adresse ned til næste trin.',
      title: 'Find din maskines IP-adresse',
      warning: 'Hvis IP-adressen begynder med 169.254, mislykkedes forbindelsen. Gå tilbage til Trin 1, og prøv igen.',
    },
    success: {
      cause: 'Det forbindelsesproblem, du oplevede, skyldes højst sandsynligt dit lokale netværksmiljø og ikke selve maskinen.',
      intro: 'Du har gennemført Wi-Fi-forbindelsestesten — flot arbejde! Dette bekræfter, at din FLUX-maskine fungerer perfekt.',
      recommend1: '• Kontakt din internetudbyder (ISP) eller routerproducent for at få hjælp til dine Wi-Fi-indstillinger',
      recommend2: '• Spørg din netværksadministrator, hvis du er på en skole, et kontor eller en delt arbejdsplads',
      recommend3: '• Kontrollér, om din router understøtter 2.4GHz, og prøv at genstarte den',
      recommend_title: 'Vores anbefaling:',
      title: 'Flot arbejde! 🎉',
    },
  ...
  flux_id_login: {
    ...
    flux_plus: {
      ...
      ai_credit_tooltip: 'Til AI-funktioner',
  ...
  generators: {
    ...
    keychain_generator: 'Nøgleringgenerator',
    material_test_generator: 'Materialetestgenerator',
    puzzle_generator: 'Puslespilsgenerator',
    title: 'Generatorer',
  },
  generic_error: {
  ...
  initialize: {
    ...
    Maskiner > "Promark Navn" > Promark-indstillinger`,
      ...
      setting_completed_ask_camera_calibration: 'Promark-feltlinseopsætningen er gennemført! Vil du fortsætte med kamerakalibrering?',
  ...
  keychain_generator: {
    ...
    text_options: {
      font_family: 'Skrifttype',
      font_settings: 'Skriftindstillinger',
      font_size: 'Skriftstørrelse',
  ...
  machine_linking: {
    continue: 'Fortsæt',
    i_have_read: 'Jeg har læst',
    input_birthday_to_link: 'Indtast din fødselsdato for at fuldføre enhedstilknytning',
    input_birthday_to_link_note: '*Bruges til at bekræfte, om din alder opfylder berettigelseskravene',
    link_failed: 'Tilknytning mislykkedes.',
    link_failed_already_linked: 'Denne enhed er i øjeblikket tilknyttet et andet FLUX ID. Du kan fortsætte med at bruge den eller tilknytte den til din konto.',
    link_failed_cannot_set_secret: 'Kan ikke gemme tilknytningsoplysninger på enheden. Kontroller forbindelsen mellem din computer og enheden.',
    link_failed_under_age: 'Du opfylder i øjeblikket ikke betingelserne for at bruge denne tjeneste og kan ikke fuldføre enhedstilknytningen.',
    link_machine: 'Tilknyt FLUX ID',
    link_machine_to_account: 'Forbundet til %(name)s. Vil du tilknytte denne enhed til din konto?',
    link_success: 'Tilknytning lykkedes.',
    link_to_my_flux_id: 'Tilknyt mit FLUX ID',
    privacy_policy: 'Privatlivspolitik',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Tilknytter…',
    use_without_linking: 'Brug uden tilknytning',
  },
  machine_status: {
  ...
  maintenance: {
    actions: {
      ...
      fail: 'Fejlet',
      history: 'Historik',
      open_guide: 'Åbn vejledning',
      pass: 'Bestået',
      print: 'Udskriv / PDF',
    },
    areas: {
      back_cover: 'Bagdæksel',
      modules: 'Moduler',
      optics: 'Optik',
      panel: 'Panel',
      working_area: 'Arbejdsområde',
    },
    cadence: {
      by_material: 'Efter materiale',
      condition: 'Efter tilstand',
      day: 'Hver dag',
      days: 'Hver %s dage',
      each_operation: 'Ved hver brug',
      every_1_2_weeks: 'Hver 1–2 uger',
      month: 'Hver måned',
      months: 'Hver %s måneder',
      upon_unboxing: 'Ved første udpakning',
      week: 'Hver uge',
      weeks: 'Hver %s uger',
    },
    celebration: {
    ...
    essential: 'Essentiel',
    essential_health: 'Essentiel tilstand',
    essential_hint: 'tæller med i tilstanden',
    feedback: {
      checked: '%s kontrolleret.',
      done: '%s er opdateret. Næste gang %s.',
      done_no_date: '%s er udført.',
      fail_warning: '%s: markeret til udskiftning af laserrør. Åbn vejledningen for at se trinnene.',
      passed: '%s bestået — laserrøret er i god stand!',
    },
    footer_tip: 'Tip: Gravér en prøvefil hver måned for at holde maskinen i god stand.',
    history_hint: 'Kun de %s seneste registreringer gemmes for hver opgave.',
    intro: 'Følg hver vedligeholdelsesopgave for denne maskine, og marker den som udført med ét klik.',
    legend: {
    ...
    machine_groups: {
      my_machines: 'Mine maskiner',
      other_models: 'Andre modeller',
    },
    machine_label: 'Maskine',
    materials: {
      acrylic: 'Akryl',
      leather: 'Læder',
      paper: 'Papir',
    ...
    status: {
      ...
      healthy: 'God stand',
      last: 'Sidst udført',
      never_done: 'Aldrig udført',
      next: 'Næste forfald',
      not_checked: 'Ikke kontrolleret',
      not_logged: 'Ikke registreret',
      overdue: 'Overskredet',
      replace_tube: 'Udskift laserrør',
    },
    tasks: {
      align: {
        keyPoints: 'Juster, når den optiske bane er ude af justering.',
        name: 'Justering af optisk bane',
      },
      chassis: {
        keyPoints: 'Fjern rester og tjæreolie fra kabinettet og bunddækslet.',
        name: 'Rengøring af kabinet',
      },
      door: {
        keyPoints: 'Fjern fedt fra lågedækslet.',
        name: 'Rengøring af lågedæksel',
      },
      exhaust: {
        keyPoints: 'Rengør blæservingerne for støv.',
        name: 'Rengøring af udsugningsblæser',
      },
      fan: {
        keyPoints: 'Fjern støv fra ventilationsblæserens vinger.',
        name: 'Rengøring af ventilationsblæser',
      },
      fieldlens: {
        keyPoints: 'Rengør feltlinsen, og tør fra midten og udad med uret.',
        name: 'Rengøring af feltlinse',
      },
      honeycomb_plate: {
        keyPoints: 'Fjern rester og tjære fra bikagepladens gitre.',
        name: 'Rengøring af bikageplade',
      },
      honeycomb_table: {
        keyPoints: 'Fjern rester og tjæreolie fra bikagenettet.',
        name: 'Rengøring af bikagebord',
      },
      lube: {
        keyPoints: 'Rengør styrestængerne, lineærskinnen og fokuseringsmekanismen, og smør dem derefter igen. Hyppigheden afhænger af det materiale, du skærer.',
        name: 'Smøring',
      },
      maintain_test: {
        keyPoints: 'Kontroller statusvisningen og kontakterne.',
        name: 'MAINTAIN-side',
      },
      mirrors_combiner: {
        keyPoints: 'Fjern snavs fra linser/spejle, og kontroller for oxidering. Ingen alkohol- eller vandmærker må efterlades.',
        name: 'Spejle, fokuseringslinse og strålekombinator',
      },
      mirrors_lens: {
        keyPoints: 'Rengør de 4 spejle og linsen, og sørg for, at der ikke er oxidering eller vandmærker.',
        name: 'Rengøring af spejle og linse',
      },
      mod_diode: {
        keyPoints: 'Rengør blæseren, fokuseringslinsen og POGO pin.',
        name: 'Diode-lasermodul',
      },
      mod_ir: {
        keyPoints: 'Rengør fokuseringslinsen.',
        name: 'Infrarødt lasermodul',
      },
      optical_inspection: {
        keyPoints: 'Efterse den optiske bane; også ved udpakning og efter udskiftning af laserrør.',
        name: 'Eftersyn af optisk bane',
      },
      optical_unboxing: {
        keyPoints: 'Sørg for, at den optiske bane er præcis. Kontroller ved første udpakning.',
        name: 'Eftersyn af optisk bane',
      },
      screen: {
        keyPoints: 'Rengør panelet for støv og fedt.',
        name: 'Rengøring af skærm',
      },
      tube: {
        keyPoints: 'Hvis 3 mm akryl ikke kan skæres ved 70% effekt, skal laserrøret udskiftes.',
        name: 'Tilstandstjek af laserrør',
      },
      water: {
        keyPoints: 'Fyld vand på, indtil det er over 80% fuldt uden luftbobler.',
        name: 'Udskiftning af kølevand',
      },
      worktable: {
        keyPoints: 'Sprøjt alkohol på et stykke køkkenrulle, og tør derefter arbejdsbordet af.',
        name: 'Rengøring af arbejdsbord',
      },
      zaxis: {
        keyPoints: 'Tør Z-aksens søjleskrue af, og påfør derefter smøremiddel jævnt med en vatpind.',
        name: 'Smøring af Z-aksens søjle',
      },
    },
    title: 'Vedligeholdelsestjekliste',
  },
  ...
  message: {
    ...
    enteringRawMode: 'Indtaster maskinstyringtilstand...',
    ...
    preview: {
      ...
      please_focus_before_preview: 'For at få bedre forhåndsvisningskvalitet, udfør venligst automatisk fokusering før forhåndsvisning.',
  ...
  monitor: {
    ...
    HARDWARE_ERROR_KEY_OFF: '#929 Sikkerhedsnøgle ikke registreret\nSikkerhedsnøglen er ikke registreret eller er blevet deaktiveret. For din sikkerhed kan maskinen ikke køre, før nøglen er korrekt tændt.\nIndsæt sikkerhedsnøglen og tænd den, før du genstarter arbejdet.',
    HARDWARE_ERROR_LASER_TEMPERATURE_ABNORMAL: '#933 Unormal lasertemperatur\nLasertemperaturen er for høj. Stop operationen og lad laseren køle ned, før du genstarter.',
    ...
    HARDWARE_ERROR_LIMIT_SWITCH_TRIGGERED: '#934 Maskinen er stoppet — laserhovedet nåede arbejdsområdets grænse.',
  ...
  params_label: {
    check_all: 'Vælg alle',
    layer_name: 'Lagnavn',
    placeholder: 'Parameteretiket',
    preview_hint: 'Dette er en forhåndsvisning. Tekstindholdet opdateres automatisk, før en opgave sendes',
    save_as_default: 'Gem som standard',
    settings: 'Indstillinger for parameteretiket',
    update: 'Opdater',
    updated: 'Parameteretiket opdateret',
    use_default: 'Brug gemt standard',
    use_recommended: 'Brug anbefalede',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      ...
      completing: 'Færdiggør snart',
      detecting: 'Registrerer justeringsmærker',
      locating: 'Finder justeringsmærker',
      preparing: 'Forbereder kameraet',
      refining: 'Finjusterer mærkernes position',
    },
    alignment: {
    ...
    calibration: {
      align_desc: '1. Læg det printede kalibreringsark i arbejdsområdet, fastgør det med tape eller malertape, så det ikke kan glide, og fokusér.\n2. Klik på “Forhåndsvis og justér” for at køre kamerajusteringen.\n3. Når mærkerne er fundet, klikker du på “Rids skalaer” for at tegne referencelinjerne på arket ved lav effekt.',
      aligned: 'Justeringsmærker fundet. Klar til at ridse.',
      auto_read: 'Aflæs skalaer med kamera',
      auto_read_failed: 'Skalaerne kunne ikke aflæses automatisk. Aflæs dem med øjet og indtast værdierne.',
      auto_read_hint: 'Kameraaflæsningen kan afvige med op til ±2; kontrollér den mod arket.',
      current_offset: 'Nuværende forskydning: X %s mm, Y %s mm',
      export_pdf: 'Eksportér kalibrerings-PDF',
      power: 'Effekt',
      print_desc: '1. Eksportér kalibreringsarkets PDF. Det indeholder de fire justeringsmærker og to skalaer.\n2. Print arket i 100 % (faktisk størrelse).',
      reading_desc: '1. Find den længste ridsede linje (den midterste), og bemærk hvilken side af den printede 0-linje den ligger på.\n2. Gå linje for linje mod den side, indtil en ridset linje og en printet linje flugter præcist.\n3. Tæl fra 0 til den printede linje (der er printet tal ved hver 5. linje; tæl de unummererede imellem med).',
      reading_x: 'X-aflæsning',
      reading_y: 'Y-aflæsning',
      scratch: 'Rids skalaer',
      speed: 'Hastighed',
      title: 'Print og skær-kalibrering',
    },
    ...
    finish: 'Afslut',
    fit_content: 'Tilpas til indhold',
    generate_from_contour: 'Generér ud fra kontur',
    grid_columns: 'Kolonner',
    grid_rows: 'Rækker',
    ...
    paper_size: 'Outputstørrelse',
    paper_too_small: 'Outputområdet er for lille. Designet (inklusive justeringsmærker) kræver mindst %s mm margen fra materialets kant for at blive inden for printerens printbare område. Vælg en større outputstørrelse, ellers bliver printet beskåret eller formindsket.',
    preview_and_align: 'Forhåndsvis og justér',
    resume_desc: 'Dette design er allerede forberedt til Print og skær.\nLæg det næste printede materiale i maskinen, og fortsæt til kamerajustering, eller start forfra for at ændre design, outputstørrelse eller skæresti.',
    resume_title: 'Genoptag Print og skær',
    select_cut_layer: 'Lag med skæresti',
    ...
    step_setup: 'Skærestier og mærker',
    ...
    uv_print_file_disabled: 'Print og skær printer indholdet af UV-printlagene. Aktivér "Aktivér UV-printfil" i indstillingerne, og tilføj derefter dit design til et UV-printlag.',
  ...
  puzzle_generator: {
    ...
    exploded_view: 'Sprængningsvisning',
    export_as: 'Eksporter som',
    export_engrave: 'Graveringslag',
    export_failed: 'Kunne ikke importere puslespil til lærred. Prøv igen eller juster puslespilsindstillinger.',
    export_none: 'Ingen',
    export_print: 'Udskriftslag',
    file_too_large: 'Den valgte fil overskrider den maksimalt tilladte størrelse.',
    guide_lines: 'Guidelinjer',
    ...
    layers: {
      board_base: 'Bundplade',
      guide_lines: 'Hjælpelinjer',
      image: 'Puslespilsbillede',
      pieces: 'Puslespilsbrikker',
      raised_edges: 'Hævede kanter',
    },
    offset_x: 'X-forskydning',
    offset_y: 'Y-forskydning',
    orientation: 'Brikkers orientering',
    orientation_type_1: 'Type 1',
    orientation_type_2: 'Type 2',
    orientation_type_3: 'Type 3',
    orientation_type_4: 'Type 4',
    piece_size: 'Brikkestørrelse',
    preview_placeholder: 'Puslespilsvisning',
    puzzle_board: 'Puslespilsbræt',
    puzzle_pieces: 'Puslespilsbrikker',
    radius: 'Radius',
    raised_edges: 'Hævede kanter',
    reset_to_default: 'Nulstil til standard',
    rows: 'Rækker',
    ...
    types: {
      ...
      heart_jigsaw: 'Hjerteformet puslespil',
      hex_jigsaw: 'Sekskant puslespil',
      rectangle_jigsaw: 'Rektangulært puslespil',
    },
    unsupported_file_type: 'Ikke-understøttet filtype. Brug JPG, PNG eller WebP.',
    upload_hint: 'JPG, PNG, WebP (maks. 10MB)',
    upload_image: 'Klik eller træk for at uploade',
    zoom: 'Zoom',
  },
  qr_code_generator: {
  ...
  settings: {
    ...
    simplify_clipper_path: 'Ankerpunkt optimering',
  ...
  tips: {
    canvas_hold_space_to_pan: 'Hold mellemrumstasten nede og træk for at panorere på lærredet.',
    feature_auto_fit: 'Efter kameraforhåndsvisning, brug Handlinger → Auto Fit for automatisk at placere objekter på dit materiale.',
    feature_box_generator: 'Brug Generatorer → Kassegenerator for at oprette kasser i tilpassede størrelser på få sekunder.',
    feature_code_generator: 'Brug Generatorer → QR-kodegenerator for at oprette QR-koder og stregkoder.',
    feature_elements: 'Elements-panelet indeholder nu over en million grafik klar til brug.',
    feature_layer_color_configurations: 'Kortlæg SVG-lagfarver til hastighed og effekt via Rediger → Lag → Farvindstillinger.',
    feature_material_test: 'Brug Generatorer → Materialetestgenerator i venstre værktøjslinje for hurtigt at finde de bedste indstillinger for et materiale.',
    layer_execution_order: 'Lagrække følgen bestemmer jobrækkefølgen. Jobs kører fra top til bund.',
    machine_clean_mirror: 'Kontroller spejle og fokuseringslinse regelmæssigt og rens dem efter behov for at forhindre røgopbygning.',
    machine_no_unattended_operation: 'Efterlad aldrig maskinen kørende uden opsyn.',
    machine_regular_start: 'Kør et laserjob mindst én gang hver anden uge for at hjælpe med at forlænge laserrørets levetid.',
    object_edit_image_to_erase: 'Brug Billede → Handlinger → Rediger billede for at slette uønskede områder i et billede.',
    object_polygon_sides: 'Juster antallet af sider i polygonets egenskabspanel.',
    object_rounded_rectangle: 'Indstil hjørneradius for et afrundet rektangel i rektanglets egenskabspanel.',
    object_sharpen_portrait: 'Forbedr portrætgraveringer med Billede → Handlinger → Skærpe.',
    settings_auto_save: 'Aktiver Autogemme i Præferencer for at undgå at miste dit arbejde.',
    settings_default_text_font: 'Du kan indstille din standardskrifttype for tekstværktøjet i Præferencer.',
    task_focus_lower_for_cutting: 'For tykkere materialer kan fokusering ca. 2 mm under overfladen forbedre skæreresultaterne.',
    task_leather_moisten_reduce_burn: 'Befugt læder let før skæring for at reducere brændmærker.',
    task_parameters_for_promark_color: 'Juster pulsbredde og frekvens på MOPA-lasere for at producere farver på rustfrit stål eller titanium.',
    task_slower_for_smoother_acrylic_edge: 'At reducere skærehastigheden lidt kan producere glattere akrylkanter.',
    tips: 'Tips:',
  },
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Kunne ikke oprette forbindelse til maskinkamera. Genstart venligst din maskine eller Beam Studio. Hvis denne fejl fortsætter, skal du følge <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">denne vejledning</a>.',
      fail_to_get_door_status: 'Sørg venligst for at døren er lukket for at aktivere lav laser til kørsel af ramme.',
      fail_to_start_preview: '#803 Kunne ikke starte forhåndsvisning. Genstart maskinen eller Beam Studio. Hvis fejlen fortsætter, se <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">denne vejledning</a>.',
      ...
      start_preview_timeout: '#803 Timeout opstod ved start af forhåndsvisning. Genstart maskinen eller Beam Studio. Hvis fejlen fortsætter, se <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">denne vejledning</a>.',
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Kalibrer Print og skær',
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Eksporter kalibreringsdata',
      ...
      import_acrylic_focus_probe: 'beamo & Beambox Fokusprobe - 3 mm',
      ...
      import_beamo_2_printing_test: 'beamo II print test',
      import_calibration_data: 'Importer kalibreringsdata',
      ...
      machines: 'Maskiner',
      maintenance_checklist: 'Vedligeholdelsestjekliste',
