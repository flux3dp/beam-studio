...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: 'Download og udskriv følgende fil på A4-papir til kamerakalibrering.',
    put_chessboard_bm2_2: 'Placer kalibreringspapiret fladt på den angivne position på arbejdsområdet.',
