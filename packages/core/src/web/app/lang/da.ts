...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'Outputstørrelsen (%s) overstiger det anbefalede maksimum på %d × %d px. Behandlingen kan tage flere minutter, og resultatet kan gøre Beam Studio langsommere. Fortsæt alligevel?',
    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale_too_large: 'Dette billede er for stort til AI-opskalering. Den maksimalt understøttede størrelse er %d × %d px.',
          array: 'Array',
          auto_fit: 'Auto Fit',
          bevel: 'Fas',
          brightness: 'Lysstyrke',
