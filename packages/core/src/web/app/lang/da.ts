...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Brug af for høje hastigheder til lag med 3D-kurveobjekter kan reducere graveringens præcision.\nVi anbefaler at holde hastigheden under %(limit)s for optimale resultater med 3D-kurveobjekter.',
      too_fast_for_curve_and_constrain: 'Følgende lag: %(layers)s overskrider hastighedsgrænsen på %(limit)s.\nGraveringshastigheden for 3D-kurveobjekter vil blive begrænset til %(limit)s. Du kan fjerne denne begrænsning i Præferencer.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'Graveringshastigheden for 3D-kurveobjekter vil blive begrænset til %(limit)s. Du kan fjerne denne begrænsning i Præferenceindstillinger.',
