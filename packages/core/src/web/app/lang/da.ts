  ...
  beambox: {
    ...
    material_browser: {
      ...
      editor: {
        ...
        parent_hint: 'Hvis angivet, vises det som en tykkelsesvariant under det overordnede materiale (ikke i det øverste gitter).',
        parent_material: 'Overordnet materiale',
        photo: 'Foto',
        tags: 'Tags',
        thickness_inch: 'Tykkelse (tomme)',
        thickness_inch_hint: 'Brøker er tilladt',
