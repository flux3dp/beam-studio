...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    hole_offset: 'Forskydning',
    hole_position: 'Position',
    hole_thickness: 'Tykkelse',
    hole_type: 'Type',
    hole_type_punch: 'Huller',
    hole_type_ring: 'Ring',
    import_to_canvas: 'Importér til lærred',
    layers: {
      keychain: 'Nøglering',
      keychain_inner: 'Nøglering indre',
      keychain_inner_position: 'Justering af nøglering indre',
    },
    letter_spacing: 'Bogstavafstand',
    line_spacing: 'Linjeafstand',
    ...
    position_ref_left_center: 'Venstre',
    position_ref_right_center: 'Højre',
    position_ref_top_center: 'Top',
