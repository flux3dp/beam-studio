...
const lang: ILang = {
  ...
  maintenance: {
    actions: {
      fail: 'Απέτυχε',
      history: 'Ιστορικό',
      mark_checked: 'Σήμανση ως ελεγμένο',
    ...
    feedback: {
      all_essential: 'Όλες οι βασικές εργασίες συντήρησης είναι ενημερωμένες — το %s σας είναι σε άριστη κατάσταση!',
      checked: '%s: ελέγχθηκε.',
    ...
    tasks: {
      ...
      lube: {
        keyPoints: 'Καθαρίστε τους οδηγούς άξονες, τη γραμμική ράγα και τον μηχανισμό εστίασης και μετά λιπάνετε ξανά.',
        name: 'Λίπανση',
      },
      maintain_test: {
  ...
  monitor: {
    ...
    HARDWARE_ERROR_NO_INK_DETECTED: '#926 Δεν εντοπίστηκε δοχείο μελάνης\n1. Αφαιρέστε τη μονάδα εκτύπωσης.\n2. Τοποθετήστε ένα δοχείο μελάνης στη μονάδα.\n3. Επανεγκαταστήστε τη μονάδα εκτύπωσης στο μηχάνημα.',
