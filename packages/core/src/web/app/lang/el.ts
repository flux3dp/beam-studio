...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο επάνω αριστερά.',
    align_4_1: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο επάνω δεξιά.',
    align_4_2: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο κάτω αριστερά.',
    align_4_3: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο κάτω δεξιά.',
    align_8_0: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο στο εξωτερικό επάνω αριστερά.',
    align_8_1: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο στο εξωτερικό επάνω δεξιά.',
    align_8_2: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο στο εξωτερικό κάτω αριστερά.',
    align_8_3: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο στο εξωτερικό κάτω δεξιά.',
    align_8_4: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο στο εσωτερικό επάνω αριστερά.',
    align_8_5: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο στο εσωτερικό επάνω δεξιά.',
    align_8_6: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο στο εσωτερικό κάτω αριστερά.',
    align_8_7: 'Θέση: Ευθυγραμμίστε με το χαραγμένο σημείο στο εσωτερικό κάτω δεξιά.',
    ...
    charuco_open_the_machine_lid: 'Ανοίξτε το καπάκι της μηχανής.',
    charuco_place_charuco: 'Τοποθετήστε το εκτυπωμένο μοτίβο βαθμονόμησης οριζόντια στο <b>%s</b> της περιοχής εργασίας.',
    ...
    check_pnp_desc: 'Έχουμε επαναλάβει τη λήψη εικόνων βάσει των αποτελεσμάτων βαθμονόμησης και σημειώσαμε τα σημεία αναφοράς χάραξης.\nΕλέγξτε αν οι κόκκινοι δείκτες ταιριάζουν με τα πραγματικά σημεία χάραξης.\nΑν παρατηρήσετε κάποια εμφανή αναντιστοιχία, απλώς κάντε κλικ στο "Επαναβαθμονόμηση" για να προσπαθήσετε ξανά.',
    ...
    solve_pnp_keep_door_closed: 'Κρατήστε την πόρτα κλειστή κατά τη διάρκεια της ακόλουθης διαδικασίας. Αν ανοιχτεί, το σύστημα θα προσπαθήσει να επανατοποθετήσει την κάμερα.',
    ...
    solve_pnp_relocate_camera: 'Κάντε κλικ στο "Μετακίνηση κάμερας" αν η κεφαλή λέιζερ δεν είναι ακόμα οριζόντια στο κέντρο.',
