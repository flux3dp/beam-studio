...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'Το μέγεθος εξόδου (%s) υπερβαίνει το συνιστώμενο μέγιστο %d × %d px. Η επεξεργασία μπορεί να διαρκέσει αρκετά λεπτά και το αποτέλεσμα μπορεί να επιβραδύνει το Beam Studio. Συνέχεια ούτως ή άλλως;',
