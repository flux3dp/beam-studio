...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Πώς να βελτιώσετε την ακρίβεια ανίχνευσης;',
    ...
    retake_tooltip: 'Επανάληψη λήψης φωτογραφίας στη θέση κάθε αντικειμένου για καλύτερη ανίχνευση',
    retry_with_remove_bg: 'Αφαίρεση φόντου',
    retry_with_remove_bg_tooltip: 'Αφαίρεση φόντου από την εικόνα προεπισκόπησης για βελτίωση ανίχνευσης περιγράμματος',
    rotation: 'Περιστροφή',
    ...
    use_original_image: 'Χρήση αρχικής εικόνας',
    use_original_image_tooltip: 'Επαναφορά της αρχικής εικόνας προεπισκόπησης χωρίς αφαίρεση φόντου',
    warning_bg_removal: 'Αυτή η λειτουργία θα εκτελέσει τη δυνατότητα "Αφαίρεση φόντου", η οποία θα χρησιμοποιήσει 0,02 Credit. Θέλετε να συνεχίσετε;',
    warning_retake_preview: 'Αυτή η λειτουργία είναι μερική επανάληψη λήψης. Θα προστεθούν νέες εικόνες και φόντο. Θέλετε να συνεχίσετε;',
  },
  autosave: {
    open_settings: 'Άνοιγμα ρυθμίσεων',
    path_not_correct: 'Η τοποθεσία αυτόματης αποθήκευσης δεν υπάρχει πλέον.',
    path_not_correct_desc: 'Παρακαλώ επιλέξτε έναν νέο φάκελο στο <b>%(preferences)s > %(autosave)s > %(path)s</b> για να συνεχίσετε να αποθηκεύετε τη δουλειά σας.',
  },
  barcode_generator: {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s πιστώσεις AI',
      credit_balance: 'Υπόλοιπο πιστώσεων AI',
      credit_cost: 'Χρησιμοποιούμενες πιστώσεις AI',
      description: 'Αυξήστε την ανάλυση και τη λεπτομέρεια της εικόνας με AI. Η αναβαθμισμένη εικόνα θα αντικαταστήσει την αρχική στον καμβά.',
      done: 'Η γενετική αναβάθμιση ολοκληρώθηκε',
      dpi_recommended: 'Συνιστάται για το τρέχον DPI επιπέδου: %dx.',
      dpi_recommended_capped: 'Συνιστάται για το τρέχον DPI επιπέδου: %dx, αλλά το %dx είναι το μέγιστο εντός του συνιστώμενου μεγέθους εξόδου.',
      failed: 'Η γενετική αναβάθμιση δεν ολοκληρώθηκε. Ελέγξτε τη σύνδεση δικτύου και δοκιμάστε ξανά.',
      insufficient_credit: 'Ανεπαρκείς πιστώσεις AI για γενετική αναβάθμιση.',
      layer_dpi: 'DPI επιπέδου',
      original_size: 'Αρχικό μέγεθος',
      output_size: 'Μέγεθος εξόδου',
      oversize_warning: 'Το μέγεθος εξόδου (%s) υπερβαίνει το συνιστώμενο μέγιστο %dpx x %dpx. Η επεξεργασία μπορεί να διαρκέσει αρκετά λεπτά και το αποτέλεσμα μπορεί να επιβραδύνει το Beam Studio. Συνέχεια ούτως ή άλλως;',
      processing: 'Αναβάθμιση σε εξέλιξη…',
      processing_hint: 'Ο χρόνος επεξεργασίας εξαρτάται από το μέγεθος της εικόνας και το δίκτυο.',
      recommended: 'Συνιστάται',
      retry: 'Επανάληψη',
      start: 'Έναρξη αναβάθμισης',
    },
    announcement_panel: {
      title: 'Ανακοίνωση',
    },
    banner: {
      ...
      firmware_warning: {
        message: 'Το %s σας εκτελεί υλικολογισμικό v%s, το οποίο ενδέχεται να επηρεάσει τη σταθερότητα του συστήματος. Συνιστούμε ενημέρωση στην πιο πρόσφατη έκδοση.',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Αντιστοίχιση σε υλικό',
        bucket_hint: 'Αποθηκεύτηκε στη συλλογή «Τα υλικά μου» (Άλλα). Μπορείτε να το μετακινήσετε σε υλικό αργότερα.',
        create_new: 'Δημιουργία νέου υλικού…',
        new_material_name: 'Όνομα νέου υλικού',
        preset_name: 'Όνομα προεπιλογής',
        settings_from_layer: 'Οι ρυθμίσεις αντιγράφηκαν από το τρέχον στρώμα',
        title: 'Αποθήκευση ρυθμίσεων τρέχοντος στρώματος ως προεπιλογή',
      },
      ...
      editor: {
        appearance: 'Εμφάνιση',
        appearance_hint: 'Δεν έχετε φωτογραφία; Επιλέξτε ένα χρώμα εξωφύλλου.',
        category: 'Κατηγορία',
        ...
        photo: 'Φωτογραφία',
        tags: 'Ετικέτες',
        title_add: 'Προσθήκη Υλικού',
        title_edit: 'Επεξεργασία Υλικού',
        upload_hint: 'Κάντε κλικ ή σύρετε μια φωτογραφία. Στη συλλογή εμφανίζεται μεγάλη προεπισκόπηση.',
      },
      enable: 'Ενεργοποίηση',
      export: 'Εξαγωγή',
      favorites: 'Αγαπημένα',
      from_current_layer: 'Από το τρέχον στρώμα',
      import: 'Εισαγωγή',
      machine: 'Μηχάνημα',
      manual: 'Χειροκίνητα',
      manual_settings: 'Χειροκίνητες ρυθμίσεις',
      modified: 'Οι παράμετροι τροποποιήθηκαν μετά την εφαρμογή της προεπιλογής',
      move_to_material: 'Μετακίνηση σε υλικό…',
      new_preset_manual: 'Νέα προεπιλογή…',
      no_materials_in_category: 'Δεν υπάρχουν ακόμη υλικά εδώ για %s.',
      no_presets_for_machine: 'Δεν υπάρχουν ακόμη ρυθμίσεις για %s.',
      no_search_match: 'Κανένα υλικό δεν ταιριάζει με «%s».',
      preset_editor: {
        name: 'Όνομα προεπιλογής',
        name_required: 'Το όνομα είναι υποχρεωτικό',
        title_edit: 'Επεξεργασία προεπιλογής',
        title_new: 'Νέα προεπιλογή',
      },
      presets: 'Προεπιλογές',
      recents: 'Πρόσφατα',
      recents_empty: 'Τα υλικά που εφαρμόστηκαν πρόσφατα θα εμφανίζονται εδώ.',
      regions: {
        auto: 'Αυτόματα',
        eu: 'Ευρώπη',
        global: 'Παγκόσμιο',
      ...
      restore_default: 'Επαναφορά προεπιλογής FLUX',
      result: 'Αποτέλεσμα',
      search_placeholder: 'Αναζήτηση υλικών, ετικετών, κατηγοριών…',
      settings_region: 'Περιοχή Καταλόγου Υλικών',
      settings_use: 'Χρήση Περιηγητή Υλικών',
      showing_bundled: 'Εμφάνιση ενσωματωμένου καταλόγου',
      state_customized: 'Προσαρμοσμένο',
      state_default: 'Προεπιλογή',
      state_disabled: 'Απενεργοποιημένο',
      state_user: 'Ορισμένο από τον χρήστη',
      storage_full: 'Ο αποθηκευτικός χώρος είναι πλήρης και η βιβλιοθήκη υλικών δεν αποθηκεύτηκε. Χρησιμοποιήστε έγχρωμα εξώφυλλα αντί για φωτογραφίες.',
      sure_to_delete_material: 'Διαγραφή αυτού του υλικού και όλων των προεπιλογών του;',
      sure_to_delete_preset: 'Διαγραφή αυτής της προεπιλογής;',
      sure_to_delete_variant: 'Διαγραφή αυτού του πάχους και των προεπιλογών του;',
      sure_to_import: 'Η εισαγωγή θα συγχωνεύσει το αρχείο στη βιβλιοθήκη υλικών σας. Συνέχεια;',
      thickness: 'Πάχος',
      title: 'Περιηγητής Υλικών',
      variant_exists: 'Υπάρχει ήδη παραλλαγή με αυτό το πάχος.',
      variants: '%d παραλλαγές',
    },
    ...
    popup: {
      ...
      disassemble_use: {
        ...
        variable_text_warning: 'Τα αντικείμενα μεταβλητού κειμένου παραλείφθηκαν. Απενεργοποιήστε το μεταβλητό κείμενο πριν την αποσυναρμολόγηση.',
      },
      ...
      path_engine_upgrade: {
        caption: 'Διαθέσιμη ταχύτερη δημιουργία εργασιών',
        keep_current: 'Διατήρηση τρέχουσας',
        message: 'Αναβαθμίσαμε τη μηχανή υπολογισμού εργασιών για βελτίωση της απόδοσης και επιτάχυνση της δημιουργίας εργασιών.\nΘέλετε να μεταβείτε στη νέα επιταχυνόμενη μηχανή;\nΜπορείτε να την απενεργοποιήσετε ανά πάσα στιγμή στο %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'Στη λειτουργία χάραξης καμπυλών, η τρέχουσα ταχύτητα μπορεί να είναι πολύ υψηλή και να επηρεάσει τις λεπτομέρειες χάραξης για τα στρώματα: %(layers)s.\nΣκεφτείτε να μειώσετε την ταχύτητα για καλύτερη ποιότητα.',
    ...
    right_panel: {
      laser_panel: {
        ...
        dropdown: {
          inches: {
            ...
            acrylic_7mm_cutting: 'Aκρυλικό - 1/4″ Κοπή',
            ...
            mdf_7mm_cutting: 'MDF Νέας Ζηλανδίας - 1/4″ Κοπή',
          ...
          mm: {
            ...
            acrylic_7mm_cutting: 'Ακρυλικό - 7mm Κοπή',
        ...
        high_quality_desc: 'Ισχύει μόνο για γεμάτες διανυσματικές χαράξεις και αντικείμενα εικόνας. Η ενεργοποίηση θα μειώσει την επιτάχυνση χάραξης για πιο λεπτά αποτελέσματα.',
        ...
        texture: 'Υφή',
        texture_angle: 'Γωνία',
        texture_intensity: 'Ένταση',
        texture_interval: 'Διάστημα',
        texture_random: 'Τυχαίο',
        texture_stripe: 'Ρίγες',
        times: 'φορές',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Γενετική αναβάθμιση',
          ai_upscale_short: 'Αναβάθμιση',
          ai_upscale_too_large: 'Αυτή η εικόνα είναι πολύ μεγάλη για μεγέθυνση με AI. Το μέγιστο υποστηριζόμενο μέγεθος είναι %dpx x %dpx.',
          array: 'Πίνακας',
          ...
          disabled_by_noun_project: 'Αυτό το σχήμα προστατεύεται από το νόμο περί πνευματικής ιδιοκτησίας, επομένως η διαδρομή του δεν μπορεί να επεξεργαστεί.',
  ...
  boxgen: {
    ...
    inner: 'Εσωτερικό',
    joints: 'Αρμός',
    max_dimension_tooltip: 'Το μέγιστο πλάτος είναι %s, η μέγιστη ρύθμιση ύψους/βάθους είναι %s.',
    merge: 'Συγχώνευση',
    outer: 'Εξωτερικό',
    reset: 'Επαναφορά',
    tCount: 'Μέτρηση T',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Μετακινήστε την κεφαλή λέιζερ για να ευθυγραμμίσετε το κόκκινο φως με το κέντρο του <b>σημείου A</b>.',
    charuco_move_to_point_b: 'Μετακινήστε την κεφαλή λέιζερ οριζόντια για να ευθυγραμμίσετε το κόκκινο φως με το κέντρο του <b>σημείου B</b>.',
    ...
    check_pnp_desc: 'Βεβαιωθείτε ότι οι κόκκινοι δείκτες ευθυγραμμίζονται με τα σημεία χάραξης\nΑν όχι, κάντε κλικ στο "Πίσω" για προσαρμογή.\nΑν όλα είναι εντάξει, μπράβο! 🎉',
    ...
    next: 'Επόμενο',
    no_picture_found: '#852 Η συσκευή σας δεν έχει διαθέσιμες ακατέργαστες φωτογραφίες για βαθμονόμηση. Παρακαλώ εκτελέστε "Ρύθμιση κάμερας (Προχωρημένο)".',
    ...
    put_charuco: 'Τοποθέτηση Μοτίβου Βαθμονόμησης',
    put_charuco_1: 'Εκτυπώστε το μοτίβο βαθμονόμησης (A4/Letter).',
    put_charuco_2: 'Κολλήστε την επίπεδα σε μια σκληρή επιφάνεια.',
    put_charuco_3: 'Τοποθετήστε στο κέντρο και εκτελέστε αυτόματη εστίαση.',
    put_charuco_bm2_1: 'Εκτυπώστε το αρχείο μοτίβου βαθμονόμησης σε χαρτί A4 (Letter Size) για βαθμονόμηση.',
    put_charuco_bm2_2: 'Κάντε κλικ στο “Επόμενο” και ακολουθήστε τις οδηγίες για να τοποθετήσετε το χαρτί.',
    put_charuco_promark_2: "Βεβαιωθείτε ότι το χαρτί βαθμονόμησης είναι καθαρά ορατό χωρίς αντηλιά. Κάντε κλικ στο 'Επόμενο' για να τραβήξετε φωτογραφία.",
    put_charuco_promark_desc_1: 'Χρησιμοποιήστε το χαρτί βαθμονόμησης από το κουτί αξεσουάρ ή εκτυπώστε το ακόλουθο μοτίβο βαθμονόμησης σε χαρτί A4 για βαθμονόμηση της κάμερας.',
    ...
    put_chessboard_promark_desc_2: 'Τοποθετήστε τη σκακιέρα επίπεδη και κεντραρισμένη στην πλατφόρμα εργασίας.',
    ...
    put_paper_promark: 'Τοποθετήστε μαύρο χαρτόνι',
    put_paper_promark_1: 'Τοποθετήστε το μαύρο χαρτόνι από το κουτί των εξαρτημάτων στην πλατφόρμα εργασίας.',
    put_paper_promark_2: 'Ρυθμίστε σωστά την εστίαση και μετά κάντε κλικ στο "Ξεκινήστε τη χάραξη" για να συνεχίσετε.',
  ...
  connection_issue_guide: {
    alert_link: 'Αποσυνδέεται; Δοκιμάστε αυτόν τον τρόπο αντιμετώπισης προβλημάτων.',
    connect_computer: {
      content: 'Ο υπολογιστής σας πρέπει να βρίσκεται στο ίδιο δίκτυο με το μηχάνημα.',
      macos_steps: 'Κάντε κλικ στο εικονίδιο Wi-Fi στη γραμμή μενού. Στη συνέχεια επιλέξτε το hotspot του τηλεφώνου σας.',
      macos_title: 'macOS',
      title: 'Συνδέστε τον υπολογιστή σας',
      windows_steps: 'Κάντε κλικ στο εικονίδιο δικτύου στη γραμμή εργασιών. Στη συνέχεια επιλέξτε το hotspot του τηλεφώνου σας.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Το μηχάνημα δεν μπορεί να βρει το hotspot μου',
      dont_know_hotspot_name: 'Δεν γνωρίζω το όνομα του hotspot μου',
      step1: '1. Στον πίνακα αφής του μηχανήματος, μεταβείτε στο: Δίκτυο → Σύνδεση σε Wi-Fi.',
      step2: '2. Βρείτε και επιλέξτε το όνομα του hotspot του τηλεφώνου σας από τη λίστα Wi-Fi.',
      step3: '3. Εισαγάγετε τον κωδικό πρόσβασης του hotspot και συνδεθείτε.',
    ...
    enter_ip: {
      ...
      placeholder: 'Διεύθυνση IP',
      step1: 'Εισαγάγετε τη διεύθυνση IP που βρήκατε στο προηγούμενο βήμα.',
      step2: 'Κάντε κλικ στο «Επαλήθευση» για να δοκιμάσετε τη σύνδεση.',
      step3: 'Το Beam Studio θα ελέγξει:',
      title: 'Εισαγάγετε τη διεύθυνση IP του μηχανήματός σας',
      verify: 'Επαλήθευση',
    },
    fail: {
      bullet1: '• Το μοντέλο και τον σειριακό αριθμό του μηχανήματός σας',
      bullet2: '• Τη διεύθυνση IP που εμφανίζεται στον πίνακα αφής',
      bullet3: '• Μια περιγραφή του σφάλματος που αντιμετωπίσατε',
      contact_title: 'Όταν επικοινωνείτε με την υποστήριξη, βοηθάει να έχετε:',
      intro: 'Μην ανησυχείτε — αυτό δεν σημαίνει απαραίτητα ότι κάτι δεν πάει καλά με το μηχάνημά σας. Ενδέχεται να υπάρχουν επιπλέον παράγοντες που επηρεάζουν τη σύνδεση. Η ομάδα υποστήριξής μας είναι εδώ για να σας βοηθήσει να το εξακριβώσετε.',
      title: 'Δεν μπορέσαμε να ολοκληρώσουμε τη δοκιμή',
    },
    hotspot: {
      android_steps: 'Ρυθμίσεις → Συνδέσεις → Σημείο πρόσβασης Wi-Fi και σύνδεση δικτύου → Σημείο πρόσβασης Wi-Fi',
      android_title: 'Android',
      ios_steps: 'Ρυθμίσεις → Προσωπικό hotspot → Να επιτρέπεται σε άλλους',
      ios_title: 'iPhone (iOS)',
      tip: 'Συμβουλή: Χρησιμοποιήστε ένα απλό αγγλικό όνομα hotspot και αριθμητικό κωδικό πρόσβασης (π.χ. Όνομα: FLUX_Test   Κωδικός: 12345678)',
      warning_2_4ghz: 'Σημαντικό: Τα μηχανήματα FLUX υποστηρίζουν μόνο Wi-Fi 2.4GHz. Ρυθμίστε το hotspot σας στα 2.4GHz πριν συνεχίσετε.',
    },
    how_it_works: 'Πώς λειτουργεί η δοκιμή:',
    how_it_works_step1: '1. Ρυθμίστε το τηλέφωνό σας ως hotspot Wi-Fi.',
    how_it_works_step2: '2. Συνδέστε το μηχάνημα στο hotspot.',
    how_it_works_step3: '3. Συνδέστε τον υπολογιστή σας στο ίδιο hotspot.',
    how_it_works_step4: '4. Δοκιμάστε τη σύνδεση στο Beam Studio.',
    intro: 'Ας εκτελέσουμε μια γρήγορη δοκιμή για να ελέγξουμε αν το μηχάνημά σας λειτουργεί σωστά. Θα συνδέσουμε το μηχάνημα και τον υπολογιστή σας μέσω του hotspot του κινητού σας τηλεφώνου για να διαπιστώσουμε αν το πρόβλημα οφείλεται στο δίκτυό σας ή στο ίδιο το μηχάνημα.',
    ip_address: {
      step1: 'Στον πίνακα αφής του μηχανήματος, μεταβείτε στο:\nΔίκτυο → Αναζητήστε τη «Διεύθυνση IP»',
      step2: 'Η IP συνήθως μοιάζει με: 172.20.10.x ή 192.168.x.x\n(Αυτό εξαρτάται από το hotspot του τηλεφώνου σας)',
      step3: 'Σημειώστε αυτή τη διεύθυνση IP για το επόμενο βήμα.',
      title: 'Βρείτε τη διεύθυνση IP του μηχανήματός σας',
      warning: 'Αν η IP ξεκινά με 169.254, η σύνδεση απέτυχε. Επιστρέψτε στο Βήμα 1 και προσπαθήστε ξανά.',
    },
    success: {
      cause: 'Το πρόβλημα σύνδεσης που αντιμετωπίσατε πιθανότατα οφείλεται στο περιβάλλον του τοπικού σας δικτύου και όχι στο ίδιο το μηχάνημα.',
      intro: 'Ολοκληρώσατε με επιτυχία τη δοκιμή σύνδεσης Wi-Fi — μπράβο σας! Αυτό επιβεβαιώνει ότι το μηχάνημα FLUX σας λειτουργεί άψογα.',
      recommend1: '• Επικοινωνήστε με τον πάροχο υπηρεσιών διαδικτύου (ISP) ή τον κατασκευαστή του router σας για βοήθεια με τις ρυθμίσεις Wi-Fi',
      recommend2: '• Ρωτήστε τον διαχειριστή δικτύου σας αν βρίσκεστε σε σχολείο, γραφείο ή κοινόχρηστο χώρο εργασίας',
      recommend3: '• Ελέγξτε αν το router σας υποστηρίζει 2.4GHz και δοκιμάστε να το επανεκκινήσετε',
      recommend_title: 'Τι Συνιστούμε:',
      title: 'Μπράβο! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'Γεννήτρια μπρελόκ',
  ...
  keychain_generator: {
    ...
    outline_offset: 'Μετατόπιση περιγράμματος',
    reset_to_default: 'Επαναφορά προεπιλογών',
    shape: 'Σχήμα',
    size_scale: 'Κλίμακα μεγέθους',
  ...
  machine_linking: {
    continue: 'Συνέχεια',
    i_have_read: 'Έχω διαβάσει',
    input_birthday_to_link: 'Εισαγάγετε την ημερομηνία γέννησής σας για να ολοκληρώσετε τη σύνδεση της συσκευής',
    input_birthday_to_link_note: '*Χρησιμοποιείται για να επαληθεύσει εάν η ηλικία σας πληροί τις προϋποθέσεις επιλεξιμότητας',
    link_failed: 'Η σύνδεση απέτυχε.',
    link_failed_already_linked: 'Αυτή η συσκευή είναι αυτή τη στιγμή συνδεδεμένη με άλλο FLUX ID. Μπορείτε να συνεχίσετε να τη χρησιμοποιείτε ή να τη συνδέσετε με τον λογαριασμό σας.',
    link_failed_cannot_set_secret: 'Δεν είναι δυνατή η αποθήκευση των πληροφοριών σύνδεσης στη συσκευή. Ελέγξτε τη σύνδεση μεταξύ του υπολογιστή και της συσκευής σας.',
    link_failed_under_age: 'Δεν πληροίτε επί του παρόντος τις προϋποθέσεις για τη χρήση αυτής της υπηρεσίας και δεν μπορείτε να ολοκληρώσετε τη σύνδεση της συσκευής.',
    link_machine: 'Σύνδεση FLUX ID',
    link_machine_to_account: 'Συνδέθηκε με %(name)s. Θέλετε να συνδέσετε αυτή τη συσκευή με τον λογαριασμό σας;',
    link_success: 'Επιτυχής σύνδεση.',
    link_to_my_flux_id: 'Σύνδεση με το FLUX ID μου',
    privacy_policy: 'Πολιτική Απορρήτου',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Σύνδεση…',
    use_without_linking: 'Χρήση χωρίς σύνδεση',
  },
  machine_status: {
  ...
  maintenance: {
    ...
    areas: {
      back_cover: 'Πίσω κάλυμμα',
      modules: 'Μονάδες',
      optics: 'Οπτικά',
      panel: 'Πίνακας',
      working_area: 'Περιοχή εργασίας',
    },
    cadence: {
      by_material: 'Ανά υλικό',
      condition: 'Κατά συνθήκη',
      day: 'Κάθε ημέρα',
      days: 'Κάθε %s ημέρες',
      each_operation: 'Σε κάθε χρήση',
      every_1_2_weeks: 'Κάθε 1–2 εβδομάδες',
      month: 'Κάθε μήνα',
      months: 'Κάθε %s μήνες',
      upon_unboxing: 'Κατά την πρώτη αποσυσκευασία',
      week: 'Κάθε εβδομάδα',
      weeks: 'Κάθε %s εβδομάδες',
    },
    celebration: {
      subtitle: 'Το %s σας είναι σε άριστη κατάσταση — συνεχίστε έτσι.',
      title: 'Όλες οι βασικές εργασίες συντήρησης ολοκληρώθηκαν!',
    },
    columns: {
      cadence: 'Συχνότητα',
      status: 'Κατάσταση',
    ...
    empty_no_machine: 'Συνδέστε ή επιλέξτε ένα μηχάνημα για να δείτε το πρόγραμμα συντήρησής του.',
    empty_no_schedule: 'Δεν υπάρχει ακόμη διαθέσιμη λίστα συντήρησης για αυτό το μοντέλο.',
    essential: 'Βασικό',
    essential_health: 'Βασική υγεία',
    essential_hint: 'μετρά στην υγεία',
    feedback: {
      checked: '%s: ελέγχθηκε.',
      done: '%s: ολοκληρώθηκε. Επόμενη προθεσμία %s.',
      done_no_date: '%s: ολοκληρώθηκε.',
      fail_warning: '%s: επισημάνθηκε για αντικατάσταση σωλήνα. Ανοίξτε τον οδηγό για τα βήματα.',
      passed: '%s: πέρασε — ο σωλήνας λέιζερ είναι υγιής!',
    },
    footer_tip: 'Συμβουλή: χαράξτε ένα δοκιμαστικό αρχείο κάθε μήνα για να διατηρείτε το μηχάνημα υγιές.',
    history_hint: 'Διατηρούνται μόνο οι %s πιο πρόσφατες καταχωρίσεις για κάθε εργασία.',
    intro: 'Παρακολουθήστε κάθε εργασία συντήρησης για αυτό το μηχάνημα και σημειώστε την ως ολοκληρωμένη με ένα κλικ.',
    legend: {
      due_soon: 'Επίκειται σύντομα',
      overdue: 'Εκπρόθεσμο',
    ...
    status: {
      ...
      healthy: 'Υγιής',
      last: 'Τελευταία',
      never_done: 'Δεν έγινε ποτέ',
      next: 'Επόμενη προθεσμία',
      not_checked: 'Μη ελεγμένο',
      not_logged: 'Μη καταγεγραμμένο',
      overdue: 'Εκπρόθεσμο',
      replace_tube: 'Αντικατάσταση σωλήνα',
    },
    tasks: {
      align: {
        keyPoints: 'Ρυθμίστε όταν η οπτική διαδρομή είναι εκτός ευθυγράμμισης.',
        name: 'Ευθυγράμμιση οπτικής διαδρομής',
      },
      chassis: {
        keyPoints: 'Αφαιρέστε τα υπολείμματα και την πίσσα από το σασί και το κάτω κάλυμμα.',
        name: 'Καθαρισμός σασί',
      },
      door: {
        keyPoints: 'Αφαιρέστε το λίπος από το κάλυμμα της πόρτας.',
        name: 'Καθαρισμός καλύμματος πόρτας',
      },
      exhaust: {
        keyPoints: 'Καθαρίστε τη σκόνη από τα πτερύγια του ανεμιστήρα.',
        name: 'Καθαρισμός ανεμιστήρα εξαγωγής',
      },
      fan: {
        keyPoints: 'Αφαιρέστε τη σκόνη από τα πτερύγια του ανεμιστήρα εξαερισμού.',
        name: 'Καθαρισμός ανεμιστήρα εξαερισμού',
      },
      fieldlens: {
        keyPoints: 'Καθαρίστε τον φακό πεδίου, σκουπίζοντας από το κέντρο προς τα έξω με δεξιόστροφη φορά.',
        name: 'Καθαρισμός φακού πεδίου',
      },
      honeycomb_plate: {
        keyPoints: 'Αφαιρέστε τα υπολείμματα και την πίσσα από τα κελιά της πλάκας κηρήθρας.',
        name: 'Καθαρισμός πλάκας κηρήθρας',
      },
      honeycomb_table: {
        keyPoints: 'Αφαιρέστε τα υπολείμματα και την πίσσα από το πλέγμα κηρήθρας.',
        name: 'Καθαρισμός τραπεζιού κηρήθρας',
      },
      lube: {
        keyPoints: 'Καθαρίστε τους οδηγούς άξονες, τη γραμμική ράγα και τον μηχανισμό εστίασης και μετά λιπάνετε ξανά. Η συχνότητα διαφέρει ανάλογα με το υλικό που κόβετε.',
        name: 'Λίπανση',
      },
      maintain_test: {
        keyPoints: 'Ελέγξτε την ένδειξη κατάστασης και τους διακόπτες.',
        name: 'Σελίδα MAINTAIN',
      },
      mirrors_combiner: {
        keyPoints: 'Αφαιρέστε τους ρύπους από τους φακούς/καθρέφτες· ελέγξτε για οξείδωση. Χωρίς υπολείμματα οινοπνεύματος ή νερού.',
        name: 'Καθρέφτες, φακός εστίασης & συνδυαστής δέσμης',
      },
      mirrors_lens: {
        keyPoints: 'Καθαρίστε τους 4 καθρέφτες και τον φακό· βεβαιωθείτε ότι δεν υπάρχει οξείδωση ή στίγματα νερού.',
        name: 'Καθαρισμός καθρεφτών & φακού',
      },
      mod_diode: {
        keyPoints: 'Καθαρίστε τον ανεμιστήρα, τον φακό εστίασης και το POGO pin.',
        name: 'Μονάδα λέιζερ διόδου',
      },
      mod_ir: {
        keyPoints: 'Καθαρίστε τον φακό εστίασης.',
        name: 'Μονάδα υπέρυθρου λέιζερ',
      },
      optical_inspection: {
        keyPoints: 'Επιθεωρήστε την οπτική διαδρομή· επίσης κατά την αποσυσκευασία και μετά την αντικατάσταση του σωλήνα.',
        name: 'Επιθεώρηση οπτικής διαδρομής',
      },
      optical_unboxing: {
        keyPoints: 'Βεβαιωθείτε ότι η οπτική διαδρομή είναι ακριβής. Ελέγξτε κατά την πρώτη αποσυσκευασία.',
        name: 'Επιθεώρηση οπτικής διαδρομής',
      },
      screen: {
        keyPoints: 'Καθαρίστε τη σκόνη και το λίπος από τον πίνακα.',
        name: 'Καθαρισμός οθόνης',
      },
      tube: {
        keyPoints: 'Αν το ακρυλικό 3 mm δεν κόβεται στο 70% της ισχύος, αντικαταστήστε τον σωλήνα.',
        name: 'Έλεγχος υγείας σωλήνα λέιζερ',
      },
      water: {
        keyPoints: 'Προσθέστε νερό μέχρι να γεμίσει πάνω από 80% χωρίς φυσαλίδες αέρα.',
        name: 'Αντικατάσταση νερού ψύξης',
      },
      worktable: {
        keyPoints: 'Ψεκάστε οινόπνευμα σε ένα χαρτομάντιλο και μετά σκουπίστε την επιφάνεια εργασίας.',
        name: 'Καθαρισμός επιφάνειας εργασίας',
      },
      zaxis: {
        keyPoints: 'Σκουπίστε τον κοχλία της κολώνας του άξονα Z και μετά απλώστε ομοιόμορφα λιπαντικό με μια μπατονέτα.',
        name: 'Λίπανση κολώνας άξονα Z',
      },
    },
    title: 'Λίστα συντήρησης',
  },
  ...
  message: {
    ...
    camera: {
      ...
      calibration_data_missing: 'Ρύθμιση βαθμονόμησης κάμερας',
      calibration_data_missing_message: 'Λείπουν τα δεδομένα βαθμονόμησης κάμερας.\nΕισαγάγετε τα αποθηκευμένα δεδομένα βαθμονόμησης ή εκτελέστε βαθμονόμηση κάμερας.',
      ...
      switching_camera: 'Αλλαγή κάμερας...',
      wide_angle_open_door: 'Ανοίξτε το κάλυμμα της πόρτας',
      wide_angle_open_door_text: 'Ανοίξτε το κάλυμμα της πόρτας πριν μεταβείτε στην ευρυγώνια κάμερα.',
    ...
    preview: {
      ...
      please_focus_before_preview: 'Για καλύτερη ποιότητα προεπισκόπησης, εκτελέστε αυτόματη εστίαση πριν την προεπισκόπηση.',
  ...
  monitor: {
    ...
    HARDWARE_ERROR_CARTRIDGE_OVERHEAT: '#931 Ειδοποίηση θερμοκρασίας δοχείου μελάνης\nΗ θερμοκρασία του δοχείου μελάνης υπερβαίνει το κανονικό εύρος.\nΓια προστασία, η εργασία διακόπηκε. Παρακαλώ επανεγκαταστήστε το δοχείο μελάνης και επανεκκινήστε την εργασία.',
    HARDWARE_ERROR_CARTRIDGE_POWERON_FAILED: '#930 Επανεγκαταστήστε το δοχείο μελάνης\nΕντοπίστηκε κακή σύνδεση στο δοχείο μελάνης. Παρακαλώ επανεγκαταστήστε το δοχείο μελάνης και δοκιμάστε ξανά.',
    ...
    HARDWARE_ERROR_KEY_OFF: '#929 Δεν εντοπίστηκε κλειδί ασφαλείας\nΤο κλειδί ασφαλείας δεν εντοπίζεται ή έχει απενεργοποιηθεί. Για την ασφάλειά σας, το μηχάνημα δεν μπορεί να λειτουργήσει μέχρι να ενεργοποιηθεί σωστά το κλειδί.\nΠαρακαλώ τοποθετήστε το κλειδί ασφαλείας και ενεργοποιήστε το πριν επανεκκινήσετε την εργασία.',
    HARDWARE_ERROR_LASER_TEMPERATURE_ABNORMAL: '#933 Ανώμαλη θερμοκρασία λέιζερ\nΗ θερμοκρασία του λέιζερ είναι πολύ υψηλή. Παρακαλώ σταματήστε τη λειτουργία και αφήστε το λέιζερ να κρυώσει πριν επανεκκινήσετε.',
    HARDWARE_ERROR_LASER_VOLTAGE_ABNORMAL: '#932 Ανώμαλη τάση λέιζερ\nΣφάλμα τάσης λέιζερ. Παρακαλώ επανεκκινήστε το μηχάνημα. Εάν το πρόβλημα παραμένει, επικοινωνήστε με την υποστήριξη πελατών.',
    HARDWARE_ERROR_LIMIT_SWITCH_TRIGGERED: '#934 Το μηχάνημα σταμάτησε — η κεφαλή λέιζερ έφτασε στο όριο της περιοχής εργασίας.',
    ...
    HARDWARE_ERROR_MAINBOARD_NO_RESPONSE: '#928 Η κύρια πλακέτα δεν ανταποκρίνεται\nΗ κύρια πλακέτα δεν ανταποκρίνεται. Παρακαλώ επανεκκινήστε την εργασία.',
    ...
    HARDWARE_ERROR_PUMP_ERROR: '#900 Χαμηλή ροή ψυκτικού. Παρακαλώ ελέγξτε τη δεξαμενή νερού σας.',
    HARDWARE_ERROR_REMOTE_INTERLOCK_OPENED: '#927 Ενεργοποίηση απομακρυσμένου διακόπτη ασφαλείας\nΠαρακαλώ ελέγξτε τον σύνδεσμο του απομακρυσμένου διακόπτη ασφαλείας και βεβαιωθείτε ότι είναι σωστά συνδεδεμένος πριν επανεκκινήσετε την εργασία.',
    ...
    USER_OPERATION_CARTRIDGE_INK_EMPTY: 'Κενή κασέτα\nΗ κασέτα δεν έχει μελάνι. Αντικαταστήστε την κασέτα για να συνεχίσετε την εκτύπωση.',
    USER_OPERATION_CARTRIDGE_INK_LOW: 'Χαμηλή στάθμη μελανιού\nΤο μελάνι στην κασέτα εξαντλείται. Συνιστούμε να αντικαταστήσετε την κασέτα σύντομα.',
    ...
    USER_OPERATION_USER_Z_AXIS_CHECK_REQUIRED: 'Υπενθύμιση εστίασης\nΕστιάστε ξανά πριν ξεκινήσετε μια νέα εργασία για να διασφαλίσετε ακριβή αποτελέσματα.',
  },
  my_cloud: {
    action: {
  ...
  params_label: {
    ...
    placeholder: 'Ετικέτα παραμέτρων',
    preview_hint: 'Αυτή είναι μια προεπισκόπηση. Το περιεχόμενο του κειμένου θα ενημερωθεί αυτόματα πριν από την αποστολή μιας εργασίας',
    save_as_default: 'Αποθήκευση ως προεπιλογή',
    settings: 'Ρυθμίσεις ετικέτας παραμέτρων',
    update: 'Ενημέρωση',
    updated: 'Η ετικέτα παραμέτρων ενημερώθηκε',
    use_default: 'Χρήση αποθηκευμένης προεπιλογής',
    use_recommended: 'Χρήση προτεινόμενων',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      calculating: 'Υπολογισμός…',
      capturing: 'Λήψη εικόνας',
      completing: 'Ολοκληρώνεται σύντομα',
      detecting: 'Ανίχνευση σημαδιών ευθυγράμμισης',
      locating: 'Εντοπισμός σημαδιών ευθυγράμμισης',
      preparing: 'Προετοιμασία κάμερας',
      refining: 'Βελτίωση θέσης σημαδιών',
    },
    alignment: {
      detect_failed: 'Δεν ανιχνεύθηκαν αρκετά σημάδια ευθυγράμμισης. Επαναλάβετε την προεπισκόπηση κάμερας και δοκιμάστε ξανά.',
      fit_error: 'Σφάλμα προσαρμογής (X / Y)',
      no_preview: 'Δεν βρέθηκε εικόνα προεπισκόπησης κάμερας. Εκτελέστε πρώτα την προεπισκόπηση κάμερας για να καταγράψετε το εκτυπωμένο υλικό.',
      rotation: 'Περιστροφή',
      scale: 'Κλίμακα',
      success: 'Η ευθυγράμμιση ολοκληρώθηκε!',
    },
    backend_outdated: 'Το τρέχον υλικολογισμικό του μηχανήματος δεν υποστηρίζει ακόμη τη λειτουργία Print & Cut.',
    calibration: {
      align_desc: '1. Τοποθετήστε το εκτυπωμένο φύλλο βαθμονόμησης στην περιοχή εργασίας, σταθεροποιήστε το με ταινία ή χαρτοταινία ώστε να μη γλιστρά και εστιάστε.\n2. Κάντε κλικ στο «Προεπισκόπηση και ευθυγράμμιση» για να εκτελέσετε την ευθυγράμμιση κάμερας.\n3. Μόλις βρεθούν τα σημάδια, κάντε κλικ στο «Χάραξη κλιμάκων» για να χαραχτούν οι γραμμές αναφοράς στο φύλλο με χαμηλή ισχύ.',
      aligned: 'Εντοπίστηκαν τα σημάδια ευθυγράμμισης. Έτοιμο για χάραξη.',
      auto_read: 'Ανάγνωση κλιμάκων με κάμερα',
      auto_read_failed: 'Δεν ήταν δυνατή η αυτόματη ανάγνωση των κλιμάκων. Διαβάστε τις με το μάτι και εισαγάγετε τις τιμές.',
      auto_read_hint: 'Η ανάγνωση της κάμερας μπορεί να αποκλίνει έως ±2· ελέγξτε την στο φύλλο.',
      current_offset: 'Τρέχουσα μετατόπιση: X %s mm, Y %s mm',
      export_pdf: 'Εξαγωγή PDF βαθμονόμησης',
      power: 'Ισχύς',
      print_desc: '1. Εξαγάγετε το PDF του φύλλου βαθμονόμησης. Περιέχει τα τέσσερα σημάδια ευθυγράμμισης και δύο κλίμακες.\n2. Εκτυπώστε το φύλλο σε κλίμακα 100% (πραγματικό μέγεθος).',
      reading_desc: '1. Βρείτε τη μακρύτερη χαραγμένη γραμμή (τη μεσαία) και σημειώστε σε ποια πλευρά της εκτυπωμένης γραμμής 0 βρίσκεται.\n2. Προχωρήστε γραμμή προς γραμμή προς αυτή την πλευρά μέχρι μια χαραγμένη γραμμή να ευθυγραμμιστεί ακριβώς με μια εκτυπωμένη.\n3. Μετρήστε από το 0 έως αυτή την εκτυπωμένη γραμμή (οι αριθμοί τυπώνονται κάθε 5 γραμμές· μετρήστε και τις ενδιάμεσες χωρίς αριθμό).',
      reading_x: 'Ένδειξη X',
      reading_y: 'Ένδειξη Y',
      scratch: 'Χάραξη κλιμάκων',
      speed: 'Ταχύτητα',
      title: 'Βαθμονόμηση Εκτύπωση και κοπή',
    },
    continue_to_alignment: 'Συνέχεια στην ευθυγράμμιση',
    cutting_layer_name: 'Εκτύπωση και κοπή - Κοπή',
    design_changed: 'Το σχέδιο άλλαξε μετά την εκτύπωση, επομένως εμφανίζεται μόνο η διαδρομή κοπής.\nΣυνεχίστε για να ευθυγραμμίσετε ένα υλικό που εκτυπώθηκε νωρίτερα, ή ξεκινήστε από την αρχή για να προετοιμάσετε το τρέχον σχέδιο.',
    export_pdf: 'Εξαγωγή PDF',
    finish: 'Ολοκλήρωση',
    fit_content: 'Προσαρμογή στο περιεχόμενο',
    generate_from_contour: 'Δημιουργία από περίγραμμα',
    grid_columns: 'Στήλες',
    grid_rows: 'Γραμμές',
    grid_spacing: 'Απόσταση (mm)',
    no_content: 'Δεν υπάρχει περιεχόμενο στα επίπεδα εκτύπωσης UV. Προσθέστε το σχέδιό σας σε ένα επίπεδο εκτύπωσης UV πριν χρησιμοποιήσετε την Εκτύπωση και κοπή.',
    no_layer_with_path: 'Καμία στρώση λέιζερ δεν περιέχει διανυσματική διαδρομή. Προετοιμάστε μια στρώση λέιζερ με τη διαδρομή κοπής για να τη χρησιμοποιήσετε ως περίγραμμα.',
    no_uv_layer: 'Δεν βρέθηκε επίπεδο εκτύπωσης UV. Αλλάξτε τη μονάδα του επιπέδου σχεδίου σε «UV Εκτύπωση» για να χρησιμοποιήσετε την Εκτύπωση και κοπή.',
    open_preferences: 'Άνοιγμα προτιμήσεων',
    orientation: 'Προσανατολισμός',
    orientation_landscape: 'Οριζόντιος',
    orientation_portrait: 'Κατακόρυφος',
    paper_size: 'Μέγεθος εξόδου',
    paper_too_small: 'Η περιοχή εξόδου είναι πολύ μικρή. Το σχέδιο (μαζί με τα σημάδια ευθυγράμμισης) χρειάζεται τουλάχιστον %s mm περιθώριο από την άκρη του υλικού ώστε να παραμείνει εντός της εκτυπώσιμης περιοχής του εκτυπωτή. Επιλέξτε μεγαλύτερο μέγεθος εξόδου, διαφορετικά η εκτύπωση θα περικοπεί ή θα σμικρυνθεί.',
    preview_and_align: 'Προεπισκόπηση και ευθυγράμμιση',
    resume_desc: 'Αυτό το σχέδιο είναι ήδη έτοιμο για Εκτύπωση και κοπή.\nΤοποθετήστε το επόμενο εκτυπωμένο υλικό στο μηχάνημα και συνεχίστε στην ευθυγράμμιση με κάμερα, ή ξεκινήστε από την αρχή για να αλλάξετε το σχέδιο, το μέγεθος εξόδου ή τη διαδρομή κοπής.',
    resume_title: 'Συνέχιση Εκτύπωσης και κοπής',
    select_cut_layer: 'Στρώση διαδρομής κοπής',
    start_over: 'Έναρξη από την αρχή',
    step_align: 'Ευθυγράμμιση με κάμερα',
    step_align_desc: 'Τοποθετήστε το εκτυπωμένο υλικό στο μηχάνημα και εκτελέστε προεπισκόπηση κάμερας.\nΤα σημάδια ανιχνεύονται και οι γραμμές κοπής ευθυγραμμίζονται αυτόματα με την εκτύπωση.\nΚάντε κλικ στο «Ολοκλήρωση» για να προστεθεί η ευθυγραμμισμένη στρώση κοπής στον καμβά· οι αρχικές στρώσεις σχεδίου θα αποκρυφτούν.\nΣτη συνέχεια στείλτε την εργασία από τον επεξεργαστή.',
    step_export: 'Εξαγωγή και εκτύπωση PDF',
    step_export_desc: 'Εξαγάγετε ένα PDF που περιέχει το σχέδιό σας και τα σημάδια ευθυγράμμισης και εκτυπώστε το στον εκτυπωτή σας σε κλίμακα 100% (πραγματικό μέγεθος).\nΜην χρησιμοποιήσετε «Προσαρμογή στη σελίδα», διαφορετικά η διαδρομή κοπής δεν θα ταιριάζει με την εκτύπωση.\nΟι μετατοπισμένες διαδρομές κοπής δεν περιλαμβάνονται, καθώς χρησιμοποιούνται μόνο από τον κόπτη λέιζερ.',
    step_paper: 'Μέγεθος εξόδου',
    step_paper_desc: 'Επιλέξτε το μέγεθος εξόδου για το εξαγόμενο PDF.\nΟρίστε γραμμές και στήλες για να εκτυπώσετε και να κόψετε πολλαπλά αντίγραφα του σχεδίου σας σε ένα κομμάτι υλικού.\nΗ προεπισκόπηση εμφανίζει το όριο εξόδου γύρω από το περιεχόμενο.',
    step_setup: 'Διαδρομές κοπής και σημάδια',
    step_setup_desc: 'Επιλέξτε πώς θα δημιουργηθεί η διαδρομή κοπής: δημιουργία περιγράμματος γύρω από ολόκληρο το σχέδιο ή χρήση υπάρχουσας στρώσης ως διαδρομή κοπής.',
    title: 'Εκτύπωση και κοπή',
    use_layer_as_cut_path: 'Χρήση στρώσης',
    uv_print_file_disabled: 'Η Εκτύπωση και κοπή εκτυπώνει το περιεχόμενο των επιπέδων εκτύπωσης UV. Ενεργοποιήστε την επιλογή «Ενεργοποίηση αρχείου εκτύπωσης UV» στις προτιμήσεις και προσθέστε το σχέδιό σας σε ένα επίπεδο εκτύπωσης UV.',
    white_mark_base: 'Λευκό φόντο κάτω από τα σημάδια',
  },
  ...
  puzzle_generator: {
    ...
    columns: 'Στήλες',
    design_preview: 'Προεπισκόπηση σχεδίου',
    exploded_view: 'Διασπασμένη προβολή',
    export_as: 'Εξαγωγή ως',
    export_engrave: 'Επίπεδο χάραξης',
    export_failed: 'Αποτυχία εισαγωγής παζλ στον καμβά. Δοκιμάστε ξανά ή προσαρμόστε τις ρυθμίσεις παζλ.',
    export_none: 'Κανένα',
    export_print: 'Επίπεδο εκτύπωσης',
    file_too_large: 'Το επιλεγμένο αρχείο υπερβαίνει το μέγιστο επιτρεπόμενο μέγεθος.',
    guide_lines: 'Γραμμές οδηγού',
    heart_sharpness: 'Οξύτητα αιχμής',
    image: 'Εικόνα',
    ...
    orientation_type_1: 'Τύπος 1',
    orientation_type_2: 'Τύπος 2',
    orientation_type_3: 'Τύπος 3',
    orientation_type_4: 'Τύπος 4',
    piece_size: 'Μέγεθος κομματιών',
    preview_placeholder: 'Προεπισκόπηση παζλ',
    puzzle_board: 'Πλάκα παζλ',
    puzzle_pieces: 'Κομμάτια παζλ',
    radius: 'Ακτίνα',
    raised_edges: 'Ανυψωμένα άκρα',
    reset_to_default: 'Επαναφορά στις προεπιλογές',
    rows: 'Γραμμές',
    switch_type_warning: 'Οι τρέχουσες ρυθμίσεις σας δεν έχουν ακόμη εισαχθεί στον καμβά.\nΗ αλλαγή τύπου παζλ θα επαναφέρει όλες τις ρυθμίσεις στις προεπιλογές.',
    tab_size: 'Μέγεθος καρτέλας',
    types: {
      circle_jigsaw: 'Κυκλικό παζλ',
      heart_jigsaw: 'Παζλ σε σχήμα καρδιάς',
      hex_jigsaw: 'Εξαγωνικό παζλ',
      rectangle_jigsaw: 'Ορθογώνιο παζλ',
    },
    unsupported_file_type: 'Μη υποστηριζόμενος τύπος αρχείου. Χρησιμοποιήστε JPG, PNG ή WebP.',
    upload_hint: 'JPG, PNG, WebP (μέγ. 10MB)',
    upload_image: 'Κάντε κλικ ή σύρετε για μεταφόρτωση',
    zoom: 'Ζουμ',
  },
  qr_code_generator: {
  ...
  settings: {
    ai_contour_detection: 'Ανίχνευση περιγράμματος με AI',
    ai_contour_detection_tooltip: 'Χρησιμοποιεί μοντέλο AI για να εντοπίσει αντικείμενα στην προεπισκόπηση κάμερας. Πιο ακριβής σε υλικά με υφή, αλλά πιο αργή σε παλαιότερους υπολογιστές· απενεργοποιήστε για κλασική ανίχνευση. Χρησιμοποιείται από: Αυτόματη Προσαρμογή.',
    ...
    show_banners: 'Εμφάνιση μπάνερ αρχικής σελίδας',
  ...
  tips: {
    canvas_hold_space_to_pan: 'Κρατήστε πατημένο το πλήκτρο Space και σύρετε για μετακίνηση στον καμβά.',
    feature_auto_fit: 'Μετά την προεπισκόπηση κάμερας, χρησιμοποιήστε Ενέργειες → Αυτόματη Προσαρμογή για αυτόματη τοποθέτηση αντικειμένων στο υλικό σας.',
    feature_box_generator: 'Χρησιμοποιήστε Γεννήτριες → Γεννήτρια Κουτιών για να δημιουργήσετε κουτιά προσαρμοσμένου μεγέθους σε δευτερόλεπτα.',
    feature_code_generator: 'Χρησιμοποιήστε Γεννήτριες → Γεννήτρια Barcode για να δημιουργήσετε κωδικούς QR και barcodes.',
    feature_elements: 'Το πάνελ Στοιχεία περιλαμβάνει τώρα πάνω από ένα εκατομμύριο γραφικά έτοιμα προς χρήση.',
    feature_layer_color_configurations: 'Αντιστοιχίστε χρώματα επιπέδων SVG σε ταχύτητα και ισχύ μέσω Επεξεργασία → Επίπεδο → Ρυθμίσεις Χρώματος.',
    feature_material_test: 'Χρησιμοποιήστε Γεννήτριες → Γεννήτρια Δοκιμής Υλικού στην αριστερή γραμμή εργαλείων για να βρείτε γρήγορα τις καλύτερες ρυθμίσεις για ένα υλικό.',
    layer_execution_order: 'Η σειρά των επιπέδων καθορίζει τη σειρά εργασίας. Οι εργασίες εκτελούνται από πάνω προς τα κάτω.',
    machine_clean_mirror: 'Ελέγχετε τακτικά τους καθρέφτες και τον φακό εστίασης και καθαρίζετέ τους όταν χρειάζεται για να αποφύγετε τη συσσώρευση καπνού.',
    machine_no_unattended_operation: 'Μην αφήνετε ποτέ το μηχάνημα να λειτουργεί χωρίς επίβλεψη.',
    machine_regular_start: 'Εκτελέστε μια εργασία λέιζερ τουλάχιστον μία φορά κάθε δύο εβδομάδες για να βοηθήσετε στην επέκταση της διάρκειας ζωής του σωλήνα λέιζερ.',
    object_edit_image_to_erase: 'Χρησιμοποιήστε Εικόνα → Ενέργειες → Επεξεργασία Εικόνας για να διαγράψετε ανεπιθύμητες περιοχές σε μια εικόνα.',
    object_polygon_sides: 'Προσαρμόστε τον αριθμό των πλευρών στον πίνακα ιδιοτήτων του πολυγώνου.',
    object_rounded_rectangle: 'Ορίστε την ακτίνα της γωνίας ενός στρογγυλεμένου ορθογωνίου στον πίνακα ιδιοτήτων του ορθογωνίου.',
    object_sharpen_portrait: 'Βελτιώστε τις χαρακτικές πορτρέτων με Εικόνα → Ενέργειες → Όξυνση.',
    settings_auto_save: 'Ενεργοποιήστε την Αυτόματη Αποθήκευση στις Προτιμήσεις για να αποφύγετε να χάσετε τη δουλειά σας.',
    settings_default_text_font: 'Μπορείτε να ορίσετε την προεπιλεγμένη γραμματοσειρά για το εργαλείο Κειμένου στις Προτιμήσεις.',
    task_focus_lower_for_cutting: 'Για παχύτερα υλικά, η εστίαση περίπου 2 mm κάτω από την επιφάνεια μπορεί να βελτιώσει τα αποτελέσματα κοπής.',
    task_leather_moisten_reduce_burn: 'Υγράνετε ελαφρά το δέρμα πριν από την κοπή για να μειώσετε τα σημάδια καψίματος.',
    task_parameters_for_promark_color: 'Προσαρμόστε το πλάτος παλμού και τη συχνότητα σε λέιζερ MOPA για να παράγετε χρώματα σε ανοξείδωτο χάλυβα ή τιτάνιο.',
    task_slower_for_smoother_acrylic_edge: 'Η μείωση της ταχύτητας κοπής ελαφρώς μπορεί να παράγει πιο λείες ακρυλικές άκρες.',
    tips: 'Συμβουλές:',
  },
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Αποτυχία σύνδεσης με την κάμερα. Κάντε επανεκκίνηση του μηχανήματος ή του Beam Studio. Αν το σφάλμα επιμένει, ακολουθήστε <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">αυτόν τον οδηγό</a>.',
      ...
      fail_to_start_preview: '#803 Αποτυχία εκκίνησης προεπισκόπησης. Κάντε επανεκκίνηση του μηχανήματος ή του Beam Studio. Αν το σφάλμα επιμένει, ακολουθήστε <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">αυτόν τον οδηγό</a>.',
      ...
      start_preview_timeout: '#803 Χρονικό όριο κατά την εκκίνηση της προεπισκόπησης. Κάντε επανεκκίνηση του μηχανήματος ή του Beam Studio. Αν το σφάλμα επιμένει, ακολουθήστε <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">αυτόν τον οδηγό</a>.',
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Βαθμονόμηση Εκτύπωση και κοπή',
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Εξαγωγή δεδομένων βαθμονόμησης',
      ...
      import_beamo_2_printing_test: 'Δοκιμή εκτύπωσης beamo II',
      import_calibration_data: 'Εισαγωγή δεδομένων βαθμονόμησης',
      import_hello_beambox: 'Παράδειγμα Beambox',
      import_hello_beamo: 'Παράδειγμα του beamo',
      import_hexa_example: 'Παράδειγμα HEXA',
      import_hexa_rf_example: 'Παράδειγμα HEXA RF',
      ...
      machines: 'Μηχανές',
      maintenance_checklist: 'Λίστα συντήρησης',
    ...
    tag_names: {
      ...
      params_label: 'Ετικέτα παραμέτρων',
