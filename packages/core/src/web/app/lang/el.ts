...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Η χρήση πολύ υψηλών ταχυτήτων για στρώματα που περιέχουν αντικείμενα καμπύλης 3D μπορεί να μειώσει την ακρίβεια χάραξης.\nΣυνιστούμε να διατηρείτε την ταχύτητα κάτω από %(limit)s για βέλτιστα αποτελέσματα με αντικείμενα καμπύλης 3D.',
      too_fast_for_curve_and_constrain: 'Τα ακόλουθα στρώματα: %(layers)s υπερβαίνουν το όριο ταχύτητας %(limit)s.\nΗ ταχύτητα χάραξης για αντικείμενα καμπύλης 3D θα περιοριστεί σε %(limit)s. Μπορείτε να αφαιρέσετε αυτόν τον περιορισμό από τις Ρυθμίσεις Προτιμήσεων.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'Η ταχύτητα χάραξης των αντικειμένων 3D καμπύλης θα περιοριστεί στο %(limit)s. Μπορείτε να καταργήσετε αυτόν τον περιορισμό στις Ρυθμίσεις Προτιμήσεων.',
  ...
  framing: {
    ...
    rotation_frame_warning: 'Η προεπισκόπηση πλαισίου θα περιστραφεί μία φορά. Αποφύγετε τη διακοπή στη μέση για να αποτρέψετε την κακή ευθυγράμμιση της σήμανσης. Για να προβάλετε ξανά, περιμένετε να ολοκληρωθεί η περιστροφή πριν κάνετε ξανά κλικ.',
