...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_1: 'Εκτυπώστε τη σκακιέρα (A4/Letter).',
    put_chessboard_2: 'Κολλήστε την επίπεδα σε μια σκληρή επιφάνεια.',
    put_chessboard_3: 'Τοποθετήστε στο κέντρο και εκτελέστε αυτόματη εστίαση.',
