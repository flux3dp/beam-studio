    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          disabled_by_noun_project: 'Τα σχήματα από το Noun Project προστατεύονται από το νόμο περί πνευματικής ιδιοκτησίας, επομένως οι διαδρομές τους δεν μπορούν να επεξεργαστούν.',
