...
const lang: ILang = {
  ...
  message: {
    ...
    detecting_objects: 'Ανίχνευση αντικειμένων στην προεπισκόπηση…',
    device_blocked: {
    ...
    object_detection_failed: 'Η ανίχνευση αντικειμένων απέτυχε· η προσκόλληση σε αντικείμενα δεν είναι διαθέσιμη για αυτήν την προεπισκόπηση.',
    objects_detected: 'Τα αντικείμενα ανιχνεύθηκαν',
  ...
  settings: {
    ...
    ai_contour_detection_tooltip: 'Χρησιμοποιεί μοντέλο AI για να εντοπίσει αντικείμενα στην προεπισκόπηση κάμερας. Πιο ακριβής σε υλικά με υφή, αλλά πιο αργή σε παλαιότερους υπολογιστές· απενεργοποιήστε για κλασική ανίχνευση. Χρησιμοποιείται από: Αυτόματη Προσαρμογή, Προσκόλληση στο κέντρο αντικειμένου.',
  ...
  topbar: {
    ...
    menu: {
      ...
      snap_to_object_center: 'Προσκόλληση στο κέντρο αντικειμένου',
