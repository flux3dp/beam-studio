...
const lang: ILang = {
  ...
  print_and_cut: {
    ...
    no_layer_with_path: 'Καμία στρώση δεν περιέχει διανυσματική διαδρομή. Προετοιμάστε μια στρώση με τη διαδρομή κοπής για να τη χρησιμοποιήσετε ως περίγραμμα.',
