...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    font_size: 'Μέγεθος γραμματοσειράς',
    hole: 'Οπή',
    hole_diameter: 'Διάμετρος',
    hole_offset: 'Μετατόπιση',
    hole_position: 'Θέση',
    hole_thickness: 'Πάχος',
    hole_type: 'Τύπος',
    hole_type_punch: 'Διάτρηση',
    ...
    position_ref: 'Θέση',
    position_ref_bottom_center: 'Κάτω',
    position_ref_left_center: 'Αριστερά',
    position_ref_right_center: 'Δεξιά',
    position_ref_top_center: 'Πάνω',
