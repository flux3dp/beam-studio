  ...
  beambox: {
    ...
    material_browser: {
      ...
      editor: {
        ...
        parent_hint: 'Αν οριστεί, εμφανίζεται ως παραλλαγή πάχους κάτω από το γονικό υλικό (όχι στο κύριο πλέγμα).',
        parent_material: 'Γονικό Υλικό',
        photo: 'Φωτογραφία',
        tags: 'Ετικέτες',
        thickness_inch: 'Πάχος (ίντσες)',
        thickness_inch_hint: 'Επιτρέπεται εισαγωγή κλάσματος',
        thickness_mm: 'Πάχος (mm)',
