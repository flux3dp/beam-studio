...
const lang: ILang = {
  ...
  monitor: {
    ...
    HARDWARE_ERROR_CARTRIDGE_POWERON_FAILED: '#930 Σφάλμα τροφοδοσίας δοχείου μελάνης\nΕντοπίστηκε ανώμαλη σύνδεση τροφοδοσίας στο δοχείο μελάνης. Παρακαλώ επανεγκαταστήστε το δοχείο μελάνης και δοκιμάστε ξανά.',
