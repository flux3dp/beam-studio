...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    shape: 'Σχήμα',
    size: 'Μέγεθος σώματος',
    size_tooltip: 'Το μέγεθος του σώματος του μπρελόκ. Το πραγματικό μέγεθος του μπρελόκ θα είναι μεγαλύτερο από αυτή την τιμή ανάλογα με τις ρυθμίσεις της οπής ανάρτησης.',
