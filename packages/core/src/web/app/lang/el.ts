...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_2_no_indicator: 'Παρακαλώ μετακινήστε το χαρτί με το μοτίβο σκακιέρας ή την κεφαλή λέιζερ μέχρι να επιβεβαιωθεί ότι ολόκληρο το μοτίβο σκακιέρας είναι εντός του παραθύρου ζωντανής προεπισκόπησης.',
