...
const lang: ILang = {
  ...
  message: {
    ...
    camera: {
      ...
      calibration_data_missing: 'Δεν είναι δυνατή η λήψη δεδομένων βαθμονόμησης κάμερας.',
      calibration_data_missing_message: 'Δεν είναι δυνατή η λήψη δεδομένων βαθμονόμησης κάμερας. Εάν εξαγάγατε δεδομένα βαθμονόμησης κάμερας, εισαγάγετε τα δεδομένα στη συσκευή. Διαφορετικά, εκτελέστε βαθμονόμηση κάμερας (Για προχωρημένους) για να βαθμονομήσετε ξανά την κάμερα.',
