    ...
    right_panel: {
      ...
      object_panel: {
        actions_panel: {
          ...
          diabled_by_gradient: 'Απενεργοποιήστε την διαβάθμιση πριν χρησιμοποιήσετε αυτήν τη λειτουργία.',
          diabled_by_infilled: 'Κλείστε τη συμπλήρωση πριν χρησιμοποιήσετε αυτήν τη λειτουργία.',
          diabled_by_infilled_and_variable_text: 'Κλείστε τη συμπλήρωση και το μεταβλητό κείμενο πριν χρησιμοποιήσετε αυτήν τη λειτουργία.',
          diabled_by_variable_text: 'Κλείστε το μεταβλητό κείμενο πριν χρησιμοποιήσετε αυτήν τη λειτουργία.',
