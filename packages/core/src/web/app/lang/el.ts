...
const lang: ILang = {
  ...
  settings: {
    ...
    curve_engraving_speed_limit: 'Όριο ταχύτητας 3D καμπύλης',
  ...
  z_speed_limit_test: {
    alert_before: 'Πριν ξεκινήσει η χάραξη 3D καμπύλης, το σύστημα θα πραγματοποιήσει δοκιμή φόρτωσης για να αποτρέψει την απώλεια βημάτων λόγω υπερβολικού βάρους.',
