...
const lang: ILang = {
  ...
  framing: {
    ...
    frame_preview_warning: 'Η προεπισκόπηση πλαισίου θα περιστραφεί μία φορά. Αποφύγετε τη διακοπή στη μέση για να αποτρέψετε την κακή ευθυγράμμιση της σήμανσης. Για να προβάλετε ξανά, περιμένετε να ολοκληρωθεί η περιστροφή πριν κάνετε ξανά κλικ.',
    framing: 'Πλαισίωση',
