...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: 'Κατεβάστε και εκτυπώστε το παρακάτω αρχείο σε χαρτί μεγέθους A4 για τη βαθμονόμηση της κάμερας.',
    put_chessboard_bm2_2: 'Τοποθετήστε το χαρτί βαθμονόμησης επίπεδο στη καθορισμένη θέση στην πλατφόρμα εργασίας.',
    ...
    put_paper_bm2_1: 'Τοποθετήστε δύο καθαρές λευκές κόλλες μεγέθους A4 ή Letter δίπλα-δίπλα και ισιώστε τις στον χώρο εργασίας.',
