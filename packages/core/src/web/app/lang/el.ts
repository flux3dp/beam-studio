...
const lang: ILang = {
  ...
  layer_module: {
    ...
    notification: {
      ...
      importedDocumentContainsPrinting4C: 'Το έγγραφο περιέχει στρώμα εκτύπωσης (4C), θέλετε να αλλάξετε την περιοχή εργασίας σε beamo II;',
  ...
  settings: {
    ...
    module_offset_4c: 'Αντιστάθμιση εκτύπωσης (4C)',
    ...
    module_offset_uv_varnish: 'Αντιστάθμιση βερνικιού',
    module_offset_uv_white_ink: 'Αντιστάθμιση λευκού μελανιού',
    none: 'Κανένα',
    normal: 'Υψηλό',
