...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'How to improve the detection accuracy?',
    ...
    retake: 'Retake Photo',
    retake_tooltip: "Retake camera photo at each object's position for better detection",
    retry_with_remove_bg: 'Remove Background',
    retry_with_remove_bg_tooltip: 'Remove background from preview image to improve contour detection',
    rotation: 'Rotate',
    ...
    use_original_image_tooltip: 'Restore the original preview image without background removal',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s AI Credits',
      credit_balance: 'AI Credit Balance',
      credit_cost: 'AI Credits Used',
      description: 'Increase image resolution and detail with AI. The upscaled image will replace the original on the canvas.',
      done: 'Generative Upscale completed',
      dpi_recommended: 'Recommended for the current layer DPI: %dx.',
      dpi_recommended_capped: 'Recommended for the current layer DPI: %dx, but %dx is the largest within the recommended output size.',
      failed: 'Generative Upscale could not be completed. Please check your network connection and try again.',
      insufficient_credit: 'Insufficient AI Credits to run Generative Upscale.',
      layer_dpi: 'Layer DPI',
      original_size: 'Original Size',
      output_size: 'Output Size',
      oversize_warning: 'The output size (%s) exceeds the recommended maximum of %dpx x %dpx. Processing may take several minutes and the result may slow down Beam Studio. Continue anyway?',
      processing: 'Upscaling…',
      processing_hint: 'Processing time depends on image size and network conditions.',
    ...
    left_panel: {
      ...
      label: {
        ...
        preview_precise: 'Precise Camera Preview',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Attach to material',
        bucket_hint: 'Saved to your “My Materials” collection (Others). You can move it to a material later.',
        create_new: 'Create new material…',
        new_material_name: 'New material name',
        preset_name: 'Preset name',
        settings_from_layer: 'Settings copied from current layer',
        title: 'Save current layer settings as a preset',
      },
      add_material: 'Add Material',
      add_preset: 'Add preset',
      apply: 'Apply',
      back_to_catalog: 'Back to catalog',
      buy_on_shop: 'Buy on Shop',
      catalog: {
        materials: {
          ...
          felt: 'Felt',
          fluorescent_acrylic: 'Fluorescent Acrylic',
          glass: 'Glass',
          glitter_acrylic: 'Glitter Acrylic',
          gloss_leather: 'Gloss Leather',
          gold: 'Gold',
          iron: 'Iron',
          ...
          mdf: 'MDF',
          metal: 'Metal',
          mirror_acrylic: 'Mirror Acrylic',
          mixed_acrylic: 'Mixed Color Acrylic',
          ...
          sticker: 'Sticker',
          stone: 'Stone',
          sublimation_acrylic: 'Sublimation Acrylic',
          titanium: 'Titanium',
          walnut_veneer: 'Walnut Veneer',
          white_abs: 'White ABS',
          wood: 'Plywood',
        },
        presets: {
          cutting: 'Cutting',
          engraving: 'Engraving',
          engraving_diode: 'Engraving (Diode)',
          engraving_fiber: 'Engraving (Fiber)',
          engraving_spray: 'Engraving (Spray)',
          kiss_cut: 'Kiss Cut',
          marking: 'Marking',
          marking_dark: 'Dark Marking',
          marking_light: 'Light Marking',
          printing: 'Printing',
          printing_fabric: 'Printing (Fabric)',
        },
      },
      categories: {
        acrylic: 'Acrylics',
      ...
      editor: {
        ...
        appearance_hint: 'No photo? Pick a cover color instead.',
        category: 'Category',
        ...
        photo: 'Photo',
        tags: 'Tags',
        title_add: 'Add Material',
        title_edit: 'Edit Material',
        upload_hint: 'Click or drag a photo. Large preview shown in the gallery.',
      },
      enable: 'Enable',
      export: 'Export',
      favorites: 'Favorites',
      from_current_layer: 'From current layer',
      import: 'Import',
      machine: 'Machine',
      manual: 'Manual',
      manual_settings: 'Manual settings',
      modified: 'Parameters edited since the preset was applied',
      move_to_material: 'Move to material…',
      new_preset_manual: 'New preset…',
      no_materials_in_category: 'No materials here for %s yet.',
      no_presets_for_machine: 'No settings for %s yet.',
      no_search_match: 'No materials match “%s”.',
      preset_editor: {
        name: 'Preset name',
        name_required: 'Name is required',
        title_edit: 'Edit preset',
        title_new: 'New preset',
      },
      presets: 'Presets',
      recents: 'Recents',
      recents_empty: 'Recently applied materials will appear here.',
      regions: {
        auto: 'Auto',
        eu: 'Europe',
        global: 'Global',
      ...
      restore_default: 'Restore FLUX default',
      result: 'Result',
      search_placeholder: 'Search materials, tags, categories…',
      settings_region: 'Material Catalog Region',
      settings_use: 'Use Material Browser',
      showing_bundled: 'Showing built-in catalog',
      state_customized: 'Customized',
      state_default: 'Default',
      state_disabled: 'Disabled',
      state_user: 'User Defined',
      storage_full: 'Storage is full, so your material library could not be saved. Try using color covers instead of photos.',
      sure_to_delete_material: 'Delete this material and all of its presets?',
      sure_to_delete_preset: 'Delete this preset?',
      sure_to_delete_variant: 'Delete this thickness and its presets?',
      sure_to_import: 'Importing will merge the file into your material library. Continue?',
      thickness: 'Thickness',
      title: 'Material Browser',
      variant_exists: 'A variant with this thickness already exists.',
      variants: '%d variants',
    },
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: 'Faster Job Generation Available',
        keep_current: 'Keep Current',
        message: 'We’ve upgraded the job calculation engine to improve performance and speed up job generation.\nWould you like to switch to the new accelerated engine?\nYou can turn it off anytime in %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'In Curve Engraving mode, the current speed may be too high and could affect engraving details for layers: %(layers)s.\nConsider reducing the speed for better quality.',
    ...
    right_panel: {
      laser_panel: {
        ...
        dropdown: {
          inches: {
            ...
            acrylic_7mm_cutting: 'Acrylic - 1/4″ Cutting',
            ...
            mdf_7mm_cutting: 'New Zealand MDF - 1/4″ Cutting',
          ...
          mm: {
            ...
            acrylic_7mm_cutting: 'Acrylic - 7mm Cutting',
            ...
            mdf_7mm_cutting: 'New Zealand MDF - 7mm Cutting',
            mdf_engraving: 'New Zealand MDF - Engraving',
            mdf_printing: 'New Zealand MDF - Printing',
            metal_bw_engraving: 'Metal - Engraving',
            opaque_acrylic: 'Opaque Acrylic',
        ...
        texture: 'Texture',
        texture_angle: 'Angle',
        texture_intensity: 'Intensity',
        texture_interval: 'Interval',
        texture_random: 'Random',
        texture_stripe: 'Stripe',
        times: 'times',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Generative Upscale',
          ai_upscale_short: 'Upscale',
          ai_upscale_too_large: 'This image is too large for AI upscaling. The maximum supported size is %dpx x %dpx.',
          array: 'Array',
          auto_fit: 'Auto Fit',
          bevel: 'Bevel',
          brightness: 'Brightness',
          ...
          disabled_by_noun_project: 'This shape is protected by intellectual property law, so its path cannot be edited.',
  ...
  boxgen: {
    ...
    inner: 'Inner',
    joints: 'Joint',
    max_dimension_tooltip: 'Max width is %s, Max height/depth setting is %s. ',
    merge: 'Merge',
    outer: 'Outer',
    reset: 'Reset',
    tCount: 'T Count',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Move the laser head to align the red light  with the center of <b>point A</b>.',
    charuco_move_to_point_b: 'Move the laser head horizontally to align the red light with the center of <b>point B</b>.',
    ...
    check_pnp_desc: 'Make sure the red markers align with the engraving spots\nIf not, click “Back” to adjust.\nIf everything is good, well done! 🎉',
    ...
    next: 'Next',
    no_picture_found: '#852 Your device does not have any available raw photos for calibration. Please perform the "Calibrate Camera (Advanced)".',
    ...
    put_charuco: 'Place Calibration Pattern',
    put_charuco_1: 'Print the calibration pattern (A4/Letter).',
    put_charuco_2: 'Stick it flat onto a rigid board.',
    put_charuco_3: 'Place at center and autofocus.',
    put_charuco_bm2_1: 'Print the calibration pattern file on A4 (Letter Size) paper for calibration.',
    put_charuco_bm2_2: 'Click “Next” and follow the guide to position the paper.',
    put_charuco_promark_2: "Please ensure the calibration paper is clearly visible without glare. Click 'Next' to take a photo.",
    put_charuco_promark_desc_1: 'Please use the calibration paper provided in the accessory box, or print the following calibration pattern on A4 paper for camera calibration.',
    put_charuco_promark_desc_2: 'Please place the calibration paper flat and centered on the work platform.',
    put_chessboard_promark_1: 'Adjust the focal distance to achieve the proper focus for the field lens.',
  ...
  cloud_sync: {
    import_config: 'Cloud settings found for this device. Do you want to import them?',
    import_failed: 'Failed to read cloud settings.',
    sync_config: 'Do you want to sync these settings to the cloud?',
    sync_failed: 'Failed to sync settings to the cloud.',
    sync_success: 'Settings synced to the cloud successfully.',
  },
  code_generator: {
    barcode: 'Barcode',
    content: 'Content',
  ...
  connection_issue_guide: {
    alert_link: 'Disconnecting? Try this troubleshooting way.',
    connect_computer: {
      content: 'Your computer must be on the same network as the machine.',
      macos_steps: "Click the Wi-Fi icon in the menu bar. Then select your phone's hotspot.",
      macos_title: 'macOS',
      title: 'Connect Your Computer',
      windows_steps: "Click the network icon in the taskbar. Then select your phone's hotspot.",
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: "Machine can't find my hotspot",
      dont_know_hotspot_name: "I don't know my hotspot name",
      step1: "1. On your machine's touch panel, go to: Network → Connect to Wi-Fi.",
      step2: "2. Find and select your phone's hotspot name from the Wi-Fi list.",
      step3: '3. Enter the hotspot password and connect.',
      title: 'Connect Machine to Phone Hotspot',
    },
    enter_ip: {
      check_firmware: 'Firmware version',
      check_ip_reachable: 'IP reachable',
      check_machine_responds: 'Machine responds',
      placeholder: 'IP Address',
      step1: 'Enter the IP address you found in the previous step.',
      step2: 'Click "Verify" to test the connection.',
      step3: 'Beam Studio will check:',
      title: "Enter Your Machine's IP Address",
      verify: 'Verify',
    },
    fail: {
      bullet1: '• Your machine model and serial number',
      bullet2: '• The IP address shown on the touch panel',
      bullet3: '• A description of the error you encountered',
      contact_title: 'When contacting support, it helps to have:',
      intro: "Don't worry — this doesn't necessarily mean something is wrong with your machine. There may be additional factors affecting the connection. Our support team is here to help you figure it out.",
      title: "We Couldn't Complete the Test",
    },
    hotspot: {
      android_steps: 'Settings → Connections → Mobile Hotspot and Tethering → Mobile Hotspot',
      android_title: 'Android',
      ios_steps: 'Settings → Personal Hotspot → Allow Others to Join',
      ios_title: 'iPhone (iOS)',
      tip: 'Tip: Use a simple English hotspot name and numeric password (e.g. Name: FLUX_Test   Password: 12345678)',
      warning_2_4ghz: 'Important: FLUX machines only support 2.4GHz Wi-Fi. Set your hotspot to 2.4GHz before proceeding.',
    },
    how_it_works: 'How the test works:',
    how_it_works_step1: '1. Set up your phone as a Wi-Fi hotspot.',
    how_it_works_step2: '2. Connect the machine to the hotspot.',
    how_it_works_step3: '3. Connect your computer to the same hotspot.',
    how_it_works_step4: '4. Test the connection in Beam Studio.',
    intro: "Let's run a quick test to check if your machine is working properly. We'll connect your machine and computer through your mobile phone's hotspot to determine if the issue is with your network or the machine itself.",
    ip_address: {
      step1: 'On the machine\'s touch panel, go to:\nNetwork → Look for "IP Address"',
      step2: "The IP usually looks like: 172.20.10.x or 192.168.x.x\n(This depends on your phone's hotspot)",
      step3: 'Write down this IP address for the next step.',
      title: "Find Your Machine's IP Address",
      warning: 'If the IP starts with 169.254, the connection failed. Go back to Step 1 and retry.',
    },
    success: {
      cause: 'The connection issue you experienced is most likely caused by your local network environment, not the machine itself.',
      intro: "You've successfully completed the Wi-Fi connection test — nice work! This confirms your FLUX machine is working perfectly.",
      recommend1: '• Contact your Internet Service Provider (ISP) or router manufacturer for help with your Wi-Fi settings',
      recommend2: "• Ask your network administrator if you're in a school, office, or shared workspace",
      recommend3: '• Check if your router supports 2.4GHz and try restarting it',
      recommend_title: 'What We Recommend:',
      title: 'Great Job! 🎉',
    },
...
Machines > ‘Promark Name’ > Promark Settings`,
      ...
      setting_completed_ask_camera_calibration: 'Promark field lens setup completed successfully! Would you like to proceed with camera calibration?',
  ...
  keychain_generator: {
    ...
    layers: {
      keychain: 'Keychain - Outline',
      keychain_deco_emboss: 'Keychain Decorations - Emboss',
      keychain_deco_emboss_guide: 'Keychain Decorations - Emboss Guide',
      keychain_deco_engraving: 'Keychain Decorations - Engraving ',
    },
    more_shapes: 'More Shapes',
  ...
  machine_linking: {
    ...
    input_birthday_to_link: 'Please enter your date of birth to complete device linking',
    input_birthday_to_link_note: '*Used to verify whether your age meets the eligibility requirements',
    link_failed: 'Link failed.',
    link_failed_already_linked: 'This device is currently linked to another FLUX ID. You can continue using it or link it to your account.',
    link_failed_cannot_set_secret: 'Unable to save link information to the device. Please check the connection between your computer and the device.',
    link_failed_under_age: 'You are currently not eligible to use this service and cannot complete the device linking.',
    link_machine: 'Link FLUX ID',
    link_machine_to_account: 'Connected to %(name)s. Would you like to link this device to your account?',
    link_success: 'Link successful.',
    link_to_my_flux_id: 'Link to my FLUX ID',
    privacy_policy: 'Privacy Policy',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Linking…',
    use_without_linking: 'Use without linking',
  },
  machine_status: {
  ...
  maintenance: {
    ...
    cadence: {
      ...
      day: 'Every day',
      days: 'Every %s days',
      each_operation: 'Each operation',
      every_1_2_weeks: 'Every 1–2 weeks',
      month: 'Every month',
      months: 'Every %s months',
      upon_unboxing: 'Upon first unboxing',
      week: 'Every week',
      weeks: 'Every %s weeks',
    },
    celebration: {
      subtitle: 'Your %s is in top shape — keep it up.',
      title: 'All essential maintenance done!',
    },
    columns: {
      cadence: 'Cadence',
      status: 'Status',
    ...
    empty_no_machine: 'Connect or select a machine to see its maintenance schedule.',
    empty_no_schedule: 'No maintenance checklist is available for this model yet.',
    essential: 'Essential',
    ...
    feedback: {
      ...
      fail_warning: '%s: marked for tube replacement. Open the guide for the steps.',
      passed: '%s passed — the tube is healthy!',
    },
    footer_tip: 'Tip: engrave a sample file monthly to keep the machine healthy.',
    history_hint: 'Only the %s most recent entries are kept for each task.',
    intro: 'Track each maintenance task for this machine and mark it done in one click.',
    legend: {
      due_soon: 'Due soon',
      overdue: 'Overdue',
    ...
    status: {
      ...
      overdue: 'Overdue',
      replace_tube: 'Replace tube',
    },
    tasks: {
      align: {
        keyPoints: 'Adjust when the optical path is misaligned.',
        name: 'Optical Path Alignment',
      },
      chassis: {
        keyPoints: 'Remove residue and tar oil from the chassis and bottom cover.',
        name: 'Chassis Cleaning',
      },
      door: {
        keyPoints: 'Remove grease from the door cover.',
        name: 'Door Cover Cleaning',
      },
      exhaust: {
        keyPoints: 'Clean the dust off the fan blades.',
        name: 'Exhaust Fan Cleaning',
      },
      fan: {
        keyPoints: 'Remove dust from the ventilation fan blades.',
        name: 'Ventilation Fan Cleaning',
      },
      fieldlens: {
        keyPoints: 'Clean the field lens, wiping from the center outward in a clockwise direction.',
        name: 'Field Lens Cleaning',
      },
      honeycomb_plate: {
        keyPoints: 'Remove residue and tar from the honeycomb plate grids.',
        name: 'Honeycomb Plate Cleaning',
      },
      honeycomb_table: {
        keyPoints: 'Remove residue and tar oil from the honeycomb mesh.',
      ...
      maintain_test: {
        keyPoints: 'Check the status display and switches.',
        name: 'MAINTAIN Page',
      },
      mirrors_combiner: {
        keyPoints: 'Remove dirt from lenses/mirrors; check for oxidation. No alcohol or water marks left.',
        name: 'Mirrors, Focus Lens & Beam Combiner',
      },
      mirrors_lens: {
        keyPoints: 'Clean the 4 mirrors and the lens; ensure no oxidation or watermarks.',
        name: 'Mirrors & Lens Cleaning',
      },
      mod_diode: {
        keyPoints: 'Clean the fan, focus lens and POGO pin.',
        name: 'Diode Laser Module',
      },
      mod_ir: {
        keyPoints: 'Clean the focus lens.',
        name: 'Infrared Laser Module',
      },
      optical_inspection: {
        keyPoints: 'Inspect the optical path; also at unboxing and after tube replacement.',
        name: 'Optical Path Inspection',
      },
      optical_unboxing: {
        keyPoints: 'Ensure the optical path is accurate. Check upon first unboxing.',
        name: 'Optical Path Inspection',
      },
      screen: {
        keyPoints: 'Clean the dust and grease on the panel.',
        name: 'Screen Cleaning',
      },
      tube: {
        keyPoints: 'If 3 mm acrylic cannot be cut at 70% power, replace the tube.',
        name: 'Laser Tube Health Check',
      },
      water: {
        keyPoints: 'Add water until over 80% full with no air bubbles.',
        name: 'Cooling Water Replacement',
      },
      worktable: {
        keyPoints: 'Spray alcohol onto a tissue, then wipe the worktable.',
        name: 'Worktable Cleaning',
      },
      zaxis: {
        keyPoints: 'Wipe the Z-axis column screw, then apply lubricant evenly with a cotton swab.',
        name: 'Z-Axis Column Lubrication',
      },
    },
  ...
  message: {
    ...
    camera: {
      ...
      fail_to_transmit_image: '#845 Something went wrong with image transmission. Please restart your machine or Beam Studio. If this error persists, please follow <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">this guide</a>.',
      switching_camera: 'Switching camera...',
      wide_angle_open_door: 'Open the Door Cover',
      wide_angle_open_door_text: 'Please open the door cover before switching to the wide-angle camera.',
    ...
    preview: {
      ...
      please_focus_before_preview: 'To get better preview quality, please perform auto-focus before previewing.',
  ...
  monitor: {
    ...
    HARDWARE_ERROR_CARTRIDGE_OVERHEAT: '#931 Ink Cartridge Temperature Alert\nThe ink cartridge temperature is above the normal range.\nFor protection, the work has been interrupted. Please reinstall the ink cartridge and restart the work.',
    HARDWARE_ERROR_CARTRIDGE_POWERON_FAILED: '#930 Reinstall the ink cartridge\nPoor ink cartridge connection detected. Please reinstall the ink cartridge and try again.',
    ...
    HARDWARE_ERROR_PUMP_ERROR: '#900 Low Coolant Flow. Please check with your water tank.',
    HARDWARE_ERROR_REMOTE_INTERLOCK_OPENED: '#927 Remote Interlock Triggered\nPlease check the remote interlock connector and make sure it’s securely connected before restarting the job.',
    ...
    USER_OPERATION_CARTRIDGE_INK_EMPTY: 'Cartridge Empty\nThe cartridge is out of ink. Please replace the cartridge to continue printing.',
    USER_OPERATION_CARTRIDGE_INK_LOW: 'Low Ink Level\nInk in the cartridge is running low. We recommend replacing the cartridge soon.',
    ...
    USER_OPERATION_USER_Z_AXIS_CHECK_REQUIRED: 'Focus Reminder\nRe-focus before starting a new job to ensure accurate results.',
  },
  my_cloud: {
    action: {
  ...
  params_label: {
    ...
    preview_hint: 'This is a preview. Text contents will be automatically updated before sending a task',
    save_as_default: 'Save as Default',
    settings: 'Params Label Settings',
    update: 'Update',
    updated: 'Params label updated',
    use_default: 'Use Saved Default',
  ...
  print_and_cut: {
    align_progress: {
      ...
      completing: 'Completing soon',
      detecting: 'Detecting alignment marks',
      locating: 'Locating alignment marks',
      preparing: 'Preparing the camera',
      refining: 'Refining mark position',
    },
    alignment: {
      detect_failed: 'Not enough alignment marks were detected. Please retake the camera preview and try again.',
      fit_error: 'Fit Error (X / Y)',
      no_preview: 'No camera preview image found. Please run the camera preview to capture the printed material first.',
      rotation: 'Rotation',
      scale: 'Scale',
      success: 'Alignment completed!',
    },
    backend_outdated: 'The machine’s current firmware does not yet support Print and Cut.',
    calibration: {
      align_desc: '1. Place the printed calibration sheet in the work area, fix it with tape or masking tape so it cannot slip, and focus.\n2. Click "Preview and Align" to run the camera alignment.\n3. Once the marks are found, click "Scratch Scales" to draw the reference lines on the sheet at low power.',
      aligned: 'Alignment marks detected. Ready to scratch.',
      auto_read: 'Read Scales by Camera',
      auto_read_failed: 'The scales could not be read automatically. Please read them by eye and enter the values.',
      auto_read_hint: 'The camera reading may be off by up to ±2; check it against the sheet.',
      current_offset: 'Current offset: X %s mm, Y %s mm',
      export_pdf: 'Export Calibration PDF',
      power: 'Power',
      print_desc: '1. Export the calibration sheet PDF. It contains the four alignment marks and two scales.\n2. Print the sheet at 100% scale (actual size).',
      reading_desc: '1. Find the longest scratched line (the middle one) and note which side of the printed 0 line it sits on.\n2. Step through the lines toward that side until a scratched line and a printed line align exactly.\n3. Count from 0 to that printed line (numbers are printed every 5 lines; count the unnumbered ones between).',
      reading_x: 'X reading',
      reading_y: 'Y reading',
      scratch: 'Scratch Scales',
      speed: 'Speed',
      title: 'Print and Cut Calibration',
    },
    continue_to_alignment: 'Continue to Alignment',
    cutting_layer_name: 'Print & Cut - Cutting',
    design_changed: 'The design has changed since it was printed, so only the cut path is shown.\nContinue to align a previously printed material, or start over to prepare the current design.',
    export_pdf: 'Export PDF',
    finish: 'Finish',
    fit_content: 'Fit Content',
    generate_from_contour: 'Generate from Contour',
    grid_columns: 'Columns',
    grid_rows: 'Rows',
    grid_spacing: 'Spacing (mm)',
    no_content: 'There is no content in the UV Print layers. Please add your design to a UV Print layer before using Print and Cut.',
    no_layer_with_path: 'No laser layer contains a vector path. Prepare a laser layer with the cut path to use it as the contour.',
    no_uv_layer: 'No UV Print layer found. Please change the module of your design layer to "UV Print" to use Print and Cut.',
    open_preferences: 'Open Preferences',
    orientation: 'Orientation',
    orientation_landscape: 'Landscape',
    orientation_portrait: 'Portrait',
    paper_size: 'Output Size',
    paper_too_small: 'The output range is too small. The design (including alignment marks) needs at least %s mm of margin from the material edge to stay inside the printer’s printable area. Choose a larger output size, or the print will be clipped or scaled down.',
    preview_and_align: 'Preview and Align',
    resume_desc: 'This design is already prepared for Print and Cut.\nPlace the next printed material in the machine and continue to camera alignment, or start over to change the design, output size or cut path.',
    resume_title: 'Resume Print and Cut',
    select_cut_layer: 'Cut Path Layer',
    start_over: 'Start Over',
    step_align: 'Camera Alignment',
    step_align_desc: 'Place the printed material in the machine and run a camera preview.\nThe marks are detected and the cut lines aligned with the print automatically.\nClick "Finish" to add the aligned cutting layer to the canvas, the original design layers will be hidden.\nThen send the task from the editor.',
    step_export: 'Export & Print PDF',
    step_export_desc: 'Export a PDF containing your design and the alignment marks, then print it with your printer at 100% scale (actual size).\nDo not use “Scale to Fit”, or the cut path will not match the print.\nThe offset cut paths are not included, as they are only used by the laser cutter.',
    step_paper: 'Output Size',
    step_paper_desc: 'Choose the output size for the exported PDF.\nSet rows and columns to print and cut multiple copies of your design on one piece of material.\nThe preview shows the output boundary around the content.',
    step_setup: 'Cut Paths & Marks',
    ...
    uv_print_file_disabled: 'Print and Cut prints the content of UV Print layers. Please enable "Enable UV Print File" in Preferences, then add your design to a UV Print layer.',
  ...
  puzzle_generator: {
    ...
    exploded_view: 'Exploded View',
    export_as: 'Export As',
    export_engrave: 'Engraving Layer',
    export_failed: 'Failed to import puzzle to canvas. Please try again or adjust puzzle settings.',
    export_none: 'None',
    export_print: 'Printing Layer',
    file_too_large: 'The selected file exceeds the maximum allowed size.',
    guide_lines: 'Guide Lines',
    heart_sharpness: 'Point Sharpness',
    image: 'Image',
    image_load_failed: 'Failed to load the selected image. Please try a different file.',
    image_resolution_warning: 'Image resolution exceeds %(resolution)spx. This may affect export quality or performance.',
    import_to_canvas: 'Import to Canvas',
    layers: {
      board_base: 'Board Base',
      guide_lines: 'Guide Lines',
    ...
    orientation_type_1: 'Type 1',
    orientation_type_2: 'Type 2',
    orientation_type_3: 'Type 3',
    orientation_type_4: 'Type 4',
    piece_size: 'Piece Size',
    preview_placeholder: 'Puzzle Preview',
    ...
    reset_to_default: 'Reset to default',
    rows: 'Rows',
    switch_type_warning: 'Your current settings have not been imported to the canvas yet.\nSwitching the puzzle type will reset all settings to their default values.',
    tab_size: 'Tab Size',
    types: {
    ...
    upload_image: 'Click or drag to upload',
    zoom: 'Zoom',
  },
  qr_code_generator: {
  ...
  settings: {
    ...
    cancel: 'Cancel',
    caption: 'Settings',
    check_updates: 'Automatically check for updates',
    close: 'Close',
    ...
    vector_order_optimization: 'Vector Order Optimization',
  ...
  tips: {
    canvas_hold_space_to_pan: 'Hold Space and drag to pan across the canvas.',
    feature_auto_fit: 'After camera preview, use Actions → Auto Fit to automatically place objects on your material.',
    feature_box_generator: 'Use Generators → Box Generator to create custom-sized boxes in seconds.',
    feature_code_generator: 'Use Generators → Barcode Generator to create QR codes and barcodes.',
    feature_elements: 'The Elements panel now includes over one million graphics ready to use.',
    feature_layer_color_configurations: 'Map SVG layer colors to speed and power via Edit → Layer → Color Settings.',
    feature_material_test: 'Use Generators → Material Test Generator in the left toolbar to quickly find the best settings for a material.',
    layer_execution_order: 'Layer order determines job order. Jobs run from top to bottom.',
    machine_clean_mirror: 'Check the mirrors and focus lens regularly and clean them when needed to prevent smoke buildup.',
    machine_no_unattended_operation: 'Never leave the machine running unattended.',
    machine_regular_start: 'Run a laser job at least once every two weeks to help extend the laser tube’s lifespan.',
    object_edit_image_to_erase: 'Use Image → Actions → Edit Image to erase unwanted areas in an image.',
    object_polygon_sides: 'Adjust the number of sides in the polygon’s properties panel.',
    object_rounded_rectangle: 'Set the corner radius of a rounded rectangle in the rectangle’s properties panel.',
    object_sharpen_portrait: 'Enhance portrait engravings with Image → Actions → Sharpen.',
    settings_auto_save: 'Enable Auto Save in Preferences to avoid losing your work.',
    settings_default_text_font: 'You can set your default font for the Text tool in Preferences.',
    task_focus_lower_for_cutting: 'For thicker materials, focusing about 2 mm below the surface can improve cutting results.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Failed to establish connection with machine camera. Please Restart your machine or Beam Studio. If this error persists, please follow <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">this guide</a>.',
      fail_to_get_door_status: 'Please make sure the door cover is closed to enable low laser for running frame.',
      fail_to_start_preview: '#803 Fail to start preview mode. Please Restart your machine or Beam Studio. If this error persists, please follow <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">this guide</a>.',
      ...
      start_preview_timeout: '#803 Timeout has occurred when starting preview mode. Please Restart your machine or Beam Studio. If this error persists, please follow <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">this guide</a>.',
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Calibrate Print and Cut',
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Export Calibration Data',
      ...
      import_acrylic_focus_probe: 'beamo & Beambox Focus Probe - 3mm',
      ...
      import_beamo_2_printing_test: 'beamo II Printing Test',
      import_calibration_data: 'Import Calibration Data',
      import_hello_beambox: 'Example of Beambox',
      import_hello_beamo: 'Example of beamo',
      import_hexa_example: 'Example of HEXA',
      import_hexa_rf_example: 'Example of HEXA RF',
      ...
      import_promark_engraving_example_1: 'Promark Engraving Example I',
      import_promark_engraving_example_2: 'Promark Engraving Example II',
      import_promark_example: 'Promark Example',
