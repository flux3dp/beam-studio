    ...
    material_browser: {
      ...
      catalog: {
        ...
        presets: {
          ...
          engraving_quality: 'Engraving (Quality)',
      ...
      editor: {
        ...
        parent_hint: 'If set, shown as a thickness variant under its parent (not in the top grid).',
        parent_material: 'Parent Material',
        photo: 'Photo',
        tags: 'Tags',
        thickness_inch: 'Thickness (inch)',
        thickness_inch_hint: 'Fractional input allowed',
