...
Machines > ‘Promark Name’ > Promark Settings`,
  ...
  settings: {
    ...
    ai_contour_detection_tooltip: 'Use an AI model to find objects in the camera preview for Auto Fit. More accurate on textured materials, but slower on older computers; turn off to use classic detection.',
