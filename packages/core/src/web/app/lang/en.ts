...
Machines > ‘Promark Name’ > Promark Settings`,
  ...
  monitor: {
    ...
    HARDWARE_ERROR_CARTRIDGE_POWERON_FAILED: '#930 Ink Cartridge Power Error\nAn abnormal power connection was detected on the ink cartridge. Please reinstall the ink cartridge and try again.',
