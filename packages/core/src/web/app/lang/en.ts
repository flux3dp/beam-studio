...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'The output size (%s) exceeds the recommended maximum of %d × %d px. Processing may take several minutes and the result may slow down Beam Studio. Continue anyway?',
