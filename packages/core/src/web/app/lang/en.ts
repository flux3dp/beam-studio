...
Machines > ‘Promark Name’ > Promark Settings`,
  ...
  message: {
    ...
    camera: {
      abort_preview: 'Abort',
      calibration_data_missing: 'Unable to get camera calibration data.',
      calibration_data_missing_message: 'Unable to get camera calibration data.\nIf you exported camera calibration data, please import the data into the device.\nOtherwise, please perform Camera Calibration (Advanced) to recalibrate the camera.',
