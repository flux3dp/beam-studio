...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Position: Align with the engraved point on the top left.',
    align_4_1: 'Position: Align with the engraved point on the top right.',
    align_4_2: 'Position: Align with the engraved point on the bottom left.',
    align_4_3: 'Position: Align with the engraved point on the bottom right.',
    align_8_0: 'Position: Align with the engraved point on the outer top left.',
    align_8_1: 'Position: Align with the engraved point on the outer top right.',
    align_8_2: 'Position: Align with the engraved point on the outer bottom left.',
    align_8_3: 'Position: Align with the engraved point on the outer bottom right.',
    align_8_4: 'Position: Align with the engraved point on the inner top left.',
    align_8_5: 'Position: Align with the engraved point on the inner top right.',
    align_8_6: 'Position: Align with the engraved point on the inner bottom left.',
    align_8_7: 'Position: Align with the engraved point on the inner bottom right.',
    ...
    cancel: 'Cancel',
    charuco_auto_focus: 'Move the laser head above the pattern then press <b>AF</b> to perform auto focus.',
    charuco_capture: 'Click “Next” to capture the pattern',
    charuco_open_the_machine_lid: 'Open the machine’s lid.',
    charuco_place_charuco: 'Place the printed calibration pattern horizontally at the <b>%s</b> of working area.',
    ...
    charuco_position_top_left: 'upper-left',
    charuco_position_top_right: 'upper-right',
    check_checkpoint_data: 'Checkpoint Data',
    check_device_pictures: 'Check Device Pictures',
    check_pnp_desc: 'We\'ve re-taken the images based on the calibration results and marked the engraving reference points.\nPlease check if the red markers match the actual engraving spots.\nIf you see any obvious mismatch, just click "Recalibrate" to try again.',
    ...
    skip: 'Skip',
    solve_pnp_keep_door_closed: 'Keep the door closed during following process. If the door is opened, the system will attempt to relocate the camera.',
    ...
    solve_pnp_relocate_camera: 'Click "Relocate Camera" if the laser head is still not horizontally centered.',
...
Machines > ‘Promark Name’ > Promark Settings`,
  ...
  layer_module: {
    ...
    notification: {
      ...
      importedDocumentContainsPrinting4C: 'The document contains printing layer (4C), would you like to change workarea to beamo II?',
  ...
  settings: {
    ...
    module_offset_4c: 'Printing (4C) Offset',
    ...
    module_offset_uv_varnish: 'Varnish Offset',
    module_offset_uv_white_ink: 'White Ink Offset',
    none: 'None',
    normal: 'Normal',
  ...
  topbar: {
    ...
    menu: {
      ...
      import_beamo_2_printing_example_full: 'Example of beamo II Printing - Full Color',
