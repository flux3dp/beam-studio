...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Using too high speeds for layers containing 3D curve objects may reduce engraving precision.\nWe recommend keeping the speed below %(limit)s for optimal results with 3D curve objects.',
      too_fast_for_curve_and_constrain: 'Following layers: %(layers)s exceed the speed limit of %(limit)s.\nThe engrave speed for 3D curve objects will be constrained to %(limit)s.You can remove this limit at Preferences Settings.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'The engraving speed of 3D curve objects will be constrained to %(limit)s. You can remove this limit at Preferences Settings.',
...
Machines > ‘Promark Name’ > Promark Settings`,
  ...
  settings: {
    ...
    curve_engraving_speed_limit: '3D Curve Speed Limit',
  ...
  z_speed_limit_test: {
    alert_before: 'Before starting 3D curve engraving, the system will perform a load test to prevent step loss due to excessive weight.',
