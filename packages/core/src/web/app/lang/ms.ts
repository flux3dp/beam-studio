...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_1: 'Cetak papan catur (A4/Letter).',
    put_chessboard_2: 'Tampalkan rata pada papan yang tegar.',
    put_chessboard_3: 'Letakkan di tengah dan lakukan autofokus.',
