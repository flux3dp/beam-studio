...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_2_no_indicator: 'Sila gerakkan kertas papan dam atau kepala laser sehingga keseluruhan papan dam disahkan berada dalam tetingkap pratonton langsung.',
