...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'Saiz output (%s) melebihi maksimum yang disyorkan %d × %d px. Pemprosesan mungkin mengambil masa beberapa minit dan hasilnya boleh melambatkan Beam Studio. Teruskan juga?',
