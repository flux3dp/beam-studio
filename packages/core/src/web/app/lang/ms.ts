    ...
    material_browser: {
      ...
      catalog: {
        ...
        presets: {
          ...
          engraving_quality: 'Ukiran (Kualiti)',
      ...
      editor: {
        ...
        parent_hint: 'Jika ditetapkan, ia dipaparkan sebagai varian ketebalan di bawah bahan induknya (bukan dalam grid utama).',
        parent_material: 'Bahan Induk',
        photo: 'Foto',
        tags: 'Tag',
        thickness_inch: 'Ketebalan (inci)',
        thickness_inch_hint: 'Input pecahan dibenarkan',
        thickness_mm: 'Ketebalan (mm)',
