...
const lang: ILang = {
  ...
  beambox: {
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Lampirkan pada bahan',
        bucket_hint: 'Disimpan ke koleksi “Bahan Saya” anda (Lain-lain). Anda boleh memindahkannya ke bahan lain kemudian.',
        create_new: 'Cipta bahan baharu…',
        new_material_name: 'Nama bahan baharu',
        preset_name: 'Nama praset',
        settings_from_layer: 'Tetapan disalin daripada lapisan semasa',
        title: 'Simpan tetapan lapisan semasa sebagai praset',
      },
      add_material: 'Tambah Bahan',
      ...
      catalog: {
        ...
        presets: {
          cutting: 'Pemotongan',
          engraving: 'Ukiran',
          engraving_diode: 'Ukiran (Diod)',
          engraving_fiber: 'Ukiran (Fiber)',
          engraving_spray: 'Ukiran (Semburan)',
          kiss_cut: 'Potongan Cetek (Kiss Cut)',
          marking: 'Penandaan',
          marking_dark: 'Penandaan Gelap',
          marking_light: 'Penandaan Cerah',
          printing: 'Percetakan',
          printing_fabric: 'Percetakan (Kain)',
        },
      },
      categories: {
        acrylic: 'Akrilik',
      ...
      editor: {
        ...
        appearance_hint: 'Tiada foto? Pilih warna kulit muka sebagai gantinya.',
        category: 'Kategori',
        ...
        photo: 'Foto',
        tags: 'Tag',
        title_add: 'Tambah Bahan',
        title_edit: 'Edit Bahan',
        upload_hint: 'Klik atau seret foto. Pratonton besar dipaparkan dalam galeri.',
      },
      enable: 'Dayakan',
      export: 'Eksport',
      favorites: 'Kegemaran',
      from_current_layer: 'Daripada lapisan semasa',
      import: 'Import',
      machine: 'Mesin',
      manual: 'Manual',
      manual_settings: 'Tetapan manual',
      modified: 'Parameter telah diedit sejak praset digunakan',
      move_to_material: 'Pindah ke bahan…',
      new_preset_manual: 'Praset baharu…',
      no_materials_in_category: 'Tiada bahan di sini untuk %s lagi.',
      no_presets_for_machine: 'Tiada tetapan untuk %s lagi.',
      no_search_match: 'Tiada bahan sepadan dengan “%s”.',
      preset_editor: {
        name: 'Nama praset',
        name_required: 'Nama diperlukan',
        title_edit: 'Edit praset',
        title_new: 'Praset baharu',
      },
      presets: 'Praset',
      recents: 'Terkini',
      recents_empty: 'Bahan yang baharu digunakan akan dipaparkan di sini.',
      regions: {
        auto: 'Auto',
        eu: 'Eropah',
        global: 'Global',
      ...
      restore_default: 'Pulihkan lalai FLUX',
      result: 'Hasil',
      search_placeholder: 'Cari bahan, tag, kategori…',
      settings_region: 'Wilayah Katalog Bahan',
      settings_use: 'Guna Pelayar Bahan',
      showing_bundled: 'Memaparkan katalog terbina dalam',
      state_customized: 'Disesuaikan',
      state_default: 'Lalai',
      state_disabled: 'Dilumpuhkan',
      state_user: 'Ditakrifkan Pengguna',
      storage_full: 'Storan penuh, pustaka bahan tidak dapat disimpan. Gunakan kulit warna dan bukan foto.',
      sure_to_delete_material: 'Padam bahan ini dan semua prasetnya?',
      sure_to_delete_preset: 'Padam praset ini?',
      sure_to_delete_variant: 'Padam ketebalan ini dan pratetapnya?',
      sure_to_import: 'Mengimport akan menggabungkan fail ini ke dalam pustaka bahan anda. Teruskan?',
      thickness: 'Ketebalan',
      title: 'Pelayar Bahan',
      variant_exists: 'Varian dengan ketebalan ini sudah wujud.',
      variants: '%d varian',
    },
  ...
  print_and_cut: {
    ...
    calibration: {
      align_desc: '1. Letakkan helaian kalibrasi yang dicetak dalam kawasan kerja, lekatkan dengan pita atau pita pelekat penutup supaya tidak bergerak, kemudian fokuskan.\n2. Klik “Pratonton dan jajarkan” untuk menjalankan penjajaran kamera.\n3. Setelah tanda dikesan, klik “Gores Skala” untuk melukis garisan rujukan pada helaian dengan kuasa rendah.',
      aligned: 'Tanda penjajaran dikesan. Sedia untuk menggores.',
      auto_read: 'Baca Skala dengan Kamera',
      auto_read_failed: 'Skala tidak dapat dibaca secara automatik. Baca dengan mata dan masukkan nilainya.',
      auto_read_hint: 'Bacaan kamera mungkin tersasar sehingga ±2; semak dengan helaian penentukuran.',
      current_offset: 'Ofset semasa: X %s mm, Y %s mm',
      export_pdf: 'Eksport PDF Kalibrasi',
      power: 'Kuasa',
      print_desc: '1. Eksport PDF helaian kalibrasi. Helaian ini mengandungi empat tanda penjajaran dan dua skala.\n2. Cetak helaian pada skala 100% (saiz sebenar).',
      reading_desc: '1. Cari garisan goresan yang paling panjang (garisan tengah) dan perhatikan di sebelah mana ia berada berbanding garisan 0 yang dicetak.\n2. Susuri garisan demi garisan ke arah sebelah itu sehingga satu garisan goresan sejajar tepat dengan garisan cetak.\n3. Kira dari 0 hingga garisan cetak itu (nombor dicetak setiap 5 garisan; kira juga garisan tanpa nombor di antaranya).',
      reading_x: 'Bacaan X',
      reading_y: 'Bacaan Y',
      scratch: 'Gores Skala',
      speed: 'Kelajuan',
      title: 'Kalibrasi Cetak dan Potong',
    },
  ...
  topbar: {
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Kalibrasi Cetak dan Potong',
