...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Kedudukan: Jajarkan dengan titik ukiran di kiri atas.',
    align_4_1: 'Kedudukan: Jajarkan dengan titik ukiran di kanan atas.',
    align_4_2: 'Kedudukan: Jajarkan dengan titik ukiran di kiri bawah.',
    align_4_3: 'Kedudukan: Jajarkan dengan titik ukiran di kanan bawah.',
    align_8_0: 'Kedudukan: Selaraskan dengan titik terukir di bahagian atas kiri luar.',
    align_8_1: 'Kedudukan: Selaraskan dengan titik terukir di bahagian atas kanan luar.',
    align_8_2: 'Kedudukan: Selaraskan dengan titik terukir di bahagian bawah kiri luar.',
    align_8_3: 'Kedudukan: Selaraskan dengan titik terukir di bahagian bawah kanan luar.',
    align_8_4: 'Kedudukan: Selaraskan dengan titik terukir di bahagian atas kiri dalam.',
    align_8_5: 'Kedudukan: Selaraskan dengan titik terukir di bahagian atas kanan dalam.',
    align_8_6: 'Kedudukan: Selaraskan dengan titik terukir di bahagian bawah kiri dalam.',
    align_8_7: 'Kedudukan: Selaraskan dengan titik terukir di bahagian bawah kanan dalam.',
    ...
    charuco_open_the_machine_lid: 'Buka penutup mesin.',
    charuco_place_charuco: 'Letakkan corak penentukuran yang dicetak secara mendatar di <b>%s</b> kawasan kerja.',
    ...
    check_pnp_desc: 'Kami telah mengambil semula imej berdasarkan hasil penentukuran dan menandakan titik rujukan ukiran.\nSila semak sama ada penanda merah sepadan dengan tempat sebenar ukiran.\nJika terdapat ketidaksepadanan yang ketara, klik "Kalibrasi Semula" untuk mencuba semula.',
    ...
    solve_pnp_keep_door_closed: 'Pastikan pintu ditutup semasa proses berikut. Jika pintu dibuka, sistem akan cuba meletakkan semula kamera.',
    ...
    solve_pnp_relocate_camera: 'Klik "Alihkan Kamera" jika kepala laser masih belum sejajar secara mendatar.',
  ...
  settings: {
    ...
    module_offset_4c: 'Ofset Cetakan (4C)',
    ...
    module_offset_uv_varnish: 'Ofset Varnish',
    module_offset_uv_white_ink: 'Ofset Dakwat Putih',
    none: 'Tiada',
    normal: 'Tinggi',
  ...
  topbar: {
    ...
    menu: {
      ...
      import_beamo_2_printing_example_full: 'Contoh Cetakan beamo II - Warna Penuh',
