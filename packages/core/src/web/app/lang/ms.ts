...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    hole_offset: 'Ofset',
    hole_position: 'Kedudukan',
    hole_thickness: 'Ketebalan',
    hole_type: 'Jenis',
    hole_type_punch: 'Tebuk',
    ...
    position_ref: 'Kedudukan',
    position_ref_bottom_center: 'Bawah',
    position_ref_left_center: 'Kiri',
    position_ref_right_center: 'Kanan',
    position_ref_top_center: 'Atas',
    ...
    types: {
      hotel_key_chain: 'Rantai Kunci Hotel',
