...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Bagaimana untuk meningkatkan ketepatan pengesanan?',
    ...
    retake: 'Ambil Semula Foto',
    retake_tooltip: 'Ambil semula foto kamera di posisi setiap objek untuk pengesanan yang lebih baik',
    retry_with_remove_bg: 'Alih Keluar Latar Belakang',
    retry_with_remove_bg_tooltip: 'Alih keluar latar belakang daripada imej pratonton untuk meningkatkan pengesanan kontur',
    rotation: 'Putar',
    ...
    use_original_image_tooltip: 'Pulihkan imej pratonton asal tanpa pengalihan keluar latar belakang',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      credit_amount: '%s Kredit AI',
      credit_balance: 'Baki Kredit AI',
      credit_cost: 'Kredit AI Digunakan',
      description: 'Tingkatkan resolusi dan perincian imej dengan AI. Imej yang di-upscale akan menggantikan imej asal pada kanvas.',
      done: 'Upscale generatif selesai',
      dpi_recommended: 'Disyorkan untuk DPI lapisan semasa: %dx.',
      dpi_recommended_capped: 'Disyorkan untuk DPI lapisan semasa: %dx, tetapi %dx ialah yang terbesar dalam saiz output yang disyorkan.',
      failed: 'Upscale generatif tidak dapat diselesaikan. Semak sambungan rangkaian anda dan cuba lagi.',
      insufficient_credit: 'Kredit AI tidak mencukupi untuk menjalankan upscale generatif.',
      layer_dpi: 'DPI Lapisan',
      original_size: 'Saiz Asal',
      output_size: 'Saiz Output',
      oversize_warning: 'Saiz output (%s) melebihi maksimum yang disyorkan %dpx x %dpx. Pemprosesan mungkin mengambil masa beberapa minit dan hasilnya boleh melambatkan Beam Studio. Teruskan juga?',
      processing: 'Sedang upscale…',
      processing_hint: 'Masa pemprosesan bergantung pada saiz imej dan keadaan rangkaian.',
    ...
    document_panel: {
      ...
      auto_shrink_tooltip: 'Hanya terpakai untuk lapisan dengan resolusi lebih besar atau sama dengan 250 DPI.',
      ...
      prespray_times: 'Bilangan pembersihan',
      rotary_mode: 'Rotari',
      scale: 'Skala',
    ...
    popup: {
      ...
      path_engine_upgrade: {
        caption: 'Penjanaan Kerja Lebih Pantas Tersedia',
        keep_current: 'Kekal Semasa',
        message: 'Kami telah menaik taraf enjin pengiraan kerja untuk meningkatkan prestasi dan mempercepatkan penjanaan kerja.\nAdakah anda ingin bertukar kepada enjin dipercepatkan baharu?\nAnda boleh mematikannya pada bila-bila masa di %(preferences)s > %(editor)s > %(path_acceleration)s.',
      },
      pdf2svg: {
      ...
      too_fast_for_curve: 'Dalam mod ukiran lengkung, kelajuan semasa mungkin terlalu tinggi dan boleh menjejaskan butiran ukiran untuk lapisan: %(layers)s.\nPertimbangkan untuk mengurangkan kelajuan untuk kualiti yang lebih baik.',
    ...
    right_panel: {
      laser_panel: {
        ...
        dropdown: {
          inches: {
            ...
            mdf_7mm_cutting: 'MDF New Zealand - 1/4″ Potong',
          ...
          mm: {
            ...
            mdf_7mm_cutting: 'MDF New Zealand - 7mm Potong',
            mdf_engraving: 'MDF New Zealand - Ukir',
            mdf_printing: 'MDF New Zealand - Cetak',
            metal_bw_engraving: 'Logam - Ukir',
            opaque_acrylic: 'Akrilik legap',
        ...
        high_quality_desc: 'Hanya terpakai untuk ukiran vektor yang diisi dan objek imej. Mengaktifkan ini akan mengurangkan pecutan ukiran untuk hasil yang lebih halus.',
        ...
        texture: 'Tekstur',
        texture_angle: 'Sudut',
        texture_intensity: 'Keamatan',
        texture_interval: 'Selang',
        texture_random: 'Rawak',
        texture_stripe: 'Jalur',
        times: 'kali',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Upscale Generatif',
          ai_upscale_short: 'Upscale',
          ai_upscale_too_large: 'Imej ini terlalu besar untuk penskalaan AI. Saiz maksimum yang disokong ialah %dpx x %dpx.',
          array: 'Susunan',
          auto_fit: 'Muat Auto',
          bevel: 'Bevel',
          brightness: 'Kecerahan',
        ...
        option_panel: {
          ...
          text_align_center: 'Tengah',
          text_align_justify: 'Imbang',
  ...
  boxgen: {
    ...
    inner: 'Dalam',
    joints: 'Sambungan',
    max_dimension_tooltip: 'Had maksimum lebar ialah %s, had maksimum tinggi/kedalaman ialah %s.',
    merge: 'Gabung',
    outer: 'Luar',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Gerakkan kepala laser untuk menjajarkan cahaya merah dengan pusat <b>titik A</b>.',
    charuco_move_to_point_b: 'Gerakkan kepala laser secara mendatar untuk menjajarkan cahaya merah dengan pusat <b>titik B</b>.',
    ...
    check_pnp_desc: 'Pastikan penanda merah sejajar dengan tempat ukiran\nJika tidak, klik "Kembali" untuk melaraskan.\nJika semuanya baik, syabas! 🎉',
    ...
    next: 'Seterusnya',
    no_picture_found: '#852 Peranti anda tidak mempunyai gambar mentah yang tersedia untuk kalibrasi. Sila lakukan "Kalibrasi Kamera (Lanjutan)".',
    ...
    put_charuco: 'Letakkan Corak Penentukuran',
    put_charuco_1: 'Cetak corak penentukuran (A4/Letter).',
    put_charuco_2: 'Tampalkan rata pada papan yang tegar.',
    put_charuco_3: 'Letakkan di tengah dan lakukan autofokus.',
    put_charuco_bm2_1: 'Cetak fail corak penentukuran pada kertas A4 (Saiz Letter) untuk penentukuran.',
    put_charuco_bm2_2: 'Klik “Seterusnya” dan ikut panduan untuk meletakkan kertas.',
    put_charuco_promark_2: "Pastikan kertas penentukuran jelas kelihatan tanpa silau. Klik 'Seterusnya' untuk mengambil gambar.",
    put_charuco_promark_desc_1: 'Gunakan kertas penentukuran yang disediakan dalam kotak aksesori atau cetak corak penentukuran berikut pada kertas A4 untuk penentukuran kamera.',
    ...
    put_paper_promark: 'Letakkan Kadbod Hitam',
    put_paper_promark_1: 'Letakkan kadbod hitam dari kotak aksesori di platform kerja.',
    put_paper_promark_2: 'Laraskan fokus dengan betul, kemudian klik "Mula Ukiran" untuk meneruskan.',
  ...
  connection_issue_guide: {
    alert_link: 'Terputus sambungan? Cuba cara penyelesaian masalah ini.',
    connect_computer: {
      content: 'Komputer anda mesti berada pada rangkaian yang sama dengan mesin.',
      macos_steps: 'Klik ikon Wi-Fi pada bar menu. Kemudian pilih hotspot telefon anda.',
      macos_title: 'macOS',
      title: 'Sambungkan Komputer Anda',
      windows_steps: 'Klik ikon rangkaian pada bar tugas. Kemudian pilih hotspot telefon anda.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Mesin tidak dapat mencari hotspot saya',
      dont_know_hotspot_name: 'Saya tidak tahu nama hotspot saya',
      step1: '1. Pada panel sentuh mesin, pergi ke: Rangkaian → Sambung ke Wi-Fi.',
      step2: '2. Cari dan pilih nama hotspot telefon anda daripada senarai Wi-Fi.',
      step3: '3. Masukkan kata laluan hotspot dan sambung.',
      title: 'Sambungkan Mesin ke Hotspot Telefon',
    },
    enter_ip: {
      check_firmware: 'Versi perisian tegar',
      check_ip_reachable: 'IP boleh dicapai',
      check_machine_responds: 'Mesin bertindak balas',
      placeholder: 'Alamat IP',
      step1: 'Masukkan alamat IP yang anda temui pada langkah sebelumnya.',
      step2: 'Klik "Sahkan" untuk menguji sambungan.',
      step3: 'Beam Studio akan memeriksa:',
      title: 'Masukkan Alamat IP Mesin Anda',
      verify: 'Sahkan',
    },
    fail: {
      bullet1: '• Model mesin dan nombor siri anda',
      bullet2: '• Alamat IP yang dipaparkan pada panel sentuh',
      bullet3: '• Penerangan ralat yang anda hadapi',
      contact_title: 'Semasa menghubungi sokongan, adalah baik untuk menyediakan:',
      intro: 'Jangan risau — ini tidak semestinya bermakna ada masalah dengan mesin anda. Mungkin terdapat faktor lain yang menjejaskan sambungan. Pasukan sokongan kami sedia membantu anda mencari puncanya.',
      title: 'Kami Tidak Dapat Melengkapkan Ujian',
    },
    hotspot: {
      android_steps: 'Tetapan → Sambungan → Hotspot Mudah Alih dan Penambatan → Hotspot Mudah Alih',
      android_title: 'Android',
      ios_steps: 'Tetapan → Hotspot Peribadi → Benarkan Orang Lain Menyertai',
      ios_title: 'iPhone (iOS)',
      tip: 'Petua: Gunakan nama hotspot bahasa Inggeris yang mudah dan kata laluan berangka (cth. Nama: FLUX_Test   Kata Laluan: 12345678)',
      warning_2_4ghz: 'Penting: Mesin FLUX hanya menyokong Wi-Fi 2.4GHz. Tetapkan hotspot anda kepada 2.4GHz sebelum meneruskan.',
    },
    how_it_works: 'Cara ujian berfungsi:',
    how_it_works_step1: '1. Sediakan telefon anda sebagai hotspot Wi-Fi.',
    how_it_works_step2: '2. Sambungkan mesin ke hotspot.',
    how_it_works_step3: '3. Sambungkan komputer anda ke hotspot yang sama.',
    how_it_works_step4: '4. Uji sambungan dalam Beam Studio.',
    intro: 'Mari jalankan ujian pantas untuk memeriksa sama ada mesin anda berfungsi dengan baik. Kami akan menyambungkan mesin dan komputer anda melalui hotspot telefon mudah alih anda untuk menentukan sama ada masalah itu berpunca daripada rangkaian anda atau mesin itu sendiri.',
    ip_address: {
      step1: 'Pada panel sentuh mesin, pergi ke:\nRangkaian → Cari "Alamat IP"',
      step2: 'IP biasanya kelihatan seperti: 172.20.10.x atau 192.168.x.x\n(Ini bergantung pada hotspot telefon anda)',
      step3: 'Catatkan alamat IP ini untuk langkah seterusnya.',
      title: 'Cari Alamat IP Mesin Anda',
      warning: 'Jika IP bermula dengan 169.254, sambungan gagal. Kembali ke Langkah 1 dan cuba lagi.',
    },
    success: {
      cause: 'Masalah sambungan yang anda alami berkemungkinan besar disebabkan oleh persekitaran rangkaian tempatan anda, bukan mesin itu sendiri.',
      intro: 'Anda telah berjaya melengkapkan ujian sambungan Wi-Fi — syabas! Ini mengesahkan mesin FLUX anda berfungsi dengan sempurna.',
      recommend1: '• Hubungi Penyedia Perkhidmatan Internet (ISP) atau pengeluar penghala anda untuk bantuan berkaitan tetapan Wi-Fi',
      recommend2: '• Tanya pentadbir rangkaian anda jika anda berada di sekolah, pejabat atau ruang kerja kongsi',
      recommend3: '• Periksa sama ada penghala anda menyokong 2.4GHz dan cuba mulakan semula',
      recommend_title: 'Apa Yang Kami Cadangkan:',
      title: 'Syabas! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'Penjana Rantai Kunci',
    material_test_generator: 'Penjana Ujian Bahan',
    puzzle_generator: 'Penjana teka-teki',
    title: 'Penjana',
  },
  generic_error: {
  ...
  initialize: {
    ...
    select_promark: 'Pilih Promark Anda',
    setting_completed: {
      back: 'Kembali',
  ...
  keychain_generator: {
    ...
    layers: {
      ...
      keychain_deco_emboss: 'Hiasan Rantai Kunci - Pemotongan',
      keychain_deco_emboss_guide: 'Hiasan Rantai Kunci - Panduan Pemotongan',
    ...
    text: 'Teks',
    text_options: {
      font_family: 'Keluarga fon',
      font_settings: 'Tetapan fon',
      font_size: 'Saiz fon',
      font_style: 'Gaya fon',
      letter_spacing: 'Jarak huruf',
      line_spacing: 'Jarak baris',
  ...
  machine_linking: {
    ...
    input_birthday_to_link: 'Sila masukkan tarikh lahir anda untuk melengkapkan pautan peranti',
    input_birthday_to_link_note: '*Digunakan untuk mengesahkan sama ada umur anda memenuhi syarat kelayakan',
    link_failed: 'Pautan gagal.',
    link_failed_already_linked: 'Peranti ini sedang dipautkan kepada FLUX ID lain. Anda boleh terus menggunakannya atau memautkannya kepada akaun anda.',
    link_failed_cannot_set_secret: 'Tidak dapat menyimpan maklumat pautan ke peranti. Sila semak sambungan antara komputer dan peranti.',
    link_failed_under_age: 'Anda pada masa ini tidak layak untuk menggunakan perkhidmatan ini dan tidak dapat melengkapkan pautan peranti.',
    link_machine: 'Pautkan FLUX ID',
    link_machine_to_account: 'Disambungkan ke %(name)s. Adakah anda ingin memautkan peranti ini ke akaun anda?',
    link_success: 'Pautan berjaya.',
    link_to_my_flux_id: 'Pautkan ke FLUX ID saya',
    privacy_policy: 'Dasar Privasi',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Memaut…',
    use_without_linking: 'Guna tanpa memaut',
  },
  machine_status: {
    '-17': 'Mod IO Kartrij',
  ...
  maintenance: {
    ...
    areas: {
      back_cover: 'Penutup belakang',
      modules: 'Modul',
      optics: 'Optik',
      panel: 'Panel',
      working_area: 'Kawasan kerja',
    },
    cadence: {
      by_material: 'Mengikut bahan',
      condition: 'Keadaan',
      day: 'Setiap hari',
      days: 'Setiap %s hari',
      each_operation: 'Setiap operasi',
      every_1_2_weeks: 'Setiap 1–2 minggu',
      month: 'Setiap bulan',
      months: 'Setiap %s bulan',
      upon_unboxing: 'Semasa buka kotak pertama kali',
      week: 'Setiap minggu',
      weeks: 'Setiap %s minggu',
    },
    celebration: {
    ...
    feedback: {
      ...
      fail_warning: '%s: ditanda untuk penggantian tiub. Buka panduan untuk langkahnya.',
      passed: '%s lulus — tiub dalam keadaan sihat!',
    },
    footer_tip: 'Petua: ukir fail sampel setiap bulan untuk mengekalkan kesihatan mesin.',
    history_hint: 'Hanya %s entri terkini disimpan untuk setiap tugas.',
    intro: 'Jejak setiap tugas penyelenggaraan untuk mesin ini dan tandakan selesai dengan satu klik.',
    legend: {
      due_soon: 'Hampir tempoh',
      overdue: 'Tertunggak',
      up_to_date: 'Terkini',
    },
    machine_groups: {
    ...
    status: {
      ...
      healthy: 'Sihat',
      last: 'Terakhir',
      never_done: 'Tidak pernah dilakukan',
      next: 'Seterusnya',
      not_checked: 'Belum diperiksa',
      not_logged: 'Tiada rekod',
      overdue: 'Tertunggak',
      replace_tube: 'Ganti tiub',
    },
    tasks: {
      align: {
        keyPoints: 'Laraskan apabila laluan optik tidak sejajar.',
        name: 'Penjajaran Laluan Optik',
      },
      chassis: {
        keyPoints: 'Buang residu dan minyak tar dari casis dan penutup bawah.',
        name: 'Pembersihan Casis',
      },
      door: {
        keyPoints: 'Buang gris dari penutup pintu.',
        name: 'Pembersihan Penutup Pintu',
      },
      exhaust: {
        keyPoints: 'Bersihkan habuk pada bilah kipas.',
        name: 'Pembersihan Kipas Ekzos',
      },
      fan: {
        keyPoints: 'Buang habuk dari bilah kipas pengudaraan.',
        name: 'Pembersihan Kipas Pengudaraan',
      },
      fieldlens: {
        keyPoints: 'Bersihkan kanta medan, lap dari tengah ke luar mengikut arah jam.',
        name: 'Pembersihan Kanta Medan',
      },
      honeycomb_plate: {
        keyPoints: 'Buang residu dan tar dari grid plat sarang lebah.',
        name: 'Pembersihan Plat Sarang Lebah',
      },
      honeycomb_table: {
        keyPoints: 'Buang residu dan minyak tar dari jaring sarang lebah.',
        name: 'Pembersihan Meja Sarang Lebah',
      },
      lube: {
        keyPoints: 'Bersihkan rod pemandu, rel linear dan mekanisme fokus, kemudian lincirkan semula. Kekerapan berbeza mengikut bahan yang anda potong.',
        name: 'Pelinciran',
      },
      maintain_test: {
        keyPoints: 'Periksa paparan status dan suis.',
        name: 'Halaman MAINTAIN',
      },
      mirrors_combiner: {
        keyPoints: 'Buang kotoran dari kanta/cermin; periksa pengoksidaan. Tiada kesan alkohol atau air tertinggal.',
        name: 'Cermin, Kanta Fokus & Penggabung Alur',
      },
      mirrors_lens: {
        keyPoints: 'Bersihkan 4 cermin dan kanta; pastikan tiada pengoksidaan atau kesan air.',
        name: 'Pembersihan Cermin & Kanta',
      },
      mod_diode: {
        keyPoints: 'Bersihkan kipas, kanta fokus dan POGO pin.',
        name: 'Modul Laser Diod',
      },
      mod_ir: {
        keyPoints: 'Bersihkan kanta fokus.',
        name: 'Modul Laser Inframerah',
      },
      optical_inspection: {
        keyPoints: 'Periksa laluan optik; juga semasa buka kotak dan selepas penggantian tiub.',
        name: 'Pemeriksaan Laluan Optik',
      },
      optical_unboxing: {
        keyPoints: 'Pastikan laluan optik tepat. Periksa semasa buka kotak pertama kali.',
        name: 'Pemeriksaan Laluan Optik',
      },
      screen: {
        keyPoints: 'Bersihkan habuk dan gris pada panel.',
        name: 'Pembersihan Skrin',
      },
      tube: {
        keyPoints: 'Jika akrilik 3 mm tidak dapat dipotong pada kuasa 70%, ganti tiub.',
        name: 'Pemeriksaan Kesihatan Tiub Laser',
      },
      water: {
        keyPoints: 'Tambah air sehingga lebih 80% penuh tanpa gelembung udara.',
        name: 'Penggantian Air Penyejuk',
      },
      worktable: {
        keyPoints: 'Semburkan alkohol pada tisu, kemudian lap meja kerja.',
        name: 'Pembersihan Meja Kerja',
      },
      zaxis: {
        keyPoints: 'Lap skru tiang paksi Z, kemudian sapu pelincir sekata dengan putik kapas.',
        name: 'Pelinciran Tiang Paksi Z',
      },
    },
    title: 'Senarai Semak Penyelenggaraan',
  },
  ...
  monitor: {
    ...
    HARDWARE_ERROR_KEY_OFF: '#929 Kunci Keselamatan Tidak Dikesan\nKunci keselamatan tidak dikesan atau telah dinyahaktifkan. Untuk keselamatan anda, mesin tidak boleh beroperasi sehingga kunci dihidupkan dengan betul.\nSila masukkan kunci keselamatan dan hidupkan sebelum memulakan semula kerja.',
    HARDWARE_ERROR_LASER_TEMPERATURE_ABNORMAL: '#933 Suhu Laser Tidak Normal\nSuhu laser terlalu tinggi. Sila hentikan operasi dan biarkan laser sejuk sebelum memulakan semula.',
    ...
    HARDWARE_ERROR_LIMIT_SWITCH_TRIGGERED: '#934 Mesin berhenti — kepala laser mencapai had kawasan kerja.',
  ...
  params_label: {
    ...
    preview_hint: 'Ini ialah pratonton. Kandungan teks akan dikemas kini secara automatik sebelum menghantar tugasan',
    save_as_default: 'Simpan sebagai lalai',
    settings: 'Tetapan Label Parameter',
    update: 'Kemas kini',
    updated: 'Label parameter dikemas kini',
    use_default: 'Guna lalai yang disimpan',
    use_recommended: 'Guna disyorkan',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      calculating: 'Mengira…',
      capturing: 'Menangkap imej',
      completing: 'Akan siap sebentar lagi',
      detecting: 'Mengesan tanda penjajaran',
      locating: 'Mencari tanda penjajaran',
      preparing: 'Menyediakan kamera',
      refining: 'Memperhalus kedudukan tanda',
    },
    alignment: {
    ...
    finish: 'Selesai',
    fit_content: 'Muatkan kandungan',
    generate_from_contour: 'Jana daripada kontur',
    grid_columns: 'Lajur',
    grid_rows: 'Baris',
    grid_spacing: 'Jarak (mm)',
    no_content: 'Tiada kandungan pada lapisan Cetakan UV. Sila tambah reka bentuk anda ke lapisan Cetakan UV sebelum menggunakan Cetak dan Potong.',
    no_layer_with_path: 'Tiada lapisan laser yang mengandungi laluan vektor. Sediakan lapisan laser dengan laluan potong untuk menggunakannya sebagai kontur.',
    no_uv_layer: 'Tiada lapisan Cetakan UV dijumpai. Sila tukar modul lapisan reka bentuk anda kepada "Cetakan UV" untuk menggunakan Cetak dan Potong.',
    open_preferences: 'Buka Keutamaan',
    orientation: 'Orientasi',
    orientation_landscape: 'Landskap',
    orientation_portrait: 'Potret',
    paper_size: 'Saiz output',
    paper_too_small: 'Kawasan output terlalu kecil. Reka bentuk (termasuk tanda penjajaran) memerlukan sekurang-kurangnya %s mm margin dari tepi bahan supaya kekal dalam kawasan boleh cetak pencetak. Pilih saiz output yang lebih besar, jika tidak cetakan akan dipotong atau dikecilkan.',
    preview_and_align: 'Pratonton dan jajarkan',
    resume_desc: 'Reka bentuk ini telah disediakan untuk Cetak dan Potong.\nLetakkan bahan bercetak seterusnya di dalam mesin dan teruskan ke penjajaran kamera, atau mula semula untuk menukar reka bentuk, saiz output atau laluan potong.',
    resume_title: 'Sambung semula Cetak dan Potong',
    select_cut_layer: 'Lapisan laluan potong',
    ...
    step_setup: 'Laluan potong dan tanda',
    ...
    uv_print_file_disabled: 'Cetak dan Potong mencetak kandungan lapisan Cetakan UV. Sila aktifkan "Benarkan Fail Cetakan UV" dalam Keutamaan, kemudian tambah reka bentuk anda ke lapisan Cetakan UV.',
  ...
  puzzle_generator: {
    ...
    columns: 'Lajur',
    design_preview: 'Pratonton reka bentuk',
    exploded_view: 'Pandangan letupan',
    export_as: 'Eksport sebagai',
    export_engrave: 'Lapisan ukiran',
    export_failed: 'Gagal mengimport teka-teki ke kanvas. Sila cuba lagi atau laraskan tetapan teka-teki.',
    export_none: 'Tiada',
    export_print: 'Lapisan cetak',
    file_too_large: 'Fail yang dipilih melebihi saiz maksimum yang dibenarkan.',
    ...
    orientation_type_1: 'Jenis 1',
    orientation_type_2: 'Jenis 2',
    orientation_type_3: 'Jenis 3',
    orientation_type_4: 'Jenis 4',
    piece_size: 'Saiz kepingan',
    preview_placeholder: 'Pratonton teka-teki',
    puzzle_board: 'Papan teka-teki',
    puzzle_pieces: 'Kepingan teka-teki',
    radius: 'Jejari',
    ...
    types: {
      ...
      heart_jigsaw: 'Teka-teki berbentuk hati',
      hex_jigsaw: 'Teka-teki heksagon',
      rectangle_jigsaw: 'Teka-teki segi empat tepat',
    },
    unsupported_file_type: 'Jenis fail tidak disokong. Sila gunakan JPG, PNG atau WebP.',
    upload_hint: 'JPG, PNG, WebP (maks 10MB)',
    upload_image: 'Klik atau seret untuk muat naik',
    zoom: 'Zum',
  },
  qr_code_generator: {
  ...
  settings: {
    ...
    show_banners: 'Paparkan banner laman utama',
  ...
  tips: {
    canvas_hold_space_to_pan: 'Tahan kekunci Spasi dan seret untuk menggerakkan kanvas.',
    feature_auto_fit: 'Selepas pratonton kamera, gunakan Tindakan → Muat Automatik untuk meletakkan objek secara automatik pada bahan anda.',
    feature_box_generator: 'Gunakan Penjana → Penjana Kotak untuk membuat kotak bersaiz tersuai dalam beberapa saat.',
    feature_code_generator: 'Gunakan Penjana → Penjana Kod Bar untuk membuat kod QR dan kod bar.',
    feature_elements: 'Panel Elemen kini merangkumi lebih satu juta grafik yang sedia untuk digunakan.',
    feature_layer_color_configurations: 'Petakan warna lapisan SVG kepada kelajuan dan kuasa melalui Edit → Lapisan → Tetapan Warna.',
    feature_material_test: 'Gunakan Penjana → Penjana Ujian Bahan di bar alat kiri untuk mencari tetapan terbaik untuk bahan dengan cepat.',
    layer_execution_order: 'Susunan lapisan menentukan susunan kerja. Kerja berjalan dari atas ke bawah.',
    machine_clean_mirror: 'Periksa cermin dan kanta fokus secara berkala dan bersihkannya apabila diperlukan untuk mencegah pengumpulan asap.',
    machine_no_unattended_operation: 'Jangan sekali-kali meninggalkan mesin berjalan tanpa pengawasan.',
    machine_regular_start: 'Jalankan kerja laser sekurang-kurangnya sekali setiap dua minggu untuk membantu memanjangkan jangka hayat tiub laser.',
    object_edit_image_to_erase: 'Gunakan Imej → Tindakan → Edit Imej untuk memadamkan kawasan yang tidak diingini dalam imej.',
    object_polygon_sides: 'Laraskan bilangan sisi dalam panel sifat poligon.',
    object_rounded_rectangle: 'Tetapkan jejari sudut segi empat tepat bulat dalam panel sifat segi empat tepat.',
    object_sharpen_portrait: 'Tingkatkan ukiran potret dengan Imej → Tindakan → Tajamkan.',
    settings_auto_save: 'Dayakan Simpan Auto dalam Keutamaan untuk mengelakkan kehilangan kerja anda.',
    settings_default_text_font: 'Anda boleh menetapkan fon lalai anda untuk alat Teks dalam Keutamaan.',
    task_focus_lower_for_cutting: 'Untuk bahan yang lebih tebal, memfokuskan kira-kira 2 mm di bawah permukaan boleh meningkatkan hasil pemotongan.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Gagal menghubungi kamera mesin. Sila mulakan semula mesin atau Beam Studio anda. Jika ralat ini berterusan, sila ikuti <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">panduan ini</a>.',
      fail_to_get_door_status: 'Sila pastikan pintu ditutup untuk membolehkan laser beroperasi.',
      fail_to_start_preview: '#803 Gagal memulakan mod pratonton. Sila mulakan semula mesin atau Beam Studio anda. Jika ralat ini berterusan, sila ikuti <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">panduan ini</a>.',
      ...
      start_preview_timeout: '#803 Timeout telah berlaku ketika memulakan mod pratonton. Sila mulakan semula mesin atau Beam Studio anda. Jika ralat ini berterusan, sila ikuti <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">panduan ini</a>.',
    ...
    menu: {
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Eksport Data Penentukuran',
      ...
      machines: 'Mesin',
      maintenance_checklist: 'Senarai Semak Penyelenggaraan',
