...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Posição: Alinhar com o ponto gravado no canto superior esquerdo.',
    align_4_1: 'Posição: Alinhar com o ponto gravado no canto superior direito.',
    align_4_2: 'Posição: Alinhar com o ponto gravado no canto inferior esquerdo.',
    align_4_3: 'Posição: Alinhar com o ponto gravado no canto inferior direito.',
    align_8_0: 'Posição: Alinhe com o ponto gravado na parte superior esquerda externa.',
    align_8_1: 'Posição: Alinhe com o ponto gravado na parte superior direita externa.',
    align_8_2: 'Posição: Alinhe com o ponto gravado na parte inferior esquerda externa.',
    align_8_3: 'Posição: Alinhe com o ponto gravado na parte inferior direita externa.',
    align_8_4: 'Posição: Alinhe com o ponto gravado na parte superior esquerda interna.',
    align_8_5: 'Posição: Alinhe com o ponto gravado na parte superior direita interna.',
    align_8_6: 'Posição: Alinhe com o ponto gravado na parte inferior esquerda interna.',
    align_8_7: 'Posição: Alinhe com o ponto gravado na parte inferior direita interna.',
    ...
    charuco_open_the_machine_lid: 'Abra a tampa da máquina.',
    charuco_place_charuco: 'Coloque o padrão de calibração impresso horizontalmente na <b>%s</b> da área de trabalho.',
    charuco_position_bottom_left: 'inferior esquerdo',
    charuco_position_bottom_right: 'inferior direito',
    charuco_position_center: 'centro',
    charuco_position_left: 'esquerda',
    charuco_position_right: 'direita',
    charuco_position_top_left: 'superior esquerdo',
    charuco_position_top_right: 'superior direito',
    check_checkpoint_data: 'Dados do ponto de verificação',
    check_device_pictures: 'Verificar imagens do dispositivo',
    check_pnp_desc: 'Repetimos as imagens com base nos resultados da calibração e marcamos os pontos de referência de gravação.\nVerifique se os marcadores vermelhos correspondem aos locais reais de gravação.\nSe notar alguma discrepância evidente, clique em "Recalibrar" para tentar novamente.',
    ...
    solve_pnp_keep_door_closed: 'Mantenha a porta fechada durante o processo seguinte. Se a porta for aberta, o sistema tentará realocar a câmera.',
    ...
    solve_pnp_relocate_camera: 'Clique em "Realocar Câmera" se a cabeça do laser ainda não estiver centralizada horizontalmente.',
