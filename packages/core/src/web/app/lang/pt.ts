...
const lang: ILang = {
  ...
  beambox: {
    ...
    popup: {
      ...
      too_fast_for_curve: 'Usar velocidades muito altas para camadas contendo objetos de curva 3D pode reduzir a precisão da gravação.\nRecomendamos manter a velocidade abaixo de %(limit)s para obter resultados ideais com objetos de curva 3D.',
      too_fast_for_curve_and_constrain: 'As seguintes camadas: %(layers)s excedem o limite de velocidade de %(limit)s.\nA velocidade de gravação para objetos de curva 3D será limitada a %(limit)s. Você pode remover este limite nas Configurações de Preferências.',
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'A velocidade de gravação de objetos de curva 3D será limitada a %(limit)s. Você pode remover esse limite nas Configurações de Preferências.',
