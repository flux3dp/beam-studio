...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_1: 'Imprima o tabuleiro de xadrez (A4/Letter).',
    put_chessboard_2: 'Cole-o plano sobre uma placa rígida.',
    put_chessboard_3: 'Coloque no centro e faça o foco automático.',
