...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'O tamanho de saída (%s) excede o máximo recomendado de %d × %d px. O processamento pode demorar vários minutos e o resultado pode tornar o Beam Studio mais lento. Continuar mesmo assim?',
