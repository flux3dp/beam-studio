    ...
    material_browser: {
      ...
      catalog: {
        ...
        presets: {
          ...
          engraving_quality: 'Gravação (qualidade)',
      ...
      editor: {
        ...
        parent_hint: 'Se definido, é apresentado como variante de espessura sob o material principal (não na grelha principal).',
        parent_material: 'Material principal',
        photo: 'Foto',
        tags: 'Etiquetas',
        thickness_inch: 'Espessura (polegadas)',
        thickness_inch_hint: 'É permitida a introdução de frações',
