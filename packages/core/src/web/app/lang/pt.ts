...
const lang: ILang = {
  ...
  keychain_generator: {
    ...
    font_size: 'Tamanho da fonte',
    hole: 'Furo',
    hole_diameter: 'Diâmetro',
    hole_offset: 'Deslocamento',
    hole_position: 'Posição',
    hole_thickness: 'Espessura',
    hole_type: 'Tipo',
    hole_type_punch: 'Perfuração',
    hole_type_ring: 'Anel',
    ...
    position_ref: 'Posição',
    position_ref_bottom_center: 'Inferior',
    position_ref_left_center: 'Esquerda',
    position_ref_right_center: 'Direita',
