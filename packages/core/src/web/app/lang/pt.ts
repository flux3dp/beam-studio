...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Como melhorar a precisão da detecção?',
    ...
    retake_tooltip: 'Tirar foto novamente na posição de cada objeto para melhor detecção',
    retry_with_remove_bg: 'Remover fundo',
    retry_with_remove_bg_tooltip: 'Remover o fundo da imagem de pré-visualização para melhorar a detecção de contornos',
    rotation: 'Girar',
    ...
    use_original_image_tooltip: 'Restaurar a imagem de pré-visualização original sem remoção de fundo',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      credit_cost: 'Créditos de IA utilizados',
      description: 'Aumente a resolução e os detalhes da imagem com IA. A imagem ampliada substituirá a original na tela.',
      done: 'Ampliação generativa concluída',
      dpi_recommended: 'Recomendado para o DPI da camada atual: %dx.',
      dpi_recommended_capped: 'Recomendado para o DPI da camada atual: %dx, mas %dx é o máximo dentro do tamanho de saída recomendado.',
      failed: 'Não foi possível concluir a ampliação generativa. Verifique a sua ligação de rede e tente novamente.',
      insufficient_credit: 'Créditos de IA insuficientes para executar a ampliação generativa.',
      layer_dpi: 'DPI da camada',
      original_size: 'Tamanho original',
      output_size: 'Tamanho de saída',
      oversize_warning: 'O tamanho de saída (%s) excede o máximo recomendado de %dpx x %dpx. O processamento pode demorar vários minutos e o resultado pode tornar o Beam Studio mais lento. Continuar mesmo assim?',
      processing: 'A ampliar…',
      processing_hint: 'O tempo de processamento depende do tamanho da imagem e da rede.',
      recommended: 'Recomendado',
      retry: 'Tentar novamente',
      start: 'Iniciar ampliação',
    },
    announcement_panel: {
      title: 'Anúncio',
    },
    ...
    left_panel: {
      ...
      label: {
        ...
        preview_precise: 'Pré-visualização precisa da câmera',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Associar a um material',
        bucket_hint: 'Guardado na sua coleção “Os meus materiais” (Outros). Pode movê-lo para um material mais tarde.',
        create_new: 'Criar novo material…',
        new_material_name: 'Nome do novo material',
        preset_name: 'Nome da predefinição',
        settings_from_layer: 'Definições copiadas da camada atual',
        title: 'Guardar as definições da camada atual como predefinição',
      },
      add_material: 'Adicionar material',
      add_preset: 'Adicionar predefinição',
      apply: 'Aplicar',
      back_to_catalog: 'Voltar ao catálogo',
      buy_on_shop: 'Comprar na loja',
      catalog: {
        materials: {
        ...
        presets: {
          cutting: 'Corte',
          engraving: 'Gravação',
          engraving_diode: 'Gravação (díodo)',
          engraving_fiber: 'Gravação (fibra)',
          engraving_spray: 'Gravação (spray)',
          kiss_cut: 'Corte superficial',
          marking: 'Marcação',
          marking_dark: 'Marcação escura',
          marking_light: 'Marcação clara',
          printing: 'Impressão',
          printing_fabric: 'Impressão (tecido)',
        },
      },
      categories: {
        acrylic: 'Acrílicos',
      ...
      editor: {
        appearance: 'Aspeto',
        appearance_hint: 'Não tem uma foto? Escolha antes uma cor de capa.',
        category: 'Categoria',
        ...
        photo: 'Foto',
        tags: 'Etiquetas',
        title_add: 'Adicionar material',
        title_edit: 'Editar material',
        upload_hint: 'Clique ou arraste uma foto. É apresentada uma pré-visualização grande na galeria.',
      },
      enable: 'Ativar',
      export: 'Exportar',
      favorites: 'Favoritos',
      from_current_layer: 'Da camada atual',
      import: 'Importar',
      machine: 'Máquina',
      manual: 'Manual',
      manual_settings: 'Definições manuais',
      modified: 'Parâmetros editados desde que a predefinição foi aplicada',
      move_to_material: 'Mover para um material…',
      new_preset_manual: 'Nova predefinição…',
      no_materials_in_category: 'Ainda não existem materiais aqui para %s.',
      no_presets_for_machine: 'Ainda não existem definições para %s.',
      no_search_match: 'Nenhum material corresponde a “%s”.',
      preset_editor: {
        name: 'Nome da predefinição',
        name_required: 'O nome é obrigatório',
        title_edit: 'Editar predefinição',
        title_new: 'Nova predefinição',
      },
      presets: 'Predefinições',
      recents: 'Recentes',
      recents_empty: 'Os materiais aplicados recentemente aparecerão aqui.',
      regions: {
        auto: 'Automático',
        eu: 'Europa',
        global: 'Global',
      ...
      restore_default: 'Restaurar a predefinição da FLUX',
      result: 'Resultado',
      search_placeholder: 'Pesquisar materiais, etiquetas, categorias…',
      settings_region: 'Região do catálogo de materiais',
      settings_use: 'Utilizar o explorador de materiais',
      showing_bundled: 'A mostrar o catálogo integrado',
      state_customized: 'Personalizado',
      state_default: 'Predefinido',
      state_disabled: 'Desativado',
      state_user: 'Definido pelo utilizador',
      storage_full: 'O armazenamento está cheio, não foi possível guardar a biblioteca de materiais. Utilize capas de cor em vez de fotografias.',
      sure_to_delete_material: 'Eliminar este material e todas as suas predefinições?',
      sure_to_delete_preset: 'Eliminar esta predefinição?',
      sure_to_delete_variant: 'Excluir esta espessura e suas predefinições?',
      sure_to_import: 'A importação irá fundir o ficheiro na sua biblioteca de materiais. Continuar?',
      thickness: 'Espessura',
      title: 'Explorador de materiais',
      variant_exists: 'Já existe uma variante com esta espessura.',
    ...
    popup: {
      ...
      disassemble_use: {
        ...
        variable_text_warning: 'Os objetos de texto variável foram ignorados. Desative o texto variável antes de desmontá-los.',
      },
      ...
      dxf_paste_failed: 'Falha ao colar o DXF da área de transferência. Certifique-se de que o conteúdo copiado é um DXF válido.',
    ...
    right_panel: {
      laser_panel: {
        ...
        high_quality_desc: 'Aplica-se apenas a gravações vetoriais preenchidas e objetos de imagem. Ativar isso reduzirá a aceleração da gravação para resultados mais finos.',
        ...
        strength: 'Potência',
        texture: 'Textura',
        texture_angle: 'Ângulo',
        texture_intensity: 'Intensidade',
        texture_interval: 'Intervalo',
        texture_random: 'Aleatório',
        texture_stripe: 'Listras',
        times: 'vezes',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale: 'Ampliação generativa',
          ai_upscale_short: 'Ampliação',
          ai_upscale_too_large: 'Esta imagem é muito grande para a ampliação com IA. O tamanho máximo suportado é %dpx x %dpx.',
          array: 'Matriz',
          ...
          disabled_by_noun_project: 'Esta forma é protegida pela lei de propriedade intelectual, portanto o seu traçado não pode ser editado.',
          ...
          to_image: 'Para Imagem',
          to_path: 'Para Caminho',
          trace: 'Traçar',
        ...
        option_panel: {
          ...
          text_align_left: 'Esquerda',
          text_align_right: 'Direita',
          text_content_placeholder: 'Inserir texto',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Mova a cabeça do laser para alinhar a luz vermelha com o centro do <b>ponto A</b>.',
    charuco_move_to_point_b: 'Mova a cabeça do laser horizontalmente para alinhar a luz vermelha com o centro do <b>ponto B</b>.',
    ...
    check_pnp_desc: 'Certifique-se de que os marcadores vermelhos estão alinhados com os pontos de gravação\nCaso contrário, clique em "Voltar" para ajustar.\nSe estiver tudo certo, muito bem! 🎉',
    ...
    put_charuco: 'Colocar Padrão de Calibração',
    put_charuco_1: 'Imprima o padrão de calibração (A4/Letter).',
    put_charuco_2: 'Cole-o plano sobre uma placa rígida.',
    put_charuco_3: 'Coloque no centro e faça o foco automático.',
    put_charuco_bm2_1: 'Imprima o arquivo do padrão de calibração em papel A4 (tamanho Carta) para calibração.',
    put_charuco_bm2_2: 'Clique em “Próximo” e siga o guia para posicionar o papel.',
    put_charuco_promark_2: "Por favor, certifique-se de que o papel de calibração esteja claramente visível sem reflexos. Clique em 'Avançar' para tirar uma foto.",
    put_charuco_promark_desc_1: 'Use o papel de calibração fornecido na caixa de acessórios ou imprima o padrão de calibração a seguir em papel A4 para calibração da câmera.',
    ...
    put_paper_promark: 'Coloque a cartolina preta',
    put_paper_promark_1: 'Coloque a cartolina preta da caixa de acessórios na plataforma de trabalho.',
    put_paper_promark_2: 'Ajuste o foco corretamente e clique em "Iniciar Gravação" para continuar.',
  ...
  cloud_sync: {
    import_config: 'Configurações na nuvem encontradas para este dispositivo. Deseja importá-las?',
    import_failed: 'Falha ao ler as configurações na nuvem.',
    sync_config: 'Deseja sincronizar estas configurações com a nuvem?',
    sync_failed: 'Falha ao sincronizar as configurações com a nuvem.',
    sync_success: 'Configurações sincronizadas com a nuvem com sucesso.',
  },
  code_generator: {
  ...
  connection_issue_guide: {
    alert_link: 'Desconectando? Experimente este método de solução de problemas.',
    connect_computer: {
      content: 'O seu computador deve estar na mesma rede que a máquina.',
      macos_steps: 'Clique no ícone Wi-Fi na barra de menus. Depois selecione o ponto de acesso do seu telefone.',
      macos_title: 'macOS',
      title: 'Conecte o seu computador',
      windows_steps: 'Clique no ícone de rede na barra de tarefas. Depois selecione o ponto de acesso do seu telefone.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'A máquina não encontra o meu ponto de acesso',
      dont_know_hotspot_name: 'Não sei o nome do meu ponto de acesso',
      step1: '1. No painel tátil da sua máquina, vá a: Rede → Conectar ao Wi-Fi.',
      step2: '2. Encontre e selecione o nome do ponto de acesso do seu telefone na lista de Wi-Fi.',
      step3: '3. Introduza a palavra-passe do ponto de acesso e conecte.',
      title: 'Conecte a máquina ao ponto de acesso do telefone',
    },
    enter_ip: {
      check_firmware: 'Versão do firmware',
      check_ip_reachable: 'IP acessível',
      check_machine_responds: 'A máquina responde',
      placeholder: 'Endereço IP',
      step1: 'Introduza o endereço IP que encontrou no passo anterior.',
      step2: 'Clique em "Verificar" para testar a conexão.',
      step3: 'O Beam Studio irá verificar:',
      title: 'Introduza o endereço IP da sua máquina',
      verify: 'Verificar',
    },
    fail: {
      bullet1: '• O modelo e o número de série da sua máquina',
      bullet2: '• O endereço IP mostrado no painel tátil',
      bullet3: '• Uma descrição do erro que encontrou',
      contact_title: 'Ao contactar o suporte, é útil ter:',
      intro: 'Não se preocupe: isto não significa necessariamente que algo esteja errado com a sua máquina. Podem existir fatores adicionais que afetam a conexão. A nossa equipa de suporte está aqui para o ajudar a resolver.',
      title: 'Não conseguimos concluir o teste',
    },
    hotspot: {
      android_steps: 'Definições → Ligações → Ponto de acesso móvel e ligação → Ponto de acesso móvel',
      android_title: 'Android',
      ios_steps: 'Definições → Ponto de acesso pessoal → Permitir a outros',
      ios_title: 'iPhone (iOS)',
      tip: 'Dica: Use um nome de ponto de acesso simples em inglês e uma palavra-passe numérica (por ex. Nome: FLUX_Test   Palavra-passe: 12345678)',
      warning_2_4ghz: 'Importante: As máquinas FLUX só suportam Wi-Fi de 2.4GHz. Configure o seu ponto de acesso para 2.4GHz antes de continuar.',
    },
    how_it_works: 'Como funciona o teste:',
    how_it_works_step1: '1. Configure o seu telefone como ponto de acesso Wi-Fi.',
    how_it_works_step2: '2. Conecte a máquina ao ponto de acesso.',
    how_it_works_step3: '3. Conecte o seu computador ao mesmo ponto de acesso.',
    how_it_works_step4: '4. Teste a conexão no Beam Studio.',
    intro: 'Vamos fazer um teste rápido para verificar se a sua máquina está a funcionar corretamente. Vamos conectar a sua máquina e o seu computador através do ponto de acesso do seu telemóvel para determinar se o problema é da sua rede ou da própria máquina.',
    ip_address: {
      step1: 'No painel tátil da máquina, vá a:\nRede → Procure "IP Address"',
      step2: 'O IP normalmente tem este aspeto: 172.20.10.x ou 192.168.x.x\n(Isto depende do ponto de acesso do seu telefone)',
      step3: 'Anote este endereço IP para o passo seguinte.',
      title: 'Encontre o endereço IP da sua máquina',
      warning: 'Se o IP começar por 169.254, a conexão falhou. Volte ao Passo 1 e tente novamente.',
    },
    success: {
      cause: 'O problema de conexão que teve é muito provavelmente causado pelo ambiente da sua rede local, e não pela própria máquina.',
      intro: 'Concluiu com sucesso o teste de conexão Wi-Fi, bom trabalho! Isto confirma que a sua máquina FLUX está a funcionar perfeitamente.',
      recommend1: '• Contacte o seu fornecedor de serviços de Internet (ISP) ou o fabricante do router para obter ajuda com as definições de Wi-Fi',
      recommend2: '• Pergunte ao seu administrador de rede se está numa escola, escritório ou espaço de trabalho partilhado',
      recommend3: '• Verifique se o seu router suporta 2.4GHz e tente reiniciá-lo',
      recommend_title: 'O que recomendamos:',
      title: 'Bom trabalho! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'Gerador de chaveiros',
    material_test_generator: 'Gerador de Teste de Material',
    puzzle_generator: 'Gerador de quebra-cabeças',
    title: 'Geradores',
  },
  generic_error: {
  ...
  initialize: {
    ...
    Máquinas > "Nome do Promark" > Configurações do Promark`,
      ...
      setting_completed_ask_camera_calibration: 'A configuração da lente de campo do Promark foi concluída com sucesso! Deseja prosseguir com a calibração da câmera?',
    ...
    select_promark: 'Selecione o seu Promark',
    setting_completed: {
      back: 'Voltar',
  ...
  keychain_generator: {
    ...
    hole_options: {
      ...
      position: 'Posição',
      thickness: 'Espessura',
      type_punch: 'Perfuração',
      type_ring: 'Anel',
    },
    import_to_canvas: 'Importar para o canvas',
    layers: {
      keychain: 'Chaveiro - Contorno',
      keychain_deco_emboss: 'Decorações do chaveiro - Corte',
      keychain_deco_emboss_guide: 'Decorações do chaveiro - Guia de corte',
    ...
    text_options: {
      ...
      font_settings: 'Configurações de fonte',
      font_size: 'Tamanho da fonte',
  ...
  machine_linking: {
    continue: 'Continuar',
    i_have_read: 'Eu li',
    input_birthday_to_link: 'Insira sua data de nascimento para concluir a vinculação do dispositivo',
    input_birthday_to_link_note: '*Usado para verificar se sua idade atende aos requisitos de elegibilidade',
    link_failed: 'Falha na vinculação.',
    link_failed_already_linked: 'Este dispositivo está atualmente vinculado a outro FLUX ID. Pode continuar a usá-lo ou vinculá-lo à sua conta.',
    link_failed_cannot_set_secret: 'Não é possível guardar as informações de vinculação no dispositivo. Por favor, verifique a ligação entre o computador e o dispositivo.',
    link_failed_under_age: 'Você atualmente não é elegível para usar este serviço e não pode concluir a vinculação do dispositivo.',
    link_machine: 'Vincular FLUX ID',
    link_machine_to_account: 'Conectado a %(name)s. Deseja vincular este dispositivo à sua conta?',
    link_success: 'Vinculação bem-sucedida.',
    link_to_my_flux_id: 'Vincular ao meu FLUX ID',
    privacy_policy: 'Política de Privacidade',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'A vincular…',
    use_without_linking: 'Usar sem vincular',
  },
  machine_status: {
  ...
  maintenance: {
    ...
    cadence: {
      ...
      day: 'A cada dia',
      days: 'A cada %s dias',
      each_operation: 'Cada operação',
      every_1_2_weeks: 'A cada 1–2 semanas',
      month: 'A cada mês',
      months: 'A cada %s meses',
      upon_unboxing: 'Ao desembalar pela primeira vez',
      week: 'A cada semana',
      weeks: 'A cada %s semanas',
    },
    celebration: {
      subtitle: 'Seu %s está em ótima forma — continue assim.',
      title: 'Toda a manutenção essencial concluída!',
    },
    columns: {
      cadence: 'Frequência',
      status: 'Estado',
    ...
    empty_no_machine: 'Conecte ou selecione uma máquina para ver seu cronograma de manutenção.',
    empty_no_schedule: 'Ainda não há lista de manutenção disponível para este modelo.',
    essential: 'Essencial',
    essential_health: 'Saúde essencial',
    essential_hint: 'conta para a saúde',
    feedback: {
      checked: '%s verificado.',
      done: '%s está em dia. Próxima vez em %s.',
      done_no_date: '%s concluído.',
      fail_warning: '%s: marcado para substituição do tubo. Abra o guia para ver os passos.',
      passed: '%s aprovado — o tubo está saudável!',
    },
    footer_tip: 'Dica: grave um arquivo de amostra mensalmente para manter a máquina saudável.',
    history_hint: 'Apenas as %s entradas mais recentes são mantidas para cada tarefa.',
    intro: 'Acompanhe cada tarefa de manutenção desta máquina e marque como concluída em um clique.',
    legend: {
    ...
    machine_groups: {
      my_machines: 'As minhas máquinas',
      other_models: 'Outros modelos',
    },
    ...
    status: {
      ...
      overdue: 'Atrasado',
      replace_tube: 'Substituir tubo',
    },
    tasks: {
      align: {
        keyPoints: 'Ajuste quando o caminho óptico estiver desalinhado.',
        name: 'Alinhamento do Caminho Óptico',
      },
      chassis: {
        keyPoints: 'Remova resíduos e óleo de alcatrão do chassi e da tampa inferior.',
        name: 'Limpeza do Chassi',
      },
      door: {
        keyPoints: 'Remova a gordura da tampa da porta.',
        name: 'Limpeza da Tampa da Porta',
      },
      exhaust: {
        keyPoints: 'Limpe a poeira das pás do ventilador.',
        name: 'Limpeza do Ventilador de Exaustão',
      },
      fan: {
        keyPoints: 'Remova a poeira das pás do ventilador de ventilação.',
        name: 'Limpeza do Ventilador de Ventilação',
      },
      fieldlens: {
        keyPoints: 'Limpe a lente de campo, do centro para fora, no sentido horário.',
        name: 'Limpeza da Lente de Campo',
      },
      honeycomb_plate: {
        keyPoints: 'Remova resíduos e alcatrão das grades da placa de favo de mel.',
        name: 'Limpeza da Placa de Favo de Mel',
      },
      honeycomb_table: {
        keyPoints: 'Remova resíduos e óleo de alcatrão da malha de favo de mel.',
      ...
      maintain_test: {
        keyPoints: 'Verifique o display de status e os interruptores.',
        name: 'Página MAINTAIN',
      },
      mirrors_combiner: {
        keyPoints: 'Remova a sujeira das lentes/espelhos; verifique se há oxidação. Não deixe marcas de álcool ou água.',
        name: 'Espelhos, Lente de Foco e Combinador de Feixe',
      },
      mirrors_lens: {
        keyPoints: 'Limpe os 4 espelhos e a lente; certifique-se de que não há oxidação nem marcas de água.',
        name: 'Limpeza dos Espelhos e da Lente',
      },
      mod_diode: {
        keyPoints: 'Limpe o ventilador, a lente de foco e o POGO pin.',
        name: 'Módulo de Laser de Diodo',
      },
      mod_ir: {
        keyPoints: 'Limpe a lente de foco.',
        name: 'Módulo de Laser Infravermelho',
      },
      optical_inspection: {
        keyPoints: 'Inspecione o caminho óptico; também ao desembalar e após a substituição do tubo.',
        name: 'Inspeção do Caminho Óptico',
      },
      optical_unboxing: {
        keyPoints: 'Certifique-se de que o caminho óptico está correto. Verifique ao desembalar pela primeira vez.',
        name: 'Inspeção do Caminho Óptico',
      },
      screen: {
        keyPoints: 'Limpe a poeira e a gordura do painel.',
        name: 'Limpeza da Tela',
      },
      tube: {
        keyPoints: 'Se não for possível cortar acrílico de 3 mm com 70% de potência, substitua o tubo.',
        name: 'Verificação da Saúde do Tubo de Laser',
      },
      water: {
        keyPoints: 'Adicione água até passar de 80% da capacidade, sem bolhas de ar.',
        name: 'Troca da Água de Refrigeração',
      },
      worktable: {
        keyPoints: 'Borrife álcool em um lenço de papel e limpe a mesa de trabalho.',
        name: 'Limpeza da Mesa de Trabalho',
      },
      zaxis: {
        keyPoints: 'Limpe o parafuso da coluna do eixo Z e aplique lubrificante uniformemente com um cotonete.',
        name: 'Lubrificação da Coluna do Eixo Z',
      },
    },
  ...
  message: {
    ...
    camera: {
      ...
      calibration_data_missing: 'Configurar a calibração da câmera',
      calibration_data_missing_message: 'Os dados de calibração da câmera estão ausentes.\nImporte os seus dados de calibração salvos ou execute a calibração da câmera.',
      ...
      fail_to_transmit_image: '#845 Ocorreu um erro na transmissão da imagem. Por favor, reinicie sua máquina ou o Beam Studio. Se este erro persistir, siga <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">este guia</a>.',
      switching_camera: 'Trocando câmera...',
      wide_angle_open_door: 'Abra a tampa da porta',
      wide_angle_open_door_text: 'Abra a tampa da porta antes de mudar para a câmera grande angular.',
  ...
  params_label: {
    ...
    placeholder: 'Rótulo de parâmetros',
    preview_hint: 'Esta é uma pré-visualização. O conteúdo do texto será atualizado automaticamente antes de enviar uma tarefa',
    save_as_default: 'Guardar como predefinição',
    settings: 'Definições do rótulo de parâmetros',
    update: 'Atualizar',
    updated: 'Rótulo de parâmetros atualizado',
    use_default: 'Usar predefinição guardada',
  ...
  print_and_cut: {
    align_progress: {
      ...
      completing: 'Concluindo',
      detecting: 'Detectando marcas de alinhamento',
      locating: 'Localizando marcas de alinhamento',
      preparing: 'Preparando a câmera',
      refining: 'Refinando a posição das marcas',
    },
    alignment: {
    ...
    calibration: {
      align_desc: '1. Coloque a folha de calibração impressa na área de trabalho, fixe-a com fita adesiva ou fita de pintor para que não deslize e faça a focagem.\n2. Clique em «Visualizar e alinhar» para executar o alinhamento por câmara.\n3. Depois de as marcas serem detetadas, clique em «Gravar escalas» para traçar as linhas de referência na folha a baixa potência.',
      aligned: 'Marcas de alinhamento detetadas. Pronto para gravar.',
      auto_read: 'Ler escalas pela câmara',
      auto_read_failed: 'Não foi possível ler as escalas automaticamente. Leia-as a olho e introduza os valores.',
      auto_read_hint: 'A leitura da câmara pode ter um desvio de até ±2; confirme-a na folha.',
      current_offset: 'Desvio atual: X %s mm, Y %s mm',
      export_pdf: 'Exportar PDF de calibração',
      power: 'Potência',
      print_desc: '1. Exporte o PDF da folha de calibração. Contém as quatro marcas de alinhamento e duas escalas.\n2. Imprima a folha a 100% (tamanho real).',
      reading_desc: '1. Encontre a linha gravada mais longa (a central) e repare de que lado da linha 0 impressa ela fica.\n2. Avance linha a linha para esse lado até uma linha gravada e uma linha impressa coincidirem exatamente.\n3. Conte de 0 até essa linha impressa (os números são impressos a cada 5 linhas; conte também as linhas sem número entre elas).',
      reading_x: 'Leitura X',
      reading_y: 'Leitura Y',
      scratch: 'Gravar escalas',
      speed: 'Velocidade',
      title: 'Calibração de Imprimir e cortar',
    },
    continue_to_alignment: 'Continuar para o alinhamento',
    cutting_layer_name: 'Imprimir e cortar - Corte',
    design_changed: 'O design foi alterado desde a impressão, por isso apenas o caminho de corte é exibido.\nContinue para alinhar um material impresso anteriormente ou recomece para preparar o design atual.',
    export_pdf: 'Exportar PDF',
    finish: 'Concluir',
    fit_content: 'Ajustar ao conteúdo',
    generate_from_contour: 'Gerar a partir do contorno',
    ...
    paper_size: 'Tamanho de saída',
    paper_too_small: 'A área de saída é muito pequena. O design (incluindo as marcas de alinhamento) precisa de pelo menos %s mm de margem em relação à borda do material para permanecer dentro da área imprimível da impressora. Escolha um tamanho de saída maior, ou a impressão será cortada ou reduzida.',
    preview_and_align: 'Visualizar e alinhar',
    resume_desc: 'Este design já está preparado para Imprimir e cortar.\nColoque o próximo material impresso na máquina e continue para o alinhamento por câmera, ou recomece para alterar o design, o tamanho de saída ou o caminho de corte.',
    resume_title: 'Retomar Imprimir e cortar',
    select_cut_layer: 'Camada do caminho de corte',
    start_over: 'Recomeçar',
    step_align: 'Alinhamento por câmera',
    step_align_desc: 'Coloque o material impresso na máquina e execute uma visualização da câmera.\nAs marcas são detectadas e as linhas de corte alinhadas automaticamente com a impressão.\nClique em «Concluir» para adicionar a camada de corte alinhada ao canvas; as camadas do design original serão ocultadas.\nEm seguida, envie a tarefa pelo editor.',
    step_export: 'Exportar e imprimir PDF',
    step_export_desc: 'Exporte um PDF com seu design e as marcas de alinhamento e imprima-o na sua impressora em escala de 100% (tamanho real).\nNão use «Ajustar à página», ou o caminho de corte não corresponderá à impressão.\nOs caminhos de corte deslocados não são incluídos, pois são usados apenas pela cortadora a laser.',
    step_paper: 'Tamanho de saída',
    step_paper_desc: 'Escolha o tamanho de saída do PDF exportado.\nDefina linhas e colunas para imprimir e cortar várias cópias do seu design em uma única peça de material.\nA visualização mostra o limite de saída ao redor do conteúdo.',
    step_setup: 'Caminhos de corte e marcas',
    ...
    uv_print_file_disabled: 'Imprimir e cortar imprime o conteúdo das camadas de impressão UV. Ative "Ativar arquivo de impressão UV" nas preferências e adicione seu design a uma camada de impressão UV.',
  ...
  puzzle_generator: {
    ...
    export_engrave: 'Camada de gravação',
    export_failed: 'Falha ao importar o quebra-cabeças para a tela. Tente novamente ou ajuste as configurações do quebra-cabeças.',
    export_none: 'Nenhum',
    export_print: 'Camada de impressão',
    file_too_large: 'O arquivo selecionado excede o tamanho máximo permitido.',
    guide_lines: 'Linhas de guia',
    heart_sharpness: 'Nitidez da ponta',
    image: 'Imagem',
    ...
    piece_size: 'Tamanho das peças',
    preview_placeholder: 'Visualização do quebra-cabeças',
    puzzle_board: 'Tabuleiro do quebra-cabeças',
    puzzle_pieces: 'Peças do quebra-cabeças',
    radius: 'Raio',
    raised_edges: 'Bordas elevadas',
    ...
    types: {
      ...
      heart_jigsaw: 'Quebra-cabeças em forma de coração',
      hex_jigsaw: 'Quebra-cabeças hexagonal',
      rectangle_jigsaw: 'Quebra-cabeças retangular',
    },
    unsupported_file_type: 'Tipo de arquivo não suportado. Use JPG, PNG ou WebP.',
    upload_hint: 'JPG, PNG, WebP (máx. 10MB)',
    upload_image: 'Clique ou arraste para carregar',
    zoom: 'Zoom',
  },
  qr_code_generator: {
  ...
  settings: {
    ...
    show_banners: 'Exibir banner da página inicial',
  ...
  tips: {
    canvas_hold_space_to_pan: 'Segure a barra de espaço e arraste para deslocar pela tela.',
    feature_auto_fit: 'Após a visualização da câmera, use Ações → Ajuste automático para posicionar automaticamente os objetos no seu material.',
    feature_box_generator: 'Use Geradores → Gerador de caixas para criar caixas de tamanho personalizado em segundos.',
    feature_code_generator: 'Use Geradores → Gerador de códigos de barras para criar códigos QR e códigos de barras.',
    feature_elements: 'O painel Elementos agora inclui mais de um milhão de gráficos prontos para usar.',
    feature_layer_color_configurations: 'Mapeie cores de camadas SVG para velocidade e potência através de Editar → Camada → Configurações de cor.',
    feature_material_test: 'Use Geradores → Gerador de teste de material na barra de ferramentas esquerda para encontrar rapidamente as melhores configurações para um material.',
    layer_execution_order: 'A ordem das camadas determina a ordem do trabalho. Os trabalhos são executados de cima para baixo.',
    machine_clean_mirror: 'Verifique os espelhos e a lente de foco regularmente e limpe-os quando necessário para evitar o acúmulo de fumaça.',
    machine_no_unattended_operation: 'Nunca deixe a máquina funcionando sem supervisão.',
    machine_regular_start: 'Execute um trabalho a laser pelo menos uma vez a cada duas semanas para ajudar a prolongar a vida útil do tubo laser.',
    object_edit_image_to_erase: 'Use Imagem → Ações → Editar imagem para apagar áreas indesejadas em uma imagem.',
    object_polygon_sides: 'Ajuste o número de lados no painel de propriedades do polígono.',
    object_rounded_rectangle: 'Defina o raio dos cantos de um retângulo arredondado no painel de propriedades do retângulo.',
    object_sharpen_portrait: 'Melhore gravuras de retratos com Imagem → Ações → Nitidez.',
    settings_auto_save: 'Ative Salvamento automático nas Preferências para evitar perder seu trabalho.',
    settings_default_text_font: 'Você pode definir sua fonte padrão para a ferramenta Texto nas Preferências.',
    task_focus_lower_for_cutting: 'Para materiais mais espessos, focar cerca de 2 mm abaixo da superfície pode melhorar os resultados de corte.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Falha ao conectar com a câmera da máquina. Reinicie seu computador ou o Beam Studio. Se este erro persistir, siga <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">este guia</a>.',
      ...
      fail_to_start_preview: '#803 Falha ao iniciar o modo de visualização. Reinicie seu computador ou o Beam Studio. Se este erro persistir, siga <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">este guia</a>.',
      ...
      start_preview_timeout: '#803 O tempo limite ocorreu ao iniciar o modo de visualização. Reinicie seu computador ou o Beam Studio. Se este erro persistir, siga <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">este guia</a>.',
    ...
    menu: {
      ...
      calibrate_print_and_cut: 'Calibrar Imprimir e cortar',
      ...
      export_calibration_data: 'Exportar dados de calibração',
      ...
      import_acrylic_focus_probe: 'Sonda de Foco beamo & Beambox - 3 mm',
      ...
      import_beamo_2_printing_test: 'Teste de impressão beamo II',
      import_calibration_data: 'Importar dados de calibração',
      ...
      import_promark_engraving_example_1: 'Exemplo de gravação de Promark I',
      import_promark_engraving_example_2: 'Exemplo de gravação de Promark II',
      ...
      machines: 'Máquinas',
      maintenance_checklist: 'Lista de Manutenção',
    ...
    tag_names: {
      ...
      params_label: 'Rótulo de parâmetros',
