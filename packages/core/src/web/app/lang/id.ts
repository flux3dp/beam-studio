...
const lang: ILang = {
  ...
  auto_fit: {
    ...
    how_to_improve_accuracy: 'Bagaimana cara meningkatkan akurasi deteksi?',
    ...
    retake_tooltip: 'Ambil ulang foto kamera di posisi setiap objek untuk deteksi yang lebih baik',
    retry_with_remove_bg: 'Hapus Latar Belakang',
    retry_with_remove_bg_tooltip: 'Hapus latar belakang dari gambar pratinjau untuk meningkatkan deteksi kontur',
    rotation: 'Putar',
    ...
    use_original_image_tooltip: 'Kembalikan gambar pratinjau asli tanpa penghapusan latar belakang',
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      credit_balance: 'Saldo Kredit AI',
      credit_cost: 'Kredit AI Digunakan',
      description: 'Tingkatkan resolusi dan detail gambar dengan AI. Gambar hasil upscale akan menggantikan gambar asli di kanvas.',
      done: 'Upscale generatif selesai',
      dpi_recommended: 'Disarankan untuk DPI layer saat ini: %dx.',
      dpi_recommended_capped: 'Disarankan untuk DPI layer saat ini: %dx, tetapi %dx adalah yang terbesar dalam ukuran output yang disarankan.',
      failed: 'Upscale generatif tidak dapat diselesaikan. Periksa koneksi jaringan Anda dan coba lagi.',
      insufficient_credit: 'Kredit AI tidak cukup untuk menjalankan upscale generatif.',
      layer_dpi: 'DPI Layer',
      original_size: 'Ukuran Asli',
      output_size: 'Ukuran Output',
      oversize_warning: 'Ukuran output (%s) melebihi maksimum yang disarankan %dpx x %dpx. Pemrosesan dapat memakan waktu beberapa menit dan hasilnya dapat memperlambat Beam Studio. Tetap lanjutkan?',
      processing: 'Sedang melakukan upscale…',
      processing_hint: 'Waktu pemrosesan bergantung pada ukuran gambar dan kondisi jaringan.',
    ...
    banner: {
      ...
      firmware_warning: {
        message: '%s Anda menjalankan firmware v%s, yang dapat memengaruhi stabilitas sistem. Sebaiknya perbarui ke versi terbaru.',
    ...
    material_browser: {
      add_from_layer: {
        attach_to: 'Lampirkan ke material',
        bucket_hint: 'Disimpan ke koleksi “Material Saya” (Lainnya). Anda dapat memindahkannya ke material lain nanti.',
        create_new: 'Buat material baru…',
        new_material_name: 'Nama material baru',
        preset_name: 'Nama preset',
        settings_from_layer: 'Pengaturan disalin dari lapisan saat ini',
        title: 'Simpan pengaturan lapisan saat ini sebagai preset',
      },
      add_material: 'Tambah Material',
      ...
      catalog: {
        materials: {
          ...
          acrylic_with_film: 'Akrilik (dengan lapisan pelindung)',
          aluminum: 'Aluminium',
          bamboo: 'Bambu',
          basswood_sheet: 'Lembaran kayu basswood',
          black_abs: 'ABS Hitam',
          black_acrylic: 'Akrilik Hitam',
          brass: 'Kuningan',
          canvas: 'Kanvas',
          cardboard: 'Kardus',
          cardstock: 'Kertas Karton',
          ceramic_tile: 'Ubin keramik',
          copper: 'Tembaga',
          cork: 'Gabus',
          denim: 'Denim',
          eva_foam: 'Busa EVA',
          fabric: 'Kain',
          faux_leather: 'Kulit sintetis',
          felt: 'Kain felt',
          fluorescent_acrylic: 'Akrilik fluoresen',
          glass: 'Kaca',
          glitter_acrylic: 'Akrilik glitter',
          gloss_leather: 'Kulit Mengkilap',
          gold: 'Emas',
          iron: 'Besi',
      ...
      editor: {
        appearance: 'Tampilan',
        appearance_hint: 'Tidak ada foto? Pilih warna sampul sebagai gantinya.',
        category: 'Kategori',
        category_required: 'Pilih sebuah kategori',
        color: 'Warna',
        name: 'Nama Material',
        name_required: 'Nama wajib diisi',
        photo: 'Foto',
        tags: 'Tag',
        title_add: 'Tambah Material',
        title_edit: 'Edit Material',
        upload_hint: 'Klik atau seret foto. Pratinjau besar ditampilkan di galeri.',
      },
      enable: 'Aktifkan',
      export: 'Ekspor',
      favorites: 'Favorit',
      from_current_layer: 'Dari lapisan saat ini',
      import: 'Impor',
      machine: 'Mesin',
      manual: 'Manual',
      manual_settings: 'Pengaturan manual',
      modified: 'Parameter telah diubah sejak preset diterapkan',
      move_to_material: 'Pindahkan ke material…',
      new_preset_manual: 'Preset baru…',
      no_materials_in_category: 'Belum ada material untuk %s di sini.',
      no_presets_for_machine: 'Belum ada pengaturan untuk %s.',
      no_search_match: 'Tidak ada material yang cocok dengan “%s”.',
      preset_editor: {
        name: 'Nama preset',
        name_required: 'Nama wajib diisi',
        title_edit: 'Edit preset',
        title_new: 'Preset baru',
      },
      presets: 'Preset',
      recents: 'Terbaru',
      recents_empty: 'Material yang baru diterapkan akan muncul di sini.',
      regions: {
        auto: 'Otomatis',
        eu: 'Eropa',
        global: 'Global',
      ...
      restore_default: 'Pulihkan default FLUX',
      result: 'Hasil',
      search_placeholder: 'Cari material, tag, kategori…',
      settings_region: 'Wilayah Katalog Material',
      settings_use: 'Gunakan Penjelajah Material',
      showing_bundled: 'Menampilkan katalog bawaan',
      state_customized: 'Dikustomisasi',
      state_default: 'Default',
      state_disabled: 'Dinonaktifkan',
      state_user: 'Ditentukan Pengguna',
      storage_full: 'Penyimpanan penuh, pustaka material tidak dapat disimpan. Gunakan sampul warna alih-alih foto.',
      sure_to_delete_material: 'Hapus material ini beserta semua presetnya?',
      sure_to_delete_preset: 'Hapus preset ini?',
      sure_to_delete_variant: 'Hapus ketebalan ini beserta presetnya?',
      sure_to_import: 'Mengimpor akan menggabungkan berkas ke dalam pustaka material Anda. Lanjutkan?',
      thickness: 'Ketebalan',
      title: 'Penjelajah Material',
      variant_exists: 'Varian dengan ketebalan ini sudah ada.',
      variants: '%d varian',
    },
    ...
    right_panel: {
      laser_panel: {
        ...
        texture: 'Tekstur',
        texture_angle: 'Sudut',
        texture_intensity: 'Intensitas',
        texture_interval: 'Interval',
        texture_random: 'Acak',
        texture_stripe: 'Garis',
        times: 'kali',
      ...
      object_panel: {
        actions_panel: {
          ...
          ai_upscale_too_large: 'Gambar ini terlalu besar untuk AI upscale. Ukuran maksimum yang didukung adalah %dpx x %dpx.',
          array: 'Array',
          ...
          disabled_by_noun_project: 'Bentuk ini dilindungi oleh hukum kekayaan intelektual, sehingga jalurnya tidak dapat diedit.',
  ...
  calibration: {
    ...
    charuco_move_to_point_a: 'Gerakkan kepala laser untuk menyelaraskan cahaya merah dengan pusat <b>titik A</b>.',
    charuco_move_to_point_b: 'Gerakkan kepala laser secara horizontal untuk menyelaraskan cahaya merah dengan pusat <b>titik B</b>.',
    ...
    check_pnp_desc: 'Pastikan penanda merah sejajar dengan titik pengukiran\nJika tidak, klik "Kembali" untuk menyesuaikan.\nJika semuanya sudah baik, kerja bagus! 🎉',
    ...
    put_charuco: 'Tempatkan Pola Kalibrasi',
    put_charuco_1: 'Cetak pola kalibrasi (A4/Letter).',
    put_charuco_2: 'Tempelkan rata pada papan yang kaku.',
    put_charuco_3: 'Letakkan di tengah dan lakukan fokus otomatis.',
    put_charuco_bm2_1: 'Cetak file pola kalibrasi pada kertas A4 (ukuran Letter) untuk kalibrasi.',
    put_charuco_bm2_2: 'Klik “Berikutnya” dan ikuti panduan untuk menempatkan kertas.',
    put_charuco_promark_2: "Pastikan kertas kalibrasi terlihat jelas tanpa silau. Klik 'Berikutnya' untuk mengambil foto.",
    put_charuco_promark_desc_1: 'Gunakan kertas kalibrasi yang disediakan dalam kotak aksesori, atau cetak pola kalibrasi berikut di kertas A4 untuk kalibrasi kamera.',
    ...
    put_paper_promark: 'Letakkan Karton Hitam',
    put_paper_promark_1: 'Letakkan karton hitam dari kotak aksesori di platform kerja.',
    put_paper_promark_2: 'Sesuaikan fokus dengan benar, lalu klik "Mulai Ukir" untuk melanjutkan.',
  ...
  connection_issue_guide: {
    alert_link: 'Terputus? Coba cara pemecahan masalah ini.',
    connect_computer: {
      content: 'Komputer Anda harus berada di jaringan yang sama dengan mesin.',
      macos_steps: 'Klik ikon Wi-Fi di bilah menu. Lalu pilih hotspot ponsel Anda.',
      macos_title: 'macOS',
      title: 'Hubungkan Komputer Anda',
      windows_steps: 'Klik ikon jaringan di bilah tugas. Lalu pilih hotspot ponsel Anda.',
      windows_title: 'Windows',
    },
    connect_wifi: {
      cant_find_hotspot: 'Mesin tidak dapat menemukan hotspot saya',
      dont_know_hotspot_name: 'Saya tidak tahu nama hotspot saya',
      step1: '1. Pada panel sentuh mesin, buka: Jaringan → Hubungkan ke Wi-Fi.',
      step2: '2. Temukan dan pilih nama hotspot ponsel Anda dari daftar Wi-Fi.',
      step3: '3. Masukkan kata sandi hotspot dan hubungkan.',
    ...
    enter_ip: {
      ...
      step1: 'Masukkan alamat IP yang Anda temukan pada langkah sebelumnya.',
      step2: 'Klik "Verifikasi" untuk menguji koneksi.',
      step3: 'Beam Studio akan memeriksa:',
      title: 'Masukkan Alamat IP Mesin Anda',
      verify: 'Verifikasi',
    },
    fail: {
      bullet1: '• Model mesin dan nomor seri Anda',
      bullet2: '• Alamat IP yang ditampilkan pada panel sentuh',
      bullet3: '• Deskripsi kesalahan yang Anda alami',
      contact_title: 'Saat menghubungi dukungan, ada baiknya menyiapkan:',
      intro: 'Jangan khawatir — ini tidak selalu berarti ada masalah dengan mesin Anda. Mungkin ada faktor lain yang memengaruhi koneksi. Tim dukungan kami siap membantu Anda menemukan penyebabnya.',
      title: 'Kami Tidak Dapat Menyelesaikan Pengujian',
    },
    hotspot: {
      android_steps: 'Pengaturan → Koneksi → Hotspot Seluler dan Penambatan → Hotspot Seluler',
      android_title: 'Android',
      ios_steps: 'Pengaturan → Hotspot Pribadi → Izinkan Orang Lain Bergabung',
      ios_title: 'iPhone (iOS)',
      tip: 'Tips: Gunakan nama hotspot bahasa Inggris yang sederhana dan kata sandi berupa angka (mis. Nama: FLUX_Test   Kata Sandi: 12345678)',
      warning_2_4ghz: 'Penting: Mesin FLUX hanya mendukung Wi-Fi 2.4GHz. Atur hotspot Anda ke 2.4GHz sebelum melanjutkan.',
    },
    how_it_works: 'Cara kerja pengujian:',
    how_it_works_step1: '1. Atur ponsel Anda sebagai hotspot Wi-Fi.',
    how_it_works_step2: '2. Hubungkan mesin ke hotspot.',
    how_it_works_step3: '3. Hubungkan komputer Anda ke hotspot yang sama.',
    how_it_works_step4: '4. Uji koneksi di Beam Studio.',
    intro: 'Mari jalankan pengujian cepat untuk memeriksa apakah mesin Anda berfungsi dengan baik. Kami akan menghubungkan mesin dan komputer Anda melalui hotspot ponsel Anda untuk menentukan apakah masalahnya ada pada jaringan Anda atau pada mesin itu sendiri.',
    ip_address: {
      step1: 'Pada panel sentuh mesin, buka:\nJaringan → Cari "Alamat IP"',
      step2: 'IP biasanya terlihat seperti: 172.20.10.x atau 192.168.x.x\n(Ini tergantung pada hotspot ponsel Anda)',
      step3: 'Catat alamat IP ini untuk langkah berikutnya.',
      title: 'Temukan Alamat IP Mesin Anda',
      warning: 'Jika IP dimulai dengan 169.254, koneksi gagal. Kembali ke Langkah 1 dan coba lagi.',
    },
    success: {
      cause: 'Masalah koneksi yang Anda alami kemungkinan besar disebabkan oleh lingkungan jaringan lokal Anda, bukan mesin itu sendiri.',
      intro: 'Anda telah berhasil menyelesaikan pengujian koneksi Wi-Fi — kerja bagus! Ini mengonfirmasi bahwa mesin FLUX Anda berfungsi dengan sempurna.',
      recommend1: '• Hubungi Penyedia Layanan Internet (ISP) atau produsen router Anda untuk bantuan terkait pengaturan Wi-Fi',
      recommend2: '• Tanyakan kepada administrator jaringan jika Anda berada di sekolah, kantor, atau ruang kerja bersama',
      recommend3: '• Periksa apakah router Anda mendukung 2.4GHz dan coba mulai ulang',
      recommend_title: 'Yang Kami Rekomendasikan:',
      title: 'Kerja Bagus! 🎉',
    },
  ...
  generators: {
    ...
    keychain_generator: 'Generator Gantungan Kunci',
  ...
  machine_linking: {
    ...
    input_birthday_to_link: 'Masukkan tanggal lahir Anda untuk menyelesaikan penautan perangkat',
    input_birthday_to_link_note: '*Digunakan untuk memverifikasi apakah usia Anda memenuhi persyaratan kelayakan',
    link_failed: 'Tautan gagal.',
    link_failed_already_linked: 'Perangkat ini saat ini ditautkan ke FLUX ID lain. Anda dapat terus menggunakannya atau menautkannya ke akun Anda.',
    link_failed_cannot_set_secret: 'Tidak dapat menyimpan informasi tautan ke perangkat. Periksa koneksi antara komputer dan perangkat Anda.',
    link_failed_under_age: 'Anda saat ini tidak memenuhi syarat untuk menggunakan layanan ini dan tidak dapat menyelesaikan penautan perangkat.',
    link_machine: 'Tautkan FLUX ID',
    link_machine_to_account: 'Terhubung ke %(name)s. Apakah Anda ingin menautkan perangkat ini ke akun Anda?',
    link_success: 'Tautan berhasil.',
    link_to_my_flux_id: 'Tautkan ke FLUX ID saya',
    privacy_policy: 'Kebijakan Privasi',
    privacy_policy_link: 'https://flux3dp.com/privacy/',
    process_linking: 'Menautkan…',
    use_without_linking: 'Gunakan tanpa menautkan',
  },
  machine_status: {
    '-17': 'Mode Kartrid IO',
    '-10': 'Mode perawatan',
  ...
  maintenance: {
    ...
    areas: {
      ...
      optics: 'Optik',
      panel: 'Panel',
      working_area: 'Area kerja',
    },
    cadence: {
      by_material: 'Menurut bahan',
      condition: 'Kondisi',
      day: 'Setiap hari',
      days: 'Setiap %s hari',
      each_operation: 'Setiap pengoperasian',
      every_1_2_weeks: 'Setiap 1–2 minggu',
      month: 'Setiap bulan',
      months: 'Setiap %s bulan',
      upon_unboxing: 'Saat pertama kali membuka kemasan',
      week: 'Setiap minggu',
    ...
    essential: 'Penting',
    essential_health: 'Kesehatan penting',
    essential_hint: 'dihitung dalam kesehatan',
    feedback: {
      checked: '%s diperiksa.',
      done: '%s baru saja dilakukan. Jatuh tempo berikutnya %s.',
      done_no_date: '%s selesai.',
      fail_warning: '%s: ditandai untuk penggantian tabung. Buka panduan untuk langkah-langkahnya.',
      passed: '%s lulus — tabung dalam kondisi baik!',
    },
    footer_tip: 'Tips: ukir file contoh setiap bulan agar mesin tetap sehat.',
    history_hint: 'Hanya %s entri terbaru yang disimpan untuk setiap tugas.',
    intro: 'Pantau setiap tugas pemeliharaan mesin ini dan tandai selesai dengan satu klik.',
    legend: {
    ...
    status: {
      ...
      healthy: 'Sehat',
      last: 'Terakhir',
      never_done: 'Belum pernah',
      next: 'Berikutnya',
      not_checked: 'Belum diperiksa',
      not_logged: 'Belum dicatat',
      overdue: 'Terlambat',
      replace_tube: 'Ganti tabung',
    },
    tasks: {
      align: {
        keyPoints: 'Sesuaikan saat jalur optik tidak sejajar.',
        name: 'Penyelarasan Jalur Optik',
      },
      chassis: {
        keyPoints: 'Bersihkan residu dan minyak tar dari sasis dan penutup bawah.',
        name: 'Pembersihan Sasis',
      },
      door: {
        keyPoints: 'Bersihkan minyak dari penutup pintu.',
        name: 'Pembersihan Penutup Pintu',
      },
      exhaust: {
        keyPoints: 'Bersihkan debu dari bilah kipas.',
        name: 'Pembersihan Kipas Pembuangan',
      },
      fan: {
        keyPoints: 'Bersihkan debu dari bilah kipas ventilasi.',
        name: 'Pembersihan Kipas Ventilasi',
      },
      fieldlens: {
        keyPoints: 'Bersihkan lensa bidang, usap dari tengah ke arah luar searah jarum jam.',
        name: 'Pembersihan Lensa Bidang',
      },
      honeycomb_plate: {
        keyPoints: 'Bersihkan residu dan tar dari kisi pelat sarang lebah.',
        name: 'Pembersihan Pelat Sarang Lebah',
      },
      honeycomb_table: {
        keyPoints: 'Bersihkan residu dan minyak tar dari jaring sarang lebah.',
      ...
      maintain_test: {
        keyPoints: 'Periksa tampilan status dan sakelar.',
        name: 'Halaman MAINTAIN',
      },
      mirrors_combiner: {
        keyPoints: 'Bersihkan kotoran dari lensa/cermin; periksa oksidasi. Jangan sisakan bekas alkohol atau air.',
        name: 'Cermin, Lensa Fokus & Beam Combiner',
      },
      mirrors_lens: {
        keyPoints: 'Bersihkan 4 cermin dan lensa; pastikan tidak ada oksidasi atau bekas air.',
        name: 'Pembersihan Cermin & Lensa',
      },
      mod_diode: {
        keyPoints: 'Bersihkan kipas, lensa fokus, dan POGO pin.',
        name: 'Modul Laser Diode',
      },
      mod_ir: {
        keyPoints: 'Bersihkan lensa fokus.',
        name: 'Modul Laser Inframerah',
      },
      optical_inspection: {
        keyPoints: 'Periksa jalur optik; juga saat membuka kemasan dan setelah penggantian tabung.',
        name: 'Pemeriksaan Jalur Optik',
      },
      optical_unboxing: {
        keyPoints: 'Pastikan jalur optik akurat. Periksa saat pertama kali membuka kemasan.',
        name: 'Pemeriksaan Jalur Optik',
      },
      screen: {
        keyPoints: 'Bersihkan debu dan minyak pada panel.',
        name: 'Pembersihan Layar',
      },
      tube: {
        keyPoints: 'Jika akrilik 3 mm tidak dapat dipotong pada daya 70%, ganti tabung.',
        name: 'Pemeriksaan Kesehatan Tabung Laser',
      },
      water: {
        keyPoints: 'Tambahkan air hingga lebih dari 80% penuh tanpa gelembung udara.',
        name: 'Penggantian Air Pendingin',
      },
      worktable: {
        keyPoints: 'Semprotkan alkohol pada tisu, lalu usap meja kerja.',
        name: 'Pembersihan Meja Kerja',
      },
      zaxis: {
        keyPoints: 'Usap sekrup kolom sumbu Z, lalu oleskan pelumas secara merata dengan cotton bud.',
        name: 'Pelumasan Kolom Sumbu Z',
      },
    },
    title: 'Daftar Periksa Pemeliharaan',
  },
  ...
  message: {
    ...
    camera: {
      ...
      fail_to_transmit_image: '#845 Terjadi kesalahan transmisi gambar. Harap mulai ulang mesin atau Beam Studio. Jika error berlanjut, ikuti <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/4402756056079">panduan ini</a>.',
      switching_camera: 'Mengganti kamera...',
      wide_angle_open_door: 'Buka pintu penutup',
      wide_angle_open_door_text: 'Buka pintu penutup sebelum beralih ke kamera sudut lebar.',
  ...
  params_label: {
    ...
    preview_hint: 'Ini adalah pratinjau. Konten teks akan diperbarui secara otomatis sebelum mengirim tugas',
    save_as_default: 'Simpan sebagai default',
    settings: 'Pengaturan Label Parameter',
    update: 'Perbarui',
    updated: 'Label parameter diperbarui',
    use_default: 'Gunakan default tersimpan',
    use_recommended: 'Gunakan yang direkomendasikan',
  },
  pass_through: {
  ...
  print_and_cut: {
    align_progress: {
      ...
      completing: 'Segera selesai',
      detecting: 'Mendeteksi tanda penyelarasan',
      locating: 'Mencari tanda penyelarasan',
      preparing: 'Menyiapkan kamera',
      refining: 'Menyempurnakan posisi tanda',
    },
    alignment: {
    ...
    calibration: {
      align_desc: '1. Letakkan lembar kalibrasi yang sudah dicetak di area kerja, rekatkan dengan selotip atau masking tape agar tidak bergeser, lalu atur fokus.\n2. Klik “Pratinjau dan selaraskan” untuk menjalankan penyelarasan kamera.\n3. Setelah tanda ditemukan, klik “Gores Skala” untuk menggoreskan garis acuan pada lembar dengan daya rendah.',
      aligned: 'Tanda penyelarasan terdeteksi. Siap menggores.',
      auto_read: 'Baca Skala dengan Kamera',
      auto_read_failed: 'Skala tidak dapat dibaca secara otomatis. Baca dengan mata dan masukkan nilainya.',
      auto_read_hint: 'Pembacaan kamera dapat meleset hingga ±2; periksa dengan lembar kalibrasi.',
      current_offset: 'Offset saat ini: X %s mm, Y %s mm',
      export_pdf: 'Ekspor PDF Kalibrasi',
      power: 'Daya',
      print_desc: '1. Ekspor PDF lembar kalibrasi. Lembar ini berisi empat tanda penyelarasan dan dua skala.\n2. Cetak lembar pada skala 100% (ukuran sebenarnya).',
      reading_desc: '1. Cari garis goresan terpanjang (garis tengah) dan perhatikan di sisi mana garis itu berada terhadap garis 0 yang tercetak.\n2. Telusuri garis demi garis ke arah sisi tersebut sampai sebuah garis goresan tepat sejajar dengan garis cetak.\n3. Hitung dari 0 hingga garis cetak tersebut (angka dicetak setiap 5 garis; hitung juga garis tanpa angka di antaranya).',
      reading_x: 'Pembacaan X',
      reading_y: 'Pembacaan Y',
      scratch: 'Gores Skala',
      speed: 'Kecepatan',
    ...
    finish: 'Selesai',
    fit_content: 'Sesuaikan dengan konten',
    generate_from_contour: 'Buat dari kontur',
    grid_columns: 'Kolom',
    grid_rows: 'Baris',
    ...
    paper_size: 'Ukuran keluaran',
    paper_too_small: 'Area keluaran terlalu kecil. Desain (termasuk tanda penyelarasan) memerlukan margin minimal %s mm dari tepi material agar tetap berada di dalam area cetak printer. Pilih ukuran keluaran yang lebih besar, jika tidak hasil cetak akan terpotong atau diperkecil.',
    preview_and_align: 'Pratinjau dan selaraskan',
    resume_desc: 'Desain ini sudah disiapkan untuk Cetak dan Potong.\nLetakkan material tercetak berikutnya di mesin dan lanjutkan ke penyelarasan kamera, atau mulai ulang untuk mengubah desain, ukuran keluaran, atau jalur potong.',
    resume_title: 'Lanjutkan Cetak dan Potong',
    select_cut_layer: 'Lapisan jalur potong',
    ...
    step_setup: 'Jalur potong dan tanda',
    step_setup_desc: 'Pilih cara membuat jalur potong: buat kontur garis luar di sekeliling seluruh desain, atau gunakan lapisan yang sudah ada sebagai jalur potong.',
    title: 'Cetak dan Potong',
    use_layer_as_cut_path: 'Gunakan lapisan',
    uv_print_file_disabled: 'Cetak dan Potong mencetak konten lapisan Cetak UV. Aktifkan "Aktifkan File Cetak UV" di Preferensi, lalu tambahkan desain Anda ke lapisan Cetak UV.',
  ...
  tips: {
    canvas_hold_space_to_pan: 'Tahan tombol Spasi dan seret untuk menggeser kanvas.',
    feature_auto_fit: 'Setelah pratinjau kamera, gunakan Tindakan → Penyesuaian Otomatis untuk menempatkan objek secara otomatis pada material Anda.',
    feature_box_generator: 'Gunakan Generator → Generator Kotak untuk membuat kotak berukuran khusus dalam hitungan detik.',
    feature_code_generator: 'Gunakan Generator → Generator Barcode untuk membuat kode QR dan barcode.',
    feature_elements: 'Panel Elemen sekarang mencakup lebih dari satu juta grafis yang siap digunakan.',
    feature_layer_color_configurations: 'Petakan warna lapisan SVG ke kecepatan dan daya melalui Edit → Lapisan → Pengaturan Warna.',
    feature_material_test: 'Gunakan Generator → Generator Uji Material di toolbar kiri untuk dengan cepat menemukan pengaturan terbaik untuk material.',
    layer_execution_order: 'Urutan lapisan menentukan urutan pekerjaan. Pekerjaan berjalan dari atas ke bawah.',
    machine_clean_mirror: 'Periksa cermin dan lensa fokus secara teratur dan bersihkan jika perlu untuk mencegah penumpukan asap.',
    machine_no_unattended_operation: 'Jangan pernah meninggalkan mesin berjalan tanpa pengawasan.',
    machine_regular_start: 'Jalankan pekerjaan laser setidaknya sekali setiap dua minggu untuk membantu memperpanjang masa pakai tabung laser.',
    object_edit_image_to_erase: 'Gunakan Gambar → Tindakan → Edit Gambar untuk menghapus area yang tidak diinginkan dalam gambar.',
    object_polygon_sides: 'Sesuaikan jumlah sisi di panel properti poligon.',
    object_rounded_rectangle: 'Atur radius sudut persegi panjang membulat di panel properti persegi panjang.',
    object_sharpen_portrait: 'Tingkatkan ukiran potret dengan Gambar → Tindakan → Pertajam.',
    settings_auto_save: 'Aktifkan Simpan Otomatis di Preferensi untuk menghindari kehilangan pekerjaan Anda.',
    settings_default_text_font: 'Anda dapat mengatur font default untuk alat Teks di Preferensi.',
    task_focus_lower_for_cutting: 'Untuk material yang lebih tebal, memfokuskan sekitar 2 mm di bawah permukaan dapat meningkatkan hasil pemotongan.',
  ...
  topbar: {
    alerts: {
      ...
      fail_to_connect_with_camera: '#803 Gagal membuat koneksi dengan kamera mesin. Harap mulai ulang mesin Anda atau Beam Studio. Jika kesalahan ini berlanjut, ikuti <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">panduan ini</a>.',
      ...
      fail_to_start_preview: '#803 Gagal memulai mode pratinjau. Harap mulai ulang mesin Anda atau Beam Studio. Jika kesalahan ini berlanjut, ikuti <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">panduan ini</a>.',
      ...
      start_preview_timeout: '#803 Timeout telah terjadi saat memulai mode pratinjau. Harap mulai ulang mesin Anda atau Beam Studio. Jika kesalahan ini berlanjut, ikuti <a target="_blank" href="https://support.flux3dp.com/hc/en-us/articles/360001791895">panduan ini</a>.',
    ...
    menu: {
      ...
      export_BVG: 'BVG',
      export_calibration_data: 'Ekspor Data Kalibrasi',
      ...
      import_acrylic_focus_probe: 'Sonde Fokus beamo & Beambox - 3 mm',
      ...
      machines: 'Mesin',
      maintenance_checklist: 'Daftar Periksa Pemeliharaan',
      ...
      reset: 'Atur Ulang',
      reset_layout: 'Atur Ulang Tata Letak',
