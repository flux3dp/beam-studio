...
const lang: ILang = {
  ...
  beambox: {
    ...
    ai_upscale_panel: {
      ...
      oversize_warning: 'Ukuran output (%s) melebihi maksimum yang disarankan %d × %d px. Pemrosesan dapat memakan waktu beberapa menit dan hasilnya dapat memperlambat Beam Studio. Tetap lanjutkan?',
