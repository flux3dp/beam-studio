  ...
  beambox: {
    ...
    material_browser: {
      ...
      editor: {
        ...
        parent_hint: 'Jika diatur, akan ditampilkan sebagai varian ketebalan di bawah material induknya (tidak muncul di kisi utama).',
        parent_material: 'Material Induk',
        photo: 'Foto',
        tags: 'Tag',
        thickness_inch: 'Ketebalan (inci)',
        thickness_inch_hint: 'Dapat diisi dalam bentuk pecahan',
