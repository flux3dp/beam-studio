...
const lang: ILang = {
  ...
  calibration: {
    ...
    put_chessboard_bm2_1: 'Unduh dan cetak file berikut pada kertas A4 untuk kalibrasi kamera.',
    put_chessboard_bm2_2: 'Letakkan kertas kalibrasi rata di posisi yang ditentukan pada area kerja.',
