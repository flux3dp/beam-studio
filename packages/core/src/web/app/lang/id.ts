  ...
  beambox: {
    ...
    right_panel: {
      laser_panel: {
        ...
        curve_engraving_speed_contrain_warning: 'Kecepatan pengukiran objek kurva 3D akan dibatasi hingga %(limit)s. Anda dapat menghapus batas ini di Pengaturan Preferensi.',
