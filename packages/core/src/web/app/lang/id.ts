...
const lang: ILang = {
  ...
  calibration: {
    ...
    align_4_0: 'Posisi: Selaraskan dengan titik ukiran di kiri atas.',
    align_4_1: 'Posisi: Selaraskan dengan titik ukiran di kanan atas.',
    align_4_2: 'Posisi: Selaraskan dengan titik ukiran di kiri bawah.',
    align_4_3: 'Posisi: Selaraskan dengan titik ukiran di kanan bawah.',
    align_8_0: 'Posisi: Sejajarkan dengan titik terukir di kiri atas luar.',
    align_8_1: 'Posisi: Sejajarkan dengan titik terukir di kanan atas luar.',
    align_8_2: 'Posisi: Sejajarkan dengan titik terukir di kiri bawah luar.',
    align_8_3: 'Posisi: Sejajarkan dengan titik terukir di kanan bawah luar.',
    align_8_4: 'Posisi: Sejajarkan dengan titik terukir di kiri atas dalam.',
    align_8_5: 'Posisi: Sejajarkan dengan titik terukir di kanan atas dalam.',
    align_8_6: 'Posisi: Sejajarkan dengan titik terukir di kiri bawah dalam.',
    align_8_7: 'Posisi: Sejajarkan dengan titik terukir di kanan bawah dalam.',
    ...
    charuco_place_charuco: 'Tempatkan pola kalibrasi yang dicetak secara horizontal di <b>%s</b> area kerja.',
    ...
    check_pnp_desc: 'Kami telah mengambil ulang gambar berdasarkan hasil kalibrasi dan menandai titik referensi pengukiran.\nSilakan periksa apakah penanda merah cocok dengan titik pengukiran yang sebenarnya.\nJika Anda melihat ketidaksesuaian yang jelas, cukup klik "Kalibrasi Ulang" untuk mencoba lagi.',
    ...
    solve_pnp_keep_door_closed: 'Tetap tutup pintu selama proses berikut. Jika pintu dibuka, sistem akan mencoba memindahkan kamera.',
    ...
    solve_pnp_relocate_camera: 'Klik "Pindahkan Kamera" jika kepala laser belum terpusat secara horizontal.',
  ...
  settings: {
    ...
    module_offset_4c: 'Offset Cetak (4C)',
    ...
    module_offset_uv_varnish: 'Offset Pernis',
    module_offset_uv_white_ink: 'Offset Tinta Putih',
    none: 'Tidak Ada',
    normal: 'Tinggi',
