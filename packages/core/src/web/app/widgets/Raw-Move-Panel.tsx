...
class RawMovePanel extends React.Component<Props, State> {
  ...
  rawMove = async (x: number, y: number): Promise<void> => {
    const { feedrate, isMoving, safeDistance, workarea } = this.state;
    ...
    const newX = Math.max(0, Math.min(workarea.maxX - safeDistance.x, x));
    const newY = Math.max(0, Math.min(workarea.maxY - safeDistance.y, y));
  ...
  moveToPoint = (point: string): void => {
    const { safeDistance, workarea } = this.state;
    const pointsMap = {
      a: {
        x: 0,
        y: 0,
  ...
  render(): React.JSX.Element {
    const { currentX, currentY, safeDistance, workarea } = this.state;
        ...
        <g className="dest-btn" id="dest-A-btn" onMouseUp={() => this.moveToPoint('a')}>
          <g>
            <g>
              <path
                className="st6"
                d="M86.6,42.5V13.1c0-2.8-2.3-5.1-5.1-5.1H5.1C2.3,8,0,10.3,0,13.1v76.3c0,2.8,2.3,5.1,5.1,5.1h29.3
            ...
            <g>
              <path
                className="st1"
                d="M86.6,34.5V5.1c0-2.8-2.3-5.1-5.1-5.1H5.1C2.3,0,0,2.3,0,5.1v76.3c0,2.8,2.3,5.1,5.1,5.1h29.3
          ...
          <g>
            <path
              className="st5"
              d="M44.2,46.2h-8.7l-1.7,5.7h-7.2l9.6-29.3h3.6v0l0,0h3.6l9.6,29.3H46L44.2,46.2z M37.1,41h5.6l-2.7-9.1h-0.1
                    L37.1,41z"
            />
          </g>
          <g>
        ...
        <g className="dest-btn" id="dest-C-btn" onMouseUp={() => this.moveToPoint('c')}>
          <g>
            <g>
              <path
                className="st6"
                d="M34.5,449.2H5.1c-2.8,0-5.1,2.3-5.1,5.1v76.3c0,2.8,2.3,5.1,5.1,5.1h76.3c2.8,0,5.1-2.3,5.1-5.1v-29.3
            ...
            <g>
              <path
                className="st1"
                d="M34.5,441.2H5.1c-2.8,0-5.1,2.3-5.1,5.1v76.3c0,2.8,2.3,5.1,5.1,5.1h76.3c2.8,0,5.1-2.3,5.1-5.1v-29.3
          ...
          <g>
            <path
              className="st7"
              d="M60.4,519.7L60.4,519.7l1.9-7.2h2.5v9.8h-1.9v-6.1l0,0l-1.8,6.2h-1.3l-1.7-6.1l0,0v6.1h-1.9v-9.8h2.5
                    L60.4,519.7z"
            />
            <path
              className="st7"
          ...
          <g>
            <path
              className="st5"
              d="M51.4,490l0,0.1c0.1,3.3-0.9,5.9-2.8,7.6c-1.9,1.7-4.7,2.6-8.2,2.6c-3.6,0-6.5-1.1-8.7-3.3
        ...
        <g className="dest-btn" id="dest-B-btn" onMouseUp={() => this.moveToPoint('b')}>
          <g>
            <g>
              <path
                className="st6"
                d="M441.4,42.5V13.1c0-2.8,2.3-5.1,5.1-5.1h76.3c2.8,0,5.1,2.3,5.1,5.1v76.3c0,2.8-2.3,5.1-5.1,5.1h-29.3
            ...
            <g>
              <path
                className="st1"
                d="M441.4,34.5V5.1c0-2.8,2.3-5.1,5.1-5.1l76.3,0c2.8,0,5.1,2.3,5.1,5.1v76.3c0,2.8-2.3,5.1-5.1,5.1h-29.3
          ...
          <g>
            <path
              className="st5"
              d="M478.7,51.8V22.5h9.6c3.6,0,6.5,0.7,8.5,2c2,1.3,3,3.4,3,6c0,1.4-0.3,2.6-1,3.7s-1.6,1.9-3,2.4
          ...
          <g>
            <path
              className="st7"
              d="M450.1,12.9L450.1,12.9l1.9-7.2h2.5v9.8h-1.9V9.3l0,0l-1.8,6.2h-1.3l-1.7-6.1l0,0v6.1h-1.9V5.7h2.5
                                L450.1,12.9z"
            />
          ...
          <g>
            ...
            <path
              className="st7"
              d="M518.8,78.9L518.8,78.9l3.4,1.4v2.1l-4.7-2.4l-4.8,2.5v-2.2l3.4-1.4v0l-3.4-1.4v-2.1l4.8,2.4l4.7-2.4v2.1
                                L518.8,78.9z"
            />
          </g>
        </g>
        <g className="dest-btn" id="dest-D-btn" onMouseUp={() => this.moveToPoint('d')}>
          <g>
            <g>
              <path
                className="st6"
                d="M493.2,449.2h29.3c2.8,0,5.1,2.3,5.1,5.1v76.3c0,2.8-2.3,5.1-5.1,5.1h-76.3c-2.8,0-5.1-2.3-5.1-5.1v-29.3
            ...
            <g>
              <path
                className="st1"
                d="M493.2,441.2h29.3c2.8,0,5.1,2.3,5.1,5.1v76.3c0,2.8-2.3,5.1-5.1,5.1h-76.3c-2.8,0-5.1-2.3-5.1-5.1v-29.3
          ...
          <g>
            <path
              className="st5"
              d="M487.3,471.3c3.4,0,6.3,1.1,8.6,3.4c2.3,2.2,3.5,5.1,3.5,8.6v5.3c0,3.5-1.2,6.4-3.5,8.6
          ...
          <g>
            <path
              className="st7"
              d="M449.3,519.7L449.3,519.7l1.9-7.2h2.5v9.8h-1.9v-6.1l0,0l-1.8,6.2h-1.3l-1.7-6.1l0,0v6.1H445v-9.8h2.5
                    L449.3,519.7z"
            />
            <path
              className="st7"
            ...
            <path
              className="st7"
              d="M465.9,516L465.9,516l1.4-3.5h2.2l-2.4,4.8l2.6,4.9h-2.3l-1.4-3.5h0l-1.4,3.5h-2.2l2.5-4.9l-2.4-4.8h2.2
                    L465.9,516z"
            />
          </g>
          <g>
            ...
            <path
              className="st7"
              d="M514.7,462.4V460l-2.1-0.5v-1.9l9.5,2.7v1.9l-9.5,2.7v-1.9L514.7,462.4z M516.1,460.4v1.6l3-0.8v0
                    L516.1,460.4z"
            />
            <path
              className="st7"
              d="M518.8,468.5L518.8,468.5l3.4,1.4v2.1l-4.7-2.4l-4.8,2.5V470l3.4-1.4v0l-3.4-1.4V465l4.8,2.4l4.7-2.4v2.1
                    L518.8,468.5z"
            />
          </g>
        </g>
