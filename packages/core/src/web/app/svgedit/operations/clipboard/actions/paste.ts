...
/**
 * Pastes elements from the clipboard with a specified offset from their original position.
 * @param x - The horizontal offset. Defaults to 100.
 * @param y - The vertical offset. Defaults to 100.
 */
export const pasteWithOffset = async (x = 100, y = 100): Promise<null | { cmd: IBatchCommand; elems: Element[] }> => {
