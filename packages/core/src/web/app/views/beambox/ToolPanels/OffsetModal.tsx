        ...
        <div className={styles.field}>
          ...
          <Select
            ...
            options={[
              ...
              { label: 'Outward', value: 'outwardOutline' },
              { label: 'Inward', value: 'inwardOutline' },
              { label: 'Outward Filled', value: 'outwardFilled' },
              { label: 'Inward Filled', value: 'inwardFilled' },
            ]}
