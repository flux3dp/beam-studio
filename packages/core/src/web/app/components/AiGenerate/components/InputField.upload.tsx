...
const InputFieldWithUpload = memo(
  ({
    field,
    imageInputs,
      ...
      >
        ...
        <div className={styles['input-container']}>
          ...
          <div className={styles['bottom-bar']}>
            <button
              className={classNames(styles['upload-btn'], {
                [styles.disabled]: !canAddMore,
            ...
            >
              ...
              {isMobile() && (
                <>
                  <span>{lang.beambox.tag.image}</span>
                  {imageInputs.length > 0 && (
                    <span className={styles['mobile-count']}>
