          ...
          {addOnInfo.rotary?.split && (
            <>
              <div className={styles['sub-item-title']}>
                {tDocu.rotary_split_setting}{' '}
                <QuestionCircleOutlined onClick={() => browser.open(tDocu.rotary_split_setting_url)} />
              </div>
              <div className={styles['sub-items']}>
                <div className={styles.title}>
                  <label htmlFor="split">{tDocu.rotary_split_size}</label>
                </div>
                ...
                <div className={styles.title}>
                  <label htmlFor="overlap">{tDocu.rotary_overlap_size}</label>
                </div>
                <div className={styles.control}>
                  <UnitInput
                    addonAfter={isInch ? 'in' : 'mm'}
