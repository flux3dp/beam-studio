...
const PuzzleStack = memo(({ boundaryPath, clipFunc, colors, edges, imageOverlay }: PuzzleStackProps) => (
  <Group>
    {imageOverlay}
    <Path data={boundaryPath} fill={colors.fill} stroke={colors.raisedEdges} strokeWidth={STROKE_WIDTH} />
    <PuzzleEdges
      clipFunc={clipFunc}
