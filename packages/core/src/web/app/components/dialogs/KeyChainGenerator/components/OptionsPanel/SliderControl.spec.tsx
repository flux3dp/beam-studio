...
describe('SliderControl', () => {
  ...
  it('should call onChange when slider changes', () => {
    const { getByTestId } = render(<SliderControl {...defaultProps} />);
