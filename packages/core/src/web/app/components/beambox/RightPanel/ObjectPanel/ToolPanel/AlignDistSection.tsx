  ...
  return isTablet ? (
    <ObjectPanelItem
      ...
      renderContent={() => (
        <Content>
          <div>
            <Label>{tObjectPanel.horizontal_alignment}</Label>
            <Row>
          ...
          <div>
            <Label>{tObjectPanel.vertical_alignment}</Label>
            <Row>
          ...
          <Divider />
          <div>
            <Label>{tObjectPanel.distribute}</Label>
            <Row>
      ...
      title={`${tObjectPanel.align}/${tObjectPanel.distribute}`}
    />
  ) : (
