...
export const EditableButton = ({
  ...
  <Button
    className={classNames(position === 'default' ? styles.button : styles[`button-${position}`], {
...
const ControlBlock = ({ children, className, extra, forceVisible, label, position, title, type }: Props) => {
