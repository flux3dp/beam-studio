...
const getInitStore = (): GlobalPreference => {
  ...
  return {
    ...
    'material-region-override': preference['material-region-override'],
    model: preference.model,
    'model-annotation': preference['model-annotation'],
    ...
    'use-material-browser': preference['use-material-browser'],
