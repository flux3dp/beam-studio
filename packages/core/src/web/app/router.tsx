...
import ConnectEthernet from '@core/app/pages/InitializeMachine/ConnectEthernet';
import ConnectMachineIp from '@core/app/pages/InitializeMachine/ConnectMachineIp';
