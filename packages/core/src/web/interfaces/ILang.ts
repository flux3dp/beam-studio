...
export interface ILang {
  ...
  beambox: {
    ...
    material_browser: {
      ...
      export: string;
      favorites: string;
      from_current_layer: string;
      import: string;
      machine: string;
      manual: string;
      manual_settings: string;
      modified: string;
      move_to_material: string;
      new_preset_manual: string;
      no_materials_in_category: string;
      no_presets_for_machine: string;
      ...
      settings_use: string;
      showing_bundled: string;
      state_customized: string;
  ...
  calibration: {
    ...
    put_charuco: string;
    put_charuco_1: string;
    put_charuco_2: string;
    put_charuco_3: string;
    put_charuco_bm2_1: string;
    put_charuco_bm2_2: string;
  ...
  topbar: {
    ...
    menu: {
      ...
      import_beamo_2_printing_test: string;
