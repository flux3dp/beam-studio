const requirement = {
  ...
  BM2_BURST_REFRESH: '6.1.14',
  BM2_CAMERA_MODE_COMMAND: '6.1.11',
  BM2_H_CAM_COMMAND: '6.1.1',
  ...
  // Alpha compatibility floor for BSPC ingestion.
  SWIFTRAY_SUPPORT_POINT_CLOUD: '2.4.9',
  // Alpha compatibility floor for STL slicing.
