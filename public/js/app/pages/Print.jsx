define([
    ...
    return function(args) {
        ...
        class Print extends React.Component{
            ...
            _handleToggleAdvancedSettingPanel = () => {
            ...
            _handleCloseAdvancedSetting = () => {
                this.setState({ showAdvancedSettings: false });
                allowDeleteObject = true;
            }

            _handleApplyAdvancedSetting = (setting) => {
            ...
            _handleDownloadFCode = () => {
                director.downloadFCode();
            }

            _handleDownloadScene = () => {
                allowDeleteObject = true;
            ...
            _handlePrinterSelectorWindowClose = () => {
                this.setState({ openPrinterSelectorWindow: false });
            }

            _handlePrinterSelectorUnmount = () => {
                AlertStore.onCancel(this._handleDefaultCancel);
                listeningToCancel = true;
            }

            _handleDeviceSelected = (printer) => {
            ...
            _handlePreviewLayerChange = (targetLayer) => {
                director.changePreviewLayer(targetLayer);
            }

            _handleCameraPositionChange = (position, rotation) => {
                director.setCameraPosition(position, rotation);
            }

            _handleMonitorClosed = () => {
            ...
            _handleQualityModelSelected = (quality, machineModel) => {
            ...
            _handleObjectDialogueFocus = (isFocused) => {
                allowDeleteObject = !isFocused;
            }

            _handleDefaultCancel = (ans) => {
            ...
            _handleSlicingEngineChange = (engineName) => {
            ...
            _checkDefaultPrintSettingsVersion = () => {
