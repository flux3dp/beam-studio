define(function() {
    ...
    return {
        ...
        initialize: {
            ...
            select_beambox_type: '请选择您 Beambox 的种类',
        ...
        settings: {
            ...
            stripe_calibration: '间距横纹校正',
            stripe_calibration_initial: '间距横纹起始位置',
            stripe_calibration_interval: '间距横纹距离',
            stripe_calibration_power: '间距横纹调整功率',
            mask: '工作范围剪裁',
            optimization: '优化',
            font_substitute: '自动替换字体',
            default_borderless_mode: '开盖模式预设',
            default_enable_autofocus_module: '自动对焦模组预设',
            default_enable_diode_module: '混合雷射模组预设',
            ...
            right_panel: {
                ...
                laser_panel: {
                    ...
                    dropdown: {
                        ...
                        wood_bw_engraving: '木板 - 双色刻印',
                        wood_shading_engraving: '木板 - 渐层刻印',
                        acrylic_3mm_cutting: '压克力 - 3mm 切割',
                        acrylic_5mm_cutting: '压克力 - 5mm 切割',
                        acrylic_bw_engraving: '压克力 - 双色刻印',
                        acrylic_shading_engraving: '压克力 - 渐层刻印',
                        leather_3mm_cutting: '皮革 - 3mm 切割',
                        leather_5mm_cutting: '皮革 - 5mm 切割',
                        leather_bw_engraving: '皮革 - 双色刻印',
                        leather_shading_engraving: '皮革 - 渐层刻印',
                        fabric_3mm_cutting: '布料 - 3mm 切割',
                        fabric_5mm_cutting: '布料 - 5mm 切割',
                        fabric_bw_engraving: '布料 - 双色刻印',
                        fabric_shading_engraving: '布料 - 渐层刻印',
                        rubber_bw_engraving: '印章垫 - 双色刻印',
