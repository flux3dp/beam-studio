define(function() {
    ...
    return {
        ...
        settings: {
            ...
            stripe_calibration_initial: '間距橫紋起始位置',
            stripe_calibration_interval: '間距橫紋距離',
            stripe_calibration_power: '間距橫紋調整功率',
            mask: '工作範圍剪裁',
            optimization: '優化',
        ...
        tutorial: {
            ...
            openBrowser: '開啟網頁',
            welcome: '歡迎使用',
            needNewUserTutorial: '歡迎使用！\n請問您是否需要 Beam Studio 的教學？',
            needNewInterfaceTutorial: '歡迎使用！\n請問是否需要為您介紹 Beam Studio 的新介面？',
            next: '下一步',
            newUser: {
                draw_a_circle: '畫一個圓',
                ...
                set_preset_engraving: '設定參數 - 雕刻',
                set_preset_cut: '設定參數 - 切割',
                add_new_layer: '新增圖層',
                draw_a_rect: '畫一個方形',
