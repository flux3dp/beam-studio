define(function() {
    ...
    return {
        ...
        settings: {
            ...
            stripe_calibration: 'Horizontal Stripe Compensation',
            stripe_calibration_initial: 'Start Position',
            stripe_calibration_interval: 'Interval',
            stripe_calibration_power: 'Power Regulation',
            mask: 'ワークエリアのクリッピング',
            optimization: '最適化',
