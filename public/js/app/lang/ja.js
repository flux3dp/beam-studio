define(function() {
    ...
    return {
        ...
        initialize: {
            ...
            select_beambox_type: 'Beamboxタイプを選択してください',
        ...
        settings: {
            ...
            stripe_calibration: '横線補正',
            stripe_calibration_initial: '開始 Y 位置',
            stripe_calibration_interval: '間隔',
            stripe_calibration_power: '出力調整',
            mask: 'ワークエリアのクリッピング',
            optimization: '最適化',
        ...
        beambox: {
            ...
            popup: {
                ...
                too_fast_for_path_and_constrain: '次のレイヤー：％s \ nベクターパスオブジェクトが含まれていて、速度が20mm / sを超えています。\ nベクターパスオブジェクトの切断速度は20mm / sに制限されます。\ nこの制限は[好み]で削除できます。',
            ...
            left_panel: {
                ...
                unpreviewable_area: 'このエリアはプレビューできません',
