...
test('Check Zoom Object', async function() {
    ...
    expect(Math.round(await rectlocation.getSize('width'))).toEqual(250);
    expect(Math.round(await rectlocation.getSize('height'))).toEqual(250);
});
...
test('Check Zoom Lock Object', async function() {
    ...
    expect(Math.round(await rect.getSize('width'))).toEqual(50);
    expect(Math.round(await rect.getSize('height'))).toEqual(50);
    expect(await rect.getLocation('x')).toEqual(323.771484375);
    expect(await rect.getLocation('y')).toEqual(253.32861328125);
});
