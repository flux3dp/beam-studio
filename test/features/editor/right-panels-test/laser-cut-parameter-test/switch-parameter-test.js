...
test('Check Switch Option Check Parameter', async function() {
    ...
    const woodEngravingspeed= await app.client.$('input#speed');
    ...
    const acrylicEngravingspeed= await app.client.$('input#speed');
    ...
    const acrylicEngravingrepeat= await app.client.$('input#repeat');
    ...
    const leatherEngravingspeed= await app.client.$('input#speed');
    ...
    const leatherEngravingrepeat= await app.client.$('input#repeat');
    ...
    const fabricEngravingspeed= await app.client.$('input#speed');
    ...
    const fabricEngravingrepeat= await app.client.$('input#repeat');
    ...
    const rubberEngravingspeed= await app.client.$('input#speed');
    ...
    const rubberEngravingrepeat= await app.client.$('input#repeat');
    ...
    const glassEngravingspeed= await app.client.$('input#speed');
    ...
    const metalEngravingspeeddiode= await app.client.$('input#speed');
    const metalEngravingspeednumberdiode = await metalEngravingspeeddiode.getAttribute('value');
    expect(metalEngravingspeednumberdiode).toEqual('10');
    const metalEngravingrepeatdiode= await app.client.$('input#repeat');
