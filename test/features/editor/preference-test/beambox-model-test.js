...
test('Check Preference Canvas Model', async function() {
    ...
    expect(fbb1bheightcheck2).toEqual('532.9499999999999');
    ...
    expect(fbb1bwidthcheck2).toEqual('568.48');
    ...
    expect(fbb1pheightcheck2).toEqual('532.9499999999999');
    ...
    expect(fbb1pwidthcheck2).toEqual('852.72');
